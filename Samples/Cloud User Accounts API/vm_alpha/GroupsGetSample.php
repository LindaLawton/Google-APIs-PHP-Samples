...
print_r(groupsGetExample($service, $project, $groupName));
...
*/
function groupsGetExample($service, $project, $groupName)
{
	try
	{
		...
		return $service->groups->GetGroups($project, $groupName);
	}
	catch (Exception $ex)
	{
