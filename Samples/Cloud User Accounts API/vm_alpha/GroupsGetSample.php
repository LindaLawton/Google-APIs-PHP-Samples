...
// Single Request.
$results = groupsGetExample($service, $project, $groupName, $optParams);
...
* @return Group
*/
function groupsGetExample($service, $project, $groupName, $optParams)
{
	try
	{
		...
		return $service->groups->GetGroups($project, $groupName, $optParams);
	}
	catch (Exception $e)
	{
