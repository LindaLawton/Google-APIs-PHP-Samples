...
// Single Request.
$results = usersInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function usersInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->users->InsertUsers($project, $optParams);
	}
	catch (Exception $e)
	{
