...
// Single Request.
$results = groupsGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function groupsGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->groups->GetIamPolicyGroups($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
