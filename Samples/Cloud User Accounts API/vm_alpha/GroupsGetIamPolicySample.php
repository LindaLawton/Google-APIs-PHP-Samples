...
print_r(groupsGetIamPolicyExample($service, $project, $resource));
...
*/
function groupsGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->groups->GetIamPolicyGroups($project, $resource);
	}
	catch (Exception $ex)
	{
