...
print_r(globalAccountsOperationsListExample($service, $project));

/**
* Retrieves the list of operation resources contained within the specified project.
* @service Authenticated Clouduseraccounts service.
* @project Project ID for this request.
* @return OperationList</returns>
*/
function globalAccountsOperationsListExample($service, $project)
{
	try
	{
		...
		return $service->globalAccountsOperations->ListGlobalAccountsOperations($project);
	}
	catch (Exception $ex)
	{
