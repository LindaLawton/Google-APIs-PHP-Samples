...
// Single Request.
$results = globalAccountsOperationsListExample($service, $project, $optParams);
...
*/
function globalAccountsOperationsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalAccountsOperations->ListGlobalAccountsOperations($project, $optParams);
	}
	catch (Exception $e)
	{
