...
print_r(groupsAddMemberExample($service, $project, $groupName));
...
*/
function groupsAddMemberExample($service, $project, $groupName)
{
	try
	{
		...
		return $service->groups->AddMemberGroups($project, $groupName);
	}
	catch (Exception $ex)
	{
