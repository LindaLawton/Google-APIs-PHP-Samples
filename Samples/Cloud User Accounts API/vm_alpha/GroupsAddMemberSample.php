...
// Single Request.
$results = groupsAddMemberExample($service, $project, $groupName, $optParams);
...
* @return Operation
*/
function groupsAddMemberExample($service, $project, $groupName, $optParams)
{
	try
	{
		...
		return $service->groups->AddMemberGroups($project, $groupName, $optParams);
	}
	catch (Exception $e)
	{
