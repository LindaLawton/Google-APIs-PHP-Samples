...
$results = usersTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function usersTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->users->TestIamPermissionsUsers($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
