...
print_r(testIamPermissions($service, $project, $resource));
...
*/
function testIamPermissions($service, $project, $resource)
{
	try
	{
		...
		return $service->testIamPermissions($project, $resource);
	}
	catch (Exception $ex)
	{
