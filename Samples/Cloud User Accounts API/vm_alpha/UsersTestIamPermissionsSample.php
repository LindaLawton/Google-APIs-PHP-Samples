...
print_r(usersTestIamPermissionsExample($service, $project, $resource));
...
*/
function usersTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->users->TestIamPermissionsUsers($project, $resource);
	}
	catch (Exception $ex)
	{
