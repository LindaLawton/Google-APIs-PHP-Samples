...
// Single Request.
$results = groupsSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function groupsSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->groups->SetIamPolicyGroups($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
