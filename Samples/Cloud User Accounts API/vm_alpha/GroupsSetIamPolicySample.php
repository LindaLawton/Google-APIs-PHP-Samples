...
print_r(groupsSetIamPolicyExample($service, $project, $resource));
...
*/
function groupsSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->groups->SetIamPolicyGroups($project, $resource);
	}
	catch (Exception $ex)
	{
