...
$results = globalAccountsOperationsGetExample($service, $project, $operation, $optParams);
...
* @return Operation
*/
function globalAccountsOperationsGetExample($service, $project, $operation, $optParams)
{
	try
	{
		...
		return $service->globalAccountsOperations->GetGlobalAccountsOperations($project, $operation, $optParams);
	}
	catch (Exception $e)
	{
