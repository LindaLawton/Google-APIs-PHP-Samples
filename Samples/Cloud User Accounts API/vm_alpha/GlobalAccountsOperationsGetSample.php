...
print_r(globalAccountsOperationsGetExample($service, $project, $operation));
...
*/
function globalAccountsOperationsGetExample($service, $project, $operation)
{
	try
	{
		...
		return $service->globalAccountsOperations->GetGlobalAccountsOperations($project, $operation);
	}
	catch (Exception $ex)
	{
