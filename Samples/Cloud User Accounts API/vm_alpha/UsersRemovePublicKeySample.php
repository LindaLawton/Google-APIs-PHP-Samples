...
// Single Request.
$results = usersRemovePublicKeyExample($service, $project, $user, $fingerprint, $optParams);
...
* @return Operation
*/
function usersRemovePublicKeyExample($service, $project, $user, $fingerprint, $optParams)
{
	try
	{
		...
		return $service->users->RemovePublicKeyUsers($project, $user, $fingerprint, $optParams);
	}
	catch (Exception $e)
	{
