...
print_r(removePublicKey($service, $project, $user, $fingerprint));
...
*/
function removePublicKey($service, $project, $user, $fingerprint)
{
	try
	{
		...
		return $service->removePublicKey($project, $user, $fingerprint);
	}
	catch (Exception $ex)
	{
