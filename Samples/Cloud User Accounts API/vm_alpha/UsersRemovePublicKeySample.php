...
print_r(usersRemovePublicKeyExample($service, $project, $user, $fingerprint));
...
*/
function usersRemovePublicKeyExample($service, $project, $user, $fingerprint)
{
	try
	{
		...
		return $service->users->RemovePublicKeyUsers($project, $user, $fingerprint);
	}
	catch (Exception $ex)
	{
