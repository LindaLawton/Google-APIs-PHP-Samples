...
// Single Request.
$results = usersAddPublicKeyExample($service, $project, $user, $optParams);
...
* @return Operation
*/
function usersAddPublicKeyExample($service, $project, $user, $optParams)
{
	try
	{
		...
		return $service->users->AddPublicKeyUsers($project, $user, $optParams);
	}
	catch (Exception $e)
	{
