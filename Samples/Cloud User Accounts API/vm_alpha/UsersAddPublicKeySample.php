...
print_r(usersAddPublicKeyExample($service, $project, $user));
...
*/
function usersAddPublicKeyExample($service, $project, $user)
{
	try
	{
		...
		return $service->users->AddPublicKeyUsers($project, $user);
	}
	catch (Exception $ex)
	{
