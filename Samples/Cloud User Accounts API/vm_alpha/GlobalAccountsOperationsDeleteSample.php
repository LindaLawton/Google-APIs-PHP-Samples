...
print_r(globalAccountsOperationsDeleteExample($service, $project, $operation));
...
*/
function globalAccountsOperationsDeleteExample($service, $project, $operation)
{
	try
	{
		...
		return $service->globalAccountsOperations->DeleteGlobalAccountsOperations($project, $operation);
	}
	catch (Exception $ex)
	{
