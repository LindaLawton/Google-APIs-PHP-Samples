 ...
 * Initializes an Clouduseraccounts.vm_alpha service object.
 * @param string API key
 * @return An authorized Clouduseraccounts.vm_alpha service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Clouduseraccounts Sample");
		...
		// Create authenticated Clouduseraccounts service
		return new Google_Service_Clouduseraccounts($client);
	} catch (Exception $e) {
