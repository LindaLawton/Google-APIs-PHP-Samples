...
// Single Request.
$results = groupsListExample($service, $project, $optParams);
...
* @return GroupList
*/
function groupsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->groups->ListGroups($project, $optParams);
	}
	catch (Exception $e)
	{
