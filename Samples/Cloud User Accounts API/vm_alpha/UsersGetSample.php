...
// Single Request.
$results = usersGetExample($service, $project, $user, $optParams);
...
* @return User
*/
function usersGetExample($service, $project, $user, $optParams)
{
	try
	{
		...
		return $service->users->GetUsers($project, $user, $optParams);
	}
	catch (Exception $e)
	{
