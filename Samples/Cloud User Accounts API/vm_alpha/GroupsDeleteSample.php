...
// Single Request.
$results = groupsDeleteExample($service, $project, $groupName, $optParams);
...
* @return Operation
*/
function groupsDeleteExample($service, $project, $groupName, $optParams)
{
	try
	{
		...
		return $service->groups->DeleteGroups($project, $groupName, $optParams);
	}
	catch (Exception $e)
	{
