...
print_r(groupsDeleteExample($service, $project, $groupName));
...
*/
function groupsDeleteExample($service, $project, $groupName)
{
	try
	{
		...
		return $service->groups->DeleteGroups($project, $groupName);
	}
	catch (Exception $ex)
	{
