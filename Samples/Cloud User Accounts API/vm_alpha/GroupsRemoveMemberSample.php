...
print_r(groupsRemoveMemberExample($service, $project, $groupName));
...
*/
function groupsRemoveMemberExample($service, $project, $groupName)
{
	try
	{
		...
		return $service->groups->RemoveMemberGroups($project, $groupName);
	}
	catch (Exception $ex)
	{
