...
// Single Request.
$results = groupsRemoveMemberExample($service, $project, $groupName, $optParams);
...
* @return Operation
*/
function groupsRemoveMemberExample($service, $project, $groupName, $optParams)
{
	try
	{
		...
		return $service->groups->RemoveMemberGroups($project, $groupName, $optParams);
	}
	catch (Exception $e)
	{
