...
$results = groupsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function groupsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->groups->TestIamPermissionsGroups($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
