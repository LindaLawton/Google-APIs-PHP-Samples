...
print_r(groupsTestIamPermissionsExample($service, $project, $resource));
...
*/
function groupsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->groups->TestIamPermissionsGroups($project, $resource);
	}
	catch (Exception $ex)
	{
