...
// Single Request.
$results = groupsInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function groupsInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->groups->InsertGroups($project, $optParams);
	}
	catch (Exception $e)
	{
