...
print_r(usersSetIamPolicyExample($service, $project, $resource));
...
*/
function usersSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->users->SetIamPolicyUsers($project, $resource);
	}
	catch (Exception $ex)
	{
