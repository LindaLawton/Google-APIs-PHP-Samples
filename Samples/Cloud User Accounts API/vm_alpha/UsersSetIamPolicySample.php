...
$results = usersSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function usersSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->users->SetIamPolicyUsers($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
