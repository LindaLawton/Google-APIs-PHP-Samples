...
// Single Request.
$results = usersGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function usersGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->users->GetIamPolicyUsers($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
