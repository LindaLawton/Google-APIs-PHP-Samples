...
print_r(usersGetIamPolicyExample($service, $project, $resource));
...
*/
function usersGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->users->GetIamPolicyUsers($project, $resource);
	}
	catch (Exception $ex)
	{
