...
print_r(linuxGetLinuxAccountViewsExample($service, $project, $zone, $instance));
...
* @return LinuxGetLinuxAccountViewsResponse</returns>
*/
function linuxGetLinuxAccountViewsExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->linux->GetLinuxAccountViewsLinux($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
