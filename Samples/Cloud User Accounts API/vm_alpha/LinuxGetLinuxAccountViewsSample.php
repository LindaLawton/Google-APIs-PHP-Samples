...
// About 
// 
// Unofficial sample for the Cloud User Accounts vm_alpha API for PHP. 
...
// Single Request.
$results = linuxGetLinuxAccountViewsExample($service, $project, $zone, $instance, $optParams);
...
* @service Authenticated Clouduseraccounts service.
* @optParams Optional paramaters are not required by a request.
* @instance The fully-qualified URL of the virtual machine requesting the views.
* @project Project ID for this request.
* @zone Name of the zone for this request.
* @return LinuxGetLinuxAccountViewsResponse
*/
function linuxGetLinuxAccountViewsExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->linux->GetLinuxAccountViewsLinux($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
