...
print_r(getLinuxAccountViews($service, $project, $zone, $instance));
...
*/
function getLinuxAccountViews($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->getLinuxAccountViews($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
