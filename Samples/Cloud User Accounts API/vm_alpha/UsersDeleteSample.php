...
// Single Request.
$results = usersDeleteExample($service, $project, $user, $optParams);
...
* @return Operation
*/
function usersDeleteExample($service, $project, $user, $optParams)
{
	try
	{
		...
		return $service->users->DeleteUsers($project, $user, $optParams);
	}
	catch (Exception $e)
	{
