...
print_r(linuxGetAuthorizedKeysViewExample($service, $project, $zone, $user, $instance));
...
* @return LinuxGetAuthorizedKeysViewResponse</returns>
*/
function linuxGetAuthorizedKeysViewExample($service, $project, $zone, $user, $instance)
{
	try
	{
		...
		return $service->linux->GetAuthorizedKeysViewLinux($project, $zone, $user, $instance);
	}
	catch (Exception $ex)
	{
