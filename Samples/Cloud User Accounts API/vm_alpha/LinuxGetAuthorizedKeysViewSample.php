...
print_r(getAuthorizedKeysView($service, $project, $zone, $user, $instance));
...
*/
function getAuthorizedKeysView($service, $project, $zone, $user, $instance)
{
	try
	{
		...
		return $service->getAuthorizedKeysView($project, $zone, $user, $instance);
	}
	catch (Exception $ex)
	{
