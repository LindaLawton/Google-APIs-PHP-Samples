...
* @return LinuxGetAuthorizedKeysViewResponse
*/
function linuxGetAuthorizedKeysViewExample($service, $project, $zone, $user, $instance, $optParams)
{
	try
	{
		...
		return $service->linux->GetAuthorizedKeysViewLinux($project, $zone, $user, $instance, $optParams);
	}
	catch (Exception $e)
	{
