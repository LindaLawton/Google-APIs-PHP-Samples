...
# Unoffical Google Play Game Services Publishing API Samples for PHP
...
These samples show how to access the [Google Play Game Services Publishing API](https://developers.google.com/games/services) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
