...
# UnOfficial Google Play Game Services Publishing API v1configuration Samples for PHP
...
These samples show how to access the [Google Play Game Services Publishing API v1configuration](https://developers.google.com/games/services) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
