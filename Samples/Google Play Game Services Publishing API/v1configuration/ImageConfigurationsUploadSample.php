...
// Single Request.
$results = imageConfigurationsUploadExample($service, $resourceId, $imageType, $optParams);
...
*/
function imageConfigurationsUploadExample($service, $resourceId, $imageType, $optParams)
{
	try
	{
		...
		return $service->imageConfigurations->UploadImageConfigurations($resourceId, $imageType, $optParams);
	}
	catch (Exception $e)
	{
