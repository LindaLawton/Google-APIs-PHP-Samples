...
print_r(imageConfigurationsUploadExample($service, $resourceId, $imageType));
...
* @return ImageConfiguration</returns>
*/
function imageConfigurationsUploadExample($service, $resourceId, $imageType)
{
	try
	{
		...
		return $service->imageConfigurations->UploadImageConfigurations($resourceId, $imageType);
	}
	catch (Exception $ex)
	{
