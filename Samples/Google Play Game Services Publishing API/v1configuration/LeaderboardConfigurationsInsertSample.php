...
print_r(leaderboardConfigurationsInsertExample($service, $applicationId));
...
*/
function leaderboardConfigurationsInsertExample($service, $applicationId)
{
	try
	{
		...
		return $service->leaderboardConfigurations->InsertLeaderboardConfigurations($applicationId);
	}
	catch (Exception $ex)
	{
