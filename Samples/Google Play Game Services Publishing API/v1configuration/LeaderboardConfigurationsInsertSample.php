...
// Single Request.
$results = leaderboardConfigurationsInsertExample($service, $applicationId, $optParams);
...
*/
function leaderboardConfigurationsInsertExample($service, $applicationId, $optParams)
{
	try
	{
		...
		return $service->leaderboardConfigurations->InsertLeaderboardConfigurations($applicationId, $optParams);
	}
	catch (Exception $e)
	{
