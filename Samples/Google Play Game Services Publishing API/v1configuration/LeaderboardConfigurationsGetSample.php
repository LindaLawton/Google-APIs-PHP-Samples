...
// Single Request.
$results = leaderboardConfigurationsGetExample($service, $leaderboardId, $optParams);
...
*/
function leaderboardConfigurationsGetExample($service, $leaderboardId, $optParams)
{
	try
	{
		...
		return $service->leaderboardConfigurations->GetLeaderboardConfigurations($leaderboardId, $optParams);
	}
	catch (Exception $e)
	{
