...
$results = leaderboardConfigurationsListExample($service, $applicationId, $optParams);
...
*/
function leaderboardConfigurationsListExample($service, $applicationId, $optParams)
{
	try
	{
		...
		return $service->leaderboardConfigurations->ListLeaderboardConfigurations($applicationId, $optParams);
	}
	catch (Exception $e)
	{
