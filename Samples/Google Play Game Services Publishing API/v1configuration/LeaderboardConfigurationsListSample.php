...
print_r(leaderboardConfigurationsListExample($service, $applicationId));
...
* @return LeaderboardConfigurationListResponse</returns>
*/
function leaderboardConfigurationsListExample($service, $applicationId)
{
	try
	{
		...
		return $service->leaderboardConfigurations->ListLeaderboardConfigurations($applicationId);
	}
	catch (Exception $ex)
	{
