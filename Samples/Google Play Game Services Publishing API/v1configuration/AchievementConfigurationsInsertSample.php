...
print_r(achievementConfigurationsInsertExample($service, $applicationId));
...
*/
function achievementConfigurationsInsertExample($service, $applicationId)
{
	try
	{
		...
		return $service->achievementConfigurations->InsertAchievementConfigurations($applicationId);
	}
	catch (Exception $ex)
	{
