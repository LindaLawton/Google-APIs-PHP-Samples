...
// Single Request.
$results = achievementConfigurationsInsertExample($service, $applicationId, $optParams);
...
*/
function achievementConfigurationsInsertExample($service, $applicationId, $optParams)
{
	try
	{
		...
		return $service->achievementConfigurations->InsertAchievementConfigurations($applicationId, $optParams);
	}
	catch (Exception $e)
	{
