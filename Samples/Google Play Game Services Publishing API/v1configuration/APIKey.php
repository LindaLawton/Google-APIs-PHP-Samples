 ...
 * Initializes an Gamesconfiguration.v1configuration service object.
 * @param string API key
 * @return An authorized Gamesconfiguration.v1configuration service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Gamesconfiguration Sample");
		...
		// Create authenticated Gamesconfiguration service
		return new Google_Service_Gamesconfiguration($client);
	} catch (Exception $e) {
