...
*/
function achievementConfigurationsListExample($service, $applicationId, $optParams)
{
	try
	{
		...
		return $service->achievementConfigurations->ListAchievementConfigurations($applicationId, $optParams);
	}
	catch (Exception $e)
	{
