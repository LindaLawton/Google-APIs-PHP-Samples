...
print_r(achievementConfigurationsListExample($service, $applicationId));
...
* @return AchievementConfigurationListResponse</returns>
*/
function achievementConfigurationsListExample($service, $applicationId)
{
	try
	{
		...
		return $service->achievementConfigurations->ListAchievementConfigurations($applicationId);
	}
	catch (Exception $ex)
	{
