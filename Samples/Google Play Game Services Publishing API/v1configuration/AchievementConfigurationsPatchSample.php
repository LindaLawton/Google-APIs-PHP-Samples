...
// Single Request.
$results = achievementConfigurationsPatchExample($service, $achievementId, $optParams);
...
*/
function achievementConfigurationsPatchExample($service, $achievementId, $optParams)
{
	try
	{
		...
		return $service->achievementConfigurations->PatchAchievementConfigurations($achievementId, $optParams);
	}
	catch (Exception $e)
	{
