...
// Single Request.
$results = leaderboardConfigurationsPatchExample($service, $leaderboardId, $optParams);
...
*/
function leaderboardConfigurationsPatchExample($service, $leaderboardId, $optParams)
{
	try
	{
		...
		return $service->leaderboardConfigurations->PatchLeaderboardConfigurations($leaderboardId, $optParams);
	}
	catch (Exception $e)
	{
