...
print_r(leaderboardConfigurationsPatchExample($service, $leaderboardId));
...
*/
function leaderboardConfigurationsPatchExample($service, $leaderboardId)
{
	try
	{
		...
		return $service->leaderboardConfigurations->PatchLeaderboardConfigurations($leaderboardId);
	}
	catch (Exception $ex)
	{
