...
print_r(ordersCustombatchExample($service));
...
* @return OrdersCustomBatchResponse</returns>
*/
function ordersCustombatchExample($service)
{
	try
	{
		...
		return $service->orders->CustombatchOrders();
	}
	catch (Exception $ex)
	{
