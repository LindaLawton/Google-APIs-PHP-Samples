...
print_r(ordersShiplineitemsExample($service, $merchantId, $orderId));
...
* @return OrdersShipLineItemsResponse</returns>
*/
function ordersShiplineitemsExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->ShiplineitemsOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
