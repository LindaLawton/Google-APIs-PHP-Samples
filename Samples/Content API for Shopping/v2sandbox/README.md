...
# UnOfficial Content API for Shopping v2sandbox Samples for PHP

## API Description

Manages product items, inventory, and Merchant Center accounts for Google Shopping.

[Official Documentation](https://developers.google.com/shopping-content)

## Sample Description

These samples show how to access the [Content API for Shopping v2sandbox](https://developers.google.com/shopping-content) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
