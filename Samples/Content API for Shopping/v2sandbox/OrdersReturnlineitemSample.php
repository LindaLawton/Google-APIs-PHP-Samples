...
print_r(ordersReturnlineitemExample($service, $merchantId, $orderId));
...
* @return OrdersReturnLineItemResponse</returns>
*/
function ordersReturnlineitemExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->ReturnlineitemOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
