...
print_r(ordersListExample($service, $merchantId));
...
* @return OrdersListResponse</returns>
*/
function ordersListExample($service, $merchantId)
{
	try
	{
		...
		return $service->orders->ListOrders($merchantId);
	}
	catch (Exception $ex)
	{
