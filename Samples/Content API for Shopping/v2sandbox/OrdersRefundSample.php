...
print_r(ordersRefundExample($service, $merchantId, $orderId));
...
* @return OrdersRefundResponse</returns>
*/
function ordersRefundExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->RefundOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
