...
print_r(ordersGettestordertemplateExample($service, $merchantId, $templateName));
...
* @return OrdersGetTestOrderTemplateResponse</returns>
*/
function ordersGettestordertemplateExample($service, $merchantId, $templateName)
{
	try
	{
		...
		return $service->orders->GettestordertemplateOrders($merchantId, $templateName);
	}
	catch (Exception $ex)
	{
