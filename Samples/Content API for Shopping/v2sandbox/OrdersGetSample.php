...
$results = ordersGetExample($service, $merchantId, $orderId, $optParams);
...
* @return Order
*/
function ordersGetExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->GetOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
