...
print_r(getbymerchantorderid($service, $merchantId, $merchantOrderId));
...
*/
function getbymerchantorderid($service, $merchantId, $merchantOrderId)
{
	try
	{
		...
		return $service->getbymerchantorderid($merchantId, $merchantOrderId);
	}
	catch (Exception $ex)
	{
