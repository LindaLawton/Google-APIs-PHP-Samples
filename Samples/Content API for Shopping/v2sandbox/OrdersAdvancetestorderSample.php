...
print_r(advancetestorder($service, $merchantId, $orderId));
...
*/
function advancetestorder($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->advancetestorder($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
