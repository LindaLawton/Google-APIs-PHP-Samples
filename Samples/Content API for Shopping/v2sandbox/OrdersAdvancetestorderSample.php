...
// Single Request.
$results = ordersAdvancetestorderExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersAdvancetestorderExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->AdvancetestorderOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
