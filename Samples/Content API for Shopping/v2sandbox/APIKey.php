...
// About 
// 
// Unofficial sample for the Shoppingcontent v2sandbox API for PHP. 
 ...
 * Initializes an Shoppingcontent.v2sandbox service object.
 * @param string API key
 * @return An authorized Shoppingcontent.v2sandbox service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Shoppingcontent Sample");
		...
		// Create authenticated Shoppingcontent service
