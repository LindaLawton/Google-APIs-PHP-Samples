...
// Single Request.
$results = ordersCancelExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersCancelExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->CancelOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
