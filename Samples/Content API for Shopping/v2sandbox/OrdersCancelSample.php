...
print_r(ordersCancelExample($service, $merchantId, $orderId));
...
* @return OrdersCancelResponse</returns>
*/
function ordersCancelExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->CancelOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
