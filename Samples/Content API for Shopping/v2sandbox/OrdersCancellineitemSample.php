...
print_r(ordersCancellineitemExample($service, $merchantId, $orderId));
...
* @return OrdersCancelLineItemResponse</returns>
*/
function ordersCancellineitemExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->CancellineitemOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
