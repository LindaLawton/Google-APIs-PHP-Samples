...
// Single Request.
$results = ordersCancellineitemExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersCancellineitemExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->CancellineitemOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
