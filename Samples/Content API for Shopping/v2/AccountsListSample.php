...
print_r(accountsListExample($service, $merchantId));
...
* @return AccountsListResponse</returns>
*/
function accountsListExample($service, $merchantId)
{
	try
	{
		...
		return $service->accounts->ListAccounts($merchantId);
	}
	catch (Exception $ex)
	{
