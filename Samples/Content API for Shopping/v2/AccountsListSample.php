...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of accounts to return in the response, used for paging.
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = accountsListExample($service, $merchantId, $optParams);
...
*/
function accountsListExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->accounts->ListAccounts($merchantId, $optParams);
	}
	catch (Exception $e)
	{
