...
// Single Request.
$results = accountsInsertExample($service, $merchantId, $optParams);
...
* @return Account
*/
function accountsInsertExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->accounts->InsertAccounts($merchantId, $optParams);
	}
	catch (Exception $e)
	{
