...
$results = datafeedstatusesListExample($service, $merchantId, $optParams);
...
*/
function datafeedstatusesListExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->datafeedstatuses->ListDatafeedstatuses($merchantId, $optParams);
	}
	catch (Exception $e)
	{
