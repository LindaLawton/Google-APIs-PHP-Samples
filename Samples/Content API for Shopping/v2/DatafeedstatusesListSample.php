...
print_r(datafeedstatusesListExample($service, $merchantId));
...
* @return DatafeedstatusesListResponse</returns>
*/
function datafeedstatusesListExample($service, $merchantId)
{
	try
	{
		...
		return $service->datafeedstatuses->ListDatafeedstatuses($merchantId);
	}
	catch (Exception $ex)
	{
