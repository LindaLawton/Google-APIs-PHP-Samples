...
print_r(shippingsettingsListExample($service, $merchantId));
...
* @return ShippingsettingsListResponse</returns>
*/
function shippingsettingsListExample($service, $merchantId)
{
	try
	{
		...
		return $service->shippingsettings->ListShippingsettings($merchantId);
	}
	catch (Exception $ex)
	{
