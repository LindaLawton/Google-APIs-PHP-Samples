...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  //The maximum number of shipping settings to return in the response, used for paging.
            
  //'pageToken' => '[YourValue]',  //The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = shippingsettingsListExample($service, $merchantId, $optParams);
...
*/
function shippingsettingsListExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->shippingsettings->ListShippingsettings($merchantId, $optParams);
	}
	catch (Exception $e)
	{
