...
$results = shippingsettingsGetExample($service, $merchantId, $accountId, $optParams);
...
*/
function shippingsettingsGetExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->shippingsettings->GetShippingsettings($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
