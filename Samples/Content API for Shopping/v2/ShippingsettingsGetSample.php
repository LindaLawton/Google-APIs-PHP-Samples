...
print_r(shippingsettingsGetExample($service, $merchantId, $accountId));
...
*/
function shippingsettingsGetExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->shippingsettings->GetShippingsettings($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
