...
print_r(productsDeleteExample($service, $merchantId, $productId));
...
*/
function productsDeleteExample($service, $merchantId, $productId)
{
	try
	{
		...
		return $service->products->DeleteProducts($merchantId, $productId);
	}
	catch (Exception $ex)
	{
