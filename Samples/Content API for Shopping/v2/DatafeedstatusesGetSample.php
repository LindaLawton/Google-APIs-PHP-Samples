...
print_r(datafeedstatusesGetExample($service, $merchantId, $datafeedId));
...
* @datafeedId 
* @merchantId 
* @return DatafeedStatus</returns>
*/
function datafeedstatusesGetExample($service, $merchantId, $datafeedId)
{
	try
	{
		...
		return $service->datafeedstatuses->GetDatafeedstatuses($merchantId, $datafeedId);
	}
	catch (Exception $ex)
	{
