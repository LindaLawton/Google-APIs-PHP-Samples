...
print_r(ordersAcknowledgeExample($service, $merchantId, $orderId));
...
* @return OrdersAcknowledgeResponse</returns>
*/
function ordersAcknowledgeExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->AcknowledgeOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
