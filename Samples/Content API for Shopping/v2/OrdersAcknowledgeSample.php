...
// Single Request.
$results = ordersAcknowledgeExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersAcknowledgeExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->AcknowledgeOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
