...
// Single Request.
$results = accounttaxPatchExample($service, $merchantId, $accountId, $optParams);
...
* @return AccountTax
*/
function accounttaxPatchExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounttax->PatchAccounttax($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
