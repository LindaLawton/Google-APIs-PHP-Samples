...
print_r(accounttaxPatchExample($service, $merchantId, $accountId));
...
*/
function accounttaxPatchExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounttax->PatchAccounttax($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
