...
print_r(accountsAuthinfoExample($service));

/**
* Returns information about the authenticated user.
* @service Authenticated Shoppingcontent service.
* @return AccountsAuthInfoResponse</returns>
*/
function accountsAuthinfoExample($service)
{
	try
	{
		...
		return $service->accounts->AuthinfoAccounts();
	}
	catch (Exception $ex)
	{
