...
print_r(shippingsettingsGetsupportedcarriersExample($service, $merchantId));
...
* @return ShippingsettingsGetSupportedCarriersResponse</returns>
*/
function shippingsettingsGetsupportedcarriersExample($service, $merchantId)
{
	try
	{
		...
		return $service->shippingsettings->GetsupportedcarriersShippingsettings($merchantId);
	}
	catch (Exception $ex)
	{
