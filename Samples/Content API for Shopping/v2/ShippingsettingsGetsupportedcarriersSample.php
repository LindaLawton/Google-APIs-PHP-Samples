...
// Single Request.
$results = shippingsettingsGetsupportedcarriersExample($service, $merchantId, $optParams);
...
*/
function shippingsettingsGetsupportedcarriersExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->shippingsettings->GetsupportedcarriersShippingsettings($merchantId, $optParams);
	}
	catch (Exception $e)
	{
