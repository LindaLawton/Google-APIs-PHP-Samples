...
print_r(datafeedsDeleteExample($service, $merchantId, $datafeedId));
...
*/
function datafeedsDeleteExample($service, $merchantId, $datafeedId)
{
	try
	{
		...
		return $service->datafeeds->DeleteDatafeeds($merchantId, $datafeedId);
	}
	catch (Exception $ex)
	{
