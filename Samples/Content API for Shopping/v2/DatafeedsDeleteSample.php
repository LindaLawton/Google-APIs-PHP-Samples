...
$results = datafeedsDeleteExample($service, $merchantId, $datafeedId, $optParams);
...
*/
function datafeedsDeleteExample($service, $merchantId, $datafeedId, $optParams)
{
	try
	{
		...
		return $service->datafeeds->DeleteDatafeeds($merchantId, $datafeedId, $optParams);
	}
	catch (Exception $e)
	{
