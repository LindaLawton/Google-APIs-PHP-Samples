...
print_r(datafeedsPatchExample($service, $merchantId, $datafeedId));
...
*/
function datafeedsPatchExample($service, $merchantId, $datafeedId)
{
	try
	{
		...
		return $service->datafeeds->PatchDatafeeds($merchantId, $datafeedId);
	}
	catch (Exception $ex)
	{
