...
// Single Request.
$results = datafeedsPatchExample($service, $merchantId, $datafeedId, $optParams);
...
* @return Datafeed
*/
function datafeedsPatchExample($service, $merchantId, $datafeedId, $optParams)
{
	try
	{
		...
		return $service->datafeeds->PatchDatafeeds($merchantId, $datafeedId, $optParams);
	}
	catch (Exception $e)
	{
