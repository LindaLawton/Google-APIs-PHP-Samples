...
print_r(accountsDeleteExample($service, $merchantId, $accountId));
...
*/
function accountsDeleteExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounts->DeleteAccounts($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
