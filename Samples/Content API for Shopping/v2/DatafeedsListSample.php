...
print_r(datafeedsListExample($service, $merchantId));
...
* @return DatafeedsListResponse</returns>
*/
function datafeedsListExample($service, $merchantId)
{
	try
	{
		...
		return $service->datafeeds->ListDatafeeds($merchantId);
	}
	catch (Exception $ex)
	{
