...
// Single Request.
$results = ordersReturnlineitemExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersReturnlineitemExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->ReturnlineitemOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
