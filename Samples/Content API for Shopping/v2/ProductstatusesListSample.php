...
print_r(productstatusesListExample($service, $merchantId));
...
* @return ProductstatusesListResponse</returns>
*/
function productstatusesListExample($service, $merchantId)
{
	try
	{
		...
		return $service->productstatuses->ListProductstatuses($merchantId);
	}
	catch (Exception $ex)
	{
