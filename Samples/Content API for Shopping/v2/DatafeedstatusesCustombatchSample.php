...
// Single Request.
$results = datafeedstatusesCustombatchExample($service, $optParams);
...
*/
function datafeedstatusesCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->datafeedstatuses->CustombatchDatafeedstatuses($optParams);
	}
	catch (Exception $e)
	{
