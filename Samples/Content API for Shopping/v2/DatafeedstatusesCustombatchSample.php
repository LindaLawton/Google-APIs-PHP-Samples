...
print_r(datafeedstatusesCustombatchExample($service));

/**
* 
* @service Authenticated Shoppingcontent service.
* @return DatafeedstatusesCustomBatchResponse</returns>
*/
function datafeedstatusesCustombatchExample($service)
{
	try
	{
		...
		return $service->datafeedstatuses->CustombatchDatafeedstatuses();
	}
	catch (Exception $ex)
	{
