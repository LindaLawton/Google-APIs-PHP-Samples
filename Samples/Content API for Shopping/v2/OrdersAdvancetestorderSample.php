...
print_r(ordersAdvancetestorderExample($service, $merchantId, $orderId));
...
* @return OrdersAdvanceTestOrderResponse</returns>
*/
function ordersAdvancetestorderExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->AdvancetestorderOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
