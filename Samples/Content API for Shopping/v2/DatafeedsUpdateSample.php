...
print_r(datafeedsUpdateExample($service, $merchantId, $datafeedId));
...
* @datafeedId 
* @merchantId 
* @return Datafeed</returns>
*/
function datafeedsUpdateExample($service, $merchantId, $datafeedId)
{
	try
	{
		...
		return $service->datafeeds->UpdateDatafeeds($merchantId, $datafeedId);
	}
	catch (Exception $ex)
	{
