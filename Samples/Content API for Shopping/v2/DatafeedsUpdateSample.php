...
// Single Request.
$results = datafeedsUpdateExample($service, $merchantId, $datafeedId, $optParams);
...
* @return Datafeed
*/
function datafeedsUpdateExample($service, $merchantId, $datafeedId, $optParams)
{
	try
	{
		...
		return $service->datafeeds->UpdateDatafeeds($merchantId, $datafeedId, $optParams);
	}
	catch (Exception $e)
	{
