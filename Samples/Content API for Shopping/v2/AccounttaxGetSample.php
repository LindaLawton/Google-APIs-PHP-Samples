...
// Single Request.
$results = accounttaxGetExample($service, $merchantId, $accountId, $optParams);
...
* @return AccountTax
*/
function accounttaxGetExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounttax->GetAccounttax($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
