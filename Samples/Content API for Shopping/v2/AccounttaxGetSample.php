...
print_r(accounttaxGetExample($service, $merchantId, $accountId));
...
*/
function accounttaxGetExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounttax->GetAccounttax($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
