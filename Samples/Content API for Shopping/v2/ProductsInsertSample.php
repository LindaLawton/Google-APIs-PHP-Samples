...
// Single Request.
$results = productsInsertExample($service, $merchantId, $optParams);
...
* @return Product
*/
function productsInsertExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->products->InsertProducts($merchantId, $optParams);
	}
	catch (Exception $e)
	{
