...
print_r(ordersCreatetestorderExample($service, $merchantId));
...
* @return OrdersCreateTestOrderResponse</returns>
*/
function ordersCreatetestorderExample($service, $merchantId)
{
	try
	{
		...
		return $service->orders->CreatetestorderOrders($merchantId);
	}
	catch (Exception $ex)
	{
