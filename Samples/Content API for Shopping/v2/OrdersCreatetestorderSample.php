...
// Single Request.
$results = ordersCreatetestorderExample($service, $merchantId, $optParams);
...
*/
function ordersCreatetestorderExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->orders->CreatetestorderOrders($merchantId, $optParams);
	}
	catch (Exception $e)
	{
