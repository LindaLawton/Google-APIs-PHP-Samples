...
print_r(accountsPatchExample($service, $merchantId, $accountId));
...
*/
function accountsPatchExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounts->PatchAccounts($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
