...
$results = accountsPatchExample($service, $merchantId, $accountId, $optParams);
...
* @return Account
*/
function accountsPatchExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounts->PatchAccounts($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
