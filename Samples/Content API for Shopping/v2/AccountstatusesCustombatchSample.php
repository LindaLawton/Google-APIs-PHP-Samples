...
// Single Request.
$results = accountstatusesCustombatchExample($service, $optParams);
...
*/
function accountstatusesCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->accountstatuses->CustombatchAccountstatuses($optParams);
	}
	catch (Exception $e)
	{
