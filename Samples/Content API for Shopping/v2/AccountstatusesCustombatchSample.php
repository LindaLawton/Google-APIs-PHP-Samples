...
print_r(accountstatusesCustombatchExample($service));

/**
* 
* @service Authenticated Shoppingcontent service.
* @return AccountstatusesCustomBatchResponse</returns>
*/
function accountstatusesCustombatchExample($service)
{
	try
	{
		...
		return $service->accountstatuses->CustombatchAccountstatuses();
	}
	catch (Exception $ex)
	{
