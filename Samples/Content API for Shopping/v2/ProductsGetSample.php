...
print_r(productsGetExample($service, $merchantId, $productId));
...
*/
function productsGetExample($service, $merchantId, $productId)
{
	try
	{
		...
		return $service->products->GetProducts($merchantId, $productId);
	}
	catch (Exception $ex)
	{
