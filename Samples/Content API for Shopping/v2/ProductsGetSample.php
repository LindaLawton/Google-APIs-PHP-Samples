...
// Single Request.
$results = productsGetExample($service, $merchantId, $productId, $optParams);
...
* @return Product
*/
function productsGetExample($service, $merchantId, $productId, $optParams)
{
	try
	{
		...
		return $service->products->GetProducts($merchantId, $productId, $optParams);
	}
	catch (Exception $e)
	{
