...
print_r(datafeedsInsertExample($service, $merchantId));
...
*/
function datafeedsInsertExample($service, $merchantId)
{
	try
	{
		...
		return $service->datafeeds->InsertDatafeeds($merchantId);
	}
	catch (Exception $ex)
	{
