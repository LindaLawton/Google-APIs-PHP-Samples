...
$results = datafeedsInsertExample($service, $merchantId, $optParams);
...
* @return Datafeed
*/
function datafeedsInsertExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->datafeeds->InsertDatafeeds($merchantId, $optParams);
	}
	catch (Exception $e)
	{
