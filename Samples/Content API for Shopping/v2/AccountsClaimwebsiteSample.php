...
print_r(accountsClaimwebsiteExample($service, $merchantId, $accountId));
...
* @return AccountsClaimWebsiteResponse</returns>
*/
function accountsClaimwebsiteExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounts->ClaimwebsiteAccounts($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
