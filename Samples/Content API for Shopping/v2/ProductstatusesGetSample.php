...
*/
function productstatusesGetExample($service, $merchantId, $productId, $optParams)
{
	try
	{
		...
		return $service->productstatuses->GetProductstatuses($merchantId, $productId, $optParams);
	}
	catch (Exception $e)
	{
