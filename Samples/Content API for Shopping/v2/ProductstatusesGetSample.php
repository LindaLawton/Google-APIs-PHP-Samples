...
print_r(productstatusesGetExample($service, $merchantId, $productId));
...
* @return ProductStatus</returns>
*/
function productstatusesGetExample($service, $merchantId, $productId)
{
	try
	{
		...
		return $service->productstatuses->GetProductstatuses($merchantId, $productId);
	}
	catch (Exception $ex)
	{
