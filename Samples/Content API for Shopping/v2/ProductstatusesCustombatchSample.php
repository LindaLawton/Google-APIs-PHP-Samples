...
print_r(productstatusesCustombatchExample($service));
...
* @return ProductstatusesCustomBatchResponse</returns>
*/
function productstatusesCustombatchExample($service)
{
	try
	{
		...
		return $service->productstatuses->CustombatchProductstatuses();
	}
	catch (Exception $ex)
	{
