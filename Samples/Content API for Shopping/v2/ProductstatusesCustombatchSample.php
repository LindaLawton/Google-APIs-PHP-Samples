...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeAttributes' => '[YourValue]',  // Flag to include full product data in the results of this request. The default value is false.
  'fields' => '*'
);
// Single Request.
$results = productstatusesCustombatchExample($service, $optParams);
...
*/
function productstatusesCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->productstatuses->CustombatchProductstatuses($optParams);
	}
	catch (Exception $e)
	{
