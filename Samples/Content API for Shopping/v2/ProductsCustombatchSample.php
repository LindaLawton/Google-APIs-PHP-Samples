...
// Single Request.
$results = productsCustombatchExample($service, $optParams);
...
*/
function productsCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->products->CustombatchProducts($optParams);
	}
	catch (Exception $e)
	{
