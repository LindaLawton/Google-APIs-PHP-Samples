...
print_r(productsCustombatchExample($service));
...
* @return ProductsCustomBatchResponse</returns>
*/
function productsCustombatchExample($service)
{
	try
	{
		...
		return $service->products->CustombatchProducts();
	}
	catch (Exception $ex)
	{
