...
print_r(datafeedsGetExample($service, $merchantId, $datafeedId));
...
*/
function datafeedsGetExample($service, $merchantId, $datafeedId)
{
	try
	{
		...
		return $service->datafeeds->GetDatafeeds($merchantId, $datafeedId);
	}
	catch (Exception $ex)
	{
