...
// Single Request.
$results = datafeedsGetExample($service, $merchantId, $datafeedId, $optParams);
...
* @return Datafeed
*/
function datafeedsGetExample($service, $merchantId, $datafeedId, $optParams)
{
	try
	{
		...
		return $service->datafeeds->GetDatafeeds($merchantId, $datafeedId, $optParams);
	}
	catch (Exception $e)
	{
