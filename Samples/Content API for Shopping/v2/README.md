...
# UnOfficial Content API for Shopping v2 Samples for PHP
...
These samples show how to access the [Content API for Shopping v2](https://developers.google.com/shopping-content) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
