...
print_r(shippingsettingsPatchExample($service, $merchantId, $accountId));
...
*/
function shippingsettingsPatchExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->shippingsettings->PatchShippingsettings($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
