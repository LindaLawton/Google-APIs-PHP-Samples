...
$results = shippingsettingsPatchExample($service, $merchantId, $accountId, $optParams);
...
*/
function shippingsettingsPatchExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->shippingsettings->PatchShippingsettings($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
