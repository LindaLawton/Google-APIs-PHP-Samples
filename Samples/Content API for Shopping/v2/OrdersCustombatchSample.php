...
$results = ordersCustombatchExample($service, $optParams);
...
*/
function ordersCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->orders->CustombatchOrders($optParams);
	}
	catch (Exception $e)
	{
