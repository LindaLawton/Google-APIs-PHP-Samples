...
$results = datafeedsCustombatchExample($service, $optParams);
...
*/
function datafeedsCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->datafeeds->CustombatchDatafeeds($optParams);
	}
	catch (Exception $e)
	{
