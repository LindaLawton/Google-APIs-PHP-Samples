...
print_r(datafeedsCustombatchExample($service));

/**
* 
* @service Authenticated Shoppingcontent service.
* @return DatafeedsCustomBatchResponse</returns>
*/
function datafeedsCustombatchExample($service)
{
	try
	{
		...
		return $service->datafeeds->CustombatchDatafeeds();
	}
	catch (Exception $ex)
	{
