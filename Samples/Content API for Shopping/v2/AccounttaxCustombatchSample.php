...
print_r(accounttaxCustombatchExample($service));

/**
* Retrieves and updates tax settings of multiple accounts in a single request.
* @service Authenticated Shoppingcontent service.
* @return AccounttaxCustomBatchResponse</returns>
*/
function accounttaxCustombatchExample($service)
{
	try
	{
		...
		return $service->accounttax->CustombatchAccounttax();
	}
	catch (Exception $ex)
	{
