...
// Single Request.
$results = accounttaxCustombatchExample($service, $optParams);
...
*/
function accounttaxCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->accounttax->CustombatchAccounttax($optParams);
	}
	catch (Exception $e)
	{
