...
print_r(accountstatusesListExample($service, $merchantId));
...
* @return AccountstatusesListResponse</returns>
*/
function accountstatusesListExample($service, $merchantId)
{
	try
	{
		...
		return $service->accountstatuses->ListAccountstatuses($merchantId);
	}
	catch (Exception $ex)
	{
