...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  //The maximum number of account statuses to return in the response, used for paging.
            
  //'pageToken' => '[YourValue]',  //The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = accountstatusesListExample($service, $merchantId, $optParams);
...
*/
function accountstatusesListExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->accountstatuses->ListAccountstatuses($merchantId, $optParams);
	}
	catch (Exception $e)
	{
