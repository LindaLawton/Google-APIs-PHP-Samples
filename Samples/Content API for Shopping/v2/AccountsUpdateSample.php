...
// Single Request.
$results = accountsUpdateExample($service, $merchantId, $accountId, $optParams);
...
* @return Account
*/
function accountsUpdateExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounts->UpdateAccounts($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
