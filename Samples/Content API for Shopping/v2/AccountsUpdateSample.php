...
print_r(accountsUpdateExample($service, $merchantId, $accountId));
...
*/
function accountsUpdateExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounts->UpdateAccounts($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
