...
// Single Request.
$results = shippingsettingsUpdateExample($service, $merchantId, $accountId, $optParams);
...
*/
function shippingsettingsUpdateExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->shippingsettings->UpdateShippingsettings($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
