...
print_r(shippingsettingsUpdateExample($service, $merchantId, $accountId));
...
* @return ShippingSettings</returns>
*/
function shippingsettingsUpdateExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->shippingsettings->UpdateShippingsettings($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
