...
print_r(accountsGetExample($service, $merchantId, $accountId));
...
*/
function accountsGetExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounts->GetAccounts($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
