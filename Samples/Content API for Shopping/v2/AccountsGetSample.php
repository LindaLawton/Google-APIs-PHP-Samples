...
$results = accountsGetExample($service, $merchantId, $accountId, $optParams);
...
* @return Account
*/
function accountsGetExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounts->GetAccounts($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
