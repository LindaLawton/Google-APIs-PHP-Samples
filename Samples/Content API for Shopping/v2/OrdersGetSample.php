...
print_r(ordersGetExample($service, $merchantId, $orderId));
...
*/
function ordersGetExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->GetOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
