...
print_r(ordersGetbymerchantorderidExample($service, $merchantId, $merchantOrderId));
...
* @return OrdersGetByMerchantOrderIdResponse</returns>
*/
function ordersGetbymerchantorderidExample($service, $merchantId, $merchantOrderId)
{
	try
	{
		...
		if (merchantOrderId == null)
			throw new Exception("merchantOrderId is required.");
		// Make the request and return the results.
		return $service->orders->GetbymerchantorderidOrders($merchantId, $merchantOrderId);
	}
	catch (Exception $ex)
	{
