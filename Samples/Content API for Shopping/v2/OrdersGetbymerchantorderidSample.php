...
// Single Request.
$results = ordersGetbymerchantorderidExample($service, $merchantId, $merchantOrderId, $optParams);
...
*/
function ordersGetbymerchantorderidExample($service, $merchantId, $merchantOrderId, $optParams)
{
	try
	{
		...
		return $service->orders->GetbymerchantorderidOrders($merchantId, $merchantOrderId, $optParams);
	}
	catch (Exception $e)
	{
