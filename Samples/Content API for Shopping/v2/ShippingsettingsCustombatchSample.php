...
print_r(shippingsettingsCustombatchExample($service));

/**
* Retrieves and updates the shipping settings of multiple accounts in a single request.
* @service Authenticated Shoppingcontent service.
* @return ShippingsettingsCustomBatchResponse</returns>
*/
function shippingsettingsCustombatchExample($service)
{
	try
	{
		...
		return $service->shippingsettings->CustombatchShippingsettings();
	}
	catch (Exception $ex)
	{
