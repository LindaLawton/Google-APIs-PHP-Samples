...
$results = shippingsettingsCustombatchExample($service, $optParams);
...
*/
function shippingsettingsCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->shippingsettings->CustombatchShippingsettings($optParams);
	}
	catch (Exception $e)
	{
