...
print_r(ordersUpdatemerchantorderidExample($service, $merchantId, $orderId));
...
* @return OrdersUpdateMerchantOrderIdResponse</returns>
*/
function ordersUpdatemerchantorderidExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->UpdatemerchantorderidOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
