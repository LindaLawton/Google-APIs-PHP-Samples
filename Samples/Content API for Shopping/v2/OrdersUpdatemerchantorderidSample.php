...
print_r(updatemerchantorderid($service, $merchantId, $orderId));
...
*/
function updatemerchantorderid($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->updatemerchantorderid($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
