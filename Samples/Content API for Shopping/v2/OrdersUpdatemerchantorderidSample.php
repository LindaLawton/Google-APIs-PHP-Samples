...
// Single Request.
$results = ordersUpdatemerchantorderidExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersUpdatemerchantorderidExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->UpdatemerchantorderidOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
