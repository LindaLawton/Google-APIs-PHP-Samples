...
print_r(accounttaxUpdateExample($service, $merchantId, $accountId));
...
* @return AccountTax</returns>
*/
function accounttaxUpdateExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accounttax->UpdateAccounttax($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
