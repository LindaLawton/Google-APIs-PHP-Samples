...
$results = accounttaxUpdateExample($service, $merchantId, $accountId, $optParams);
...
* @return AccountTax
*/
function accounttaxUpdateExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounttax->UpdateAccounttax($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
