...
// Single Request.
$results = ordersShiplineitemsExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersShiplineitemsExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->ShiplineitemsOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
