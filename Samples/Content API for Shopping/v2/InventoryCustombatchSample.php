...
// Single Request.
$results = inventoryCustombatchExample($service, $optParams);
...
* @return InventoryCustomBatchResponse
*/
function inventoryCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->inventory->CustombatchInventory($optParams);
	}
	catch (Exception $e)
	{
