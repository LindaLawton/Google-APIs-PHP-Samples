...
print_r(inventoryCustombatchExample($service));
...
* @return InventoryCustomBatchResponse</returns>
*/
function inventoryCustombatchExample($service)
{
	try
	{
		...
		return $service->inventory->CustombatchInventory();
	}
	catch (Exception $ex)
	{
