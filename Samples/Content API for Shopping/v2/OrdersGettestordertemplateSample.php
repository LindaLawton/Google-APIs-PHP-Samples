...
print_r(gettestordertemplate($service, $merchantId, $templateName));
...
*/
function gettestordertemplate($service, $merchantId, $templateName)
{
	try
	{
		...
		return $service->gettestordertemplate($merchantId, $templateName);
	}
	catch (Exception $ex)
	{
