...
// Single Request.
$results = ordersGettestordertemplateExample($service, $merchantId, $templateName, $optParams);
...
*/
function ordersGettestordertemplateExample($service, $merchantId, $templateName, $optParams)
{
	try
	{
		...
		return $service->orders->GettestordertemplateOrders($merchantId, $templateName, $optParams);
	}
	catch (Exception $e)
	{
