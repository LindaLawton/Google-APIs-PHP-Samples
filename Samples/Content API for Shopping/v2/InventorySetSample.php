...
$results = inventorySetExample($service, $merchantId, $storeCode, $productId, $optParams);
...
*/
function inventorySetExample($service, $merchantId, $storeCode, $productId, $optParams)
{
	try
	{
		...
		return $service->inventory->SetInventory($merchantId, $storeCode, $productId, $optParams);
	}
	catch (Exception $e)
	{
