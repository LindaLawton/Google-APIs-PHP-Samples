...
print_r(set($service, $merchantId, $storeCode, $productId));
...
*/
function set($service, $merchantId, $storeCode, $productId)
{
	try
	{
		...
		return $service->set($merchantId, $storeCode, $productId);
	}
	catch (Exception $ex)
	{
