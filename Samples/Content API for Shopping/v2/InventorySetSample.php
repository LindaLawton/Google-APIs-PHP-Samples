...
print_r(inventorySetExample($service, $merchantId, $storeCode, $productId));
...
* @return InventorySetResponse</returns>
*/
function inventorySetExample($service, $merchantId, $storeCode, $productId)
{
	try
	{
		...
		if (storeCode == null)
			throw new Exception("storeCode is required.");
		// Make the request and return the results.
		return $service->inventory->SetInventory($merchantId, $storeCode, $productId);
	}
	catch (Exception $ex)
	{
