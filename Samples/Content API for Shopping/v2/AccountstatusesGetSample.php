...
// Single Request.
$results = accountstatusesGetExample($service, $merchantId, $accountId, $optParams);
...
*/
function accountstatusesGetExample($service, $merchantId, $accountId, $optParams)
{
	try
	{
		...
		return $service->accountstatuses->GetAccountstatuses($merchantId, $accountId, $optParams);
	}
	catch (Exception $e)
	{
