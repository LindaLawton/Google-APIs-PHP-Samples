...
print_r(accountstatusesGetExample($service, $merchantId, $accountId));
...
* @return AccountStatus</returns>
*/
function accountstatusesGetExample($service, $merchantId, $accountId)
{
	try
	{
		...
		return $service->accountstatuses->GetAccountstatuses($merchantId, $accountId);
	}
	catch (Exception $ex)
	{
