...
// Single Request.
$results = ordersUpdateshipmentExample($service, $merchantId, $orderId, $optParams);
...
*/
function ordersUpdateshipmentExample($service, $merchantId, $orderId, $optParams)
{
	try
	{
		...
		return $service->orders->UpdateshipmentOrders($merchantId, $orderId, $optParams);
	}
	catch (Exception $e)
	{
