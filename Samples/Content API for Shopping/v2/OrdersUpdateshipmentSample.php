...
print_r(ordersUpdateshipmentExample($service, $merchantId, $orderId));
...
* @return OrdersUpdateShipmentResponse</returns>
*/
function ordersUpdateshipmentExample($service, $merchantId, $orderId)
{
	try
	{
		...
		return $service->orders->UpdateshipmentOrders($merchantId, $orderId);
	}
	catch (Exception $ex)
	{
