...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of tax settings to return in the response, used for paging.
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = accounttaxListExample($service, $merchantId, $optParams);
...
*/
function accounttaxListExample($service, $merchantId, $optParams)
{
	try
	{
		...
		return $service->accounttax->ListAccounttax($merchantId, $optParams);
	}
	catch (Exception $e)
	{
