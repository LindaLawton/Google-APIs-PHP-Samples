...
print_r(accounttaxListExample($service, $merchantId));
...
* @return AccounttaxListResponse</returns>
*/
function accounttaxListExample($service, $merchantId)
{
	try
	{
		...
		return $service->accounttax->ListAccounttax($merchantId);
	}
	catch (Exception $ex)
	{
