...
print_r(accountsCustombatchExample($service));

/**
* Retrieves, inserts, updates, and deletes multiple Merchant Center (sub-)accounts in a single request.
* @service Authenticated Shoppingcontent service.
* @return AccountsCustomBatchResponse</returns>
*/
function accountsCustombatchExample($service)
{
	try
	{
		...
		return $service->accounts->CustombatchAccounts();
	}
	catch (Exception $ex)
	{
