...
// Single Request.
$results = accountsCustombatchExample($service, $optParams);
...
*/
function accountsCustombatchExample($service, $optParams)
{
	try
	{
		...
		return $service->accounts->CustombatchAccounts($optParams);
	}
	catch (Exception $e)
	{
