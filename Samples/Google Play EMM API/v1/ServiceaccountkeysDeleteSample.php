...
print_r(serviceaccountkeysDeleteExample($service, $enterpriseId, $keyId));
...
*/
function serviceaccountkeysDeleteExample($service, $enterpriseId, $keyId)
{
	try
	{
		...
		return $service->serviceaccountkeys->DeleteServiceaccountkeys($enterpriseId, $keyId);
	}
	catch (Exception $ex)
	{
