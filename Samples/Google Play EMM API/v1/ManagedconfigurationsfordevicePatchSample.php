...
// Single Request.
$results = managedconfigurationsfordevicePatchExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams);
...
*/
function managedconfigurationsfordevicePatchExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->PatchManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams);
	}
	catch (Exception $e)
	{
