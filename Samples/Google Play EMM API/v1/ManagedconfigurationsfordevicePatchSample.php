...
print_r(managedconfigurationsfordevicePatchExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId));
...
*/
function managedconfigurationsfordevicePatchExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->PatchManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId);
	}
	catch (Exception $ex)
	{
