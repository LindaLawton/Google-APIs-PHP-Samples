...
// Single Request.
$results = enterprisesSetAndroidDevicePolicyConfigExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesSetAndroidDevicePolicyConfigExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->SetAndroidDevicePolicyConfigEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
