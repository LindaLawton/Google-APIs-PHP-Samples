...
print_r(enterprisesSetAndroidDevicePolicyConfigExample($service, $enterpriseId));
...
* @return AndroidDevicePolicyConfig</returns>
*/
function enterprisesSetAndroidDevicePolicyConfigExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->SetAndroidDevicePolicyConfigEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
