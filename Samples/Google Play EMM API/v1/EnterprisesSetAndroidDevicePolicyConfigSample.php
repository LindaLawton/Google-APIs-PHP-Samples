...
print_r(setAndroidDevicePolicyConfig($service, $enterpriseId));
...
*/
function setAndroidDevicePolicyConfig($service, $enterpriseId)
{
	try
	{
		...
		return $service->setAndroidDevicePolicyConfig($enterpriseId);
	}
	catch (Exception $ex)
	{
