...
print_r(permissionsGetExample($service, $permissionId));
...
*/
function permissionsGetExample($service, $permissionId)
{
	try
	{
		...
		return $service->permissions->GetPermissions($permissionId);
	}
	catch (Exception $ex)
	{
