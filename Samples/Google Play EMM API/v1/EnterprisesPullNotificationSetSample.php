...
print_r(enterprisesPullNotificationSetExample($service));
...
* @return NotificationSet</returns>
*/
function enterprisesPullNotificationSetExample($service)
{
	try
	{
		...
		return $service->enterprises->PullNotificationSetEnterprises();
	}
	catch (Exception $ex)
	{
