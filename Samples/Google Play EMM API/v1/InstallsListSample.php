...
$results = installsListExample($service, $enterpriseId, $userId, $deviceId, $optParams);
...
*/
function installsListExample($service, $enterpriseId, $userId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->installs->ListInstalls($enterpriseId, $userId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
