...
print_r(installsListExample($service, $enterpriseId, $userId, $deviceId));
...
* @return InstallsListResponse</returns>
*/
function installsListExample($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->installs->ListInstalls($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
