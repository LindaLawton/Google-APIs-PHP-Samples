...
print_r(storelayoutpagesUpdateExample($service, $enterpriseId, $pageId));
...
* @return StorePage</returns>
*/
function storelayoutpagesUpdateExample($service, $enterpriseId, $pageId)
{
	try
	{
		...
		return $service->storelayoutpages->UpdateStorelayoutpages($enterpriseId, $pageId);
	}
	catch (Exception $ex)
	{
