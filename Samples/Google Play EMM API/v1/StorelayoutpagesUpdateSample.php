...
// Single Request.
$results = storelayoutpagesUpdateExample($service, $enterpriseId, $pageId, $optParams);
...
* @return StorePage
*/
function storelayoutpagesUpdateExample($service, $enterpriseId, $pageId, $optParams)
{
	try
	{
		...
		return $service->storelayoutpages->UpdateStorelayoutpages($enterpriseId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
