...
print_r(storelayoutclustersDeleteExample($service, $enterpriseId, $pageId, $clusterId));
...
*/
function storelayoutclustersDeleteExample($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->storelayoutclusters->DeleteStorelayoutclusters($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
