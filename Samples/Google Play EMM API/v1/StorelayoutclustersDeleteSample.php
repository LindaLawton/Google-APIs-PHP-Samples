...
$results = storelayoutclustersDeleteExample($service, $enterpriseId, $pageId, $clusterId, $optParams);
...
*/
function storelayoutclustersDeleteExample($service, $enterpriseId, $pageId, $clusterId, $optParams)
{
	try
	{
		...
		return $service->storelayoutclusters->DeleteStorelayoutclusters($enterpriseId, $pageId, $clusterId, $optParams);
	}
	catch (Exception $e)
	{
