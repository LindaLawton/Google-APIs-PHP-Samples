...
print_r(delete($service, $enterpriseId, $pageId, $clusterId));
...
*/
function delete($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->delete($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
