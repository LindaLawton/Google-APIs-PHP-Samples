...
$results = storelayoutpagesDeleteExample($service, $enterpriseId, $pageId, $optParams);
...
*/
function storelayoutpagesDeleteExample($service, $enterpriseId, $pageId, $optParams)
{
	try
	{
		...
		return $service->storelayoutpages->DeleteStorelayoutpages($enterpriseId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
