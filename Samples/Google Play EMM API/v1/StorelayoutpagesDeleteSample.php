...
print_r(storelayoutpagesDeleteExample($service, $enterpriseId, $pageId));
...
*/
function storelayoutpagesDeleteExample($service, $enterpriseId, $pageId)
{
	try
	{
		...
		return $service->storelayoutpages->DeleteStorelayoutpages($enterpriseId, $pageId);
	}
	catch (Exception $ex)
	{
