...
print_r(storelayoutclustersGetExample($service, $enterpriseId, $pageId, $clusterId));
...
*/
function storelayoutclustersGetExample($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->storelayoutclusters->GetStorelayoutclusters($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
