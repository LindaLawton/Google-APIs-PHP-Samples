...
print_r(usersRevokeTokenExample($service, $enterpriseId, $userId));
...
*/
function usersRevokeTokenExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->RevokeTokenUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
