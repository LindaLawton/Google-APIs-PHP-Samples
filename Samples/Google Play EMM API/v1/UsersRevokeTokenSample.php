...
$results = usersRevokeTokenExample($service, $enterpriseId, $userId, $optParams);
...
*/
function usersRevokeTokenExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->RevokeTokenUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
