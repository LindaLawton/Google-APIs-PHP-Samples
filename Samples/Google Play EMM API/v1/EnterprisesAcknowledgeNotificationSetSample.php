...
print_r(enterprisesAcknowledgeNotificationSetExample($service));
...
*/
function enterprisesAcknowledgeNotificationSetExample($service)
{
	try
	{
		...
		return $service->enterprises->AcknowledgeNotificationSetEnterprises();
	}
	catch (Exception $ex)
	{
