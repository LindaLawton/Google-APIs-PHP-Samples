...
print_r(get($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function get($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->get($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
