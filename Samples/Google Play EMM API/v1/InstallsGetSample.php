...
// Single Request.
$results = installsGetExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams);
...
* @return Install
*/
function installsGetExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams)
{
	try
	{
		...
		return $service->installs->GetInstalls($enterpriseId, $userId, $deviceId, $installId, $optParams);
	}
	catch (Exception $e)
	{
