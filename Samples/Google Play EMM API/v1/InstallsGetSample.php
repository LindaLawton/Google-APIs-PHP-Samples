...
print_r(installsGetExample($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function installsGetExample($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->installs->GetInstalls($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
