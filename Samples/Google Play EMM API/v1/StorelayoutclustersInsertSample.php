...
// Single Request.
$results = storelayoutclustersInsertExample($service, $enterpriseId, $pageId, $optParams);
...
* @return StoreCluster
*/
function storelayoutclustersInsertExample($service, $enterpriseId, $pageId, $optParams)
{
	try
	{
		...
		return $service->storelayoutclusters->InsertStorelayoutclusters($enterpriseId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
