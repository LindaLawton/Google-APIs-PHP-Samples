...
print_r(storelayoutclustersInsertExample($service, $enterpriseId, $pageId));
...
*/
function storelayoutclustersInsertExample($service, $enterpriseId, $pageId)
{
	try
	{
		...
		return $service->storelayoutclusters->InsertStorelayoutclusters($enterpriseId, $pageId);
	}
	catch (Exception $ex)
	{
