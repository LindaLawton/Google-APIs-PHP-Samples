...
print_r(delete($service, $enterpriseId, $userId, $entitlementId));
...
*/
function delete($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->delete($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
