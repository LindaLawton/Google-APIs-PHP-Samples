...
print_r(entitlementsDeleteExample($service, $enterpriseId, $userId, $entitlementId));
...
*/
function entitlementsDeleteExample($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->entitlements->DeleteEntitlements($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
