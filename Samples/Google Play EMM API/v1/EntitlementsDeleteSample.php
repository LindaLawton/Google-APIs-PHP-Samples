...
$results = entitlementsDeleteExample($service, $enterpriseId, $userId, $entitlementId, $optParams);
...
*/
function entitlementsDeleteExample($service, $enterpriseId, $userId, $entitlementId, $optParams)
{
	try
	{
		...
		return $service->entitlements->DeleteEntitlements($enterpriseId, $userId, $entitlementId, $optParams);
	}
	catch (Exception $e)
	{
