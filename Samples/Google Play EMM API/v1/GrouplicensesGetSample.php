...
print_r(grouplicensesGetExample($service, $enterpriseId, $groupLicenseId));
...
* @return GroupLicense</returns>
*/
function grouplicensesGetExample($service, $enterpriseId, $groupLicenseId)
{
	try
	{
		...
		return $service->grouplicenses->GetGrouplicenses($enterpriseId, $groupLicenseId);
	}
	catch (Exception $ex)
	{
