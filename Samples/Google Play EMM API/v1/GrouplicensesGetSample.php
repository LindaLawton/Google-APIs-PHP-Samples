...
// Single Request.
$results = grouplicensesGetExample($service, $enterpriseId, $groupLicenseId, $optParams);
...
* @return GroupLicense
*/
function grouplicensesGetExample($service, $enterpriseId, $groupLicenseId, $optParams)
{
	try
	{
		...
		return $service->grouplicenses->GetGrouplicenses($enterpriseId, $groupLicenseId, $optParams);
	}
	catch (Exception $e)
	{
