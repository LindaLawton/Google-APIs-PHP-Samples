...
// Single Request.
$results = usersUpdateExample($service, $enterpriseId, $userId, $optParams);
...
* @return User
*/
function usersUpdateExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->UpdateUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
