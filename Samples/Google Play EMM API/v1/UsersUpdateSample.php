...
print_r(usersUpdateExample($service, $enterpriseId, $userId));
...
* @return User</returns>
*/
function usersUpdateExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->UpdateUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
