...
print_r(productsListExample($service, $enterpriseId));

/**
* Finds approved products that match a query, or all approved products if there is no query.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return ProductsListResponse</returns>
*/
function productsListExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->products->ListProducts($enterpriseId);
	}
	catch (Exception $ex)
	{
