...
// Single Request.
$results = usersGenerateAuthenticationTokenExample($service, $enterpriseId, $userId, $optParams);
...
*/
function usersGenerateAuthenticationTokenExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->GenerateAuthenticationTokenUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
