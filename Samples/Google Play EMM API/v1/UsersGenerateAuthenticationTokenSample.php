...
print_r(usersGenerateAuthenticationTokenExample($service, $enterpriseId, $userId));
...
* @return AuthenticationToken</returns>
*/
function usersGenerateAuthenticationTokenExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->GenerateAuthenticationTokenUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
