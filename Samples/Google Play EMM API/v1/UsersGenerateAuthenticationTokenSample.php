...
print_r(generateAuthenticationToken($service, $enterpriseId, $userId));
...
*/
function generateAuthenticationToken($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->generateAuthenticationToken($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
