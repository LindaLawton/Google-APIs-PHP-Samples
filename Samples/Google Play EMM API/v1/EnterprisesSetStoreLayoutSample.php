...
print_r(enterprisesSetStoreLayoutExample($service, $enterpriseId));
...
* @return StoreLayout</returns>
*/
function enterprisesSetStoreLayoutExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->SetStoreLayoutEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
