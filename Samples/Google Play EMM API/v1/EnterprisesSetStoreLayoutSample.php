...
$results = enterprisesSetStoreLayoutExample($service, $enterpriseId, $optParams);
...
* @return StoreLayout
*/
function enterprisesSetStoreLayoutExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->SetStoreLayoutEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
