...
print_r(enterprisesDeleteExample($service, $enterpriseId));
...
*/
function enterprisesDeleteExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->DeleteEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
