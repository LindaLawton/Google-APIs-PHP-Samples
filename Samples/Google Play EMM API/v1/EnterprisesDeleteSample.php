...
$results = enterprisesDeleteExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesDeleteExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->DeleteEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
