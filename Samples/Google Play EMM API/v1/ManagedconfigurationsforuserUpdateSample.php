...
print_r(managedconfigurationsforuserUpdateExample($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function managedconfigurationsforuserUpdateExample($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		if (managedConfigurationForUserId == null)
			throw new Exception("managedConfigurationForUserId is required.");
		if (userId == null)
			throw new Exception("userId is required.");
		// Make the request and return the results.
		return $service->managedconfigurationsforuser->UpdateManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
