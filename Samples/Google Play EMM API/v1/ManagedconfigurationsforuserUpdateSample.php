...
$results = managedconfigurationsforuserUpdateExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
...
*/
function managedconfigurationsforuserUpdateExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->UpdateManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
	}
	catch (Exception $e)
	{
