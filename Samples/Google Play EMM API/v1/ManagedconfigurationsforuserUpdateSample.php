...
print_r(update($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function update($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->update($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
