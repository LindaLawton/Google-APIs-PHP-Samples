...
print_r(storelayoutclustersUpdateExample($service, $enterpriseId, $pageId, $clusterId));
...
* @return StoreCluster</returns>
*/
function storelayoutclustersUpdateExample($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->storelayoutclusters->UpdateStorelayoutclusters($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
