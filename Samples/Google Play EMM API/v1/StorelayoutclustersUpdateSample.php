...
print_r(update($service, $enterpriseId, $pageId, $clusterId));
...
*/
function update($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->update($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
