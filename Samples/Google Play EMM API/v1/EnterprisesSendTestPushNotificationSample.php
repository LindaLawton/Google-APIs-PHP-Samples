...
// Single Request.
$results = enterprisesSendTestPushNotificationExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesSendTestPushNotificationExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->SendTestPushNotificationEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
