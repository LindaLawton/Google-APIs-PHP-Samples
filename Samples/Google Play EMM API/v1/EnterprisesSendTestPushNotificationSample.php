...
print_r(enterprisesSendTestPushNotificationExample($service, $enterpriseId));

/**
* Sends a test notification to validate the EMM integration with the Google Cloud Pub/Sub service for this enterprise.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return EnterprisesSendTestPushNotificationResponse</returns>
*/
function enterprisesSendTestPushNotificationExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->SendTestPushNotificationEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
