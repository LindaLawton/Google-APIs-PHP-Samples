...
print_r(sendTestPushNotification($service, $enterpriseId));
...
*/
function sendTestPushNotification($service, $enterpriseId)
{
	try
	{
		...
		return $service->sendTestPushNotification($enterpriseId);
	}
	catch (Exception $ex)
	{
