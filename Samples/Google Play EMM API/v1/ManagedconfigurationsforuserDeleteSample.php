...
print_r(delete($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function delete($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->delete($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
