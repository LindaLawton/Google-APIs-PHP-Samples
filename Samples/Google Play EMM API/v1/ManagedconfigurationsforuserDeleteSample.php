...
print_r(managedconfigurationsforuserDeleteExample($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function managedconfigurationsforuserDeleteExample($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->DeleteManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
