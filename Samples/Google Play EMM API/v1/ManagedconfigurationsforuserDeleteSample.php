...
$results = managedconfigurationsforuserDeleteExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
...
*/
function managedconfigurationsforuserDeleteExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->DeleteManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
	}
	catch (Exception $e)
	{
