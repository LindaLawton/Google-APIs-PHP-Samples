...
// Single Request.
$results = usersGenerateTokenExample($service, $enterpriseId, $userId, $optParams);
...
* @return UserToken
*/
function usersGenerateTokenExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->GenerateTokenUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
