...
print_r(usersGenerateTokenExample($service, $enterpriseId, $userId));
...
*/
function usersGenerateTokenExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->GenerateTokenUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
