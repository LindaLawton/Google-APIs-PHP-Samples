...
print_r(enterprisesGetServiceAccountExample($service, $enterpriseId));
...
* @return ServiceAccount</returns>
*/
function enterprisesGetServiceAccountExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->GetServiceAccountEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
