...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'keyType' => '[YourValue]',  // The type of credential to return with the service account. Required.
  'fields' => '*'
);
// Single Request.
$results = enterprisesGetServiceAccountExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesGetServiceAccountExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->GetServiceAccountEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
