...
print_r(patch($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function patch($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->patch($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
