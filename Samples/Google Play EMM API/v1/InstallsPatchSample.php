...
// Single Request.
$results = installsPatchExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams);
...
* @return Install
*/
function installsPatchExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams)
{
	try
	{
		...
		return $service->installs->PatchInstalls($enterpriseId, $userId, $deviceId, $installId, $optParams);
	}
	catch (Exception $e)
	{
