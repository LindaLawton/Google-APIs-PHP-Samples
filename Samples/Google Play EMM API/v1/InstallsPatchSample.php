...
print_r(installsPatchExample($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function installsPatchExample($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->installs->PatchInstalls($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
