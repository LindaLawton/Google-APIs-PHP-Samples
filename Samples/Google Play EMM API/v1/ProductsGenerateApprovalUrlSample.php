...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'languageCode' => '[YourValue]',  // The BCP 47 language code used for permission names and descriptions in the returned iframe, for instance "en-US".
  'fields' => '*'
);
// Single Request.
$results = productsGenerateApprovalUrlExample($service, $enterpriseId, $productId, $optParams);
...
*/
function productsGenerateApprovalUrlExample($service, $enterpriseId, $productId, $optParams)
{
	try
	{
		...
		return $service->products->GenerateApprovalUrlProducts($enterpriseId, $productId, $optParams);
	}
	catch (Exception $e)
	{
