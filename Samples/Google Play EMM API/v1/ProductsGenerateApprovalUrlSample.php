...
print_r(generateApprovalUrl($service, $enterpriseId, $productId));
...
*/
function generateApprovalUrl($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->generateApprovalUrl($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
