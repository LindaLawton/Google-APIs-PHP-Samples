...
print_r(productsGenerateApprovalUrlExample($service, $enterpriseId, $productId));
...
* @return ProductsGenerateApprovalUrlResponse</returns>
*/
function productsGenerateApprovalUrlExample($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->products->GenerateApprovalUrlProducts($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
