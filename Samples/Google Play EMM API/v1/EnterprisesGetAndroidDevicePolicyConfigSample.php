...
print_r(getAndroidDevicePolicyConfig($service, $enterpriseId));
...
*/
function getAndroidDevicePolicyConfig($service, $enterpriseId)
{
	try
	{
		...
		return $service->getAndroidDevicePolicyConfig($enterpriseId);
	}
	catch (Exception $ex)
	{
