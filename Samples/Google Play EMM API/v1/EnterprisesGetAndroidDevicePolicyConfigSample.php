...
// Single Request.
$results = enterprisesGetAndroidDevicePolicyConfigExample($service, $enterpriseId, $optParams);
...
* @return AndroidDevicePolicyConfig
*/
function enterprisesGetAndroidDevicePolicyConfigExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->GetAndroidDevicePolicyConfigEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
