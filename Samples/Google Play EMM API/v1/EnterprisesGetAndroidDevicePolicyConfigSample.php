...
print_r(enterprisesGetAndroidDevicePolicyConfigExample($service, $enterpriseId));
...
*/
function enterprisesGetAndroidDevicePolicyConfigExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->GetAndroidDevicePolicyConfigEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
