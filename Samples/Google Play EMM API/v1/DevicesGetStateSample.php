...
// Single Request.
$results = devicesGetStateExample($service, $enterpriseId, $userId, $deviceId, $optParams);
...
* @return DeviceState
*/
function devicesGetStateExample($service, $enterpriseId, $userId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->devices->GetStateDevices($enterpriseId, $userId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
