...
print_r(devicesGetStateExample($service, $enterpriseId, $userId, $deviceId));
...
* @return DeviceState</returns>
*/
function devicesGetStateExample($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->devices->GetStateDevices($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
