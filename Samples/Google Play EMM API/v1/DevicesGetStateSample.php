...
print_r(getState($service, $enterpriseId, $userId, $deviceId));
...
*/
function getState($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->getState($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
