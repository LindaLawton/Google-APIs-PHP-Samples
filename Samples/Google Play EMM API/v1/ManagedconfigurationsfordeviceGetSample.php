...
print_r(get($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId));
...
*/
function get($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId)
{
	try
	{
		...
		return $service->get($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId);
	}
	catch (Exception $ex)
	{
