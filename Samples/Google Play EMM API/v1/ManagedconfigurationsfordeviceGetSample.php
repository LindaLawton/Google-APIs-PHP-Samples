...
print_r(managedconfigurationsfordeviceGetExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId));
...
*/
function managedconfigurationsfordeviceGetExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->GetManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId);
	}
	catch (Exception $ex)
	{
