...
// Single Request.
$results = managedconfigurationsfordeviceGetExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams);
...
*/
function managedconfigurationsfordeviceGetExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->GetManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams);
	}
	catch (Exception $e)
	{
