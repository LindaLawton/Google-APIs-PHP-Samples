...
// Single Request.
$results = enterprisesEnrollExample($service, $token, $optParams);
...
* @return Enterprise
*/
function enterprisesEnrollExample($service, $token, $optParams)
{
	try
	{
		...
		return $service->enterprises->EnrollEnterprises($token, $optParams);
	}
	catch (Exception $e)
	{
