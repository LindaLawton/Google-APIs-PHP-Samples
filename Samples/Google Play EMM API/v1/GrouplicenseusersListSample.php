...
// Single Request.
$results = grouplicenseusersListExample($service, $enterpriseId, $groupLicenseId, $optParams);
...
*/
function grouplicenseusersListExample($service, $enterpriseId, $groupLicenseId, $optParams)
{
	try
	{
		...
		return $service->grouplicenseusers->ListGrouplicenseusers($enterpriseId, $groupLicenseId, $optParams);
	}
	catch (Exception $e)
	{
