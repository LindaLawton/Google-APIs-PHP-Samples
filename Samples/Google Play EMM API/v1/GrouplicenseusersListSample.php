...
print_r(grouplicenseusersListExample($service, $enterpriseId, $groupLicenseId));
...
* @return GroupLicenseUsersListResponse</returns>
*/
function grouplicenseusersListExample($service, $enterpriseId, $groupLicenseId)
{
	try
	{
		...
		if (groupLicenseId == null)
			throw new Exception("groupLicenseId is required.");
		// Make the request and return the results.
		return $service->grouplicenseusers->ListGrouplicenseusers($enterpriseId, $groupLicenseId);
	}
	catch (Exception $ex)
	{
