...
print_r(usersDeleteExample($service, $enterpriseId, $userId));
...
*/
function usersDeleteExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->DeleteUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
