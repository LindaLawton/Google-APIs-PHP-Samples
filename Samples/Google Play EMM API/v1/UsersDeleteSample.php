...
$results = usersDeleteExample($service, $enterpriseId, $userId, $optParams);
...
*/
function usersDeleteExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->DeleteUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
