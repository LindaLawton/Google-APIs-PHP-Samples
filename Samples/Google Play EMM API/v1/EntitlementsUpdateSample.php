...
// Single Request.
$results = entitlementsUpdateExample($service, $enterpriseId, $userId, $entitlementId, $optParams);
...
* @return Entitlement
*/
function entitlementsUpdateExample($service, $enterpriseId, $userId, $entitlementId, $optParams)
{
	try
	{
		...
		if (entitlementId == null)
			throw new Exception("entitlementId is required.");
		if (userId == null)
			throw new Exception("userId is required.");
		// Make the request and return the results.
		return $service->entitlements->UpdateEntitlements($enterpriseId, $userId, $entitlementId, $optParams);
	}
	catch (Exception $e)
	{
