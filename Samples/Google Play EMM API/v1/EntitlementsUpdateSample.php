...
print_r(update($service, $enterpriseId, $userId, $entitlementId));
...
*/
function update($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->update($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
