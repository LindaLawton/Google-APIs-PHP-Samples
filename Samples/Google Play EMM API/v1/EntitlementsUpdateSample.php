...
print_r(entitlementsUpdateExample($service, $enterpriseId, $userId, $entitlementId));
...
* @return Entitlement</returns>
*/
function entitlementsUpdateExample($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->entitlements->UpdateEntitlements($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
