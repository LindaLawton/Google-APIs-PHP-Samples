...
print_r(grouplicensesListExample($service, $enterpriseId));

/**
* Retrieves IDs of all products for which the enterprise has a group license.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return GroupLicensesListResponse</returns>
*/
function grouplicensesListExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->grouplicenses->ListGrouplicenses($enterpriseId);
	}
	catch (Exception $ex)
	{
