...
$results = grouplicensesListExample($service, $enterpriseId, $optParams);
...
*/
function grouplicensesListExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->grouplicenses->ListGrouplicenses($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
