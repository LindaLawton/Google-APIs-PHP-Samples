...
// Single Request.
$results = storelayoutpagesListExample($service, $enterpriseId, $optParams);
...
*/
function storelayoutpagesListExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->storelayoutpages->ListStorelayoutpages($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
