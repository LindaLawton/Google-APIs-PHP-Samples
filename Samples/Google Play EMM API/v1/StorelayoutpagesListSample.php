...
print_r(storelayoutpagesListExample($service, $enterpriseId));

/**
* Retrieves the details of all pages in the store.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return StoreLayoutPagesListResponse</returns>
*/
function storelayoutpagesListExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->storelayoutpages->ListStorelayoutpages($enterpriseId);
	}
	catch (Exception $ex)
	{
