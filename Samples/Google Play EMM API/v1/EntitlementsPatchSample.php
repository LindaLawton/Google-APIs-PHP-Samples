...
* @return Entitlement
*/
function entitlementsPatchExample($service, $enterpriseId, $userId, $entitlementId, $optParams)
{
	try
	{
		...
		return $service->entitlements->PatchEntitlements($enterpriseId, $userId, $entitlementId, $optParams);
	}
	catch (Exception $e)
	{
