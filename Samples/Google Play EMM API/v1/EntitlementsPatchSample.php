...
print_r(entitlementsPatchExample($service, $enterpriseId, $userId, $entitlementId));
...
*/
function entitlementsPatchExample($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->entitlements->PatchEntitlements($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
