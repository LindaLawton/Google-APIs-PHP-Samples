...
print_r(patch($service, $enterpriseId, $userId, $entitlementId));
...
*/
function patch($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->patch($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
