...
print_r(managedconfigurationsfordeviceUpdateExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId));
...
* @return ManagedConfiguration</returns>
*/
function managedconfigurationsfordeviceUpdateExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId)
{
	try
	{
		...
		if (managedConfigurationForDeviceId == null)
			throw new Exception("managedConfigurationForDeviceId is required.");
		if (userId == null)
			throw new Exception("userId is required.");
		// Make the request and return the results.
		return $service->managedconfigurationsfordevice->UpdateManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId);
	}
	catch (Exception $ex)
	{
