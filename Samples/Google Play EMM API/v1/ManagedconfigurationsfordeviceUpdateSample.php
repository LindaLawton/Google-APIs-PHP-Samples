...
// Single Request.
$results = managedconfigurationsfordeviceUpdateExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams);
...
*/
function managedconfigurationsfordeviceUpdateExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->UpdateManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId, $optParams);
	}
	catch (Exception $e)
	{
