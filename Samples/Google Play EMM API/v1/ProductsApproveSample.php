...
$results = productsApproveExample($service, $enterpriseId, $productId, $optParams);
...
*/
function productsApproveExample($service, $enterpriseId, $productId, $optParams)
{
	try
	{
		...
		return $service->products->ApproveProducts($enterpriseId, $productId, $optParams);
	}
	catch (Exception $e)
	{
