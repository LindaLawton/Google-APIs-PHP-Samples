...
print_r(productsApproveExample($service, $enterpriseId, $productId));
...
*/
function productsApproveExample($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->products->ApproveProducts($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
