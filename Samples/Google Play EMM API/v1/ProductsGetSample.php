...
// Single Request.
$results = productsGetExample($service, $enterpriseId, $productId, $optParams);
...
* @return Product
*/
function productsGetExample($service, $enterpriseId, $productId, $optParams)
{
	try
	{
		...
		return $service->products->GetProducts($enterpriseId, $productId, $optParams);
	}
	catch (Exception $e)
	{
