...
// Single Request.
$results = entitlementsListExample($service, $enterpriseId, $userId, $optParams);
...
*/
function entitlementsListExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->entitlements->ListEntitlements($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
