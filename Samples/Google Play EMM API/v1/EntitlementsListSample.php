...
print_r(entitlementsListExample($service, $enterpriseId, $userId));
...
* @return EntitlementsListResponse</returns>
*/
function entitlementsListExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->entitlements->ListEntitlements($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
