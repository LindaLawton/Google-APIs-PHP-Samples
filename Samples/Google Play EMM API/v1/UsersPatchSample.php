...
$results = usersPatchExample($service, $enterpriseId, $userId, $optParams);
...
* @return User
*/
function usersPatchExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->PatchUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
