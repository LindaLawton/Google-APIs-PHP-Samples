...
print_r(usersPatchExample($service, $enterpriseId, $userId));
...
* @return User</returns>
*/
function usersPatchExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->PatchUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
