...
// Single Request.
$results = storelayoutpagesInsertExample($service, $enterpriseId, $optParams);
...
* @return StorePage
*/
function storelayoutpagesInsertExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->storelayoutpages->InsertStorelayoutpages($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
