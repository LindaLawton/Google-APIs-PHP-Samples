...
print_r(storelayoutpagesInsertExample($service, $enterpriseId));
...
*/
function storelayoutpagesInsertExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->storelayoutpages->InsertStorelayoutpages($enterpriseId);
	}
	catch (Exception $ex)
	{
