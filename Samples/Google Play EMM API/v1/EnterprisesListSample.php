...
print_r(enterprisesListExample($service, $domain));
...
* @return EnterprisesListResponse</returns>
*/
function enterprisesListExample($service, $domain)
{
	try
	{
		...
		return $service->enterprises->ListEnterprises($domain);
	}
	catch (Exception $ex)
	{
