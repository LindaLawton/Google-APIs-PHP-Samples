...
$results = enterprisesListExample($service, $domain, $optParams);
...
*/
function enterprisesListExample($service, $domain, $optParams)
{
	try
	{
		...
		return $service->enterprises->ListEnterprises($domain, $optParams);
	}
	catch (Exception $e)
	{
