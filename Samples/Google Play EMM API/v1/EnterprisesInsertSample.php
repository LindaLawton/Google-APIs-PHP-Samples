...
$results = enterprisesInsertExample($service, $token, $optParams);
...
* @return Enterprise
*/
function enterprisesInsertExample($service, $token, $optParams)
{
	try
	{
		...
		return $service->enterprises->InsertEnterprises($token, $optParams);
	}
	catch (Exception $e)
	{
