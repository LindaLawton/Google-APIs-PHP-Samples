...
print_r(update($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function update($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->update($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
