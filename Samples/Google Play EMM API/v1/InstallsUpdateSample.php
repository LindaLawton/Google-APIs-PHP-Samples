...
* @return Install
*/
function installsUpdateExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams)
{
	try
	{
		...
		return $service->installs->UpdateInstalls($enterpriseId, $userId, $deviceId, $installId, $optParams);
	}
	catch (Exception $e)
	{
