...
print_r(installsUpdateExample($service, $enterpriseId, $userId, $deviceId, $installId));
...
* @return Install</returns>
*/
function installsUpdateExample($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->installs->UpdateInstalls($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
