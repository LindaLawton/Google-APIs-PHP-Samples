...
print_r(enterprisesCreateWebTokenExample($service, $enterpriseId));

/**
* Returns a unique token to access an embeddable UI. To generate a web UI, pass the generated token into the managed Google Play javascript API. Each token may only be used to start one UI session. See the javascript API documentation for further information.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return AdministratorWebToken</returns>
*/
function enterprisesCreateWebTokenExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->CreateWebTokenEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
