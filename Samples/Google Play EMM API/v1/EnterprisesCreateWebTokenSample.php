...
// Single Request.
$results = enterprisesCreateWebTokenExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesCreateWebTokenExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->CreateWebTokenEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
