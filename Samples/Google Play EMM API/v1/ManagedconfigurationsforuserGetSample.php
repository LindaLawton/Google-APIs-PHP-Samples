...
print_r(get($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function get($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->get($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
