...
// Single Request.
$results = managedconfigurationsforuserGetExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
...
*/
function managedconfigurationsforuserGetExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->GetManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
	}
	catch (Exception $e)
	{
