...
print_r(managedconfigurationsforuserGetExample($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function managedconfigurationsforuserGetExample($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->GetManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
