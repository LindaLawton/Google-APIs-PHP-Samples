...
print_r(enterprisesGenerateSignupUrlExample($service));

/**
* Generates a sign-up URL.
* @service Authenticated Androidenterprise service.
* @return SignupInfo</returns>
*/
function enterprisesGenerateSignupUrlExample($service)
{
	try
	{
		...
		return $service->enterprises->GenerateSignupUrlEnterprises();
	}
	catch (Exception $ex)
	{
