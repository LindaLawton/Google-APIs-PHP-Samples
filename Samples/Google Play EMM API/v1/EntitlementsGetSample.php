...
print_r(entitlementsGetExample($service, $enterpriseId, $userId, $entitlementId));
...
*/
function entitlementsGetExample($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->entitlements->GetEntitlements($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
