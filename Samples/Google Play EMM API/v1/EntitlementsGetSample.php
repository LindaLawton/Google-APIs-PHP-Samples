...
print_r(get($service, $enterpriseId, $userId, $entitlementId));
...
*/
function get($service, $enterpriseId, $userId, $entitlementId)
{
	try
	{
		...
		return $service->get($enterpriseId, $userId, $entitlementId);
	}
	catch (Exception $ex)
	{
