...
$results = entitlementsGetExample($service, $enterpriseId, $userId, $entitlementId, $optParams);
...
* @return Entitlement
*/
function entitlementsGetExample($service, $enterpriseId, $userId, $entitlementId, $optParams)
{
	try
	{
		...
		return $service->entitlements->GetEntitlements($enterpriseId, $userId, $entitlementId, $optParams);
	}
	catch (Exception $e)
	{
