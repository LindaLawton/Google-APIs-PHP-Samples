...
print_r(storelayoutpagesGetExample($service, $enterpriseId, $pageId));
...
*/
function storelayoutpagesGetExample($service, $enterpriseId, $pageId)
{
	try
	{
		...
		return $service->storelayoutpages->GetStorelayoutpages($enterpriseId, $pageId);
	}
	catch (Exception $ex)
	{
