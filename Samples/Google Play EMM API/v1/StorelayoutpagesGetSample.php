...
// Single Request.
$results = storelayoutpagesGetExample($service, $enterpriseId, $pageId, $optParams);
...
* @return StorePage
*/
function storelayoutpagesGetExample($service, $enterpriseId, $pageId, $optParams)
{
	try
	{
		...
		return $service->storelayoutpages->GetStorelayoutpages($enterpriseId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
