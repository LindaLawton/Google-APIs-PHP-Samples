...
// Single Request.
$results = enterprisesGetStoreLayoutExample($service, $enterpriseId, $optParams);
...
* @return StoreLayout
*/
function enterprisesGetStoreLayoutExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->GetStoreLayoutEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
