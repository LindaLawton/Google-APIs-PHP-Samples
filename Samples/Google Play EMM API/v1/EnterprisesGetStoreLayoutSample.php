...
print_r(enterprisesGetStoreLayoutExample($service, $enterpriseId));
...
*/
function enterprisesGetStoreLayoutExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->GetStoreLayoutEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
