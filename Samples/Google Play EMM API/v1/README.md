...
# UnOfficial Google Play EMM API v1 Samples for PHP

## API Description

Manages the deployment of apps to Android for Work users.

[Official Documentation](https://developers.google.com/android/work/play/emm-api)

## Sample Description

These samples show how to access the [Google Play EMM API v1](https://developers.google.com/android/work/play/emm-api) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
