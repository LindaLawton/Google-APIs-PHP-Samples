...
print_r(installsDeleteExample($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function installsDeleteExample($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->installs->DeleteInstalls($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
