...
$results = installsDeleteExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams);
...
*/
function installsDeleteExample($service, $enterpriseId, $userId, $deviceId, $installId, $optParams)
{
	try
	{
		...
		if (installId == null)
			throw new Exception("installId is required.");
		if (userId == null)
			throw new Exception("userId is required.");
		// Make the request and return the results.
		return $service->installs->DeleteInstalls($enterpriseId, $userId, $deviceId, $installId, $optParams);
	}
	catch (Exception $e)
	{
