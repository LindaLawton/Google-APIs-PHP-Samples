...
print_r(delete($service, $enterpriseId, $userId, $deviceId, $installId));
...
*/
function delete($service, $enterpriseId, $userId, $deviceId, $installId)
{
	try
	{
		...
		return $service->delete($enterpriseId, $userId, $deviceId, $installId);
	}
	catch (Exception $ex)
	{
