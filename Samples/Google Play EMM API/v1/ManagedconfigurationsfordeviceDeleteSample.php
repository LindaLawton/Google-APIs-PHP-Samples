...
print_r(managedconfigurationsfordeviceDeleteExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId));
...
*/
function managedconfigurationsfordeviceDeleteExample($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->DeleteManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId);
	}
	catch (Exception $ex)
	{
