...
print_r(delete($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId));
...
*/
function delete($service, $enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId)
{
	try
	{
		...
		return $service->delete($enterpriseId, $userId, $deviceId, $managedConfigurationForDeviceId);
	}
	catch (Exception $ex)
	{
