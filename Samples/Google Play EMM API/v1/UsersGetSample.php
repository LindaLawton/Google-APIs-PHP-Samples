...
// Single Request.
$results = usersGetExample($service, $enterpriseId, $userId, $optParams);
...
* @return User
*/
function usersGetExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->GetUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
