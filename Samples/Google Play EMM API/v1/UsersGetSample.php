...
print_r(usersGetExample($service, $enterpriseId, $userId));
...
* @return User</returns>
*/
function usersGetExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->GetUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
