...
$results = usersListExample($service, $enterpriseId, $email, $optParams);
...
*/
function usersListExample($service, $enterpriseId, $email, $optParams)
{
	try
	{
		...
		return $service->users->ListUsers($enterpriseId, $email, $optParams);
	}
	catch (Exception $e)
	{
