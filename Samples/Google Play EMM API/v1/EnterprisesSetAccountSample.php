...
// Single Request.
$results = enterprisesSetAccountExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesSetAccountExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->SetAccountEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
