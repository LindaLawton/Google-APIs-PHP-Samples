...
print_r(enterprisesSetAccountExample($service, $enterpriseId));

/**
* Sets the account that will be used to authenticate to the API as the enterprise.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return EnterpriseAccount</returns>
*/
function enterprisesSetAccountExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->SetAccountEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
