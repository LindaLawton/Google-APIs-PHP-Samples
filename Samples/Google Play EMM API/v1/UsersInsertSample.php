...
$results = usersInsertExample($service, $enterpriseId, $optParams);
...
* @return User
*/
function usersInsertExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->users->InsertUsers($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
