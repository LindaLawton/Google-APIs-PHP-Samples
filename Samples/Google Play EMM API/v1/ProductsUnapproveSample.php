...
print_r(productsUnapproveExample($service, $enterpriseId, $productId));
...
*/
function productsUnapproveExample($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->products->UnapproveProducts($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
