...
print_r(serviceaccountkeysListExample($service, $enterpriseId));

/**
* Lists all active credentials for the service account associated with this enterprise. Only the ID and key type are returned. The calling service account must have been retrieved by calling Enterprises.GetServiceAccount and must have been set as the enterprise service account by calling Enterprises.SetAccount.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return ServiceAccountKeysListResponse</returns>
*/
function serviceaccountkeysListExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->serviceaccountkeys->ListServiceaccountkeys($enterpriseId);
	}
	catch (Exception $ex)
	{
