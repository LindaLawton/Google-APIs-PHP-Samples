...
// Single Request.
$results = serviceaccountkeysListExample($service, $enterpriseId, $optParams);
...
*/
function serviceaccountkeysListExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->serviceaccountkeys->ListServiceaccountkeys($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
