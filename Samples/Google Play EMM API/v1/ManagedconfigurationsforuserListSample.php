...
print_r(managedconfigurationsforuserListExample($service, $enterpriseId, $userId));
...
* @return ManagedConfigurationsForUserListResponse</returns>
*/
function managedconfigurationsforuserListExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->ListManagedconfigurationsforuser($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
