...
$results = managedconfigurationsforuserListExample($service, $enterpriseId, $userId, $optParams);
...
*/
function managedconfigurationsforuserListExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->ListManagedconfigurationsforuser($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
