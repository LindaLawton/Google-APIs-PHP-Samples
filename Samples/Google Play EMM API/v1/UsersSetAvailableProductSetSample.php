...
// Single Request.
$results = usersSetAvailableProductSetExample($service, $enterpriseId, $userId, $optParams);
...
* @return ProductSet
*/
function usersSetAvailableProductSetExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->SetAvailableProductSetUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
