...
print_r(usersSetAvailableProductSetExample($service, $enterpriseId, $userId));
...
* @return ProductSet</returns>
*/
function usersSetAvailableProductSetExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->SetAvailableProductSetUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
