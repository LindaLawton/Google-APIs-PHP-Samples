...
print_r(setAvailableProductSet($service, $enterpriseId, $userId));
...
*/
function setAvailableProductSet($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->setAvailableProductSet($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
