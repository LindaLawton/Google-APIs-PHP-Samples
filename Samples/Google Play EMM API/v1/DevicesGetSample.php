...
// Single Request.
$results = devicesGetExample($service, $enterpriseId, $userId, $deviceId, $optParams);
...
* @return Device
*/
function devicesGetExample($service, $enterpriseId, $userId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->devices->GetDevices($enterpriseId, $userId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
