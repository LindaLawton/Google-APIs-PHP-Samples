...
print_r(devicesGetExample($service, $enterpriseId, $userId, $deviceId));
...
*/
function devicesGetExample($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->devices->GetDevices($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
