...
// Single Request.
$results = managedconfigurationsforuserPatchExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
...
*/
function managedconfigurationsforuserPatchExample($service, $enterpriseId, $userId, $managedConfigurationForUserId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->PatchManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId, $optParams);
	}
	catch (Exception $e)
	{
