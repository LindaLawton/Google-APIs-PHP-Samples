...
print_r(managedconfigurationsforuserPatchExample($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function managedconfigurationsforuserPatchExample($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->managedconfigurationsforuser->PatchManagedconfigurationsforuser($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
