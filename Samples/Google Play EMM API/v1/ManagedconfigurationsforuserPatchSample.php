...
print_r(patch($service, $enterpriseId, $userId, $managedConfigurationForUserId));
...
*/
function patch($service, $enterpriseId, $userId, $managedConfigurationForUserId)
{
	try
	{
		...
		return $service->patch($enterpriseId, $userId, $managedConfigurationForUserId);
	}
	catch (Exception $ex)
	{
