...
print_r(productsGetPermissionsExample($service, $enterpriseId, $productId));
...
* @return ProductPermissions</returns>
*/
function productsGetPermissionsExample($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->products->GetPermissionsProducts($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
