...
// Single Request.
$results = productsGetPermissionsExample($service, $enterpriseId, $productId, $optParams);
...
*/
function productsGetPermissionsExample($service, $enterpriseId, $productId, $optParams)
{
	try
	{
		...
		return $service->products->GetPermissionsProducts($enterpriseId, $productId, $optParams);
	}
	catch (Exception $e)
	{
