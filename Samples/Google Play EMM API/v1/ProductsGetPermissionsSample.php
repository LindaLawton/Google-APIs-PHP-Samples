...
print_r(getPermissions($service, $enterpriseId, $productId));
...
*/
function getPermissions($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->getPermissions($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
