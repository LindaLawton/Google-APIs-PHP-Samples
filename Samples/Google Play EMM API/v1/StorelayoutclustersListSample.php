...
print_r(storelayoutclustersListExample($service, $enterpriseId, $pageId));
...
* @return StoreLayoutClustersListResponse</returns>
*/
function storelayoutclustersListExample($service, $enterpriseId, $pageId)
{
	try
	{
		...
		return $service->storelayoutclusters->ListStorelayoutclusters($enterpriseId, $pageId);
	}
	catch (Exception $ex)
	{
