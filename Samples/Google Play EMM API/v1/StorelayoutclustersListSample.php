...
$results = storelayoutclustersListExample($service, $enterpriseId, $pageId, $optParams);
...
*/
function storelayoutclustersListExample($service, $enterpriseId, $pageId, $optParams)
{
	try
	{
		...
		return $service->storelayoutclusters->ListStorelayoutclusters($enterpriseId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
