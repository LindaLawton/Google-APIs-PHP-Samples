...
$results = storelayoutclustersPatchExample($service, $enterpriseId, $pageId, $clusterId, $optParams);
...
* @return StoreCluster
*/
function storelayoutclustersPatchExample($service, $enterpriseId, $pageId, $clusterId, $optParams)
{
	try
	{
		...
		return $service->storelayoutclusters->PatchStorelayoutclusters($enterpriseId, $pageId, $clusterId, $optParams);
	}
	catch (Exception $e)
	{
