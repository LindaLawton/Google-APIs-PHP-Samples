...
print_r(storelayoutclustersPatchExample($service, $enterpriseId, $pageId, $clusterId));
...
*/
function storelayoutclustersPatchExample($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->storelayoutclusters->PatchStorelayoutclusters($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
