...
print_r(patch($service, $enterpriseId, $pageId, $clusterId));
...
*/
function patch($service, $enterpriseId, $pageId, $clusterId)
{
	try
	{
		...
		return $service->patch($enterpriseId, $pageId, $clusterId);
	}
	catch (Exception $ex)
	{
