...
$results = enterprisesUnenrollExample($service, $enterpriseId, $optParams);
...
*/
function enterprisesUnenrollExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->UnenrollEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
