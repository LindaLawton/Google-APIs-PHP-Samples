...
print_r(enterprisesUnenrollExample($service, $enterpriseId));
...
*/
function enterprisesUnenrollExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->UnenrollEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
