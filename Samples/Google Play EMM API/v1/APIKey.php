...
// About 
// 
// Unofficial sample for the Androidenterprise v1 API for PHP. 
 ...
 * Initializes an Androidenterprise.v1 service object.
 * @param string API key
 * @return An authorized Androidenterprise.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Androidenterprise Sample");
		...
		// Create authenticated Androidenterprise service
		return new Google_Service_Androidenterprise($client);
	} catch (Exception $e) {
