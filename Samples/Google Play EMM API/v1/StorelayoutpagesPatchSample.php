...
print_r(storelayoutpagesPatchExample($service, $enterpriseId, $pageId));
...
*/
function storelayoutpagesPatchExample($service, $enterpriseId, $pageId)
{
	try
	{
		...
		return $service->storelayoutpages->PatchStorelayoutpages($enterpriseId, $pageId);
	}
	catch (Exception $ex)
	{
