...
// Single Request.
$results = storelayoutpagesPatchExample($service, $enterpriseId, $pageId, $optParams);
...
* @return StorePage
*/
function storelayoutpagesPatchExample($service, $enterpriseId, $pageId, $optParams)
{
	try
	{
		...
		return $service->storelayoutpages->PatchStorelayoutpages($enterpriseId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
