...
print_r(managedconfigurationsfordeviceListExample($service, $enterpriseId, $userId, $deviceId));
...
* @return ManagedConfigurationsForDeviceListResponse</returns>
*/
function managedconfigurationsfordeviceListExample($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->ListManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
