...
// Single Request.
$results = managedconfigurationsfordeviceListExample($service, $enterpriseId, $userId, $deviceId, $optParams);
...
*/
function managedconfigurationsfordeviceListExample($service, $enterpriseId, $userId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->managedconfigurationsfordevice->ListManagedconfigurationsfordevice($enterpriseId, $userId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
