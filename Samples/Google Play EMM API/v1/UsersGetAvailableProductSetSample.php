...
// Single Request.
$results = usersGetAvailableProductSetExample($service, $enterpriseId, $userId, $optParams);
...
* @return ProductSet
*/
function usersGetAvailableProductSetExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->GetAvailableProductSetUsers($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
