...
print_r(usersGetAvailableProductSetExample($service, $enterpriseId, $userId));
...
*/
function usersGetAvailableProductSetExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->users->GetAvailableProductSetUsers($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
