...
print_r(getAvailableProductSet($service, $enterpriseId, $userId));
...
*/
function getAvailableProductSet($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->getAvailableProductSet($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
