...
$results = serviceaccountkeysInsertExample($service, $enterpriseId, $optParams);
...
*/
function serviceaccountkeysInsertExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->serviceaccountkeys->InsertServiceaccountkeys($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
