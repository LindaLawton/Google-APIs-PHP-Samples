...
print_r(productsGetAppRestrictionsSchemaExample($service, $enterpriseId, $productId));
...
* @return AppRestrictionsSchema</returns>
*/
function productsGetAppRestrictionsSchemaExample($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->products->GetAppRestrictionsSchemaProducts($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
