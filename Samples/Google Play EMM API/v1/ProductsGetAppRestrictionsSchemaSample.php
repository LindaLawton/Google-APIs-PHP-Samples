...
print_r(getAppRestrictionsSchema($service, $enterpriseId, $productId));
...
*/
function getAppRestrictionsSchema($service, $enterpriseId, $productId)
{
	try
	{
		...
		return $service->getAppRestrictionsSchema($enterpriseId, $productId);
	}
	catch (Exception $ex)
	{
