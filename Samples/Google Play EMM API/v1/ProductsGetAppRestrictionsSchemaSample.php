...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'language' => '[YourValue]',  // The BCP47 tag for the user's preferred language (e.g. "en-US", "de").
  'fields' => '*'
);
// Single Request.
$results = productsGetAppRestrictionsSchemaExample($service, $enterpriseId, $productId, $optParams);
...
*/
function productsGetAppRestrictionsSchemaExample($service, $enterpriseId, $productId, $optParams)
{
	try
	{
		...
		return $service->products->GetAppRestrictionsSchemaProducts($enterpriseId, $productId, $optParams);
	}
	catch (Exception $e)
	{
