...
// Single Request.
$results = devicesSetStateExample($service, $enterpriseId, $userId, $deviceId, $optParams);
...
* @return DeviceState
*/
function devicesSetStateExample($service, $enterpriseId, $userId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->devices->SetStateDevices($enterpriseId, $userId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
