...
print_r(setState($service, $enterpriseId, $userId, $deviceId));
...
*/
function setState($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->setState($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
