...
print_r(devicesSetStateExample($service, $enterpriseId, $userId, $deviceId));
...
*/
function devicesSetStateExample($service, $enterpriseId, $userId, $deviceId)
{
	try
	{
		...
		return $service->devices->SetStateDevices($enterpriseId, $userId, $deviceId);
	}
	catch (Exception $ex)
	{
