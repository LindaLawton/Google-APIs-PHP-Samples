...
print_r(devicesListExample($service, $enterpriseId, $userId));
...
* @return DevicesListResponse</returns>
*/
function devicesListExample($service, $enterpriseId, $userId)
{
	try
	{
		...
		return $service->devices->ListDevices($enterpriseId, $userId);
	}
	catch (Exception $ex)
	{
