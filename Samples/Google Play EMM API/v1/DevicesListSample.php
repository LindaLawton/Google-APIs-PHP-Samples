...
// Single Request.
$results = devicesListExample($service, $enterpriseId, $userId, $optParams);
...
*/
function devicesListExample($service, $enterpriseId, $userId, $optParams)
{
	try
	{
		...
		return $service->devices->ListDevices($enterpriseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
