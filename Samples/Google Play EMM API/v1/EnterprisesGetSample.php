...
// Single Request.
$results = enterprisesGetExample($service, $enterpriseId, $optParams);
...
* @return Enterprise
*/
function enterprisesGetExample($service, $enterpriseId, $optParams)
{
	try
	{
		...
		return $service->enterprises->GetEnterprises($enterpriseId, $optParams);
	}
	catch (Exception $e)
	{
