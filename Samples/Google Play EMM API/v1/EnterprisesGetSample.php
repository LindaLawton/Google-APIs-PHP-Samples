...
print_r(enterprisesGetExample($service, $enterpriseId));

/**
* Retrieves the name and domain of an enterprise.
* @service Authenticated Androidenterprise service.
* @enterpriseId The ID of the enterprise.
* @return Enterprise</returns>
*/
function enterprisesGetExample($service, $enterpriseId)
{
	try
	{
		...
		return $service->enterprises->GetEnterprises($enterpriseId);
	}
	catch (Exception $ex)
	{
