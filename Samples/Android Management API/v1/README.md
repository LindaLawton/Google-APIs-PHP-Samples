...
# UnOfficial Android Management API v1 Samples for PHP

## API Description

The Android Management API provides remote enterprise management of Android devices and apps.

[Official Documentation](https://developers.google.com/android/management)

## Sample Description

These samples show how to access the [Android Management API v1](https://developers.google.com/android/management) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
