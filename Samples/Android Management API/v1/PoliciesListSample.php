...
print_r(policiesListExample($service, $parent));
...
* @return ListPoliciesResponse</returns>
*/
function policiesListExample($service, $parent)
{
	try
	{
		...
		return $service->policies->ListPolicies($parent);
	}
	catch (Exception $ex)
	{
