...
// Single Request.
$results = policiesDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function policiesDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->policies->DeletePolicies($name, $optParams);
	}
	catch (Exception $e)
	{
