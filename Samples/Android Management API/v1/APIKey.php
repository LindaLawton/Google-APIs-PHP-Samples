 ...
 * Initializes an Androidmanagement.v1 service object.
 * @param string API key
 * @return An authorized Androidmanagement.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Androidmanagement Sample");
		...
		// Create authenticated Androidmanagement service
		return new Google_Service_Androidmanagement($client);
	} catch (Exception $e) {
