...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  // The field mask indicating the fields to update. If not set, all modifiable fields will be modified.
  'fields' => '*'
);
// Single Request.
$results = policiesPatchExample($service, $name, $optParams);
...
* @return Policy
*/
function policiesPatchExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->policies->PatchPolicies($name, $optParams);
	}
	catch (Exception $e)
	{
