...
print_r(enrollmentTokensCreateExample($service, $parent));
...
* @return EnrollmentToken</returns>
*/
function enrollmentTokensCreateExample($service, $parent)
{
	try
	{
		...
		return $service->enrollmentTokens->CreateEnrollmentTokens($parent);
	}
	catch (Exception $ex)
	{
