...
print_r(enrollmentTokensDeleteExample($service, $name));
...
*/
function enrollmentTokensDeleteExample($service, $name)
{
	try
	{
		...
		return $service->enrollmentTokens->DeleteEnrollmentTokens($name);
	}
	catch (Exception $ex)
	{
