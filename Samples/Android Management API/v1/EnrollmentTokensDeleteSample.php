...
$results = enrollmentTokensDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function enrollmentTokensDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->enrollmentTokens->DeleteEnrollmentTokens($name, $optParams);
	}
	catch (Exception $e)
	{
