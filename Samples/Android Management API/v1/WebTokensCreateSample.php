...
// Single Request.
$results = webTokensCreateExample($service, $parent, $optParams);
...
* @return WebToken
*/
function webTokensCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->webTokens->CreateWebTokens($parent, $optParams);
	}
	catch (Exception $e)
	{
