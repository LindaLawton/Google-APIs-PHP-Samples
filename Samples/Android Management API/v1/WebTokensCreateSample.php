...
print_r(webTokensCreateExample($service, $parent));
...
* @return WebToken</returns>
*/
function webTokensCreateExample($service, $parent)
{
	try
	{
		...
		return $service->webTokens->CreateWebTokens($parent);
	}
	catch (Exception $ex)
	{
