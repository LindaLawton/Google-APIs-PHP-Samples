...
# Unoffical Google Slides API Samples for PHP
...
These samples show how to access the [Google Slides API](https://developers.google.com/slides/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
