 ...
 * Initializes an Slides.v1 service object.
 * @param string API key
 * @return An authorized Slides.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Slides Sample");
		...
		// Create authenticated Slides service
