...
# UnOfficial Google Slides API v1 Samples for PHP

## API Description

An API for creating and editing Google Slides presentations.

[Official Documentation](https://developers.google.com/slides/)

## Sample Description

These samples show how to access the [Google Slides API v1](https://developers.google.com/slides/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
