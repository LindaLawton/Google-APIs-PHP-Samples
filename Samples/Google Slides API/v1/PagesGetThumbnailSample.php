...
print_r(getThumbnail($service, $presentationId, $pageObjectId));
...
*/
function getThumbnail($service, $presentationId, $pageObjectId)
{
	try
	{
		...
		return $service->getThumbnail($presentationId, $pageObjectId);
	}
	catch (Exception $ex)
	{
