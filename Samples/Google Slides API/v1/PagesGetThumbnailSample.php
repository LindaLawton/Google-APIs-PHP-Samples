...
print_r(pagesGetThumbnailExample($service, $presentationId, $pageObjectId));
...
*/
function pagesGetThumbnailExample($service, $presentationId, $pageObjectId)
{
	try
	{
		...
		return $service->pages->GetThumbnailPages($presentationId, $pageObjectId);
	}
	catch (Exception $ex)
	{
