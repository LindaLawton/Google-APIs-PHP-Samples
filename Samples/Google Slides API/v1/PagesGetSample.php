...
print_r(pagesGetExample($service, $presentationId, $pageObjectId));
...
* @return Page</returns>
*/
function pagesGetExample($service, $presentationId, $pageObjectId)
{
	try
	{
		...
		return $service->pages->GetPages($presentationId, $pageObjectId);
	}
	catch (Exception $ex)
	{
