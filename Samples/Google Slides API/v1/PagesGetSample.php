...
$results = pagesGetExample($service, $presentationId, $pageObjectId, $optParams);
...
* @return Page
*/
function pagesGetExample($service, $presentationId, $pageObjectId, $optParams)
{
	try
	{
		...
		return $service->pages->GetPages($presentationId, $pageObjectId, $optParams);
	}
	catch (Exception $e)
	{
