...
print_r(datasetsListExample($service, $projectId));

/**
* Lists all datasets in the specified project to which you have been granted the READER dataset role.
* @service Authenticated Bigquery service.
* @projectId Project ID of the datasets to be listed
* @return DatasetList</returns>
*/
function datasetsListExample($service, $projectId)
{
	try
	{
		...
		return $service->datasets->ListDatasets($projectId);
	}
	catch (Exception $ex)
	{
