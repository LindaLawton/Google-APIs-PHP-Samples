...
print_r(update($service, $projectId, $datasetId, $tableId));
...
*/
function update($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->update($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
