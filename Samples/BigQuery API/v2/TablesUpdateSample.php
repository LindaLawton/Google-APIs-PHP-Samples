...
$results = tablesUpdateExample($service, $projectId, $datasetId, $tableId, $optParams);
...
* @return Table
*/
function tablesUpdateExample($service, $projectId, $datasetId, $tableId, $optParams)
{
	try
	{
		...
		return $service->tables->UpdateTables($projectId, $datasetId, $tableId, $optParams);
	}
	catch (Exception $e)
	{
