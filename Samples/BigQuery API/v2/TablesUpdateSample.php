...
print_r(tablesUpdateExample($service, $projectId, $datasetId, $tableId));
...
*/
function tablesUpdateExample($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->tables->UpdateTables($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
