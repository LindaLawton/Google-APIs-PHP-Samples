...
print_r(delete($service, $projectId, $datasetId, $tableId));
...
*/
function delete($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->delete($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
