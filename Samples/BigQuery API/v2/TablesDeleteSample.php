...
print_r(tablesDeleteExample($service, $projectId, $datasetId, $tableId));
...
*/
function tablesDeleteExample($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->tables->DeleteTables($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
