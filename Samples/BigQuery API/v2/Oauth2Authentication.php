 ...
 * Initializes an Bigquery.v2 service object.
 * @return An authorized Bigquery.v2 service object.
 */
function getAuthenticateOAuth2() {
	try {
		$client = new Google_Client();
		$client->setAuthConfig(__DIR__ . '/client_secrets.json');
		$client->addScope(Google_Service_Bigquery::ANALYTICS_READONLY);
		...
		if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
			...
			return new Google_Service_Bigquery($client); 
