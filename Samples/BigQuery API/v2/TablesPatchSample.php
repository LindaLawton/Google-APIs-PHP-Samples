...
// Single Request.
$results = tablesPatchExample($service, $projectId, $datasetId, $tableId, $optParams);
...
* @return Table
*/
function tablesPatchExample($service, $projectId, $datasetId, $tableId, $optParams)
{
	try
	{
		...
		return $service->tables->PatchTables($projectId, $datasetId, $tableId, $optParams);
	}
	catch (Exception $e)
	{
