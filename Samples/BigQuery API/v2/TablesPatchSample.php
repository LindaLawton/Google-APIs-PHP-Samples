...
print_r(tablesPatchExample($service, $projectId, $datasetId, $tableId));
...
*/
function tablesPatchExample($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->tables->PatchTables($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
