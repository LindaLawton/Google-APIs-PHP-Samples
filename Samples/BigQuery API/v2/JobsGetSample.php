...
$results = jobsGetExample($service, $projectId, $jobId, $optParams);
...
* @return Job
*/
function jobsGetExample($service, $projectId, $jobId, $optParams)
{
	try
	{
		...
		return $service->jobs->GetJobs($projectId, $jobId, $optParams);
	}
	catch (Exception $e)
	{
