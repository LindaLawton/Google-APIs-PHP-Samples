...
print_r(tabledataInsertAllExample($service, $projectId, $datasetId, $tableId));
...
* @return TableDataInsertAllResponse</returns>
*/
function tabledataInsertAllExample($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->tabledata->InsertAllTabledata($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
