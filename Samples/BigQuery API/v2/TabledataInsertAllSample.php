...
print_r(insertAll($service, $projectId, $datasetId, $tableId));
...
*/
function insertAll($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->insertAll($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
