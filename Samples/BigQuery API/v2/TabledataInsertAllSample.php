...
// Single Request.
$results = tabledataInsertAllExample($service, $projectId, $datasetId, $tableId, $optParams);
...
*/
function tabledataInsertAllExample($service, $projectId, $datasetId, $tableId, $optParams)
{
	try
	{
		...
		return $service->tabledata->InsertAllTabledata($projectId, $datasetId, $tableId, $optParams);
	}
	catch (Exception $e)
	{
