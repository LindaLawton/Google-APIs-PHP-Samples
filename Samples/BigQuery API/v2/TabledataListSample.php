...
print_r(tabledataListExample($service, $projectId, $datasetId, $tableId));
...
* @return TableDataList</returns>
*/
function tabledataListExample($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->tabledata->ListTabledata($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
