...
print_r(tablesInsertExample($service, $projectId, $datasetId));
...
*/
function tablesInsertExample($service, $projectId, $datasetId)
{
	try
	{
		...
		return $service->tables->InsertTables($projectId, $datasetId);
	}
	catch (Exception $ex)
	{
