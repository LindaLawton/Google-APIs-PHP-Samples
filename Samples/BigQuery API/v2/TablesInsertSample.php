...
// Single Request.
$results = tablesInsertExample($service, $projectId, $datasetId, $optParams);
...
* @return Table
*/
function tablesInsertExample($service, $projectId, $datasetId, $optParams)
{
	try
	{
		...
		return $service->tables->InsertTables($projectId, $datasetId, $optParams);
	}
	catch (Exception $e)
	{
