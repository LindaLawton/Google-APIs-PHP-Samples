...
print_r(tablesListExample($service, $projectId, $datasetId));
...
* @return TableList</returns>
*/
function tablesListExample($service, $projectId, $datasetId)
{
	try
	{
		...
		return $service->tables->ListTables($projectId, $datasetId);
	}
	catch (Exception $ex)
	{
