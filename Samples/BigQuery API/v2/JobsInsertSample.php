...
// Single Request.
$results = jobsInsertExample($service, $projectId, $optParams);
...
* @return Job
*/
function jobsInsertExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->jobs->InsertJobs($projectId, $optParams);
	}
	catch (Exception $e)
	{
