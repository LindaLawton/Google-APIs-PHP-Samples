...
$results = datasetsUpdateExample($service, $projectId, $datasetId, $optParams);
...
* @return Dataset
*/
function datasetsUpdateExample($service, $projectId, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->UpdateDatasets($projectId, $datasetId, $optParams);
	}
	catch (Exception $e)
	{
