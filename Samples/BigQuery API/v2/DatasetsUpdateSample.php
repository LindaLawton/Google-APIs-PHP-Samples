...
print_r(datasetsUpdateExample($service, $projectId, $datasetId));
...
*/
function datasetsUpdateExample($service, $projectId, $datasetId)
{
	try
	{
		...
		return $service->datasets->UpdateDatasets($projectId, $datasetId);
	}
	catch (Exception $ex)
	{
