...
// Single Request.
$results = projectsGetServiceAccountExample($service, $projectId, $optParams);
...
*/
function projectsGetServiceAccountExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->GetServiceAccountProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
