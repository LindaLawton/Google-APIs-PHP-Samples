...
print_r(projectsGetServiceAccountExample($service, $projectId));
...
* @return GetServiceAccountResponse</returns>
*/
function projectsGetServiceAccountExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->GetServiceAccountProjects($projectId);
	}
	catch (Exception $ex)
	{
