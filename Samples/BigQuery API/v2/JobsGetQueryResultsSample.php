...
print_r(jobsGetQueryResultsExample($service, $projectId, $jobId));
...
* @return GetQueryResultsResponse</returns>
*/
function jobsGetQueryResultsExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->jobs->GetQueryResultsJobs($projectId, $jobId);
	}
	catch (Exception $ex)
	{
