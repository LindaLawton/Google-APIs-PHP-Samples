...
# UnOfficial BigQuery API v2 Samples for PHP
...
These samples show how to access the [BigQuery API v2](https://cloud.google.com/bigquery/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
