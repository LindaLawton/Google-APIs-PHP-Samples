...
print_r(datasetsDeleteExample($service, $projectId, $datasetId));
...
*/
function datasetsDeleteExample($service, $projectId, $datasetId)
{
	try
	{
		...
		return $service->datasets->DeleteDatasets($projectId, $datasetId);
	}
	catch (Exception $ex)
	{
