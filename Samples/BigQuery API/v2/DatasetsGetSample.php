...
$results = datasetsGetExample($service, $projectId, $datasetId, $optParams);
...
* @return Dataset
*/
function datasetsGetExample($service, $projectId, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->GetDatasets($projectId, $datasetId, $optParams);
	}
	catch (Exception $e)
	{
