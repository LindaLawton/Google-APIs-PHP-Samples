...
print_r(datasetsGetExample($service, $projectId, $datasetId));
...
*/
function datasetsGetExample($service, $projectId, $datasetId)
{
	try
	{
		...
		return $service->datasets->GetDatasets($projectId, $datasetId);
	}
	catch (Exception $ex)
	{
