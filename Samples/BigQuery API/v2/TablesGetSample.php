...
print_r(tablesGetExample($service, $projectId, $datasetId, $tableId));
...
*/
function tablesGetExample($service, $projectId, $datasetId, $tableId)
{
	try
	{
		...
		return $service->tables->GetTables($projectId, $datasetId, $tableId);
	}
	catch (Exception $ex)
	{
