...
print_r(jobsQueryExample($service, $projectId));

/**
* Runs a BigQuery SQL query synchronously and returns query results if the query completes within a specified timeout.
* @service Authenticated Bigquery service.
* @projectId Project ID of the project billed for the query
* @return QueryResponse</returns>
*/
function jobsQueryExample($service, $projectId)
{
	try
	{
		...
		return $service->jobs->QueryJobs($projectId);
	}
	catch (Exception $ex)
	{
