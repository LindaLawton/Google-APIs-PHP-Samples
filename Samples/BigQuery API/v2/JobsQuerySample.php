...
$results = jobsQueryExample($service, $projectId, $optParams);
...
*/
function jobsQueryExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->jobs->QueryJobs($projectId, $optParams);
	}
	catch (Exception $e)
	{
