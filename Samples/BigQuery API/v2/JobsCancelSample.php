...
print_r(jobsCancelExample($service, $projectId, $jobId));
...
* @return JobCancelResponse</returns>
*/
function jobsCancelExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->jobs->CancelJobs($projectId, $jobId);
	}
	catch (Exception $ex)
	{
