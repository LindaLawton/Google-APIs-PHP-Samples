...
$results = jobsCancelExample($service, $projectId, $jobId, $optParams);
...
*/
function jobsCancelExample($service, $projectId, $jobId, $optParams)
{
	try
	{
		...
		return $service->jobs->CancelJobs($projectId, $jobId, $optParams);
	}
	catch (Exception $e)
	{
