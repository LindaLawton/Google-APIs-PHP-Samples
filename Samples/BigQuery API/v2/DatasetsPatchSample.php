...
print_r(datasetsPatchExample($service, $projectId, $datasetId));
...
*/
function datasetsPatchExample($service, $projectId, $datasetId)
{
	try
	{
		...
		return $service->datasets->PatchDatasets($projectId, $datasetId);
	}
	catch (Exception $ex)
	{
