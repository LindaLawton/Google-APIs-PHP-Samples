...
// Single Request.
$results = datasetsPatchExample($service, $projectId, $datasetId, $optParams);
...
* @return Dataset
*/
function datasetsPatchExample($service, $projectId, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->PatchDatasets($projectId, $datasetId, $optParams);
	}
	catch (Exception $e)
	{
