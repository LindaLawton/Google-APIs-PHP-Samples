...
// Single Request.
$results = versionsCreateExample($service, $parent, $optParams);
...
* @return GoogleLongrunning__Operation
*/
function versionsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->versions->CreateVersions($parent, $optParams);
	}
	catch (Exception $e)
	{
