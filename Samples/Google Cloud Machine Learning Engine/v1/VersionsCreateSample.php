...
print_r(versionsCreateExample($service, $parent));
...
* @return GoogleLongrunning__Operation</returns>
*/
function versionsCreateExample($service, $parent)
{
	try
	{
		...
		return $service->versions->CreateVersions($parent);
	}
	catch (Exception $ex)
	{
