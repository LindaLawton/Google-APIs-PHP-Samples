...
// Single Request.
$results = jobsGetIamPolicyExample($service, $resource, $optParams);
...
*/
function jobsGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->jobs->GetIamPolicyJobs($resource, $optParams);
	}
	catch (Exception $e)
	{
