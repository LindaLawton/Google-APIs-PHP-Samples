...
print_r(jobsGetIamPolicyExample($service, $resource));
...
* @return GoogleIamV1__Policy</returns>
*/
function jobsGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->jobs->GetIamPolicyJobs($resource);
	}
	catch (Exception $ex)
	{
