...
// Single Request.
$results = jobsSetIamPolicyExample($service, $resource, $optParams);
...
* @return GoogleIamV1__Policy
*/
function jobsSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->jobs->SetIamPolicyJobs($resource, $optParams);
	}
	catch (Exception $e)
	{
