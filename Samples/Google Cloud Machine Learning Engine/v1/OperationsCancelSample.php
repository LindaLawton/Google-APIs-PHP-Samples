...
print_r(operationsCancelExample($service, $name));
...
* @return GoogleProtobuf__Empty</returns>
*/
function operationsCancelExample($service, $name)
{
	try
	{
		...
		return $service->operations->CancelOperations($name);
	}
	catch (Exception $ex)
	{
