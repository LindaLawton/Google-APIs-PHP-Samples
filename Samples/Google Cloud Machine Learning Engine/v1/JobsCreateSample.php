...
$results = jobsCreateExample($service, $parent, $optParams);
...
* @return GoogleCloudMlV1__Job
*/
function jobsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->jobs->CreateJobs($parent, $optParams);
	}
	catch (Exception $e)
	{
