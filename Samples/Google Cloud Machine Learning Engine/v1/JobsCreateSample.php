...
print_r(jobsCreateExample($service, $parent));

/**
* Creates a training or a batch prediction job.
* @service Authenticated Cloudmachinelearningengine service.
* @parent Required. The project name.
* @return GoogleCloudMlV1__Job</returns>
*/
function jobsCreateExample($service, $parent)
{
	try
	{
		...
		return $service->jobs->CreateJobs($parent);
	}
	catch (Exception $ex)
	{
