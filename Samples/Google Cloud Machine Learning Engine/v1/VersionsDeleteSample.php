...
// Single Request.
$results = versionsDeleteExample($service, $name, $optParams);
...
*/
function versionsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->versions->DeleteVersions($name, $optParams);
	}
	catch (Exception $e)
	{
