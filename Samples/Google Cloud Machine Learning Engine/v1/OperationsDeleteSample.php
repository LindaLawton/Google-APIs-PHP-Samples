...
// Single Request.
$results = operationsDeleteExample($service, $name, $optParams);
...
*/
function operationsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->operations->DeleteOperations($name, $optParams);
	}
	catch (Exception $e)
	{
