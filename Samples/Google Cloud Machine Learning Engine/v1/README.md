...
# UnOfficial Google Cloud Machine Learning Engine v1 Samples for PHP

## API Description

An API to enable creating and using machine learning models.

[Official Documentation](https://cloud.google.com/ml/)

## Sample Description

These samples show how to access the [Google Cloud Machine Learning Engine v1](https://cloud.google.com/ml/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
