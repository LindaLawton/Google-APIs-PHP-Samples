...
// Single Request.
$results = versionsSetDefaultExample($service, $name, $optParams);
...
* @return GoogleCloudMlV1__Version
*/
function versionsSetDefaultExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->versions->SetDefaultVersions($name, $optParams);
	}
	catch (Exception $e)
	{
