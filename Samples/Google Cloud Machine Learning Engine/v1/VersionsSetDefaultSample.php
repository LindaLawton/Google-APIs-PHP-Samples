...
print_r(versionsSetDefaultExample($service, $name));
...
* @return GoogleCloudMlV1__Version</returns>
*/
function versionsSetDefaultExample($service, $name)
{
	try
	{
		...
		return $service->versions->SetDefaultVersions($name);
	}
	catch (Exception $ex)
	{
