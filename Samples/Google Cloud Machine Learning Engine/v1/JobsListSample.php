...
print_r(jobsListExample($service, $parent));
...
* @return GoogleCloudMlV1__ListJobsResponse</returns>
*/
function jobsListExample($service, $parent)
{
	try
	{
		...
		return $service->jobs->ListJobs($parent);
	}
	catch (Exception $ex)
	{
