...
print_r(jobsTestIamPermissionsExample($service, $resource));
...
* @return GoogleIamV1__TestIamPermissionsResponse</returns>
*/
function jobsTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->jobs->TestIamPermissionsJobs($resource);
	}
	catch (Exception $ex)
	{
