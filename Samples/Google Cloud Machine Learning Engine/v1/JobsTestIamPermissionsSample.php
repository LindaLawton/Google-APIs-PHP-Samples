...
// Single Request.
$results = jobsTestIamPermissionsExample($service, $resource, $optParams);
...
* @return GoogleIamV1__TestIamPermissionsResponse
*/
function jobsTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->jobs->TestIamPermissionsJobs($resource, $optParams);
	}
	catch (Exception $e)
	{
