...
print_r(operationsListExample($service, $name));
...
* @return GoogleLongrunning__ListOperationsResponse</returns>
*/
function operationsListExample($service, $name)
{
	try
	{
		...
		return $service->operations->ListOperations($name);
	}
	catch (Exception $ex)
	{
