...
print_r(versionsListExample($service, $parent));
...
* @return GoogleCloudMlV1__ListVersionsResponse</returns>
*/
function versionsListExample($service, $parent)
{
	try
	{
		...
		return $service->versions->ListVersions($parent);
	}
	catch (Exception $ex)
	{
