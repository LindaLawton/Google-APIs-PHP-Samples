...
print_r(leaderboardsListExample($service));

/**
* Lists all the leaderboard metadata for your application.
* @service Authenticated Games service.
* @return LeaderboardListResponse</returns>
*/
function leaderboardsListExample($service)
{
	try
	{
		...
		return $service->leaderboards->ListLeaderboards();
	}
	catch (Exception $ex)
	{
