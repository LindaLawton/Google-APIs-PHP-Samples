...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of leaderboards to return in the response. For any response, the actual number of leaderboards returned may be less than the specified maxResults.
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = leaderboardsListExample($service, $optParams);
...
*/
function leaderboardsListExample($service, $optParams)
{
	try
	{
		...
		return $service->leaderboards->ListLeaderboards($optParams);
	}
	catch (Exception $e)
	{
