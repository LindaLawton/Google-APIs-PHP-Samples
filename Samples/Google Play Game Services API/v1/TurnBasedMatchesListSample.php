...
print_r(turnBasedMatchesListExample($service));

/**
* Returns turn-based matches the player is or was involved in.
* @service Authenticated Games service.
* @return TurnBasedMatchList</returns>
*/
function turnBasedMatchesListExample($service)
{
	try
	{
		...
		return $service->turnBasedMatches->ListTurnBasedMatches();
	}
	catch (Exception $ex)
	{
