...
$results = applicationsPlayedExample($service, $optParams);
...
*/
function applicationsPlayedExample($service, $optParams)
{
	try
	{
		...
		return $service->applications->PlayedApplications($optParams);
	}
	catch (Exception $e)
	{
