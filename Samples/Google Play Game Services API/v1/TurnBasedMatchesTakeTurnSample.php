...
// Single Request.
$results = turnBasedMatchesTakeTurnExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesTakeTurnExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->TakeTurnTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
