...
print_r(turnBasedMatchesTakeTurnExample($service, $matchId));
...
*/
function turnBasedMatchesTakeTurnExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->TakeTurnTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
