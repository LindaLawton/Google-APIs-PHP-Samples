...
print_r(turnBasedMatchesLeaveTurnExample($service, $matchId, $matchVersion));
...
* @return TurnBasedMatch</returns>
*/
function turnBasedMatchesLeaveTurnExample($service, $matchId, $matchVersion)
{
	try
	{
		...
		return $service->turnBasedMatches->LeaveTurnTurnBasedMatches($matchId, $matchVersion);
	}
	catch (Exception $ex)
	{
