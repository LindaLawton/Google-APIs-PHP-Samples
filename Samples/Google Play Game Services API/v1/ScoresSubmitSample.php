...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'scoreTag' => '[YourValue]',  //Additional information about the score you're submitting. Values must contain no more than 64 URI-safe characters as defined by section 2.3 of RFC 3986.
  'fields' => '*'
);
// Single Request.
$results = scoresSubmitExample($service, $leaderboardId, $score, $optParams);
...
*/
function scoresSubmitExample($service, $leaderboardId, $score, $optParams)
{
	try
	{
		...
		return $service->scores->SubmitScores($leaderboardId, $score, $optParams);
	}
	catch (Exception $e)
	{
