...
print_r(scoresSubmitExample($service, $leaderboardId, $score));
...
* @return PlayerScoreResponse</returns>
*/
function scoresSubmitExample($service, $leaderboardId, $score)
{
	try
	{
		...
		return $service->scores->SubmitScores($leaderboardId, $score);
	}
	catch (Exception $ex)
	{
