...
print_r(questsListExample($service, $playerId));
...
* @return QuestListResponse</returns>
*/
function questsListExample($service, $playerId)
{
	try
	{
		...
		return $service->quests->ListQuests($playerId);
	}
	catch (Exception $ex)
	{
