...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of quest resources to return in the response, used for paging. For any response, the actual number of quest resources returned may be less than the specified maxResults. Acceptable values are 1 to 50, inclusive. (Default: 50).
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = questsListExample($service, $playerId, $optParams);
...
*/
function questsListExample($service, $playerId, $optParams)
{
	try
	{
		...
		return $service->quests->ListQuests($playerId, $optParams);
	}
	catch (Exception $e)
	{
