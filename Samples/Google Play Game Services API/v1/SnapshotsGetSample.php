...
$results = snapshotsGetExample($service, $snapshotId, $optParams);
...
* @return Snapshot
*/
function snapshotsGetExample($service, $snapshotId, $optParams)
{
	try
	{
		...
		if (snapshotId == null)
			throw new Exception("snapshotId is required.");
		// Make the request and return the results.
		return $service->snapshots->GetSnapshots($snapshotId, $optParams);
	}
	catch (Exception $e)
	{
