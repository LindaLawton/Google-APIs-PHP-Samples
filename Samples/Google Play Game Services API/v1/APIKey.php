 ...
 * Initializes an Games.v1 service object.
 * @param string API key
 * @return An authorized Games.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Games Sample");
		...
		// Create authenticated Games service
		return new Google_Service_Games($client);
	} catch (Exception $e) {
