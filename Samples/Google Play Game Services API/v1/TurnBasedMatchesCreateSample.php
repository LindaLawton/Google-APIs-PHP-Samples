...
// Single Request.
$results = turnBasedMatchesCreateExample($service, $optParams);
...
*/
function turnBasedMatchesCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->CreateTurnBasedMatches($optParams);
	}
	catch (Exception $e)
	{
