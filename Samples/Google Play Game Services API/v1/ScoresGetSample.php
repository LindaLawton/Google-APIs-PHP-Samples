...
print_r(get($service, $playerId, $leaderboardId, $timeSpan));
...
*/
function get($service, $playerId, $leaderboardId, $timeSpan)
{
	try
	{
		...
		return $service->get($playerId, $leaderboardId, $timeSpan);
	}
	catch (Exception $ex)
	{
