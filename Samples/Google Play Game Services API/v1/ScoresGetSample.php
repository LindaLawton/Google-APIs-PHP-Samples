...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeRankType' => '[YourValue]',  // The types of ranks to return. If the parameter is omitted, no ranks will be returned.
...
// Single Request.
$results = scoresGetExample($service, $playerId, $leaderboardId, $timeSpan, $optParams);
...
do {
	...
	$results = filesListExample($service, $playerId, $leaderboardId, $timeSpan, $optParams);	
...
*/
function scoresGetExample($service, $playerId, $leaderboardId, $timeSpan, $optParams)
{
	try
	{
		...
		return $service->scores->GetScores($playerId, $leaderboardId, $timeSpan, $optParams);
	}
	catch (Exception $e)
	{
