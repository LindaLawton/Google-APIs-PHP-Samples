...
print_r(scoresGetExample($service, $playerId, $leaderboardId, $timeSpan));
...
* @return PlayerLeaderboardScoreListResponse</returns>
*/
function scoresGetExample($service, $playerId, $leaderboardId, $timeSpan)
{
	try
	{
		...
		return $service->scores->GetScores($playerId, $leaderboardId, $timeSpan);
	}
	catch (Exception $ex)
	{
