...
// Single Request.
$results = metagameGetMetagameConfigExample($service, $optParams);
...
*/
function metagameGetMetagameConfigExample($service, $optParams)
{
	try
	{
		...
		return $service->metagame->GetMetagameConfigMetagame($optParams);
	}
	catch (Exception $e)
	{
