...
print_r(metagameGetMetagameConfigExample($service));

/**
* Return the metagame configuration data for the calling application.
* @service Authenticated Games service.
* @return MetagameConfig</returns>
*/
function metagameGetMetagameConfigExample($service)
{
	try
	{
		...
		return $service->metagame->GetMetagameConfigMetagame();
	}
	catch (Exception $ex)
	{
