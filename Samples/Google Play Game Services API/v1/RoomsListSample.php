...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  //The maximum number of rooms to return in the response, used for paging. For any response, the actual number of rooms to return may be less than the specified maxResults.
            
  //'pageToken' => '[YourValue]',  //The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = roomsListExample($service, $optParams);
...
* @return RoomList
*/
function roomsListExample($service, $optParams)
{
	try
	{
		...
		return $service->rooms->ListRooms($optParams);
	}
	catch (Exception $e)
	{
