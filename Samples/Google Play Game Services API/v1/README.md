...
# UnOfficial Google Play Game Services API v1 Samples for PHP
...
These samples show how to access the [Google Play Game Services API v1](https://developers.google.com/games/services/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
