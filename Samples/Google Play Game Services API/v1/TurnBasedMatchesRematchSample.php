...
// Single Request.
$results = turnBasedMatchesRematchExample($service, $matchId, $optParams);
...
* @return TurnBasedMatchRematch
*/
function turnBasedMatchesRematchExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->RematchTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
