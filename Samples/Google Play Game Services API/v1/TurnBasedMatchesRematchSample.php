...
print_r(turnBasedMatchesRematchExample($service, $matchId));
...
* @return TurnBasedMatchRematch</returns>
*/
function turnBasedMatchesRematchExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->RematchTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
