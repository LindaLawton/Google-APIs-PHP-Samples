...
print_r(claim($service, $questId, $milestoneId, $requestId));
...
*/
function claim($service, $questId, $milestoneId, $requestId)
{
	try
	{
		...
		return $service->claim($questId, $milestoneId, $requestId);
	}
	catch (Exception $ex)
	{
