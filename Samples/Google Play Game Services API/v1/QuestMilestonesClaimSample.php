...
$results = questMilestonesClaimExample($service, $questId, $milestoneId, $requestId, $optParams);
...
*/
function questMilestonesClaimExample($service, $questId, $milestoneId, $requestId, $optParams)
{
	try
	{
		...
		if (milestoneId == null)
			throw new Exception("milestoneId is required.");
		if (questId == null)
			throw new Exception("questId is required.");
		if (requestId == null)
			throw new Exception("requestId is required.");
		// Make the request and return the results.
		return $service->questMilestones->ClaimQuestMilestones($questId, $milestoneId, $requestId, $optParams);
	}
	catch (Exception $e)
	{
