...
print_r(questMilestonesClaimExample($service, $questId, $milestoneId, $requestId));
...
*/
function questMilestonesClaimExample($service, $questId, $milestoneId, $requestId)
{
	try
	{
		...
		return $service->questMilestones->ClaimQuestMilestones($questId, $milestoneId, $requestId);
	}
	catch (Exception $ex)
	{
