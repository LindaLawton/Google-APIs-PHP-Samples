...
print_r(turnBasedMatchesDismissExample($service, $matchId));
...
*/
function turnBasedMatchesDismissExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->DismissTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
