...
print_r(listWindow($service, $leaderboardId, $collection, $timeSpan));
...
*/
function listWindow($service, $leaderboardId, $collection, $timeSpan)
{
	try
	{
		...
		return $service->listWindow($leaderboardId, $collection, $timeSpan);
	}
	catch (Exception $ex)
	{
