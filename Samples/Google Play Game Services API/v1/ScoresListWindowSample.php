...
print_r(scoresListWindowExample($service, $leaderboardId, $collection, $timeSpan));
...
* @return LeaderboardScores</returns>
*/
function scoresListWindowExample($service, $leaderboardId, $collection, $timeSpan)
{
	try
	{
		...
		return $service->scores->ListWindowScores($leaderboardId, $collection, $timeSpan);
	}
	catch (Exception $ex)
	{
