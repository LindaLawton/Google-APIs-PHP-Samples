...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of category resources to return in the response, used for paging. For any response, the actual number of category resources returned may be less than the specified maxResults.
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = metagameListCategoriesByPlayerExample($service, $playerId, $collection, $optParams);
...
do {
	...
	$results = filesListExample($service, $playerId, $collection, $optParams);	
...
*/
function metagameListCategoriesByPlayerExample($service, $playerId, $collection, $optParams)
{
	try
	{
		...
		return $service->metagame->ListCategoriesByPlayerMetagame($playerId, $collection, $optParams);
	}
	catch (Exception $e)
	{
