...
print_r(metagameListCategoriesByPlayerExample($service, $playerId, $collection));
...
* @return CategoryListResponse</returns>
*/
function metagameListCategoriesByPlayerExample($service, $playerId, $collection)
{
	try
	{
		...
		return $service->metagame->ListCategoriesByPlayerMetagame($playerId, $collection);
	}
	catch (Exception $ex)
	{
