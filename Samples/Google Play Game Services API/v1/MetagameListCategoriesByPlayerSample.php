...
print_r(listCategoriesByPlayer($service, $playerId, $collection));
...
*/
function listCategoriesByPlayer($service, $playerId, $collection)
{
	try
	{
		...
		return $service->listCategoriesByPlayer($playerId, $collection);
	}
	catch (Exception $ex)
	{
