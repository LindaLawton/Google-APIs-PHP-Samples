...
print_r(achievementsUnlockExample($service, $achievementId));

/**
* Unlocks this achievement for the currently authenticated player.
* @service Authenticated Games service.
* @achievementId The ID of the achievement used by this method.
* @return AchievementUnlockResponse</returns>
*/
function achievementsUnlockExample($service, $achievementId)
{
	try
	{
		...
		return $service->achievements->UnlockAchievements($achievementId);
	}
	catch (Exception $ex)
	{
