...
// Single Request.
$results = achievementsUnlockExample($service, $achievementId, $optParams);
...
*/
function achievementsUnlockExample($service, $achievementId, $optParams)
{
	try
	{
		...
		return $service->achievements->UnlockAchievements($achievementId, $optParams);
	}
	catch (Exception $e)
	{
