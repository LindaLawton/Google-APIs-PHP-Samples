...
// Single Request.
$results = turnBasedMatchesJoinExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesJoinExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->JoinTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
