...
print_r(turnBasedMatchesJoinExample($service, $matchId));
...
*/
function turnBasedMatchesJoinExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->JoinTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
