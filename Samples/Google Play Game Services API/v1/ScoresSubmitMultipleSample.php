...
print_r(scoresSubmitMultipleExample($service));

/**
* Submits multiple scores to leaderboards.
* @service Authenticated Games service.
* @return PlayerScoreListResponse</returns>
*/
function scoresSubmitMultipleExample($service)
{
	try
	{
		...
		return $service->scores->SubmitMultipleScores();
	}
	catch (Exception $ex)
	{
