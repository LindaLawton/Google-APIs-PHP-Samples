...
// Single Request.
$results = scoresSubmitMultipleExample($service, $optParams);
...
*/
function scoresSubmitMultipleExample($service, $optParams)
{
	try
	{
		...
		return $service->scores->SubmitMultipleScores($optParams);
	}
	catch (Exception $e)
	{
