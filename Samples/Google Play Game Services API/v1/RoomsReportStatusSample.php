...
// Single Request.
$results = roomsReportStatusExample($service, $roomId, $optParams);
...
* @return RoomStatus
*/
function roomsReportStatusExample($service, $roomId, $optParams)
{
	try
	{
		...
		return $service->rooms->ReportStatusRooms($roomId, $optParams);
	}
	catch (Exception $e)
	{
