...
print_r(roomsReportStatusExample($service, $roomId));

/**
* Updates sent by a client reporting the status of peers in a room. For internal use by the Games SDK only. Calling this method directly is unsupported.
* @service Authenticated Games service.
* @roomId The ID of the room.
* @return RoomStatus</returns>
*/
function roomsReportStatusExample($service, $roomId)
{
	try
	{
		...
		return $service->rooms->ReportStatusRooms($roomId);
	}
	catch (Exception $ex)
	{
