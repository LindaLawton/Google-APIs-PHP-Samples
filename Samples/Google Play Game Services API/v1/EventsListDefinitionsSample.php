...
print_r(eventsListDefinitionsExample($service));

/**
* Returns a list of the event definitions in this application.
* @service Authenticated Games service.
* @return EventDefinitionListResponse</returns>
*/
function eventsListDefinitionsExample($service)
{
	try
	{
		...
		return $service->events->ListDefinitionsEvents();
	}
	catch (Exception $ex)
	{
