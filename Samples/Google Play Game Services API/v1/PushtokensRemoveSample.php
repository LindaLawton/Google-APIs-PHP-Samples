...
$results = pushtokensRemoveExample($service, $optParams);
...
*/
function pushtokensRemoveExample($service, $optParams)
{
	try
	{
		...
		return $service->pushtokens->RemovePushtokens($optParams);
	}
	catch (Exception $e)
	{
