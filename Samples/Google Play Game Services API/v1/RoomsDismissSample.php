...
$results = roomsDismissExample($service, $roomId, $optParams);
...
*/
function roomsDismissExample($service, $roomId, $optParams)
{
	try
	{
		...
		return $service->rooms->DismissRooms($roomId, $optParams);
	}
	catch (Exception $e)
	{
