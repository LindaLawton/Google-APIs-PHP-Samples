...
print_r(turnBasedMatchesDeclineExample($service, $matchId));
...
*/
function turnBasedMatchesDeclineExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->DeclineTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
