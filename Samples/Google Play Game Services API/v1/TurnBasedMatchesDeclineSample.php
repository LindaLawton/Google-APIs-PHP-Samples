...
// Single Request.
$results = turnBasedMatchesDeclineExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesDeclineExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->DeclineTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
