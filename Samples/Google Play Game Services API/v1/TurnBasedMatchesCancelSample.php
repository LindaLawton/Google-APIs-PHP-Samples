...
print_r(turnBasedMatchesCancelExample($service, $matchId));
...
*/
function turnBasedMatchesCancelExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->CancelTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
