...
$results = turnBasedMatchesCancelExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesCancelExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->CancelTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
