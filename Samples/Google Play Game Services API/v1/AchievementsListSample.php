...
print_r(achievementsListExample($service, $playerId));
...
* @return PlayerAchievementListResponse</returns>
*/
function achievementsListExample($service, $playerId)
{
	try
	{
		...
		return $service->achievements->ListAchievements($playerId);
	}
	catch (Exception $ex)
	{
