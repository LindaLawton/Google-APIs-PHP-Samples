...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of achievement resources to return in the response, used for paging. For any response, the actual number of achievement resources returned may be less than the specified maxResults.
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
            
  //'state' => '[YourValue]',  // Tells the server to return only achievements with the specified state. If this parameter isn't specified, all achievements are returned.
  'fields' => '*'
);
// Single Request.
$results = achievementsListExample($service, $playerId, $optParams);
...
do {
	...
	$results = filesListExample($service, $playerId, $optParams);	
...
*/
function achievementsListExample($service, $playerId, $optParams)
{
	try
	{
		...
		return $service->achievements->ListAchievements($playerId, $optParams);
	}
	catch (Exception $e)
	{
