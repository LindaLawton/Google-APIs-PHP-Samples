...
print_r(applicationsVerifyExample($service, $applicationId));
...
* @return ApplicationVerifyResponse</returns>
*/
function applicationsVerifyExample($service, $applicationId)
{
	try
	{
		...
		return $service->applications->VerifyApplications($applicationId);
	}
	catch (Exception $ex)
	{
