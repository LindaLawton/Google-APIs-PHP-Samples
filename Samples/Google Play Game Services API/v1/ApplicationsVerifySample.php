...
$results = applicationsVerifyExample($service, $applicationId, $optParams);
...
*/
function applicationsVerifyExample($service, $applicationId, $optParams)
{
	try
	{
		...
		return $service->applications->VerifyApplications($applicationId, $optParams);
	}
	catch (Exception $e)
	{
