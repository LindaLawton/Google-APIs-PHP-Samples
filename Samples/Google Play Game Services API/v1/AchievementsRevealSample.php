...
// Single Request.
$results = achievementsRevealExample($service, $achievementId, $optParams);
...
*/
function achievementsRevealExample($service, $achievementId, $optParams)
{
	try
	{
		...
		return $service->achievements->RevealAchievements($achievementId, $optParams);
	}
	catch (Exception $e)
	{
