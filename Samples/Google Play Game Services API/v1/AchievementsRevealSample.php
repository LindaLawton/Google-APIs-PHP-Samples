...
print_r(achievementsRevealExample($service, $achievementId));

/**
* Sets the state of the achievement with the given ID to REVEALED for the currently authenticated player.
* @service Authenticated Games service.
* @achievementId The ID of the achievement used by this method.
* @return AchievementRevealResponse</returns>
*/
function achievementsRevealExample($service, $achievementId)
{
	try
	{
		...
		return $service->achievements->RevealAchievements($achievementId);
	}
	catch (Exception $ex)
	{
