...
print_r(achievementsIncrementExample($service, $achievementId, $stepsToIncrement));
...
* @return AchievementIncrementResponse</returns>
*/
function achievementsIncrementExample($service, $achievementId, $stepsToIncrement)
{
	try
	{
		...
		return $service->achievements->IncrementAchievements($achievementId, $stepsToIncrement);
	}
	catch (Exception $ex)
	{
