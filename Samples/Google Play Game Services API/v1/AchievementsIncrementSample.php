...
print_r(increment($service, $achievementId, $stepsToIncrement));
...
*/
function increment($service, $achievementId, $stepsToIncrement)
{
	try
	{
		...
		return $service->increment($achievementId, $stepsToIncrement);
	}
	catch (Exception $ex)
	{
