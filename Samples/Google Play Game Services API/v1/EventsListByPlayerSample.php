...
print_r(eventsListByPlayerExample($service));

/**
* Returns a list showing the current progress on events in this application for the currently authenticated user.
* @service Authenticated Games service.
* @return PlayerEventListResponse</returns>
*/
function eventsListByPlayerExample($service)
{
	try
	{
		...
		return $service->events->ListByPlayerEvents();
	}
	catch (Exception $ex)
	{
