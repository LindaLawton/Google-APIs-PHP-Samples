...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of events to return in the response, used for paging. For any response, the actual number of events to return may be less than the specified maxResults.
            
  //'pageToken' => '[YourValue]',  // The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = eventsListByPlayerExample($service, $optParams);
...
*/
function eventsListByPlayerExample($service, $optParams)
{
	try
	{
		...
		return $service->events->ListByPlayerEvents($optParams);
	}
	catch (Exception $e)
	{
