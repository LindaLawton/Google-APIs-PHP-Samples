...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  //The maximum number of snapshot resources to return in the response, used for paging. For any response, the actual number of snapshot resources returned may be less than the specified maxResults.
            
  //'pageToken' => '[YourValue]',  //The token returned by the previous request.
  'fields' => '*'
);
// Single Request.
$results = snapshotsListExample($service, $playerId, $optParams);
...
*/
function snapshotsListExample($service, $playerId, $optParams)
{
	try
	{
		...
		return $service->snapshots->ListSnapshots($playerId, $optParams);
	}
	catch (Exception $e)
	{
