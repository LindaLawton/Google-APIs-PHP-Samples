...
print_r(snapshotsListExample($service, $playerId));
...
* @return SnapshotListResponse</returns>
*/
function snapshotsListExample($service, $playerId)
{
	try
	{
		...
		return $service->snapshots->ListSnapshots($playerId);
	}
	catch (Exception $ex)
	{
