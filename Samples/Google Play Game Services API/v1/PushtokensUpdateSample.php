...
$results = pushtokensUpdateExample($service, $optParams);
...
*/
function pushtokensUpdateExample($service, $optParams)
{
	try
	{
		...
		return $service->pushtokens->UpdatePushtokens($optParams);
	}
	catch (Exception $e)
	{
