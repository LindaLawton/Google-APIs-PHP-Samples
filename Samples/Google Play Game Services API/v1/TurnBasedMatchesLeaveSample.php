...
$results = turnBasedMatchesLeaveExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesLeaveExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->LeaveTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
