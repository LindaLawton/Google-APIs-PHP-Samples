...
print_r(turnBasedMatchesLeaveExample($service, $matchId));
...
*/
function turnBasedMatchesLeaveExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->LeaveTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
