...
print_r(achievementDefinitionsListExample($service));

/**
* Lists all the achievement definitions for your application.
* @service Authenticated Games service.
* @return AchievementDefinitionsListResponse</returns>
*/
function achievementDefinitionsListExample($service)
{
	try
	{
		...
		return $service->achievementDefinitions->ListAchievementDefinitions();
	}
	catch (Exception $ex)
	{
