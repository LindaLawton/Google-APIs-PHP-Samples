...
// Single Request.
$results = achievementDefinitionsListExample($service, $optParams);
...
*/
function achievementDefinitionsListExample($service, $optParams)
{
	try
	{
		...
		return $service->achievementDefinitions->ListAchievementDefinitions($optParams);
	}
	catch (Exception $e)
	{
