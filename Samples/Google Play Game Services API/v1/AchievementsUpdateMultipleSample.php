...
$results = achievementsUpdateMultipleExample($service, $optParams);
...
*/
function achievementsUpdateMultipleExample($service, $optParams)
{
	try
	{
		...
		return $service->achievements->UpdateMultipleAchievements($optParams);
	}
	catch (Exception $e)
	{
