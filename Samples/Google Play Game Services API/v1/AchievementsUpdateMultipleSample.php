...
print_r(achievementsUpdateMultipleExample($service));

/**
* Updates multiple achievements for the currently authenticated player.
* @service Authenticated Games service.
* @return AchievementUpdateMultipleResponse</returns>
*/
function achievementsUpdateMultipleExample($service)
{
	try
	{
		...
		return $service->achievements->UpdateMultipleAchievements();
	}
	catch (Exception $ex)
	{
