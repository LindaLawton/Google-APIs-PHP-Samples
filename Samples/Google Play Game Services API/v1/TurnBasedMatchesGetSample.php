...
print_r(turnBasedMatchesGetExample($service, $matchId));
...
*/
function turnBasedMatchesGetExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->GetTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
