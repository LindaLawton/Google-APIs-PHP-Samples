...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeMatchData' => '[YourValue]',  // Get match data along with metadata.
            
  //'language' => '[YourValue]',  // The preferred language to use for strings returned by this method.
  'fields' => '*'
);
// Single Request.
$results = turnBasedMatchesGetExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesGetExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->GetTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
