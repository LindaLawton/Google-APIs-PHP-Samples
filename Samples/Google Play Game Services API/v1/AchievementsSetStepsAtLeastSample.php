...
print_r(achievementsSetStepsAtLeastExample($service, $achievementId, $steps));
...
* @return AchievementSetStepsAtLeastResponse</returns>
*/
function achievementsSetStepsAtLeastExample($service, $achievementId, $steps)
{
	try
	{
		...
		if (steps == null)
			throw new Exception("steps is required.");
		// Make the request and return the results.
		return $service->achievements->SetStepsAtLeastAchievements($achievementId, $steps);
	}
	catch (Exception $ex)
	{
