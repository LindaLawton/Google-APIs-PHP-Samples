...
print_r(setStepsAtLeast($service, $achievementId, $steps));
...
*/
function setStepsAtLeast($service, $achievementId, $steps)
{
	try
	{
		...
		return $service->setStepsAtLeast($achievementId, $steps);
	}
	catch (Exception $ex)
	{
