...
// Single Request.
$results = questsAcceptExample($service, $questId, $optParams);
...
* @return Quest
*/
function questsAcceptExample($service, $questId, $optParams)
{
	try
	{
		...
		return $service->quests->AcceptQuests($questId, $optParams);
	}
	catch (Exception $e)
	{
