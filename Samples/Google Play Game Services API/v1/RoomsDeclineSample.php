...
// Single Request.
$results = roomsDeclineExample($service, $roomId, $optParams);
...
* @return Room
*/
function roomsDeclineExample($service, $roomId, $optParams)
{
	try
	{
		...
		return $service->rooms->DeclineRooms($roomId, $optParams);
	}
	catch (Exception $e)
	{
