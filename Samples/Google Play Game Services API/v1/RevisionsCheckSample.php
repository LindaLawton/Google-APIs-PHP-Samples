...
print_r(revisionsCheckExample($service, $clientRevision));
...
* @return RevisionCheckResponse</returns>
*/
function revisionsCheckExample($service, $clientRevision)
{
	try
	{
		...
		if (clientRevision == null)
			throw new Exception("clientRevision is required.");
		// Make the request and return the results.
		return $service->revisions->CheckRevisions($clientRevision);
	}
	catch (Exception $ex)
	{
