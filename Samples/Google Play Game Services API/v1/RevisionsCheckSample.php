...
// Single Request.
$results = revisionsCheckExample($service, $clientRevision, $optParams);
...
*/
function revisionsCheckExample($service, $clientRevision, $optParams)
{
	try
	{
		...
		return $service->revisions->CheckRevisions($clientRevision, $optParams);
	}
	catch (Exception $e)
	{
