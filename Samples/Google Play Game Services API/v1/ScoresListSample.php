...
print_r(scoresListExample($service, $leaderboardId, $collection, $timeSpan));
...
*/
function scoresListExample($service, $leaderboardId, $collection, $timeSpan)
{
	try
	{
		...
		return $service->scores->ListScores($leaderboardId, $collection, $timeSpan);
	}
	catch (Exception $ex)
	{
