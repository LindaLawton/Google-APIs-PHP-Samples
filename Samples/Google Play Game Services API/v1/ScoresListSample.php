...
print_r(list($service, $leaderboardId, $collection, $timeSpan));
...
*/
function list($service, $leaderboardId, $collection, $timeSpan)
{
	try
	{
		...
		return $service->list($leaderboardId, $collection, $timeSpan);
	}
	catch (Exception $ex)
	{
