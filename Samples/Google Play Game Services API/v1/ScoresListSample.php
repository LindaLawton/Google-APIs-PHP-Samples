...
// Single Request.
$results = scoresListExample($service, $leaderboardId, $collection, $timeSpan, $optParams);
...
*/
function scoresListExample($service, $leaderboardId, $collection, $timeSpan, $optParams)
{
	try
	{
		...
		return $service->scores->ListScores($leaderboardId, $collection, $timeSpan, $optParams);
	}
	catch (Exception $e)
	{
