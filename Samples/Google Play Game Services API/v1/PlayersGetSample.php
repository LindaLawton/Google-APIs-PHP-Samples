...
// Single Request.
$results = playersGetExample($service, $playerId, $optParams);
...
* @return Player
*/
function playersGetExample($service, $playerId, $optParams)
{
	try
	{
		...
		return $service->players->GetPlayers($playerId, $optParams);
	}
	catch (Exception $e)
	{
