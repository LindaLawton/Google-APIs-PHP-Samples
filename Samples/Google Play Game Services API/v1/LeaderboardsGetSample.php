...
print_r(leaderboardsGetExample($service, $leaderboardId));

/**
* Retrieves the metadata of the leaderboard with the given ID.
* @service Authenticated Games service.
* @leaderboardId The ID of the leaderboard.
* @return Leaderboard</returns>
*/
function leaderboardsGetExample($service, $leaderboardId)
{
	try
	{
		...
		return $service->leaderboards->GetLeaderboards($leaderboardId);
	}
	catch (Exception $ex)
	{
