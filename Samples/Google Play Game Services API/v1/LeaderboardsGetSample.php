...
// Single Request.
$results = leaderboardsGetExample($service, $leaderboardId, $optParams);
...
* @return Leaderboard
*/
function leaderboardsGetExample($service, $leaderboardId, $optParams)
{
	try
	{
		...
		return $service->leaderboards->GetLeaderboards($leaderboardId, $optParams);
	}
	catch (Exception $e)
	{
