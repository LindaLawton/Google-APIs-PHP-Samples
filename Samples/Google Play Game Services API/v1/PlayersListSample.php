...
// Single Request.
$results = playersListExample($service, $collection, $optParams);
...
do {
	...
	$results = filesListExample($service, $collection, $optParams);	
...
*/
function playersListExample($service, $collection, $optParams)
{
	try
	{
		...
		return $service->players->ListPlayers($collection, $optParams);
	}
	catch (Exception $e)
	{
