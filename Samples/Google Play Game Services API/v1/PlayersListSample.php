...
print_r(playersListExample($service, $collection));

/**
* Get the collection of players for the currently authenticated user.
* @service Authenticated Games service.
* @collection Collection of players being retrieved
* @return PlayerListResponse</returns>
*/
function playersListExample($service, $collection)
{
	try
	{
		...
		return $service->players->ListPlayers($collection);
	}
	catch (Exception $ex)
	{
