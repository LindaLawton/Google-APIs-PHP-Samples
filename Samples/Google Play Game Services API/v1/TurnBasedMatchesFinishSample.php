...
print_r(turnBasedMatchesFinishExample($service, $matchId));
...
*/
function turnBasedMatchesFinishExample($service, $matchId)
{
	try
	{
		...
		return $service->turnBasedMatches->FinishTurnBasedMatches($matchId);
	}
	catch (Exception $ex)
	{
