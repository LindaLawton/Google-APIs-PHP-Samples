...
// Single Request.
$results = turnBasedMatchesFinishExample($service, $matchId, $optParams);
...
*/
function turnBasedMatchesFinishExample($service, $matchId, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->FinishTurnBasedMatches($matchId, $optParams);
	}
	catch (Exception $e)
	{
