 ...
 * Initializes an Safebrowsing.v4 service object.
 * @param string API key
 * @return An authorized Safebrowsing.v4 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Safebrowsing Sample");
		...
		// Create authenticated Safebrowsing service
		return new Google_Service_Safebrowsing($client);
	} catch (Exception $e) {
