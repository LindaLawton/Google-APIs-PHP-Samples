...
// Single Request.
$results = threatMatchesFindExample($service, $optParams);
...
*/
function threatMatchesFindExample($service, $optParams)
{
	try
	{
		...
		return $service->threatMatches->FindThreatMatches($optParams);
	}
	catch (Exception $e)
	{
