...
print_r(threatMatchesFindExample($service));

/**
* Finds the threat entries that match the Safe Browsing lists.
* @service Authenticated Safebrowsing service.
* @return FindThreatMatchesResponse</returns>
*/
function threatMatchesFindExample($service)
{
	try
	{
		...
		return $service->threatMatches->FindThreatMatches();
	}
	catch (Exception $ex)
	{
