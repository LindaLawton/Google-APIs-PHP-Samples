...
print_r(encodedFullHashesGetExample($service, $encodedRequest));

/**
* 
* @service Authenticated Safebrowsing service.
* @encodedRequest A serialized FindFullHashesRequest proto.
* @return FindFullHashesResponse</returns>
*/
function encodedFullHashesGetExample($service, $encodedRequest)
{
	try
	{
		...
		return $service->encodedFullHashes->GetEncodedFullHashes($encodedRequest);
	}
	catch (Exception $ex)
	{
