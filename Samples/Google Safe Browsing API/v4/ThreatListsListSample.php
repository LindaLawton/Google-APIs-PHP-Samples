...
print_r(threatListsListExample($service));

/**
* Lists the Safe Browsing threat lists available for download.
* @service Authenticated Safebrowsing service.
* @return ListThreatListsResponse</returns>
*/
function threatListsListExample($service)
{
	try
	{
		...
		return $service->threatLists->ListThreatLists();
	}
	catch (Exception $ex)
	{
