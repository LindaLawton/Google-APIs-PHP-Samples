...
print_r(encodedUpdatesGetExample($service, $encodedRequest));

/**
* 
* @service Authenticated Safebrowsing service.
* @encodedRequest A serialized FetchThreatListUpdatesRequest proto.
* @return FetchThreatListUpdatesResponse</returns>
*/
function encodedUpdatesGetExample($service, $encodedRequest)
{
	try
	{
		...
		return $service->encodedUpdates->GetEncodedUpdates($encodedRequest);
	}
	catch (Exception $ex)
	{
