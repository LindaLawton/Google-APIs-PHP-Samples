...
// About 
// 
// Unofficial sample for the safebrowsing v4 API for PHP. 
...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'clientId' => '[YourValue]',  // A client ID that uniquely identifies the client implementation of the SafeBrowsing API.
  'fields' => '*'
);
// Single Request.
$results = encodedUpdatesGetExample($service, $encodedRequest, $optParams);


/**
* 
* @service Authenticated Safebrowsing service.
* @optParams Optional paramaters are not required by a request.
* @encodedRequest A serialized FetchThreatListUpdatesRequest proto.
* @return FetchThreatListUpdatesResponse
*/
function encodedUpdatesGetExample($service, $encodedRequest, $optParams)
{
	try
	{
		...
		if (encodedRequest == null)
			throw new Exception("encodedRequest is required.");
		// Make the request and return the results.
		return $service->encodedUpdates->GetEncodedUpdates($encodedRequest, $optParams);
	}
	catch (Exception $e)
	{
