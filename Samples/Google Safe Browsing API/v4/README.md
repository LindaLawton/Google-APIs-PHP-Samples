...
# UnOfficial Google Safe Browsing API v4 Samples for PHP
...
[Official Documentation](https://developers.google.com/safe-browsing/)

## Sample Description

These samples show how to access the [Google Safe Browsing API v4](https://developers.google.com/safe-browsing/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
