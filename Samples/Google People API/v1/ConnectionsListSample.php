...
print_r(connectionsListExample($service, $resourceName));
...
* @return ListConnectionsResponse</returns>
*/
function connectionsListExample($service, $resourceName)
{
	try
	{
		...
		return $service->connections->ListConnections($resourceName);
	}
	catch (Exception $ex)
	{
