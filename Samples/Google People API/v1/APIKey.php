 ...
 * Initializes an Peopleservice.v1 service object.
 * @param string API key
 * @return An authorized Peopleservice.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Peopleservice Sample");
		...
		// Create authenticated Peopleservice service
		return new Google_Service_Peopleservice($client);
	} catch (Exception $e) {
