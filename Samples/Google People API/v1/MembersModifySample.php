...
print_r(membersModifyExample($service, $resourceName));

/**
* Modify the members of a contact group owned by the authenticated user.
* @service Authenticated Peopleservice service.
* @resourceName The resource name of the contact group to modify.
* @return ModifyContactGroupMembersResponse</returns>
*/
function membersModifyExample($service, $resourceName)
{
	try
	{
		...
		return $service->members->ModifyMembers($resourceName);
	}
	catch (Exception $ex)
	{
