...
$results = membersModifyExample($service, $resourceName, $optParams);
...
*/
function membersModifyExample($service, $resourceName, $optParams)
{
	try
	{
		...
		return $service->members->ModifyMembers($resourceName, $optParams);
	}
	catch (Exception $e)
	{
