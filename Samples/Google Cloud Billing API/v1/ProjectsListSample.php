...
print_r(projectsListExample($service, $name));
...
* @return ListProjectBillingInfoResponse</returns>
*/
function projectsListExample($service, $name)
{
	try
	{
		...
		return $service->projects->ListProjects($name);
	}
	catch (Exception $ex)
	{
