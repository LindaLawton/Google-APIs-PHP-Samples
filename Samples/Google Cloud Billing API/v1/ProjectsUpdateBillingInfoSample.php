...
print_r(projectsUpdateBillingInfoExample($service, $name));
...
* @return ProjectBillingInfo</returns>
*/
function projectsUpdateBillingInfoExample($service, $name)
{
	try
	{
		...
		return $service->projects->UpdateBillingInfoProjects($name);
	}
	catch (Exception $ex)
	{
