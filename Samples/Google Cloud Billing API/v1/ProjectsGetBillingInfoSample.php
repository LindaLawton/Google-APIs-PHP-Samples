...
print_r(projectsGetBillingInfoExample($service, $name));
...
*/
function projectsGetBillingInfoExample($service, $name)
{
	try
	{
		...
		return $service->projects->GetBillingInfoProjects($name);
	}
	catch (Exception $ex)
	{
