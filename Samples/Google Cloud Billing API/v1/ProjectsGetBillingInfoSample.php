...
// Single Request.
$results = projectsGetBillingInfoExample($service, $name, $optParams);
...
*/
function projectsGetBillingInfoExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->projects->GetBillingInfoProjects($name, $optParams);
	}
	catch (Exception $e)
	{
