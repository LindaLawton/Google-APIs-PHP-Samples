...
# UnOfficial Google Cloud Billing API v1 Samples for PHP
...
These samples show how to access the [Google Cloud Billing API v1](https://cloud.google.com/billing/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
