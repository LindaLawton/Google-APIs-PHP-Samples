 ...
 * Initializes an Cloudbilling.v1 service object.
 * @param string API key
 * @return An authorized Cloudbilling.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudbilling Sample");
		...
		// Create authenticated Cloudbilling service
		return new Google_Service_Cloudbilling($client);
	} catch (Exception $e) {
