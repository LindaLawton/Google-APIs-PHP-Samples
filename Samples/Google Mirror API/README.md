...
# Unoffical Google Mirror API Samples for PHP
...
These samples show how to access the [Google Mirror API](https://developers.google.com/glass) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
