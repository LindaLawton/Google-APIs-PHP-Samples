...
$results = contactsDeleteExample($service, $id, $optParams);
...
*/
function contactsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->contacts->DeleteContacts($id, $optParams);
	}
	catch (Exception $e)
	{
