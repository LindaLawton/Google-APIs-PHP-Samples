...
print_r(accountsInsertExample($service, $userToken, $accountType, $accountName));
...
*/
function accountsInsertExample($service, $userToken, $accountType, $accountName)
{
	try
	{
		...
		return $service->accounts->InsertAccounts($userToken, $accountType, $accountName);
	}
	catch (Exception $ex)
	{
