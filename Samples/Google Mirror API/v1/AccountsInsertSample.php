...
print_r(insert($service, $userToken, $accountType, $accountName));
...
*/
function insert($service, $userToken, $accountType, $accountName)
{
	try
	{
		...
		return $service->insert($userToken, $accountType, $accountName);
	}
	catch (Exception $ex)
	{
