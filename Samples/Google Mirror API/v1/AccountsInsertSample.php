...
$results = accountsInsertExample($service, $userToken, $accountType, $accountName, $optParams);
...
* @return Account
*/
function accountsInsertExample($service, $userToken, $accountType, $accountName, $optParams)
{
	try
	{
		...
		if (accountName == null)
			throw new Exception("accountName is required.");
		if (accountType == null)
			throw new Exception("accountType is required.");
		if (userToken == null)
			throw new Exception("userToken is required.");
		// Make the request and return the results.
		return $service->accounts->InsertAccounts($userToken, $accountType, $accountName, $optParams);
	}
	catch (Exception $e)
	{
