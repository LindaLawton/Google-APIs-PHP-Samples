...
# UnOfficial Google Mirror API v1 Samples for PHP
...
These samples show how to access the [Google Mirror API v1](https://developers.google.com/glass) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
