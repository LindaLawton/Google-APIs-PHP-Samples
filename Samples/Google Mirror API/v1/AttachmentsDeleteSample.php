...
$results = attachmentsDeleteExample($service, $itemId, $attachmentId, $optParams);
...
*/
function attachmentsDeleteExample($service, $itemId, $attachmentId, $optParams)
{
	try
	{
		...
		if (attachmentId == null)
			throw new Exception("attachmentId is required.");
		if (itemId == null)
			throw new Exception("itemId is required.");
		// Make the request and return the results.
		return $service->attachments->DeleteAttachments($itemId, $attachmentId, $optParams);
	}
	catch (Exception $e)
	{
