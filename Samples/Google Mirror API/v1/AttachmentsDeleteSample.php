...
print_r(attachmentsDeleteExample($service, $itemId, $attachmentId));
...
*/
function attachmentsDeleteExample($service, $itemId, $attachmentId)
{
	try
	{
		...
		return $service->attachments->DeleteAttachments($itemId, $attachmentId);
	}
	catch (Exception $ex)
	{
