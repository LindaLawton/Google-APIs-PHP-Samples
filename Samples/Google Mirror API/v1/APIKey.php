 ...
 * Initializes an Mirror.v1 service object.
 * @param string API key
 * @return An authorized Mirror.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Mirror Sample");
		...
		// Create authenticated Mirror service
		return new Google_Service_Mirror($client);
	} catch (Exception $e) {
