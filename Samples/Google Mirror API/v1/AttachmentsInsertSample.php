...
// Single Request.
$results = attachmentsInsertExample($service, $itemId, $optParams);
...
* @return Attachment
*/
function attachmentsInsertExample($service, $itemId, $optParams)
{
	try
	{
		...
		return $service->attachments->InsertAttachments($itemId, $optParams);
	}
	catch (Exception $e)
	{
