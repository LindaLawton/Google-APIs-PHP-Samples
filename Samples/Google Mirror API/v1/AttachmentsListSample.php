...
print_r(attachmentsListExample($service, $itemId));

/**
* Returns a list of attachments for a timeline item.
* @service Authenticated Mirror service.
* @itemId The ID of the timeline item whose attachments should be listed.
* @return AttachmentsListResponse</returns>
*/
function attachmentsListExample($service, $itemId)
{
	try
	{
		...
		return $service->attachments->ListAttachments($itemId);
	}
	catch (Exception $ex)
	{
