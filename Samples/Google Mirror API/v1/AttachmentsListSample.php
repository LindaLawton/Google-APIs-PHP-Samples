...
// Single Request.
$results = attachmentsListExample($service, $itemId, $optParams);
...
*/
function attachmentsListExample($service, $itemId, $optParams)
{
	try
	{
		...
		return $service->attachments->ListAttachments($itemId, $optParams);
	}
	catch (Exception $e)
	{
