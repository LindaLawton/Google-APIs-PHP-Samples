...
$results = attachmentsGetExample($service, $itemId, $attachmentId, $optParams);
...
* @return Attachment
*/
function attachmentsGetExample($service, $itemId, $attachmentId, $optParams)
{
	try
	{
		...
		return $service->attachments->GetAttachments($itemId, $attachmentId, $optParams);
	}
	catch (Exception $e)
	{
