...
print_r(attachmentsGetExample($service, $itemId, $attachmentId));
...
* @return Attachment</returns>
*/
function attachmentsGetExample($service, $itemId, $attachmentId)
{
	try
	{
		...
		return $service->attachments->GetAttachments($itemId, $attachmentId);
	}
	catch (Exception $ex)
	{
