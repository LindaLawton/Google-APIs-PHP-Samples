...
$results = subscriptionsInsertExample($service, $optParams);
...
* @return Subscription
*/
function subscriptionsInsertExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->InsertSubscriptions($optParams);
	}
	catch (Exception $e)
	{
