...
print_r(create($service, $projectId, $historyId, $executionId, $stepId));
...
*/
function create($service, $projectId, $historyId, $executionId, $stepId)
{
	try
	{
		...
		return $service->create($projectId, $historyId, $executionId, $stepId);
	}
	catch (Exception $ex)
	{
