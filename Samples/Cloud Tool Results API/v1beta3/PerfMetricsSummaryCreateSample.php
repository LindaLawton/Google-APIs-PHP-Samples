...
// Single Request.
$results = perfMetricsSummaryCreateExample($service, $projectId, $historyId, $executionId, $stepId, $optParams);
...
*/
function perfMetricsSummaryCreateExample($service, $projectId, $historyId, $executionId, $stepId, $optParams)
{
	try
	{
		...
		return $service->perfMetricsSummary->CreatePerfMetricsSummary($projectId, $historyId, $executionId, $stepId, $optParams);
	}
	catch (Exception $e)
	{
