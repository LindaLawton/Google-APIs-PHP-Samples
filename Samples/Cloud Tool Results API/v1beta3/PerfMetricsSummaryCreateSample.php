...
print_r(perfMetricsSummaryCreateExample($service, $projectId, $historyId, $executionId, $stepId));
...
* @return PerfMetricsSummary</returns>
*/
function perfMetricsSummaryCreateExample($service, $projectId, $historyId, $executionId, $stepId)
{
	try
	{
		...
		return $service->perfMetricsSummary->CreatePerfMetricsSummary($projectId, $historyId, $executionId, $stepId);
	}
	catch (Exception $ex)
	{
