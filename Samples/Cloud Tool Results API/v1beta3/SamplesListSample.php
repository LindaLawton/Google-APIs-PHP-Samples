...
print_r(list($service, $projectId, $historyId, $executionId, $stepId, $sampleSeriesId));
...
*/
function list($service, $projectId, $historyId, $executionId, $stepId, $sampleSeriesId)
{
	try
	{
		...
		return $service->list($projectId, $historyId, $executionId, $stepId, $sampleSeriesId);
	}
	catch (Exception $ex)
	{
