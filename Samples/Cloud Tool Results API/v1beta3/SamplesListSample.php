...
print_r(samplesListExample($service, $projectId, $historyId, $executionId, $stepId, $sampleSeriesId));
...
* @return ListPerfSamplesResponse</returns>
*/
function samplesListExample($service, $projectId, $historyId, $executionId, $stepId, $sampleSeriesId)
{
	try
	{
		...
		return $service->samples->ListSamples($projectId, $historyId, $executionId, $stepId, $sampleSeriesId);
	}
	catch (Exception $ex)
	{
