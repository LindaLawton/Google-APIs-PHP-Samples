...
// Single Request.
$results = samplesBatchCreateExample($service, $projectId, $historyId, $executionId, $stepId, $sampleSeriesId, $optParams);
...
*/
function samplesBatchCreateExample($service, $projectId, $historyId, $executionId, $stepId, $sampleSeriesId, $optParams)
{
	try
	{
		...
		return $service->samples->BatchCreateSamples($projectId, $historyId, $executionId, $stepId, $sampleSeriesId, $optParams);
	}
	catch (Exception $e)
	{
