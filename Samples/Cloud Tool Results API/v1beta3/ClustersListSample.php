...
print_r(list($service, $projectId, $historyId, $executionId));
...
*/
function list($service, $projectId, $historyId, $executionId)
{
	try
	{
		...
		return $service->list($projectId, $historyId, $executionId);
	}
	catch (Exception $ex)
	{
