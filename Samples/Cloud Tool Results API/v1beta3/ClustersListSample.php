...
$results = clustersListExample($service, $projectId, $historyId, $executionId, $optParams);
...
*/
function clustersListExample($service, $projectId, $historyId, $executionId, $optParams)
{
	try
	{
		...
		return $service->clusters->ListClusters($projectId, $historyId, $executionId, $optParams);
	}
	catch (Exception $e)
	{
