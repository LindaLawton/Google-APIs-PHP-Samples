...
// About 
// 
// Unofficial sample for the Toolresults v1beta3 API for PHP. 
 ...
 * Initializes an Toolresults.v1beta3 service object.
 * @param string API key
 * @return An authorized Toolresults.v1beta3 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Toolresults Sample");
		...
		// Create authenticated Toolresults service
		return new Google_Service_Toolresults($client);
	} catch (Exception $e) {
