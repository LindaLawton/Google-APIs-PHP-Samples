...
print_r(list($service, $projectId, $historyId, $executionId, $stepId));
...
*/
function list($service, $projectId, $historyId, $executionId, $stepId)
{
	try
	{
		...
		return $service->list($projectId, $historyId, $executionId, $stepId);
	}
	catch (Exception $ex)
	{
