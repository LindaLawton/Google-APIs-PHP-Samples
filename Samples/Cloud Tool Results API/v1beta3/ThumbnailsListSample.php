...
print_r(thumbnailsListExample($service, $projectId, $historyId, $executionId, $stepId));
...
Required.
* @return ListStepThumbnailsResponse</returns>
*/
function thumbnailsListExample($service, $projectId, $historyId, $executionId, $stepId)
{
	try
	{
		...
		return $service->thumbnails->ListThumbnails($projectId, $historyId, $executionId, $stepId);
	}
	catch (Exception $ex)
	{
