...
print_r(get($service, $projectId, $historyId, $executionId, $clusterId));
...
*/
function get($service, $projectId, $historyId, $executionId, $clusterId)
{
	try
	{
		...
		return $service->get($projectId, $historyId, $executionId, $clusterId);
	}
	catch (Exception $ex)
	{
