...
// Single Request.
$results = clustersGetExample($service, $projectId, $historyId, $executionId, $clusterId, $optParams);
...
*/
function clustersGetExample($service, $projectId, $historyId, $executionId, $clusterId, $optParams)
{
	try
	{
		...
		return $service->clusters->GetClusters($projectId, $historyId, $executionId, $clusterId, $optParams);
	}
	catch (Exception $e)
	{
