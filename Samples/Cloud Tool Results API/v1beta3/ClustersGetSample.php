...
print_r(clustersGetExample($service, $projectId, $historyId, $executionId, $clusterId));
...
Required.
* @return ScreenshotCluster</returns>
*/
function clustersGetExample($service, $projectId, $historyId, $executionId, $clusterId)
{
	try
	{
		...
		return $service->clusters->GetClusters($projectId, $historyId, $executionId, $clusterId);
	}
	catch (Exception $ex)
	{
