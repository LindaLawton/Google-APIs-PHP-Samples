...
// Single Request.
$results = webResourcePatchExample($service, $id, $optParams);
...
*/
function webResourcePatchExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->webResource->PatchWebResource($id, $optParams);
	}
	catch (Exception $e)
	{
