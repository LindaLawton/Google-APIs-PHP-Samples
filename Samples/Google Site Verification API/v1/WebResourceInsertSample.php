...
// Single Request.
$results = webResourceInsertExample($service, $verificationMethod, $optParams);
...
*/
function webResourceInsertExample($service, $verificationMethod, $optParams)
{
	try
	{
		...
		return $service->webResource->InsertWebResource($verificationMethod, $optParams);
	}
	catch (Exception $e)
	{
