...
print_r(webResourceInsertExample($service, $verificationMethod));

/**
* Attempt verification of a website or domain.
* @service Authenticated Siteverification service.
* @verificationMethod The method to use for verifying a site or domain.
* @return SiteVerificationWebResourceResource</returns>
*/
function webResourceInsertExample($service, $verificationMethod)
{
	try
	{
		...
		return $service->webResource->InsertWebResource($verificationMethod);
	}
	catch (Exception $ex)
	{
