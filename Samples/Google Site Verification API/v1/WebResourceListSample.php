...
print_r(webResourceListExample($service));

/**
* Get the list of your verified websites and domains.
* @service Authenticated Siteverification service.
* @return SiteVerificationWebResourceListResponse</returns>
*/
function webResourceListExample($service)
{
	try
	{
		...
		return $service->webResource->ListWebResource();
	}
	catch (Exception $ex)
	{
