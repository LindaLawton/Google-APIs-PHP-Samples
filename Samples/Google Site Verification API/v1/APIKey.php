...
// About 
// 
// Unofficial sample for the Siteverification v1 API for PHP. 
 ...
 * Initializes an Siteverification.v1 service object.
 * @param string API key
 * @return An authorized Siteverification.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Siteverification Sample");
		...
		// Create authenticated Siteverification service
		return new Google_Service_Siteverification($client);
	} catch (Exception $e) {
