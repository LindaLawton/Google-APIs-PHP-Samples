...
$results = webResourceGetExample($service, $id, $optParams);
...
*/
function webResourceGetExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->webResource->GetWebResource($id, $optParams);
	}
	catch (Exception $e)
	{
