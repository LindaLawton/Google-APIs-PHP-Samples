...
// Single Request.
$results = webResourceGetTokenExample($service, $optParams);
...
*/
function webResourceGetTokenExample($service, $optParams)
{
	try
	{
		...
		return $service->webResource->GetTokenWebResource($optParams);
	}
	catch (Exception $e)
	{
