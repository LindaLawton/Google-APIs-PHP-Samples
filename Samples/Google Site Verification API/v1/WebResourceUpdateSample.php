...
// Single Request.
$results = webResourceUpdateExample($service, $id, $optParams);
...
*/
function webResourceUpdateExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->webResource->UpdateWebResource($id, $optParams);
	}
	catch (Exception $e)
	{
