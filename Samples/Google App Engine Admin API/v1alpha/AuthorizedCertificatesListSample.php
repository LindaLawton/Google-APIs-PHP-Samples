...
print_r(authorizedCertificatesListExample($service, $appsId));
...
* @return ListAuthorizedCertificatesResponse</returns>
*/
function authorizedCertificatesListExample($service, $appsId)
{
	try
	{
		...
		return $service->authorizedCertificates->ListAuthorizedCertificates($appsId);
	}
	catch (Exception $ex)
	{
