...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'view' => '[YourValue]',  //Controls the set of fields returned in the LIST response.
  'fields' => '*'
);
// Single Request.
$results = authorizedCertificatesListExample($service, $appsId, $optParams);
...
*/
function authorizedCertificatesListExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->authorizedCertificates->ListAuthorizedCertificates($appsId, $optParams);
	}
	catch (Exception $e)
	{
