...
print_r(authorizedCertificatesCreateExample($service, $appsId));
...
*/
function authorizedCertificatesCreateExample($service, $appsId)
{
	try
	{
		...
		return $service->authorizedCertificates->CreateAuthorizedCertificates($appsId);
	}
	catch (Exception $ex)
	{
