...
// Single Request.
$results = authorizedCertificatesCreateExample($service, $appsId, $optParams);
...
*/
function authorizedCertificatesCreateExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->authorizedCertificates->CreateAuthorizedCertificates($appsId, $optParams);
	}
	catch (Exception $e)
	{
