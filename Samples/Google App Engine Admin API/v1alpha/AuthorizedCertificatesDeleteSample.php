...
print_r(authorizedCertificatesDeleteExample($service, $appsId, $authorizedCertificatesId));
...
*/
function authorizedCertificatesDeleteExample($service, $appsId, $authorizedCertificatesId)
{
	try
	{
		...
		return $service->authorizedCertificates->DeleteAuthorizedCertificates($appsId, $authorizedCertificatesId);
	}
	catch (Exception $ex)
	{
