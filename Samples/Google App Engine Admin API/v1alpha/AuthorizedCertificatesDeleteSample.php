...
print_r(delete($service, $appsId, $authorizedCertificatesId));
...
*/
function delete($service, $appsId, $authorizedCertificatesId)
{
	try
	{
		...
		return $service->delete($appsId, $authorizedCertificatesId);
	}
	catch (Exception $ex)
	{
