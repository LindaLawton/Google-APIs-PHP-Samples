...
// Single Request.
$results = authorizedCertificatesDeleteExample($service, $appsId, $authorizedCertificatesId, $optParams);
...
* @return Empty
*/
function authorizedCertificatesDeleteExample($service, $appsId, $authorizedCertificatesId, $optParams)
{
	try
	{
		...
		return $service->authorizedCertificates->DeleteAuthorizedCertificates($appsId, $authorizedCertificatesId, $optParams);
	}
	catch (Exception $e)
	{
