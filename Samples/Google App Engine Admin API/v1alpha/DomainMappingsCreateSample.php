...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'noManagedCertificate' => '[YourValue]',  //Whether a managed certificate should be provided by App Engine. If true, a certificate ID must be manaually set in the DomainMapping resource to configure SSL for this domain. If false, a managed certificate will be provisioned and a certificate ID will be automatically populated.
  'fields' => '*'
);
// Single Request.
$results = domainMappingsCreateExample($service, $appsId, $optParams);
...
* @return Operation
*/
function domainMappingsCreateExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->domainMappings->CreateDomainMappings($appsId, $optParams);
	}
	catch (Exception $e)
	{
