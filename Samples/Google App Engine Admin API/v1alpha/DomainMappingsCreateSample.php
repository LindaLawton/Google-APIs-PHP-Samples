...
print_r(domainMappingsCreateExample($service, $appsId));
...
*/
function domainMappingsCreateExample($service, $appsId)
{
	try
	{
		...
		return $service->domainMappings->CreateDomainMappings($appsId);
	}
	catch (Exception $ex)
	{
