...
print_r(domainMappingsListExample($service, $appsId));
...
* @return ListDomainMappingsResponse</returns>
*/
function domainMappingsListExample($service, $appsId)
{
	try
	{
		...
		return $service->domainMappings->ListDomainMappings($appsId);
	}
	catch (Exception $ex)
	{
