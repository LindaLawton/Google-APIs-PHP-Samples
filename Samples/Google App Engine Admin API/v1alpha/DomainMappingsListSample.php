...
// Single Request.
$results = domainMappingsListExample($service, $appsId, $optParams);
...
*/
function domainMappingsListExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->domainMappings->ListDomainMappings($appsId, $optParams);
	}
	catch (Exception $e)
	{
