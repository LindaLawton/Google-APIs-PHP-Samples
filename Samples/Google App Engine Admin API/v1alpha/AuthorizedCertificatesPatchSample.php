...
print_r(patch($service, $appsId, $authorizedCertificatesId));
...
*/
function patch($service, $appsId, $authorizedCertificatesId)
{
	try
	{
		...
		return $service->patch($appsId, $authorizedCertificatesId);
	}
	catch (Exception $ex)
	{
