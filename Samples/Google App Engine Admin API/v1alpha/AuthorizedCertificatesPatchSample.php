...
print_r(authorizedCertificatesPatchExample($service, $appsId, $authorizedCertificatesId));
...
* @return AuthorizedCertificate</returns>
*/
function authorizedCertificatesPatchExample($service, $appsId, $authorizedCertificatesId)
{
	try
	{
		...
		return $service->authorizedCertificates->PatchAuthorizedCertificates($appsId, $authorizedCertificatesId);
	}
	catch (Exception $ex)
	{
