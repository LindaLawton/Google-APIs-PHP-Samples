...
// About 
// 
// Unofficial sample for the appengine v1alpha API for PHP. 
...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  // Standard field mask for the set of fields to be updated. Updates are only supported on the certificate_raw_data and display_name fields.
  'fields' => '*'
);
// Single Request.
$results = authorizedCertificatesPatchExample($service, $appsId, $authorizedCertificatesId, $optParams);
...
*/
function authorizedCertificatesPatchExample($service, $appsId, $authorizedCertificatesId, $optParams)
{
	try
	{
		...
		if (authorizedCertificatesId == null)
			throw new Exception("authorizedCertificatesId is required.");
		if (appsId == null)
			throw new Exception("appsId is required.");
		// Make the request and return the results.
		return $service->authorizedCertificates->PatchAuthorizedCertificates($appsId, $authorizedCertificatesId, $optParams);
	}
	catch (Exception $e)
	{
