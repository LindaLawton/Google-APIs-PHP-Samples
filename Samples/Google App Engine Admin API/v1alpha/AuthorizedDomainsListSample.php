...
print_r(authorizedDomainsListExample($service, $appsId));
...
* @return ListAuthorizedDomainsResponse</returns>
*/
function authorizedDomainsListExample($service, $appsId)
{
	try
	{
		...
		return $service->authorizedDomains->ListAuthorizedDomains($appsId);
	}
	catch (Exception $ex)
	{
