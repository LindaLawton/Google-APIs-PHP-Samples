...
$results = authorizedDomainsListExample($service, $appsId, $optParams);
...
*/
function authorizedDomainsListExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->authorizedDomains->ListAuthorizedDomains($appsId, $optParams);
	}
	catch (Exception $e)
	{
