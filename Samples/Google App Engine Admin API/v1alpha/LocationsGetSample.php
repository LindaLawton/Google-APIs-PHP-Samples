...
// Single Request.
$results = locationsGetExample($service, $appsId, $locationsId, $optParams);
...
* @return Location
*/
function locationsGetExample($service, $appsId, $locationsId, $optParams)
{
	try
	{
		...
		if (locationsId == null)
			throw new Exception("locationsId is required.");
		// Make the request and return the results.
		return $service->locations->GetLocations($appsId, $locationsId, $optParams);
	}
	catch (Exception $e)
	{
