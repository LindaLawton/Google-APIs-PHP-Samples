...
print_r(domainMappingsGetExample($service, $appsId, $domainMappingsId));
...
* @return DomainMapping</returns>
*/
function domainMappingsGetExample($service, $appsId, $domainMappingsId)
{
	try
	{
		...
		return $service->domainMappings->GetDomainMappings($appsId, $domainMappingsId);
	}
	catch (Exception $ex)
	{
