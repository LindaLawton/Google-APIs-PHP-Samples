...
// Single Request.
$results = domainMappingsGetExample($service, $appsId, $domainMappingsId, $optParams);
...
*/
function domainMappingsGetExample($service, $appsId, $domainMappingsId, $optParams)
{
	try
	{
		...
		return $service->domainMappings->GetDomainMappings($appsId, $domainMappingsId, $optParams);
	}
	catch (Exception $e)
	{
