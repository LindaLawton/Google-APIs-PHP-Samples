...
print_r(domainMappingsDeleteExample($service, $appsId, $domainMappingsId));
...
*/
function domainMappingsDeleteExample($service, $appsId, $domainMappingsId)
{
	try
	{
		...
		return $service->domainMappings->DeleteDomainMappings($appsId, $domainMappingsId);
	}
	catch (Exception $ex)
	{
