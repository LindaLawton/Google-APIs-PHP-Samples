...
// Single Request.
$results = domainMappingsDeleteExample($service, $appsId, $domainMappingsId, $optParams);
...
* @return Operation
*/
function domainMappingsDeleteExample($service, $appsId, $domainMappingsId, $optParams)
{
	try
	{
		...
		if (domainMappingsId == null)
			throw new Exception("domainMappingsId is required.");
		if (appsId == null)
			throw new Exception("appsId is required.");
		// Make the request and return the results.
		return $service->domainMappings->DeleteDomainMappings($appsId, $domainMappingsId, $optParams);
	}
	catch (Exception $e)
	{
