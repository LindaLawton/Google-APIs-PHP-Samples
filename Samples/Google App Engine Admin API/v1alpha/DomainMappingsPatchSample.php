...
* @return Operation
*/
function domainMappingsPatchExample($service, $appsId, $domainMappingsId, $optParams)
{
	try
	{
		...
		return $service->domainMappings->PatchDomainMappings($appsId, $domainMappingsId, $optParams);
	}
	catch (Exception $e)
	{
