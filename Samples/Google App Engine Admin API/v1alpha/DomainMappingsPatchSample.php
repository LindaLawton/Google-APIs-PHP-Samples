...
print_r(domainMappingsPatchExample($service, $appsId, $domainMappingsId));
...
*/
function domainMappingsPatchExample($service, $appsId, $domainMappingsId)
{
	try
	{
		...
		return $service->domainMappings->PatchDomainMappings($appsId, $domainMappingsId);
	}
	catch (Exception $ex)
	{
