...
print_r(get($service, $appsId, $authorizedCertificatesId));
...
*/
function get($service, $appsId, $authorizedCertificatesId)
{
	try
	{
		...
		return $service->get($appsId, $authorizedCertificatesId);
	}
	catch (Exception $ex)
	{
