...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'view' => '[YourValue]',  //Controls the set of fields returned in the GET response.
  'fields' => '*'
);
// Single Request.
$results = authorizedCertificatesGetExample($service, $appsId, $authorizedCertificatesId, $optParams);
...
*/
function authorizedCertificatesGetExample($service, $appsId, $authorizedCertificatesId, $optParams)
{
	try
	{
		...
		return $service->authorizedCertificates->GetAuthorizedCertificates($appsId, $authorizedCertificatesId, $optParams);
	}
	catch (Exception $e)
	{
