...
print_r(authorizedCertificatesGetExample($service, $appsId, $authorizedCertificatesId));
...
*/
function authorizedCertificatesGetExample($service, $appsId, $authorizedCertificatesId)
{
	try
	{
		...
		return $service->authorizedCertificates->GetAuthorizedCertificates($appsId, $authorizedCertificatesId);
	}
	catch (Exception $ex)
	{
