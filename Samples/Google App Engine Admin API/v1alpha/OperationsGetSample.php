...
print_r(operationsGetExample($service, $appsId, $operationsId));
...
*/
function operationsGetExample($service, $appsId, $operationsId)
{
	try
	{
		...
		return $service->operations->GetOperations($appsId, $operationsId);
	}
	catch (Exception $ex)
	{
