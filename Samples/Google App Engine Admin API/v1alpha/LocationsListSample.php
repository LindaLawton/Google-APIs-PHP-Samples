...
// Single Request.
$results = locationsListExample($service, $appsId, $optParams);
...
*/
function locationsListExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->locations->ListLocations($appsId, $optParams);
	}
	catch (Exception $e)
	{
