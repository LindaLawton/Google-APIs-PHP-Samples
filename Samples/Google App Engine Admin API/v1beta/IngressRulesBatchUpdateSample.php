...
print_r(ingressRulesBatchUpdateExample($service, $appsId));
...
* @return BatchUpdateIngressRulesResponse</returns>
*/
function ingressRulesBatchUpdateExample($service, $appsId)
{
	try
	{
		...
		return $service->ingressRules->BatchUpdateIngressRules($appsId);
	}
	catch (Exception $ex)
	{
