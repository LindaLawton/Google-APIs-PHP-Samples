...
// Single Request.
$results = ingressRulesBatchUpdateExample($service, $appsId, $optParams);
...
*/
function ingressRulesBatchUpdateExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->ingressRules->BatchUpdateIngressRules($appsId, $optParams);
	}
	catch (Exception $e)
	{
