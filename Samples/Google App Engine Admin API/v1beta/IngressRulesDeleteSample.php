...
// Single Request.
$results = ingressRulesDeleteExample($service, $appsId, $ingressRulesId, $optParams);
...
* @return Empty
*/
function ingressRulesDeleteExample($service, $appsId, $ingressRulesId, $optParams)
{
	try
	{
		...
		if (ingressRulesId == null)
			throw new Exception("ingressRulesId is required.");
		// Make the request and return the results.
		return $service->ingressRules->DeleteIngressRules($appsId, $ingressRulesId, $optParams);
	}
	catch (Exception $e)
	{
