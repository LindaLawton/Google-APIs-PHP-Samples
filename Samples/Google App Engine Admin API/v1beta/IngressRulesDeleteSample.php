...
print_r(ingressRulesDeleteExample($service, $appsId, $ingressRulesId));
...
*/
function ingressRulesDeleteExample($service, $appsId, $ingressRulesId)
{
	try
	{
		...
		return $service->ingressRules->DeleteIngressRules($appsId, $ingressRulesId);
	}
	catch (Exception $ex)
	{
