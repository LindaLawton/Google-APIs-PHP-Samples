...
print_r(ingressRulesListExample($service, $appsId));
...
* @return ListIngressRulesResponse</returns>
*/
function ingressRulesListExample($service, $appsId)
{
	try
	{
		...
		return $service->ingressRules->ListIngressRules($appsId);
	}
	catch (Exception $ex)
	{
