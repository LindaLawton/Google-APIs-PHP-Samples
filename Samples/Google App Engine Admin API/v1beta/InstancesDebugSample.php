...
print_r(instancesDebugExample($service, $appsId, $servicesId, $versionsId, $instancesId));
...
*/
function instancesDebugExample($service, $appsId, $servicesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->instances->DebugInstances($appsId, $servicesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
