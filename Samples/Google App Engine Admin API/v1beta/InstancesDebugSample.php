...
$results = instancesDebugExample($service, $appsId, $servicesId, $versionsId, $instancesId, $optParams);
...
* @return Operation
*/
function instancesDebugExample($service, $appsId, $servicesId, $versionsId, $instancesId, $optParams)
{
	try
	{
		...
		return $service->instances->DebugInstances($appsId, $servicesId, $versionsId, $instancesId, $optParams);
	}
	catch (Exception $e)
	{
