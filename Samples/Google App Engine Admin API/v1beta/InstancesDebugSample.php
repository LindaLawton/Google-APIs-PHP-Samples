...
print_r(debug($service, $appsId, $servicesId, $versionsId, $instancesId));
...
*/
function debug($service, $appsId, $servicesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->debug($appsId, $servicesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
