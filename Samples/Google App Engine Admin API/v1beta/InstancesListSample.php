...
print_r(instancesListExample($service, $appsId, $servicesId, $versionsId));
...
* @return ListInstancesResponse</returns>
*/
function instancesListExample($service, $appsId, $servicesId, $versionsId)
{
	try
	{
		...
		return $service->instances->ListInstances($appsId, $servicesId, $versionsId);
	}
	catch (Exception $ex)
	{
