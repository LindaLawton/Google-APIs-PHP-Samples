...
// Single Request.
$results = instancesListExample($service, $appsId, $servicesId, $versionsId, $optParams);
...
do {
	...
	$results = filesListExample($service, $appsId, $servicesId, $versionsId, $optParams);	
...
*/
function instancesListExample($service, $appsId, $servicesId, $versionsId, $optParams)
{
	try
	{
		...
		return $service->instances->ListInstances($appsId, $servicesId, $versionsId, $optParams);
	}
	catch (Exception $e)
	{
