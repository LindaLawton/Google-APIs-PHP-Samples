...
print_r(instancesGetExample($service, $appsId, $servicesId, $versionsId, $instancesId));
...
*/
function instancesGetExample($service, $appsId, $servicesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->instances->GetInstances($appsId, $servicesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
