...
// Single Request.
$results = instancesGetExample($service, $appsId, $servicesId, $versionsId, $instancesId, $optParams);
...
* @return Instance
*/
function instancesGetExample($service, $appsId, $servicesId, $versionsId, $instancesId, $optParams)
{
	try
	{
		...
		return $service->instances->GetInstances($appsId, $servicesId, $versionsId, $instancesId, $optParams);
	}
	catch (Exception $e)
	{
