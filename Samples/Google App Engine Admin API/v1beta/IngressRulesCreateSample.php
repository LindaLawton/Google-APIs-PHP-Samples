...
print_r(ingressRulesCreateExample($service, $appsId));
...
*/
function ingressRulesCreateExample($service, $appsId)
{
	try
	{
		...
		return $service->ingressRules->CreateIngressRules($appsId);
	}
	catch (Exception $ex)
	{
