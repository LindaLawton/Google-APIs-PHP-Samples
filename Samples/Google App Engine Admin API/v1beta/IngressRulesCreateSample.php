...
// Single Request.
$results = ingressRulesCreateExample($service, $appsId, $optParams);
...
* @return FirewallRule
*/
function ingressRulesCreateExample($service, $appsId, $optParams)
{
	try
	{
		...
		return $service->ingressRules->CreateIngressRules($appsId, $optParams);
	}
	catch (Exception $e)
	{
