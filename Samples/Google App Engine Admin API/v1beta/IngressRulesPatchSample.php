...
// Single Request.
$results = ingressRulesPatchExample($service, $appsId, $ingressRulesId, $optParams);
...
* @return FirewallRule
*/
function ingressRulesPatchExample($service, $appsId, $ingressRulesId, $optParams)
{
	try
	{
		...
		return $service->ingressRules->PatchIngressRules($appsId, $ingressRulesId, $optParams);
	}
	catch (Exception $e)
	{
