...
print_r(ingressRulesPatchExample($service, $appsId, $ingressRulesId));
...
* @return FirewallRule</returns>
*/
function ingressRulesPatchExample($service, $appsId, $ingressRulesId)
{
	try
	{
		...
		return $service->ingressRules->PatchIngressRules($appsId, $ingressRulesId);
	}
	catch (Exception $ex)
	{
