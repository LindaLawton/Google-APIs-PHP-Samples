...
print_r(delete($service, $appsId, $servicesId, $versionsId, $instancesId));
...
*/
function delete($service, $appsId, $servicesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->delete($appsId, $servicesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
