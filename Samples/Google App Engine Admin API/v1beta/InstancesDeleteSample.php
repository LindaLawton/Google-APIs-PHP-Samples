...
$results = instancesDeleteExample($service, $appsId, $servicesId, $versionsId, $instancesId, $optParams);
...
* @return Operation
*/
function instancesDeleteExample($service, $appsId, $servicesId, $versionsId, $instancesId, $optParams)
{
	try
	{
		...
		return $service->instances->DeleteInstances($appsId, $servicesId, $versionsId, $instancesId, $optParams);
	}
	catch (Exception $e)
	{
