...
print_r(instancesDeleteExample($service, $appsId, $servicesId, $versionsId, $instancesId));
...
*/
function instancesDeleteExample($service, $appsId, $servicesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->instances->DeleteInstances($appsId, $servicesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
