...
// Single Request.
$results = ingressRulesGetExample($service, $appsId, $ingressRulesId, $optParams);
...
* @return FirewallRule
*/
function ingressRulesGetExample($service, $appsId, $ingressRulesId, $optParams)
{
	try
	{
		...
		return $service->ingressRules->GetIngressRules($appsId, $ingressRulesId, $optParams);
	}
	catch (Exception $e)
	{
