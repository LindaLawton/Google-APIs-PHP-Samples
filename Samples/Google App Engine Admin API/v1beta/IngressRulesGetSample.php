...
print_r(ingressRulesGetExample($service, $appsId, $ingressRulesId));
...
*/
function ingressRulesGetExample($service, $appsId, $ingressRulesId)
{
	try
	{
		...
		return $service->ingressRules->GetIngressRules($appsId, $ingressRulesId);
	}
	catch (Exception $ex)
	{
