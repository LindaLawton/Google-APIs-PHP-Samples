...
print_r(delete($service, $appsId, $modulesId, $versionsId, $instancesId));
...
*/
function delete($service, $appsId, $modulesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->delete($appsId, $modulesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
