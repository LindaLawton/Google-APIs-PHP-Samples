...
// About 
// 
// Unofficial sample for the appengine v1beta4 API for PHP. 
...
$results = instancesDeleteExample($service, $appsId, $modulesId, $versionsId, $instancesId, $optParams);
...
* @return Operation
*/
function instancesDeleteExample($service, $appsId, $modulesId, $versionsId, $instancesId, $optParams)
{
	try
	{
		...
		if (modulesId == null)
			throw new Exception("modulesId is required.");
		if (instancesId == null)
			throw new Exception("instancesId is required.");
		if (appsId == null)
			throw new Exception("appsId is required.");
		// Make the request and return the results.
		return $service->instances->DeleteInstances($appsId, $modulesId, $versionsId, $instancesId, $optParams);
	}
	catch (Exception $e)
	{
