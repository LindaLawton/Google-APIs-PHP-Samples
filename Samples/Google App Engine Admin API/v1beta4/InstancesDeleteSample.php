...
print_r(instancesDeleteExample($service, $appsId, $modulesId, $versionsId, $instancesId));
...
*/
function instancesDeleteExample($service, $appsId, $modulesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->instances->DeleteInstances($appsId, $modulesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
