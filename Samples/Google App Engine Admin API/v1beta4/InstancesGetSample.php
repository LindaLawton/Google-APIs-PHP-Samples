...
print_r(instancesGetExample($service, $appsId, $modulesId, $versionsId, $instancesId));
...
*/
function instancesGetExample($service, $appsId, $modulesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->instances->GetInstances($appsId, $modulesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
