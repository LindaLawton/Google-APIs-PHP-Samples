...
print_r(get($service, $appsId, $modulesId, $versionsId, $instancesId));
...
*/
function get($service, $appsId, $modulesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->get($appsId, $modulesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
