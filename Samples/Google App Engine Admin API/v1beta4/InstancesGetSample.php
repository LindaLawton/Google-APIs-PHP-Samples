...
// Single Request.
$results = instancesGetExample($service, $appsId, $modulesId, $versionsId, $instancesId, $optParams);
...
* @return Instance
*/
function instancesGetExample($service, $appsId, $modulesId, $versionsId, $instancesId, $optParams)
{
	try
	{
		...
		return $service->instances->GetInstances($appsId, $modulesId, $versionsId, $instancesId, $optParams);
	}
	catch (Exception $e)
	{
