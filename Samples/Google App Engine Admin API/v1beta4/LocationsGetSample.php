...
print_r(locationsGetExample($service, $appsId, $locationsId));
...
*/
function locationsGetExample($service, $appsId, $locationsId)
{
	try
	{
		...
		return $service->locations->GetLocations($appsId, $locationsId);
	}
	catch (Exception $ex)
	{
