...
// Single Request.
$results = instancesDebugExample($service, $appsId, $modulesId, $versionsId, $instancesId, $optParams);
...
* @return Operation
*/
function instancesDebugExample($service, $appsId, $modulesId, $versionsId, $instancesId, $optParams)
{
	try
	{
		...
		return $service->instances->DebugInstances($appsId, $modulesId, $versionsId, $instancesId, $optParams);
	}
	catch (Exception $e)
	{
