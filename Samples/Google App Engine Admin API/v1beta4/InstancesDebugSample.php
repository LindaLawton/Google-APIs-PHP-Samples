...
print_r(debug($service, $appsId, $modulesId, $versionsId, $instancesId));
...
*/
function debug($service, $appsId, $modulesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->debug($appsId, $modulesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
