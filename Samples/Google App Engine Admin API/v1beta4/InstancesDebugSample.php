...
print_r(instancesDebugExample($service, $appsId, $modulesId, $versionsId, $instancesId));
...
*/
function instancesDebugExample($service, $appsId, $modulesId, $versionsId, $instancesId)
{
	try
	{
		...
		return $service->instances->DebugInstances($appsId, $modulesId, $versionsId, $instancesId);
	}
	catch (Exception $ex)
	{
