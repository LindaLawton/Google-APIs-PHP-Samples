...
print_r(instancesListExample($service, $appsId, $modulesId, $versionsId));
...
*/
function instancesListExample($service, $appsId, $modulesId, $versionsId)
{
	try
	{
		...
		return $service->instances->ListInstances($appsId, $modulesId, $versionsId);
	}
	catch (Exception $ex)
	{
