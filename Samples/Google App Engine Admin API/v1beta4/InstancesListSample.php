...
// Single Request.
$results = instancesListExample($service, $appsId, $modulesId, $versionsId, $optParams);
...
do {
	...
	$results = filesListExample($service, $appsId, $modulesId, $versionsId, $optParams);	
...
*/
function instancesListExample($service, $appsId, $modulesId, $versionsId, $optParams)
{
	try
	{
		...
		return $service->instances->ListInstances($appsId, $modulesId, $versionsId, $optParams);
	}
	catch (Exception $e)
	{
