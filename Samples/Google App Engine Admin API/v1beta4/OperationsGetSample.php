...
// Single Request.
$results = operationsGetExample($service, $appsId, $operationsId, $optParams);
...
* @return Operation
*/
function operationsGetExample($service, $appsId, $operationsId, $optParams)
{
	try
	{
		...
		if (operationsId == null)
			throw new Exception("operationsId is required.");
		// Make the request and return the results.
		return $service->operations->GetOperations($appsId, $operationsId, $optParams);
	}
	catch (Exception $e)
	{
