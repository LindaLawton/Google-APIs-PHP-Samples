...
// Single Request.
$results = commentsGetExample($service, $commentId, $optParams);
...
* @return Comment
*/
function commentsGetExample($service, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->GetComments($commentId, $optParams);
	}
	catch (Exception $e)
	{
