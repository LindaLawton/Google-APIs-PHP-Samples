...
$results = circlesPatchExample($service, $circleId, $optParams);
...
* @return Circle
*/
function circlesPatchExample($service, $circleId, $optParams)
{
	try
	{
		...
		return $service->circles->PatchCircles($circleId, $optParams);
	}
	catch (Exception $e)
	{
