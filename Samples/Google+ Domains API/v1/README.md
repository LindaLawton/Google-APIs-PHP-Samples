...
# UnOfficial Google+ Domains API v1 Samples for PHP

## API Description

Builds on top of the Google+ platform for Google Apps Domains.

[Official Documentation](https://developers.google.com/+/domains/)

## Sample Description

These samples show how to access the [Google+ Domains API v1](https://developers.google.com/+/domains/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
