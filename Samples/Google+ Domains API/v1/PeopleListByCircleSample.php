...
$results = peopleListByCircleExample($service, $circleId, $optParams);
...
do {
	...
	$results = filesListExample($service, $circleId, $optParams);	
...
* @return PeopleFeed
*/
function peopleListByCircleExample($service, $circleId, $optParams)
{
	try
	{
		...
		return $service->people->ListByCirclePeople($circleId, $optParams);
	}
	catch (Exception $e)
	{
