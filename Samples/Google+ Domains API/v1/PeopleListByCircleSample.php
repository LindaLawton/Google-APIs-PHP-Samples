...
print_r(peopleListByCircleExample($service, $circleId));
...
*/
function peopleListByCircleExample($service, $circleId)
{
	try
	{
		...
		return $service->people->ListByCirclePeople($circleId);
	}
	catch (Exception $ex)
	{
