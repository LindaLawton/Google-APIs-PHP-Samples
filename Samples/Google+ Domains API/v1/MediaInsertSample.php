...
print_r(mediaInsertExample($service, $userId, $collection));
...
*/
function mediaInsertExample($service, $userId, $collection)
{
	try
	{
		...
		return $service->media->InsertMedia($userId, $collection);
	}
	catch (Exception $ex)
	{
