...
// Single Request.
$results = mediaInsertExample($service, $userId, $collection, $optParams);
...
* @return Media
*/
function mediaInsertExample($service, $userId, $collection, $optParams)
{
	try
	{
		...
		return $service->media->InsertMedia($userId, $collection, $optParams);
	}
	catch (Exception $e)
	{
