 ...
 * Initializes an Plusdomains.v1 service object.
 * @param string API key
 * @return An authorized Plusdomains.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Plusdomains Sample");
		...
		// Create authenticated Plusdomains service
		return new Google_Service_Plusdomains($client);
	} catch (Exception $e) {
