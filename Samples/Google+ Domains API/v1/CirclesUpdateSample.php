...
// Single Request.
$results = circlesUpdateExample($service, $circleId, $optParams);
...
* @return Circle
*/
function circlesUpdateExample($service, $circleId, $optParams)
{
	try
	{
		...
		return $service->circles->UpdateCircles($circleId, $optParams);
	}
	catch (Exception $e)
	{
