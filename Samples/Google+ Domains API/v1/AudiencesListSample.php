...
print_r(audiencesListExample($service, $userId));
...
* @return AudiencesFeed</returns>
*/
function audiencesListExample($service, $userId)
{
	try
	{
		...
		return $service->audiences->ListAudiences($userId);
	}
	catch (Exception $ex)
	{
