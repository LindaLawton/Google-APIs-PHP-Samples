...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // The maximum number of circles to include in the response, which is used for paging. For any response, the actual number returned might be less than the specified maxResults.
...
// Single Request.
$results = audiencesListExample($service, $userId, $optParams);
...
* @return AudiencesFeed
*/
function audiencesListExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->audiences->ListAudiences($userId, $optParams);
	}
	catch (Exception $e)
	{
