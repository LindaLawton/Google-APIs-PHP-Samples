...
// Single Request.
$results = circlesListExample($service, $userId, $optParams);
...
* @return CircleFeed
*/
function circlesListExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->circles->ListCircles($userId, $optParams);
	}
	catch (Exception $e)
	{
