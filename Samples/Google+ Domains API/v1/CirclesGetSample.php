...
// Single Request.
$results = circlesGetExample($service, $circleId, $optParams);
...
* @return Circle
*/
function circlesGetExample($service, $circleId, $optParams)
{
	try
	{
		...
		return $service->circles->GetCircles($circleId, $optParams);
	}
	catch (Exception $e)
	{
