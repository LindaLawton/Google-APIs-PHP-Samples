...
// Single Request.
$results = commentsInsertExample($service, $activityId, $optParams);
...
* @return Comment
*/
function commentsInsertExample($service, $activityId, $optParams)
{
	try
	{
		...
		return $service->comments->InsertComments($activityId, $optParams);
	}
	catch (Exception $e)
	{
