...
print_r(listByActivity($service, $activityId, $collection));
...
*/
function listByActivity($service, $activityId, $collection)
{
	try
	{
		...
		return $service->listByActivity($activityId, $collection);
	}
	catch (Exception $ex)
	{
