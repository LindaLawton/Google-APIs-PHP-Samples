...
print_r(peopleListByActivityExample($service, $activityId, $collection));
...
* @return PeopleFeed</returns>
*/
function peopleListByActivityExample($service, $activityId, $collection)
{
	try
	{
		...
		return $service->people->ListByActivityPeople($activityId, $collection);
	}
	catch (Exception $ex)
	{
