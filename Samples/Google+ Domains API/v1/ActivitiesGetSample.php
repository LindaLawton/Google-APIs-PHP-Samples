...
print_r(activitiesGetExample($service, $activityId));

/**
* Get an activity.
* @service Authenticated Plusdomains service.
* @activityId The ID of the activity to get.
* @return Activity</returns>
*/
function activitiesGetExample($service, $activityId)
{
	try
	{
		...
		return $service->activities->GetActivities($activityId);
	}
	catch (Exception $ex)
	{
