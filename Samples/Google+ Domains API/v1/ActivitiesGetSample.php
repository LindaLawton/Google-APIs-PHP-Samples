...
// Single Request.
$results = activitiesGetExample($service, $activityId, $optParams);
...
* @return Activity
*/
function activitiesGetExample($service, $activityId, $optParams)
{
	try
	{
		...
		return $service->activities->GetActivities($activityId, $optParams);
	}
	catch (Exception $e)
	{
