...
print_r(peopleListExample($service, $userId, $collection));
...
*/
function peopleListExample($service, $userId, $collection)
{
	try
	{
		...
		return $service->people->ListPeople($userId, $collection);
	}
	catch (Exception $ex)
	{
