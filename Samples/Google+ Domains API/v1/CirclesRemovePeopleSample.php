...
print_r(circlesRemovePeopleExample($service, $circleId));
...
*/
function circlesRemovePeopleExample($service, $circleId)
{
	try
	{
		...
		return $service->circles->RemovePeopleCircles($circleId);
	}
	catch (Exception $ex)
	{
