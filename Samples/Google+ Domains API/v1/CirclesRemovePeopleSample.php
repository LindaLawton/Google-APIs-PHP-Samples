...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'userId' => '[YourValue]',  // IDs of the people to remove from the circle. Optional, can be repeated.
  'fields' => '*'
);
// Single Request.
$results = circlesRemovePeopleExample($service, $circleId, $optParams);
...
*/
function circlesRemovePeopleExample($service, $circleId, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->circles->RemovePeopleCircles($circleId, $optParams);
	}
	catch (Exception $e)
	{
