...
print_r(circlesAddPeopleExample($service, $circleId));
...
* @return Circle</returns>
*/
function circlesAddPeopleExample($service, $circleId)
{
	try
	{
		...
		return $service->circles->AddPeopleCircles($circleId);
	}
	catch (Exception $ex)
	{
