...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListBidMetricsResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.bidMetrics.listmethod.
...
// Single Request.
$results = bidMetricsListExample($service, $accountId, $filterSetId, $optParams);
...
*/
function bidMetricsListExample($service, $accountId, $filterSetId, $optParams)
{
	try
	{
		...
		return $service->bidMetrics->ListBidMetrics($accountId, $filterSetId, $optParams);
	}
	catch (Exception $e)
	{
