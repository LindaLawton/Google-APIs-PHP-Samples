...
print_r(bidMetricsListExample($service, $accountId, $filterSetId));
...
* @return ListBidMetricsResponse</returns>
*/
function bidMetricsListExample($service, $accountId, $filterSetId)
{
	try
	{
		...
		return $service->bidMetrics->ListBidMetrics($accountId, $filterSetId);
	}
	catch (Exception $ex)
	{
