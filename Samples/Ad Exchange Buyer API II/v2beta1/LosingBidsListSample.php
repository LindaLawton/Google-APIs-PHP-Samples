...
print_r(losingBidsListExample($service, $accountId, $filterSetId));
...
* @return ListLosingBidsResponse</returns>
*/
function losingBidsListExample($service, $accountId, $filterSetId)
{
	try
	{
		...
		return $service->losingBids->ListLosingBids($accountId, $filterSetId);
	}
	catch (Exception $ex)
	{
