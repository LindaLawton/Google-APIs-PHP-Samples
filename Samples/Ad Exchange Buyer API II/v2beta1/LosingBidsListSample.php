...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListLosingBidsResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.losingBids.listmethod.
...
// Single Request.
$results = losingBidsListExample($service, $accountId, $filterSetId, $optParams);
...
*/
function losingBidsListExample($service, $accountId, $filterSetId, $optParams)
{
	try
	{
		...
		return $service->losingBids->ListLosingBids($accountId, $filterSetId, $optParams);
	}
	catch (Exception $e)
	{
