...
print_r(creativesListExample($service, $accountId, $filterSetId, $creativeStatusId));
...
* @return ListCreativeStatusBreakdownByCreativeResponse</returns>
*/
function creativesListExample($service, $accountId, $filterSetId, $creativeStatusId)
{
	try
	{
		...
		return $service->creatives->ListCreatives($accountId, $filterSetId, $creativeStatusId);
	}
	catch (Exception $ex)
	{
