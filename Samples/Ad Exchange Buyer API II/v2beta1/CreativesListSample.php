...
print_r(list($service, $accountId, $filterSetId, $creativeStatusId));
...
*/
function list($service, $accountId, $filterSetId, $creativeStatusId)
{
	try
	{
		...
		return $service->list($accountId, $filterSetId, $creativeStatusId);
	}
	catch (Exception $ex)
	{
