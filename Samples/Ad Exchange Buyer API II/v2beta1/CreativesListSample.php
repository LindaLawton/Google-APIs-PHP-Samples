...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListCreativeStatusBreakdownByCreativeResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.filteredBids.creatives.listmethod.
  'fields' => '*'
);
// Single Request.
$results = creativesListExample($service, $accountId, $filterSetId, $creativeStatusId, $optParams);
...
do {
	...
	$results = filesListExample($service, $accountId, $filterSetId, $creativeStatusId, $optParams);	
} while($results->getNextPageToken());  

/**
* List all creatives associated with a specific reason for which bids werefiltered, with the number of bids filtered for each creative.
...
*/
function creativesListExample($service, $accountId, $filterSetId, $creativeStatusId, $optParams)
{
	try
	{
		...
		if (creativeStatusId == null)
			throw new Exception("creativeStatusId is required.");
		// Make the request and return the results.
		return $service->creatives->ListCreatives($accountId, $filterSetId, $creativeStatusId, $optParams);
	}
	catch (Exception $e)
	{
