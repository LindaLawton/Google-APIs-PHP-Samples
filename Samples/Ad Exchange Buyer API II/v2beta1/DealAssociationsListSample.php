...
print_r(dealAssociationsListExample($service, $accountId, $creativeId));
...
* @return ListDealAssociationsResponse</returns>
*/
function dealAssociationsListExample($service, $accountId, $creativeId)
{
	try
	{
		...
		return $service->dealAssociations->ListDealAssociations($accountId, $creativeId);
	}
	catch (Exception $ex)
	{
