...
print_r(get($service, $accountId, $clientAccountId, $userId));
...
*/
function get($service, $accountId, $clientAccountId, $userId)
{
	try
	{
		...
		return $service->get($accountId, $clientAccountId, $userId);
	}
	catch (Exception $ex)
	{
