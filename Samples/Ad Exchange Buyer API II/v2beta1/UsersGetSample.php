...
// Single Request.
$results = usersGetExample($service, $accountId, $clientAccountId, $userId, $optParams);
...
* @return ClientUser
*/
function usersGetExample($service, $accountId, $clientAccountId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->GetUsers($accountId, $clientAccountId, $userId, $optParams);
	}
	catch (Exception $e)
	{
