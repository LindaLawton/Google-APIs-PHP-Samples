...
print_r(usersGetExample($service, $accountId, $clientAccountId, $userId));
...
*/
function usersGetExample($service, $accountId, $clientAccountId, $userId)
{
	try
	{
		...
		return $service->users->GetUsers($accountId, $clientAccountId, $userId);
	}
	catch (Exception $ex)
	{
