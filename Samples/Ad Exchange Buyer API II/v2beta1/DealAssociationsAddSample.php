...
print_r(dealAssociationsAddExample($service, $accountId, $creativeId));
...
*/
function dealAssociationsAddExample($service, $accountId, $creativeId)
{
	try
	{
		...
		return $service->dealAssociations->AddDealAssociations($accountId, $creativeId);
	}
	catch (Exception $ex)
	{
