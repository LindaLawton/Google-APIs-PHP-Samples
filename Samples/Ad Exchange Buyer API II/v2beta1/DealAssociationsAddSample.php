...
// Single Request.
$results = dealAssociationsAddExample($service, $accountId, $creativeId, $optParams);
...
* @return Empty
*/
function dealAssociationsAddExample($service, $accountId, $creativeId, $optParams)
{
	try
	{
		...
		return $service->dealAssociations->AddDealAssociations($accountId, $creativeId, $optParams);
	}
	catch (Exception $e)
	{
