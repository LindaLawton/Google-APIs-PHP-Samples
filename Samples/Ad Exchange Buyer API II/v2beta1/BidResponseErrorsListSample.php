...
print_r(bidResponseErrorsListExample($service, $accountId, $filterSetId));
...
* @return ListBidResponseErrorsResponse</returns>
*/
function bidResponseErrorsListExample($service, $accountId, $filterSetId)
{
	try
	{
		...
		return $service->bidResponseErrors->ListBidResponseErrors($accountId, $filterSetId);
	}
	catch (Exception $ex)
	{
