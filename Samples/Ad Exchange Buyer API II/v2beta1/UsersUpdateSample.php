...
// Single Request.
$results = usersUpdateExample($service, $accountId, $clientAccountId, $userId, $optParams);
...
* @return ClientUser
*/
function usersUpdateExample($service, $accountId, $clientAccountId, $userId, $optParams)
{
	try
	{
		...
		return $service->users->UpdateUsers($accountId, $clientAccountId, $userId, $optParams);
	}
	catch (Exception $e)
	{
