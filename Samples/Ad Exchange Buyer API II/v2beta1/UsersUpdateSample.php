...
print_r(update($service, $accountId, $clientAccountId, $userId));
...
*/
function update($service, $accountId, $clientAccountId, $userId)
{
	try
	{
		...
		return $service->update($accountId, $clientAccountId, $userId);
	}
	catch (Exception $ex)
	{
