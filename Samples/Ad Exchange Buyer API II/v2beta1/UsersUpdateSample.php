...
print_r(usersUpdateExample($service, $accountId, $clientAccountId, $userId));
...
* @return ClientUser</returns>
*/
function usersUpdateExample($service, $accountId, $clientAccountId, $userId)
{
	try
	{
		...
		return $service->users->UpdateUsers($accountId, $clientAccountId, $userId);
	}
	catch (Exception $ex)
	{
