...
$results = invitationsCreateExample($service, $accountId, $clientAccountId, $optParams);
...
*/
function invitationsCreateExample($service, $accountId, $clientAccountId, $optParams)
{
	try
	{
		...
		return $service->invitations->CreateInvitations($accountId, $clientAccountId, $optParams);
	}
	catch (Exception $e)
	{
