...
print_r(invitationsCreateExample($service, $accountId, $clientAccountId));
...
*/
function invitationsCreateExample($service, $accountId, $clientAccountId)
{
	try
	{
		...
		return $service->invitations->CreateInvitations($accountId, $clientAccountId);
	}
	catch (Exception $ex)
	{
