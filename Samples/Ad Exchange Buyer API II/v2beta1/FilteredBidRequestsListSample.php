...
print_r(filteredBidRequestsListExample($service, $accountId, $filterSetId));
...
* @return ListFilteredBidRequestsResponse</returns>
*/
function filteredBidRequestsListExample($service, $accountId, $filterSetId)
{
	try
	{
		...
		return $service->filteredBidRequests->ListFilteredBidRequests($accountId, $filterSetId);
	}
	catch (Exception $ex)
	{
