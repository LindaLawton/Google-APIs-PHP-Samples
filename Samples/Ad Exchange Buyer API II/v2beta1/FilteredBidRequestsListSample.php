...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  //A token identifying a page of results the server should return.Typically, this is the value ofListFilteredBidRequestsResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.filteredBidRequests.listmethod.
...
// Single Request.
$results = filteredBidRequestsListExample($service, $accountId, $filterSetId, $optParams);
...
*/
function filteredBidRequestsListExample($service, $accountId, $filterSetId, $optParams)
{
	try
	{
		...
		return $service->filteredBidRequests->ListFilteredBidRequests($accountId, $filterSetId, $optParams);
	}
	catch (Exception $e)
	{
