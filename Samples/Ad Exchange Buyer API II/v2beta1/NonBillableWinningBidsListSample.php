...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListNonBillableWinningBidsResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.nonBillableWinningBids.listmethod.
  'fields' => '*'
);
// Single Request.
$results = nonBillableWinningBidsListExample($service, $accountId, $filterSetId, $optParams);
...
*/
function nonBillableWinningBidsListExample($service, $accountId, $filterSetId, $optParams)
{
	try
	{
		...
		return $service->nonBillableWinningBids->ListNonBillableWinningBids($accountId, $filterSetId, $optParams);
	}
	catch (Exception $e)
	{
