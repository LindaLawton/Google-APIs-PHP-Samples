...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageSize' => '[YourValue]',  //Requested page size. The server may return fewer clients than requested.If unspecified, the server will pick an appropriate default.
            
  //'pageToken' => '[YourValue]',  //A token identifying a page of results the server should return.Typically, this is the value ofListClientUsersResponse.nextPageTokenreturned from the previous call to theaccounts.clients.users.list method.
  'fields' => '*'
);
// Single Request.
$results = usersListExample($service, $accountId, $clientAccountId, $optParams);
...
*/
function usersListExample($service, $accountId, $clientAccountId, $optParams)
{
	try
	{
		...
		return $service->users->ListUsers($accountId, $clientAccountId, $optParams);
	}
	catch (Exception $e)
	{
