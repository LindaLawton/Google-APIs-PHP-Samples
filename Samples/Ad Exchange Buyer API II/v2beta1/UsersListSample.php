...
print_r(usersListExample($service, $accountId, $clientAccountId));
...
* @return ListClientUsersResponse</returns>
*/
function usersListExample($service, $accountId, $clientAccountId)
{
	try
	{
		...
		return $service->users->ListUsers($accountId, $clientAccountId);
	}
	catch (Exception $ex)
	{
