...
print_r(bidResponsesWithoutBidsListExample($service, $accountId, $filterSetId));
...
* @return ListBidResponsesWithoutBidsResponse</returns>
*/
function bidResponsesWithoutBidsListExample($service, $accountId, $filterSetId)
{
	try
	{
		...
		return $service->bidResponsesWithoutBids->ListBidResponsesWithoutBids($accountId, $filterSetId);
	}
	catch (Exception $ex)
	{
