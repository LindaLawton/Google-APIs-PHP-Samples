...
print_r(invitationsListExample($service, $accountId, $clientAccountId));
...
*/
function invitationsListExample($service, $accountId, $clientAccountId)
{
	try
	{
		...
		return $service->invitations->ListInvitations($accountId, $clientAccountId);
	}
	catch (Exception $ex)
	{
