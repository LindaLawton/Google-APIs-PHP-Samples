...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListClientUserInvitationsResponse.nextPageTokenreturned from the previous call to theclients.invitations.listmethod.
            
  //'pageSize' => '[YourValue]',  // Requested page size. Server may return fewer clients than requested.If unspecified, server will pick an appropriate default.
  'fields' => '*'
);
// Single Request.
$results = invitationsListExample($service, $accountId, $clientAccountId, $optParams);
...
do {
	...
	$results = filesListExample($service, $accountId, $clientAccountId, $optParams);	
...
*/
function invitationsListExample($service, $accountId, $clientAccountId, $optParams)
{
	try
	{
		...
		return $service->invitations->ListInvitations($accountId, $clientAccountId, $optParams);
	}
	catch (Exception $e)
	{
