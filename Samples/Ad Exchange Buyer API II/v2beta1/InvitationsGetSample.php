...
print_r(invitationsGetExample($service, $accountId, $clientAccountId, $invitationId));
...
* @return ClientUserInvitation</returns>
*/
function invitationsGetExample($service, $accountId, $clientAccountId, $invitationId)
{
	try
	{
		...
		if (invitationId == null)
			throw new Exception("invitationId is required.");
		if (accountId == null)
			throw new Exception("accountId is required.");
		if (clientAccountId == null)
			throw new Exception("clientAccountId is required.");
		// Make the request and return the results.
		return $service->invitations->GetInvitations($accountId, $clientAccountId, $invitationId);
	}
	catch (Exception $ex)
	{
