...
// Single Request.
$results = invitationsGetExample($service, $accountId, $clientAccountId, $invitationId, $optParams);
...
*/
function invitationsGetExample($service, $accountId, $clientAccountId, $invitationId, $optParams)
{
	try
	{
		...
		return $service->invitations->GetInvitations($accountId, $clientAccountId, $invitationId, $optParams);
	}
	catch (Exception $e)
	{
