...
* @return Empty
*/
function dealAssociationsRemoveExample($service, $accountId, $creativeId, $optParams)
{
	try
	{
		...
		return $service->dealAssociations->RemoveDealAssociations($accountId, $creativeId, $optParams);
	}
	catch (Exception $e)
	{
