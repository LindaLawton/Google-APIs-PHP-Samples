...
print_r(dealAssociationsRemoveExample($service, $accountId, $creativeId));
...
*/
function dealAssociationsRemoveExample($service, $accountId, $creativeId)
{
	try
	{
		...
		return $service->dealAssociations->RemoveDealAssociations($accountId, $creativeId);
	}
	catch (Exception $ex)
	{
