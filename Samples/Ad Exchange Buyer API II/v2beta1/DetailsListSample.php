...
print_r(detailsListExample($service, $accountId, $filterSetId, $creativeStatusId));
...
* @return ListCreativeStatusBreakdownByDetailResponse</returns>
*/
function detailsListExample($service, $accountId, $filterSetId, $creativeStatusId)
{
	try
	{
		...
		return $service->details->ListDetails($accountId, $filterSetId, $creativeStatusId);
	}
	catch (Exception $ex)
	{
