...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListCreativeStatusBreakdownByDetailResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.filteredBids.details.listmethod.
  'fields' => '*'
);
// Single Request.
$results = detailsListExample($service, $accountId, $filterSetId, $creativeStatusId, $optParams);
...
/**
* List all details associated with a specific reason for which bids werefiltered, with the number of bids filtered for each detail.
...
*/
function detailsListExample($service, $accountId, $filterSetId, $creativeStatusId, $optParams)
{
	try
	{
		...
		return $service->details->ListDetails($accountId, $filterSetId, $creativeStatusId, $optParams);
	}
	catch (Exception $e)
	{
