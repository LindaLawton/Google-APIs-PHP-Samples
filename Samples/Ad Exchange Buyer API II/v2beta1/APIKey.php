 ...
 * Initializes an Adexchangebuyerii.v2beta1 service object.
 * @param string API key
 * @return An authorized Adexchangebuyerii.v2beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Adexchangebuyerii Sample");
		...
		// Create authenticated Adexchangebuyerii service
		return new Google_Service_Adexchangebuyerii($client);
	} catch (Exception $e) {
