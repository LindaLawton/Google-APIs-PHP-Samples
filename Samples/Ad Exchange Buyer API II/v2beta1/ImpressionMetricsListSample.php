...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  // A token identifying a page of results the server should return.Typically, this is the value ofListImpressionMetricsResponse.nextPageTokenreturned from the previous call to theaccounts.filterSets.impressionMetrics.listmethod.
...
// Single Request.
$results = impressionMetricsListExample($service, $accountId, $filterSetId, $optParams);
...
*/
function impressionMetricsListExample($service, $accountId, $filterSetId, $optParams)
{
	try
	{
		...
		return $service->impressionMetrics->ListImpressionMetrics($accountId, $filterSetId, $optParams);
	}
	catch (Exception $e)
	{
