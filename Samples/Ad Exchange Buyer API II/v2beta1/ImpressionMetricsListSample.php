...
print_r(impressionMetricsListExample($service, $accountId, $filterSetId));
...
* @return ListImpressionMetricsResponse</returns>
*/
function impressionMetricsListExample($service, $accountId, $filterSetId)
{
	try
	{
		...
		return $service->impressionMetrics->ListImpressionMetrics($accountId, $filterSetId);
	}
	catch (Exception $ex)
	{
