...
print_r(productsListExample($service, $parent));
...
* @return ListProductsResponse</returns>
*/
function productsListExample($service, $parent)
{
	try
	{
		...
		return $service->products->ListProducts($parent);
	}
	catch (Exception $ex)
	{
