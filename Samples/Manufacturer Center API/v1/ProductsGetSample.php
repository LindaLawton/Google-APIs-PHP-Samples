...
// Single Request.
$results = productsGetExample($service, $parent, $name, $optParams);
...
* @return Product
*/
function productsGetExample($service, $parent, $name, $optParams)
{
	try
	{
		...
		return $service->products->GetProducts($parent, $name, $optParams);
	}
	catch (Exception $e)
	{
