...
// Single Request.
$results = productsUpdateExample($service, $parent, $name, $optParams);
...
* @return Product
*/
function productsUpdateExample($service, $parent, $name, $optParams)
{
	try
	{
		...
		return $service->products->UpdateProducts($parent, $name, $optParams);
	}
	catch (Exception $e)
	{
