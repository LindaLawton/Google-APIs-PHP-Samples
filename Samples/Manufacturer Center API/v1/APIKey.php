...
// About 
// 
// Unofficial sample for the Manufacturercenter v1 API for PHP. 
 ...
 * Initializes an Manufacturercenter.v1 service object.
 * @param string API key
 * @return An authorized Manufacturercenter.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Manufacturercenter Sample");
		...
		// Create authenticated Manufacturercenter service
		return new Google_Service_Manufacturercenter($client);
	} catch (Exception $e) {
