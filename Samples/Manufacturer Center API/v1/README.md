...
# UnOfficial Manufacturer Center API v1 Samples for PHP

## API Description

Public API for managing Manufacturer Center related data.

[Official Documentation](https://developers.google.com/manufacturers/)

## Sample Description

These samples show how to access the [Manufacturer Center API v1](https://developers.google.com/manufacturers/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
