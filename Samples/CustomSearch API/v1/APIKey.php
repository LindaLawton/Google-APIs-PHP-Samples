 ...
 * Initializes an Customsearch.v1 service object.
 * @param string API key
 * @return An authorized Customsearch.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Customsearch Sample");
		...
		// Create authenticated Customsearch service
