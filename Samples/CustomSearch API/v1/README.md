...
# UnOfficial CustomSearch API v1 Samples for PHP
...
These samples show how to access the [CustomSearch API v1](https://developers.google.com/custom-search/v1/using_rest) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
