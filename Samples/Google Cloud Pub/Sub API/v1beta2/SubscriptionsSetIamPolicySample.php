...
// Single Request.
$results = subscriptionsSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function subscriptionsSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->subscriptions->SetIamPolicySubscriptions($resource, $optParams);
	}
	catch (Exception $e)
	{
