...
// Single Request.
$results = subscriptionsCreateExample($service, $name, $optParams);
...
* @return Subscription
*/
function subscriptionsCreateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->subscriptions->CreateSubscriptions($name, $optParams);
	}
	catch (Exception $e)
	{
