...
// Single Request.
$results = subscriptionsTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function subscriptionsTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->subscriptions->TestIamPermissionsSubscriptions($resource, $optParams);
	}
	catch (Exception $e)
	{
