...
// Single Request.
$results = subscriptionsModifyAckDeadlineExample($service, $subscription, $optParams);
...
* @return Empty
*/
function subscriptionsModifyAckDeadlineExample($service, $subscription, $optParams)
{
	try
	{
		...
		return $service->subscriptions->ModifyAckDeadlineSubscriptions($subscription, $optParams);
	}
	catch (Exception $e)
	{
