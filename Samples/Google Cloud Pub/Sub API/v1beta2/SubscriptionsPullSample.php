...
// Single Request.
$results = subscriptionsPullExample($service, $subscription, $optParams);
...
* @return PullResponse
*/
function subscriptionsPullExample($service, $subscription, $optParams)
{
	try
	{
		...
		return $service->subscriptions->PullSubscriptions($subscription, $optParams);
	}
	catch (Exception $e)
	{
