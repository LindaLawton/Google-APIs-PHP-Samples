...
// Single Request.
$results = subscriptionsGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function subscriptionsGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->subscriptions->GetIamPolicySubscriptions($resource, $optParams);
	}
	catch (Exception $e)
	{
