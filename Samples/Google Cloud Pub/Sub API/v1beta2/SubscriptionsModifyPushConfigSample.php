...
// Single Request.
$results = subscriptionsModifyPushConfigExample($service, $subscription, $optParams);
...
* @return Empty
*/
function subscriptionsModifyPushConfigExample($service, $subscription, $optParams)
{
	try
	{
		...
		return $service->subscriptions->ModifyPushConfigSubscriptions($subscription, $optParams);
	}
	catch (Exception $e)
	{
