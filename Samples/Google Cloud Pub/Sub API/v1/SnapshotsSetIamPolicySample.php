...
// Single Request.
$results = snapshotsSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function snapshotsSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->SetIamPolicySnapshots($resource, $optParams);
	}
	catch (Exception $e)
	{
