...
// Single Request.
$results = snapshotsGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function snapshotsGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->GetIamPolicySnapshots($resource, $optParams);
	}
	catch (Exception $e)
	{
