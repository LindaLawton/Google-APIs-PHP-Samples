...
* @return Empty
*/
function subscriptionsDeleteExample($service, $subscription, $optParams)
{
	try
	{
		...
		return $service->subscriptions->DeleteSubscriptions($subscription, $optParams);
	}
	catch (Exception $e)
	{
