...
// Single Request.
$results = snapshotsTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function snapshotsTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->TestIamPermissionsSnapshots($resource, $optParams);
	}
	catch (Exception $e)
	{
