...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // Maximum number of subscriptions to return.
            
  //'query' => '[YourValue]',  // A valid label query expression.
            
  //'pageToken' => '[YourValue]',  // The value obtained in the last <code>ListSubscriptionsResponse</code>for continuation.
  'fields' => '*'
);
// Single Request.
...
*/
function subscriptionsListExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->ListSubscriptions($optParams);
	}
	catch (Exception $e)
	{
