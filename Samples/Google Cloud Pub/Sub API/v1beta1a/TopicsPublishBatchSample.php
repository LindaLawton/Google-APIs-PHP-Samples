...
// Single Request.
$results = topicsPublishBatchExample($service, $optParams);
...
*/
function topicsPublishBatchExample($service, $optParams)
{
	try
	{
		...
		return $service->topics->PublishBatchTopics($optParams);
	}
	catch (Exception $e)
	{
