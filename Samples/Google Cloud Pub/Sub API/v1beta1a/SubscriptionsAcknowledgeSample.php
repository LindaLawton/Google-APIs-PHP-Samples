...
// Single Request.
$results = subscriptionsAcknowledgeExample($service, $optParams);
...
* @return Empty
*/
function subscriptionsAcknowledgeExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->AcknowledgeSubscriptions($optParams);
	}
	catch (Exception $e)
	{
