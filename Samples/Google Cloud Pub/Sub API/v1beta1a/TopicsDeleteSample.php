...
// Single Request.
$results = topicsDeleteExample($service, $topic, $optParams);
...
* @return Empty
*/
function topicsDeleteExample($service, $topic, $optParams)
{
	try
	{
		...
		return $service->topics->DeleteTopics($topic, $optParams);
	}
	catch (Exception $e)
	{
