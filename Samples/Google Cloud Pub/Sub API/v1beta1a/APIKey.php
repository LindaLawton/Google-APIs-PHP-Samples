 ...
 * Initializes an Pubsub.v1beta1a service object.
 * @param string API key
 * @return An authorized Pubsub.v1beta1a service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Pubsub Sample");
		...
		// Create authenticated Pubsub service
