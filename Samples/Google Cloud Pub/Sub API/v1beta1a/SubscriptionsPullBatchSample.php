...
// Single Request.
$results = subscriptionsPullBatchExample($service, $optParams);
...
*/
function subscriptionsPullBatchExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->PullBatchSubscriptions($optParams);
	}
	catch (Exception $e)
	{
