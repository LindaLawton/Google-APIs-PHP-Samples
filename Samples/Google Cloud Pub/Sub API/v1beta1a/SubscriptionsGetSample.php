...
// Single Request.
$results = subscriptionsGetExample($service, $subscription, $optParams);
...
* @return Subscription
*/
function subscriptionsGetExample($service, $subscription, $optParams)
{
	try
	{
		...
		return $service->subscriptions->GetSubscriptions($subscription, $optParams);
	}
	catch (Exception $e)
	{
