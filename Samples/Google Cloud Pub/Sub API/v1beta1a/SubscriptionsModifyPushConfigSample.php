...
// Single Request.
$results = subscriptionsModifyPushConfigExample($service, $optParams);
...
* @return Empty
*/
function subscriptionsModifyPushConfigExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->ModifyPushConfigSubscriptions($optParams);
	}
	catch (Exception $e)
	{
