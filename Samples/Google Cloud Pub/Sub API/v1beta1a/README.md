...
# UnOfficial Google Cloud Pub/Sub API v1beta1a Samples for PHP
...
These samples show how to access the [Google Cloud Pub/Sub API v1beta1a](https://cloud.google.com/pubsub/docs) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
