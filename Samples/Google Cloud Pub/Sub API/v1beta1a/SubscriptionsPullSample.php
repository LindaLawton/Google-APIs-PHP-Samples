...
// Single Request.
$results = subscriptionsPullExample($service, $optParams);
...
* @return PullResponse
*/
function subscriptionsPullExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->PullSubscriptions($optParams);
	}
	catch (Exception $e)
	{
