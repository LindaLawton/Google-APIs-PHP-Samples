...
// Single Request.
$results = subscriptionsCreateExample($service, $optParams);
...
* @return Subscription
*/
function subscriptionsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->CreateSubscriptions($optParams);
	}
	catch (Exception $e)
	{
