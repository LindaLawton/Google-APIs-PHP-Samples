...
// Single Request.
$results = subscriptionsModifyAckDeadlineExample($service, $optParams);
...
* @return Empty
*/
function subscriptionsModifyAckDeadlineExample($service, $optParams)
{
	try
	{
		...
		return $service->subscriptions->ModifyAckDeadlineSubscriptions($optParams);
	}
	catch (Exception $e)
	{
