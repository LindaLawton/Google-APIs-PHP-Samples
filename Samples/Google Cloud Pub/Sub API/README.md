...
# Unoffical Google Cloud Pub/Sub API Samples for PHP
...
These samples show how to access the [Google Cloud Pub/Sub API](https://cloud.google.com/pubsub/docs) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
