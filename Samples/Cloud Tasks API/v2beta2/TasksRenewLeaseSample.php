...
$results = tasksRenewLeaseExample($service, $name, $optParams);
...
* @return Task
*/
function tasksRenewLeaseExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->tasks->RenewLeaseTasks($name, $optParams);
	}
	catch (Exception $e)
	{
