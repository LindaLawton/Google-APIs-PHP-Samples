...
$results = tasksCancelLeaseExample($service, $name, $optParams);
...
* @return Task
*/
function tasksCancelLeaseExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->tasks->CancelLeaseTasks($name, $optParams);
	}
	catch (Exception $e)
	{
