...
// Single Request.
$results = tasksCreateExample($service, $parent, $optParams);
...
* @return Task
*/
function tasksCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->tasks->CreateTasks($parent, $optParams);
	}
	catch (Exception $e)
	{
