...
// Single Request.
$results = tasksAcknowledgeExample($service, $name, $optParams);
...
* @return Empty
*/
function tasksAcknowledgeExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->tasks->AcknowledgeTasks($name, $optParams);
	}
	catch (Exception $e)
	{
