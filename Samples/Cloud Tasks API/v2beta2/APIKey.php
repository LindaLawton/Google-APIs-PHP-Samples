...
// About 
// 
// Unofficial sample for the Cloudtasks v2beta2 API for PHP. 
 ...
 * Initializes an Cloudtasks.v2beta2 service object.
 * @param string API key
 * @return An authorized Cloudtasks.v2beta2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudtasks Sample");
		...
		// Create authenticated Cloudtasks service
		return new Google_Service_Cloudtasks($client);
	} catch (Exception $e) {
