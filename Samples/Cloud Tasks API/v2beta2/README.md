...
# UnOfficial Cloud Tasks API v2beta2 Samples for PHP

## API Description

Manages the execution of large numbers of distributed requests. Cloud Tasks is in Alpha.

[Official Documentation](https://cloud.google.com/cloud-tasks/)

## Sample Description

These samples show how to access the [Cloud Tasks API v2beta2](https://cloud.google.com/cloud-tasks/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
