...
// Single Request.
$results = speechAsyncrecognizeExample($service, $optParams);
...
* @return Operation
*/
function speechAsyncrecognizeExample($service, $optParams)
{
	try
	{
		...
		return $service->speech->AsyncrecognizeSpeech($optParams);
	}
	catch (Exception $e)
	{
