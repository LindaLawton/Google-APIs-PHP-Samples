...
# UnOfficial Google Cloud Speech API v1beta1 Samples for PHP

## API Description

Converts audio to text by applying powerful neural network models.

[Official Documentation](https://cloud.google.com/speech/)

## Sample Description

These samples show how to access the [Google Cloud Speech API v1beta1](https://cloud.google.com/speech/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
