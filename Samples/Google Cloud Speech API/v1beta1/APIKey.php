...
// About 
// 
// Unofficial sample for the Speech v1beta1 API for PHP. 
 ...
 * Initializes an Speech.v1beta1 service object.
 * @param string API key
 * @return An authorized Speech.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Speech Sample");
		...
		// Create authenticated Speech service
		return new Google_Service_Speech($client);
	} catch (Exception $e) {
