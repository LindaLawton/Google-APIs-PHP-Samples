...
// Single Request.
$results = speechSyncrecognizeExample($service, $optParams);
...
*/
function speechSyncrecognizeExample($service, $optParams)
{
	try
	{
		...
		return $service->speech->SyncrecognizeSpeech($optParams);
	}
	catch (Exception $e)
	{
