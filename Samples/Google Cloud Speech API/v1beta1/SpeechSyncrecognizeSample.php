...
print_r(speechSyncrecognizeExample($service));
...
* @return SyncRecognizeResponse</returns>
*/
function speechSyncrecognizeExample($service)
{
	try
	{
		...
		return $service->speech->SyncrecognizeSpeech();
	}
	catch (Exception $ex)
	{
