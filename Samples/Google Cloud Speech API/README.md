...
# Unoffical Google Cloud Speech API Samples for PHP
...
These samples show how to access the [Google Cloud Speech API](https://cloud.google.com/speech/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
