...
# Unoffical Stackdriver Logging API Samples for PHP
...
These samples show how to access the [Stackdriver Logging API](https://cloud.google.com/logging/docs/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
