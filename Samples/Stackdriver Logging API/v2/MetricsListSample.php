...
print_r(metricsListExample($service, $parent));
...
* @return ListLogMetricsResponse</returns>
*/
function metricsListExample($service, $parent)
{
	try
	{
		...
		return $service->metrics->ListMetrics($parent);
	}
	catch (Exception $ex)
	{
