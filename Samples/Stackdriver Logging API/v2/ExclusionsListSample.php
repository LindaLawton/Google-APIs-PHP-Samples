...
print_r(exclusionsListExample($service, $parent));
...
* @return ListExclusionsResponse</returns>
*/
function exclusionsListExample($service, $parent)
{
	try
	{
		...
		return $service->exclusions->ListExclusions($parent);
	}
	catch (Exception $ex)
	{
