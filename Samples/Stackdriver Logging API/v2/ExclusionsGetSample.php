...
// Single Request.
$results = exclusionsGetExample($service, $name, $optParams);
...
* @return LogExclusion
*/
function exclusionsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->exclusions->GetExclusions($name, $optParams);
	}
	catch (Exception $e)
	{
