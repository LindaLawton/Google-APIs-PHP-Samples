...
// Single Request.
$results = metricsCreateExample($service, $parent, $optParams);
...
* @return LogMetric
*/
function metricsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->metrics->CreateMetrics($parent, $optParams);
	}
	catch (Exception $e)
	{
