...
print_r(sinksUpdateExample($service, $sinkName));
...
* @return LogSink</returns>
*/
function sinksUpdateExample($service, $sinkName)
{
	try
	{
		...
		return $service->sinks->UpdateSinks($sinkName);
	}
	catch (Exception $ex)
	{
