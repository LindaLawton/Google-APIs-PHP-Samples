...
$results = monitoredResourceDescriptorsListExample($service, $optParams);
...
*/
function monitoredResourceDescriptorsListExample($service, $optParams)
{
	try
	{
		...
		return $service->monitoredResourceDescriptors->ListMonitoredResourceDescriptors($optParams);
	}
	catch (Exception $e)
	{
