...
print_r(monitoredResourceDescriptorsListExample($service));
...
*/
function monitoredResourceDescriptorsListExample($service)
{
	try
	{
		...
		return $service->monitoredResourceDescriptors->ListMonitoredResourceDescriptors();
	}
	catch (Exception $ex)
	{
