...
print_r(metricsUpdateExample($service, $metricName));
...
* @return LogMetric</returns>
*/
function metricsUpdateExample($service, $metricName)
{
	try
	{
		...
		return $service->metrics->UpdateMetrics($metricName);
	}
	catch (Exception $ex)
	{
