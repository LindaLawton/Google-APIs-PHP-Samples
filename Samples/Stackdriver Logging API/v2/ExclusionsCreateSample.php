...
// Single Request.
$results = exclusionsCreateExample($service, $parent, $optParams);
...
* @return LogExclusion
*/
function exclusionsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->exclusions->CreateExclusions($parent, $optParams);
	}
	catch (Exception $e)
	{
