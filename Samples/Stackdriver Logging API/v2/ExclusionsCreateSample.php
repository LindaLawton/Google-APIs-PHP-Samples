...
print_r(exclusionsCreateExample($service, $parent));
...
* @return LogExclusion</returns>
*/
function exclusionsCreateExample($service, $parent)
{
	try
	{
		...
		return $service->exclusions->CreateExclusions($parent);
	}
	catch (Exception $ex)
	{
