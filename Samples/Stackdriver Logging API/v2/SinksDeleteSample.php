...
// Single Request.
$results = sinksDeleteExample($service, $sinkName, $optParams);
...
* @return Empty
*/
function sinksDeleteExample($service, $sinkName, $optParams)
{
	try
	{
		...
		return $service->sinks->DeleteSinks($sinkName, $optParams);
	}
	catch (Exception $e)
	{
