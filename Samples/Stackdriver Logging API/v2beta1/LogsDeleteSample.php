...
// Single Request.
$results = logsDeleteExample($service, $logName, $optParams);
...
* @return Empty
*/
function logsDeleteExample($service, $logName, $optParams)
{
	try
	{
		...
		return $service->logs->DeleteLogs($logName, $optParams);
	}
	catch (Exception $e)
	{
