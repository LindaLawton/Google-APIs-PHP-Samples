...
$results = metricsUpdateExample($service, $metricName, $optParams);
...
* @return LogMetric
*/
function metricsUpdateExample($service, $metricName, $optParams)
{
	try
	{
		...
		return $service->metrics->UpdateMetrics($metricName, $optParams);
	}
	catch (Exception $e)
	{
