...
// Single Request.
$results = metricsListExample($service, $parent, $optParams);
...
*/
function metricsListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->metrics->ListMetrics($parent, $optParams);
	}
	catch (Exception $e)
	{
