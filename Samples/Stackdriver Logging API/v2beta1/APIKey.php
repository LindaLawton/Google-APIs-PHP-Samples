 ...
 * Initializes an Logging.v2beta1 service object.
 * @param string API key
 * @return An authorized Logging.v2beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Logging Sample");
		...
		// Create authenticated Logging service
		return new Google_Service_Logging($client);
	} catch (Exception $e) {
