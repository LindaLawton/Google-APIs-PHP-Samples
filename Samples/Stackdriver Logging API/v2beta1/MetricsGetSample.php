...
// Single Request.
$results = metricsGetExample($service, $metricName, $optParams);
...
* @return LogMetric
*/
function metricsGetExample($service, $metricName, $optParams)
{
	try
	{
		...
		return $service->metrics->GetMetrics($metricName, $optParams);
	}
	catch (Exception $e)
	{
