...
print_r(photosBatchUpdateExample($service));
...
* @return BatchUpdatePhotosResponse</returns>
*/
function photosBatchUpdateExample($service)
{
	try
	{
		...
		return $service->photos->BatchUpdatePhotos();
	}
	catch (Exception $ex)
	{
