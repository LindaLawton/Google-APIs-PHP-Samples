...
// Single Request.
$results = photosBatchUpdateExample($service, $optParams);
...
*/
function photosBatchUpdateExample($service, $optParams)
{
	try
	{
		...
		return $service->photos->BatchUpdatePhotos($optParams);
	}
	catch (Exception $e)
	{
