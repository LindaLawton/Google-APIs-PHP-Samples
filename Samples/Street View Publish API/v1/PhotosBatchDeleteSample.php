...
print_r(photosBatchDeleteExample($service));
...
* @return BatchDeletePhotosResponse</returns>
*/
function photosBatchDeleteExample($service)
{
	try
	{
		...
		return $service->photos->BatchDeletePhotos();
	}
	catch (Exception $ex)
	{
