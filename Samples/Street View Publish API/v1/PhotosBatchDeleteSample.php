...
// Single Request.
$results = photosBatchDeleteExample($service, $optParams);
...
*/
function photosBatchDeleteExample($service, $optParams)
{
	try
	{
		...
		return $service->photos->BatchDeletePhotos($optParams);
	}
	catch (Exception $e)
	{
