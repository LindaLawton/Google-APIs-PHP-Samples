...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'filter' => '[YourValue]',  // The filter expression. For example: `placeId=ChIJj61dQgK6j4AR4GeTYWZsKWw`.The only filter supported at the moment is `placeId`.
...
*/
function photosListExample($service, $optParams)
{
	try
	{
		...
		return $service->photos->ListPhotos($optParams);
	}
	catch (Exception $e)
	{
