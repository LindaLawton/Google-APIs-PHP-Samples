...
// About 
// 
// Unofficial sample for the Streetviewpublish v1 API for PHP. 
 ...
 * Initializes an Streetviewpublish.v1 service object.
 * @param string API key
 * @return An authorized Streetviewpublish.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Streetviewpublish Sample");
		...
		// Create authenticated Streetviewpublish service
		return new Google_Service_Streetviewpublish($client);
	} catch (Exception $e) {
