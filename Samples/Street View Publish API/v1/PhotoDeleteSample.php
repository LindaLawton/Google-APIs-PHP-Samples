...
// Single Request.
$results = photoDeleteExample($service, $photoId, $optParams);
...
* @return Empty
*/
function photoDeleteExample($service, $photoId, $optParams)
{
	try
	{
		...
		if (photoId == null)
			throw new Exception("photoId is required.");
		// Make the request and return the results.
		return $service->photo->DeletePhoto($photoId, $optParams);
	}
	catch (Exception $e)
	{
