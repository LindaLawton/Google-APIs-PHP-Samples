...
# UnOfficial Resource Views API v1beta1 Samples for PHP
...
These samples show how to access the [Resource Views API v1beta1](https://developers.google.com/compute/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
