...
print_r(addresources($service, $projectName, $zone, $resourceViewName));
...
*/
function addresources($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->addresources($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
