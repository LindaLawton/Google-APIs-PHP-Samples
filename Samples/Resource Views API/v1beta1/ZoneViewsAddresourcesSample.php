...
$results = zoneViewsAddresourcesExample($service, $projectName, $zone, $resourceViewName, $optParams);
...
*/
function zoneViewsAddresourcesExample($service, $projectName, $zone, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->zoneViews->AddresourcesZoneViews($projectName, $zone, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
