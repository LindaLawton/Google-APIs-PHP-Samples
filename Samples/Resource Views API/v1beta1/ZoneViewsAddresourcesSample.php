...
print_r(zoneViewsAddresourcesExample($service, $projectName, $zone, $resourceViewName));
...
*/
function zoneViewsAddresourcesExample($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->zoneViews->AddresourcesZoneViews($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
