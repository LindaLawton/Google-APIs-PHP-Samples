...
print_r(listresources($service, $projectName, $region, $resourceViewName));
...
*/
function listresources($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->listresources($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
