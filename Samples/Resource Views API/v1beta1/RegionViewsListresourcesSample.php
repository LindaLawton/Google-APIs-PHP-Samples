...
print_r(regionViewsListresourcesExample($service, $projectName, $region, $resourceViewName));
...
* @return RegionViewsListResourcesResponse</returns>
*/
function regionViewsListresourcesExample($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->regionViews->ListresourcesRegionViews($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
