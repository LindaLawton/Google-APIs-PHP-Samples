...
do {
	...
	$results = filesListExample($service, $projectName, $region, $resourceViewName, $optParams);	
...
* @return RegionViewsListResourcesResponse
*/
function regionViewsListresourcesExample($service, $projectName, $region, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->regionViews->ListresourcesRegionViews($projectName, $region, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
