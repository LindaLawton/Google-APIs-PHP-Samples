...
print_r(regionViewsInsertExample($service, $projectName, $region));
...
* @return RegionViewsInsertResponse</returns>
*/
function regionViewsInsertExample($service, $projectName, $region)
{
	try
	{
		...
		return $service->regionViews->InsertRegionViews($projectName, $region);
	}
	catch (Exception $ex)
	{
