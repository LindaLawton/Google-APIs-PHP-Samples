...
$results = regionViewsInsertExample($service, $projectName, $region, $optParams);
...
* @return RegionViewsInsertResponse
*/
function regionViewsInsertExample($service, $projectName, $region, $optParams)
{
	try
	{
		...
		return $service->regionViews->InsertRegionViews($projectName, $region, $optParams);
	}
	catch (Exception $e)
	{
