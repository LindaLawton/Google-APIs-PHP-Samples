 ...
 * Initializes an Resourceviews.v1beta1 service object.
 * @param string API key
 * @return An authorized Resourceviews.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Resourceviews Sample");
		...
		// Create authenticated Resourceviews service
		return new Google_Service_Resourceviews($client);
	} catch (Exception $e) {
