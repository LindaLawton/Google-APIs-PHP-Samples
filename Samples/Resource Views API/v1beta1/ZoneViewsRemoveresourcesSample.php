...
print_r(removeresources($service, $projectName, $zone, $resourceViewName));
...
*/
function removeresources($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->removeresources($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
