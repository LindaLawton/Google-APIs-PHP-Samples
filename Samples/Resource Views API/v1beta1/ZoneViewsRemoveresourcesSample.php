...
print_r(zoneViewsRemoveresourcesExample($service, $projectName, $zone, $resourceViewName));
...
*/
function zoneViewsRemoveresourcesExample($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->zoneViews->RemoveresourcesZoneViews($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
