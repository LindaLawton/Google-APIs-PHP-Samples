...
print_r(zoneViewsInsertExample($service, $projectName, $zone));
...
* @return ZoneViewsInsertResponse</returns>
*/
function zoneViewsInsertExample($service, $projectName, $zone)
{
	try
	{
		...
		return $service->zoneViews->InsertZoneViews($projectName, $zone);
	}
	catch (Exception $ex)
	{
