...
// Single Request.
$results = zoneViewsInsertExample($service, $projectName, $zone, $optParams);
...
* @return ZoneViewsInsertResponse
*/
function zoneViewsInsertExample($service, $projectName, $zone, $optParams)
{
	try
	{
		...
		return $service->zoneViews->InsertZoneViews($projectName, $zone, $optParams);
	}
	catch (Exception $e)
	{
