...
print_r(regionViewsGetExample($service, $projectName, $region, $resourceViewName));
...
*/
function regionViewsGetExample($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->regionViews->GetRegionViews($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
