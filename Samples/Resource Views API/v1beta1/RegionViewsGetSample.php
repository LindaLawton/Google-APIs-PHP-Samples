...
print_r(get($service, $projectName, $region, $resourceViewName));
...
*/
function get($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->get($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
