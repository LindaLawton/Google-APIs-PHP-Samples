...
// Single Request.
$results = regionViewsGetExample($service, $projectName, $region, $resourceViewName, $optParams);
...
* @return ResourceView
*/
function regionViewsGetExample($service, $projectName, $region, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->regionViews->GetRegionViews($projectName, $region, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
