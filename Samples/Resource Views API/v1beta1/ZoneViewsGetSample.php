...
print_r(zoneViewsGetExample($service, $projectName, $zone, $resourceViewName));
...
*/
function zoneViewsGetExample($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->zoneViews->GetZoneViews($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
