...
$results = zoneViewsGetExample($service, $projectName, $zone, $resourceViewName, $optParams);
...
* @return ResourceView
*/
function zoneViewsGetExample($service, $projectName, $zone, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->zoneViews->GetZoneViews($projectName, $zone, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
