...
print_r(get($service, $projectName, $zone, $resourceViewName));
...
*/
function get($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->get($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
