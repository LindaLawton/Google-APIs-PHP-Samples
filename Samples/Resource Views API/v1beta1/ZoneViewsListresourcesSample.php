...
// About 
// 
// Unofficial sample for the resourceviews v1beta1 API for PHP. 
...
// Single Request.
$results = zoneViewsListresourcesExample($service, $projectName, $zone, $resourceViewName, $optParams);
...
do {
	...
	$results = filesListExample($service, $projectName, $zone, $resourceViewName, $optParams);	
...
*/
function zoneViewsListresourcesExample($service, $projectName, $zone, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->zoneViews->ListresourcesZoneViews($projectName, $zone, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
