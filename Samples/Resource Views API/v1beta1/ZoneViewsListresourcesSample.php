...
print_r(listresources($service, $projectName, $zone, $resourceViewName));
...
*/
function listresources($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->listresources($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
