...
print_r(zoneViewsListresourcesExample($service, $projectName, $zone, $resourceViewName));
...
*/
function zoneViewsListresourcesExample($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->zoneViews->ListresourcesZoneViews($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
