...
print_r(zoneViewsListExample($service, $projectName, $zone));
...
* @return ZoneViewsListResponse</returns>
*/
function zoneViewsListExample($service, $projectName, $zone)
{
	try
	{
		...
		return $service->zoneViews->ListZoneViews($projectName, $zone);
	}
	catch (Exception $ex)
	{
