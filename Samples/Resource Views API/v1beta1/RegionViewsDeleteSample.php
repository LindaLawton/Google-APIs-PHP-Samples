...
print_r(regionViewsDeleteExample($service, $projectName, $region, $resourceViewName));
...
*/
function regionViewsDeleteExample($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->regionViews->DeleteRegionViews($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
