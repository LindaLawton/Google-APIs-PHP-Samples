...
$results = regionViewsDeleteExample($service, $projectName, $region, $resourceViewName, $optParams);
...
*/
function regionViewsDeleteExample($service, $projectName, $region, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->regionViews->DeleteRegionViews($projectName, $region, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
