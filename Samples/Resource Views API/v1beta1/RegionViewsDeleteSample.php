...
print_r(delete($service, $projectName, $region, $resourceViewName));
...
*/
function delete($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->delete($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
