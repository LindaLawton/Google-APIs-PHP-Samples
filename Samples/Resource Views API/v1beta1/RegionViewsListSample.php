...
// Single Request.
$results = regionViewsListExample($service, $projectName, $region, $optParams);
...
do {
	...
	$results = filesListExample($service, $projectName, $region, $optParams);	
...
* @return RegionViewsListResponse
*/
function regionViewsListExample($service, $projectName, $region, $optParams)
{
	try
	{
		...
		return $service->regionViews->ListRegionViews($projectName, $region, $optParams);
	}
	catch (Exception $e)
	{
