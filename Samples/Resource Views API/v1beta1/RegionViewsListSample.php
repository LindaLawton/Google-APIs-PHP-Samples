...
print_r(regionViewsListExample($service, $projectName, $region));
...
* @return RegionViewsListResponse</returns>
*/
function regionViewsListExample($service, $projectName, $region)
{
	try
	{
		...
		return $service->regionViews->ListRegionViews($projectName, $region);
	}
	catch (Exception $ex)
	{
