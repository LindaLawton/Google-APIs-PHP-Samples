...
print_r(removeresources($service, $projectName, $region, $resourceViewName));
...
*/
function removeresources($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->removeresources($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
