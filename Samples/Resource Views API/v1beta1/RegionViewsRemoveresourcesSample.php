...
print_r(regionViewsRemoveresourcesExample($service, $projectName, $region, $resourceViewName));
...
*/
function regionViewsRemoveresourcesExample($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->regionViews->RemoveresourcesRegionViews($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
