...
$results = zoneViewsDeleteExample($service, $projectName, $zone, $resourceViewName, $optParams);
...
*/
function zoneViewsDeleteExample($service, $projectName, $zone, $resourceViewName, $optParams)
{
	try
	{
		...
		return $service->zoneViews->DeleteZoneViews($projectName, $zone, $resourceViewName, $optParams);
	}
	catch (Exception $e)
	{
