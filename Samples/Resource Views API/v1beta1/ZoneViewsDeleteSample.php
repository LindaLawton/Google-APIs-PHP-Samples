...
print_r(zoneViewsDeleteExample($service, $projectName, $zone, $resourceViewName));
...
*/
function zoneViewsDeleteExample($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->zoneViews->DeleteZoneViews($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
