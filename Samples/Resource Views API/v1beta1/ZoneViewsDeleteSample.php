...
print_r(delete($service, $projectName, $zone, $resourceViewName));
...
*/
function delete($service, $projectName, $zone, $resourceViewName)
{
	try
	{
		...
		return $service->delete($projectName, $zone, $resourceViewName);
	}
	catch (Exception $ex)
	{
