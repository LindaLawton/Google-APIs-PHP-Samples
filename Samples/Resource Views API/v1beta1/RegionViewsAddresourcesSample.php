...
print_r(addresources($service, $projectName, $region, $resourceViewName));
...
*/
function addresources($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->addresources($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
