...
print_r(regionViewsAddresourcesExample($service, $projectName, $region, $resourceViewName));
...
*/
function regionViewsAddresourcesExample($service, $projectName, $region, $resourceViewName)
{
	try
	{
		...
		return $service->regionViews->AddresourcesRegionViews($projectName, $region, $resourceViewName);
	}
	catch (Exception $ex)
	{
