...
// Single Request.
$results = consumersGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function consumersGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->consumers->GetIamPolicyConsumers($resource, $optParams);
	}
	catch (Exception $e)
	{
