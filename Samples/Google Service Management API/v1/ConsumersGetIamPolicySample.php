...
print_r(consumersGetIamPolicyExample($service, $resource));
...
*/
function consumersGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->consumers->GetIamPolicyConsumers($resource);
	}
	catch (Exception $ex)
	{
