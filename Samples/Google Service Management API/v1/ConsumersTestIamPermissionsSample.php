...
print_r(consumersTestIamPermissionsExample($service, $resource));
...
*/
function consumersTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->consumers->TestIamPermissionsConsumers($resource);
	}
	catch (Exception $ex)
	{
