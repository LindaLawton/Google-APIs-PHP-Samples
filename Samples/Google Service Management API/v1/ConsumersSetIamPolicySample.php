...
// Single Request.
$results = consumersSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function consumersSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->consumers->SetIamPolicyConsumers($resource, $optParams);
	}
	catch (Exception $e)
	{
