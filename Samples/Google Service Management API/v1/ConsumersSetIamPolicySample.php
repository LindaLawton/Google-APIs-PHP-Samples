...
print_r(consumersSetIamPolicyExample($service, $resource));
...
*/
function consumersSetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->consumers->SetIamPolicyConsumers($resource);
	}
	catch (Exception $ex)
	{
