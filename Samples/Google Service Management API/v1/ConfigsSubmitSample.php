...
// Single Request.
$results = configsSubmitExample($service, $serviceName, $optParams);
...
* @return Operation
*/
function configsSubmitExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->configs->SubmitConfigs($serviceName, $optParams);
	}
	catch (Exception $e)
	{
