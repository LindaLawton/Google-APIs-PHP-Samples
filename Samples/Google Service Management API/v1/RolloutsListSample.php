...
print_r(rolloutsListExample($service, $serviceName));
...
* @return ListServiceRolloutsResponse</returns>
*/
function rolloutsListExample($service, $serviceName)
{
	try
	{
		...
		return $service->rollouts->ListRollouts($serviceName);
	}
	catch (Exception $ex)
	{
