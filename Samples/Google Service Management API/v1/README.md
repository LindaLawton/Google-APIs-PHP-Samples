...
# UnOfficial Google Service Management API v1 Samples for PHP

## API Description

Google Service Management allows service producers to publish their services on Google Cloud Platform so that they can be discovered and used by service consumers.

[Official Documentation](https://cloud.google.com/service-management/)

## Sample Description

These samples show how to access the [Google Service Management API v1](https://cloud.google.com/service-management/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
