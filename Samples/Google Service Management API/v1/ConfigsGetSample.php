...
print_r(configsGetExample($service, $serviceName, $configId));
...
*/
function configsGetExample($service, $serviceName, $configId)
{
	try
	{
		...
		return $service->configs->GetConfigs($serviceName, $configId);
	}
	catch (Exception $ex)
	{
