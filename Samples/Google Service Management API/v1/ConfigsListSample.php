...
$results = configsListExample($service, $serviceName, $optParams);
...
*/
function configsListExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->configs->ListConfigs($serviceName, $optParams);
	}
	catch (Exception $e)
	{
