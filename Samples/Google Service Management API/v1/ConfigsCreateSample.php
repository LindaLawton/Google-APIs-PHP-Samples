...
// Single Request.
$results = configsCreateExample($service, $serviceName, $optParams);
...
* @return Service
*/
function configsCreateExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->configs->CreateConfigs($serviceName, $optParams);
	}
	catch (Exception $e)
	{
