...
print_r(rolloutsGetExample($service, $serviceName, $rolloutId));
...
*/
function rolloutsGetExample($service, $serviceName, $rolloutId)
{
	try
	{
		...
		return $service->rollouts->GetRollouts($serviceName, $rolloutId);
	}
	catch (Exception $ex)
	{
