...
// Single Request.
$results = rolloutsGetExample($service, $serviceName, $rolloutId, $optParams);
...
* @return Rollout
*/
function rolloutsGetExample($service, $serviceName, $rolloutId, $optParams)
{
	try
	{
		...
		if (rolloutId == null)
			throw new Exception("rolloutId is required.");
		// Make the request and return the results.
		return $service->rollouts->GetRollouts($serviceName, $rolloutId, $optParams);
	}
	catch (Exception $e)
	{
