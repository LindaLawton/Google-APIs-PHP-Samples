...
print_r(representativesRepresentativeInfoByAddressExample($service));

/**
* Looks up political geography and representative information for a single address.
* @service Authenticated Civicinfo service.
* @return RepresentativeInfoResponse</returns>
*/
function representativesRepresentativeInfoByAddressExample($service)
{
	try
	{
		...
		return $service->representatives->RepresentativeInfoByAddressRepresentatives();
	}
	catch (Exception $ex)
	{
