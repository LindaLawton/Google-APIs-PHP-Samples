...
// About 
// 
// Unofficial sample for the Civicinfo v2 API for PHP. 
 ...
 * Initializes an Civicinfo.v2 service object.
 * @param string API key
 * @return An authorized Civicinfo.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Civicinfo Sample");
		...
		// Create authenticated Civicinfo service
