...
# UnOfficial Google Civic Information API v2 Samples for PHP

## API Description

Provides polling places, early vote locations, contest data, election officials, and government representatives for U.S. residential addresses.

[Official Documentation](https://developers.google.com/civic-information)

## Sample Description

These samples show how to access the [Google Civic Information API v2](https://developers.google.com/civic-information) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
