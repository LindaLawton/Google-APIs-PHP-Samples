...
print_r(representativeInfoByDivision($service, $ocdId));
...
*/
function representativeInfoByDivision($service, $ocdId)
{
	try
	{
		...
		return $service->representativeInfoByDivision($ocdId);
	}
	catch (Exception $ex)
	{
