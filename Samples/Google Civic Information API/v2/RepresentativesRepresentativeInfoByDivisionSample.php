...
print_r(representativesRepresentativeInfoByDivisionExample($service, $ocdId));
...
* @return RepresentativeInfoData</returns>
*/
function representativesRepresentativeInfoByDivisionExample($service, $ocdId)
{
	try
	{
		...
		return $service->representatives->RepresentativeInfoByDivisionRepresentatives($ocdId);
	}
	catch (Exception $ex)
	{
