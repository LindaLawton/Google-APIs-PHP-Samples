...
// Single Request.
$results = electionsElectionQueryExample($service, $optParams);
...
*/
function electionsElectionQueryExample($service, $optParams)
{
	try
	{
		...
		return $service->elections->ElectionQueryElections($optParams);
	}
	catch (Exception $e)
	{
