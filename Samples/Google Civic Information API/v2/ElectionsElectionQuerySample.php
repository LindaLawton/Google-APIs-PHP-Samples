...
print_r(electionsElectionQueryExample($service));

/**
* List of available elections to query.
* @service Authenticated Civicinfo service.
* @return ElectionsQueryResponse</returns>
*/
function electionsElectionQueryExample($service)
{
	try
	{
		...
		return $service->elections->ElectionQueryElections();
	}
	catch (Exception $ex)
	{
