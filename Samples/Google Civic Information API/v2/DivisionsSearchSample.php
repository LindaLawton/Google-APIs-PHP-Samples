...
print_r(divisionsSearchExample($service));

/**
* Searches for political divisions by their natural name or OCD ID.
* @service Authenticated Civicinfo service.
* @return DivisionSearchResponse</returns>
*/
function divisionsSearchExample($service)
{
	try
	{
		...
		return $service->divisions->SearchDivisions();
	}
	catch (Exception $ex)
	{
