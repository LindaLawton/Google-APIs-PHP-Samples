...
print_r(electionsVoterInfoQueryExample($service, $address));

/**
* Looks up information relevant to a voter based on the voter's registered address.
* @service Authenticated Civicinfo service.
* @address The registered address of the voter to look up.
* @return VoterInfoResponse</returns>
*/
function electionsVoterInfoQueryExample($service, $address)
{
	try
	{
		...
		return $service->elections->VoterInfoQueryElections($address);
	}
	catch (Exception $ex)
	{
