...
$results = filtersCreateExample($service, $userId, $optParams);
...
* @return Filter
*/
function filtersCreateExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->filters->CreateFilters($userId, $optParams);
	}
	catch (Exception $e)
	{
