...
$results = labelsDeleteExample($service, $userId, $id, $optParams);
...
*/
function labelsDeleteExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->labels->DeleteLabels($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
