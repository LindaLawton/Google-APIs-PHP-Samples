...
$results = forwardingAddressesDeleteExample($service, $userId, $forwardingEmail, $optParams);
...
*/
function forwardingAddressesDeleteExample($service, $userId, $forwardingEmail, $optParams)
{
	try
	{
		...
		if (forwardingEmail == null)
			throw new Exception("forwardingEmail is required.");
		if (userId == null)
			throw new Exception("userId is required.");
		// Make the request and return the results.
		return $service->forwardingAddresses->DeleteForwardingAddresses($userId, $forwardingEmail, $optParams);
	}
	catch (Exception $e)
	{
