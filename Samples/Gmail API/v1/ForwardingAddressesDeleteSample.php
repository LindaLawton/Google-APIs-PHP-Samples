...
print_r(forwardingAddressesDeleteExample($service, $userId, $forwardingEmail));
...
*/
function forwardingAddressesDeleteExample($service, $userId, $forwardingEmail)
{
	try
	{
		...
		return $service->forwardingAddresses->DeleteForwardingAddresses($userId, $forwardingEmail);
	}
	catch (Exception $ex)
	{
