...
// Single Request.
$results = labelsPatchExample($service, $userId, $id, $optParams);
...
* @return Label
*/
function labelsPatchExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->labels->PatchLabels($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
