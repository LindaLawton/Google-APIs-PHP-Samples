...
// Single Request.
$results = threadsUntrashExample($service, $userId, $id, $optParams);
...
* @return Thread
*/
function threadsUntrashExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->threads->UntrashThreads($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
