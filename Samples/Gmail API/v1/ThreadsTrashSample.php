...
// Single Request.
$results = threadsTrashExample($service, $userId, $id, $optParams);
...
* @return Thread
*/
function threadsTrashExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->threads->TrashThreads($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
