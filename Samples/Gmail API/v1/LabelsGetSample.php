...
// Single Request.
$results = labelsGetExample($service, $userId, $id, $optParams);
...
* @return Label
*/
function labelsGetExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->labels->GetLabels($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
