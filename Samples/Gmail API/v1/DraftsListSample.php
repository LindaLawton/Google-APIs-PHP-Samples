...
print_r(draftsListExample($service, $userId));

/**
* Lists the drafts in the user's mailbox.
* @service Authenticated Gmail service.
* @userId The user's email address. The special value me can be used to indicate the authenticated user.
* @return ListDraftsResponse</returns>
*/
function draftsListExample($service, $userId)
{
	try
	{
		...
		return $service->drafts->ListDrafts($userId);
	}
	catch (Exception $ex)
	{
