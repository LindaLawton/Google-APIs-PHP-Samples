...
print_r(smimeInfoGetExample($service, $userId, $sendAsEmail, $id));
...
* @return SmimeInfo</returns>
*/
function smimeInfoGetExample($service, $userId, $sendAsEmail, $id)
{
	try
	{
		...
		return $service->smimeInfo->GetSmimeInfo($userId, $sendAsEmail, $id);
	}
	catch (Exception $ex)
	{
