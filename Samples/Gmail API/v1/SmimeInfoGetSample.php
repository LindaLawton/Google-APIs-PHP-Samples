...
// Single Request.
$results = smimeInfoGetExample($service, $userId, $sendAsEmail, $id, $optParams);
...
* @return SmimeInfo
*/
function smimeInfoGetExample($service, $userId, $sendAsEmail, $id, $optParams)
{
	try
	{
		...
		return $service->smimeInfo->GetSmimeInfo($userId, $sendAsEmail, $id, $optParams);
	}
	catch (Exception $e)
	{
