...
$results = threadsModifyExample($service, $userId, $id, $optParams);
...
* @return Thread
*/
function threadsModifyExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->threads->ModifyThreads($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
