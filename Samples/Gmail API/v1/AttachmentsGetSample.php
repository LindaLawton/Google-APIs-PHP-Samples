...
// Single Request.
$results = attachmentsGetExample($service, $userId, $messageId, $id, $optParams);
...
*/
function attachmentsGetExample($service, $userId, $messageId, $id, $optParams)
{
	try
	{
		...
		return $service->attachments->GetAttachments($userId, $messageId, $id, $optParams);
	}
	catch (Exception $e)
	{
