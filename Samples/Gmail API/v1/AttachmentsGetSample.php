...
print_r(attachmentsGetExample($service, $userId, $messageId, $id));
...
* @return MessagePartBody</returns>
*/
function attachmentsGetExample($service, $userId, $messageId, $id)
{
	try
	{
		...
		return $service->attachments->GetAttachments($userId, $messageId, $id);
	}
	catch (Exception $ex)
	{
