...
// Single Request.
$results = forwardingAddressesListExample($service, $userId, $optParams);
...
*/
function forwardingAddressesListExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->forwardingAddresses->ListForwardingAddresses($userId, $optParams);
	}
	catch (Exception $e)
	{
