...
print_r(forwardingAddressesListExample($service, $userId));
...
* @return ListForwardingAddressesResponse</returns>
*/
function forwardingAddressesListExample($service, $userId)
{
	try
	{
		...
		return $service->forwardingAddresses->ListForwardingAddresses($userId);
	}
	catch (Exception $ex)
	{
