...
# UnOfficial Gmail API v1 Samples for PHP
...
These samples show how to access the [Gmail API v1](https://developers.google.com/gmail/api/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
