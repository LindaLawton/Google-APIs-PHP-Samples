...
print_r(forwardingAddressesCreateExample($service, $userId));
...
*/
function forwardingAddressesCreateExample($service, $userId)
{
	try
	{
		...
		return $service->forwardingAddresses->CreateForwardingAddresses($userId);
	}
	catch (Exception $ex)
	{
