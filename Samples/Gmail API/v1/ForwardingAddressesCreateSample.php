...
$results = forwardingAddressesCreateExample($service, $userId, $optParams);
...
*/
function forwardingAddressesCreateExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->forwardingAddresses->CreateForwardingAddresses($userId, $optParams);
	}
	catch (Exception $e)
	{
