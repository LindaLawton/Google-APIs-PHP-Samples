...
print_r(threadsListExample($service, $userId));

/**
* Lists the threads in the user's mailbox.
* @service Authenticated Gmail service.
* @userId The user's email address. The special value me can be used to indicate the authenticated user.
* @return ListThreadsResponse</returns>
*/
function threadsListExample($service, $userId)
{
	try
	{
		...
		return $service->threads->ListThreads($userId);
	}
	catch (Exception $ex)
	{
