...
// Single Request.
$results = filtersGetExample($service, $userId, $id, $optParams);
...
* @return Filter
*/
function filtersGetExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->filters->GetFilters($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
