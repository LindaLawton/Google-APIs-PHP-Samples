...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'format' => '[YourValue]',  // The format to return the messages in.
            
  //'metadataHeaders' => '[YourValue]',  // When given and format is METADATA, only include headers specified.
  'fields' => '*'
);
// Single Request.
$results = threadsGetExample($service, $userId, $id, $optParams);
...
* @return Thread
*/
function threadsGetExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->threads->GetThreads($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
