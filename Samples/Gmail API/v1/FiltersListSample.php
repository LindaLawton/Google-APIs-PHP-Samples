...
print_r(filtersListExample($service, $userId));
...
* @return ListFiltersResponse</returns>
*/
function filtersListExample($service, $userId)
{
	try
	{
		...
		return $service->filters->ListFilters($userId);
	}
	catch (Exception $ex)
	{
