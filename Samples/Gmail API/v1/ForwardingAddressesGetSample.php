...
print_r(forwardingAddressesGetExample($service, $userId, $forwardingEmail));
...
* @return ForwardingAddress</returns>
*/
function forwardingAddressesGetExample($service, $userId, $forwardingEmail)
{
	try
	{
		...
		return $service->forwardingAddresses->GetForwardingAddresses($userId, $forwardingEmail);
	}
	catch (Exception $ex)
	{
