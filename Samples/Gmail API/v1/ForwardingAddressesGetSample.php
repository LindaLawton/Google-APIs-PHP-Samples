...
// Single Request.
$results = forwardingAddressesGetExample($service, $userId, $forwardingEmail, $optParams);
...
*/
function forwardingAddressesGetExample($service, $userId, $forwardingEmail, $optParams)
{
	try
	{
		...
		return $service->forwardingAddresses->GetForwardingAddresses($userId, $forwardingEmail, $optParams);
	}
	catch (Exception $e)
	{
