...
$results = filtersDeleteExample($service, $userId, $id, $optParams);
...
*/
function filtersDeleteExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->filters->DeleteFilters($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
