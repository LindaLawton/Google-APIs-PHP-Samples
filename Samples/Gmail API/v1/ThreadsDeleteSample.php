...
$results = threadsDeleteExample($service, $userId, $id, $optParams);
...
*/
function threadsDeleteExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->threads->DeleteThreads($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
