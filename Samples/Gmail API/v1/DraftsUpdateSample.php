...
print_r(draftsUpdateExample($service, $userId, $id));
...
* @return Draft</returns>
*/
function draftsUpdateExample($service, $userId, $id)
{
	try
	{
		...
		return $service->drafts->UpdateDrafts($userId, $id);
	}
	catch (Exception $ex)
	{
