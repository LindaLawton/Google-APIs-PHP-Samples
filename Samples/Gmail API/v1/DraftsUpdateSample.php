...
// Single Request.
$results = draftsUpdateExample($service, $userId, $id, $optParams);
...
* @return Draft
*/
function draftsUpdateExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->drafts->UpdateDrafts($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
