...
// Single Request.
$results = labelsUpdateExample($service, $userId, $id, $optParams);
...
* @return Label
*/
function labelsUpdateExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->labels->UpdateLabels($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
