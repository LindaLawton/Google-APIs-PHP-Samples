...
print_r(smimeInfoListExample($service, $userId, $sendAsEmail));
...
* @return ListSmimeInfoResponse</returns>
*/
function smimeInfoListExample($service, $userId, $sendAsEmail)
{
	try
	{
		...
		return $service->smimeInfo->ListSmimeInfo($userId, $sendAsEmail);
	}
	catch (Exception $ex)
	{
