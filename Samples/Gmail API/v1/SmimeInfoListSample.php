...
// Single Request.
$results = smimeInfoListExample($service, $userId, $sendAsEmail, $optParams);
...
*/
function smimeInfoListExample($service, $userId, $sendAsEmail, $optParams)
{
	try
	{
		...
		return $service->smimeInfo->ListSmimeInfo($userId, $sendAsEmail, $optParams);
	}
	catch (Exception $e)
	{
