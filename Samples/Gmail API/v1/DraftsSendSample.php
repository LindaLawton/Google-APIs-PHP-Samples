...
// Single Request.
$results = draftsSendExample($service, $userId, $optParams);
...
* @return Message
*/
function draftsSendExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->drafts->SendDrafts($userId, $optParams);
	}
	catch (Exception $e)
	{
