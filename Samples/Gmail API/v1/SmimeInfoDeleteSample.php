...
$results = smimeInfoDeleteExample($service, $userId, $sendAsEmail, $id, $optParams);
...
*/
function smimeInfoDeleteExample($service, $userId, $sendAsEmail, $id, $optParams)
{
	try
	{
		...
		if (sendAsEmail == null)
			throw new Exception("sendAsEmail is required.");
		if (userId == null)
			throw new Exception("userId is required.");
		// Make the request and return the results.
		return $service->smimeInfo->DeleteSmimeInfo($userId, $sendAsEmail, $id, $optParams);
	}
	catch (Exception $e)
	{
