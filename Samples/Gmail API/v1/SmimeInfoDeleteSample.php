...
print_r(smimeInfoDeleteExample($service, $userId, $sendAsEmail, $id));
...
*/
function smimeInfoDeleteExample($service, $userId, $sendAsEmail, $id)
{
	try
	{
		...
		return $service->smimeInfo->DeleteSmimeInfo($userId, $sendAsEmail, $id);
	}
	catch (Exception $ex)
	{
