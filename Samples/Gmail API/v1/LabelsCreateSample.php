...
// Single Request.
$results = labelsCreateExample($service, $userId, $optParams);
...
* @return Label
*/
function labelsCreateExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->labels->CreateLabels($userId, $optParams);
	}
	catch (Exception $e)
	{
