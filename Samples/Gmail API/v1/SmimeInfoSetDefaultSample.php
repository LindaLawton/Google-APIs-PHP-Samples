...
print_r(smimeInfoSetDefaultExample($service, $userId, $sendAsEmail, $id));
...
*/
function smimeInfoSetDefaultExample($service, $userId, $sendAsEmail, $id)
{
	try
	{
		...
		return $service->smimeInfo->SetDefaultSmimeInfo($userId, $sendAsEmail, $id);
	}
	catch (Exception $ex)
	{
