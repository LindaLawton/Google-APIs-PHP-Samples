...
// Single Request.
$results = draftsCreateExample($service, $userId, $optParams);
...
* @return Draft
*/
function draftsCreateExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->drafts->CreateDrafts($userId, $optParams);
	}
	catch (Exception $e)
	{
