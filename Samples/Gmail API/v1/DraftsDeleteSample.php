...
$results = draftsDeleteExample($service, $userId, $id, $optParams);
...
*/
function draftsDeleteExample($service, $userId, $id, $optParams)
{
	try
	{
		...
		return $service->drafts->DeleteDrafts($userId, $id, $optParams);
	}
	catch (Exception $e)
	{
