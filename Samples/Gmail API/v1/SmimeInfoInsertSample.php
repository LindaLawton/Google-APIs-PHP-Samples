...
// Single Request.
$results = smimeInfoInsertExample($service, $userId, $sendAsEmail, $optParams);
...
* @return SmimeInfo
*/
function smimeInfoInsertExample($service, $userId, $sendAsEmail, $optParams)
{
	try
	{
		...
		return $service->smimeInfo->InsertSmimeInfo($userId, $sendAsEmail, $optParams);
	}
	catch (Exception $e)
	{
