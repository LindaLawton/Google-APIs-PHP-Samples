...
print_r(smimeInfoInsertExample($service, $userId, $sendAsEmail));
...
*/
function smimeInfoInsertExample($service, $userId, $sendAsEmail)
{
	try
	{
		...
		return $service->smimeInfo->InsertSmimeInfo($userId, $sendAsEmail);
	}
	catch (Exception $ex)
	{
