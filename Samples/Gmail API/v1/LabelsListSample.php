...
// Single Request.
$results = labelsListExample($service, $userId, $optParams);
...
*/
function labelsListExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->labels->ListLabels($userId, $optParams);
	}
	catch (Exception $e)
	{
