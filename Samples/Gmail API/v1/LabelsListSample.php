...
print_r(labelsListExample($service, $userId));

/**
* Lists all labels in the user's mailbox.
* @service Authenticated Gmail service.
* @userId The user's email address. The special value me can be used to indicate the authenticated user.
* @return ListLabelsResponse</returns>
*/
function labelsListExample($service, $userId)
{
	try
	{
		...
		return $service->labels->ListLabels($userId);
	}
	catch (Exception $ex)
	{
