...
// Single Request.
$results = servicesAllocateQuotaExample($service, $serviceName, $optParams);
...
*/
function servicesAllocateQuotaExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->services->AllocateQuotaServices($serviceName, $optParams);
	}
	catch (Exception $e)
	{
