...
print_r(servicesAllocateQuotaExample($service, $serviceName));
...
* @return AllocateQuotaResponse</returns>
*/
function servicesAllocateQuotaExample($service, $serviceName)
{
	try
	{
		...
		return $service->services->AllocateQuotaServices($serviceName);
	}
	catch (Exception $ex)
	{
