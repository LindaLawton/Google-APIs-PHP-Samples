...
// Single Request.
$results = servicesReportExample($service, $serviceName, $optParams);
...
*/
function servicesReportExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->services->ReportServices($serviceName, $optParams);
	}
	catch (Exception $e)
	{
