...
print_r(servicesReportExample($service, $serviceName));
...
* @return ReportResponse</returns>
*/
function servicesReportExample($service, $serviceName)
{
	try
	{
		...
		return $service->services->ReportServices($serviceName);
	}
	catch (Exception $ex)
	{
