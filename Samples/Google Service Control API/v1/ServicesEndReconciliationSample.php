...
$results = servicesEndReconciliationExample($service, $serviceName, $optParams);
...
* @return EndReconciliationResponse
*/
function servicesEndReconciliationExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->services->EndReconciliationServices($serviceName, $optParams);
	}
	catch (Exception $e)
	{
