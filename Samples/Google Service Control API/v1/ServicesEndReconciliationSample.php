...
print_r(servicesEndReconciliationExample($service, $serviceName));
...
* @return EndReconciliationResponse</returns>
*/
function servicesEndReconciliationExample($service, $serviceName)
{
	try
	{
		...
		return $service->services->EndReconciliationServices($serviceName);
	}
	catch (Exception $ex)
	{
