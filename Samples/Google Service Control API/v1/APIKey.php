...
// About 
// 
// Unofficial sample for the Servicecontrol v1 API for PHP. 
 ...
 * Initializes an Servicecontrol.v1 service object.
 * @param string API key
 * @return An authorized Servicecontrol.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Servicecontrol Sample");
		...
		// Create authenticated Servicecontrol service
		return new Google_Service_Servicecontrol($client);
	} catch (Exception $e) {
