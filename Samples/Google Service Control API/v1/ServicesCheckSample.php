...
// Single Request.
$results = servicesCheckExample($service, $serviceName, $optParams);
...
*/
function servicesCheckExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->services->CheckServices($serviceName, $optParams);
	}
	catch (Exception $e)
	{
