...
# UnOfficial Google Service Control API v1 Samples for PHP
...
[Official Documentation](https://cloud.google.com/service-control/)

## Sample Description

These samples show how to access the [Google Service Control API v1](https://cloud.google.com/service-control/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
