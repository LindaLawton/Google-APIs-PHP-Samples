...
print_r(servicesReleaseQuotaExample($service, $serviceName));
...
*/
function servicesReleaseQuotaExample($service, $serviceName)
{
	try
	{
		...
		return $service->services->ReleaseQuotaServices($serviceName);
	}
	catch (Exception $ex)
	{
