...
* @return ReleaseQuotaResponse
*/
function servicesReleaseQuotaExample($service, $serviceName, $optParams)
{
	try
	{
		...
		return $service->services->ReleaseQuotaServices($serviceName, $optParams);
	}
	catch (Exception $e)
	{
