...
# UnOfficial Google Analytics Reporting API v4 Samples for PHP

## API Description

Accesses Analytics report data.

[Official Documentation](https://developers.google.com/analytics/devguides/reporting/core/v4/)

## Sample Description

These samples show how to access the [Google Analytics Reporting API v4](https://developers.google.com/analytics/devguides/reporting/core/v4/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
