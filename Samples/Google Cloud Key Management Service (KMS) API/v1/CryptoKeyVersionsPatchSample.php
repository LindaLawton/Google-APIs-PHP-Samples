...
print_r(cryptoKeyVersionsPatchExample($service, $name));
...
*/
function cryptoKeyVersionsPatchExample($service, $name)
{
	try
	{
		...
		return $service->cryptoKeyVersions->PatchCryptoKeyVersions($name);
	}
	catch (Exception $ex)
	{
