...
// About 
// 
// Unofficial sample for the Cloud KMS v1 API for PHP. 
...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  // Required list of fields to be updated in this request.
  'fields' => '*'
);
// Single Request.
$results = cryptoKeyVersionsPatchExample($service, $name, $optParams);
...
function cryptoKeyVersionsPatchExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->cryptoKeyVersions->PatchCryptoKeyVersions($name, $optParams);
	}
	catch (Exception $e)
	{
