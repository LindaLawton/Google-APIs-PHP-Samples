...
// Single Request.
$results = cryptoKeyVersionsRestoreExample($service, $name, $optParams);
...
*/
function cryptoKeyVersionsRestoreExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->cryptoKeyVersions->RestoreCryptoKeyVersions($name, $optParams);
	}
	catch (Exception $e)
	{
