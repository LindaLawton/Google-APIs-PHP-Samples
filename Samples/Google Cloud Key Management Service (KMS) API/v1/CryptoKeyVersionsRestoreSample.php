...
print_r(cryptoKeyVersionsRestoreExample($service, $name));
...
*/
function cryptoKeyVersionsRestoreExample($service, $name)
{
	try
	{
		...
		return $service->cryptoKeyVersions->RestoreCryptoKeyVersions($name);
	}
	catch (Exception $ex)
	{
