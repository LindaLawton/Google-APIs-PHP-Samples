...
print_r(cryptoKeyVersionsGetExample($service, $name));
...
*/
function cryptoKeyVersionsGetExample($service, $name)
{
	try
	{
		...
		return $service->cryptoKeyVersions->GetCryptoKeyVersions($name);
	}
	catch (Exception $ex)
	{
