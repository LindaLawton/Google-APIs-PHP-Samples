...
// Single Request.
$results = cryptoKeyVersionsGetExample($service, $name, $optParams);
...
*/
function cryptoKeyVersionsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->cryptoKeyVersions->GetCryptoKeyVersions($name, $optParams);
	}
	catch (Exception $e)
	{
