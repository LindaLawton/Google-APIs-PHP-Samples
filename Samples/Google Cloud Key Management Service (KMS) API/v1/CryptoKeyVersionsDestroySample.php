...
$results = cryptoKeyVersionsDestroyExample($service, $name, $optParams);
...
*/
function cryptoKeyVersionsDestroyExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->cryptoKeyVersions->DestroyCryptoKeyVersions($name, $optParams);
	}
	catch (Exception $e)
	{
