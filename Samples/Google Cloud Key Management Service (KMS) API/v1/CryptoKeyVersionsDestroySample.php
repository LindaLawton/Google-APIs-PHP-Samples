...
print_r(cryptoKeyVersionsDestroyExample($service, $name));
...
*/
function cryptoKeyVersionsDestroyExample($service, $name)
{
	try
	{
		...
		return $service->cryptoKeyVersions->DestroyCryptoKeyVersions($name);
	}
	catch (Exception $ex)
	{
