...
print_r(cryptoKeyVersionsListExample($service, $parent));
...
* @return ListCryptoKeyVersionsResponse</returns>
*/
function cryptoKeyVersionsListExample($service, $parent)
{
	try
	{
		...
		return $service->cryptoKeyVersions->ListCryptoKeyVersions($parent);
	}
	catch (Exception $ex)
	{
