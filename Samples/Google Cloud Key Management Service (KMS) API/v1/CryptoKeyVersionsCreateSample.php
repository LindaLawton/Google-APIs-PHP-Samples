...
// Single Request.
$results = cryptoKeyVersionsCreateExample($service, $parent, $optParams);
...
*/
function cryptoKeyVersionsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->cryptoKeyVersions->CreateCryptoKeyVersions($parent, $optParams);
	}
	catch (Exception $e)
	{
