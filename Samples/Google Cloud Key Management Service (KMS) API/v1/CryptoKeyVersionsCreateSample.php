...
print_r(cryptoKeyVersionsCreateExample($service, $parent));
...
* @return CryptoKeyVersion</returns>
*/
function cryptoKeyVersionsCreateExample($service, $parent)
{
	try
	{
		...
		return $service->cryptoKeyVersions->CreateCryptoKeyVersions($parent);
	}
	catch (Exception $ex)
	{
