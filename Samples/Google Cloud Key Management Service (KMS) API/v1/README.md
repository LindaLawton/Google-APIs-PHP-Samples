...
# UnOfficial Google Cloud Key Management Service (KMS) API v1 Samples for PHP
...
[Official Documentation](https://cloud.google.com/kms/)

## Sample Description

These samples show how to access the [Google Cloud Key Management Service (KMS) API v1](https://cloud.google.com/kms/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
