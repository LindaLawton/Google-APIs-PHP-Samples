...
print_r(apisGetRestExample($service, $api, $version));

/**
* Retrieve the description of a particular version of an api.
* @service Authenticated Discovery service.
* @api The name of the API.
* @version The version of the API.
* @return RestDescription</returns>
*/
function apisGetRestExample($service, $api, $version)
{
	try
	{
		...
		return $service->apis->GetRestApis($api, $version);
	}
	catch (Exception $ex)
	{
