...
$results = apisGetRestExample($service, $api, $version, $optParams);
...
*/
function apisGetRestExample($service, $api, $version, $optParams)
{
	try
	{
		...
		return $service->apis->GetRestApis($api, $version, $optParams);
	}
	catch (Exception $e)
	{
