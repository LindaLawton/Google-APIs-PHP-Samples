...
# UnOfficial APIs Discovery Service v1 Samples for PHP

## API Description

Provides information about other Google APIs, such as what APIs are available, the resource, and method details for each API.

[Official Documentation](https://developers.google.com/discovery/)

## Sample Description

These samples show how to access the [APIs Discovery Service v1](https://developers.google.com/discovery/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
