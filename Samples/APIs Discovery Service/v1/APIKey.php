...
// About 
// 
// Unofficial sample for the Discovery v1 API for PHP. 
 ...
 * Initializes an Discovery.v1 service object.
 * @param string API key
 * @return An authorized Discovery.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Discovery Sample");
		...
		// Create authenticated Discovery service
		return new Google_Service_Discovery($client);
	} catch (Exception $e) {
