...
print_r(imagesAnnotateExample($service));

/**
* Run image detection and annotation for a batch of images.
* @service Authenticated Vision service.
* @return BatchAnnotateImagesResponse</returns>
*/
function imagesAnnotateExample($service)
{
	try
	{
		...
		return $service->images->AnnotateImages();
	}
	catch (Exception $ex)
	{
