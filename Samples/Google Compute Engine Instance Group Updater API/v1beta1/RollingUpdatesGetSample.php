...
$results = rollingUpdatesGetExample($service, $project, $zone, $rollingUpdate, $optParams);
...
*/
function rollingUpdatesGetExample($service, $project, $zone, $rollingUpdate, $optParams)
{
	try
	{
		...
		return $service->rollingUpdates->GetRollingUpdates($project, $zone, $rollingUpdate, $optParams);
	}
	catch (Exception $e)
	{
