...
print_r(rollingUpdatesGetExample($service, $project, $zone, $rollingUpdate));
...
* @return RollingUpdate</returns>
*/
function rollingUpdatesGetExample($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollingUpdates->GetRollingUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
