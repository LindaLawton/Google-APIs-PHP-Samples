...
// Single Request.
$results = rollingUpdatesListExample($service, $project, $zone, $optParams);
...
* @return RollingUpdateList
*/
function rollingUpdatesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->rollingUpdates->ListRollingUpdates($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
