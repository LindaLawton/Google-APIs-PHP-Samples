...
print_r(rollingUpdatesListExample($service, $project, $zone));
...
* @return RollingUpdateList</returns>
*/
function rollingUpdatesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->rollingUpdates->ListRollingUpdates($project, $zone);
	}
	catch (Exception $ex)
	{
