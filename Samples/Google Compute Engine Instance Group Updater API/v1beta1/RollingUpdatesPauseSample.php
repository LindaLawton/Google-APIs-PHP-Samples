...
print_r(rollingUpdatesPauseExample($service, $project, $zone, $rollingUpdate));
...
*/
function rollingUpdatesPauseExample($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollingUpdates->PauseRollingUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
