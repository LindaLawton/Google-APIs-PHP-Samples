...
// Single Request.
$results = rollingUpdatesPauseExample($service, $project, $zone, $rollingUpdate, $optParams);
...
* @return Operation
*/
function rollingUpdatesPauseExample($service, $project, $zone, $rollingUpdate, $optParams)
{
	try
	{
		...
		return $service->rollingUpdates->PauseRollingUpdates($project, $zone, $rollingUpdate, $optParams);
	}
	catch (Exception $e)
	{
