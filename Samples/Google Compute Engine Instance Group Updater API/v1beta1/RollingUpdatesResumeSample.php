...
// Single Request.
$results = rollingUpdatesResumeExample($service, $project, $zone, $rollingUpdate, $optParams);
...
* @return Operation
*/
function rollingUpdatesResumeExample($service, $project, $zone, $rollingUpdate, $optParams)
{
	try
	{
		...
		return $service->rollingUpdates->ResumeRollingUpdates($project, $zone, $rollingUpdate, $optParams);
	}
	catch (Exception $e)
	{
