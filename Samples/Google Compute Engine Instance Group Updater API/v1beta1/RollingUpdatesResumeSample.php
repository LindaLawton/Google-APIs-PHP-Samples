...
print_r(rollingUpdatesResumeExample($service, $project, $zone, $rollingUpdate));
...
*/
function rollingUpdatesResumeExample($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollingUpdates->ResumeRollingUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
