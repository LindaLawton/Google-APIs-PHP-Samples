...
print_r(zoneOperationsGetExample($service, $project, $zone, $operation));
...
*/
function zoneOperationsGetExample($service, $project, $zone, $operation)
{
	try
	{
		...
		return $service->zoneOperations->GetZoneOperations($project, $zone, $operation);
	}
	catch (Exception $ex)
	{
