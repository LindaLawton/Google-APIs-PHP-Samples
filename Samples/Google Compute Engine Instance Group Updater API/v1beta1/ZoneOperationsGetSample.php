...
$results = zoneOperationsGetExample($service, $project, $zone, $operation, $optParams);
...
* @return Operation
*/
function zoneOperationsGetExample($service, $project, $zone, $operation, $optParams)
{
	try
	{
		...
		return $service->zoneOperations->GetZoneOperations($project, $zone, $operation, $optParams);
	}
	catch (Exception $e)
	{
