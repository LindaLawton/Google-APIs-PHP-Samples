...
// Single Request.
$results = rollingUpdatesRollbackExample($service, $project, $zone, $rollingUpdate, $optParams);
...
* @return Operation
*/
function rollingUpdatesRollbackExample($service, $project, $zone, $rollingUpdate, $optParams)
{
	try
	{
		...
		return $service->rollingUpdates->RollbackRollingUpdates($project, $zone, $rollingUpdate, $optParams);
	}
	catch (Exception $e)
	{
