...
print_r(rollingUpdatesRollbackExample($service, $project, $zone, $rollingUpdate));
...
*/
function rollingUpdatesRollbackExample($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollingUpdates->RollbackRollingUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
