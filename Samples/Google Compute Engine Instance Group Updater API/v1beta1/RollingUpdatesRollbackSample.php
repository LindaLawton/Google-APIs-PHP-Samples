...
print_r(rollback($service, $project, $zone, $rollingUpdate));
...
*/
function rollback($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollback($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
