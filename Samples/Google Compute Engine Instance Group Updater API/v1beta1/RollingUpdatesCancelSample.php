...
print_r(rollingUpdatesCancelExample($service, $project, $zone, $rollingUpdate));
...
*/
function rollingUpdatesCancelExample($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollingUpdates->CancelRollingUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
