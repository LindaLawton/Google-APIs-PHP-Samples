...
// Single Request.
$results = rollingUpdatesCancelExample($service, $project, $zone, $rollingUpdate, $optParams);
...
* @return Operation
*/
function rollingUpdatesCancelExample($service, $project, $zone, $rollingUpdate, $optParams)
{
	try
	{
		...
		return $service->rollingUpdates->CancelRollingUpdates($project, $zone, $rollingUpdate, $optParams);
	}
	catch (Exception $e)
	{
