...
print_r(zoneOperationsListExample($service, $project, $zone));
...
*/
function zoneOperationsListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->zoneOperations->ListZoneOperations($project, $zone);
	}
	catch (Exception $ex)
	{
