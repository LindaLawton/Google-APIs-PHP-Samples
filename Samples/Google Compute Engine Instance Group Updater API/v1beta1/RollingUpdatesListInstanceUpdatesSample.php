...
print_r(listInstanceUpdates($service, $project, $zone, $rollingUpdate));
...
*/
function listInstanceUpdates($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->listInstanceUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
