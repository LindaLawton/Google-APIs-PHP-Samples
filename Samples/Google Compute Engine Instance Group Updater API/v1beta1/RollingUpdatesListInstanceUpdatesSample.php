...
print_r(rollingUpdatesListInstanceUpdatesExample($service, $project, $zone, $rollingUpdate));
...
* @return InstanceUpdateList</returns>
*/
function rollingUpdatesListInstanceUpdatesExample($service, $project, $zone, $rollingUpdate)
{
	try
	{
		...
		return $service->rollingUpdates->ListInstanceUpdatesRollingUpdates($project, $zone, $rollingUpdate);
	}
	catch (Exception $ex)
	{
