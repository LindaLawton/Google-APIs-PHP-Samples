 ...
 * Initializes an Replicapoolupdater.v1beta1 service object.
 * @param string API key
 * @return An authorized Replicapoolupdater.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Replicapoolupdater Sample");
		...
		// Create authenticated Replicapoolupdater service
		return new Google_Service_Replicapoolupdater($client);
	} catch (Exception $e) {
