...
print_r(rollingUpdatesInsertExample($service, $project, $zone));
...
*/
function rollingUpdatesInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->rollingUpdates->InsertRollingUpdates($project, $zone);
	}
	catch (Exception $ex)
	{
