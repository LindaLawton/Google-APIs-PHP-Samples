...
# Unoffical Google Compute Engine Instance Group Updater API Samples for PHP
...
These samples show how to access the [Google Compute Engine Instance Group Updater API](https://cloud.google.com/compute/docs/instance-groups/manager/#applying_rolling_updates_using_the_updater_service) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
