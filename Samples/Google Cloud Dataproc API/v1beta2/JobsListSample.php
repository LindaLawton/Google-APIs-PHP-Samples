...
print_r(jobsListExample($service, $projectId, $region));
...
* @return ListJobsResponse</returns>
*/
function jobsListExample($service, $projectId, $region)
{
	try
	{
		...
		return $service->jobs->ListJobs($projectId, $region);
	}
	catch (Exception $ex)
	{
