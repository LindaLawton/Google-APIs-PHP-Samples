...
// Single Request.
$results = clustersGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function clustersGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->clusters->GetIamPolicyClusters($resource, $optParams);
	}
	catch (Exception $e)
	{
