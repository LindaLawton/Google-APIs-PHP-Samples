...
print_r(clustersGetIamPolicyExample($service, $resource));
...
*/
function clustersGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->clusters->GetIamPolicyClusters($resource);
	}
	catch (Exception $ex)
	{
