...
print_r(delete($service, $projectId, $region, $clusterName));
...
*/
function delete($service, $projectId, $region, $clusterName)
{
	try
	{
		...
		return $service->delete($projectId, $region, $clusterName);
	}
	catch (Exception $ex)
	{
