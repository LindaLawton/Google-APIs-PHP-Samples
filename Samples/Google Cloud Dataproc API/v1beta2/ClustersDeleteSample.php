...
print_r(clustersDeleteExample($service, $projectId, $region, $clusterName));
...
*/
function clustersDeleteExample($service, $projectId, $region, $clusterName)
{
	try
	{
		...
		return $service->clusters->DeleteClusters($projectId, $region, $clusterName);
	}
	catch (Exception $ex)
	{
