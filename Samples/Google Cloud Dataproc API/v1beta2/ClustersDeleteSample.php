...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'clusterUuid' => '[YourValue]',  // Optional. Specifying the cluster_uuid means the RPC should fail (with error NOT_FOUND) if cluster with specified UUID does not exist.
  'fields' => '*'
);
// Single Request.
$results = clustersDeleteExample($service, $projectId, $region, $clusterName, $optParams);
...
* @return Operation
*/
function clustersDeleteExample($service, $projectId, $region, $clusterName, $optParams)
{
	try
	{
		...
		return $service->clusters->DeleteClusters($projectId, $region, $clusterName, $optParams);
	}
	catch (Exception $e)
	{
