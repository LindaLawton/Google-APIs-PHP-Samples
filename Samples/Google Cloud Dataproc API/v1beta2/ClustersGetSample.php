...
print_r(clustersGetExample($service, $projectId, $region, $clusterName));
...
* @return Cluster</returns>
*/
function clustersGetExample($service, $projectId, $region, $clusterName)
{
	try
	{
		...
		return $service->clusters->GetClusters($projectId, $region, $clusterName);
	}
	catch (Exception $ex)
	{
