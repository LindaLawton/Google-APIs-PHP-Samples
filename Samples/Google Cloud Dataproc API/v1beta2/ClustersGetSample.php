...
$results = clustersGetExample($service, $projectId, $region, $clusterName, $optParams);
...
* @return Cluster
*/
function clustersGetExample($service, $projectId, $region, $clusterName, $optParams)
{
	try
	{
		...
		return $service->clusters->GetClusters($projectId, $region, $clusterName, $optParams);
	}
	catch (Exception $e)
	{
