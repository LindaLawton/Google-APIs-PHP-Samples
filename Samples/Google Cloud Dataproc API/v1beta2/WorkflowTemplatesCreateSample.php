...
// Single Request.
$results = workflowTemplatesCreateExample($service, $parent, $optParams);
...
*/
function workflowTemplatesCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->workflowTemplates->CreateWorkflowTemplates($parent, $optParams);
	}
	catch (Exception $e)
	{
