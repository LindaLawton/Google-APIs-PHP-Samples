...
$results = clustersCreateExample($service, $projectId, $region, $optParams);
...
* @return Operation
*/
function clustersCreateExample($service, $projectId, $region, $optParams)
{
	try
	{
		...
		return $service->clusters->CreateClusters($projectId, $region, $optParams);
	}
	catch (Exception $e)
	{
