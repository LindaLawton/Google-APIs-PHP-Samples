...
print_r(clustersSetIamPolicyExample($service, $resource));
...
*/
function clustersSetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->clusters->SetIamPolicyClusters($resource);
	}
	catch (Exception $ex)
	{
