...
// Single Request.
$results = clustersSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function clustersSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->clusters->SetIamPolicyClusters($resource, $optParams);
	}
	catch (Exception $e)
	{
