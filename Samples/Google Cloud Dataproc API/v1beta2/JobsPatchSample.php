...
print_r(jobsPatchExample($service, $projectId, $region, $jobId));
...
* @return Job</returns>
*/
function jobsPatchExample($service, $projectId, $region, $jobId)
{
	try
	{
		...
		return $service->jobs->PatchJobs($projectId, $region, $jobId);
	}
	catch (Exception $ex)
	{
