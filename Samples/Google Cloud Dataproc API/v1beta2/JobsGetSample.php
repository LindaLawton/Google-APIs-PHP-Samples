...
print_r(jobsGetExample($service, $projectId, $region, $jobId));
...
* @return Job</returns>
*/
function jobsGetExample($service, $projectId, $region, $jobId)
{
	try
	{
		...
		return $service->jobs->GetJobs($projectId, $region, $jobId);
	}
	catch (Exception $ex)
	{
