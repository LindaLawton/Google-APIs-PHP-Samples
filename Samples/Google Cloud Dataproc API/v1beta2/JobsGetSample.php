...
// Single Request.
$results = jobsGetExample($service, $projectId, $region, $jobId, $optParams);
...
* @return Job
*/
function jobsGetExample($service, $projectId, $region, $jobId, $optParams)
{
	try
	{
		...
		return $service->jobs->GetJobs($projectId, $region, $jobId, $optParams);
	}
	catch (Exception $e)
	{
