...
print_r(clustersTestIamPermissionsExample($service, $resource));
...
*/
function clustersTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->clusters->TestIamPermissionsClusters($resource);
	}
	catch (Exception $ex)
	{
