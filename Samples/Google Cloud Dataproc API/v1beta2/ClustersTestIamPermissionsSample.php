...
// Single Request.
$results = clustersTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function clustersTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->clusters->TestIamPermissionsClusters($resource, $optParams);
	}
	catch (Exception $e)
	{
