...
print_r(diagnose($service, $projectId, $region, $clusterName));
...
*/
function diagnose($service, $projectId, $region, $clusterName)
{
	try
	{
		...
		return $service->diagnose($projectId, $region, $clusterName);
	}
	catch (Exception $ex)
	{
