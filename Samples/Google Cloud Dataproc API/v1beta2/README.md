...
# UnOfficial Google Cloud Dataproc API v1beta2 Samples for PHP

## API Description

Manages Hadoop-based clusters and jobs on Google Cloud Platform.

[Official Documentation](https://cloud.google.com/dataproc/)

## Sample Description

These samples show how to access the [Google Cloud Dataproc API v1beta2](https://cloud.google.com/dataproc/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
