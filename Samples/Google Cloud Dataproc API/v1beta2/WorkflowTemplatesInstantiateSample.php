...
// Single Request.
$results = workflowTemplatesInstantiateExample($service, $name, $optParams);
...
* @return Operation
*/
function workflowTemplatesInstantiateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->workflowTemplates->InstantiateWorkflowTemplates($name, $optParams);
	}
	catch (Exception $e)
	{
