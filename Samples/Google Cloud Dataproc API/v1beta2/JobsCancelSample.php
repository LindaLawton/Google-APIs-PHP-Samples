...
print_r(jobsCancelExample($service, $projectId, $region, $jobId));
...
* @return Job</returns>
*/
function jobsCancelExample($service, $projectId, $region, $jobId)
{
	try
	{
		...
		return $service->jobs->CancelJobs($projectId, $region, $jobId);
	}
	catch (Exception $ex)
	{
