...
print_r(clustersListExample($service, $projectId, $region));
...
* @return ListClustersResponse</returns>
*/
function clustersListExample($service, $projectId, $region)
{
	try
	{
		...
		return $service->clusters->ListClusters($projectId, $region);
	}
	catch (Exception $ex)
	{
