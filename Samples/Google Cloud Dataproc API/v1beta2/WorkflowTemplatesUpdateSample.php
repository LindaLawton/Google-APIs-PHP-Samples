...
// Single Request.
$results = workflowTemplatesUpdateExample($service, $name, $optParams);
...
*/
function workflowTemplatesUpdateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->workflowTemplates->UpdateWorkflowTemplates($name, $optParams);
	}
	catch (Exception $e)
	{
