...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'version' => '[YourValue]',  // Optional The version of workflow template to delete. If specified, will only delete the template if the current server version matches specified version.
  'fields' => '*'
);
// Single Request.
$results = workflowTemplatesDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function workflowTemplatesDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->workflowTemplates->DeleteWorkflowTemplates($name, $optParams);
	}
	catch (Exception $e)
	{
