...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageSize' => '[YourValue]',  // Optional The maximum number of results to return in each response.
  'fields' => '*'
);
// Single Request.
$results = workflowTemplatesListExample($service, $parent, $optParams);
...
*/
function workflowTemplatesListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->workflowTemplates->ListWorkflowTemplates($parent, $optParams);
	}
	catch (Exception $e)
	{
