...
// Single Request.
$results = jobsSubmitExample($service, $projectId, $region, $optParams);
...
* @return Job
*/
function jobsSubmitExample($service, $projectId, $region, $optParams)
{
	try
	{
		...
		return $service->jobs->SubmitJobs($projectId, $region, $optParams);
	}
	catch (Exception $e)
	{
