...
print_r(clustersPatchExample($service, $projectId, $region, $clusterName));
...
*/
function clustersPatchExample($service, $projectId, $region, $clusterName)
{
	try
	{
		...
		return $service->clusters->PatchClusters($projectId, $region, $clusterName);
	}
	catch (Exception $ex)
	{
