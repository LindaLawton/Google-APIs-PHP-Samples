...
// Single Request.
$results = jobsCancelExample($service, $projectId, $region, $jobId, $optParams);
...
* @return Job
*/
function jobsCancelExample($service, $projectId, $region, $jobId, $optParams)
{
	try
	{
		...
		return $service->jobs->CancelJobs($projectId, $region, $jobId, $optParams);
	}
	catch (Exception $e)
	{
