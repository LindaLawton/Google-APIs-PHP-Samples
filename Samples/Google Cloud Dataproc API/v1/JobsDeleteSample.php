...
$results = jobsDeleteExample($service, $projectId, $region, $jobId, $optParams);
...
* @return Empty
*/
function jobsDeleteExample($service, $projectId, $region, $jobId, $optParams)
{
	try
	{
		...
		return $service->jobs->DeleteJobs($projectId, $region, $jobId, $optParams);
	}
	catch (Exception $e)
	{
