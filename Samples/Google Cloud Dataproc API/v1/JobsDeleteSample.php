...
print_r(jobsDeleteExample($service, $projectId, $region, $jobId));
...
*/
function jobsDeleteExample($service, $projectId, $region, $jobId)
{
	try
	{
		...
		return $service->jobs->DeleteJobs($projectId, $region, $jobId);
	}
	catch (Exception $ex)
	{
