...
print_r(clustersCreateExample($service, $projectId, $region));
...
*/
function clustersCreateExample($service, $projectId, $region)
{
	try
	{
		...
		return $service->clusters->CreateClusters($projectId, $region);
	}
	catch (Exception $ex)
	{
