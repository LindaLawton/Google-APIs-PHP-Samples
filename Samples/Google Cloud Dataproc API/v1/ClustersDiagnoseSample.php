...
* @return Operation
*/
function clustersDiagnoseExample($service, $projectId, $region, $clusterName, $optParams)
{
	try
	{
		...
		return $service->clusters->DiagnoseClusters($projectId, $region, $clusterName, $optParams);
	}
	catch (Exception $e)
	{
