...
print_r(clustersDiagnoseExample($service, $projectId, $region, $clusterName));
...
*/
function clustersDiagnoseExample($service, $projectId, $region, $clusterName)
{
	try
	{
		...
		return $service->clusters->DiagnoseClusters($projectId, $region, $clusterName);
	}
	catch (Exception $ex)
	{
