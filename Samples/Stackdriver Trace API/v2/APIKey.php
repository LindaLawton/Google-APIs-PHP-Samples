...
// About 
// 
// Unofficial sample for the Cloud Trace v2 API for PHP. 
 ...
 * Initializes an Cloudtrace.v2 service object.
 * @param string API key
 * @return An authorized Cloudtrace.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudtrace Sample");
		...
		// Create authenticated Cloudtrace service
		return new Google_Service_Cloudtrace($client);
	} catch (Exception $e) {
