...
// Single Request.
$results = tracesGetExample($service, $projectId, $traceId, $optParams);
...
* @return Trace
*/
function tracesGetExample($service, $projectId, $traceId, $optParams)
{
	try
	{
		...
		if (traceId == null)
			throw new Exception("traceId is required.");
		// Make the request and return the results.
		return $service->traces->GetTraces($projectId, $traceId, $optParams);
	}
	catch (Exception $e)
	{
