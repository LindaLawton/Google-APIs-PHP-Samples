...
print_r(tracesGetExample($service, $projectId, $traceId));
...
*/
function tracesGetExample($service, $projectId, $traceId)
{
	try
	{
		...
		return $service->traces->GetTraces($projectId, $traceId);
	}
	catch (Exception $ex)
	{
