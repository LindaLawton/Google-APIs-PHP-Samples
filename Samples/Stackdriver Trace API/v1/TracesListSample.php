...
print_r(tracesListExample($service, $projectId));

/**
* Returns of a list of traces that match the specified filter conditions.
* @service Authenticated Cloudtrace service.
* @projectId ID of the Cloud project where the trace data is stored.
* @return ListTracesResponse</returns>
*/
function tracesListExample($service, $projectId)
{
	try
	{
		...
		return $service->traces->ListTraces($projectId);
	}
	catch (Exception $ex)
	{
