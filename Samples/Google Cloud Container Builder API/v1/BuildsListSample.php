...
print_r(buildsListExample($service, $projectId));
...
* @return ListBuildsResponse</returns>
*/
function buildsListExample($service, $projectId)
{
	try
	{
		...
		return $service->builds->ListBuilds($projectId);
	}
	catch (Exception $ex)
	{
