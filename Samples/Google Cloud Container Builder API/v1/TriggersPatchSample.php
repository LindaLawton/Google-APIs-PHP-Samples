...
// Single Request.
$results = triggersPatchExample($service, $projectId, $triggerId, $optParams);
...
* @return BuildTrigger
*/
function triggersPatchExample($service, $projectId, $triggerId, $optParams)
{
	try
	{
		...
		return $service->triggers->PatchTriggers($projectId, $triggerId, $optParams);
	}
	catch (Exception $e)
	{
