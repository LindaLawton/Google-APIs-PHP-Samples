...
print_r(triggersPatchExample($service, $projectId, $triggerId));
...
* @return BuildTrigger</returns>
*/
function triggersPatchExample($service, $projectId, $triggerId)
{
	try
	{
		...
		return $service->triggers->PatchTriggers($projectId, $triggerId);
	}
	catch (Exception $ex)
	{
