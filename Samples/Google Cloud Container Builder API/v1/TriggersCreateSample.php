...
// Single Request.
$results = triggersCreateExample($service, $projectId, $optParams);
...
* @return BuildTrigger
*/
function triggersCreateExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->triggers->CreateTriggers($projectId, $optParams);
	}
	catch (Exception $e)
	{
