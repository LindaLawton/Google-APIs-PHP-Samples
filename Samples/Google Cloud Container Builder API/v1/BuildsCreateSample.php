...
$results = buildsCreateExample($service, $projectId, $optParams);
...
* @return Operation
*/
function buildsCreateExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->builds->CreateBuilds($projectId, $optParams);
	}
	catch (Exception $e)
	{
