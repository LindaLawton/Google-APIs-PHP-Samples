...
print_r(triggersGetExample($service, $projectId, $triggerId));
...
*/
function triggersGetExample($service, $projectId, $triggerId)
{
	try
	{
		...
		return $service->triggers->GetTriggers($projectId, $triggerId);
	}
	catch (Exception $ex)
	{
