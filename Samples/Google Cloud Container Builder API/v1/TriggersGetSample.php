...
// Single Request.
$results = triggersGetExample($service, $projectId, $triggerId, $optParams);
...
* @return BuildTrigger
*/
function triggersGetExample($service, $projectId, $triggerId, $optParams)
{
	try
	{
		...
		return $service->triggers->GetTriggers($projectId, $triggerId, $optParams);
	}
	catch (Exception $e)
	{
