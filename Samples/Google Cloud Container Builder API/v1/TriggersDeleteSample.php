...
// Single Request.
$results = triggersDeleteExample($service, $projectId, $triggerId, $optParams);
...
* @return Empty
*/
function triggersDeleteExample($service, $projectId, $triggerId, $optParams)
{
	try
	{
		...
		return $service->triggers->DeleteTriggers($projectId, $triggerId, $optParams);
	}
	catch (Exception $e)
	{
