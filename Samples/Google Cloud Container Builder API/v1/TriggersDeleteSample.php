...
print_r(triggersDeleteExample($service, $projectId, $triggerId));
...
*/
function triggersDeleteExample($service, $projectId, $triggerId)
{
	try
	{
		...
		return $service->triggers->DeleteTriggers($projectId, $triggerId);
	}
	catch (Exception $ex)
	{
