...
print_r(triggersListExample($service, $projectId));
...
* @return ListBuildTriggersResponse</returns>
*/
function triggersListExample($service, $projectId)
{
	try
	{
		...
		return $service->triggers->ListTriggers($projectId);
	}
	catch (Exception $ex)
	{
