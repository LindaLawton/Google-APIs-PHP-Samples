...
$results = triggersListExample($service, $projectId, $optParams);
...
*/
function triggersListExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->triggers->ListTriggers($projectId, $optParams);
	}
	catch (Exception $e)
	{
