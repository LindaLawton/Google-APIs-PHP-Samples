...
// About 
// 
// Unofficial sample for the Cloudbuild v1 API for PHP. 
 ...
 * Initializes an Cloudbuild.v1 service object.
 * @param string API key
 * @return An authorized Cloudbuild.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudbuild Sample");
		...
		// Create authenticated Cloudbuild service
		return new Google_Service_Cloudbuild($client);
	} catch (Exception $e) {
