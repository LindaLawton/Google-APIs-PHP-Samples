...
$results = buildsCancelExample($service, $projectId, $id, $optParams);
...
* @return Build
*/
function buildsCancelExample($service, $projectId, $id, $optParams)
{
	try
	{
		...
		return $service->builds->CancelBuilds($projectId, $id, $optParams);
	}
	catch (Exception $e)
	{
