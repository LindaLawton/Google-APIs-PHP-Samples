...
print_r(testMatricesCreateExample($service, $projectId));
...
*/
function testMatricesCreateExample($service, $projectId)
{
	try
	{
		...
		return $service->testMatrices->CreateTestMatrices($projectId);
	}
	catch (Exception $ex)
	{
