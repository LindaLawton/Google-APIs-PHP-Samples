...
// Single Request.
$results = testMatricesGetExample($service, $projectId, $testMatrixId, $optParams);
...
* @return TestMatrix
*/
function testMatricesGetExample($service, $projectId, $testMatrixId, $optParams)
{
	try
	{
		...
		return $service->testMatrices->GetTestMatrices($projectId, $testMatrixId, $optParams);
	}
	catch (Exception $e)
	{
