...
print_r(testMatricesGetExample($service, $projectId, $testMatrixId));
...
* @return TestMatrix</returns>
*/
function testMatricesGetExample($service, $projectId, $testMatrixId)
{
	try
	{
		...
		return $service->testMatrices->GetTestMatrices($projectId, $testMatrixId);
	}
	catch (Exception $ex)
	{
