 ...
 * Initializes an Testing.v1 service object.
 * @param string API key
 * @return An authorized Testing.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Testing Sample");
		...
		// Create authenticated Testing service
		return new Google_Service_Testing($client);
	} catch (Exception $e) {
