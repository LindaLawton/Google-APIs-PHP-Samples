...
// Single Request.
$results = testMatricesCancelExample($service, $projectId, $testMatrixId, $optParams);
...
*/
function testMatricesCancelExample($service, $projectId, $testMatrixId, $optParams)
{
	try
	{
		...
		return $service->testMatrices->CancelTestMatrices($projectId, $testMatrixId, $optParams);
	}
	catch (Exception $e)
	{
