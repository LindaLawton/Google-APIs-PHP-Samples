...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'projectId' => '[YourValue]',  //For authorization, the cloud project requesting the TestEnvironmentCatalog.Optional
  'fields' => '*'
);
// Single Request.
$results = testEnvironmentCatalogGetExample($service, $environmentType, $optParams);
...
*/
function testEnvironmentCatalogGetExample($service, $environmentType, $optParams)
{
	try
	{
		...
		if (environmentType == null)
			throw new Exception("environmentType is required.");
		// Make the request and return the results.
		return $service->testEnvironmentCatalog->GetTestEnvironmentCatalog($environmentType, $optParams);
	}
	catch (Exception $e)
	{
