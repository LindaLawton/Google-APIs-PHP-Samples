...
print_r(testEnvironmentCatalogGetExample($service, $environmentType));
...
Required
* @return TestEnvironmentCatalog</returns>
*/
function testEnvironmentCatalogGetExample($service, $environmentType)
{
	try
	{
		...
		return $service->testEnvironmentCatalog->GetTestEnvironmentCatalog($environmentType);
	}
	catch (Exception $ex)
	{
