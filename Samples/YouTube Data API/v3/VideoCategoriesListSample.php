...
print_r(videoCategoriesListExample($service, $part));
...
* @return VideoCategoryListResponse</returns>
*/
function videoCategoriesListExample($service, $part)
{
	try
	{
		...
		return $service->videoCategories->ListVideoCategories($part);
	}
	catch (Exception $ex)
	{
