...
// Single Request.
$results = liveStreamsInsertExample($service, $part, $optParams);
...
* @return LiveStream
*/
function liveStreamsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveStreams->InsertLiveStreams($part, $optParams);
	}
	catch (Exception $e)
	{
