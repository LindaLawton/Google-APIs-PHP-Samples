...
print_r(liveStreamsInsertExample($service, $part));
...
* @return LiveStream</returns>
*/
function liveStreamsInsertExample($service, $part)
{
	try
	{
		...
		return $service->liveStreams->InsertLiveStreams($part);
	}
	catch (Exception $ex)
	{
