...
print_r(channelSectionsInsertExample($service, $part));
...
* @return ChannelSection</returns>
*/
function channelSectionsInsertExample($service, $part)
{
	try
	{
		...
		return $service->channelSections->InsertChannelSections($part);
	}
	catch (Exception $ex)
	{
