...
$results = channelSectionsInsertExample($service, $part, $optParams);
...
*/
function channelSectionsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->channelSections->InsertChannelSections($part, $optParams);
	}
	catch (Exception $e)
	{
