...
// Single Request.
$results = activitiesInsertExample($service, $part, $optParams);
...
* @return Activity
*/
function activitiesInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->activities->InsertActivities($part, $optParams);
	}
	catch (Exception $e)
	{
