...
$results = playlistItemsDeleteExample($service, $id, $optParams);
...
*/
function playlistItemsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->playlistItems->DeletePlaylistItems($id, $optParams);
	}
	catch (Exception $e)
	{
