...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'id' => '[YourValue]',  //The id parameter specifies a comma-separated list of IDs that identify the caption resources that should be retrieved. Each ID must identify a caption track associated with the specified video.
            
  //'onBehalfOf' => '[YourValue]',  //ID of the Google+ Page for the channel that the request is on behalf of.
...
// Single Request.
$results = captionsListExample($service, $part, $videoId, $optParams);
...
*/
function captionsListExample($service, $part, $videoId, $optParams)
{
	try
	{
		...
		return $service->captions->ListCaptions($part, $videoId, $optParams);
	}
	catch (Exception $e)
	{
