...
print_r(liveBroadcastsControlExample($service, $id, $part));
...
*/
function liveBroadcastsControlExample($service, $id, $part)
{
	try
	{
		...
		return $service->liveBroadcasts->ControlLiveBroadcasts($id, $part);
	}
	catch (Exception $ex)
	{
