...
// Single Request.
$results = fanFundingEventsListExample($service, $part, $optParams);
...
* @part The part parameter specifies the fanFundingEvent resource parts that the API response will include. Supported values are id and snippet.
* @return FanFundingEventListResponse
*/
function fanFundingEventsListExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->fanFundingEvents->ListFanFundingEvents($part, $optParams);
	}
	catch (Exception $e)
	{
