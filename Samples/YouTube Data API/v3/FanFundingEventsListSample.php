...
print_r(fanFundingEventsListExample($service, $part));
...
* @return FanFundingEventListResponse</returns>
*/
function fanFundingEventsListExample($service, $part)
{
	try
	{
		...
		return $service->fanFundingEvents->ListFanFundingEvents($part);
	}
	catch (Exception $ex)
	{
