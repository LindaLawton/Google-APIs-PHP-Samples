...
print_r(captionsUpdateExample($service, $part));
...
* @return Caption</returns>
*/
function captionsUpdateExample($service, $part)
{
	try
	{
		...
		return $service->captions->UpdateCaptions($part);
	}
	catch (Exception $ex)
	{
