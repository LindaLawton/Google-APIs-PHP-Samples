...
* @return Caption
*/
function captionsUpdateExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->captions->UpdateCaptions($part, $optParams);
	}
	catch (Exception $e)
	{
