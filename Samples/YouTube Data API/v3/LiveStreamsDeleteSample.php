...
$results = liveStreamsDeleteExample($service, $id, $optParams);
...
*/
function liveStreamsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->liveStreams->DeleteLiveStreams($id, $optParams);
	}
	catch (Exception $e)
	{
