...
print_r(sponsorsListExample($service, $part));

/**
* Lists sponsors for a channel.
* @service Authenticated Youtube service.
* @part The part parameter specifies the sponsor resource parts that the API response will include. Supported values are id and snippet.
* @return SponsorListResponse</returns>
*/
function sponsorsListExample($service, $part)
{
	try
	{
		...
		return $service->sponsors->ListSponsors($part);
	}
	catch (Exception $ex)
	{
