...
$results = watermarksUnsetExample($service, $channelId, $optParams);
...
* @channelId The channelId parameter specifies the YouTube channel ID for which the watermark is being unset.

*/
function watermarksUnsetExample($service, $channelId, $optParams)
{
	try
	{
		...
		if (channelId == null)
			throw new Exception("channelId is required.");
		// Make the request and return the results.
		return $service->watermarks->UnsetWatermarks($channelId, $optParams);
	}
	catch (Exception $e)
	{
