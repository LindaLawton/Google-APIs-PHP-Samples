...
print_r(commentsListExample($service, $part));
...
* @return CommentListResponse</returns>
*/
function commentsListExample($service, $part)
{
	try
	{
		...
		return $service->comments->ListComments($part);
	}
	catch (Exception $ex)
	{
