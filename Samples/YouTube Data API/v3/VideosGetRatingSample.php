...
print_r(videosGetRatingExample($service, $id));
...
* @return VideoGetRatingResponse</returns>
*/
function videosGetRatingExample($service, $id)
{
	try
	{
		...
		return $service->videos->GetRatingVideos($id);
	}
	catch (Exception $ex)
	{
