...
// Single Request.
$results = videosGetRatingExample($service, $id, $optParams);
...
*/
function videosGetRatingExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->videos->GetRatingVideos($id, $optParams);
	}
	catch (Exception $e)
	{
