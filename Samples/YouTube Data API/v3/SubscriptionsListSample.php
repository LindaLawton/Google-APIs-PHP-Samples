...
print_r(subscriptionsListExample($service, $part));
...
* @return SubscriptionListResponse</returns>
*/
function subscriptionsListExample($service, $part)
{
	try
	{
		...
		return $service->subscriptions->ListSubscriptions($part);
	}
	catch (Exception $ex)
	{
