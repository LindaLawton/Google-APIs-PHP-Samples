...
print_r(liveChatMessagesListExample($service, $liveChatId, $part));
...
* @return LiveChatMessageListResponse</returns>
*/
function liveChatMessagesListExample($service, $liveChatId, $part)
{
	try
	{
		...
		return $service->liveChatMessages->ListLiveChatMessages($liveChatId, $part);
	}
	catch (Exception $ex)
	{
