...
print_r(channelBannersInsertExample($service));
...
* @return ChannelBannerResource</returns>
*/
function channelBannersInsertExample($service)
{
	try
	{
		...
		return $service->channelBanners->InsertChannelBanners();
	}
	catch (Exception $ex)
	{
