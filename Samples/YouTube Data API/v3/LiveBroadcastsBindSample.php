...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'streamId' => '[YourValue]',  //The streamId parameter specifies the unique ID of the video stream that is being bound to a broadcast. If this parameter is omitted, the API will remove any existing binding between the broadcast and a video stream.
  'fields' => '*'
);
// Single Request.
$results = liveBroadcastsBindExample($service, $id, $part, $optParams);
...
*/
function liveBroadcastsBindExample($service, $id, $part, $optParams)
{
	try
	{
		...
		return $service->liveBroadcasts->BindLiveBroadcasts($id, $part, $optParams);
	}
	catch (Exception $e)
	{
