...
print_r(liveBroadcastsBindExample($service, $id, $part));
...
*/
function liveBroadcastsBindExample($service, $id, $part)
{
	try
	{
		...
		return $service->liveBroadcasts->BindLiveBroadcasts($id, $part);
	}
	catch (Exception $ex)
	{
