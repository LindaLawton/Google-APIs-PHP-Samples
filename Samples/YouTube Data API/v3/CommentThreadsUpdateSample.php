...
print_r(commentThreadsUpdateExample($service, $part));
...
* @return CommentThread</returns>
*/
function commentThreadsUpdateExample($service, $part)
{
	try
	{
		...
		return $service->commentThreads->UpdateCommentThreads($part);
	}
	catch (Exception $ex)
	{
