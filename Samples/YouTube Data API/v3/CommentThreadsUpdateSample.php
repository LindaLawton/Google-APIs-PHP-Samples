...
// Single Request.
$results = commentThreadsUpdateExample($service, $part, $optParams);
...
*/
function commentThreadsUpdateExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->commentThreads->UpdateCommentThreads($part, $optParams);
	}
	catch (Exception $e)
	{
