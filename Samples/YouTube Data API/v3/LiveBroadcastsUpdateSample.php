...
print_r(liveBroadcastsUpdateExample($service, $part));
...
*/
function liveBroadcastsUpdateExample($service, $part)
{
	try
	{
		...
		return $service->liveBroadcasts->UpdateLiveBroadcasts($part);
	}
	catch (Exception $ex)
	{
