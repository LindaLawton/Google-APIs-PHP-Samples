...
// Single Request.
$results = playlistItemsUpdateExample($service, $part, $optParams);
...
* @return PlaylistItem
*/
function playlistItemsUpdateExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->playlistItems->UpdatePlaylistItems($part, $optParams);
	}
	catch (Exception $e)
	{
