...
print_r(liveStreamsListExample($service, $part));
...
* @return LiveStreamListResponse</returns>
*/
function liveStreamsListExample($service, $part)
{
	try
	{
		...
		return $service->liveStreams->ListLiveStreams($part);
	}
	catch (Exception $ex)
	{
