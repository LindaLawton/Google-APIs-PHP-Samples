...
print_r(superChatEventsListExample($service, $part));
...
* @return SuperChatEventListResponse</returns>
*/
function superChatEventsListExample($service, $part)
{
	try
	{
		...
		return $service->superChatEvents->ListSuperChatEvents($part);
	}
	catch (Exception $ex)
	{
