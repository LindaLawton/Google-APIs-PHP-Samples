...
$results = captionsDeleteExample($service, $id, $optParams);
...
*/
function captionsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->captions->DeleteCaptions($id, $optParams);
	}
	catch (Exception $e)
	{
