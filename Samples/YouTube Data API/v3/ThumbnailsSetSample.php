...
print_r(thumbnailsSetExample($service, $videoId));
...
* @return ThumbnailSetResponse</returns>
*/
function thumbnailsSetExample($service, $videoId)
{
	try
	{
		...
		return $service->thumbnails->SetThumbnails($videoId);
	}
	catch (Exception $ex)
	{
