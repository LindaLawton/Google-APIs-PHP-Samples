...
// Single Request.
$results = thumbnailsSetExample($service, $videoId, $optParams);
...
*/
function thumbnailsSetExample($service, $videoId, $optParams)
{
	try
	{
		...
		return $service->thumbnails->SetThumbnails($videoId, $optParams);
	}
	catch (Exception $e)
	{
