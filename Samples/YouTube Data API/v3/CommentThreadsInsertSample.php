...
// Single Request.
$results = commentThreadsInsertExample($service, $part, $optParams);
...
*/
function commentThreadsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->commentThreads->InsertCommentThreads($part, $optParams);
	}
	catch (Exception $e)
	{
