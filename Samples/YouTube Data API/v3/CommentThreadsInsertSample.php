...
print_r(commentThreadsInsertExample($service, $part));
...
*/
function commentThreadsInsertExample($service, $part)
{
	try
	{
		...
		return $service->commentThreads->InsertCommentThreads($part);
	}
	catch (Exception $ex)
	{
