...
$results = commentsDeleteExample($service, $id, $optParams);
...
*/
function commentsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->comments->DeleteComments($id, $optParams);
	}
	catch (Exception $e)
	{
