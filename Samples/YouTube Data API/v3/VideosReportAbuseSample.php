...
$results = videosReportAbuseExample($service, $optParams);
...
*/
function videosReportAbuseExample($service, $optParams)
{
	try
	{
		...
		return $service->videos->ReportAbuseVideos($optParams);
	}
	catch (Exception $e)
	{
