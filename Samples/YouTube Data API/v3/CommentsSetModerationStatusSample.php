...
print_r(commentsSetModerationStatusExample($service, $id, $moderationStatus));
...
*/
function commentsSetModerationStatusExample($service, $id, $moderationStatus)
{
	try
	{
		...
		return $service->comments->SetModerationStatusComments($id, $moderationStatus);
	}
	catch (Exception $ex)
	{
