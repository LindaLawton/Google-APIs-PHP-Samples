...
print_r(setModerationStatus($service, $id, $moderationStatus));
...
*/
function setModerationStatus($service, $id, $moderationStatus)
{
	try
	{
		...
		return $service->setModerationStatus($id, $moderationStatus);
	}
	catch (Exception $ex)
	{
