...
// Single Request.
$results = subscriptionsInsertExample($service, $part, $optParams);
...
* @return Subscription
*/
function subscriptionsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->subscriptions->InsertSubscriptions($part, $optParams);
	}
	catch (Exception $e)
	{
