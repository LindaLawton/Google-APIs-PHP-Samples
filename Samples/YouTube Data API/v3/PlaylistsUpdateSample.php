...
print_r(playlistsUpdateExample($service, $part));
...
* @return Playlist</returns>
*/
function playlistsUpdateExample($service, $part)
{
	try
	{
		...
		return $service->playlists->UpdatePlaylists($part);
	}
	catch (Exception $ex)
	{
