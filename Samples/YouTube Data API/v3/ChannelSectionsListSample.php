...
print_r(channelSectionsListExample($service, $part));
...
* @return ChannelSectionListResponse</returns>
*/
function channelSectionsListExample($service, $part)
{
	try
	{
		...
		return $service->channelSections->ListChannelSections($part);
	}
	catch (Exception $ex)
	{
