...
print_r(playlistItemsListExample($service, $part));
...
* @return PlaylistItemListResponse</returns>
*/
function playlistItemsListExample($service, $part)
{
	try
	{
		...
		return $service->playlistItems->ListPlaylistItems($part);
	}
	catch (Exception $ex)
	{
