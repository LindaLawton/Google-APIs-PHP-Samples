...
// Single Request.
$results = playlistsInsertExample($service, $part, $optParams);
...
* @return Playlist
*/
function playlistsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->playlists->InsertPlaylists($part, $optParams);
	}
	catch (Exception $e)
	{
