...
print_r(playlistItemsInsertExample($service, $part));
...
* @return PlaylistItem</returns>
*/
function playlistItemsInsertExample($service, $part)
{
	try
	{
		...
		return $service->playlistItems->InsertPlaylistItems($part);
	}
	catch (Exception $ex)
	{
