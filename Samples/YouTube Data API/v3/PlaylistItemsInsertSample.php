...
// Single Request.
$results = playlistItemsInsertExample($service, $part, $optParams);
...
* @return PlaylistItem
*/
function playlistItemsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->playlistItems->InsertPlaylistItems($part, $optParams);
	}
	catch (Exception $e)
	{
