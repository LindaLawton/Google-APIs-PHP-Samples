...
print_r(videoAbuseReportReasonsListExample($service, $part));
...
* @return VideoAbuseReportReasonListResponse</returns>
*/
function videoAbuseReportReasonsListExample($service, $part)
{
	try
	{
		...
		return $service->videoAbuseReportReasons->ListVideoAbuseReportReasons($part);
	}
	catch (Exception $ex)
	{
