...
// Single Request.
$results = videoAbuseReportReasonsListExample($service, $part, $optParams);
...
*/
function videoAbuseReportReasonsListExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->videoAbuseReportReasons->ListVideoAbuseReportReasons($part, $optParams);
	}
	catch (Exception $e)
	{
