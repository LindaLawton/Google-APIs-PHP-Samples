...
print_r(liveChatMessagesDeleteExample($service, $id));
...
*/
function liveChatMessagesDeleteExample($service, $id)
{
	try
	{
		...
		return $service->liveChatMessages->DeleteLiveChatMessages($id);
	}
	catch (Exception $ex)
	{
