...
$results = liveChatMessagesDeleteExample($service, $id, $optParams);
...
*/
function liveChatMessagesDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->liveChatMessages->DeleteLiveChatMessages($id, $optParams);
	}
	catch (Exception $e)
	{
