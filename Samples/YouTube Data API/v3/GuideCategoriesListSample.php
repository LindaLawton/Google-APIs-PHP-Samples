...
print_r(guideCategoriesListExample($service, $part));
...
* @return GuideCategoryListResponse</returns>
*/
function guideCategoriesListExample($service, $part)
{
	try
	{
		...
		return $service->guideCategories->ListGuideCategories($part);
	}
	catch (Exception $ex)
	{
