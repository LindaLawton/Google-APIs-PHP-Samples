...
// Single Request.
$results = liveChatMessagesInsertExample($service, $part, $optParams);
...
*/
function liveChatMessagesInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveChatMessages->InsertLiveChatMessages($part, $optParams);
	}
	catch (Exception $e)
	{
