...
print_r(liveChatMessagesInsertExample($service, $part));
...
* @return LiveChatMessage</returns>
*/
function liveChatMessagesInsertExample($service, $part)
{
	try
	{
		...
		return $service->liveChatMessages->InsertLiveChatMessages($part);
	}
	catch (Exception $ex)
	{
