...
print_r(i18nRegionsListExample($service, $part));
...
* @return I18nRegionListResponse</returns>
*/
function i18nRegionsListExample($service, $part)
{
	try
	{
		...
		return $service->i18nRegions->ListI18nRegions($part);
	}
	catch (Exception $ex)
	{
