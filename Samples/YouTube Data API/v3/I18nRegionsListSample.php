...
// Single Request.
$results = i18nRegionsListExample($service, $part, $optParams);
...
*/
function i18nRegionsListExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->i18nRegions->ListI18nRegions($part, $optParams);
	}
	catch (Exception $e)
	{
