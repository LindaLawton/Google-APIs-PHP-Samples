...
$results = commentsInsertExample($service, $part, $optParams);
...
* @return Comment
*/
function commentsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->comments->InsertComments($part, $optParams);
	}
	catch (Exception $e)
	{
