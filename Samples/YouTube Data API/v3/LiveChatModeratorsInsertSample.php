...
// Single Request.
$results = liveChatModeratorsInsertExample($service, $part, $optParams);
...
*/
function liveChatModeratorsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveChatModerators->InsertLiveChatModerators($part, $optParams);
	}
	catch (Exception $e)
	{
