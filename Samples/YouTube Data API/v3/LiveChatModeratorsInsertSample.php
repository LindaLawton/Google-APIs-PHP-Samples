...
print_r(liveChatModeratorsInsertExample($service, $part));
...
* @return LiveChatModerator</returns>
*/
function liveChatModeratorsInsertExample($service, $part)
{
	try
	{
		...
		return $service->liveChatModerators->InsertLiveChatModerators($part);
	}
	catch (Exception $ex)
	{
