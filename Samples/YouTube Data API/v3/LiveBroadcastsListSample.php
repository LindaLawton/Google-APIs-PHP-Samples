...
print_r(liveBroadcastsListExample($service, $part));
...
* @return LiveBroadcastListResponse</returns>
*/
function liveBroadcastsListExample($service, $part)
{
	try
	{
		...
		return $service->liveBroadcasts->ListLiveBroadcasts($part);
	}
	catch (Exception $ex)
	{
