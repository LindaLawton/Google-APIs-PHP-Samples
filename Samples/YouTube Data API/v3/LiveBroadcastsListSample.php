...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'broadcastStatus' => '[YourValue]',  // The broadcastStatus parameter filters the API response to only include broadcasts with the specified status.
            
  //'broadcastType' => '[YourValue]',  // The broadcastType parameter filters the API response to only include broadcasts with the specified type. This is only compatible with the mine filter for now.
            
  //'id' => '[YourValue]',  // The id parameter specifies a comma-separated list of YouTube broadcast IDs that identify the broadcasts being retrieved. In a liveBroadcast resource, the id property specifies the broadcast's ID.
  ...
  //'mine' => '[YourValue]',  // The mine parameter can be used to instruct the API to only return broadcasts owned by the authenticated user. Set the parameter value to true to only retrieve your own broadcasts.
...
// Single Request.
$results = liveBroadcastsListExample($service, $part, $optParams);
...
*/
function liveBroadcastsListExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveBroadcasts->ListLiveBroadcasts($part, $optParams);
	}
	catch (Exception $e)
	{
