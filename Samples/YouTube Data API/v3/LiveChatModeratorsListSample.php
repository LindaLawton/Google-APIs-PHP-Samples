...
// Single Request.
$results = liveChatModeratorsListExample($service, $liveChatId, $part, $optParams);
...
*/
function liveChatModeratorsListExample($service, $liveChatId, $part, $optParams)
{
	try
	{
		...
		return $service->liveChatModerators->ListLiveChatModerators($liveChatId, $part, $optParams);
	}
	catch (Exception $e)
	{
