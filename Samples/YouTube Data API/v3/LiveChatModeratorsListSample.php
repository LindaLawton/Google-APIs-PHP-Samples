...
print_r(liveChatModeratorsListExample($service, $liveChatId, $part));
...
* @return LiveChatModeratorListResponse</returns>
*/
function liveChatModeratorsListExample($service, $liveChatId, $part)
{
	try
	{
		...
		return $service->liveChatModerators->ListLiveChatModerators($liveChatId, $part);
	}
	catch (Exception $ex)
	{
