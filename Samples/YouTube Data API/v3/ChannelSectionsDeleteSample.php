...
$results = channelSectionsDeleteExample($service, $id, $optParams);
...
*/
function channelSectionsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->channelSections->DeleteChannelSections($id, $optParams);
	}
	catch (Exception $e)
	{
