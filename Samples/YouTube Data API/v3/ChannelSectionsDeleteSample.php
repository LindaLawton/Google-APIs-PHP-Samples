...
print_r(channelSectionsDeleteExample($service, $id));
...
*/
function channelSectionsDeleteExample($service, $id)
{
	try
	{
		...
		return $service->channelSections->DeleteChannelSections($id);
	}
	catch (Exception $ex)
	{
