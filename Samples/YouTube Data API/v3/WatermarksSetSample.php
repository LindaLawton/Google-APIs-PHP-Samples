...
$results = watermarksSetExample($service, $channelId, $optParams);
...
* @channelId The channelId parameter specifies the YouTube channel ID for which the watermark is being provided.

*/
function watermarksSetExample($service, $channelId, $optParams)
{
	try
	{
		...
		return $service->watermarks->SetWatermarks($channelId, $optParams);
	}
	catch (Exception $e)
	{
