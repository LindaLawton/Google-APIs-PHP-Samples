...
print_r(activitiesListExample($service, $part));
...
* @return ActivityListResponse</returns>
*/
function activitiesListExample($service, $part)
{
	try
	{
		...
		return $service->activities->ListActivities($part);
	}
	catch (Exception $ex)
	{
