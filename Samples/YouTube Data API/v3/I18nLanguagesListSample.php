...
// Single Request.
$results = i18nLanguagesListExample($service, $part, $optParams);
...
*/
function i18nLanguagesListExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->i18nLanguages->ListI18nLanguages($part, $optParams);
	}
	catch (Exception $e)
	{
