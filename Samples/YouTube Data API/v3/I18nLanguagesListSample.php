...
print_r(i18nLanguagesListExample($service, $part));
...
* @return I18nLanguageListResponse</returns>
*/
function i18nLanguagesListExample($service, $part)
{
	try
	{
		...
		return $service->i18nLanguages->ListI18nLanguages($part);
	}
	catch (Exception $ex)
	{
