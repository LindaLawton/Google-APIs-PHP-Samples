...
$results = commentsMarkAsSpamExample($service, $id, $optParams);
...
*/
function commentsMarkAsSpamExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->comments->MarkAsSpamComments($id, $optParams);
	}
	catch (Exception $e)
	{
