...
# UnOfficial YouTube Data API v3 Samples for PHP
...
These samples show how to access the [YouTube Data API v3](https://developers.google.com/youtube/v3) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
