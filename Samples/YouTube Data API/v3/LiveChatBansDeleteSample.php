...
$results = liveChatBansDeleteExample($service, $id, $optParams);
...
*/
function liveChatBansDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->liveChatBans->DeleteLiveChatBans($id, $optParams);
	}
	catch (Exception $e)
	{
