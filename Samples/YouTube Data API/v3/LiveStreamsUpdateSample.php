...
// Single Request.
$results = liveStreamsUpdateExample($service, $part, $optParams);
...
* @return LiveStream
*/
function liveStreamsUpdateExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveStreams->UpdateLiveStreams($part, $optParams);
	}
	catch (Exception $e)
	{
