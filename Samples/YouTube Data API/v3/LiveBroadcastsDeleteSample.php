...
$results = liveBroadcastsDeleteExample($service, $id, $optParams);
...
*/
function liveBroadcastsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->liveBroadcasts->DeleteLiveBroadcasts($id, $optParams);
	}
	catch (Exception $e)
	{
