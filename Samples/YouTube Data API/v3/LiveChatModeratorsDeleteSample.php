...
$results = liveChatModeratorsDeleteExample($service, $id, $optParams);
...
*/
function liveChatModeratorsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->liveChatModerators->DeleteLiveChatModerators($id, $optParams);
	}
	catch (Exception $e)
	{
