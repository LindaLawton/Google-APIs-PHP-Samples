...
print_r(liveChatModeratorsDeleteExample($service, $id));
...
*/
function liveChatModeratorsDeleteExample($service, $id)
{
	try
	{
		...
		return $service->liveChatModerators->DeleteLiveChatModerators($id);
	}
	catch (Exception $ex)
	{
