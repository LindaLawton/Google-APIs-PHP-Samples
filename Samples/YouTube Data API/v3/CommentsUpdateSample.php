...
$results = commentsUpdateExample($service, $part, $optParams);
...
* @return Comment
*/
function commentsUpdateExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->comments->UpdateComments($part, $optParams);
	}
	catch (Exception $e)
	{
