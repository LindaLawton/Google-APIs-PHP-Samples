...
print_r(channelSectionsUpdateExample($service, $part));
...
*/
function channelSectionsUpdateExample($service, $part)
{
	try
	{
		...
		return $service->channelSections->UpdateChannelSections($part);
	}
	catch (Exception $ex)
	{
