...
$results = channelSectionsUpdateExample($service, $part, $optParams);
...
*/
function channelSectionsUpdateExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->channelSections->UpdateChannelSections($part, $optParams);
	}
	catch (Exception $e)
	{
