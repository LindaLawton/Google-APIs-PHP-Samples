...
print_r(channelsListExample($service, $part));
...
* @return ChannelListResponse</returns>
*/
function channelsListExample($service, $part)
{
	try
	{
		...
		return $service->channels->ListChannels($part);
	}
	catch (Exception $ex)
	{
