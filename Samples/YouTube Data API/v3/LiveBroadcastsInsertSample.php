...
// Single Request.
$results = liveBroadcastsInsertExample($service, $part, $optParams);
...
*/
function liveBroadcastsInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveBroadcasts->InsertLiveBroadcasts($part, $optParams);
	}
	catch (Exception $e)
	{
