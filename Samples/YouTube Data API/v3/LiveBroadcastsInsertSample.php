...
print_r(liveBroadcastsInsertExample($service, $part));
...
*/
function liveBroadcastsInsertExample($service, $part)
{
	try
	{
		...
		return $service->liveBroadcasts->InsertLiveBroadcasts($part);
	}
	catch (Exception $ex)
	{
