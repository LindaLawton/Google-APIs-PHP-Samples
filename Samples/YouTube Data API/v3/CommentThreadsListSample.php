...
print_r(commentThreadsListExample($service, $part));
...
* @return CommentThreadListResponse</returns>
*/
function commentThreadsListExample($service, $part)
{
	try
	{
		...
		return $service->commentThreads->ListCommentThreads($part);
	}
	catch (Exception $ex)
	{
