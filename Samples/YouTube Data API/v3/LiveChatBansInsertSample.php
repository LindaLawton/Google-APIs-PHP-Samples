...
// Single Request.
$results = liveChatBansInsertExample($service, $part, $optParams);
...
* @return LiveChatBan
*/
function liveChatBansInsertExample($service, $part, $optParams)
{
	try
	{
		...
		return $service->liveChatBans->InsertLiveChatBans($part, $optParams);
	}
	catch (Exception $e)
	{
