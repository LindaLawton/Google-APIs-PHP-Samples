...
print_r(liveChatBansInsertExample($service, $part));
...
* @return LiveChatBan</returns>
*/
function liveChatBansInsertExample($service, $part)
{
	try
	{
		...
		return $service->liveChatBans->InsertLiveChatBans($part);
	}
	catch (Exception $ex)
	{
