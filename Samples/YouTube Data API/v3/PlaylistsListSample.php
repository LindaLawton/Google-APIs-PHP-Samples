...
print_r(playlistsListExample($service, $part));
...
* @return PlaylistListResponse</returns>
*/
function playlistsListExample($service, $part)
{
	try
	{
		...
		return $service->playlists->ListPlaylists($part);
	}
	catch (Exception $ex)
	{
