...
// Single Request.
$results = databasesListExample($service, $project, $instance, $optParams);
...
*/
function databasesListExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->databases->ListDatabases($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
