...
print_r(databasesListExample($service, $project, $instance));
...
*/
function databasesListExample($service, $project, $instance)
{
	try
	{
		...
		return $service->databases->ListDatabases($project, $instance);
	}
	catch (Exception $ex)
	{
