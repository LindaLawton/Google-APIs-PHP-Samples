...
print_r(databasesGetExample($service, $project, $instance, $database));
...
* @return Database</returns>
*/
function databasesGetExample($service, $project, $instance, $database)
{
	try
	{
		...
		return $service->databases->GetDatabases($project, $instance, $database);
	}
	catch (Exception $ex)
	{
