...
// Single Request.
$results = databasesGetExample($service, $project, $instance, $database, $optParams);
...
* @return Database
*/
function databasesGetExample($service, $project, $instance, $database, $optParams)
{
	try
	{
		...
		return $service->databases->GetDatabases($project, $instance, $database, $optParams);
	}
	catch (Exception $e)
	{
