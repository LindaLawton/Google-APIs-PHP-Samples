...
print_r(instancesGetExample($service, $project, $instance));
...
* @return DatabaseInstance</returns>
*/
function instancesGetExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->GetInstances($project, $instance);
	}
	catch (Exception $ex)
	{
