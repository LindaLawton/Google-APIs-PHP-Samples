...
// Single Request.
$results = instancesGetExample($service, $project, $instance, $optParams);
...
*/
function instancesGetExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->GetInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
