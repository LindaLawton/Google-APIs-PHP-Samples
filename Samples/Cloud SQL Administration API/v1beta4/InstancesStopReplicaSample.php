...
print_r(instancesStopReplicaExample($service, $project, $instance));
...
*/
function instancesStopReplicaExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->StopReplicaInstances($project, $instance);
	}
	catch (Exception $ex)
	{
