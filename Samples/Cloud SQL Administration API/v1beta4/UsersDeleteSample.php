...
print_r(usersDeleteExample($service, $project, $instance, $host, $name));
...
*/
function usersDeleteExample($service, $project, $instance, $host, $name)
{
	try
	{
		...
		return $service->users->DeleteUsers($project, $instance, $host, $name);
	}
	catch (Exception $ex)
	{
