 ...
 * Initializes an Sqladmin.v1beta4 service object.
 * @param string API key
 * @return An authorized Sqladmin.v1beta4 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Sqladmin Sample");
		...
		// Create authenticated Sqladmin service
		return new Google_Service_Sqladmin($client);
	} catch (Exception $e) {
