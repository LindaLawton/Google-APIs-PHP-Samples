...
// Single Request.
$results = usersListExample($service, $project, $instance, $optParams);
...
*/
function usersListExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->users->ListUsers($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
