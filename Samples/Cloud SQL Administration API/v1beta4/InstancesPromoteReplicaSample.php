...
print_r(instancesPromoteReplicaExample($service, $project, $instance));
...
*/
function instancesPromoteReplicaExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->PromoteReplicaInstances($project, $instance);
	}
	catch (Exception $ex)
	{
