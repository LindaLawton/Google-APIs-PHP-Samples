...
$results = instancesPromoteReplicaExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesPromoteReplicaExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->PromoteReplicaInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
