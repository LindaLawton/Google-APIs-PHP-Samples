...
// Single Request.
$results = backupRunsListExample($service, $project, $instance, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $instance, $optParams);	
...
*/
function backupRunsListExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->backupRuns->ListBackupRuns($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
