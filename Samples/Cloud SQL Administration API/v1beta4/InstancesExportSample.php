...
print_r(instancesExportExample($service, $project, $instance));
...
*/
function instancesExportExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->ExportInstances($project, $instance);
	}
	catch (Exception $ex)
	{
