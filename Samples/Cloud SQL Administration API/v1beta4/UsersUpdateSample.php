...
print_r(usersUpdateExample($service, $project, $instance, $host, $name));
...
*/
function usersUpdateExample($service, $project, $instance, $host, $name)
{
	try
	{
		...
		return $service->users->UpdateUsers($project, $instance, $host, $name);
	}
	catch (Exception $ex)
	{
