...
// Single Request.
$results = usersUpdateExample($service, $project, $instance, $host, $name, $optParams);
...
* @return Operation
*/
function usersUpdateExample($service, $project, $instance, $host, $name, $optParams)
{
	try
	{
		...
		return $service->users->UpdateUsers($project, $instance, $host, $name, $optParams);
	}
	catch (Exception $e)
	{
