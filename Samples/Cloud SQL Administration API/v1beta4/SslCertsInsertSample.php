...
// Single Request.
$results = sslCertsInsertExample($service, $project, $instance, $optParams);
...
*/
function sslCertsInsertExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->sslCerts->InsertSslCerts($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
