...
print_r(sslCertsInsertExample($service, $project, $instance));
...
* @return SslCertsInsertResponse</returns>
*/
function sslCertsInsertExample($service, $project, $instance)
{
	try
	{
		...
		return $service->sslCerts->InsertSslCerts($project, $instance);
	}
	catch (Exception $ex)
	{
