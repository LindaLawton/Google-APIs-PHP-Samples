...
// Single Request.
$results = instancesUpdateExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesUpdateExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->UpdateInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
