...
print_r(instancesUpdateExample($service, $project, $instance));
...
*/
function instancesUpdateExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->UpdateInstances($project, $instance);
	}
	catch (Exception $ex)
	{
