...
// Single Request.
$results = instancesResetSslConfigExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesResetSslConfigExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->ResetSslConfigInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
