...
print_r(instancesResetSslConfigExample($service, $project, $instance));
...
*/
function instancesResetSslConfigExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->ResetSslConfigInstances($project, $instance);
	}
	catch (Exception $ex)
	{
