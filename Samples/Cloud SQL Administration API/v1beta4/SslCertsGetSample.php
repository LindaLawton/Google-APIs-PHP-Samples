...
print_r(get($service, $project, $instance, $sha1Fingerprint));
...
*/
function get($service, $project, $instance, $sha1Fingerprint)
{
	try
	{
		...
		return $service->get($project, $instance, $sha1Fingerprint);
	}
	catch (Exception $ex)
	{
