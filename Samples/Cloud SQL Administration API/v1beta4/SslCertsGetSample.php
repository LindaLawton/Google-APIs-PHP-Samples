...
print_r(sslCertsGetExample($service, $project, $instance, $sha1Fingerprint));
...
* @return SslCert</returns>
*/
function sslCertsGetExample($service, $project, $instance, $sha1Fingerprint)
{
	try
	{
		...
		return $service->sslCerts->GetSslCerts($project, $instance, $sha1Fingerprint);
	}
	catch (Exception $ex)
	{
