...
// Single Request.
$results = sslCertsGetExample($service, $project, $instance, $sha1Fingerprint, $optParams);
...
* @return SslCert
*/
function sslCertsGetExample($service, $project, $instance, $sha1Fingerprint, $optParams)
{
	try
	{
		...
		return $service->sslCerts->GetSslCerts($project, $instance, $sha1Fingerprint, $optParams);
	}
	catch (Exception $e)
	{
