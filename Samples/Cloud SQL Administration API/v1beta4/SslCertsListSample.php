...
print_r(sslCertsListExample($service, $project, $instance));
...
* @return SslCertsListResponse</returns>
*/
function sslCertsListExample($service, $project, $instance)
{
	try
	{
		...
		return $service->sslCerts->ListSslCerts($project, $instance);
	}
	catch (Exception $ex)
	{
