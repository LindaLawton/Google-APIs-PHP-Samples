...
// Single Request.
$results = sslCertsListExample($service, $project, $instance, $optParams);
...
*/
function sslCertsListExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->sslCerts->ListSslCerts($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
