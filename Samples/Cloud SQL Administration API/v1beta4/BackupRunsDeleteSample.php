...
print_r(backupRunsDeleteExample($service, $project, $instance, $id));
...
*/
function backupRunsDeleteExample($service, $project, $instance, $id)
{
	try
	{
		...
		return $service->backupRuns->DeleteBackupRuns($project, $instance, $id);
	}
	catch (Exception $ex)
	{
