...
// Single Request.
$results = backupRunsDeleteExample($service, $project, $instance, $id, $optParams);
...
* @return Operation
*/
function backupRunsDeleteExample($service, $project, $instance, $id, $optParams)
{
	try
	{
		...
		return $service->backupRuns->DeleteBackupRuns($project, $instance, $id, $optParams);
	}
	catch (Exception $e)
	{
