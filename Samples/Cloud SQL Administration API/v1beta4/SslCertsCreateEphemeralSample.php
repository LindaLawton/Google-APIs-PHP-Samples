...
// Single Request.
$results = sslCertsCreateEphemeralExample($service, $project, $instance, $optParams);
...
* @return SslCert
*/
function sslCertsCreateEphemeralExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->sslCerts->CreateEphemeralSslCerts($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
