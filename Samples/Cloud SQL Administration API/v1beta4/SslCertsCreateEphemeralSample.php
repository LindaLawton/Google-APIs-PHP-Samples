...
print_r(sslCertsCreateEphemeralExample($service, $project, $instance));
...
*/
function sslCertsCreateEphemeralExample($service, $project, $instance)
{
	try
	{
		...
		return $service->sslCerts->CreateEphemeralSslCerts($project, $instance);
	}
	catch (Exception $ex)
	{
