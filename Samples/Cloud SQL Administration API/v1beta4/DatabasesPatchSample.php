...
print_r(databasesPatchExample($service, $project, $instance, $database));
...
*/
function databasesPatchExample($service, $project, $instance, $database)
{
	try
	{
		...
		return $service->databases->PatchDatabases($project, $instance, $database);
	}
	catch (Exception $ex)
	{
