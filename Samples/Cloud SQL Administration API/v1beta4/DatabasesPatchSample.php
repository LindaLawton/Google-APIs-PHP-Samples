...
$results = databasesPatchExample($service, $project, $instance, $database, $optParams);
...
* @return Operation
*/
function databasesPatchExample($service, $project, $instance, $database, $optParams)
{
	try
	{
		...
		return $service->databases->PatchDatabases($project, $instance, $database, $optParams);
	}
	catch (Exception $e)
	{
