...
// Single Request.
$results = instancesStartReplicaExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesStartReplicaExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->StartReplicaInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
