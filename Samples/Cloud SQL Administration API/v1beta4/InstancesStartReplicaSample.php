...
print_r(instancesStartReplicaExample($service, $project, $instance));
...
*/
function instancesStartReplicaExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->StartReplicaInstances($project, $instance);
	}
	catch (Exception $ex)
	{
