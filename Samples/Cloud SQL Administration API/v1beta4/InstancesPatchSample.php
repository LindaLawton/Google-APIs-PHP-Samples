...
// Single Request.
$results = instancesPatchExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesPatchExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->PatchInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
