...
print_r(instancesPatchExample($service, $project, $instance));
...
*/
function instancesPatchExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->PatchInstances($project, $instance);
	}
	catch (Exception $ex)
	{
