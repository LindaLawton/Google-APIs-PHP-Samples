...
print_r(instancesFailoverExample($service, $project, $instance));
...
*/
function instancesFailoverExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->FailoverInstances($project, $instance);
	}
	catch (Exception $ex)
	{
