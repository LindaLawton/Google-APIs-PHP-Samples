...
$results = instancesFailoverExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesFailoverExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->FailoverInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
