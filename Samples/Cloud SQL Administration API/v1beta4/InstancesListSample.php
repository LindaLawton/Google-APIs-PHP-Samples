...
print_r(instancesListExample($service, $project));
...
* @return InstancesListResponse</returns>
*/
function instancesListExample($service, $project)
{
	try
	{
		...
		return $service->instances->ListInstances($project);
	}
	catch (Exception $ex)
	{
