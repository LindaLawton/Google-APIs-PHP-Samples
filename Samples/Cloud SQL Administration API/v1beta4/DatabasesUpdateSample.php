...
// Single Request.
$results = databasesUpdateExample($service, $project, $instance, $database, $optParams);
...
* @return Operation
*/
function databasesUpdateExample($service, $project, $instance, $database, $optParams)
{
	try
	{
		...
		return $service->databases->UpdateDatabases($project, $instance, $database, $optParams);
	}
	catch (Exception $e)
	{
