...
print_r(databasesUpdateExample($service, $project, $instance, $database));
...
*/
function databasesUpdateExample($service, $project, $instance, $database)
{
	try
	{
		...
		return $service->databases->UpdateDatabases($project, $instance, $database);
	}
	catch (Exception $ex)
	{
