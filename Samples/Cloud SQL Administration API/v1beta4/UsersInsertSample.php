...
$results = usersInsertExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function usersInsertExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->users->InsertUsers($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
