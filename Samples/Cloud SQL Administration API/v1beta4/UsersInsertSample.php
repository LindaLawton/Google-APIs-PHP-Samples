...
print_r(usersInsertExample($service, $project, $instance));
...
*/
function usersInsertExample($service, $project, $instance)
{
	try
	{
		...
		return $service->users->InsertUsers($project, $instance);
	}
	catch (Exception $ex)
	{
