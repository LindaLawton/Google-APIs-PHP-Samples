...
print_r(instancesImportExample($service, $project, $instance));
...
*/
function instancesImportExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->ImportInstances($project, $instance);
	}
	catch (Exception $ex)
	{
