...
$results = instancesImportExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesImportExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->ImportInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
