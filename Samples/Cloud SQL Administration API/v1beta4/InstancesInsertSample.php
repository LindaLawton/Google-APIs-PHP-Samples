...
// Single Request.
$results = instancesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function instancesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instances->InsertInstances($project, $optParams);
	}
	catch (Exception $e)
	{
