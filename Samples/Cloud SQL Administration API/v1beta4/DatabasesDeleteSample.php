...
print_r(databasesDeleteExample($service, $project, $instance, $database));
...
*/
function databasesDeleteExample($service, $project, $instance, $database)
{
	try
	{
		...
		return $service->databases->DeleteDatabases($project, $instance, $database);
	}
	catch (Exception $ex)
	{
