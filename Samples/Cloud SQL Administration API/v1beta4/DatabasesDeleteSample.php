...
// Single Request.
$results = databasesDeleteExample($service, $project, $instance, $database, $optParams);
...
* @return Operation
*/
function databasesDeleteExample($service, $project, $instance, $database, $optParams)
{
	try
	{
		...
		return $service->databases->DeleteDatabases($project, $instance, $database, $optParams);
	}
	catch (Exception $e)
	{
