...
print_r(instancesCloneExample($service, $project, $instance));
...
*/
function instancesCloneExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->CloneInstances($project, $instance);
	}
	catch (Exception $ex)
	{
