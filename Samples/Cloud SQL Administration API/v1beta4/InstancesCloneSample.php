...
$results = instancesCloneExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesCloneExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->CloneInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
