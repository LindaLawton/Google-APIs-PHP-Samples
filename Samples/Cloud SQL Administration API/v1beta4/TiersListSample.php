...
print_r(tiersListExample($service, $project));
...
* @return TiersListResponse</returns>
*/
function tiersListExample($service, $project)
{
	try
	{
		...
		return $service->tiers->ListTiers($project);
	}
	catch (Exception $ex)
	{
