...
$results = instancesDeleteExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesDeleteExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->DeleteInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
