...
print_r(instancesDeleteExample($service, $project, $instance));
...
*/
function instancesDeleteExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->DeleteInstances($project, $instance);
	}
	catch (Exception $ex)
	{
