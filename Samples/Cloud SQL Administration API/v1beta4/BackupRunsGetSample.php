...
print_r(backupRunsGetExample($service, $project, $instance, $id));
...
*/
function backupRunsGetExample($service, $project, $instance, $id)
{
	try
	{
		...
		return $service->backupRuns->GetBackupRuns($project, $instance, $id);
	}
	catch (Exception $ex)
	{
