...
$results = backupRunsGetExample($service, $project, $instance, $id, $optParams);
...
* @return BackupRun
*/
function backupRunsGetExample($service, $project, $instance, $id, $optParams)
{
	try
	{
		...
		return $service->backupRuns->GetBackupRuns($project, $instance, $id, $optParams);
	}
	catch (Exception $e)
	{
