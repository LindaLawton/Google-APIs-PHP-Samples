...
print_r(instancesRestartExample($service, $project, $instance));
...
*/
function instancesRestartExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->RestartInstances($project, $instance);
	}
	catch (Exception $ex)
	{
