...
// Single Request.
$results = instancesRestartExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesRestartExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->RestartInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
