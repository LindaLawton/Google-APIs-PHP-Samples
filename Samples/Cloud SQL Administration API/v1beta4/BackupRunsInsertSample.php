...
print_r(backupRunsInsertExample($service, $project, $instance));
...
*/
function backupRunsInsertExample($service, $project, $instance)
{
	try
	{
		...
		return $service->backupRuns->InsertBackupRuns($project, $instance);
	}
	catch (Exception $ex)
	{
