...
$results = databasesInsertExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function databasesInsertExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->databases->InsertDatabases($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
