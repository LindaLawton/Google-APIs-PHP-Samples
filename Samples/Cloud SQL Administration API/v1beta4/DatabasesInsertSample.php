...
print_r(databasesInsertExample($service, $project, $instance));
...
*/
function databasesInsertExample($service, $project, $instance)
{
	try
	{
		...
		return $service->databases->InsertDatabases($project, $instance);
	}
	catch (Exception $ex)
	{
