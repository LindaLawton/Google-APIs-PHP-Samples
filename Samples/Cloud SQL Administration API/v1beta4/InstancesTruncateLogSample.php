...
$results = instancesTruncateLogExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesTruncateLogExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->TruncateLogInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
