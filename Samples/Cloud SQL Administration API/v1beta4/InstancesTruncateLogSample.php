...
print_r(instancesTruncateLogExample($service, $project, $instance));
...
*/
function instancesTruncateLogExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->TruncateLogInstances($project, $instance);
	}
	catch (Exception $ex)
	{
