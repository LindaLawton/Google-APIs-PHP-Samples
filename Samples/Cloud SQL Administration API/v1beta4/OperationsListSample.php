...
print_r(operationsListExample($service, $project, $instance));
...
*/
function operationsListExample($service, $project, $instance)
{
	try
	{
		...
		return $service->operations->ListOperations($project, $instance);
	}
	catch (Exception $ex)
	{
