...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  //Maximum number of operations per response.
            
  //'pageToken' => '[YourValue]',  //A previously-returned page token representing part of the larger set of results to view.
  'fields' => '*'
);
// Single Request.
$results = operationsListExample($service, $project, $instance, $optParams);
...
*/
function operationsListExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->operations->ListOperations($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
