...
$results = sslCertsDeleteExample($service, $project, $instance, $sha1Fingerprint, $optParams);
...
* @return Operation
*/
function sslCertsDeleteExample($service, $project, $instance, $sha1Fingerprint, $optParams)
{
	try
	{
		...
		if (sha1Fingerprint == null)
			throw new Exception("sha1Fingerprint is required.");
		// Make the request and return the results.
		return $service->sslCerts->DeleteSslCerts($project, $instance, $sha1Fingerprint, $optParams);
	}
	catch (Exception $e)
	{
