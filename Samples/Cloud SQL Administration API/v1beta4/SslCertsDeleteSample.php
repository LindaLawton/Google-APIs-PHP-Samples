...
print_r(delete($service, $project, $instance, $sha1Fingerprint));
...
*/
function delete($service, $project, $instance, $sha1Fingerprint)
{
	try
	{
		...
		return $service->delete($project, $instance, $sha1Fingerprint);
	}
	catch (Exception $ex)
	{
