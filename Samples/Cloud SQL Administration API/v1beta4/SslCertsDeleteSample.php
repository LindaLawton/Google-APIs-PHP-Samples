...
print_r(sslCertsDeleteExample($service, $project, $instance, $sha1Fingerprint));
...
*/
function sslCertsDeleteExample($service, $project, $instance, $sha1Fingerprint)
{
	try
	{
		...
		return $service->sslCerts->DeleteSslCerts($project, $instance, $sha1Fingerprint);
	}
	catch (Exception $ex)
	{
