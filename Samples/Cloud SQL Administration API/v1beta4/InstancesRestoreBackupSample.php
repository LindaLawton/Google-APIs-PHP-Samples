...
$results = instancesRestoreBackupExample($service, $project, $instance, $optParams);
...
* @return Operation
*/
function instancesRestoreBackupExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->RestoreBackupInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
