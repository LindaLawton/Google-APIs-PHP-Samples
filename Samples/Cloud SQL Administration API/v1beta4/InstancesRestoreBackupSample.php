...
print_r(instancesRestoreBackupExample($service, $project, $instance));
...
*/
function instancesRestoreBackupExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->RestoreBackupInstances($project, $instance);
	}
	catch (Exception $ex)
	{
