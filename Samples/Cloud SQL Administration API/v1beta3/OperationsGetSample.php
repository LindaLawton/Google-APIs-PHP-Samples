...
print_r(operationsGetExample($service, $project, $instance, $operation));
...
* @return InstanceOperation</returns>
*/
function operationsGetExample($service, $project, $instance, $operation)
{
	try
	{
		...
		return $service->operations->GetOperations($project, $instance, $operation);
	}
	catch (Exception $ex)
	{
