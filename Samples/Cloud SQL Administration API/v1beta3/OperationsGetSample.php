...
// Single Request.
$results = operationsGetExample($service, $project, $instance, $operation, $optParams);
...
*/
function operationsGetExample($service, $project, $instance, $operation, $optParams)
{
	try
	{
		...
		return $service->operations->GetOperations($project, $instance, $operation, $optParams);
	}
	catch (Exception $e)
	{
