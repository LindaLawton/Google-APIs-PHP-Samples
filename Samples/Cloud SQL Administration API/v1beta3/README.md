...
# UnOfficial Cloud SQL Administration API v1beta3 Samples for PHP
...
These samples show how to access the [Cloud SQL Administration API v1beta3](https://cloud.google.com/sql/docs/reference/latest) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
