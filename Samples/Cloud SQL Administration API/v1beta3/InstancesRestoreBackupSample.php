...
print_r(instancesRestoreBackupExample($service, $project, $instance, $backupConfiguration, $dueTime));
...
* @return InstancesRestoreBackupResponse</returns>
*/
function instancesRestoreBackupExample($service, $project, $instance, $backupConfiguration, $dueTime)
{
	try
	{
		...
		return $service->instances->RestoreBackupInstances($project, $instance, $backupConfiguration, $dueTime);
	}
	catch (Exception $ex)
	{
