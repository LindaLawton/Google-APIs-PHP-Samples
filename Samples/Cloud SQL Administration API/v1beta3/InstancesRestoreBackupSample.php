...
print_r(restoreBackup($service, $project, $instance, $backupConfiguration, $dueTime));
...
*/
function restoreBackup($service, $project, $instance, $backupConfiguration, $dueTime)
{
	try
	{
		...
		return $service->restoreBackup($project, $instance, $backupConfiguration, $dueTime);
	}
	catch (Exception $ex)
	{
