...
print_r(backupRunsGetExample($service, $project, $instance, $backupConfiguration, $dueTime));
...
* @return BackupRun</returns>
*/
function backupRunsGetExample($service, $project, $instance, $backupConfiguration, $dueTime)
{
	try
	{
		...
		return $service->backupRuns->GetBackupRuns($project, $instance, $backupConfiguration, $dueTime);
	}
	catch (Exception $ex)
	{
