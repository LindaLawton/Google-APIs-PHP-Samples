...
print_r(get($service, $project, $instance, $backupConfiguration, $dueTime));
...
*/
function get($service, $project, $instance, $backupConfiguration, $dueTime)
{
	try
	{
		...
		return $service->get($project, $instance, $backupConfiguration, $dueTime);
	}
	catch (Exception $ex)
	{
