...
// Single Request.
$results = backupRunsGetExample($service, $project, $instance, $backupConfiguration, $dueTime, $optParams);
...
* @return BackupRun
*/
function backupRunsGetExample($service, $project, $instance, $backupConfiguration, $dueTime, $optParams)
{
	try
	{
		...
		return $service->backupRuns->GetBackupRuns($project, $instance, $backupConfiguration, $dueTime, $optParams);
	}
	catch (Exception $e)
	{
