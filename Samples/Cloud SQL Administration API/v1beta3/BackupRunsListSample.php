...
print_r(list($service, $project, $instance, $backupConfiguration));
...
*/
function list($service, $project, $instance, $backupConfiguration)
{
	try
	{
		...
		return $service->list($project, $instance, $backupConfiguration);
	}
	catch (Exception $ex)
	{
