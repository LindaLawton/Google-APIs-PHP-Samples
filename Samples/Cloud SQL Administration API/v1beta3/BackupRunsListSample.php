...
print_r(backupRunsListExample($service, $project, $instance, $backupConfiguration));
...
* @return BackupRunsListResponse</returns>
*/
function backupRunsListExample($service, $project, $instance, $backupConfiguration)
{
	try
	{
		...
		return $service->backupRuns->ListBackupRuns($project, $instance, $backupConfiguration);
	}
	catch (Exception $ex)
	{
