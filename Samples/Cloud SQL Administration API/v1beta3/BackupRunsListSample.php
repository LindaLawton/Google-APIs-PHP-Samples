...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // Maximum number of backup runs per response.
            
  //'pageToken' => '[YourValue]',  // A previously-returned page token representing part of the larger set of results to view.
  'fields' => '*'
);
// Single Request.
$results = backupRunsListExample($service, $project, $instance, $backupConfiguration, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $instance, $backupConfiguration, $optParams);	
...
*/
function backupRunsListExample($service, $project, $instance, $backupConfiguration, $optParams)
{
	try
	{
		...
		return $service->backupRuns->ListBackupRuns($project, $instance, $backupConfiguration, $optParams);
	}
	catch (Exception $e)
	{
