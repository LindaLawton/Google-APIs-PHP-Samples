...
print_r(instancesSetRootPasswordExample($service, $project, $instance));
...
* @return InstancesSetRootPasswordResponse</returns>
*/
function instancesSetRootPasswordExample($service, $project, $instance)
{
	try
	{
		...
		return $service->instances->SetRootPasswordInstances($project, $instance);
	}
	catch (Exception $ex)
	{
