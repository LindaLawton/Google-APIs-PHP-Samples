...
// Single Request.
$results = instancesSetRootPasswordExample($service, $project, $instance, $optParams);
...
* @return InstancesSetRootPasswordResponse
*/
function instancesSetRootPasswordExample($service, $project, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetRootPasswordInstances($project, $instance, $optParams);
	}
	catch (Exception $e)
	{
