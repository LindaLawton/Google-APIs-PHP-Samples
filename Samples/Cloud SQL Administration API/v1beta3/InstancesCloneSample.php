...
print_r(instancesCloneExample($service, $project));
...
* @return InstancesCloneResponse</returns>
*/
function instancesCloneExample($service, $project)
{
	try
	{
		...
		return $service->instances->CloneInstances($project);
	}
	catch (Exception $ex)
	{
