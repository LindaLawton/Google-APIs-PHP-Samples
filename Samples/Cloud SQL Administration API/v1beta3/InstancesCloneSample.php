...
// Single Request.
$results = instancesCloneExample($service, $project, $optParams);
...
* @return InstancesCloneResponse
*/
function instancesCloneExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instances->CloneInstances($project, $optParams);
	}
	catch (Exception $e)
	{
