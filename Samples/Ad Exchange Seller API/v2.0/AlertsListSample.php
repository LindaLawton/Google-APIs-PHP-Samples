...
print_r(alertsListExample($service, $accountId));

/**
* List the alerts for this Ad Exchange account.
* @service Authenticated Adexchangeseller service.
* @accountId Account owning the alerts.
* @return Alerts</returns>
*/
function alertsListExample($service, $accountId)
{
	try
	{
		...
		return $service->alerts->ListAlerts($accountId);
	}
	catch (Exception $ex)
	{
