...
$results = alertsListExample($service, $accountId, $optParams);
...
* @return Alerts
*/
function alertsListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->alerts->ListAlerts($accountId, $optParams);
	}
	catch (Exception $e)
	{
