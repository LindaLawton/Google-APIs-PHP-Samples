...
$results = preferreddealsListExample($service, $accountId, $optParams);
...
*/
function preferreddealsListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->preferreddeals->ListPreferreddeals($accountId, $optParams);
	}
	catch (Exception $e)
	{
