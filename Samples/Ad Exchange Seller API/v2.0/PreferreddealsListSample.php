...
print_r(preferreddealsListExample($service, $accountId));

/**
* List the preferred deals for this Ad Exchange account.
* @service Authenticated Adexchangeseller service.
* @accountId Account owning the deals.
* @return PreferredDeals</returns>
*/
function preferreddealsListExample($service, $accountId)
{
	try
	{
		...
		return $service->preferreddeals->ListPreferreddeals($accountId);
	}
	catch (Exception $ex)
	{
