...
$results = customchannelsGetExample($service, $accountId, $adClientId, $customChannelId, $optParams);
...
*/
function customchannelsGetExample($service, $accountId, $adClientId, $customChannelId, $optParams)
{
	try
	{
		...
		if (customChannelId == null)
			throw new Exception("customChannelId is required.");
		// Make the request and return the results.
		return $service->customchannels->GetCustomchannels($accountId, $adClientId, $customChannelId, $optParams);
	}
	catch (Exception $e)
	{
