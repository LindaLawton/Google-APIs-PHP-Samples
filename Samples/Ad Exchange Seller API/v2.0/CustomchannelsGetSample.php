...
print_r(get($service, $accountId, $adClientId, $customChannelId));
...
*/
function get($service, $accountId, $adClientId, $customChannelId)
{
	try
	{
		...
		return $service->get($accountId, $adClientId, $customChannelId);
	}
	catch (Exception $ex)
	{
