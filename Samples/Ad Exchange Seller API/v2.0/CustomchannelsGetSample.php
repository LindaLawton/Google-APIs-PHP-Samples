...
print_r(customchannelsGetExample($service, $accountId, $adClientId, $customChannelId));
...
* @return CustomChannel</returns>
*/
function customchannelsGetExample($service, $accountId, $adClientId, $customChannelId)
{
	try
	{
		...
		return $service->customchannels->GetCustomchannels($accountId, $adClientId, $customChannelId);
	}
	catch (Exception $ex)
	{
