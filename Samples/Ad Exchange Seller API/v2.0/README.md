...
# UnOfficial Ad Exchange Seller API v2.0 Samples for PHP
...
These samples show how to access the [Ad Exchange Seller API v2.0](https://developers.google.com/ad-exchange/seller-rest/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
