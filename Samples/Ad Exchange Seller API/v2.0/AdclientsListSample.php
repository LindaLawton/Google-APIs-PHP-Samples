...
print_r(adclientsListExample($service, $accountId));

/**
* List all ad clients in this Ad Exchange account.
* @service Authenticated Adexchangeseller service.
* @accountId Account to which the ad client belongs.
* @return AdClients</returns>
*/
function adclientsListExample($service, $accountId)
{
	try
	{
		...
		return $service->adclients->ListAdclients($accountId);
	}
	catch (Exception $ex)
	{
