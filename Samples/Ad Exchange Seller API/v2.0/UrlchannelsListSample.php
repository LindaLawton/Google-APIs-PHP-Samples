...
print_r(urlchannelsListExample($service, $accountId, $adClientId));
...
* @return UrlChannels</returns>
*/
function urlchannelsListExample($service, $accountId, $adClientId)
{
	try
	{
		...
		return $service->urlchannels->ListUrlchannels($accountId, $adClientId);
	}
	catch (Exception $ex)
	{
