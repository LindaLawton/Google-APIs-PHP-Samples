...
print_r(savedGenerateExample($service, $accountId, $savedReportId));
...
*/
function savedGenerateExample($service, $accountId, $savedReportId)
{
	try
	{
		...
		return $service->saved->GenerateSaved($accountId, $savedReportId);
	}
	catch (Exception $ex)
	{
