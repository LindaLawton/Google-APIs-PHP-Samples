...
// Single Request.
$results = savedGenerateExample($service, $accountId, $savedReportId, $optParams);
...
* @return Report
*/
function savedGenerateExample($service, $accountId, $savedReportId, $optParams)
{
	try
	{
		...
		if (savedReportId == null)
			throw new Exception("savedReportId is required.");
		// Make the request and return the results.
		return $service->saved->GenerateSaved($accountId, $savedReportId, $optParams);
	}
	catch (Exception $e)
	{
