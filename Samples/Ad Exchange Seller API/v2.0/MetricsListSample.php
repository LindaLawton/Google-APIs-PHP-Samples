...
// Single Request.
$results = metricsListExample($service, $accountId, $optParams);
...
* @return Metadata
*/
function metricsListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->metrics->ListMetrics($accountId, $optParams);
	}
	catch (Exception $e)
	{
