...
// Single Request.
$results = customchannelsListExample($service, $accountId, $adClientId, $optParams);
...
do {
	...
	$results = filesListExample($service, $accountId, $adClientId, $optParams);	
...
*/
function customchannelsListExample($service, $accountId, $adClientId, $optParams)
{
	try
	{
		...
		return $service->customchannels->ListCustomchannels($accountId, $adClientId, $optParams);
	}
	catch (Exception $e)
	{
