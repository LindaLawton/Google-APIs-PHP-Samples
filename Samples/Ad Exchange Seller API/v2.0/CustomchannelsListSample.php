...
print_r(customchannelsListExample($service, $accountId, $adClientId));
...
*/
function customchannelsListExample($service, $accountId, $adClientId)
{
	try
	{
		...
		return $service->customchannels->ListCustomchannels($accountId, $adClientId);
	}
	catch (Exception $ex)
	{
