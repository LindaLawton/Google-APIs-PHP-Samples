...
print_r(savedListExample($service, $accountId));

/**
* List all saved reports in this Ad Exchange account.
* @service Authenticated Adexchangeseller service.
* @accountId Account owning the saved reports.
* @return SavedReports</returns>
*/
function savedListExample($service, $accountId)
{
	try
	{
		...
		return $service->saved->ListSaved($accountId);
	}
	catch (Exception $ex)
	{
