...
// Single Request.
$results = dimensionsListExample($service, $accountId, $optParams);
...
* @return Metadata
*/
function dimensionsListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->dimensions->ListDimensions($accountId, $optParams);
	}
	catch (Exception $e)
	{
