...
print_r(preferreddealsGetExample($service, $accountId, $dealId));
...
* @return PreferredDeal</returns>
*/
function preferreddealsGetExample($service, $accountId, $dealId)
{
	try
	{
		...
		return $service->preferreddeals->GetPreferreddeals($accountId, $dealId);
	}
	catch (Exception $ex)
	{
