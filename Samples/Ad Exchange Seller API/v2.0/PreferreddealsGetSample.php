...
// Single Request.
$results = preferreddealsGetExample($service, $accountId, $dealId, $optParams);
...
*/
function preferreddealsGetExample($service, $accountId, $dealId, $optParams)
{
	try
	{
		...
		return $service->preferreddeals->GetPreferreddeals($accountId, $dealId, $optParams);
	}
	catch (Exception $e)
	{
