...
//     Build date: 09/20/2017 15:55:49
 ...
 * Initializes an Adexchangeseller.v1.1 service object.
 * @param string API key
 * @return An authorized Adexchangeseller.v1.1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Adexchangeseller Sample");
		...
		// Create authenticated Adexchangeseller service
		return new Google_Service_Adexchangeseller($client);
	} catch (Exception $e) {
