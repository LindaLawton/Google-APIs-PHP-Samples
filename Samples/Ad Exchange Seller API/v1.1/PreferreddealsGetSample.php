...
// Single Request.
$results = preferreddealsGetExample($service, $dealId, $optParams);
...
*/
function preferreddealsGetExample($service, $dealId, $optParams)
{
	try
	{
		...
		return $service->preferreddeals->GetPreferreddeals($dealId, $optParams);
	}
	catch (Exception $e)
	{
