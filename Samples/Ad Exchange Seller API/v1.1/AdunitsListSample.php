...
do {
	...
	$results = filesListExample($service, $adClientId, $customChannelId, $optParams);	
...
* @return AdUnits
*/
function adunitsListExample($service, $adClientId, $customChannelId, $optParams)
{
	try
	{
		...
		return $service->adunits->ListAdunits($adClientId, $customChannelId, $optParams);
	}
	catch (Exception $e)
	{
