...
print_r(adunitsListExample($service, $adClientId, $customChannelId));
...
* @return AdUnits</returns>
*/
function adunitsListExample($service, $adClientId, $customChannelId)
{
	try
	{
		...
		return $service->adunits->ListAdunits($adClientId, $customChannelId);
	}
	catch (Exception $ex)
	{
