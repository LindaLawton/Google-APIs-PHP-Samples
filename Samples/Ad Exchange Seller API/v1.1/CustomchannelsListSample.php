...
do {
	...
	$results = filesListExample($service, $adClientId, $adUnitId, $optParams);	
...
*/
function customchannelsListExample($service, $adClientId, $adUnitId, $optParams)
{
	try
	{
		...
		return $service->customchannels->ListCustomchannels($adClientId, $adUnitId, $optParams);
	}
	catch (Exception $e)
	{
