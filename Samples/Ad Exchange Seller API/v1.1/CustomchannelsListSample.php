...
print_r(customchannelsListExample($service, $adClientId, $adUnitId));
...
* @return CustomChannels</returns>
*/
function customchannelsListExample($service, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->customchannels->ListCustomchannels($adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
