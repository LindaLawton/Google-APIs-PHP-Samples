...
$results = preferreddealsListExample($service, $optParams);
...
*/
function preferreddealsListExample($service, $optParams)
{
	try
	{
		...
		return $service->preferreddeals->ListPreferreddeals($optParams);
	}
	catch (Exception $e)
	{
