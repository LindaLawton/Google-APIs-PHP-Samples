...
// Single Request.
$results = accountsGetExample($service, $accountId, $optParams);
...
* @return Account
*/
function accountsGetExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->accounts->GetAccounts($accountId, $optParams);
	}
	catch (Exception $e)
	{
