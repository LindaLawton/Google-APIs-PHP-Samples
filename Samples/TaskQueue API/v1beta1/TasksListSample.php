...
// Single Request.
$results = tasksListExample($service, $project, $taskqueue, $optParams);
...
* @return Tasks2
*/
function tasksListExample($service, $project, $taskqueue, $optParams)
{
	try
	{
		...
		return $service->tasks->ListTasks($project, $taskqueue, $optParams);
	}
	catch (Exception $e)
	{
