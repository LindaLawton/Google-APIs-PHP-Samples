...
print_r(tasksDeleteExample($service, $project, $taskqueue, $task));
...
*/
function tasksDeleteExample($service, $project, $taskqueue, $task)
{
	try
	{
		...
		return $service->tasks->DeleteTasks($project, $taskqueue, $task);
	}
	catch (Exception $ex)
	{
