...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'getStats' => '[YourValue]',  // Whether to get stats. Optional.
  'fields' => '*'
);
// Single Request.
$results = taskqueuesGetExample($service, $project, $taskqueue, $optParams);
...
* @return TaskQueue
*/
function taskqueuesGetExample($service, $project, $taskqueue, $optParams)
{
	try
	{
		...
		return $service->taskqueues->GetTaskqueues($project, $taskqueue, $optParams);
	}
	catch (Exception $e)
	{
