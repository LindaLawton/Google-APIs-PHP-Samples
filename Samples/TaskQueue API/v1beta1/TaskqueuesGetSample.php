...
print_r(taskqueuesGetExample($service, $project, $taskqueue));
...
* @return TaskQueue</returns>
*/
function taskqueuesGetExample($service, $project, $taskqueue)
{
	try
	{
		...
		return $service->taskqueues->GetTaskqueues($project, $taskqueue);
	}
	catch (Exception $ex)
	{
