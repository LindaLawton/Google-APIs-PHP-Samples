 ...
 * Initializes an Taskqueue.v1beta1 service object.
 * @param string API key
 * @return An authorized Taskqueue.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Taskqueue Sample");
		...
		// Create authenticated Taskqueue service
		return new Google_Service_Taskqueue($client);
	} catch (Exception $e) {
