...
// About 
// 
// Unofficial sample for the taskqueue v1beta1 API for PHP. 
...
print_r(tasksLeaseExample($service, $project, $taskqueue, $numTasks, $leaseSecs));

/**
* Lease 1 or more tasks from a TaskQueue.
* @service Authenticated Taskqueue service.
...
* @return Tasks</returns>
*/
function tasksLeaseExample($service, $project, $taskqueue, $numTasks, $leaseSecs)
{
	try
	{
		...
		if (leaseSecs == null)
			throw new Exception("leaseSecs is required.");
		if (numTasks == null)
			throw new Exception("numTasks is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (taskqueue == null)
			throw new Exception("taskqueue is required.");
		// Make the request and return the results.
		return $service->tasks->LeaseTasks($project, $taskqueue, $numTasks, $leaseSecs);
	}
	catch (Exception $ex)
	{
