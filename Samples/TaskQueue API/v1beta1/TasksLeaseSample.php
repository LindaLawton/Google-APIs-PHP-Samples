...
print_r(lease($service, $project, $taskqueue, $numTasks, $leaseSecs));
...
*/
function lease($service, $project, $taskqueue, $numTasks, $leaseSecs)
{
	try
	{
		...
		return $service->lease($project, $taskqueue, $numTasks, $leaseSecs);
	}
	catch (Exception $ex)
	{
