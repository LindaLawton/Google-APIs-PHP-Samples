...
print_r(tasksPatchExample($service, $project, $taskqueue, $task, $newLeaseSeconds));
...
* @return Task</returns>
*/
function tasksPatchExample($service, $project, $taskqueue, $task, $newLeaseSeconds)
{
	try
	{
		...
		return $service->tasks->PatchTasks($project, $taskqueue, $task, $newLeaseSeconds);
	}
	catch (Exception $ex)
	{
