...
print_r(patch($service, $project, $taskqueue, $task, $newLeaseSeconds));
...
* @return Task</returns>
*/
function patch($service, $project, $taskqueue, $task, $newLeaseSeconds)
{
	try
	{
		...
		return $service->patch($project, $taskqueue, $task, $newLeaseSeconds);
	}
	catch (Exception $ex)
	{
