...
* @return Task
*/
function tasksPatchExample($service, $project, $taskqueue, $task, $newLeaseSeconds, $optParams)
{
	try
	{
		...
		return $service->tasks->PatchTasks($project, $taskqueue, $task, $newLeaseSeconds, $optParams);
	}
	catch (Exception $e)
	{
