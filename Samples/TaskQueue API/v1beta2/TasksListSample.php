...
print_r(tasksListExample($service, $project, $taskqueue));
...
* @return Tasks2</returns>
*/
function tasksListExample($service, $project, $taskqueue)
{
	try
	{
		...
		return $service->tasks->ListTasks($project, $taskqueue);
	}
	catch (Exception $ex)
	{
