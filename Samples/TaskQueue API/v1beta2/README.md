...
# UnOfficial TaskQueue API v1beta2 Samples for PHP
...
These samples show how to access the [TaskQueue API v1beta2](https://developers.google.com/appengine/docs/python/taskqueue/rest) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
