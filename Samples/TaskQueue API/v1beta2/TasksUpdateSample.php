...
// Single Request.
$results = tasksUpdateExample($service, $project, $taskqueue, $task, $newLeaseSeconds, $optParams);
...
* @return Task
*/
function tasksUpdateExample($service, $project, $taskqueue, $task, $newLeaseSeconds, $optParams)
{
	try
	{
		...
		if (newLeaseSeconds == null)
			throw new Exception("newLeaseSeconds is required.");
		if (project == null)
		...
		return $service->tasks->UpdateTasks($project, $taskqueue, $task, $newLeaseSeconds, $optParams);
	}
	catch (Exception $e)
	{
