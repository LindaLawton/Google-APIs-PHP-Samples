...
print_r(tasksUpdateExample($service, $project, $taskqueue, $task, $newLeaseSeconds));
...
* @return Task</returns>
*/
function tasksUpdateExample($service, $project, $taskqueue, $task, $newLeaseSeconds)
{
	try
	{
		...
		return $service->tasks->UpdateTasks($project, $taskqueue, $task, $newLeaseSeconds);
	}
	catch (Exception $ex)
	{
