...
print_r(update($service, $project, $taskqueue, $task, $newLeaseSeconds));
...
* @return Task</returns>
*/
function update($service, $project, $taskqueue, $task, $newLeaseSeconds)
{
	try
	{
		...
		return $service->update($project, $taskqueue, $task, $newLeaseSeconds);
	}
	catch (Exception $ex)
	{
