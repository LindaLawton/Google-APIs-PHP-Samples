...
// Single Request.
$results = tasksInsertExample($service, $project, $taskqueue, $optParams);
...
* @return Task
*/
function tasksInsertExample($service, $project, $taskqueue, $optParams)
{
	try
	{
		...
		return $service->tasks->InsertTasks($project, $taskqueue, $optParams);
	}
	catch (Exception $e)
	{
