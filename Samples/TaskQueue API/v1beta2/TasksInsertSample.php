...
print_r(tasksInsertExample($service, $project, $taskqueue));
...
* @return Task</returns>
*/
function tasksInsertExample($service, $project, $taskqueue)
{
	try
	{
		...
		return $service->tasks->InsertTasks($project, $taskqueue);
	}
	catch (Exception $ex)
	{
