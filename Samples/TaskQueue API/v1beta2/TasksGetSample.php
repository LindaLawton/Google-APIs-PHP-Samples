...
$results = tasksGetExample($service, $project, $taskqueue, $task, $optParams);
...
* @return Task
*/
function tasksGetExample($service, $project, $taskqueue, $task, $optParams)
{
	try
	{
		...
		return $service->tasks->GetTasks($project, $taskqueue, $task, $optParams);
	}
	catch (Exception $e)
	{
