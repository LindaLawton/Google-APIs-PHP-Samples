...
print_r(tasksGetExample($service, $project, $taskqueue, $task));
...
* @return Task</returns>
*/
function tasksGetExample($service, $project, $taskqueue, $task)
{
	try
	{
		...
		return $service->tasks->GetTasks($project, $taskqueue, $task);
	}
	catch (Exception $ex)
	{
