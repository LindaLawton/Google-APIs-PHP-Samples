...
* @return Tasks
*/
function tasksLeaseExample($service, $project, $taskqueue, $numTasks, $leaseSecs, $optParams)
{
	try
	{
		...
		return $service->tasks->LeaseTasks($project, $taskqueue, $numTasks, $leaseSecs, $optParams);
	}
	catch (Exception $e)
	{
