...
// Single Request.
$results = reposCreateExample($service, $parent, $optParams);
...
* @return Repo
*/
function reposCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->repos->CreateRepos($parent, $optParams);
	}
	catch (Exception $e)
	{
