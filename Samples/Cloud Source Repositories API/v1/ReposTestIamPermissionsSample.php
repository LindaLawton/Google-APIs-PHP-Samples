...
print_r(reposTestIamPermissionsExample($service, $resource));
...
*/
function reposTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->repos->TestIamPermissionsRepos($resource);
	}
	catch (Exception $ex)
	{
