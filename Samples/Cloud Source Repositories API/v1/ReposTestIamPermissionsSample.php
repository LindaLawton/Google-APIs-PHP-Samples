...
// Single Request.
$results = reposTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function reposTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->repos->TestIamPermissionsRepos($resource, $optParams);
	}
	catch (Exception $e)
	{
