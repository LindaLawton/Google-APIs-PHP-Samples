...
// Single Request.
$results = reposGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function reposGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->repos->GetIamPolicyRepos($resource, $optParams);
	}
	catch (Exception $e)
	{
