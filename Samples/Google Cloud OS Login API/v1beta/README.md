...
# UnOfficial Google Cloud OS Login API v1beta Samples for PHP
...
These samples show how to access the [Google Cloud OS Login API v1beta](https://cloud.google.com/compute/docs/oslogin/rest/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
