...
print_r(sshPublicKeysPatchExample($service, $name));
...
* @return SshPublicKey</returns>
*/
function sshPublicKeysPatchExample($service, $name)
{
	try
	{
		...
		return $service->sshPublicKeys->PatchSshPublicKeys($name);
	}
	catch (Exception $ex)
	{
