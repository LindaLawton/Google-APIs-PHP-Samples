...
# Unoffical Google Cloud OS Login API Samples for PHP
...
These samples show how to access the [Google Cloud OS Login API](https://cloud.google.com/compute/docs/oslogin/rest/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
