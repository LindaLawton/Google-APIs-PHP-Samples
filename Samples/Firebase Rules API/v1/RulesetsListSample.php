...
print_r(rulesetsListExample($service, $name));
...
* @return ListRulesetsResponse</returns>
*/
function rulesetsListExample($service, $name)
{
	try
	{
		...
		return $service->rulesets->ListRulesets($name);
	}
	catch (Exception $ex)
	{
