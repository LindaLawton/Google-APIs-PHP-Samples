...
print_r(rulesetsCreateExample($service, $name));
...
* @return Ruleset</returns>
*/
function rulesetsCreateExample($service, $name)
{
	try
	{
		...
		return $service->rulesets->CreateRulesets($name);
	}
	catch (Exception $ex)
	{
