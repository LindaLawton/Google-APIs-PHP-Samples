...
$results = rulesetsCreateExample($service, $name, $optParams);
...
* @return Ruleset
*/
function rulesetsCreateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->rulesets->CreateRulesets($name, $optParams);
	}
	catch (Exception $e)
	{
