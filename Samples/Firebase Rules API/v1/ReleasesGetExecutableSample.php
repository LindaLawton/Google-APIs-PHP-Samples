...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'executableVersion' => '[YourValue]',  // The requested runtime executable version.Defaults to FIREBASE_RULES_EXECUTABLE_V1
  'fields' => '*'
);
// Single Request.
$results = releasesGetExecutableExample($service, $name, $optParams);
...
*/
function releasesGetExecutableExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->releases->GetExecutableReleases($name, $optParams);
	}
	catch (Exception $e)
	{
