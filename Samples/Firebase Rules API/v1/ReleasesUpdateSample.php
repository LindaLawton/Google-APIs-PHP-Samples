...
print_r(releasesUpdateExample($service, $name));
...
* @return Release</returns>
*/
function releasesUpdateExample($service, $name)
{
	try
	{
		...
		return $service->releases->UpdateReleases($name);
	}
	catch (Exception $ex)
	{
