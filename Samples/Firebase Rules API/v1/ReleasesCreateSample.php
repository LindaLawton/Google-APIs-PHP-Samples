...
$results = releasesCreateExample($service, $name, $optParams);
...
* @return Release
*/
function releasesCreateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->releases->CreateReleases($name, $optParams);
	}
	catch (Exception $e)
	{
