...
print_r(releasesListExample($service, $name));
...
* @return ListReleasesResponse</returns>
*/
function releasesListExample($service, $name)
{
	try
	{
		...
		return $service->releases->ListReleases($name);
	}
	catch (Exception $ex)
	{
