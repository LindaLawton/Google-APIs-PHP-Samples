...
// About 
// 
// Unofficial sample for the Firebaserules v1 API for PHP. 
 ...
 * Initializes an Firebaserules.v1 service object.
 * @param string API key
 * @return An authorized Firebaserules.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Firebaserules Sample");
		...
		// Create authenticated Firebaserules service
		return new Google_Service_Firebaserules($client);
	} catch (Exception $e) {
