...
$results = rulesetsDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function rulesetsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->rulesets->DeleteRulesets($name, $optParams);
	}
	catch (Exception $e)
	{
