...
# UnOfficial Knowledge Graph Search API v1 Samples for PHP

## API Description

Searches the Google Knowledge Graph for entities.

[Official Documentation](https://developers.google.com/knowledge-graph/)

## Sample Description

These samples show how to access the [Knowledge Graph Search API v1](https://developers.google.com/knowledge-graph/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
