...
print_r(entitiesSearchExample($service));
...
* @service Authenticated Kgsearch service.
* @return SearchResponse</returns>
*/
function entitiesSearchExample($service)
{
	try
	{
		...
		return $service->entities->SearchEntities();
	}
	catch (Exception $ex)
	{
