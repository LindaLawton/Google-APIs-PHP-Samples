...
// About 
// 
// Unofficial sample for the kgsearch v1 API for PHP. 
 ...
 * Initializes an Kgsearch.v1 service object.
 * @param string API key
 * @return An authorized Kgsearch.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Kgsearch Sample");
		...
		// Create authenticated Kgsearch service
		return new Google_Service_Kgsearch($client);
	} catch (Exception $e) {
