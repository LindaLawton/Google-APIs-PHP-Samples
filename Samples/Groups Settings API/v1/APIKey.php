...
// About 
// 
// Unofficial sample for the groupssettings v1 API for PHP. 
 ...
 * Initializes an Groupssettings.v1 service object.
 * @param string API key
 * @return An authorized Groupssettings.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Groupssettings Sample");
		...
		// Create authenticated Groupssettings service
		return new Google_Service_Groupssettings($client);
	} catch (Exception $e) {
