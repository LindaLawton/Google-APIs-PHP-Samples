...
print_r(groupsUpdateExample($service, $groupUniqueId));

/**
* Updates an existing resource.
* @service Authenticated Groupssettings service.
* @groupUniqueId The resource ID
* @return Groups</returns>
*/
function groupsUpdateExample($service, $groupUniqueId)
{
	try
	{
		...
		return $service->groups->UpdateGroups($groupUniqueId);
	}
	catch (Exception $ex)
	{
