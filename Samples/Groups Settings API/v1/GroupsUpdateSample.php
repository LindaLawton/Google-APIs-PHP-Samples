...
// Single Request.
$results = groupsUpdateExample($service, $groupUniqueId, $optParams);


/**
* Updates an existing resource.
* @service Authenticated Groupssettings service.
* @optParams Optional paramaters are not required by a request.
* @groupUniqueId The resource ID
* @return Groups
*/
function groupsUpdateExample($service, $groupUniqueId, $optParams)
{
	try
	{
		...
		if (groupUniqueId == null)
			throw new Exception("groupUniqueId is required.");
		// Make the request and return the results.
		return $service->groups->UpdateGroups($groupUniqueId, $optParams);
	}
	catch (Exception $e)
	{
