...
// Single Request.
$results = groupsPatchExample($service, $groupUniqueId, $optParams);
...
* @return Groups
*/
function groupsPatchExample($service, $groupUniqueId, $optParams)
{
	try
	{
		...
		return $service->groups->PatchGroups($groupUniqueId, $optParams);
	}
	catch (Exception $e)
	{
