...
// Single Request.
$results = groupsGetExample($service, $groupUniqueId, $optParams);
...
* @return Groups
*/
function groupsGetExample($service, $groupUniqueId, $optParams)
{
	try
	{
		...
		return $service->groups->GetGroups($groupUniqueId, $optParams);
	}
	catch (Exception $e)
	{
