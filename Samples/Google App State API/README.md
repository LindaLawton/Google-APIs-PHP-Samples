...
# Unoffical Google App State API Samples for PHP
...
These samples show how to access the [Google App State API](https://developers.google.com/games/services/web/api/states) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
