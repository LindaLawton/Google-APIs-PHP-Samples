...
// Single Request.
$results = statesGetExample($service, $stateKey, $optParams);
...
* @return GetResponse
*/
function statesGetExample($service, $stateKey, $optParams)
{
	try
	{
		...
		return $service->states->GetStates($stateKey, $optParams);
	}
	catch (Exception $e)
	{
