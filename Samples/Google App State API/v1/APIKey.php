...
// About 
// 
// Unofficial sample for the Appstate v1 API for PHP. 
 ...
 * Initializes an Appstate.v1 service object.
 * @param string API key
 * @return An authorized Appstate.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Appstate Sample");
		...
		// Create authenticated Appstate service
		return new Google_Service_Appstate($client);
	} catch (Exception $e) {
