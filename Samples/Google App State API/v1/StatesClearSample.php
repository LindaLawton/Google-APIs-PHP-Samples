...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'currentDataVersion' => '[YourValue]',  // The version of the data to be cleared. Version strings are returned by the server.
  'fields' => '*'
);
// Single Request.
$results = statesClearExample($service, $stateKey, $optParams);
...
* @return WriteResult
*/
function statesClearExample($service, $stateKey, $optParams)
{
	try
	{
		...
		return $service->states->ClearStates($stateKey, $optParams);
	}
	catch (Exception $e)
	{
