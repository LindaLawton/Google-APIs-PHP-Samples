...
print_r(statesUpdateExample($service, $stateKey));
...
* @return WriteResult</returns>
*/
function statesUpdateExample($service, $stateKey)
{
	try
	{
		...
		return $service->states->UpdateStates($stateKey);
	}
	catch (Exception $ex)
	{
