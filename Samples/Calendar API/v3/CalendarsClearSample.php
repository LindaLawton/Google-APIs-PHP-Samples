...
$results = calendarsClearExample($service, $calendarId, $optParams);
...
*/
function calendarsClearExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendars->ClearCalendars($calendarId, $optParams);
	}
	catch (Exception $e)
	{
