...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'sendNotifications' => '[YourValue]',  // Whether to send notifications about the event update (e.g. attendee's responses, title changes, etc.). Optional. The default is False.
...
// Single Request.
$results = eventsUpdateExample($service, $calendarId, $eventId, $optParams);
...
* @return Event
*/
function eventsUpdateExample($service, $calendarId, $eventId, $optParams)
{
	try
	{
		...
		return $service->events->UpdateEvents($calendarId, $eventId, $optParams);
	}
	catch (Exception $e)
	{
