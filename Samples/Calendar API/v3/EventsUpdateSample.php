...
print_r(eventsUpdateExample($service, $calendarId, $eventId));
...
*/
function eventsUpdateExample($service, $calendarId, $eventId)
{
	try
	{
		...
		return $service->events->UpdateEvents($calendarId, $eventId);
	}
	catch (Exception $ex)
	{
