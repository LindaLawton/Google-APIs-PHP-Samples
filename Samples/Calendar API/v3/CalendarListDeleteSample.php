...
$results = calendarListDeleteExample($service, $calendarId, $optParams);
...
*/
function calendarListDeleteExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendarList->DeleteCalendarList($calendarId, $optParams);
	}
	catch (Exception $e)
	{
