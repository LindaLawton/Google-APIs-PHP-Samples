...
print_r(calendarListDeleteExample($service, $calendarId));
...
*/
function calendarListDeleteExample($service, $calendarId)
{
	try
	{
		...
		return $service->calendarList->DeleteCalendarList($calendarId);
	}
	catch (Exception $ex)
	{
