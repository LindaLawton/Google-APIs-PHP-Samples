...
// Single Request.
$results = aclGetExample($service, $calendarId, $ruleId, $optParams);
...
* @return AclRule
*/
function aclGetExample($service, $calendarId, $ruleId, $optParams)
{
	try
	{
		...
		return $service->acl->GetAcl($calendarId, $ruleId, $optParams);
	}
	catch (Exception $e)
	{
