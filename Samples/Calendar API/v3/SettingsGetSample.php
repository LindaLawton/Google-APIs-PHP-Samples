...
// Single Request.
$results = settingsGetExample($service, $setting, $optParams);
...
* @return Setting
*/
function settingsGetExample($service, $setting, $optParams)
{
	try
	{
		...
		return $service->settings->GetSettings($setting, $optParams);
	}
	catch (Exception $e)
	{
