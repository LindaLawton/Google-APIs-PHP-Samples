...
// Single Request.
$results = eventsImportExample($service, $calendarId, $optParams);
...
* @return Event
*/
function eventsImportExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->events->ImportEvents($calendarId, $optParams);
	}
	catch (Exception $e)
	{
