...
$results = aclDeleteExample($service, $calendarId, $ruleId, $optParams);
...
*/
function aclDeleteExample($service, $calendarId, $ruleId, $optParams)
{
	try
	{
		...
		return $service->acl->DeleteAcl($calendarId, $ruleId, $optParams);
	}
	catch (Exception $e)
	{
