...
print_r(eventsInstancesExample($service, $calendarId, $eventId));
...
*/
function eventsInstancesExample($service, $calendarId, $eventId)
{
	try
	{
		...
		return $service->events->InstancesEvents($calendarId, $eventId);
	}
	catch (Exception $ex)
	{
