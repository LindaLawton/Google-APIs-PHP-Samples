...
do {
	...
	$results = filesListExample($service, $calendarId, $eventId, $optParams);	
...
* @return Events
*/
function eventsInstancesExample($service, $calendarId, $eventId, $optParams)
{
	try
	{
		...
		return $service->events->InstancesEvents($calendarId, $eventId, $optParams);
	}
	catch (Exception $e)
	{
