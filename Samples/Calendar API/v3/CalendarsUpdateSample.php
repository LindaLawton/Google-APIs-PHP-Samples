...
print_r(calendarsUpdateExample($service, $calendarId));
...
*/
function calendarsUpdateExample($service, $calendarId)
{
	try
	{
		...
		return $service->calendars->UpdateCalendars($calendarId);
	}
	catch (Exception $ex)
	{
