...
// Single Request.
$results = calendarsUpdateExample($service, $calendarId, $optParams);
...
* @return Calendar
*/
function calendarsUpdateExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendars->UpdateCalendars($calendarId, $optParams);
	}
	catch (Exception $e)
	{
