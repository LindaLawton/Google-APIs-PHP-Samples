...
print_r(eventsPatchExample($service, $calendarId, $eventId));
...
*/
function eventsPatchExample($service, $calendarId, $eventId)
{
	try
	{
		...
		return $service->events->PatchEvents($calendarId, $eventId);
	}
	catch (Exception $ex)
	{
