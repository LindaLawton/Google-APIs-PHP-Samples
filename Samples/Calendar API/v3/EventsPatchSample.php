...
// Single Request.
$results = eventsPatchExample($service, $calendarId, $eventId, $optParams);
...
* @return Event
*/
function eventsPatchExample($service, $calendarId, $eventId, $optParams)
{
	try
	{
		...
		return $service->events->PatchEvents($calendarId, $eventId, $optParams);
	}
	catch (Exception $e)
	{
