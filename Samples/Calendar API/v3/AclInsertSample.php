...
// Single Request.
$results = aclInsertExample($service, $calendarId, $optParams);
...
* @return AclRule
*/
function aclInsertExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->acl->InsertAcl($calendarId, $optParams);
	}
	catch (Exception $e)
	{
