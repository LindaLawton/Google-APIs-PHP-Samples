...
// Single Request.
$results = aclListExample($service, $calendarId, $optParams);
...
* @return Acl
*/
function aclListExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->acl->ListAcl($calendarId, $optParams);
	}
	catch (Exception $e)
	{
