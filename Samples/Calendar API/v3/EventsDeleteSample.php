...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'sendNotifications' => '[YourValue]',  // Whether to send notifications about the deletion of the event. Optional. The default is False.
  'fields' => '*'
);
// Single Request.
$results = eventsDeleteExample($service, $calendarId, $eventId, $optParams);
...
*/
function eventsDeleteExample($service, $calendarId, $eventId, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->events->DeleteEvents($calendarId, $eventId, $optParams);
	}
	catch (Exception $e)
	{
