...
print_r(eventsDeleteExample($service, $calendarId, $eventId));
...
*/
function eventsDeleteExample($service, $calendarId, $eventId)
{
	try
	{
		...
		return $service->events->DeleteEvents($calendarId, $eventId);
	}
	catch (Exception $ex)
	{
