...
// Single Request.
$results = calendarsPatchExample($service, $calendarId, $optParams);
...
* @return Calendar
*/
function calendarsPatchExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendars->PatchCalendars($calendarId, $optParams);
	}
	catch (Exception $e)
	{
