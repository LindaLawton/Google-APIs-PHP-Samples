...
print_r(calendarListGetExample($service, $calendarId));
...
*/
function calendarListGetExample($service, $calendarId)
{
	try
	{
		...
		return $service->calendarList->GetCalendarList($calendarId);
	}
	catch (Exception $ex)
	{
