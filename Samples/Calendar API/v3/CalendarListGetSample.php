...
// Single Request.
$results = calendarListGetExample($service, $calendarId, $optParams);
...
*/
function calendarListGetExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendarList->GetCalendarList($calendarId, $optParams);
	}
	catch (Exception $e)
	{
