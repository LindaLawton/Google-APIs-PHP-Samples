...
print_r(aclUpdateExample($service, $calendarId, $ruleId));
...
* @return AclRule</returns>
*/
function aclUpdateExample($service, $calendarId, $ruleId)
{
	try
	{
		...
		return $service->acl->UpdateAcl($calendarId, $ruleId);
	}
	catch (Exception $ex)
	{
