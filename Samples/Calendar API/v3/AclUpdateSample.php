...
// Single Request.
$results = aclUpdateExample($service, $calendarId, $ruleId, $optParams);
...
* @return AclRule
*/
function aclUpdateExample($service, $calendarId, $ruleId, $optParams)
{
	try
	{
		...
		if (ruleId == null)
			throw new Exception("ruleId is required.");
		// Make the request and return the results.
		return $service->acl->UpdateAcl($calendarId, $ruleId, $optParams);
	}
	catch (Exception $e)
	{
