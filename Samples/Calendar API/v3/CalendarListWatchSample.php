...
$results = calendarListWatchExample($service, $optParams);
...
* @return Channel
*/
function calendarListWatchExample($service, $optParams)
{
	try
	{
		...
		return $service->calendarList->WatchCalendarList($optParams);
	}
	catch (Exception $e)
	{
