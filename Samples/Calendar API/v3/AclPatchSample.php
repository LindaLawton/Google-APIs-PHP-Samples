...
$results = aclPatchExample($service, $calendarId, $ruleId, $optParams);
...
* @return AclRule
*/
function aclPatchExample($service, $calendarId, $ruleId, $optParams)
{
	try
	{
		...
		return $service->acl->PatchAcl($calendarId, $ruleId, $optParams);
	}
	catch (Exception $e)
	{
