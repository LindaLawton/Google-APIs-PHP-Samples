...
// Single Request.
$results = eventsGetExample($service, $calendarId, $eventId, $optParams);
...
* @return Event
*/
function eventsGetExample($service, $calendarId, $eventId, $optParams)
{
	try
	{
		...
		return $service->events->GetEvents($calendarId, $eventId, $optParams);
	}
	catch (Exception $e)
	{
