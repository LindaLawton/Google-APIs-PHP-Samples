...
print_r(eventsGetExample($service, $calendarId, $eventId));
...
*/
function eventsGetExample($service, $calendarId, $eventId)
{
	try
	{
		...
		return $service->events->GetEvents($calendarId, $eventId);
	}
	catch (Exception $ex)
	{
