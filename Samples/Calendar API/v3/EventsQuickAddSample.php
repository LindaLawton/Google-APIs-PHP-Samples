...
print_r(eventsQuickAddExample($service, $calendarId, $text));
...
*/
function eventsQuickAddExample($service, $calendarId, $text)
{
	try
	{
		...
		return $service->events->QuickAddEvents($calendarId, $text);
	}
	catch (Exception $ex)
	{
