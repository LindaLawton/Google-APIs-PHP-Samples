...
# UnOfficial Calendar API v3 Samples for PHP

## API Description

Manipulates events and other calendar data.

[Official Documentation](https://developers.google.com/google-apps/calendar/firstapp)

## Sample Description

These samples show how to access the [Calendar API v3](https://developers.google.com/google-apps/calendar/firstapp) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
