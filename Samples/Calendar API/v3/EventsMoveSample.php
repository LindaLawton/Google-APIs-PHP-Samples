...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'sendNotifications' => '[YourValue]',  // Whether to send notifications about the change of the event's organizer. Optional. The default is False.
  'fields' => '*'
);
// Single Request.
$results = eventsMoveExample($service, $calendarId, $eventId, $destination, $optParams);
...
* @return Event
*/
function eventsMoveExample($service, $calendarId, $eventId, $destination, $optParams)
{
	try
	{
		...
		return $service->events->MoveEvents($calendarId, $eventId, $destination, $optParams);
	}
	catch (Exception $e)
	{
