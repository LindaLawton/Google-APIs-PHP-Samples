...
print_r(move($service, $calendarId, $eventId, $destination));
...
*/
function move($service, $calendarId, $eventId, $destination)
{
	try
	{
		...
		return $service->move($calendarId, $eventId, $destination);
	}
	catch (Exception $ex)
	{
