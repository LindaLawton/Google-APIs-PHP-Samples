...
print_r(eventsMoveExample($service, $calendarId, $eventId, $destination));
...
*/
function eventsMoveExample($service, $calendarId, $eventId, $destination)
{
	try
	{
		...
		return $service->events->MoveEvents($calendarId, $eventId, $destination);
	}
	catch (Exception $ex)
	{
