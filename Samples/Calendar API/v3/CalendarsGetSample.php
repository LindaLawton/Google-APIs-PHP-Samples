...
// Single Request.
$results = calendarsGetExample($service, $calendarId, $optParams);
...
* @return Calendar
*/
function calendarsGetExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendars->GetCalendars($calendarId, $optParams);
	}
	catch (Exception $e)
	{
