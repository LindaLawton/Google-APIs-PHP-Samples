...
print_r(calendarListPatchExample($service, $calendarId));
...
*/
function calendarListPatchExample($service, $calendarId)
{
	try
	{
		...
		return $service->calendarList->PatchCalendarList($calendarId);
	}
	catch (Exception $ex)
	{
