...
// Single Request.
$results = calendarListPatchExample($service, $calendarId, $optParams);
...
*/
function calendarListPatchExample($service, $calendarId, $optParams)
{
	try
	{
		...
		return $service->calendarList->PatchCalendarList($calendarId, $optParams);
	}
	catch (Exception $e)
	{
