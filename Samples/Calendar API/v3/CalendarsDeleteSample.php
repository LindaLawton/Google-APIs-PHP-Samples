...
print_r(calendarsDeleteExample($service, $calendarId));
...
*/
function calendarsDeleteExample($service, $calendarId)
{
	try
	{
		...
		return $service->calendars->DeleteCalendars($calendarId);
	}
	catch (Exception $ex)
	{
