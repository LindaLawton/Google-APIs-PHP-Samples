...
print_r(calendarListUpdateExample($service, $calendarId));
...
* @return CalendarListEntry</returns>
*/
function calendarListUpdateExample($service, $calendarId)
{
	try
	{
		...
		return $service->calendarList->UpdateCalendarList($calendarId);
	}
	catch (Exception $ex)
	{
