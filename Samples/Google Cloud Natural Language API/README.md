...
# Unoffical Google Cloud Natural Language API Samples for PHP
...
These samples show how to access the [Google Cloud Natural Language API](https://cloud.google.com/natural-language/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
