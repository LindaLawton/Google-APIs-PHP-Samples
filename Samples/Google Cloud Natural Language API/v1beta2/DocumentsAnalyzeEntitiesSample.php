...
print_r(documentsAnalyzeEntitiesExample($service));
...
* @return AnalyzeEntitiesResponse</returns>
*/
function documentsAnalyzeEntitiesExample($service)
{
	try
	{
		...
		return $service->documents->AnalyzeEntitiesDocuments();
	}
	catch (Exception $ex)
	{
