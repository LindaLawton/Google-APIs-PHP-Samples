...
// Single Request.
$results = documentsAnalyzeEntitySentimentExample($service, $optParams);
...
*/
function documentsAnalyzeEntitySentimentExample($service, $optParams)
{
	try
	{
		...
		return $service->documents->AnalyzeEntitySentimentDocuments($optParams);
	}
	catch (Exception $e)
	{
