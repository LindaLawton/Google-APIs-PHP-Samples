...
print_r(documentsAnalyzeEntitySentimentExample($service));
...
* @return AnalyzeEntitySentimentResponse</returns>
*/
function documentsAnalyzeEntitySentimentExample($service)
{
	try
	{
		...
		return $service->documents->AnalyzeEntitySentimentDocuments();
	}
	catch (Exception $ex)
	{
