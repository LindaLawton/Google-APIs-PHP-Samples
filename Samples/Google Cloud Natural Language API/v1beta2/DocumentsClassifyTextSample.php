...
print_r(documentsClassifyTextExample($service));

/**
* Classifies a document into categories.
* @service Authenticated Cloudnaturallanguage service.
* @return ClassifyTextResponse</returns>
*/
function documentsClassifyTextExample($service)
{
	try
	{
		...
		return $service->documents->ClassifyTextDocuments();
	}
	catch (Exception $ex)
	{
