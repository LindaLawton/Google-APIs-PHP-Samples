...
// Single Request.
$results = documentsClassifyTextExample($service, $optParams);
...
*/
function documentsClassifyTextExample($service, $optParams)
{
	try
	{
		...
		return $service->documents->ClassifyTextDocuments($optParams);
	}
	catch (Exception $e)
	{
