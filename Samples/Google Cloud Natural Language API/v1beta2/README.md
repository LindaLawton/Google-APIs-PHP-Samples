...
# UnOfficial Google Cloud Natural Language API v1beta2 Samples for PHP
...
These samples show how to access the [Google Cloud Natural Language API v1beta2](https://cloud.google.com/natural-language/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
