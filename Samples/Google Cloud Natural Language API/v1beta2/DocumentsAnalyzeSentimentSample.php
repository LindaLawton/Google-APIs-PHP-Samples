...
print_r(documentsAnalyzeSentimentExample($service));

/**
* Analyzes the sentiment of the provided text.
* @service Authenticated Cloudnaturallanguage service.
* @return AnalyzeSentimentResponse</returns>
*/
function documentsAnalyzeSentimentExample($service)
{
	try
	{
		...
		return $service->documents->AnalyzeSentimentDocuments();
	}
	catch (Exception $ex)
	{
