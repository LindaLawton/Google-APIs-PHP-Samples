...
print_r(documentsAnalyzeSyntaxExample($service));
...
* @return AnalyzeSyntaxResponse</returns>
*/
function documentsAnalyzeSyntaxExample($service)
{
	try
	{
		...
		return $service->documents->AnalyzeSyntaxDocuments();
	}
	catch (Exception $ex)
	{
