...
// Single Request.
$results = documentsAnalyzeSyntaxExample($service, $optParams);
...
*/
function documentsAnalyzeSyntaxExample($service, $optParams)
{
	try
	{
		...
		return $service->documents->AnalyzeSyntaxDocuments($optParams);
	}
	catch (Exception $e)
	{
