...
// Single Request.
$results = documentsAnalyzeEntitiesExample($service, $optParams);
...
*/
function documentsAnalyzeEntitiesExample($service, $optParams)
{
	try
	{
		...
		return $service->documents->AnalyzeEntitiesDocuments($optParams);
	}
	catch (Exception $e)
	{
