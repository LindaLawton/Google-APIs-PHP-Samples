...
*/
function guardianInvitationsPatchExample($service, $studentId, $invitationId, $optParams)
{
	try
	{
		...
		return $service->guardianInvitations->PatchGuardianInvitations($studentId, $invitationId, $optParams);
	}
	catch (Exception $e)
	{
