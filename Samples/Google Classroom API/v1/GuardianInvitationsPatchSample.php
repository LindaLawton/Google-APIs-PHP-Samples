...
print_r(guardianInvitationsPatchExample($service, $studentId, $invitationId));
...
* @return GuardianInvitation</returns>
*/
function guardianInvitationsPatchExample($service, $studentId, $invitationId)
{
	try
	{
		...
		return $service->guardianInvitations->PatchGuardianInvitations($studentId, $invitationId);
	}
	catch (Exception $ex)
	{
