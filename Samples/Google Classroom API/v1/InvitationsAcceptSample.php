...
// Single Request.
$results = invitationsAcceptExample($service, $id, $optParams);
...
* @return Empty
*/
function invitationsAcceptExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->invitations->AcceptInvitations($id, $optParams);
	}
	catch (Exception $e)
	{
