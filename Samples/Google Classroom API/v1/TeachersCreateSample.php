...
// Single Request.
$results = teachersCreateExample($service, $courseId, $optParams);
...
* @return Teacher
*/
function teachersCreateExample($service, $courseId, $optParams)
{
	try
	{
		...
		return $service->teachers->CreateTeachers($courseId, $optParams);
	}
	catch (Exception $e)
	{
