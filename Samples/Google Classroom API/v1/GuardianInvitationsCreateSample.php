...
print_r(guardianInvitationsCreateExample($service, $studentId));
...
*/
function guardianInvitationsCreateExample($service, $studentId)
{
	try
	{
		...
		return $service->guardianInvitations->CreateGuardianInvitations($studentId);
	}
	catch (Exception $ex)
	{
