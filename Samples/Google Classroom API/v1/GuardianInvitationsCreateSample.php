...
$results = guardianInvitationsCreateExample($service, $studentId, $optParams);
...
*/
function guardianInvitationsCreateExample($service, $studentId, $optParams)
{
	try
	{
		...
		return $service->guardianInvitations->CreateGuardianInvitations($studentId, $optParams);
	}
	catch (Exception $e)
	{
