...
$results = guardiansDeleteExample($service, $studentId, $guardianId, $optParams);
...
* @return Empty
*/
function guardiansDeleteExample($service, $studentId, $guardianId, $optParams)
{
	try
	{
		...
		return $service->guardians->DeleteGuardians($studentId, $guardianId, $optParams);
	}
	catch (Exception $e)
	{
