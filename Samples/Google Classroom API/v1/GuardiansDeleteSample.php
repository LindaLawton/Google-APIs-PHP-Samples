...
print_r(guardiansDeleteExample($service, $studentId, $guardianId));
...
*/
function guardiansDeleteExample($service, $studentId, $guardianId)
{
	try
	{
		...
		return $service->guardians->DeleteGuardians($studentId, $guardianId);
	}
	catch (Exception $ex)
	{
