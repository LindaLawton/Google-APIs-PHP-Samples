...
* @return Empty
*/
function announcementsDeleteExample($service, $courseId, $id, $optParams)
{
	try
	{
		...
		return $service->announcements->DeleteAnnouncements($courseId, $id, $optParams);
	}
	catch (Exception $e)
	{
