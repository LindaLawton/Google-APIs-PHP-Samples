...
$results = announcementsModifyAssigneesExample($service, $courseId, $id, $optParams);


/**
* Modifies assignee mode and options of a announcement.Only a teacher of the course that contains the announcement maycall this method.This method returns the following error codes:* `PERMISSION_DENIED` if the requesting user is not permitted to access therequested course or course work or for access errors.* `INVALID_ARGUMENT` if the request is malformed.* `NOT_FOUND` if the requested course or course work does not exist.
...
* @return Announcement
*/
function announcementsModifyAssigneesExample($service, $courseId, $id, $optParams)
{
	try
	{
		...
		return $service->announcements->ModifyAssigneesAnnouncements($courseId, $id, $optParams);
	}
	catch (Exception $e)
	{
