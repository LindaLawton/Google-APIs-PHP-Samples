...
// Single Request.
$results = aliasesCreateExample($service, $courseId, $optParams);
...
* @return CourseAlias
*/
function aliasesCreateExample($service, $courseId, $optParams)
{
	try
	{
		...
		return $service->aliases->CreateAliases($courseId, $optParams);
	}
	catch (Exception $e)
	{
