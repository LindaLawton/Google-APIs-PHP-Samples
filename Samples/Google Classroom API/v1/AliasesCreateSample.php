...
print_r(aliasesCreateExample($service, $courseId));
...
alias.
* @return CourseAlias</returns>
*/
function aliasesCreateExample($service, $courseId)
{
	try
	{
		...
		return $service->aliases->CreateAliases($courseId);
	}
	catch (Exception $ex)
	{
