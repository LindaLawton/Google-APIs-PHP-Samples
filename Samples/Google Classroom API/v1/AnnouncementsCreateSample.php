...
* @return Announcement
*/
function announcementsCreateExample($service, $courseId, $optParams)
{
	try
	{
		...
		return $service->announcements->CreateAnnouncements($courseId, $optParams);
	}
	catch (Exception $e)
	{
