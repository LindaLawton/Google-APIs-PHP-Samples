...
print_r(invitationsListExample($service));
...
* @return ListInvitationsResponse</returns>
*/
function invitationsListExample($service)
{
	try
	{
		...
		return $service->invitations->ListInvitations();
	}
	catch (Exception $ex)
	{
