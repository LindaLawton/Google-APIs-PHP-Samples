...
* @return Announcement
*/
function announcementsGetExample($service, $courseId, $id, $optParams)
{
	try
	{
		...
		return $service->announcements->GetAnnouncements($courseId, $id, $optParams);
	}
	catch (Exception $e)
	{
