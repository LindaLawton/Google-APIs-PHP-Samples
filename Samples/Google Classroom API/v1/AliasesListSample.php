...
print_r(aliasesListExample($service, $courseId));
...
alias.
* @return ListCourseAliasesResponse</returns>
*/
function aliasesListExample($service, $courseId)
{
	try
	{
		...
		return $service->aliases->ListAliases($courseId);
	}
	catch (Exception $ex)
	{
