...
print_r(studentSubmissionsListExample($service, $courseId, $courseWorkId));
...
alias.
* @return ListStudentSubmissionsResponse</returns>
*/
function studentSubmissionsListExample($service, $courseId, $courseWorkId)
{
	try
	{
		...
		return $service->studentSubmissions->ListStudentSubmissions($courseId, $courseWorkId);
	}
	catch (Exception $ex)
	{
