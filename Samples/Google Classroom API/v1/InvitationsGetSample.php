...
$results = invitationsGetExample($service, $id, $optParams);
...
* @return Invitation
*/
function invitationsGetExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->invitations->GetInvitations($id, $optParams);
	}
	catch (Exception $e)
	{
