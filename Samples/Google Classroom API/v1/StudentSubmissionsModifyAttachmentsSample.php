...
print_r(studentSubmissionsModifyAttachmentsExample($service, $courseId, $courseWorkId, $id));
...
*/
function studentSubmissionsModifyAttachmentsExample($service, $courseId, $courseWorkId, $id)
{
	try
	{
		...
		return $service->studentSubmissions->ModifyAttachmentsStudentSubmissions($courseId, $courseWorkId, $id);
	}
	catch (Exception $ex)
	{
