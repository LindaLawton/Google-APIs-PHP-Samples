...
# UnOfficial Google Classroom API v1 Samples for PHP

## API Description

Manages classes, rosters, and invitations in Google Classroom.

[Official Documentation](https://developers.google.com/classroom/)

## Sample Description

These samples show how to access the [Google Classroom API v1](https://developers.google.com/classroom/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
