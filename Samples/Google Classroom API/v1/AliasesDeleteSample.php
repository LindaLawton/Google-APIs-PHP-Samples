...
$results = aliasesDeleteExample($service, $courseId, $alias, $optParams);
...
* @return Empty
*/
function aliasesDeleteExample($service, $courseId, $alias, $optParams)
{
	try
	{
		...
		return $service->aliases->DeleteAliases($courseId, $alias, $optParams);
	}
	catch (Exception $e)
	{
