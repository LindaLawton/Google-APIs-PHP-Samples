 ...
 * Initializes an Classroom.v1 service object.
 * @param string API key
 * @return An authorized Classroom.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Classroom Sample");
		...
		// Create authenticated Classroom service
