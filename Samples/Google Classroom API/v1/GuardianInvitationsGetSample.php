...
$results = guardianInvitationsGetExample($service, $studentId, $invitationId, $optParams);
...
*/
function guardianInvitationsGetExample($service, $studentId, $invitationId, $optParams)
{
	try
	{
		...
		return $service->guardianInvitations->GetGuardianInvitations($studentId, $invitationId, $optParams);
	}
	catch (Exception $e)
	{
