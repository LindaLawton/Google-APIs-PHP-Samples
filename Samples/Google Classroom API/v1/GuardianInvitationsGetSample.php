...
print_r(guardianInvitationsGetExample($service, $studentId, $invitationId));
...
*/
function guardianInvitationsGetExample($service, $studentId, $invitationId)
{
	try
	{
		...
		return $service->guardianInvitations->GetGuardianInvitations($studentId, $invitationId);
	}
	catch (Exception $ex)
	{
