...
// Single Request.
$results = studentsGetExample($service, $courseId, $userId, $optParams);
...
* @return Student
*/
function studentsGetExample($service, $courseId, $userId, $optParams)
{
	try
	{
		...
		return $service->students->GetStudents($courseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
