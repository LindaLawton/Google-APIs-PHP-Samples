...
print_r(studentsGetExample($service, $courseId, $userId));
...
* @return Student</returns>
*/
function studentsGetExample($service, $courseId, $userId)
{
	try
	{
		...
		return $service->students->GetStudents($courseId, $userId);
	}
	catch (Exception $ex)
	{
