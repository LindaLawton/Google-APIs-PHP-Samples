...
print_r(invitationsCreateExample($service));
...
* @return Invitation</returns>
*/
function invitationsCreateExample($service)
{
	try
	{
		...
		return $service->invitations->CreateInvitations();
	}
	catch (Exception $ex)
	{
