...
// Single Request.
$results = invitationsCreateExample($service, $optParams);
...
* @return Invitation
*/
function invitationsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->invitations->CreateInvitations($optParams);
	}
	catch (Exception $e)
	{
