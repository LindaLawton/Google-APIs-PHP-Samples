...
// Single Request.
$results = studentsListExample($service, $courseId, $optParams);
...
*/
function studentsListExample($service, $courseId, $optParams)
{
	try
	{
		...
		return $service->students->ListStudents($courseId, $optParams);
	}
	catch (Exception $e)
	{
