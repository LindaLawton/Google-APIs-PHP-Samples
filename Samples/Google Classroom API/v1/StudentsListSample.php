...
print_r(studentsListExample($service, $courseId));
...
alias.
* @return ListStudentsResponse</returns>
*/
function studentsListExample($service, $courseId)
{
	try
	{
		...
		return $service->students->ListStudents($courseId);
	}
	catch (Exception $ex)
	{
