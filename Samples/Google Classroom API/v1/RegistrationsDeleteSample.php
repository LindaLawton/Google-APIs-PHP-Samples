...
$results = registrationsDeleteExample($service, $registrationId, $optParams);
...
* @return Empty
*/
function registrationsDeleteExample($service, $registrationId, $optParams)
{
	try
	{
		...
		if (registrationId == null)
			throw new Exception("registrationId is required.");
		// Make the request and return the results.
		return $service->registrations->DeleteRegistrations($registrationId, $optParams);
	}
	catch (Exception $e)
	{
