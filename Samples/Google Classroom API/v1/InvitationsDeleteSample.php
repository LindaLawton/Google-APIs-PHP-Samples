...
// Single Request.
$results = invitationsDeleteExample($service, $id, $optParams);
...
* @return Empty
*/
function invitationsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->invitations->DeleteInvitations($id, $optParams);
	}
	catch (Exception $e)
	{
