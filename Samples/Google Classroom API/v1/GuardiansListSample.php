...
print_r(guardiansListExample($service, $studentId));
...
* @return ListGuardiansResponse</returns>
*/
function guardiansListExample($service, $studentId)
{
	try
	{
		...
		return $service->guardians->ListGuardians($studentId);
	}
	catch (Exception $ex)
	{
