...
print_r(studentSubmissionsTurnInExample($service, $courseId, $courseWorkId, $id));
...
*/
function studentSubmissionsTurnInExample($service, $courseId, $courseWorkId, $id)
{
	try
	{
		...
		return $service->studentSubmissions->TurnInStudentSubmissions($courseId, $courseWorkId, $id);
	}
	catch (Exception $ex)
	{
