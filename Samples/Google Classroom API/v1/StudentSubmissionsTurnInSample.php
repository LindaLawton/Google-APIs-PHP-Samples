...
// Single Request.
$results = studentSubmissionsTurnInExample($service, $courseId, $courseWorkId, $id, $optParams);
...
* @return Empty
*/
function studentSubmissionsTurnInExample($service, $courseId, $courseWorkId, $id, $optParams)
{
	try
	{
		...
		return $service->studentSubmissions->TurnInStudentSubmissions($courseId, $courseWorkId, $id, $optParams);
	}
	catch (Exception $e)
	{
