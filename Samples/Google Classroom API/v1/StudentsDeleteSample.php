...
// Single Request.
$results = studentsDeleteExample($service, $courseId, $userId, $optParams);
...
* @return Empty
*/
function studentsDeleteExample($service, $courseId, $userId, $optParams)
{
	try
	{
		...
		return $service->students->DeleteStudents($courseId, $userId, $optParams);
	}
	catch (Exception $e)
	{
