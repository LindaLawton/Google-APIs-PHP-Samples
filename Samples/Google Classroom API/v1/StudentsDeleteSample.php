...
print_r(studentsDeleteExample($service, $courseId, $userId));
...
*/
function studentsDeleteExample($service, $courseId, $userId)
{
	try
	{
		...
		return $service->students->DeleteStudents($courseId, $userId);
	}
	catch (Exception $ex)
	{
