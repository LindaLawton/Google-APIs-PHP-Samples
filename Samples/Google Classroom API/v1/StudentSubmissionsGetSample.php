...
print_r(studentSubmissionsGetExample($service, $courseId, $courseWorkId, $id));
...
*/
function studentSubmissionsGetExample($service, $courseId, $courseWorkId, $id)
{
	try
	{
		...
		return $service->studentSubmissions->GetStudentSubmissions($courseId, $courseWorkId, $id);
	}
	catch (Exception $ex)
	{
