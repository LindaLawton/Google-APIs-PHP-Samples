...
# Unoffical Google Classroom API Samples for PHP
...
These samples show how to access the [Google Classroom API](https://developers.google.com/classroom/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
