...
print_r(compositeTypesUpdateExample($service, $project, $compositeType));
...
*/
function compositeTypesUpdateExample($service, $project, $compositeType)
{
	try
	{
		...
		return $service->compositeTypes->UpdateCompositeTypes($project, $compositeType);
	}
	catch (Exception $ex)
	{
