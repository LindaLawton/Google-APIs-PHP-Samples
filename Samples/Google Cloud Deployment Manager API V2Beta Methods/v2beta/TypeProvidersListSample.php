...
print_r(typeProvidersListExample($service, $project));

/**
* Lists all resource type providers for Deployment Manager.
* @service Authenticated Deploymentmanagerv2beta service.
* @project The project ID for this request.
* @return TypeProvidersListResponse</returns>
*/
function typeProvidersListExample($service, $project)
{
	try
	{
		...
		return $service->typeProviders->ListTypeProviders($project);
	}
	catch (Exception $ex)
	{
