...
$results = typeProvidersListExample($service, $project, $optParams);
...
*/
function typeProvidersListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->typeProviders->ListTypeProviders($project, $optParams);
	}
	catch (Exception $e)
	{
