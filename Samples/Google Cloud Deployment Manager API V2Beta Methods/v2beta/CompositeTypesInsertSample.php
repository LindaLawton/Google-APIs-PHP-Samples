...
print_r(compositeTypesInsertExample($service, $project));
...
*/
function compositeTypesInsertExample($service, $project)
{
	try
	{
		...
		return $service->compositeTypes->InsertCompositeTypes($project);
	}
	catch (Exception $ex)
	{
