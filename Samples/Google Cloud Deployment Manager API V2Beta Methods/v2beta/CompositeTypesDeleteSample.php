...
print_r(compositeTypesDeleteExample($service, $project, $compositeType));
...
*/
function compositeTypesDeleteExample($service, $project, $compositeType)
{
	try
	{
		...
		return $service->compositeTypes->DeleteCompositeTypes($project, $compositeType);
	}
	catch (Exception $ex)
	{
