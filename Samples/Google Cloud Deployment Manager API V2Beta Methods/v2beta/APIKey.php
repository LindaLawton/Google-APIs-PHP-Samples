...
// About 
// 
// Unofficial sample for the Deploymentmanagerv2beta v2beta API for PHP. 
 ...
 * Initializes an Deploymentmanagerv2beta.v2beta service object.
 * @param string API key
 * @return An authorized Deploymentmanagerv2beta.v2beta service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Deploymentmanagerv2beta Sample");
		...
		// Create authenticated Deploymentmanagerv2beta service
		return new Google_Service_Deploymentmanagerv2beta($client);
	} catch (Exception $e) {
