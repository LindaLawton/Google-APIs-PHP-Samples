...
// Single Request.
$results = compositeTypesListExample($service, $project, $optParams);
...
*/
function compositeTypesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->compositeTypes->ListCompositeTypes($project, $optParams);
	}
	catch (Exception $e)
	{
