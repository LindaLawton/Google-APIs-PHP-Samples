...
// Single Request.
$results = typeProvidersUpdateExample($service, $project, $typeProvider, $optParams);
...
* @return Operation
*/
function typeProvidersUpdateExample($service, $project, $typeProvider, $optParams)
{
	try
	{
		...
		return $service->typeProviders->UpdateTypeProviders($project, $typeProvider, $optParams);
	}
	catch (Exception $e)
	{
