...
// Single Request.
$results = typeProvidersDeleteExample($service, $project, $typeProvider, $optParams);
...
* @return Operation
*/
function typeProvidersDeleteExample($service, $project, $typeProvider, $optParams)
{
	try
	{
		...
		return $service->typeProviders->DeleteTypeProviders($project, $typeProvider, $optParams);
	}
	catch (Exception $e)
	{
