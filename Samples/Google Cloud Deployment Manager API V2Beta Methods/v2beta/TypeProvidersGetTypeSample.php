...
print_r(typeProvidersGetTypeExample($service, $project, $typeProvider, $type));
...
* @return TypeInfo</returns>
*/
function typeProvidersGetTypeExample($service, $project, $typeProvider, $type)
{
	try
	{
		...
		return $service->typeProviders->GetTypeTypeProviders($project, $typeProvider, $type);
	}
	catch (Exception $ex)
	{
