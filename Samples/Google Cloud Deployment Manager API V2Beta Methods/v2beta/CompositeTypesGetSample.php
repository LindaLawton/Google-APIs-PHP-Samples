...
// Single Request.
$results = compositeTypesGetExample($service, $project, $compositeType, $optParams);
...
*/
function compositeTypesGetExample($service, $project, $compositeType, $optParams)
{
	try
	{
		...
		return $service->compositeTypes->GetCompositeTypes($project, $compositeType, $optParams);
	}
	catch (Exception $e)
	{
