...
// Single Request.
$results = projectsImportExample($service, $projectId, $optParams);
...
*/
function projectsImportExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->ImportProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
