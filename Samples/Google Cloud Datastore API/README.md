...
# Unoffical Google Cloud Datastore API Samples for PHP
...
These samples show how to access the [Google Cloud Datastore API](https://cloud.google.com/datastore/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
