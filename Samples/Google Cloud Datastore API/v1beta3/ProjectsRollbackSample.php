...
print_r(projectsRollbackExample($service, $projectId));

/**
* Rolls back a transaction.
* @service Authenticated Datastore service.
* @projectId The ID of the project against which to make the request.
* @return RollbackResponse</returns>
*/
function projectsRollbackExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->RollbackProjects($projectId);
	}
	catch (Exception $ex)
	{
