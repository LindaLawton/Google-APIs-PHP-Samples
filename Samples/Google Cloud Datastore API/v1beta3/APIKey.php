...
// About 
// 
// Unofficial sample for the Datastore v1beta3 API for PHP. 
 ...
 * Initializes an Datastore.v1beta3 service object.
 * @param string API key
 * @return An authorized Datastore.v1beta3 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Datastore Sample");
		...
		// Create authenticated Datastore service
