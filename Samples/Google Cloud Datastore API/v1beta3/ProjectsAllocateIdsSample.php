...
print_r(projectsAllocateIdsExample($service, $projectId));
...
* @return AllocateIdsResponse</returns>
*/
function projectsAllocateIdsExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->AllocateIdsProjects($projectId);
	}
	catch (Exception $ex)
	{
