...
// Single Request.
$results = projectsAllocateIdsExample($service, $projectId, $optParams);
...
*/
function projectsAllocateIdsExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->AllocateIdsProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
