...
// Single Request.
$results = projectsCommitExample($service, $projectId, $optParams);
...
*/
function projectsCommitExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->CommitProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
