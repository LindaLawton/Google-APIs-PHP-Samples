...
# UnOfficial Google Cloud Datastore API v1beta3 Samples for PHP
...
These samples show how to access the [Google Cloud Datastore API v1beta3](https://cloud.google.com/datastore/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
