...
print_r(projectsRunQueryExample($service, $projectId));

/**
* Queries for entities.
* @service Authenticated Datastore service.
* @projectId The ID of the project against which to make the request.
* @return RunQueryResponse</returns>
*/
function projectsRunQueryExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->RunQueryProjects($projectId);
	}
	catch (Exception $ex)
	{
