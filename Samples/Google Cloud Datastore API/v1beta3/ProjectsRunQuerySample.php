...
// Single Request.
$results = projectsRunQueryExample($service, $projectId, $optParams);
...
*/
function projectsRunQueryExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->RunQueryProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
