...
// Single Request.
$results = projectsLookupExample($service, $projectId, $optParams);
...
*/
function projectsLookupExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->LookupProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
