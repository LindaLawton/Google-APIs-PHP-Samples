...
print_r(projectsLookupExample($service, $projectId));

/**
* Looks up entities by key.
* @service Authenticated Datastore service.
* @projectId The ID of the project against which to make the request.
* @return LookupResponse</returns>
*/
function projectsLookupExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->LookupProjects($projectId);
	}
	catch (Exception $ex)
	{
