...
print_r(projectsBeginTransactionExample($service, $projectId));

/**
* Begins a new transaction.
* @service Authenticated Datastore service.
* @projectId The ID of the project against which to make the request.
* @return BeginTransactionResponse</returns>
*/
function projectsBeginTransactionExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->BeginTransactionProjects($projectId);
	}
	catch (Exception $ex)
	{
