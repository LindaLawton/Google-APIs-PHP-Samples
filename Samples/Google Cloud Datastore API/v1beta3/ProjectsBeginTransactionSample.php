...
// Single Request.
$results = projectsBeginTransactionExample($service, $projectId, $optParams);
...
*/
function projectsBeginTransactionExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->BeginTransactionProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
