...
print_r(callsetsSearchExample($service));
...
* @return SearchCallSetsResponse</returns>
*/
function callsetsSearchExample($service)
{
	try
	{
		...
		return $service->callsets->SearchCallsets();
	}
	catch (Exception $ex)
	{
