...
// Single Request.
$results = variantsetsSearchExample($service, $optParams);
...
*/
function variantsetsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->variantsets->SearchVariantsets($optParams);
	}
	catch (Exception $e)
	{
