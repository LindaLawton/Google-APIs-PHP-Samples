...
print_r(variantsetsSearchExample($service));
...
* @return SearchVariantSetsResponse</returns>
*/
function variantsetsSearchExample($service)
{
	try
	{
		...
		return $service->variantsets->SearchVariantsets();
	}
	catch (Exception $ex)
	{
