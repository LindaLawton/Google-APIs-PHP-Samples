...
// Single Request.
$results = variantsetsCreateExample($service, $optParams);
...
* @return VariantSet
*/
function variantsetsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->variantsets->CreateVariantsets($optParams);
	}
	catch (Exception $e)
	{
