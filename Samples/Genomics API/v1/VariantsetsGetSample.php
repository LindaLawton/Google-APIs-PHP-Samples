...
// Single Request.
$results = variantsetsGetExample($service, $variantSetId, $optParams);
...
* @return VariantSet
*/
function variantsetsGetExample($service, $variantSetId, $optParams)
{
	try
	{
		...
		return $service->variantsets->GetVariantsets($variantSetId, $optParams);
	}
	catch (Exception $e)
	{
