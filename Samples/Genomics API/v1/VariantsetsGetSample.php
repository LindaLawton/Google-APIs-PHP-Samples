...
print_r(variantsetsGetExample($service, $variantSetId));
...
*/
function variantsetsGetExample($service, $variantSetId)
{
	try
	{
		...
		return $service->variantsets->GetVariantsets($variantSetId);
	}
	catch (Exception $ex)
	{
