...
print_r(annotationsDeleteExample($service, $annotationId));
...
*/
function annotationsDeleteExample($service, $annotationId)
{
	try
	{
		...
		return $service->annotations->DeleteAnnotations($annotationId);
	}
	catch (Exception $ex)
	{
