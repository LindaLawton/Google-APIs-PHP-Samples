...
// Single Request.
$results = annotationsSearchExample($service, $optParams);
...
*/
function annotationsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->annotations->SearchAnnotations($optParams);
	}
	catch (Exception $e)
	{
