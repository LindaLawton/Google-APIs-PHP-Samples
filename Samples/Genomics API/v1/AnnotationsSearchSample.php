...
print_r(annotationsSearchExample($service));
...
* @return SearchAnnotationsResponse</returns>
*/
function annotationsSearchExample($service)
{
	try
	{
		...
		return $service->annotations->SearchAnnotations();
	}
	catch (Exception $ex)
	{
