...
// Single Request.
$results = annotationsetsCreateExample($service, $optParams);
...
*/
function annotationsetsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->annotationsets->CreateAnnotationsets($optParams);
	}
	catch (Exception $e)
	{
