...
print_r(annotationsGetExample($service, $annotationId));
...
*/
function annotationsGetExample($service, $annotationId)
{
	try
	{
		...
		return $service->annotations->GetAnnotations($annotationId);
	}
	catch (Exception $ex)
	{
