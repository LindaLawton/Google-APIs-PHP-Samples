...
$results = annotationsGetExample($service, $annotationId, $optParams);
...
* @return Annotation
*/
function annotationsGetExample($service, $annotationId, $optParams)
{
	try
	{
		...
		return $service->annotations->GetAnnotations($annotationId, $optParams);
	}
	catch (Exception $e)
	{
