...
// Single Request.
$results = datasetsUndeleteExample($service, $datasetId, $optParams);
...
* @return Dataset
*/
function datasetsUndeleteExample($service, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->UndeleteDatasets($datasetId, $optParams);
	}
	catch (Exception $e)
	{
