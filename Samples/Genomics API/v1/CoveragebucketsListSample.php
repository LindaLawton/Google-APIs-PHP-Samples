...
print_r(coveragebucketsListExample($service, $readGroupSetId));
...
*/
function coveragebucketsListExample($service, $readGroupSetId)
{
	try
	{
		...
		return $service->coveragebuckets->ListCoveragebuckets($readGroupSetId);
	}
	catch (Exception $ex)
	{
