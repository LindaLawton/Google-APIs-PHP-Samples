...
// Single Request.
$results = variantsetsExportExample($service, $variantSetId, $optParams);
...
* @return Operation
*/
function variantsetsExportExample($service, $variantSetId, $optParams)
{
	try
	{
		...
		return $service->variantsets->ExportVariantsets($variantSetId, $optParams);
	}
	catch (Exception $e)
	{
