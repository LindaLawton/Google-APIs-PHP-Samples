...
print_r(variantsetsExportExample($service, $variantSetId));
...
*/
function variantsetsExportExample($service, $variantSetId)
{
	try
	{
		...
		return $service->variantsets->ExportVariantsets($variantSetId);
	}
	catch (Exception $ex)
	{
