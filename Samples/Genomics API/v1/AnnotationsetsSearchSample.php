...
print_r(annotationsetsSearchExample($service));
...
* @return SearchAnnotationSetsResponse</returns>
*/
function annotationsetsSearchExample($service)
{
	try
	{
		...
		return $service->annotationsets->SearchAnnotationsets();
	}
	catch (Exception $ex)
	{
