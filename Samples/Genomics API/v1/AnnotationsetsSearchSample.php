...
// Single Request.
$results = annotationsetsSearchExample($service, $optParams);
...
* @return SearchAnnotationSetsResponse
*/
function annotationsetsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->annotationsets->SearchAnnotationsets($optParams);
	}
	catch (Exception $e)
	{
