...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  //An optional mask specifying which fields to update. At this time, mutablefields are names andinfo. Acceptable values are "names" and"info". If unspecified, all mutable fields will be updated.
  'fields' => '*'
);
// Single Request.
$results = variantsPatchExample($service, $variantId, $optParams);
...
* @return Variant
*/
function variantsPatchExample($service, $variantId, $optParams)
{
	try
	{
		...
		if (variantId == null)
			throw new Exception("variantId is required.");
		// Make the request and return the results.
		return $service->variants->PatchVariants($variantId, $optParams);
	}
	catch (Exception $e)
	{
