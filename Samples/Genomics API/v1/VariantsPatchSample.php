...
print_r(variantsPatchExample($service, $variantId));
...
* @return Variant</returns>
*/
function variantsPatchExample($service, $variantId)
{
	try
	{
		...
		return $service->variants->PatchVariants($variantId);
	}
	catch (Exception $ex)
	{
