...
// Single Request.
$results = datasetsDeleteExample($service, $datasetId, $optParams);
...
* @return Empty
*/
function datasetsDeleteExample($service, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->DeleteDatasets($datasetId, $optParams);
	}
	catch (Exception $e)
	{
