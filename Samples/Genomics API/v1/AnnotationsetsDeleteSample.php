...
print_r(annotationsetsDeleteExample($service, $annotationSetId));
...
*/
function annotationsetsDeleteExample($service, $annotationSetId)
{
	try
	{
		...
		return $service->annotationsets->DeleteAnnotationsets($annotationSetId);
	}
	catch (Exception $ex)
	{
