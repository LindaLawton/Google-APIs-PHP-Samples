...
// Single Request.
$results = annotationsetsDeleteExample($service, $annotationSetId, $optParams);
...
* @return Empty
*/
function annotationsetsDeleteExample($service, $annotationSetId, $optParams)
{
	try
	{
		...
		return $service->annotationsets->DeleteAnnotationsets($annotationSetId, $optParams);
	}
	catch (Exception $e)
	{
