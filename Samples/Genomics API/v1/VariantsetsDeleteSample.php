...
print_r(variantsetsDeleteExample($service, $variantSetId));
...
*/
function variantsetsDeleteExample($service, $variantSetId)
{
	try
	{
		...
		return $service->variantsets->DeleteVariantsets($variantSetId);
	}
	catch (Exception $ex)
	{
