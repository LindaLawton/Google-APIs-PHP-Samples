...
// Single Request.
$results = readsSearchExample($service, $optParams);
...
* @return SearchReadsResponse
*/
function readsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->reads->SearchReads($optParams);
	}
	catch (Exception $e)
	{
