...
$results = variantsDeleteExample($service, $variantId, $optParams);
...
* @return Empty
*/
function variantsDeleteExample($service, $variantId, $optParams)
{
	try
	{
		...
		return $service->variants->DeleteVariants($variantId, $optParams);
	}
	catch (Exception $e)
	{
