...
print_r(annotationsBatchCreateExample($service));
...
* @return BatchCreateAnnotationsResponse</returns>
*/
function annotationsBatchCreateExample($service)
{
	try
	{
		...
		return $service->annotations->BatchCreateAnnotations();
	}
	catch (Exception $ex)
	{
