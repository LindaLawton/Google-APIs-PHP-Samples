...
$results = annotationsBatchCreateExample($service, $optParams);
...
* @return BatchCreateAnnotationsResponse
*/
function annotationsBatchCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->annotations->BatchCreateAnnotations($optParams);
	}
	catch (Exception $e)
	{
