...
print_r(datasetsGetIamPolicyExample($service, $resource));
...
*/
function datasetsGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->datasets->GetIamPolicyDatasets($resource);
	}
	catch (Exception $ex)
	{
