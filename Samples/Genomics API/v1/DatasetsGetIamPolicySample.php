...
// Single Request.
$results = datasetsGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function datasetsGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->datasets->GetIamPolicyDatasets($resource, $optParams);
	}
	catch (Exception $e)
	{
