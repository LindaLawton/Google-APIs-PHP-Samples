...
print_r(annotationsUpdateExample($service, $annotationId));
...
* @return Annotation</returns>
*/
function annotationsUpdateExample($service, $annotationId)
{
	try
	{
		...
		return $service->annotations->UpdateAnnotations($annotationId);
	}
	catch (Exception $ex)
	{
