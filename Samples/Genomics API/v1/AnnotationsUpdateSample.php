...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  //An optional mask specifying which fields to update. Mutable fields arename,variant,transcript, andinfo. If unspecified, all mutablefields will be updated.
  'fields' => '*'
);
// Single Request.
$results = annotationsUpdateExample($service, $annotationId, $optParams);
...
* @return Annotation
*/
function annotationsUpdateExample($service, $annotationId, $optParams)
{
	try
	{
		...
		return $service->annotations->UpdateAnnotations($annotationId, $optParams);
	}
	catch (Exception $e)
	{
