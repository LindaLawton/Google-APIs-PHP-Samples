...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  // An optional mask specifying which fields to update. Mutable fields arename,source_uri, andinfo. If unspecified, allmutable fields will be updated.
  'fields' => '*'
);
// Single Request.
$results = annotationsetsUpdateExample($service, $annotationSetId, $optParams);
...
*/
function annotationsetsUpdateExample($service, $annotationSetId, $optParams)
{
	try
	{
		...
		if (annotationSetId == null)
			throw new Exception("annotationSetId is required.");
		// Make the request and return the results.
		return $service->annotationsets->UpdateAnnotationsets($annotationSetId, $optParams);
	}
	catch (Exception $e)
	{
