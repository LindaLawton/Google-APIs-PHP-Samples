...
print_r(annotationsetsUpdateExample($service, $annotationSetId));
...
* @return AnnotationSet</returns>
*/
function annotationsetsUpdateExample($service, $annotationSetId)
{
	try
	{
		...
		return $service->annotationsets->UpdateAnnotationsets($annotationSetId);
	}
	catch (Exception $ex)
	{
