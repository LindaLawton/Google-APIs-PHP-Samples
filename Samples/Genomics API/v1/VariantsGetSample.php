...
$results = variantsGetExample($service, $variantId, $optParams);
...
* @return Variant
*/
function variantsGetExample($service, $variantId, $optParams)
{
	try
	{
		...
		return $service->variants->GetVariants($variantId, $optParams);
	}
	catch (Exception $e)
	{
