...
print_r(datasetsTestIamPermissionsExample($service, $resource));
...
*/
function datasetsTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->datasets->TestIamPermissionsDatasets($resource);
	}
	catch (Exception $ex)
	{
