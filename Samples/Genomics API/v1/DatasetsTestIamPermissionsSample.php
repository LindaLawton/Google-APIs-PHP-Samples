...
// Single Request.
$results = datasetsTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function datasetsTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->datasets->TestIamPermissionsDatasets($resource, $optParams);
	}
	catch (Exception $e)
	{
