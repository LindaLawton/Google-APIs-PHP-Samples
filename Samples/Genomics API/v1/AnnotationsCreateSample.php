...
$results = annotationsCreateExample($service, $optParams);
...
* @return Annotation
*/
function annotationsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->annotations->CreateAnnotations($optParams);
	}
	catch (Exception $e)
	{
