...
print_r(referencesetsGetExample($service, $referenceSetId));
...
* @return ReferenceSet</returns>
*/
function referencesetsGetExample($service, $referenceSetId)
{
	try
	{
		...
		return $service->referencesets->GetReferencesets($referenceSetId);
	}
	catch (Exception $ex)
	{
