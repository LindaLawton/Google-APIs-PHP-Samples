...
// Single Request.
$results = referencesetsGetExample($service, $referenceSetId, $optParams);
...
* @return ReferenceSet
*/
function referencesetsGetExample($service, $referenceSetId, $optParams)
{
	try
	{
		...
		if (referenceSetId == null)
			throw new Exception("referenceSetId is required.");
		// Make the request and return the results.
		return $service->referencesets->GetReferencesets($referenceSetId, $optParams);
	}
	catch (Exception $e)
	{
