...
print_r(datasetsSetIamPolicyExample($service, $resource));
...
*/
function datasetsSetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->datasets->SetIamPolicyDatasets($resource);
	}
	catch (Exception $ex)
	{
