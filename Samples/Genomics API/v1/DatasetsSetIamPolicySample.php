...
// Single Request.
$results = datasetsSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function datasetsSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->datasets->SetIamPolicyDatasets($resource, $optParams);
	}
	catch (Exception $e)
	{
