...
print_r(variantsSearchExample($service));
...
* @return SearchVariantsResponse</returns>
*/
function variantsSearchExample($service)
{
	try
	{
		...
		return $service->variants->SearchVariants();
	}
	catch (Exception $ex)
	{
