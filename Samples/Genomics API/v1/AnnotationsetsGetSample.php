...
print_r(annotationsetsGetExample($service, $annotationSetId));
...
*/
function annotationsetsGetExample($service, $annotationSetId)
{
	try
	{
		...
		return $service->annotationsets->GetAnnotationsets($annotationSetId);
	}
	catch (Exception $ex)
	{
