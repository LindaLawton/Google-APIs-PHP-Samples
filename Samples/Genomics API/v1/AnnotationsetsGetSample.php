...
// Single Request.
$results = annotationsetsGetExample($service, $annotationSetId, $optParams);
...
*/
function annotationsetsGetExample($service, $annotationSetId, $optParams)
{
	try
	{
		...
		return $service->annotationsets->GetAnnotationsets($annotationSetId, $optParams);
	}
	catch (Exception $e)
	{
