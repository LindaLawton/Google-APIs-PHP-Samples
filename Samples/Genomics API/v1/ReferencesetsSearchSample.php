...
// Single Request.
$results = referencesetsSearchExample($service, $optParams);
...
* @return SearchReferenceSetsResponse
*/
function referencesetsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->referencesets->SearchReferencesets($optParams);
	}
	catch (Exception $e)
	{
