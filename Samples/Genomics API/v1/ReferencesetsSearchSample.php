...
print_r(referencesetsSearchExample($service));
...
* @return SearchReferenceSetsResponse</returns>
*/
function referencesetsSearchExample($service)
{
	try
	{
		...
		return $service->referencesets->SearchReferencesets();
	}
	catch (Exception $ex)
	{
