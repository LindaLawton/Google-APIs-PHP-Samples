...
print_r(basesListExample($service, $referenceId));
...
* @return ListBasesResponse</returns>
*/
function basesListExample($service, $referenceId)
{
	try
	{
		...
		return $service->bases->ListBases($referenceId);
	}
	catch (Exception $ex)
	{
