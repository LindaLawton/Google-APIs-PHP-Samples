...
// Single Request.
$results = datasetsGetExample($service, $datasetId, $optParams);
...
* @return Dataset
*/
function datasetsGetExample($service, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->GetDatasets($datasetId, $optParams);
	}
	catch (Exception $e)
	{
