...
print_r(variantsetsPatchExample($service, $variantSetId));
...
* @return VariantSet</returns>
*/
function variantsetsPatchExample($service, $variantSetId)
{
	try
	{
		...
		return $service->variantsets->PatchVariantsets($variantSetId);
	}
	catch (Exception $ex)
	{
