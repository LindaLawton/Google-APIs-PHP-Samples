...
// Single Request.
$results = callsetsPatchExample($service, $callSetId, $optParams);
...
* @return CallSet
*/
function callsetsPatchExample($service, $callSetId, $optParams)
{
	try
	{
		...
		return $service->callsets->PatchCallsets($callSetId, $optParams);
	}
	catch (Exception $e)
	{
