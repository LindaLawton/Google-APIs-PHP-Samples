...
// Single Request.
$results = pipelinesDeleteExample($service, $pipelineId, $optParams);
...
* @pipelineId Caller must have WRITE access to the project in which this pipeline
is defined.
* @return Empty
*/
function pipelinesDeleteExample($service, $pipelineId, $optParams)
{
	try
	{
		...
		if (pipelineId == null)
			throw new Exception("pipelineId is required.");
		// Make the request and return the results.
		return $service->pipelines->DeletePipelines($pipelineId, $optParams);
	}
	catch (Exception $e)
	{
