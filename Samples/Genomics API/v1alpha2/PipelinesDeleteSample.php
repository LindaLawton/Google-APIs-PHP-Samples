...
print_r(pipelinesDeleteExample($service, $pipelineId));
...
*/
function pipelinesDeleteExample($service, $pipelineId)
{
	try
	{
		...
		return $service->pipelines->DeletePipelines($pipelineId);
	}
	catch (Exception $ex)
	{
