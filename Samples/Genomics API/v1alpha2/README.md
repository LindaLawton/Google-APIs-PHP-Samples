...
# UnOfficial Genomics API v1alpha2 Samples for PHP

## API Description

Upload, process, query, and search Genomics data in the cloud.

[Official Documentation](https://cloud.google.com/genomics)

## Sample Description

These samples show how to access the [Genomics API v1alpha2](https://cloud.google.com/genomics) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
