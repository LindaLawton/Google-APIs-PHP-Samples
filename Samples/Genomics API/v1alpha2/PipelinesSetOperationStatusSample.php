...
$results = pipelinesSetOperationStatusExample($service, $optParams);
...
* @return Empty
*/
function pipelinesSetOperationStatusExample($service, $optParams)
{
	try
	{
		...
		return $service->pipelines->SetOperationStatusPipelines($optParams);
	}
	catch (Exception $e)
	{
