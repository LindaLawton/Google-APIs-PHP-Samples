...
print_r(pipelinesSetOperationStatusExample($service));
...
*/
function pipelinesSetOperationStatusExample($service)
{
	try
	{
		...
		return $service->pipelines->SetOperationStatusPipelines();
	}
	catch (Exception $ex)
	{
