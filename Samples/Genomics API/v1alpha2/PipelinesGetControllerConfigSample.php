...
print_r(pipelinesGetControllerConfigExample($service));
...
* @return ControllerConfig</returns>
*/
function pipelinesGetControllerConfigExample($service)
{
	try
	{
		...
		return $service->pipelines->GetControllerConfigPipelines();
	}
	catch (Exception $ex)
	{
