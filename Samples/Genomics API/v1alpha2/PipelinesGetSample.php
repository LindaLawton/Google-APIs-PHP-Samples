...
// Single Request.
$results = pipelinesGetExample($service, $pipelineId, $optParams);
...
* @pipelineId Caller must have READ access to the project in which this pipeline
is defined.
* @return Pipeline
*/
function pipelinesGetExample($service, $pipelineId, $optParams)
{
	try
	{
		...
		return $service->pipelines->GetPipelines($pipelineId, $optParams);
	}
	catch (Exception $e)
	{
