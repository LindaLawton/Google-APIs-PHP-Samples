 ...
 * Initializes an Genomics.v1alpha2 service object.
 * @param string API key
 * @return An authorized Genomics.v1alpha2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Genomics Sample");
		...
		// Create authenticated Genomics service
		return new Google_Service_Genomics($client);
	} catch (Exception $e) {
