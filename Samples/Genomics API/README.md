...
# Unoffical Genomics API Samples for PHP
...
These samples show how to access the [Genomics API](https://cloud.google.com/genomics) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
