 ...
 * Initializes an Script.v1 service object.
 * @param string API key
 * @return An authorized Script.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Script Sample");
		...
		// Create authenticated Script service
