...
# UnOfficial Google Apps Script Execution API v1 Samples for PHP

## API Description

Executes functions in Google Apps Script projects.

[Official Documentation](https://developers.google.com/apps-script/execution/rest/v1/scripts/run)

## Sample Description

These samples show how to access the [Google Apps Script Execution API v1](https://developers.google.com/apps-script/execution/rest/v1/scripts/run) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
