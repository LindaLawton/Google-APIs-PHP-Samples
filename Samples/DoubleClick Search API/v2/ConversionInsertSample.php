...
// Single Request.
$results = conversionInsertExample($service, $optParams);
...
*/
function conversionInsertExample($service, $optParams)
{
	try
	{
		...
		return $service->conversion->InsertConversion($optParams);
	}
	catch (Exception $e)
	{
