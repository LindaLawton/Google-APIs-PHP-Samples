...
print_r(conversionUpdateAvailabilityExample($service));

/**
* Updates the availabilities of a batch of floodlight activities in DoubleClick Search.
* @service Authenticated Doubleclicksearch service.
* @return UpdateAvailabilityResponse</returns>
*/
function conversionUpdateAvailabilityExample($service)
{
	try
	{
		...
		return $service->conversion->UpdateAvailabilityConversion();
	}
	catch (Exception $ex)
	{
