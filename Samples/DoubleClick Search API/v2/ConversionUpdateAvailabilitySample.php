...
// Single Request.
$results = conversionUpdateAvailabilityExample($service, $optParams);
...
*/
function conversionUpdateAvailabilityExample($service, $optParams)
{
	try
	{
		...
		return $service->conversion->UpdateAvailabilityConversion($optParams);
	}
	catch (Exception $e)
	{
