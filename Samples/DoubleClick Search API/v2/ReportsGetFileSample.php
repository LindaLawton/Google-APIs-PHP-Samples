...
print_r(reportsGetFileExample($service, $reportId, $reportFragment));
...
*/
function reportsGetFileExample($service, $reportId, $reportFragment)
{
	try
	{
		...
		if (reportFragment == null)
			throw new Exception("reportFragment is required.");
		if (reportId == null)
			throw new Exception("reportId is required.");
		// Make the request and return the results.
		return $service->reports->GetFileReports($reportId, $reportFragment);
	}
	catch (Exception $ex)
	{
