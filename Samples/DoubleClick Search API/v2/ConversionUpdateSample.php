...
// Single Request.
$results = conversionUpdateExample($service, $optParams);
...
*/
function conversionUpdateExample($service, $optParams)
{
	try
	{
		...
		return $service->conversion->UpdateConversion($optParams);
	}
	catch (Exception $e)
	{
