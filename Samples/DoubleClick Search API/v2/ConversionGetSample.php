...
*/
function conversionGetExample($service, $agencyId, $advertiserId, $engineAccountId, $endDate, $rowCount, $startDate, $startRow, $optParams)
{
	try
	{
		...
		return $service->conversion->GetConversion($agencyId, $advertiserId, $engineAccountId, $endDate, $rowCount, $startDate, $startRow, $optParams);
	}
	catch (Exception $e)
	{
