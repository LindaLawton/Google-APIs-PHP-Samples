...
print_r(conversionPatchExample($service, $advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow));
...
*/
function conversionPatchExample($service, $advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow)
{
	try
	{
		...
		return $service->conversion->PatchConversion($advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow);
	}
	catch (Exception $ex)
	{
