...
print_r(patch($service, $advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow));
...
*/
function patch($service, $advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow)
{
	try
	{
		...
		return $service->patch($advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow);
	}
	catch (Exception $ex)
	{
