...
// Single Request.
$results = conversionPatchExample($service, $advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow, $optParams);
...
*/
function conversionPatchExample($service, $advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow, $optParams)
{
	try
	{
		...
		return $service->conversion->PatchConversion($advertiserId, $agencyId, $endDate, $engineAccountId, $rowCount, $startDate, $startRow, $optParams);
	}
	catch (Exception $e)
	{
