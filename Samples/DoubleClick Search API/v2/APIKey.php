 ...
 * Initializes an Doubleclicksearch.v2 service object.
 * @param string API key
 * @return An authorized Doubleclicksearch.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Doubleclicksearch Sample");
		...
		// Create authenticated Doubleclicksearch service
		return new Google_Service_Doubleclicksearch($client);
	} catch (Exception $e) {
