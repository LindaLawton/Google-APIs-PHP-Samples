...
// Single Request.
$results = reportsGetExample($service, $reportId, $optParams);
...
* @return Report
*/
function reportsGetExample($service, $reportId, $optParams)
{
	try
	{
		...
		return $service->reports->GetReports($reportId, $optParams);
	}
	catch (Exception $e)
	{
