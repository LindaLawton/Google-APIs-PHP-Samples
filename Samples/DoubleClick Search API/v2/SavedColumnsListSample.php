...
// Single Request.
$results = savedColumnsListExample($service, $agencyId, $advertiserId, $optParams);
...
*/
function savedColumnsListExample($service, $agencyId, $advertiserId, $optParams)
{
	try
	{
		...
		return $service->savedColumns->ListSavedColumns($agencyId, $advertiserId, $optParams);
	}
	catch (Exception $e)
	{
