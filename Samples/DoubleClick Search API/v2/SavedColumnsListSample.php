...
print_r(savedColumnsListExample($service, $agencyId, $advertiserId));
...
* @return SavedColumnList</returns>
*/
function savedColumnsListExample($service, $agencyId, $advertiserId)
{
	try
	{
		...
		return $service->savedColumns->ListSavedColumns($agencyId, $advertiserId);
	}
	catch (Exception $ex)
	{
