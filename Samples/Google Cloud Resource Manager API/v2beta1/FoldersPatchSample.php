...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  // Fields to be updated.Only the `display_name` can be updated.
  'fields' => '*'
);
// Single Request.
$results = foldersPatchExample($service, $name, $optParams);
...
* @return Folder
*/
function foldersPatchExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->folders->PatchFolders($name, $optParams);
	}
	catch (Exception $e)
	{
