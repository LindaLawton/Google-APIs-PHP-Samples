...
// Single Request.
$results = foldersUndeleteExample($service, $name, $optParams);
...
* @return Folder
*/
function foldersUndeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->folders->UndeleteFolders($name, $optParams);
	}
	catch (Exception $e)
	{
