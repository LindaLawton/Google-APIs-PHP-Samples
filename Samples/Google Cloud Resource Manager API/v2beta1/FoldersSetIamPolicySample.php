...
print_r(foldersSetIamPolicyExample($service, $resource));
...
*/
function foldersSetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->folders->SetIamPolicyFolders($resource);
	}
	catch (Exception $ex)
	{
