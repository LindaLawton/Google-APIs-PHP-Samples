...
$results = foldersSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function foldersSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->SetIamPolicyFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
