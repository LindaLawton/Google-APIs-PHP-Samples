...
$results = foldersGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function foldersGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->GetIamPolicyFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
