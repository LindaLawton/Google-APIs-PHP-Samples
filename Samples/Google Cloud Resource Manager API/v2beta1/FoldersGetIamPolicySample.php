...
print_r(foldersGetIamPolicyExample($service, $resource));
...
*/
function foldersGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->folders->GetIamPolicyFolders($resource);
	}
	catch (Exception $ex)
	{
