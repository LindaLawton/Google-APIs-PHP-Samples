...
$results = foldersDeleteExample($service, $name, $optParams);
...
* @return Folder
*/
function foldersDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->folders->DeleteFolders($name, $optParams);
	}
	catch (Exception $e)
	{
