...
// Single Request.
$results = foldersTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function foldersTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->TestIamPermissionsFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
