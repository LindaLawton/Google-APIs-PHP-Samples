...
print_r(foldersTestIamPermissionsExample($service, $resource));
...
*/
function foldersTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->folders->TestIamPermissionsFolders($resource);
	}
	catch (Exception $ex)
	{
