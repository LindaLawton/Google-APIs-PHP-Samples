...
# UnOfficial Google Cloud Resource Manager API v2beta1 Samples for PHP
...
These samples show how to access the [Google Cloud Resource Manager API v2beta1](https://cloud.google.com/resource-manager) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
