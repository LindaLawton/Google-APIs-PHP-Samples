...
print_r(projectsClearOrgPolicyExample($service, $resource));
...
*/
function projectsClearOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->projects->ClearOrgPolicyProjects($resource);
	}
	catch (Exception $ex)
	{
