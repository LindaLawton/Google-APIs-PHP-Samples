...
$results = projectsClearOrgPolicyExample($service, $resource, $optParams);
...
* @return Empty
*/
function projectsClearOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->ClearOrgPolicyProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
