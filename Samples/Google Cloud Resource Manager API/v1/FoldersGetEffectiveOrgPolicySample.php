...
print_r(foldersGetEffectiveOrgPolicyExample($service, $resource));
...
*/
function foldersGetEffectiveOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->folders->GetEffectiveOrgPolicyFolders($resource);
	}
	catch (Exception $ex)
	{
