...
// Single Request.
$results = foldersGetEffectiveOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function foldersGetEffectiveOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->GetEffectiveOrgPolicyFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
