...
// Single Request.
$results = organizationsTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function organizationsTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->TestIamPermissionsOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
