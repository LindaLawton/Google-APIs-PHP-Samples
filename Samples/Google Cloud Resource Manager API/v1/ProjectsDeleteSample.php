...
// Single Request.
$results = projectsDeleteExample($service, $projectId, $optParams);
...
* @return Empty
*/
function projectsDeleteExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->DeleteProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
