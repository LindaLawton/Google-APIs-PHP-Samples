...
$results = projectsGetAncestryExample($service, $projectId, $optParams);
...
*/
function projectsGetAncestryExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->GetAncestryProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
