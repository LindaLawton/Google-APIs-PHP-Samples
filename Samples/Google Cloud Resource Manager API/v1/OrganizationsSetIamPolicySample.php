...
print_r(organizationsSetIamPolicyExample($service, $resource));
...
*/
function organizationsSetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->SetIamPolicyOrganizations($resource);
	}
	catch (Exception $ex)
	{
