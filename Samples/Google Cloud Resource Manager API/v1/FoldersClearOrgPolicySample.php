...
print_r(foldersClearOrgPolicyExample($service, $resource));
...
*/
function foldersClearOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->folders->ClearOrgPolicyFolders($resource);
	}
	catch (Exception $ex)
	{
