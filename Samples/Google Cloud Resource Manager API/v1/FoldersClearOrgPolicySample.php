...
// Single Request.
$results = foldersClearOrgPolicyExample($service, $resource, $optParams);
...
* @return Empty
*/
function foldersClearOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->ClearOrgPolicyFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
