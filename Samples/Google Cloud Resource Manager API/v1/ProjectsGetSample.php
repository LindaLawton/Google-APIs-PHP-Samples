...
// Single Request.
$results = projectsGetExample($service, $projectId, $optParams);
...
* @return Project
*/
function projectsGetExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->GetProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
