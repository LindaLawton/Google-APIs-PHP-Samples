...
print_r(foldersSetOrgPolicyExample($service, $resource));
...
*/
function foldersSetOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->folders->SetOrgPolicyFolders($resource);
	}
	catch (Exception $ex)
	{
