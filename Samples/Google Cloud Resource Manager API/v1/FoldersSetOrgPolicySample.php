...
// Single Request.
$results = foldersSetOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function foldersSetOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->SetOrgPolicyFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
