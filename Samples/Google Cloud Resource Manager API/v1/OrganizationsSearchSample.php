...
// Single Request.
$results = organizationsSearchExample($service, $optParams);
...
*/
function organizationsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->organizations->SearchOrganizations($optParams);
	}
	catch (Exception $e)
	{
