...
print_r(organizationsSearchExample($service));
...
* @return SearchOrganizationsResponse</returns>
*/
function organizationsSearchExample($service)
{
	try
	{
		...
		return $service->organizations->SearchOrganizations();
	}
	catch (Exception $ex)
	{
