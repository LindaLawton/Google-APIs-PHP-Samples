...
// Single Request.
$results = projectsTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function projectsTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->TestIamPermissionsProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
