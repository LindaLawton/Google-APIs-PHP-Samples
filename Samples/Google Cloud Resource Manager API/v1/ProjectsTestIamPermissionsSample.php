...
print_r(projectsTestIamPermissionsExample($service, $resource));
...
*/
function projectsTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->projects->TestIamPermissionsProjects($resource);
	}
	catch (Exception $ex)
	{
