...
// Single Request.
$results = projectsListAvailableOrgPolicyConstraintsExample($service, $resource, $optParams);
...
*/
function projectsListAvailableOrgPolicyConstraintsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->ListAvailableOrgPolicyConstraintsProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
