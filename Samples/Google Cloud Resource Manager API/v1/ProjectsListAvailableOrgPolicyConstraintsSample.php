...
print_r(projectsListAvailableOrgPolicyConstraintsExample($service, $resource));
...
*/
function projectsListAvailableOrgPolicyConstraintsExample($service, $resource)
{
	try
	{
		...
		return $service->projects->ListAvailableOrgPolicyConstraintsProjects($resource);
	}
	catch (Exception $ex)
	{
