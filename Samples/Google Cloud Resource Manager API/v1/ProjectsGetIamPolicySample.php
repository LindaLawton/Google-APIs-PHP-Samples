...
print_r(projectsGetIamPolicyExample($service, $resource));
...
*/
function projectsGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->projects->GetIamPolicyProjects($resource);
	}
	catch (Exception $ex)
	{
