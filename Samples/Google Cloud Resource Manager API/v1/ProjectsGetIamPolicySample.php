...
// Single Request.
$results = projectsGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function projectsGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->GetIamPolicyProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
