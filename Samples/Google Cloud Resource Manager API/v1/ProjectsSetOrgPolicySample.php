...
print_r(projectsSetOrgPolicyExample($service, $resource));
...
*/
function projectsSetOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->projects->SetOrgPolicyProjects($resource);
	}
	catch (Exception $ex)
	{
