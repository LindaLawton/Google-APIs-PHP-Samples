...
// Single Request.
$results = projectsSetOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function projectsSetOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->SetOrgPolicyProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
