...
// Single Request.
$results = projectsListOrgPoliciesExample($service, $resource, $optParams);
...
*/
function projectsListOrgPoliciesExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->ListOrgPoliciesProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
