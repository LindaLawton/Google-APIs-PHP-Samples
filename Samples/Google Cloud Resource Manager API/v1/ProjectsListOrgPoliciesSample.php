...
print_r(projectsListOrgPoliciesExample($service, $resource));
...
*/
function projectsListOrgPoliciesExample($service, $resource)
{
	try
	{
		...
		return $service->projects->ListOrgPoliciesProjects($resource);
	}
	catch (Exception $ex)
	{
