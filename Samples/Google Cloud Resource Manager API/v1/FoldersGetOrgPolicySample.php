...
print_r(foldersGetOrgPolicyExample($service, $resource));
...
*/
function foldersGetOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->folders->GetOrgPolicyFolders($resource);
	}
	catch (Exception $ex)
	{
