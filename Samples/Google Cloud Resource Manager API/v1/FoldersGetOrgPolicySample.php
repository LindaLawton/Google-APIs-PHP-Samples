...
// Single Request.
$results = foldersGetOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function foldersGetOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->GetOrgPolicyFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
