...
// Single Request.
$results = projectsSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function projectsSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->SetIamPolicyProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
