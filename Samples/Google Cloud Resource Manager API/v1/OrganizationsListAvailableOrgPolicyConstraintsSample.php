...
print_r(organizationsListAvailableOrgPolicyConstraintsExample($service, $resource));

/**
* Lists `Constraints` that could be applied on the specified resource.
* @service Authenticated Cloudresourcemanager service.
* @resource Name of the resource to list `Constraints` for.
* @return ListAvailableOrgPolicyConstraintsResponse</returns>
*/
function organizationsListAvailableOrgPolicyConstraintsExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->ListAvailableOrgPolicyConstraintsOrganizations($resource);
	}
	catch (Exception $ex)
	{
