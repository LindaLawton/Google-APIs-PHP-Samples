...
// Single Request.
$results = organizationsListAvailableOrgPolicyConstraintsExample($service, $resource, $optParams);
...
*/
function organizationsListAvailableOrgPolicyConstraintsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->ListAvailableOrgPolicyConstraintsOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
