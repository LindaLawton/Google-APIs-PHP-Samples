...
// Single Request.
$results = foldersListOrgPoliciesExample($service, $resource, $optParams);
...
*/
function foldersListOrgPoliciesExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->ListOrgPoliciesFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
