...
print_r(foldersListOrgPoliciesExample($service, $resource));
...
*/
function foldersListOrgPoliciesExample($service, $resource)
{
	try
	{
		...
		return $service->folders->ListOrgPoliciesFolders($resource);
	}
	catch (Exception $ex)
	{
