...
print_r(projectsGetEffectiveOrgPolicyExample($service, $resource));
...
*/
function projectsGetEffectiveOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->projects->GetEffectiveOrgPolicyProjects($resource);
	}
	catch (Exception $ex)
	{
