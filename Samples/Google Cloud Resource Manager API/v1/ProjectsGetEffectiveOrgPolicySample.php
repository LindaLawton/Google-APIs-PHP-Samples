...
// Single Request.
$results = projectsGetEffectiveOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function projectsGetEffectiveOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->GetEffectiveOrgPolicyProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
