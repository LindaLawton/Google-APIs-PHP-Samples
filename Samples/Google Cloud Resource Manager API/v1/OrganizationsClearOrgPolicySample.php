...
print_r(organizationsClearOrgPolicyExample($service, $resource));
...
*/
function organizationsClearOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->ClearOrgPolicyOrganizations($resource);
	}
	catch (Exception $ex)
	{
