...
// Single Request.
$results = organizationsClearOrgPolicyExample($service, $resource, $optParams);
...
* @return Empty
*/
function organizationsClearOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->ClearOrgPolicyOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
