...
print_r(foldersListAvailableOrgPolicyConstraintsExample($service, $resource));
...
*/
function foldersListAvailableOrgPolicyConstraintsExample($service, $resource)
{
	try
	{
		...
		return $service->folders->ListAvailableOrgPolicyConstraintsFolders($resource);
	}
	catch (Exception $ex)
	{
