...
print_r(listAvailableOrgPolicyConstraints($service, $resource));
...
*/
function listAvailableOrgPolicyConstraints($service, $resource)
{
	try
	{
		...
		return $service->listAvailableOrgPolicyConstraints($resource);
	}
	catch (Exception $ex)
	{
