...
// Single Request.
$results = foldersListAvailableOrgPolicyConstraintsExample($service, $resource, $optParams);
...
*/
function foldersListAvailableOrgPolicyConstraintsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->folders->ListAvailableOrgPolicyConstraintsFolders($resource, $optParams);
	}
	catch (Exception $e)
	{
