...
print_r(organizationsGetOrgPolicyExample($service, $resource));
...
*/
function organizationsGetOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->GetOrgPolicyOrganizations($resource);
	}
	catch (Exception $ex)
	{
