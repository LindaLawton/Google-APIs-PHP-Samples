...
// Single Request.
$results = organizationsGetOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function organizationsGetOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->GetOrgPolicyOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
