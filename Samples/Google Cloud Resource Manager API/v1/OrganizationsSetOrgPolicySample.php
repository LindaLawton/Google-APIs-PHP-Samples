...
print_r(organizationsSetOrgPolicyExample($service, $resource));
...
*/
function organizationsSetOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->SetOrgPolicyOrganizations($resource);
	}
	catch (Exception $ex)
	{
