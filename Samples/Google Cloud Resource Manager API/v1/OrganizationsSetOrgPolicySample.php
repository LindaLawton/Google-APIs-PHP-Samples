...
// Single Request.
$results = organizationsSetOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function organizationsSetOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->SetOrgPolicyOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
