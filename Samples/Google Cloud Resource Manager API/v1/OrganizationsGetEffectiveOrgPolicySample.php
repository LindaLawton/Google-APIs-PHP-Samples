...
print_r(organizationsGetEffectiveOrgPolicyExample($service, $resource));
...
* @return OrgPolicy</returns>
*/
function organizationsGetEffectiveOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->GetEffectiveOrgPolicyOrganizations($resource);
	}
	catch (Exception $ex)
	{
