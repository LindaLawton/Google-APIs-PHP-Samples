...
// Single Request.
$results = organizationsGetEffectiveOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function organizationsGetEffectiveOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->GetEffectiveOrgPolicyOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
