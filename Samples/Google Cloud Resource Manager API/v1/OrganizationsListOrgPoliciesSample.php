...
// Single Request.
$results = organizationsListOrgPoliciesExample($service, $resource, $optParams);
...
*/
function organizationsListOrgPoliciesExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->ListOrgPoliciesOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
