...
print_r(organizationsListOrgPoliciesExample($service, $resource));

/**
* Lists all the `Policies` set for a particular resource.
* @service Authenticated Cloudresourcemanager service.
* @resource Name of the resource to list Policies for.
* @return ListOrgPoliciesResponse</returns>
*/
function organizationsListOrgPoliciesExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->ListOrgPoliciesOrganizations($resource);
	}
	catch (Exception $ex)
	{
