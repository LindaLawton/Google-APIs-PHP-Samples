...
print_r(projectsGetOrgPolicyExample($service, $resource));
...
*/
function projectsGetOrgPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->projects->GetOrgPolicyProjects($resource);
	}
	catch (Exception $ex)
	{
