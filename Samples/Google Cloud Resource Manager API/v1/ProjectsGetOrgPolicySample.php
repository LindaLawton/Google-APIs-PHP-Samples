...
$results = projectsGetOrgPolicyExample($service, $resource, $optParams);
...
* @return OrgPolicy
*/
function projectsGetOrgPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->projects->GetOrgPolicyProjects($resource, $optParams);
	}
	catch (Exception $e)
	{
