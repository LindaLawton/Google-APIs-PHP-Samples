...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageSize' => '[YourValue]',  // The maximum number of Organizations to return in the response.This field is optional.
            
  //'filter' => '[YourValue]',  // An optional query string used to filter the Organizations to return inthe response. Filter rules are case-insensitive.Organizations may be filtered by `owner.directoryCustomerId` or by`domain`, where the domain is a Google for Work domain, for example:|Filter|Description||------|-----------||owner.directorycustomerid:123456789|Organizations with `owner.directory_customer_id` equal to `123456789`.||domain:google.com|Organizations corresponding to the domain `google.com`.|This field is optional.
            
  //'pageToken' => '[YourValue]',  // A pagination token returned from a previous call to `ListOrganizations`that indicates from where listing should continue.This field is optional.
  'fields' => '*'
);
// Single Request.
$results = organizationsListExample($service, $optParams);
...
*/
function organizationsListExample($service, $optParams)
{
	try
	{
		...
		return $service->organizations->ListOrganizations($optParams);
	}
	catch (Exception $e)
	{
