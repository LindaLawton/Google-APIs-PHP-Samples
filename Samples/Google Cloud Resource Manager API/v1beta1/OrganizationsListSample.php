...
print_r(organizationsListExample($service));
...
* @return ListOrganizationsResponse</returns>
*/
function organizationsListExample($service)
{
	try
	{
		...
		return $service->organizations->ListOrganizations();
	}
	catch (Exception $ex)
	{
