...
print_r(organizationsTestIamPermissionsExample($service, $resource));
...
*/
function organizationsTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->TestIamPermissionsOrganizations($resource);
	}
	catch (Exception $ex)
	{
