...
// Single Request.
$results = projectsUndeleteExample($service, $projectId, $optParams);
...
* @return Empty
*/
function projectsUndeleteExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->UndeleteProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
