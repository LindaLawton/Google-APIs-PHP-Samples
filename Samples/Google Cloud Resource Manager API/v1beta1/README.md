...
# UnOfficial Google Cloud Resource Manager API v1beta1 Samples for PHP

## API Description

The Google Cloud Resource Manager API provides methods for creating, reading, and updating project metadata.

[Official Documentation](https://cloud.google.com/resource-manager)

## Sample Description

These samples show how to access the [Google Cloud Resource Manager API v1beta1](https://cloud.google.com/resource-manager) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
