...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'organizationId' => '[YourValue]',  //The id of the Organization resource to fetch.This field is deprecated and will be removed in v1. Use name instead.
  'fields' => '*'
);
// Single Request.
$results = organizationsGetExample($service, $name, $optParams);
...
* @return Organization
*/
function organizationsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->organizations->GetOrganizations($name, $optParams);
	}
	catch (Exception $e)
	{
