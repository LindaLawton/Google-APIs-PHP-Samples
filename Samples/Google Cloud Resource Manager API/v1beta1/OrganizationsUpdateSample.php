...
// Single Request.
$results = organizationsUpdateExample($service, $name, $optParams);
...
* @return Organization
*/
function organizationsUpdateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->organizations->UpdateOrganizations($name, $optParams);
	}
	catch (Exception $e)
	{
