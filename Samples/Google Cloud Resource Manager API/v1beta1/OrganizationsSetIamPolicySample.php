...
// Single Request.
$results = organizationsSetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function organizationsSetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->SetIamPolicyOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
