...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'useLegacyStack' => '[YourValue]',  // A safety hatch to opt out of the new reliable project creation process.
  'fields' => '*'
);
// Single Request.
$results = projectsCreateExample($service, $optParams);
...
* @return Project
*/
function projectsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->projects->CreateProjects($optParams);
	}
	catch (Exception $e)
	{
