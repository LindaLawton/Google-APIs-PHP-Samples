...
print_r(projectsGetAncestryExample($service, $projectId));
...
Required.
* @return GetAncestryResponse</returns>
*/
function projectsGetAncestryExample($service, $projectId)
{
	try
	{
		...
		return $service->projects->GetAncestryProjects($projectId);
	}
	catch (Exception $ex)
	{
