...
$results = organizationsGetIamPolicyExample($service, $resource, $optParams);
...
* @return Policy
*/
function organizationsGetIamPolicyExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->organizations->GetIamPolicyOrganizations($resource, $optParams);
	}
	catch (Exception $e)
	{
