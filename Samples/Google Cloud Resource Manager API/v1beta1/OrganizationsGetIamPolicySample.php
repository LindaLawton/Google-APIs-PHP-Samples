...
print_r(organizationsGetIamPolicyExample($service, $resource));
...
*/
function organizationsGetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->organizations->GetIamPolicyOrganizations($resource);
	}
	catch (Exception $ex)
	{
