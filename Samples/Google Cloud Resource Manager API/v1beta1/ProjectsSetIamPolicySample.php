...
print_r(projectsSetIamPolicyExample($service, $resource));
...
*/
function projectsSetIamPolicyExample($service, $resource)
{
	try
	{
		...
		return $service->projects->SetIamPolicyProjects($resource);
	}
	catch (Exception $ex)
	{
