...
// Single Request.
$results = projectsUpdateExample($service, $projectId, $optParams);
...
* @return Project
*/
function projectsUpdateExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->projects->UpdateProjects($projectId, $optParams);
	}
	catch (Exception $e)
	{
