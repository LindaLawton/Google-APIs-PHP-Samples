...
// About 
// 
// Unofficial sample for the Cloudresourcemanager v1beta1 API for PHP. 
 ...
 * Initializes an Cloudresourcemanager.v1beta1 service object.
 * @param string API key
 * @return An authorized Cloudresourcemanager.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudresourcemanager Sample");
		...
		// Create authenticated Cloudresourcemanager service
