...
// Single Request.
$results = vpnTunnelsListExample($service, $project, $region, $optParams);
...
*/
function vpnTunnelsListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->vpnTunnels->ListVpnTunnels($project, $region, $optParams);
	}
	catch (Exception $e)
	{
