...
print_r(regionBackendServicesInsertExample($service, $project, $region));
...
*/
function regionBackendServicesInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionBackendServices->InsertRegionBackendServices($project, $region);
	}
	catch (Exception $ex)
	{
