...
$results = regionBackendServicesInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionBackendServicesInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->InsertRegionBackendServices($project, $region, $optParams);
	}
	catch (Exception $e)
	{
