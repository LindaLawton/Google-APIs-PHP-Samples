...
print_r(targetSslProxiesSetSslCertificatesExample($service, $project, $targetSslProxy));
...
*/
function targetSslProxiesSetSslCertificatesExample($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->targetSslProxies->SetSslCertificatesTargetSslProxies($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
