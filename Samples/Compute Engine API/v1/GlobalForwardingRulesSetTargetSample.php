...
// Single Request.
$results = globalForwardingRulesSetTargetExample($service, $project, $forwardingRule, $optParams);
...
* @return Operation
*/
function globalForwardingRulesSetTargetExample($service, $project, $forwardingRule, $optParams)
{
	try
	{
		...
		if (forwardingRule == null)
			throw new Exception("forwardingRule is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->globalForwardingRules->SetTargetGlobalForwardingRules($project, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
