...
// Single Request.
$results = regionBackendServicesPatchExample($service, $project, $region, $backendService, $optParams);
...
* @return Operation
*/
function regionBackendServicesPatchExample($service, $project, $region, $backendService, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->PatchRegionBackendServices($project, $region, $backendService, $optParams);
	}
	catch (Exception $e)
	{
