...
print_r(patch($service, $project, $region, $backendService));
...
*/
function patch($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->patch($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
