...
$results = forwardingRulesSetTargetExample($service, $project, $region, $forwardingRule, $optParams);
...
* @return Operation
*/
function forwardingRulesSetTargetExample($service, $project, $region, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->SetTargetForwardingRules($project, $region, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
