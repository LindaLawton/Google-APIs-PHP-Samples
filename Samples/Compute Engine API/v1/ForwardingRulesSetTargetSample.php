...
print_r(setTarget($service, $project, $region, $forwardingRule));
...
*/
function setTarget($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->setTarget($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
