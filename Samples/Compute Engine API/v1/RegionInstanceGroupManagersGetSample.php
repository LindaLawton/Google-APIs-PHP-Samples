...
// Single Request.
$results = regionInstanceGroupManagersGetExample($service, $project, $region, $instanceGroupManager, $optParams);
...
*/
function regionInstanceGroupManagersGetExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->GetRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
