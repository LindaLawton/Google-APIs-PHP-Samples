...
print_r(get($service, $project, $region, $instanceGroupManager));
...
*/
function get($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->get($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
