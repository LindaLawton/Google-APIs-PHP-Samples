...
print_r(autoscalersDeleteExample($service, $project, $zone, $autoscaler));
...
*/
function autoscalersDeleteExample($service, $project, $zone, $autoscaler)
{
	try
	{
		...
		return $service->autoscalers->DeleteAutoscalers($project, $zone, $autoscaler);
	}
	catch (Exception $ex)
	{
