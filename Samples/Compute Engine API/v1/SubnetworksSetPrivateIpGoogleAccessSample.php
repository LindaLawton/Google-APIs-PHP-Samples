...
print_r(subnetworksSetPrivateIpGoogleAccessExample($service, $project, $region, $subnetwork));
...
*/
function subnetworksSetPrivateIpGoogleAccessExample($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->subnetworks->SetPrivateIpGoogleAccessSubnetworks($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
