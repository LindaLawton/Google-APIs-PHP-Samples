...
print_r(setPrivateIpGoogleAccess($service, $project, $region, $subnetwork));
...
*/
function setPrivateIpGoogleAccess($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->setPrivateIpGoogleAccess($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
