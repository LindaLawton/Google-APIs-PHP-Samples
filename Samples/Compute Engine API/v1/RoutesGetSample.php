...
// Single Request.
$results = routesGetExample($service, $project, $route, $optParams);
...
* @return Route
*/
function routesGetExample($service, $project, $route, $optParams)
{
	try
	{
		...
		return $service->routes->GetRoutes($project, $route, $optParams);
	}
	catch (Exception $e)
	{
