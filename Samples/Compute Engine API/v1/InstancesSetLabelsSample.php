...
print_r(instancesSetLabelsExample($service, $project, $zone, $instance));
...
*/
function instancesSetLabelsExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetLabelsInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
