...
// Single Request.
$results = regionsGetExample($service, $project, $region, $optParams);
...
* @return Region
*/
function regionsGetExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regions->GetRegions($project, $region, $optParams);
	}
	catch (Exception $e)
	{
