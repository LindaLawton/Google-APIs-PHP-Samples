...
// Single Request.
$results = targetHttpProxiesDeleteExample($service, $project, $targetHttpProxy, $optParams);
...
* @return Operation
*/
function targetHttpProxiesDeleteExample($service, $project, $targetHttpProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpProxies->DeleteTargetHttpProxies($project, $targetHttpProxy, $optParams);
	}
	catch (Exception $e)
	{
