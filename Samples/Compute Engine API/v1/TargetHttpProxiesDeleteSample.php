...
print_r(targetHttpProxiesDeleteExample($service, $project, $targetHttpProxy));
...
*/
function targetHttpProxiesDeleteExample($service, $project, $targetHttpProxy)
{
	try
	{
		...
		return $service->targetHttpProxies->DeleteTargetHttpProxies($project, $targetHttpProxy);
	}
	catch (Exception $ex)
	{
