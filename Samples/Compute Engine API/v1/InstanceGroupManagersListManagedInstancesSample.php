...
print_r(listManagedInstances($service, $project, $zone, $instanceGroupManager));
...
*/
function listManagedInstances($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->listManagedInstances($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
