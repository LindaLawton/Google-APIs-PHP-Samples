...
print_r(targetTcpProxiesListExample($service, $project));

/**
* Retrieves the list of TargetTcpProxy resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return TargetTcpProxyList</returns>
*/
function targetTcpProxiesListExample($service, $project)
{
	try
	{
		...
		return $service->targetTcpProxies->ListTargetTcpProxies($project);
	}
	catch (Exception $ex)
	{
