...
print_r(instanceTemplatesInsertExample($service, $project));
...
*/
function instanceTemplatesInsertExample($service, $project)
{
	try
	{
		...
		return $service->instanceTemplates->InsertInstanceTemplates($project);
	}
	catch (Exception $ex)
	{
