...
// Single Request.
$results = instanceTemplatesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function instanceTemplatesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instanceTemplates->InsertInstanceTemplates($project, $optParams);
	}
	catch (Exception $e)
	{
