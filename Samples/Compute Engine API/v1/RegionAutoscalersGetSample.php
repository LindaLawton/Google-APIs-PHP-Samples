...
print_r(regionAutoscalersGetExample($service, $project, $region, $autoscaler));
...
* @return Autoscaler</returns>
*/
function regionAutoscalersGetExample($service, $project, $region, $autoscaler)
{
	try
	{
		...
		return $service->regionAutoscalers->GetRegionAutoscalers($project, $region, $autoscaler);
	}
	catch (Exception $ex)
	{
