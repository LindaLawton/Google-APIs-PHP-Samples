...
// Single Request.
$results = targetTcpProxiesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function targetTcpProxiesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetTcpProxies->InsertTargetTcpProxies($project, $optParams);
	}
	catch (Exception $e)
	{
