...
print_r(backendServicesUpdateExample($service, $project, $backendService));
...
*/
function backendServicesUpdateExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->UpdateBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
