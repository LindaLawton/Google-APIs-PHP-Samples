...
// Single Request.
$results = backendServicesUpdateExample($service, $project, $backendService, $optParams);
...
* @return Operation
*/
function backendServicesUpdateExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->UpdateBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
