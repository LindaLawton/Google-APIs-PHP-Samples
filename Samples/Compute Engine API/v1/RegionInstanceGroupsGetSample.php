...
$results = regionInstanceGroupsGetExample($service, $project, $region, $instanceGroup, $optParams);
...
*/
function regionInstanceGroupsGetExample($service, $project, $region, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroups->GetRegionInstanceGroups($project, $region, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
