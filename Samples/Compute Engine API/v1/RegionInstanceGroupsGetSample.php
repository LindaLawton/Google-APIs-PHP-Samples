...
print_r(regionInstanceGroupsGetExample($service, $project, $region, $instanceGroup));
...
* @return InstanceGroup</returns>
*/
function regionInstanceGroupsGetExample($service, $project, $region, $instanceGroup)
{
	try
	{
		...
		return $service->regionInstanceGroups->GetRegionInstanceGroups($project, $region, $instanceGroup);
	}
	catch (Exception $ex)
	{
