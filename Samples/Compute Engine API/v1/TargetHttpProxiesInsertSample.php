...
print_r(targetHttpProxiesInsertExample($service, $project));
...
*/
function targetHttpProxiesInsertExample($service, $project)
{
	try
	{
		...
		return $service->targetHttpProxies->InsertTargetHttpProxies($project);
	}
	catch (Exception $ex)
	{
