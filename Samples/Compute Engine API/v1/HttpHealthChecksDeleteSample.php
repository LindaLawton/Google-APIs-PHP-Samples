...
print_r(httpHealthChecksDeleteExample($service, $project, $httpHealthCheck));
...
*/
function httpHealthChecksDeleteExample($service, $project, $httpHealthCheck)
{
	try
	{
		...
		return $service->httpHealthChecks->DeleteHttpHealthChecks($project, $httpHealthCheck);
	}
	catch (Exception $ex)
	{
