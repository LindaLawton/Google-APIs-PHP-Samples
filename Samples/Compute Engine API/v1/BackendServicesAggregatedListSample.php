...
print_r(backendServicesAggregatedListExample($service, $project));

/**
* Retrieves the list of all BackendService resources, regional and global, available to the specified project.
* @service Authenticated Compute service.
* @project Name of the project scoping this request.
* @return BackendServiceAggregatedList</returns>
*/
function backendServicesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->backendServices->AggregatedListBackendServices($project);
	}
	catch (Exception $ex)
	{
