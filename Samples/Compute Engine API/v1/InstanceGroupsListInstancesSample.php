...
print_r(instanceGroupsListInstancesExample($service, $project, $zone, $instanceGroup));
...
* @return InstanceGroupsListInstances</returns>
*/
function instanceGroupsListInstancesExample($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->instanceGroups->ListInstancesInstanceGroups($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
