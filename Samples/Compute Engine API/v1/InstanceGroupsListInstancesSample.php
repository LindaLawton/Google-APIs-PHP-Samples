...
// Single Request.
$results = instanceGroupsListInstancesExample($service, $project, $zone, $instanceGroup, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $zone, $instanceGroup, $optParams);	
...
*/
function instanceGroupsListInstancesExample($service, $project, $zone, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->ListInstancesInstanceGroups($project, $zone, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
