...
print_r(globalAddressesListExample($service, $project));

/**
* Retrieves a list of global addresses.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return AddressList</returns>
*/
function globalAddressesListExample($service, $project)
{
	try
	{
		...
		return $service->globalAddresses->ListGlobalAddresses($project);
	}
	catch (Exception $ex)
	{
