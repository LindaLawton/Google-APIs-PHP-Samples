...
$results = globalAddressesListExample($service, $project, $optParams);
...
* @return AddressList
*/
function globalAddressesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalAddresses->ListGlobalAddresses($project, $optParams);
	}
	catch (Exception $e)
	{
