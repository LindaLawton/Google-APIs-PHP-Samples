...
// Single Request.
$results = instancesDeleteAccessConfigExample($service, $project, $zone, $instance, $accessConfig, $networkInterface, $optParams);
...
* @return Operation
*/
function instancesDeleteAccessConfigExample($service, $project, $zone, $instance, $accessConfig, $networkInterface, $optParams)
{
	try
	{
		...
		if (accessConfig == null)
			throw new Exception("accessConfig is required.");
		if (instance == null)
			throw new Exception("instance is required.");
		if (networkInterface == null)
			throw new Exception("networkInterface is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (zone == null)
			throw new Exception("zone is required.");
		// Make the request and return the results.
		return $service->instances->DeleteAccessConfigInstances($project, $zone, $instance, $accessConfig, $networkInterface, $optParams);
	}
	catch (Exception $e)
	{
