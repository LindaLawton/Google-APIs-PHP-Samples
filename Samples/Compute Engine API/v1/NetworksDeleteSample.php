...
print_r(networksDeleteExample($service, $project, $network));
...
*/
function networksDeleteExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->DeleteNetworks($project, $network);
	}
	catch (Exception $ex)
	{
