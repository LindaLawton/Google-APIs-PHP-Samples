...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'forceCreate' => '[YourValue]',  // Force image creation if true.
...
// Single Request.
$results = imagesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function imagesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->images->InsertImages($project, $optParams);
	}
	catch (Exception $e)
	{
