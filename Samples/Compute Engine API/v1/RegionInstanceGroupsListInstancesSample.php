...
print_r(listInstances($service, $project, $region, $instanceGroup));
...
*/
function listInstances($service, $project, $region, $instanceGroup)
{
	try
	{
		...
		return $service->listInstances($project, $region, $instanceGroup);
	}
	catch (Exception $ex)
	{
