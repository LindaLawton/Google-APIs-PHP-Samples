...
// Single Request.
$results = regionInstanceGroupsListInstancesExample($service, $project, $region, $instanceGroup, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $region, $instanceGroup, $optParams);	
...
*/
function regionInstanceGroupsListInstancesExample($service, $project, $region, $instanceGroup, $optParams)
{
	try
	{
		...
		if (instanceGroup == null)
			throw new Exception("instanceGroup is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (region == null)
			throw new Exception("region is required.");
		// Make the request and return the results.
		return $service->regionInstanceGroups->ListInstancesRegionInstanceGroups($project, $region, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
