...
// Single Request.
$results = regionCommitmentsListExample($service, $project, $region, $optParams);
...
*/
function regionCommitmentsListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionCommitments->ListRegionCommitments($project, $region, $optParams);
	}
	catch (Exception $e)
	{
