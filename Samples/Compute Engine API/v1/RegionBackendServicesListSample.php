...
$results = regionBackendServicesListExample($service, $project, $region, $optParams);
...
*/
function regionBackendServicesListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->ListRegionBackendServices($project, $region, $optParams);
	}
	catch (Exception $e)
	{
