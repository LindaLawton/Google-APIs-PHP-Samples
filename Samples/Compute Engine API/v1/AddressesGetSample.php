...
print_r(addressesGetExample($service, $project, $region, $address));
...
*/
function addressesGetExample($service, $project, $region, $address)
{
	try
	{
		...
		return $service->addresses->GetAddresses($project, $region, $address);
	}
	catch (Exception $ex)
	{
