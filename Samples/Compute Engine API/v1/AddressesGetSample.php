...
// Single Request.
$results = addressesGetExample($service, $project, $region, $address, $optParams);
...
* @return Address
*/
function addressesGetExample($service, $project, $region, $address, $optParams)
{
	try
	{
		...
		return $service->addresses->GetAddresses($project, $region, $address, $optParams);
	}
	catch (Exception $e)
	{
