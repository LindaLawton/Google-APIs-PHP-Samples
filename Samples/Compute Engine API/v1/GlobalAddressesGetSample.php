...
print_r(globalAddressesGetExample($service, $project, $address));
...
*/
function globalAddressesGetExample($service, $project, $address)
{
	try
	{
		...
		return $service->globalAddresses->GetGlobalAddresses($project, $address);
	}
	catch (Exception $ex)
	{
