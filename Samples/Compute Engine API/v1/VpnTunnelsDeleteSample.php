...
// Single Request.
$results = vpnTunnelsDeleteExample($service, $project, $region, $vpnTunnel, $optParams);
...
* @return Operation
*/
function vpnTunnelsDeleteExample($service, $project, $region, $vpnTunnel, $optParams)
{
	try
	{
		...
		if (vpnTunnel == null)
			throw new Exception("vpnTunnel is required.");
		// Make the request and return the results.
		return $service->vpnTunnels->DeleteVpnTunnels($project, $region, $vpnTunnel, $optParams);
	}
	catch (Exception $e)
	{
