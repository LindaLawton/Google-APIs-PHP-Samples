...
// Single Request.
$results = healthChecksDeleteExample($service, $project, $healthCheck, $optParams);
...
* @return Operation
*/
function healthChecksDeleteExample($service, $project, $healthCheck, $optParams)
{
	try
	{
		...
		if (healthCheck == null)
			throw new Exception("healthCheck is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->healthChecks->DeleteHealthChecks($project, $healthCheck, $optParams);
	}
	catch (Exception $e)
	{
