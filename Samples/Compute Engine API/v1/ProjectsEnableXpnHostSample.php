...
print_r(projectsEnableXpnHostExample($service, $project));
...
*/
function projectsEnableXpnHostExample($service, $project)
{
	try
	{
		...
		return $service->projects->EnableXpnHostProjects($project);
	}
	catch (Exception $ex)
	{
