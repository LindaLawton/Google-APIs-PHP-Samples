...
// Single Request.
$results = instancesSetMachineTypeExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetMachineTypeExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetMachineTypeInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
