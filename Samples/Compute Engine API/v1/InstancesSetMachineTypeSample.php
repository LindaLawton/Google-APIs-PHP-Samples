...
print_r(instancesSetMachineTypeExample($service, $project, $zone, $instance));
...
*/
function instancesSetMachineTypeExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetMachineTypeInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
