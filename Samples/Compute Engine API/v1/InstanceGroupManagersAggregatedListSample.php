...
// Single Request.
$results = instanceGroupManagersAggregatedListExample($service, $project, $optParams);
...
*/
function instanceGroupManagersAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->AggregatedListInstanceGroupManagers($project, $optParams);
	}
	catch (Exception $e)
	{
