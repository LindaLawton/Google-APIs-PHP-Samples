...
// Single Request.
$results = snapshotsDeleteExample($service, $project, $snapshot, $optParams);
...
* @return Operation
*/
function snapshotsDeleteExample($service, $project, $snapshot, $optParams)
{
	try
	{
		...
		if (snapshot == null)
			throw new Exception("snapshot is required.");
		// Make the request and return the results.
		return $service->snapshots->DeleteSnapshots($project, $snapshot, $optParams);
	}
	catch (Exception $e)
	{
