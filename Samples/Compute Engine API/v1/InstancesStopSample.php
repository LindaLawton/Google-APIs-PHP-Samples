...
print_r(instancesStopExample($service, $project, $zone, $instance));
...
*/
function instancesStopExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->StopInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
