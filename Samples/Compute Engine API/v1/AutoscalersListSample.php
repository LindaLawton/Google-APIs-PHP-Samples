...
print_r(autoscalersListExample($service, $project, $zone));
...
* @return AutoscalerList</returns>
*/
function autoscalersListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->autoscalers->ListAutoscalers($project, $zone);
	}
	catch (Exception $ex)
	{
