...
print_r(addAccessConfig($service, $project, $zone, $instance, $networkInterface));
...
*/
function addAccessConfig($service, $project, $zone, $instance, $networkInterface)
{
	try
	{
		...
		return $service->addAccessConfig($project, $zone, $instance, $networkInterface);
	}
	catch (Exception $ex)
	{
