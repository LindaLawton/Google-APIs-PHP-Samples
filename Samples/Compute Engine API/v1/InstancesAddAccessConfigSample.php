...
// Single Request.
$results = instancesAddAccessConfigExample($service, $project, $zone, $instance, $networkInterface, $optParams);
...
* @return Operation
*/
function instancesAddAccessConfigExample($service, $project, $zone, $instance, $networkInterface, $optParams)
{
	try
	{
		...
		return $service->instances->AddAccessConfigInstances($project, $zone, $instance, $networkInterface, $optParams);
	}
	catch (Exception $e)
	{
