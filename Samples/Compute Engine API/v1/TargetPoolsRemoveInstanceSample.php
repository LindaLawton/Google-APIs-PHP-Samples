...
print_r(targetPoolsRemoveInstanceExample($service, $project, $region, $targetPool));
...
*/
function targetPoolsRemoveInstanceExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->RemoveInstanceTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
