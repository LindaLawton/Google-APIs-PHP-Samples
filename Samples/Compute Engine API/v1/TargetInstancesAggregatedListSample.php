...
print_r(targetInstancesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of target instances.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return TargetInstanceAggregatedList</returns>
*/
function targetInstancesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->targetInstances->AggregatedListTargetInstances($project);
	}
	catch (Exception $ex)
	{
