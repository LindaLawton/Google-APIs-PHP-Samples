...
$results = firewallsPatchExample($service, $project, $firewall, $optParams);
...
* @return Operation
*/
function firewallsPatchExample($service, $project, $firewall, $optParams)
{
	try
	{
		...
		return $service->firewalls->PatchFirewalls($project, $firewall, $optParams);
	}
	catch (Exception $e)
	{
