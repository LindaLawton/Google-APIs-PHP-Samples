...
print_r(firewallsPatchExample($service, $project, $firewall));
...
*/
function firewallsPatchExample($service, $project, $firewall)
{
	try
	{
		...
		return $service->firewalls->PatchFirewalls($project, $firewall);
	}
	catch (Exception $ex)
	{
