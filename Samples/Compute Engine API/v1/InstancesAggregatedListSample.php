...
print_r(instancesAggregatedListExample($service, $project));

/**
* Retrieves aggregated list of instances.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return InstanceAggregatedList</returns>
*/
function instancesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->instances->AggregatedListInstances($project);
	}
	catch (Exception $ex)
	{
