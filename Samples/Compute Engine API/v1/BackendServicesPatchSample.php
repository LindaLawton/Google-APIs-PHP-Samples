...
print_r(backendServicesPatchExample($service, $project, $backendService));
...
*/
function backendServicesPatchExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->PatchBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
