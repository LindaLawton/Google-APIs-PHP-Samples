...
// Single Request.
$results = backendServicesPatchExample($service, $project, $backendService, $optParams);
...
* @return Operation
*/
function backendServicesPatchExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->PatchBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
