...
print_r(instancesSetTagsExample($service, $project, $zone, $instance));
...
*/
function instancesSetTagsExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetTagsInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
