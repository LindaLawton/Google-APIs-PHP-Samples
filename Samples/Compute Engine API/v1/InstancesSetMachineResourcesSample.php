...
print_r(instancesSetMachineResourcesExample($service, $project, $zone, $instance));
...
*/
function instancesSetMachineResourcesExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetMachineResourcesInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
