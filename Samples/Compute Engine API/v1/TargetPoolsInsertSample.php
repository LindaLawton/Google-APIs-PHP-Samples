...
print_r(targetPoolsInsertExample($service, $project, $region));
...
*/
function targetPoolsInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->targetPools->InsertTargetPools($project, $region);
	}
	catch (Exception $ex)
	{
