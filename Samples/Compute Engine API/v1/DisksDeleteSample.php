...
print_r(disksDeleteExample($service, $project, $zone, $disk));
...
*/
function disksDeleteExample($service, $project, $zone, $disk)
{
	try
	{
		...
		return $service->disks->DeleteDisks($project, $zone, $disk);
	}
	catch (Exception $ex)
	{
