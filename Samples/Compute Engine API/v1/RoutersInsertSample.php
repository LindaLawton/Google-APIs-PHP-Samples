...
print_r(routersInsertExample($service, $project, $region));
...
*/
function routersInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->routers->InsertRouters($project, $region);
	}
	catch (Exception $ex)
	{
