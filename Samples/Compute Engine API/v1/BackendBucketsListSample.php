...
print_r(backendBucketsListExample($service, $project));

/**
* Retrieves the list of BackendBucket resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return BackendBucketList</returns>
*/
function backendBucketsListExample($service, $project)
{
	try
	{
		...
		return $service->backendBuckets->ListBackendBuckets($project);
	}
	catch (Exception $ex)
	{
