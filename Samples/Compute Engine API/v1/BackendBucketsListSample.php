...
// Single Request.
$results = backendBucketsListExample($service, $project, $optParams);
...
*/
function backendBucketsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->ListBackendBuckets($project, $optParams);
	}
	catch (Exception $e)
	{
