...
print_r(delete($service, $project, $region, $instanceGroupManager));
...
*/
function delete($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->delete($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
