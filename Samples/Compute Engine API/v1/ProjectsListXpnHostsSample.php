...
// Single Request.
$results = projectsListXpnHostsExample($service, $project, $optParams);
...
* @return XpnHostList
*/
function projectsListXpnHostsExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->ListXpnHostsProjects($project, $optParams);
	}
	catch (Exception $e)
	{
