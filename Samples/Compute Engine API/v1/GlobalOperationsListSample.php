...
print_r(globalOperationsListExample($service, $project));
...
*/
function globalOperationsListExample($service, $project)
{
	try
	{
		...
		return $service->globalOperations->ListGlobalOperations($project);
	}
	catch (Exception $ex)
	{
