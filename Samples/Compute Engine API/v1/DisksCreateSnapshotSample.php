...
print_r(disksCreateSnapshotExample($service, $project, $zone, $disk));
...
*/
function disksCreateSnapshotExample($service, $project, $zone, $disk)
{
	try
	{
		...
		return $service->disks->CreateSnapshotDisks($project, $zone, $disk);
	}
	catch (Exception $ex)
	{
