...
print_r(addressesDeleteExample($service, $project, $region, $address));
...
*/
function addressesDeleteExample($service, $project, $region, $address)
{
	try
	{
		...
		return $service->addresses->DeleteAddresses($project, $region, $address);
	}
	catch (Exception $ex)
	{
