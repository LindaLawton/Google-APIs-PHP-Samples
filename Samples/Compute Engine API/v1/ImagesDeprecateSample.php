...
// Single Request.
$results = imagesDeprecateExample($service, $project, $image, $optParams);
...
* @return Operation
*/
function imagesDeprecateExample($service, $project, $image, $optParams)
{
	try
	{
		...
		return $service->images->DeprecateImages($project, $image, $optParams);
	}
	catch (Exception $e)
	{
