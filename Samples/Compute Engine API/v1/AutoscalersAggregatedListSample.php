...
// Single Request.
$results = autoscalersAggregatedListExample($service, $project, $optParams);
...
*/
function autoscalersAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->autoscalers->AggregatedListAutoscalers($project, $optParams);
	}
	catch (Exception $e)
	{
