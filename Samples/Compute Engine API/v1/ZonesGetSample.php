...
$results = zonesGetExample($service, $project, $zone, $optParams);
...
* @return Zone
*/
function zonesGetExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->zones->GetZones($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
