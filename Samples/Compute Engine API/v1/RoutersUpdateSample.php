...
$results = routersUpdateExample($service, $project, $region, $router, $optParams);
...
* @return Operation
*/
function routersUpdateExample($service, $project, $region, $router, $optParams)
{
	try
	{
		...
		return $service->routers->UpdateRouters($project, $region, $router, $optParams);
	}
	catch (Exception $e)
	{
