...
print_r(routersUpdateExample($service, $project, $region, $router));
...
*/
function routersUpdateExample($service, $project, $region, $router)
{
	try
	{
		...
		return $service->routers->UpdateRouters($project, $region, $router);
	}
	catch (Exception $ex)
	{
