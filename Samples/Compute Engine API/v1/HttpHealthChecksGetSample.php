...
// Single Request.
$results = httpHealthChecksGetExample($service, $project, $httpHealthCheck, $optParams);
...
*/
function httpHealthChecksGetExample($service, $project, $httpHealthCheck, $optParams)
{
	try
	{
		...
		return $service->httpHealthChecks->GetHttpHealthChecks($project, $httpHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
