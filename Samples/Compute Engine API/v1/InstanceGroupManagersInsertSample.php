...
$results = instanceGroupManagersInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function instanceGroupManagersInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->InsertInstanceGroupManagers($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
