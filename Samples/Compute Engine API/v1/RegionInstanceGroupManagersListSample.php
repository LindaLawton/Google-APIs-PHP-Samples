...
print_r(regionInstanceGroupManagersListExample($service, $project, $region));
...
* @return RegionInstanceGroupManagerList</returns>
*/
function regionInstanceGroupManagersListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ListRegionInstanceGroupManagers($project, $region);
	}
	catch (Exception $ex)
	{
