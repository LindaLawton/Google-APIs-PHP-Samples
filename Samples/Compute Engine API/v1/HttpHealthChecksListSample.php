...
// Single Request.
$results = httpHealthChecksListExample($service, $project, $optParams);
...
*/
function httpHealthChecksListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->httpHealthChecks->ListHttpHealthChecks($project, $optParams);
	}
	catch (Exception $e)
	{
