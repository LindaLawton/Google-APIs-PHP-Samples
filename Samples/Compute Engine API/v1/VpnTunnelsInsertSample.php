...
print_r(vpnTunnelsInsertExample($service, $project, $region));
...
*/
function vpnTunnelsInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->vpnTunnels->InsertVpnTunnels($project, $region);
	}
	catch (Exception $ex)
	{
