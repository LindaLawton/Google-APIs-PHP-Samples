...
// Single Request.
$results = globalOperationsAggregatedListExample($service, $project, $optParams);
...
*/
function globalOperationsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalOperations->AggregatedListGlobalOperations($project, $optParams);
	}
	catch (Exception $e)
	{
