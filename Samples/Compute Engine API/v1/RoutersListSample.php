...
print_r(routersListExample($service, $project, $region));
...
* @return RouterList</returns>
*/
function routersListExample($service, $project, $region)
{
	try
	{
		...
		return $service->routers->ListRouters($project, $region);
	}
	catch (Exception $ex)
	{
