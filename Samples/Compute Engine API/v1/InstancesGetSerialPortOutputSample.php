...
print_r(getSerialPortOutput($service, $project, $zone, $instance));
...
*/
function getSerialPortOutput($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->getSerialPortOutput($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
