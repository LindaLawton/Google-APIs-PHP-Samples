...
print_r(instancesSetDiskAutoDeleteExample($service, $project, $zone, $instance, $autoDelete, $deviceName));
...
*/
function instancesSetDiskAutoDeleteExample($service, $project, $zone, $instance, $autoDelete, $deviceName)
{
	try
	{
		...
		return $service->instances->SetDiskAutoDeleteInstances($project, $zone, $instance, $autoDelete, $deviceName);
	}
	catch (Exception $ex)
	{
