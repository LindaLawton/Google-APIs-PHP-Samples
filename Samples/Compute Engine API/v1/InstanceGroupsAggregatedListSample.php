...
// Single Request.
$results = instanceGroupsAggregatedListExample($service, $project, $optParams);
...
*/
function instanceGroupsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->AggregatedListInstanceGroups($project, $optParams);
	}
	catch (Exception $e)
	{
