...
print_r(delete($service, $project, $region, $targetVpnGateway));
...
*/
function delete($service, $project, $region, $targetVpnGateway)
{
	try
	{
		...
		return $service->delete($project, $region, $targetVpnGateway);
	}
	catch (Exception $ex)
	{
