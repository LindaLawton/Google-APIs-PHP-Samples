...
// Single Request.
$results = instancesSetSchedulingExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetSchedulingExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetSchedulingInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
