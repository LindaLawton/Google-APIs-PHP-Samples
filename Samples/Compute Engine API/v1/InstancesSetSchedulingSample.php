...
print_r(instancesSetSchedulingExample($service, $project, $zone, $instance));
...
*/
function instancesSetSchedulingExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetSchedulingInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
