...
// Single Request.
$results = httpHealthChecksPatchExample($service, $project, $httpHealthCheck, $optParams);
...
* @return Operation
*/
function httpHealthChecksPatchExample($service, $project, $httpHealthCheck, $optParams)
{
	try
	{
		...
		return $service->httpHealthChecks->PatchHttpHealthChecks($project, $httpHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
