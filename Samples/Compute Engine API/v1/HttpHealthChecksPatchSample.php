...
print_r(httpHealthChecksPatchExample($service, $project, $httpHealthCheck));
...
*/
function httpHealthChecksPatchExample($service, $project, $httpHealthCheck)
{
	try
	{
		...
		return $service->httpHealthChecks->PatchHttpHealthChecks($project, $httpHealthCheck);
	}
	catch (Exception $ex)
	{
