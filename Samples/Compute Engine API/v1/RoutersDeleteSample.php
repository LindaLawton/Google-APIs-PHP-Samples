...
// Single Request.
$results = routersDeleteExample($service, $project, $region, $router, $optParams);
...
* @return Operation
*/
function routersDeleteExample($service, $project, $region, $router, $optParams)
{
	try
	{
		...
		return $service->routers->DeleteRouters($project, $region, $router, $optParams);
	}
	catch (Exception $e)
	{
