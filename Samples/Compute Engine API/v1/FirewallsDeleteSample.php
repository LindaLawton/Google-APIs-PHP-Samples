...
// Single Request.
$results = firewallsDeleteExample($service, $project, $firewall, $optParams);
...
* @return Operation
*/
function firewallsDeleteExample($service, $project, $firewall, $optParams)
{
	try
	{
		...
		if (firewall == null)
			throw new Exception("firewall is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->firewalls->DeleteFirewalls($project, $firewall, $optParams);
	}
	catch (Exception $e)
	{
