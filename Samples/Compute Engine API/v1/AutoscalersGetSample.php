...
// Single Request.
$results = autoscalersGetExample($service, $project, $zone, $autoscaler, $optParams);
...
* @return Autoscaler
*/
function autoscalersGetExample($service, $project, $zone, $autoscaler, $optParams)
{
	try
	{
		...
		return $service->autoscalers->GetAutoscalers($project, $zone, $autoscaler, $optParams);
	}
	catch (Exception $e)
	{
