...
print_r(autoscalersGetExample($service, $project, $zone, $autoscaler));
...
*/
function autoscalersGetExample($service, $project, $zone, $autoscaler)
{
	try
	{
		...
		return $service->autoscalers->GetAutoscalers($project, $zone, $autoscaler);
	}
	catch (Exception $ex)
	{
