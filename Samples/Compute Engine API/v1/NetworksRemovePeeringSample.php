...
// Single Request.
$results = networksRemovePeeringExample($service, $project, $network, $optParams);
...
* @return Operation
*/
function networksRemovePeeringExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->RemovePeeringNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
