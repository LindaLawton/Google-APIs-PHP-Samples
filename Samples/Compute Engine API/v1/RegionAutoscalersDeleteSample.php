...
print_r(regionAutoscalersDeleteExample($service, $project, $region, $autoscaler));
...
*/
function regionAutoscalersDeleteExample($service, $project, $region, $autoscaler)
{
	try
	{
		...
		return $service->regionAutoscalers->DeleteRegionAutoscalers($project, $region, $autoscaler);
	}
	catch (Exception $ex)
	{
