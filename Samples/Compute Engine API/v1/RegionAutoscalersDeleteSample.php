...
// Single Request.
$results = regionAutoscalersDeleteExample($service, $project, $region, $autoscaler, $optParams);
...
* @return Operation
*/
function regionAutoscalersDeleteExample($service, $project, $region, $autoscaler, $optParams)
{
	try
	{
		...
		if (autoscaler == null)
			throw new Exception("autoscaler is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (region == null)
			throw new Exception("region is required.");
		// Make the request and return the results.
		return $service->regionAutoscalers->DeleteRegionAutoscalers($project, $region, $autoscaler, $optParams);
	}
	catch (Exception $e)
	{
