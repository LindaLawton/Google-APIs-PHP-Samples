...
// Single Request.
$results = urlMapsInvalidateCacheExample($service, $project, $urlMap, $optParams);
...
* @return Operation
*/
function urlMapsInvalidateCacheExample($service, $project, $urlMap, $optParams)
{
	try
	{
		...
		if (urlMap == null)
			throw new Exception("urlMap is required.");
		// Make the request and return the results.
		return $service->urlMaps->InvalidateCacheUrlMaps($project, $urlMap, $optParams);
	}
	catch (Exception $e)
	{
