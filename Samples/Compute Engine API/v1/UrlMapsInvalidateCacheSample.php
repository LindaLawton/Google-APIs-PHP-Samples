...
print_r(urlMapsInvalidateCacheExample($service, $project, $urlMap));
...
*/
function urlMapsInvalidateCacheExample($service, $project, $urlMap)
{
	try
	{
		...
		return $service->urlMaps->InvalidateCacheUrlMaps($project, $urlMap);
	}
	catch (Exception $ex)
	{
