...
print_r(subnetworksExpandIpCidrRangeExample($service, $project, $region, $subnetwork));
...
*/
function subnetworksExpandIpCidrRangeExample($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->subnetworks->ExpandIpCidrRangeSubnetworks($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
