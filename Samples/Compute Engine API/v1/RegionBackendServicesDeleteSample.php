...
print_r(delete($service, $project, $region, $backendService));
...
*/
function delete($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->delete($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
