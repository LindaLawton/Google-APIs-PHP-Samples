...
// Single Request.
$results = regionBackendServicesDeleteExample($service, $project, $region, $backendService, $optParams);
...
* @return Operation
*/
function regionBackendServicesDeleteExample($service, $project, $region, $backendService, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->DeleteRegionBackendServices($project, $region, $backendService, $optParams);
	}
	catch (Exception $e)
	{
