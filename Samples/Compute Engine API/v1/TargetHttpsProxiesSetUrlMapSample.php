...
print_r(targetHttpsProxiesSetUrlMapExample($service, $project, $targetHttpsProxy));
...
*/
function targetHttpsProxiesSetUrlMapExample($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetUrlMapTargetHttpsProxies($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
