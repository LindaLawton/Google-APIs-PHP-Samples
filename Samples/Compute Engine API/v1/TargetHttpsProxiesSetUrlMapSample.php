...
$results = targetHttpsProxiesSetUrlMapExample($service, $project, $targetHttpsProxy, $optParams);
...
* @return Operation
*/
function targetHttpsProxiesSetUrlMapExample($service, $project, $targetHttpsProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetUrlMapTargetHttpsProxies($project, $targetHttpsProxy, $optParams);
	}
	catch (Exception $e)
	{
