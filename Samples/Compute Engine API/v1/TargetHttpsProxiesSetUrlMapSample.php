...
print_r(setUrlMap($service, $project, $targetHttpsProxy));
...
*/
function setUrlMap($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->setUrlMap($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
