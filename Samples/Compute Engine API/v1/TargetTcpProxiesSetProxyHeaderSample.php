...
$results = targetTcpProxiesSetProxyHeaderExample($service, $project, $targetTcpProxy, $optParams);
...
* @return Operation
*/
function targetTcpProxiesSetProxyHeaderExample($service, $project, $targetTcpProxy, $optParams)
{
	try
	{
		...
		return $service->targetTcpProxies->SetProxyHeaderTargetTcpProxies($project, $targetTcpProxy, $optParams);
	}
	catch (Exception $e)
	{
