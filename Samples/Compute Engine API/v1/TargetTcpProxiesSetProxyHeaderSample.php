...
print_r(targetTcpProxiesSetProxyHeaderExample($service, $project, $targetTcpProxy));
...
*/
function targetTcpProxiesSetProxyHeaderExample($service, $project, $targetTcpProxy)
{
	try
	{
		...
		return $service->targetTcpProxies->SetProxyHeaderTargetTcpProxies($project, $targetTcpProxy);
	}
	catch (Exception $ex)
	{
