...
// Single Request.
$results = snapshotsListExample($service, $project, $optParams);
...
* @return SnapshotList
*/
function snapshotsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->snapshots->ListSnapshots($project, $optParams);
	}
	catch (Exception $e)
	{
