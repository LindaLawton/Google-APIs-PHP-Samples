...
print_r(healthChecksInsertExample($service, $project));
...
*/
function healthChecksInsertExample($service, $project)
{
	try
	{
		...
		return $service->healthChecks->InsertHealthChecks($project);
	}
	catch (Exception $ex)
	{
