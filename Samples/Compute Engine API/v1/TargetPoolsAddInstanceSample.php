...
print_r(addInstance($service, $project, $region, $targetPool));
...
*/
function addInstance($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->addInstance($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
