...
print_r(delete($service, $project, $zone, $targetInstance));
...
*/
function delete($service, $project, $zone, $targetInstance)
{
	try
	{
		...
		return $service->delete($project, $zone, $targetInstance);
	}
	catch (Exception $ex)
	{
