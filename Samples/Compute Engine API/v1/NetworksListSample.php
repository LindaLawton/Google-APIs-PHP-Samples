...
print_r(networksListExample($service, $project));

/**
* Retrieves the list of networks available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return NetworkList</returns>
*/
function networksListExample($service, $project)
{
	try
	{
		...
		return $service->networks->ListNetworks($project);
	}
	catch (Exception $ex)
	{
