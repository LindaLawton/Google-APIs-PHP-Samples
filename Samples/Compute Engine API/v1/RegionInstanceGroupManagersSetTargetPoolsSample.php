...
print_r(setTargetPools($service, $project, $region, $instanceGroupManager));
...
*/
function setTargetPools($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->setTargetPools($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
