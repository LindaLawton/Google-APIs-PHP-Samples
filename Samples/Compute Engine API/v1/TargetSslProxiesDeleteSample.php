...
// Single Request.
$results = targetSslProxiesDeleteExample($service, $project, $targetSslProxy, $optParams);
...
* @return Operation
*/
function targetSslProxiesDeleteExample($service, $project, $targetSslProxy, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->DeleteTargetSslProxies($project, $targetSslProxy, $optParams);
	}
	catch (Exception $e)
	{
