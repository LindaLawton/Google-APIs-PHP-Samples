...
$results = regionCommitmentsGetExample($service, $project, $region, $commitment, $optParams);
...
* @return Commitment
*/
function regionCommitmentsGetExample($service, $project, $region, $commitment, $optParams)
{
	try
	{
		...
		if (commitment == null)
			throw new Exception("commitment is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (region == null)
			throw new Exception("region is required.");
		// Make the request and return the results.
		return $service->regionCommitments->GetRegionCommitments($project, $region, $commitment, $optParams);
	}
	catch (Exception $e)
	{
