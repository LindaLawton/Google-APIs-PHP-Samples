...
print_r(regionCommitmentsGetExample($service, $project, $region, $commitment));
...
* @return Commitment</returns>
*/
function regionCommitmentsGetExample($service, $project, $region, $commitment)
{
	try
	{
		...
		return $service->regionCommitments->GetRegionCommitments($project, $region, $commitment);
	}
	catch (Exception $ex)
	{
