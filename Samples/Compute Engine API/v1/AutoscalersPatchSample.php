...
print_r(autoscalersPatchExample($service, $project, $zone));
...
*/
function autoscalersPatchExample($service, $project, $zone)
{
	try
	{
		...
		return $service->autoscalers->PatchAutoscalers($project, $zone);
	}
	catch (Exception $ex)
	{
