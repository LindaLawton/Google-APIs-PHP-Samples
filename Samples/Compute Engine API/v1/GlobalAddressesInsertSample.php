...
// Single Request.
$results = globalAddressesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function globalAddressesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalAddresses->InsertGlobalAddresses($project, $optParams);
	}
	catch (Exception $e)
	{
