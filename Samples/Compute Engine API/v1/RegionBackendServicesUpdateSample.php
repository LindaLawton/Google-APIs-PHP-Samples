...
print_r(regionBackendServicesUpdateExample($service, $project, $region, $backendService));
...
*/
function regionBackendServicesUpdateExample($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->regionBackendServices->UpdateRegionBackendServices($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
