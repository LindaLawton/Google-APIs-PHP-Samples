...
print_r(update($service, $project, $region, $backendService));
...
*/
function update($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->update($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
