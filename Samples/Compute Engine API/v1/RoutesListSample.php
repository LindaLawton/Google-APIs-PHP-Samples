...
// Single Request.
$results = routesListExample($service, $project, $optParams);
...
* @return RouteList
*/
function routesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->routes->ListRoutes($project, $optParams);
	}
	catch (Exception $e)
	{
