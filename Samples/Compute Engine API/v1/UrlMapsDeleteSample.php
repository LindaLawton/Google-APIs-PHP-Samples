...
print_r(urlMapsDeleteExample($service, $project, $urlMap));
...
*/
function urlMapsDeleteExample($service, $project, $urlMap)
{
	try
	{
		...
		return $service->urlMaps->DeleteUrlMaps($project, $urlMap);
	}
	catch (Exception $ex)
	{
