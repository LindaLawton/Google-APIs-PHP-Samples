...
$results = urlMapsDeleteExample($service, $project, $urlMap, $optParams);
...
* @return Operation
*/
function urlMapsDeleteExample($service, $project, $urlMap, $optParams)
{
	try
	{
		...
		return $service->urlMaps->DeleteUrlMaps($project, $urlMap, $optParams);
	}
	catch (Exception $e)
	{
