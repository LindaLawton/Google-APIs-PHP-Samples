...
// Single Request.
$results = urlMapsPatchExample($service, $project, $urlMap, $optParams);
...
* @return Operation
*/
function urlMapsPatchExample($service, $project, $urlMap, $optParams)
{
	try
	{
		...
		return $service->urlMaps->PatchUrlMaps($project, $urlMap, $optParams);
	}
	catch (Exception $e)
	{
