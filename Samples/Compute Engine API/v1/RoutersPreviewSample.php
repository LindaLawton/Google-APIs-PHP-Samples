...
// Single Request.
$results = routersPreviewExample($service, $project, $region, $router, $optParams);
...
*/
function routersPreviewExample($service, $project, $region, $router, $optParams)
{
	try
	{
		...
		return $service->routers->PreviewRouters($project, $region, $router, $optParams);
	}
	catch (Exception $e)
	{
