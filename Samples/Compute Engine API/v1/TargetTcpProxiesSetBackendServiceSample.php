...
// Single Request.
$results = targetTcpProxiesSetBackendServiceExample($service, $project, $targetTcpProxy, $optParams);
...
* @return Operation
*/
function targetTcpProxiesSetBackendServiceExample($service, $project, $targetTcpProxy, $optParams)
{
	try
	{
		...
		if (targetTcpProxy == null)
			throw new Exception("targetTcpProxy is required.");
		// Make the request and return the results.
		return $service->targetTcpProxies->SetBackendServiceTargetTcpProxies($project, $targetTcpProxy, $optParams);
	}
	catch (Exception $e)
	{
