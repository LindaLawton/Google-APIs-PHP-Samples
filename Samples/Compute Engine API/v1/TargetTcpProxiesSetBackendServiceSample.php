...
print_r(targetTcpProxiesSetBackendServiceExample($service, $project, $targetTcpProxy));
...
*/
function targetTcpProxiesSetBackendServiceExample($service, $project, $targetTcpProxy)
{
	try
	{
		...
		return $service->targetTcpProxies->SetBackendServiceTargetTcpProxies($project, $targetTcpProxy);
	}
	catch (Exception $ex)
	{
