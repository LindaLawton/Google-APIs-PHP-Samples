...
print_r(setBackendService($service, $project, $targetSslProxy));
...
*/
function setBackendService($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->setBackendService($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
