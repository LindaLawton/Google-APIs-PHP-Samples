...
print_r(targetSslProxiesSetBackendServiceExample($service, $project, $targetSslProxy));
...
*/
function targetSslProxiesSetBackendServiceExample($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->targetSslProxies->SetBackendServiceTargetSslProxies($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
