...
$results = forwardingRulesInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function forwardingRulesInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->InsertForwardingRules($project, $region, $optParams);
	}
	catch (Exception $e)
	{
