...
$results = subnetworksInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function subnetworksInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->subnetworks->InsertSubnetworks($project, $region, $optParams);
	}
	catch (Exception $e)
	{
