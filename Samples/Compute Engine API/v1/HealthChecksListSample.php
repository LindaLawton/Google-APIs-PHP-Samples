...
// Single Request.
$results = healthChecksListExample($service, $project, $optParams);
...
*/
function healthChecksListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->healthChecks->ListHealthChecks($project, $optParams);
	}
	catch (Exception $e)
	{
