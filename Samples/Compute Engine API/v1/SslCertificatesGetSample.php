...
// Single Request.
$results = sslCertificatesGetExample($service, $project, $sslCertificate, $optParams);
...
*/
function sslCertificatesGetExample($service, $project, $sslCertificate, $optParams)
{
	try
	{
		...
		return $service->sslCertificates->GetSslCertificates($project, $sslCertificate, $optParams);
	}
	catch (Exception $e)
	{
