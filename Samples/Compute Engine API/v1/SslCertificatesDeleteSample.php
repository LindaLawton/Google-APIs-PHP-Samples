...
// Single Request.
$results = sslCertificatesDeleteExample($service, $project, $sslCertificate, $optParams);
...
* @return Operation
*/
function sslCertificatesDeleteExample($service, $project, $sslCertificate, $optParams)
{
	try
	{
		...
		if (sslCertificate == null)
			throw new Exception("sslCertificate is required.");
		// Make the request and return the results.
		return $service->sslCertificates->DeleteSslCertificates($project, $sslCertificate, $optParams);
	}
	catch (Exception $e)
	{
