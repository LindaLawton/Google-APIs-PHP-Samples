...
$results = firewallsGetExample($service, $project, $firewall, $optParams);
...
* @return Firewall
*/
function firewallsGetExample($service, $project, $firewall, $optParams)
{
	try
	{
		...
		return $service->firewalls->GetFirewalls($project, $firewall, $optParams);
	}
	catch (Exception $e)
	{
