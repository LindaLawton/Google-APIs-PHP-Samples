...
print_r(projectsGetXpnResourcesExample($service, $project));
...
* @return ProjectsGetXpnResources</returns>
*/
function projectsGetXpnResourcesExample($service, $project)
{
	try
	{
		...
		return $service->projects->GetXpnResourcesProjects($project);
	}
	catch (Exception $ex)
	{
