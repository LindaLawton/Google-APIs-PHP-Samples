...
print_r(projectsMoveInstanceExample($service, $project));
...
*/
function projectsMoveInstanceExample($service, $project)
{
	try
	{
		...
		return $service->projects->MoveInstanceProjects($project);
	}
	catch (Exception $ex)
	{
