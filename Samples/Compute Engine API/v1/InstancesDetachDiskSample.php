...
print_r(instancesDetachDiskExample($service, $project, $zone, $instance, $deviceName));
...
*/
function instancesDetachDiskExample($service, $project, $zone, $instance, $deviceName)
{
	try
	{
		...
		return $service->instances->DetachDiskInstances($project, $zone, $instance, $deviceName);
	}
	catch (Exception $ex)
	{
