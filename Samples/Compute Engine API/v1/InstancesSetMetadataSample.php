...
// Single Request.
$results = instancesSetMetadataExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetMetadataExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetMetadataInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
