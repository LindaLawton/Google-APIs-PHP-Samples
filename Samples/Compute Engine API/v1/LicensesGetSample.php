...
// Single Request.
$results = licensesGetExample($service, $project, $license, $optParams);
...
* @return License
*/
function licensesGetExample($service, $project, $license, $optParams)
{
	try
	{
		...
		return $service->licenses->GetLicenses($project, $license, $optParams);
	}
	catch (Exception $e)
	{
