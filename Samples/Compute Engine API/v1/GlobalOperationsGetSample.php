...
print_r(globalOperationsGetExample($service, $project, $operation));
...
*/
function globalOperationsGetExample($service, $project, $operation)
{
	try
	{
		...
		return $service->globalOperations->GetGlobalOperations($project, $operation);
	}
	catch (Exception $ex)
	{
