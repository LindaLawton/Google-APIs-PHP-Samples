...
// Single Request.
$results = globalOperationsGetExample($service, $project, $operation, $optParams);
...
* @return Operation
*/
function globalOperationsGetExample($service, $project, $operation, $optParams)
{
	try
	{
		...
		return $service->globalOperations->GetGlobalOperations($project, $operation, $optParams);
	}
	catch (Exception $e)
	{
