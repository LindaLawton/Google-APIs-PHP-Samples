...
// Single Request.
$results = targetHttpsProxiesListExample($service, $project, $optParams);
...
*/
function targetHttpsProxiesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->ListTargetHttpsProxies($project, $optParams);
	}
	catch (Exception $e)
	{
