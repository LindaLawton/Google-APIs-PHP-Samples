...
print_r(routersGetExample($service, $project, $region, $router));
...
*/
function routersGetExample($service, $project, $region, $router)
{
	try
	{
		...
		return $service->routers->GetRouters($project, $region, $router);
	}
	catch (Exception $ex)
	{
