...
// Single Request.
$results = backendServicesDeleteExample($service, $project, $backendService, $optParams);
...
* @return Operation
*/
function backendServicesDeleteExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->DeleteBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
