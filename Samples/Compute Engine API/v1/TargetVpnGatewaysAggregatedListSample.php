...
// Single Request.
$results = targetVpnGatewaysAggregatedListExample($service, $project, $optParams);
...
*/
function targetVpnGatewaysAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetVpnGateways->AggregatedListTargetVpnGateways($project, $optParams);
	}
	catch (Exception $e)
	{
