...
// Single Request.
$results = regionInstanceGroupManagersAbandonInstancesExample($service, $project, $region, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function regionInstanceGroupManagersAbandonInstancesExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->AbandonInstancesRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
