...
print_r(addressesInsertExample($service, $project, $region));
...
*/
function addressesInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->addresses->InsertAddresses($project, $region);
	}
	catch (Exception $ex)
	{
