...
// Single Request.
$results = backendServicesGetExample($service, $project, $backendService, $optParams);
...
*/
function backendServicesGetExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->GetBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
