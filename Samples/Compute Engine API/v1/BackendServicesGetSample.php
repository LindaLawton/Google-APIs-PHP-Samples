...
print_r(backendServicesGetExample($service, $project, $backendService));
...
*/
function backendServicesGetExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->GetBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
