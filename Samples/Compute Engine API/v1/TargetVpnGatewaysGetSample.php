...
print_r(targetVpnGatewaysGetExample($service, $project, $region, $targetVpnGateway));
...
* @return TargetVpnGateway</returns>
*/
function targetVpnGatewaysGetExample($service, $project, $region, $targetVpnGateway)
{
	try
	{
		...
		return $service->targetVpnGateways->GetTargetVpnGateways($project, $region, $targetVpnGateway);
	}
	catch (Exception $ex)
	{
