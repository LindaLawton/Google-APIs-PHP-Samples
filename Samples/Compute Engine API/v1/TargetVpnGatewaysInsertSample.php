...
$results = targetVpnGatewaysInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function targetVpnGatewaysInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->targetVpnGateways->InsertTargetVpnGateways($project, $region, $optParams);
	}
	catch (Exception $e)
	{
