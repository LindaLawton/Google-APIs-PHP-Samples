...
// Single Request.
$results = instanceTemplatesGetExample($service, $project, $instanceTemplate, $optParams);
...
*/
function instanceTemplatesGetExample($service, $project, $instanceTemplate, $optParams)
{
	try
	{
		...
		return $service->instanceTemplates->GetInstanceTemplates($project, $instanceTemplate, $optParams);
	}
	catch (Exception $e)
	{
