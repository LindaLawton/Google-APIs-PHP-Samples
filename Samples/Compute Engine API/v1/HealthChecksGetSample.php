...
print_r(healthChecksGetExample($service, $project, $healthCheck));
...
* @return HealthCheck</returns>
*/
function healthChecksGetExample($service, $project, $healthCheck)
{
	try
	{
		...
		return $service->healthChecks->GetHealthChecks($project, $healthCheck);
	}
	catch (Exception $ex)
	{
