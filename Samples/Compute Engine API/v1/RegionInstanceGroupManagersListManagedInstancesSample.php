...
print_r(listManagedInstances($service, $project, $region, $instanceGroupManager));
...
*/
function listManagedInstances($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->listManagedInstances($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
