...
$results = regionInstanceGroupManagersListManagedInstancesExample($service, $project, $region, $instanceGroupManager, $optParams);
...
*/
function regionInstanceGroupManagersListManagedInstancesExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ListManagedInstancesRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
