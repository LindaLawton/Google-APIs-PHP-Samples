...
print_r(regionInstanceGroupManagersListManagedInstancesExample($service, $project, $region, $instanceGroupManager));
...
* @return RegionInstanceGroupManagersListInstancesResponse</returns>
*/
function regionInstanceGroupManagersListManagedInstancesExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ListManagedInstancesRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
