...
print_r(forwardingRulesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of forwarding rules.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return ForwardingRuleAggregatedList</returns>
*/
function forwardingRulesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->forwardingRules->AggregatedListForwardingRules($project);
	}
	catch (Exception $ex)
	{
