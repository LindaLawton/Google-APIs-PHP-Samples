...
print_r(httpsHealthChecksInsertExample($service, $project));
...
*/
function httpsHealthChecksInsertExample($service, $project)
{
	try
	{
		...
		return $service->httpsHealthChecks->InsertHttpsHealthChecks($project);
	}
	catch (Exception $ex)
	{
