...
print_r(setSslCertificates($service, $project, $targetHttpsProxy));
...
*/
function setSslCertificates($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->setSslCertificates($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
