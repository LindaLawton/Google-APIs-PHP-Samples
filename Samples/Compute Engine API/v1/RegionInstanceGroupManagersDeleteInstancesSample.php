...
print_r(deleteInstances($service, $project, $region, $instanceGroupManager));
...
*/
function deleteInstances($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->deleteInstances($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
