...
print_r(backendBucketsInsertExample($service, $project));
...
*/
function backendBucketsInsertExample($service, $project)
{
	try
	{
		...
		return $service->backendBuckets->InsertBackendBuckets($project);
	}
	catch (Exception $ex)
	{
