...
print_r(httpsHealthChecksPatchExample($service, $project, $httpsHealthCheck));
...
*/
function httpsHealthChecksPatchExample($service, $project, $httpsHealthCheck)
{
	try
	{
		...
		return $service->httpsHealthChecks->PatchHttpsHealthChecks($project, $httpsHealthCheck);
	}
	catch (Exception $ex)
	{
