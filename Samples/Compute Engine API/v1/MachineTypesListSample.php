...
// Single Request.
$results = machineTypesListExample($service, $project, $zone, $optParams);
...
*/
function machineTypesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->machineTypes->ListMachineTypes($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
