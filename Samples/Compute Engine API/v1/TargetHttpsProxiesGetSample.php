...
print_r(targetHttpsProxiesGetExample($service, $project, $targetHttpsProxy));
...
* @return TargetHttpsProxy</returns>
*/
function targetHttpsProxiesGetExample($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->targetHttpsProxies->GetTargetHttpsProxies($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
