...
// Single Request.
$results = sslCertificatesListExample($service, $project, $optParams);
...
*/
function sslCertificatesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->sslCertificates->ListSslCertificates($project, $optParams);
	}
	catch (Exception $e)
	{
