...
print_r(zoneOperationsDeleteExample($service, $project, $zone, $operation));
...
*/
function zoneOperationsDeleteExample($service, $project, $zone, $operation)
{
	try
	{
		...
		return $service->zoneOperations->DeleteZoneOperations($project, $zone, $operation);
	}
	catch (Exception $ex)
	{
