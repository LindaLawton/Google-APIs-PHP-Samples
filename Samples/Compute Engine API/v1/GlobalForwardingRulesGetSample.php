...
// Single Request.
$results = globalForwardingRulesGetExample($service, $project, $forwardingRule, $optParams);
...
*/
function globalForwardingRulesGetExample($service, $project, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->GetGlobalForwardingRules($project, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
