...
// Single Request.
$results = instancesStartExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesStartExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->StartInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
