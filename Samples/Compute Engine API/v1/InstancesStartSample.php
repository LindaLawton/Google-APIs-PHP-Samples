...
print_r(instancesStartExample($service, $project, $zone, $instance));
...
*/
function instancesStartExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->StartInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
