...
$results = regionInstanceGroupManagersInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionInstanceGroupManagersInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->InsertRegionInstanceGroupManagers($project, $region, $optParams);
	}
	catch (Exception $e)
	{
