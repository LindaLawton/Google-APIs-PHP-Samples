...
// Single Request.
$results = targetInstancesListExample($service, $project, $zone, $optParams);
...
*/
function targetInstancesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->targetInstances->ListTargetInstances($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
