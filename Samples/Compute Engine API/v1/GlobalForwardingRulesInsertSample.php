...
// Single Request.
$results = globalForwardingRulesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function globalForwardingRulesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->InsertGlobalForwardingRules($project, $optParams);
	}
	catch (Exception $e)
	{
