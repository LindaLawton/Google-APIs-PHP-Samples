...
print_r(globalForwardingRulesInsertExample($service, $project));
...
*/
function globalForwardingRulesInsertExample($service, $project)
{
	try
	{
		...
		return $service->globalForwardingRules->InsertGlobalForwardingRules($project);
	}
	catch (Exception $ex)
	{
