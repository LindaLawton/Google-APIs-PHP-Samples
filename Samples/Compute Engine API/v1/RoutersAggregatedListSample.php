...
// Single Request.
$results = routersAggregatedListExample($service, $project, $optParams);
...
*/
function routersAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->routers->AggregatedListRouters($project, $optParams);
	}
	catch (Exception $e)
	{
