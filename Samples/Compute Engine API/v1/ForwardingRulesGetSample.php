...
// Single Request.
$results = forwardingRulesGetExample($service, $project, $region, $forwardingRule, $optParams);
...
*/
function forwardingRulesGetExample($service, $project, $region, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->GetForwardingRules($project, $region, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
