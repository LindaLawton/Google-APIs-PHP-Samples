...
print_r(forwardingRulesGetExample($service, $project, $region, $forwardingRule));
...
*/
function forwardingRulesGetExample($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->forwardingRules->GetForwardingRules($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
