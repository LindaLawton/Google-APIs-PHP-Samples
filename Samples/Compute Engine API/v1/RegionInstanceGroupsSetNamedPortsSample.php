...
print_r(setNamedPorts($service, $project, $region, $instanceGroup));
...
*/
function setNamedPorts($service, $project, $region, $instanceGroup)
{
	try
	{
		...
		return $service->setNamedPorts($project, $region, $instanceGroup);
	}
	catch (Exception $ex)
	{
