...
print_r(regionInstanceGroupsSetNamedPortsExample($service, $project, $region, $instanceGroup));
...
*/
function regionInstanceGroupsSetNamedPortsExample($service, $project, $region, $instanceGroup)
{
	try
	{
		...
		return $service->regionInstanceGroups->SetNamedPortsRegionInstanceGroups($project, $region, $instanceGroup);
	}
	catch (Exception $ex)
	{
