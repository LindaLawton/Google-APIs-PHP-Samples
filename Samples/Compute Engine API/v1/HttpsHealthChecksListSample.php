...
print_r(httpsHealthChecksListExample($service, $project));

/**
* Retrieves the list of HttpsHealthCheck resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return HttpsHealthCheckList</returns>
*/
function httpsHealthChecksListExample($service, $project)
{
	try
	{
		...
		return $service->httpsHealthChecks->ListHttpsHealthChecks($project);
	}
	catch (Exception $ex)
	{
