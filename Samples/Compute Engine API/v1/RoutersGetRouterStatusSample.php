...
print_r(routersGetRouterStatusExample($service, $project, $region, $router));
...
* @return RouterStatusResponse</returns>
*/
function routersGetRouterStatusExample($service, $project, $region, $router)
{
	try
	{
		...
		return $service->routers->GetRouterStatusRouters($project, $region, $router);
	}
	catch (Exception $ex)
	{
