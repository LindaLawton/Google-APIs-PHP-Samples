...
// Single Request.
$results = snapshotsGetExample($service, $project, $snapshot, $optParams);
...
* @return Snapshot
*/
function snapshotsGetExample($service, $project, $snapshot, $optParams)
{
	try
	{
		...
		return $service->snapshots->GetSnapshots($project, $snapshot, $optParams);
	}
	catch (Exception $e)
	{
