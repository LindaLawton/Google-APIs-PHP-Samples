...
$results = regionCommitmentsAggregatedListExample($service, $project, $optParams);
...
*/
function regionCommitmentsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->regionCommitments->AggregatedListRegionCommitments($project, $optParams);
	}
	catch (Exception $e)
	{
