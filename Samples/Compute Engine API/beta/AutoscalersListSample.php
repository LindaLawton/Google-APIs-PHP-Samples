...
// Single Request.
$results = autoscalersListExample($service, $project, $zone, $optParams);
...
*/
function autoscalersListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->autoscalers->ListAutoscalers($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
