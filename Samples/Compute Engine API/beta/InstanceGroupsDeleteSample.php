...
print_r(instanceGroupsDeleteExample($service, $project, $zone, $instanceGroup));
...
*/
function instanceGroupsDeleteExample($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->instanceGroups->DeleteInstanceGroups($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
