...
$results = instanceGroupsDeleteExample($service, $project, $zone, $instanceGroup, $optParams);
...
* @return Operation
*/
function instanceGroupsDeleteExample($service, $project, $zone, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->DeleteInstanceGroups($project, $zone, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
