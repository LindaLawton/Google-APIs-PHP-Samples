...
// Single Request.
$results = networksDeleteExample($service, $project, $network, $optParams);
...
* @return Operation
*/
function networksDeleteExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->DeleteNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
