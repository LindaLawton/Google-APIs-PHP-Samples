...
print_r(projectsEnableXpnResourceExample($service, $project));
...
*/
function projectsEnableXpnResourceExample($service, $project)
{
	try
	{
		...
		return $service->projects->EnableXpnResourceProjects($project);
	}
	catch (Exception $ex)
	{
