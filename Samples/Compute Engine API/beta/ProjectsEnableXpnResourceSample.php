...
// Single Request.
$results = projectsEnableXpnResourceExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsEnableXpnResourceExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->EnableXpnResourceProjects($project, $optParams);
	}
	catch (Exception $e)
	{
