...
print_r(interconnectsDeleteExample($service, $project, $interconnect));
...
*/
function interconnectsDeleteExample($service, $project, $interconnect)
{
	try
	{
		...
		return $service->interconnects->DeleteInterconnects($project, $interconnect);
	}
	catch (Exception $ex)
	{
