...
// Single Request.
$results = interconnectsDeleteExample($service, $project, $interconnect, $optParams);
...
* @return Operation
*/
function interconnectsDeleteExample($service, $project, $interconnect, $optParams)
{
	try
	{
		...
		if (interconnect == null)
			throw new Exception("interconnect is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->interconnects->DeleteInterconnects($project, $interconnect, $optParams);
	}
	catch (Exception $e)
	{
