...
// Single Request.
$results = addressesListExample($service, $project, $region, $optParams);
...
* @return AddressList
*/
function addressesListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->addresses->ListAddresses($project, $region, $optParams);
	}
	catch (Exception $e)
	{
