...
$results = projectsSetUsageExportBucketExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsSetUsageExportBucketExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->SetUsageExportBucketProjects($project, $optParams);
	}
	catch (Exception $e)
	{
