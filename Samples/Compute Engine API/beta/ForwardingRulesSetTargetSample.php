...
print_r(forwardingRulesSetTargetExample($service, $project, $region, $forwardingRule));
...
*/
function forwardingRulesSetTargetExample($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->forwardingRules->SetTargetForwardingRules($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
