...
// Single Request.
$results = httpHealthChecksDeleteExample($service, $project, $httpHealthCheck, $optParams);
...
* @return Operation
*/
function httpHealthChecksDeleteExample($service, $project, $httpHealthCheck, $optParams)
{
	try
	{
		...
		if (httpHealthCheck == null)
			throw new Exception("httpHealthCheck is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->httpHealthChecks->DeleteHttpHealthChecks($project, $httpHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
