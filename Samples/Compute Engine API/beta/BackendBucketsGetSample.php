...
print_r(backendBucketsGetExample($service, $project, $backendBucket));
...
* @return BackendBucket</returns>
*/
function backendBucketsGetExample($service, $project, $backendBucket)
{
	try
	{
		...
		return $service->backendBuckets->GetBackendBuckets($project, $backendBucket);
	}
	catch (Exception $ex)
	{
