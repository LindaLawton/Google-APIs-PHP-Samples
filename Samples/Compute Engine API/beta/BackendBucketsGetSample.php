...
// Single Request.
$results = backendBucketsGetExample($service, $project, $backendBucket, $optParams);
...
*/
function backendBucketsGetExample($service, $project, $backendBucket, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->GetBackendBuckets($project, $backendBucket, $optParams);
	}
	catch (Exception $e)
	{
