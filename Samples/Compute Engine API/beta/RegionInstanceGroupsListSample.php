...
// Single Request.
$results = regionInstanceGroupsListExample($service, $project, $region, $optParams);
...
*/
function regionInstanceGroupsListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroups->ListRegionInstanceGroups($project, $region, $optParams);
	}
	catch (Exception $e)
	{
