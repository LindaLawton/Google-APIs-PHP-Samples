...
print_r(regionInstanceGroupsListExample($service, $project, $region));
...
* @return RegionInstanceGroupList</returns>
*/
function regionInstanceGroupsListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionInstanceGroups->ListRegionInstanceGroups($project, $region);
	}
	catch (Exception $ex)
	{
