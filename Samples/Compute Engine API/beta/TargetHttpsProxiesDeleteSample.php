...
// Single Request.
$results = targetHttpsProxiesDeleteExample($service, $project, $targetHttpsProxy, $optParams);
...
* @return Operation
*/
function targetHttpsProxiesDeleteExample($service, $project, $targetHttpsProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->DeleteTargetHttpsProxies($project, $targetHttpsProxy, $optParams);
	}
	catch (Exception $e)
	{
