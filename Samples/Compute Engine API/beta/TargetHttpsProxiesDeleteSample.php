...
print_r(targetHttpsProxiesDeleteExample($service, $project, $targetHttpsProxy));
...
*/
function targetHttpsProxiesDeleteExample($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->targetHttpsProxies->DeleteTargetHttpsProxies($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
