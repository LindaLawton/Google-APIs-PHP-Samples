...
$results = instanceGroupsAddInstancesExample($service, $project, $zone, $instanceGroup, $optParams);
...
* @return Operation
*/
function instanceGroupsAddInstancesExample($service, $project, $zone, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->AddInstancesInstanceGroups($project, $zone, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
