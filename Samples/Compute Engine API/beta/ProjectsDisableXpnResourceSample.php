...
// Single Request.
$results = projectsDisableXpnResourceExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsDisableXpnResourceExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->DisableXpnResourceProjects($project, $optParams);
	}
	catch (Exception $e)
	{
