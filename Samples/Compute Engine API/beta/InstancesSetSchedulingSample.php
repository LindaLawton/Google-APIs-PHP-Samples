...
print_r(setScheduling($service, $project, $zone, $instance));
...
*/
function setScheduling($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->setScheduling($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
