...
print_r(instancesInsertExample($service, $project, $zone));
...
*/
function instancesInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->instances->InsertInstances($project, $zone);
	}
	catch (Exception $ex)
	{
