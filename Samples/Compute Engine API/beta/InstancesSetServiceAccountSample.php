...
print_r(setServiceAccount($service, $project, $zone, $instance));
...
*/
function setServiceAccount($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->setServiceAccount($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
