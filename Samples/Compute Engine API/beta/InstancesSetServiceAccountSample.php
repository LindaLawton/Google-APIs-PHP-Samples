...
print_r(instancesSetServiceAccountExample($service, $project, $zone, $instance));
...
*/
function instancesSetServiceAccountExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetServiceAccountInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
