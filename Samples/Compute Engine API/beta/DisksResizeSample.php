...
$results = disksResizeExample($service, $project, $zone, $disk, $optParams);
...
* @return Operation
*/
function disksResizeExample($service, $project, $zone, $disk, $optParams)
{
	try
	{
		...
		return $service->disks->ResizeDisks($project, $zone, $disk, $optParams);
	}
	catch (Exception $e)
	{
