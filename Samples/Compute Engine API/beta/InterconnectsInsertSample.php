...
$results = interconnectsInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function interconnectsInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->interconnects->InsertInterconnects($project, $optParams);
	}
	catch (Exception $e)
	{
