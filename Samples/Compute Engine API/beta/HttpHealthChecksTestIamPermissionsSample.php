...
$results = httpHealthChecksTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function httpHealthChecksTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->httpHealthChecks->TestIamPermissionsHttpHealthChecks($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
