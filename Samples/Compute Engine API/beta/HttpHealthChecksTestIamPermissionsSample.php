...
print_r(httpHealthChecksTestIamPermissionsExample($service, $project, $resource));
...
*/
function httpHealthChecksTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->httpHealthChecks->TestIamPermissionsHttpHealthChecks($project, $resource);
	}
	catch (Exception $ex)
	{
