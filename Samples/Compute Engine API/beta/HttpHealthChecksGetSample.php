...
print_r(httpHealthChecksGetExample($service, $project, $httpHealthCheck));
...
* @return HttpHealthCheck</returns>
*/
function httpHealthChecksGetExample($service, $project, $httpHealthCheck)
{
	try
	{
		...
		return $service->httpHealthChecks->GetHttpHealthChecks($project, $httpHealthCheck);
	}
	catch (Exception $ex)
	{
