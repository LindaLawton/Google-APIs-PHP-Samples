...
print_r(deleteAccessConfig($service, $project, $zone, $instance, $accessConfig, $networkInterface));
...
*/
function deleteAccessConfig($service, $project, $zone, $instance, $accessConfig, $networkInterface)
{
	try
	{
		...
		return $service->deleteAccessConfig($project, $zone, $instance, $accessConfig, $networkInterface);
	}
	catch (Exception $ex)
	{
