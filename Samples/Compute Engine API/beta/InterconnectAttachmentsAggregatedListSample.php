...
print_r(interconnectAttachmentsAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of interconnect attachments.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return InterconnectAttachmentAggregatedList</returns>
*/
function interconnectAttachmentsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->interconnectAttachments->AggregatedListInterconnectAttachments($project);
	}
	catch (Exception $ex)
	{
