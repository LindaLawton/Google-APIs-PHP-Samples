...
$results = interconnectAttachmentsAggregatedListExample($service, $project, $optParams);
...
*/
function interconnectAttachmentsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->AggregatedListInterconnectAttachments($project, $optParams);
	}
	catch (Exception $e)
	{
