...
// Single Request.
$results = disksDeleteExample($service, $project, $zone, $disk, $optParams);
...
* @return Operation
*/
function disksDeleteExample($service, $project, $zone, $disk, $optParams)
{
	try
	{
		...
		return $service->disks->DeleteDisks($project, $zone, $disk, $optParams);
	}
	catch (Exception $e)
	{
