...
print_r(globalAddressesSetLabelsExample($service, $project, $resource));
...
*/
function globalAddressesSetLabelsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->globalAddresses->SetLabelsGlobalAddresses($project, $resource);
	}
	catch (Exception $ex)
	{
