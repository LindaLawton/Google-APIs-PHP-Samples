...
// Single Request.
$results = globalForwardingRulesDeleteExample($service, $project, $forwardingRule, $optParams);
...
* @return Operation
*/
function globalForwardingRulesDeleteExample($service, $project, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->DeleteGlobalForwardingRules($project, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
