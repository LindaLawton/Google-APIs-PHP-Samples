...
// Single Request.
$results = subnetworksDeleteExample($service, $project, $region, $subnetwork, $optParams);
...
* @return Operation
*/
function subnetworksDeleteExample($service, $project, $region, $subnetwork, $optParams)
{
	try
	{
		...
		return $service->subnetworks->DeleteSubnetworks($project, $region, $subnetwork, $optParams);
	}
	catch (Exception $e)
	{
