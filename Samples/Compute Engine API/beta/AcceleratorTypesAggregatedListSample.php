...
// Single Request.
$results = acceleratorTypesAggregatedListExample($service, $project, $optParams);
...
*/
function acceleratorTypesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->acceleratorTypes->AggregatedListAcceleratorTypes($project, $optParams);
	}
	catch (Exception $e)
	{
