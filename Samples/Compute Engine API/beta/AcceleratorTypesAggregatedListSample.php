...
print_r(acceleratorTypesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of accelerator types.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return AcceleratorTypeAggregatedList</returns>
*/
function acceleratorTypesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->acceleratorTypes->AggregatedListAcceleratorTypes($project);
	}
	catch (Exception $ex)
	{
