...
print_r(targetHttpsProxiesListExample($service, $project));

/**
* Retrieves the list of TargetHttpsProxy resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return TargetHttpsProxyList</returns>
*/
function targetHttpsProxiesListExample($service, $project)
{
	try
	{
		...
		return $service->targetHttpsProxies->ListTargetHttpsProxies($project);
	}
	catch (Exception $ex)
	{
