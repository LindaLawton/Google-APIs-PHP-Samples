...
print_r(backendBucketsPatchExample($service, $project, $backendBucket));
...
*/
function backendBucketsPatchExample($service, $project, $backendBucket)
{
	try
	{
		...
		return $service->backendBuckets->PatchBackendBuckets($project, $backendBucket);
	}
	catch (Exception $ex)
	{
