...
print_r(instanceGroupsInsertExample($service, $project, $zone));
...
*/
function instanceGroupsInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->instanceGroups->InsertInstanceGroups($project, $zone);
	}
	catch (Exception $ex)
	{
