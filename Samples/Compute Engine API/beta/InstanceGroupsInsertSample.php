...
// Single Request.
$results = instanceGroupsInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function instanceGroupsInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->InsertInstanceGroups($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
