...
print_r(firewallsListExample($service, $project));

/**
* Retrieves the list of firewall rules available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return FirewallList</returns>
*/
function firewallsListExample($service, $project)
{
	try
	{
		...
		return $service->firewalls->ListFirewalls($project);
	}
	catch (Exception $ex)
	{
