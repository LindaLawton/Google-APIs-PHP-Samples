...
print_r(urlMapsListExample($service, $project));

/**
* Retrieves the list of UrlMap resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return UrlMapList</returns>
*/
function urlMapsListExample($service, $project)
{
	try
	{
		...
		return $service->urlMaps->ListUrlMaps($project);
	}
	catch (Exception $ex)
	{
