...
print_r(globalForwardingRulesGetExample($service, $project, $forwardingRule));
...
* @return ForwardingRule</returns>
*/
function globalForwardingRulesGetExample($service, $project, $forwardingRule)
{
	try
	{
		...
		return $service->globalForwardingRules->GetGlobalForwardingRules($project, $forwardingRule);
	}
	catch (Exception $ex)
	{
