...
$results = imagesDeleteExample($service, $project, $image, $optParams);
...
* @return Operation
*/
function imagesDeleteExample($service, $project, $image, $optParams)
{
	try
	{
		...
		return $service->images->DeleteImages($project, $image, $optParams);
	}
	catch (Exception $e)
	{
