...
print_r(snapshotsGetExample($service, $project, $snapshot));
...
*/
function snapshotsGetExample($service, $project, $snapshot)
{
	try
	{
		...
		return $service->snapshots->GetSnapshots($project, $snapshot);
	}
	catch (Exception $ex)
	{
