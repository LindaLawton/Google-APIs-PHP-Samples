...
print_r(sslCertificatesListExample($service, $project));

/**
* Retrieves the list of SslCertificate resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return SslCertificateList</returns>
*/
function sslCertificatesListExample($service, $project)
{
	try
	{
		...
		return $service->sslCertificates->ListSslCertificates($project);
	}
	catch (Exception $ex)
	{
