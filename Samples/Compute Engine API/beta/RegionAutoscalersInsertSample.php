...
// Single Request.
$results = regionAutoscalersInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionAutoscalersInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionAutoscalers->InsertRegionAutoscalers($project, $region, $optParams);
	}
	catch (Exception $e)
	{
