...
print_r(setNamedPorts($service, $project, $zone, $instanceGroup));
...
*/
function setNamedPorts($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->setNamedPorts($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
