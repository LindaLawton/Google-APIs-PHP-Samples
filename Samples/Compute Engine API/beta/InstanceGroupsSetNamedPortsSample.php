...
// Single Request.
$results = instanceGroupsSetNamedPortsExample($service, $project, $zone, $instanceGroup, $optParams);
...
* @return Operation
*/
function instanceGroupsSetNamedPortsExample($service, $project, $zone, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->SetNamedPortsInstanceGroups($project, $zone, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
