...
print_r(targetTcpProxiesInsertExample($service, $project));
...
*/
function targetTcpProxiesInsertExample($service, $project)
{
	try
	{
		...
		return $service->targetTcpProxies->InsertTargetTcpProxies($project);
	}
	catch (Exception $ex)
	{
