...
print_r(backendServicesTestIamPermissionsExample($service, $project, $resource));
...
*/
function backendServicesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->backendServices->TestIamPermissionsBackendServices($project, $resource);
	}
	catch (Exception $ex)
	{
