...
print_r(regionCommitmentsListExample($service, $project, $region));
...
* @return CommitmentList</returns>
*/
function regionCommitmentsListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionCommitments->ListRegionCommitments($project, $region);
	}
	catch (Exception $ex)
	{
