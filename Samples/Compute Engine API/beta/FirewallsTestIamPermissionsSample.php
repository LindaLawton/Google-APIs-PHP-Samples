...
print_r(firewallsTestIamPermissionsExample($service, $project, $resource));
...
*/
function firewallsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->firewalls->TestIamPermissionsFirewalls($project, $resource);
	}
	catch (Exception $ex)
	{
