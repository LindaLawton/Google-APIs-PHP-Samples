...
// Single Request.
$results = firewallsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function firewallsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->firewalls->TestIamPermissionsFirewalls($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
