...
// Single Request.
$results = targetPoolsAggregatedListExample($service, $project, $optParams);
...
*/
function targetPoolsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetPools->AggregatedListTargetPools($project, $optParams);
	}
	catch (Exception $e)
	{
