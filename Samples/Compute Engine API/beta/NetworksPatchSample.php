...
print_r(networksPatchExample($service, $project, $network));
...
*/
function networksPatchExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->PatchNetworks($project, $network);
	}
	catch (Exception $ex)
	{
