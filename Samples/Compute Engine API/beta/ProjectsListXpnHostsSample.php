...
print_r(projectsListXpnHostsExample($service, $project));

/**
* List all shared VPC host projects visible to the user in an organization.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return XpnHostList</returns>
*/
function projectsListXpnHostsExample($service, $project)
{
	try
	{
		...
		return $service->projects->ListXpnHostsProjects($project);
	}
	catch (Exception $ex)
	{
