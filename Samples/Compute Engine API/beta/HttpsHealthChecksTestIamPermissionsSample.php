...
// Single Request.
$results = httpsHealthChecksTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function httpsHealthChecksTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->httpsHealthChecks->TestIamPermissionsHttpsHealthChecks($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
