...
print_r(networksRemovePeeringExample($service, $project, $network));
...
*/
function networksRemovePeeringExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->RemovePeeringNetworks($project, $network);
	}
	catch (Exception $ex)
	{
