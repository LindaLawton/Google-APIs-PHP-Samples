...
print_r(securityPoliciesDeleteExample($service, $project, $securityPolicy));
...
*/
function securityPoliciesDeleteExample($service, $project, $securityPolicy)
{
	try
	{
		...
		return $service->securityPolicies->DeleteSecurityPolicies($project, $securityPolicy);
	}
	catch (Exception $ex)
	{
