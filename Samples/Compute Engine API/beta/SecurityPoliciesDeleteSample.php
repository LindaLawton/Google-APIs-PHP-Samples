...
// Single Request.
$results = securityPoliciesDeleteExample($service, $project, $securityPolicy, $optParams);
...
* @return Operation
*/
function securityPoliciesDeleteExample($service, $project, $securityPolicy, $optParams)
{
	try
	{
		...
		if (securityPolicy == null)
			throw new Exception("securityPolicy is required.");
		// Make the request and return the results.
		return $service->securityPolicies->DeleteSecurityPolicies($project, $securityPolicy, $optParams);
	}
	catch (Exception $e)
	{
