...
print_r(vpnTunnelsAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of VPN tunnels.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return VpnTunnelAggregatedList</returns>
*/
function vpnTunnelsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->vpnTunnels->AggregatedListVpnTunnels($project);
	}
	catch (Exception $ex)
	{
