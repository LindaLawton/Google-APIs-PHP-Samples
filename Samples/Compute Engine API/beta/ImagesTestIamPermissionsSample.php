...
$results = imagesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function imagesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->images->TestIamPermissionsImages($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
