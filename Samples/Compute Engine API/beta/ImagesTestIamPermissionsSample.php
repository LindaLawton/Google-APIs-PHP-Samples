...
print_r(imagesTestIamPermissionsExample($service, $project, $resource));
...
*/
function imagesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->images->TestIamPermissionsImages($project, $resource);
	}
	catch (Exception $ex)
	{
