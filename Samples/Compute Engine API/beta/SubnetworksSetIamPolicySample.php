...
print_r(setIamPolicy($service, $project, $region, $resource));
...
*/
function setIamPolicy($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->setIamPolicy($project, $region, $resource);
	}
	catch (Exception $ex)
	{
