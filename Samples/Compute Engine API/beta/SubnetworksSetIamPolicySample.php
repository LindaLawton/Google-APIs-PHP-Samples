...
// Single Request.
$results = subnetworksSetIamPolicyExample($service, $project, $region, $resource, $optParams);
...
* @return Policy
*/
function subnetworksSetIamPolicyExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->subnetworks->SetIamPolicySubnetworks($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
