...
print_r(subnetworksSetIamPolicyExample($service, $project, $region, $resource));
...
*/
function subnetworksSetIamPolicyExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->subnetworks->SetIamPolicySubnetworks($project, $region, $resource);
	}
	catch (Exception $ex)
	{
