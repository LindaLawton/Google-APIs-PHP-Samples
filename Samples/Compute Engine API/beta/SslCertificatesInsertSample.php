...
print_r(sslCertificatesInsertExample($service, $project));
...
*/
function sslCertificatesInsertExample($service, $project)
{
	try
	{
		...
		return $service->sslCertificates->InsertSslCertificates($project);
	}
	catch (Exception $ex)
	{
