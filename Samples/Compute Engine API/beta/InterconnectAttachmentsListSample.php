...
$results = interconnectAttachmentsListExample($service, $project, $region, $optParams);
...
*/
function interconnectAttachmentsListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->ListInterconnectAttachments($project, $region, $optParams);
	}
	catch (Exception $e)
	{
