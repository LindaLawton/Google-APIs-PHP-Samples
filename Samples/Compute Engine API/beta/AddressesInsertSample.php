...
// Single Request.
$results = addressesInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function addressesInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->addresses->InsertAddresses($project, $region, $optParams);
	}
	catch (Exception $e)
	{
