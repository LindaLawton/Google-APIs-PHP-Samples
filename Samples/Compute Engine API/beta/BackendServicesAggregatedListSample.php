...
// Single Request.
$results = backendServicesAggregatedListExample($service, $project, $optParams);
...
*/
function backendServicesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->backendServices->AggregatedListBackendServices($project, $optParams);
	}
	catch (Exception $e)
	{
