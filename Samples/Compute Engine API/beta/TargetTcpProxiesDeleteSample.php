...
print_r(targetTcpProxiesDeleteExample($service, $project, $targetTcpProxy));
...
*/
function targetTcpProxiesDeleteExample($service, $project, $targetTcpProxy)
{
	try
	{
		...
		return $service->targetTcpProxies->DeleteTargetTcpProxies($project, $targetTcpProxy);
	}
	catch (Exception $ex)
	{
