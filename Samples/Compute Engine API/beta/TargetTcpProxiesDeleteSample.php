...
// Single Request.
$results = targetTcpProxiesDeleteExample($service, $project, $targetTcpProxy, $optParams);
...
* @return Operation
*/
function targetTcpProxiesDeleteExample($service, $project, $targetTcpProxy, $optParams)
{
	try
	{
		...
		return $service->targetTcpProxies->DeleteTargetTcpProxies($project, $targetTcpProxy, $optParams);
	}
	catch (Exception $e)
	{
