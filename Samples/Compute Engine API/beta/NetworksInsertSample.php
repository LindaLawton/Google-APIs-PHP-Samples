...
// Single Request.
$results = networksInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function networksInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->networks->InsertNetworks($project, $optParams);
	}
	catch (Exception $e)
	{
