...
// Single Request.
$results = instancesStartWithEncryptionKeyExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesStartWithEncryptionKeyExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->StartWithEncryptionKeyInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
