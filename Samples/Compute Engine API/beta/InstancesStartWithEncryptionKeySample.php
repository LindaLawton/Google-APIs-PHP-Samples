...
print_r(startWithEncryptionKey($service, $project, $zone, $instance));
...
*/
function startWithEncryptionKey($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->startWithEncryptionKey($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
