...
print_r(sslCertificatesGetExample($service, $project, $sslCertificate));
...
* @return SslCertificate</returns>
*/
function sslCertificatesGetExample($service, $project, $sslCertificate)
{
	try
	{
		...
		return $service->sslCertificates->GetSslCertificates($project, $sslCertificate);
	}
	catch (Exception $ex)
	{
