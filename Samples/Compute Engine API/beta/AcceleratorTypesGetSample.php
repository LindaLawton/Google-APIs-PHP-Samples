...
print_r(acceleratorTypesGetExample($service, $project, $zone, $acceleratorType));
...
* @return AcceleratorType</returns>
*/
function acceleratorTypesGetExample($service, $project, $zone, $acceleratorType)
{
	try
	{
		...
		return $service->acceleratorTypes->GetAcceleratorTypes($project, $zone, $acceleratorType);
	}
	catch (Exception $ex)
	{
