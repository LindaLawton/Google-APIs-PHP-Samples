...
// Single Request.
$results = acceleratorTypesGetExample($service, $project, $zone, $acceleratorType, $optParams);
...
*/
function acceleratorTypesGetExample($service, $project, $zone, $acceleratorType, $optParams)
{
	try
	{
		...
		if (acceleratorType == null)
			throw new Exception("acceleratorType is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (zone == null)
			throw new Exception("zone is required.");
		// Make the request and return the results.
		return $service->acceleratorTypes->GetAcceleratorTypes($project, $zone, $acceleratorType, $optParams);
	}
	catch (Exception $e)
	{
