...
// Single Request.
$results = regionBackendServicesGetExample($service, $project, $region, $backendService, $optParams);
...
*/
function regionBackendServicesGetExample($service, $project, $region, $backendService, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->GetRegionBackendServices($project, $region, $backendService, $optParams);
	}
	catch (Exception $e)
	{
