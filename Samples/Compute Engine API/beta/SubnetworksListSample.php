...
print_r(subnetworksListExample($service, $project, $region));
...
* @return SubnetworkList</returns>
*/
function subnetworksListExample($service, $project, $region)
{
	try
	{
		...
		return $service->subnetworks->ListSubnetworks($project, $region);
	}
	catch (Exception $ex)
	{
