...
print_r(forwardingRulesInsertExample($service, $project, $region));
...
*/
function forwardingRulesInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->forwardingRules->InsertForwardingRules($project, $region);
	}
	catch (Exception $ex)
	{
