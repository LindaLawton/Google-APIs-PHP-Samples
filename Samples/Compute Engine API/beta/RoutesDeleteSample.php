...
$results = routesDeleteExample($service, $project, $route, $optParams);
...
* @return Operation
*/
function routesDeleteExample($service, $project, $route, $optParams)
{
	try
	{
		...
		return $service->routes->DeleteRoutes($project, $route, $optParams);
	}
	catch (Exception $e)
	{
