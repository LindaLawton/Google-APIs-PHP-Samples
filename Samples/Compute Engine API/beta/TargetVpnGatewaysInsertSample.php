...
print_r(targetVpnGatewaysInsertExample($service, $project, $region));
...
*/
function targetVpnGatewaysInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->targetVpnGateways->InsertTargetVpnGateways($project, $region);
	}
	catch (Exception $ex)
	{
