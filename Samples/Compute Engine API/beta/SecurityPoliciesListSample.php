...
$results = securityPoliciesListExample($service, $project, $optParams);
...
*/
function securityPoliciesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->securityPolicies->ListSecurityPolicies($project, $optParams);
	}
	catch (Exception $e)
	{
