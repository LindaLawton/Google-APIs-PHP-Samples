...
print_r(securityPoliciesListExample($service, $project));

/**
* List all the policies that have been configured for the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return SecurityPolicyList</returns>
*/
function securityPoliciesListExample($service, $project)
{
	try
	{
		...
		return $service->securityPolicies->ListSecurityPolicies($project);
	}
	catch (Exception $ex)
	{
