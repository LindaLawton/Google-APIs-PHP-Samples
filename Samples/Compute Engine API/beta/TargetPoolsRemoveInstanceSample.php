...
print_r(removeInstance($service, $project, $region, $targetPool));
...
*/
function removeInstance($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->removeInstance($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
