...
// Single Request.
$results = imagesGetExample($service, $project, $image, $optParams);
...
* @return Image
*/
function imagesGetExample($service, $project, $image, $optParams)
{
	try
	{
		...
		return $service->images->GetImages($project, $image, $optParams);
	}
	catch (Exception $e)
	{
