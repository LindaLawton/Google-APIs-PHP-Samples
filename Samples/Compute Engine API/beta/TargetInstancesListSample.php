...
print_r(targetInstancesListExample($service, $project, $zone));
...
* @return TargetInstanceList</returns>
*/
function targetInstancesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->targetInstances->ListTargetInstances($project, $zone);
	}
	catch (Exception $ex)
	{
