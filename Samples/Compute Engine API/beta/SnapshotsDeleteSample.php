...
print_r(snapshotsDeleteExample($service, $project, $snapshot));
...
*/
function snapshotsDeleteExample($service, $project, $snapshot)
{
	try
	{
		...
		return $service->snapshots->DeleteSnapshots($project, $snapshot);
	}
	catch (Exception $ex)
	{
