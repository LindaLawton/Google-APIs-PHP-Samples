...
print_r(targetSslProxiesGetExample($service, $project, $targetSslProxy));
...
* @return TargetSslProxy</returns>
*/
function targetSslProxiesGetExample($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->targetSslProxies->GetTargetSslProxies($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
