...
*/
function instancesGetSerialPortOutputExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->GetSerialPortOutputInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
