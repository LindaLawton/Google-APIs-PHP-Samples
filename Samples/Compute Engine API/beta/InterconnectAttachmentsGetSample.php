...
// Single Request.
$results = interconnectAttachmentsGetExample($service, $project, $region, $interconnectAttachment, $optParams);
...
*/
function interconnectAttachmentsGetExample($service, $project, $region, $interconnectAttachment, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->GetInterconnectAttachments($project, $region, $interconnectAttachment, $optParams);
	}
	catch (Exception $e)
	{
