...
print_r(forwardingRulesListExample($service, $project, $region));
...
*/
function forwardingRulesListExample($service, $project, $region)
{
	try
	{
		...
		return $service->forwardingRules->ListForwardingRules($project, $region);
	}
	catch (Exception $ex)
	{
