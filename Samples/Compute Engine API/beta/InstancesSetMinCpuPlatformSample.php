...
print_r(instancesSetMinCpuPlatformExample($service, $project, $zone, $instance));
...
*/
function instancesSetMinCpuPlatformExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetMinCpuPlatformInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
