...
print_r(setProxyHeader($service, $project, $targetSslProxy));
...
*/
function setProxyHeader($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->setProxyHeader($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
