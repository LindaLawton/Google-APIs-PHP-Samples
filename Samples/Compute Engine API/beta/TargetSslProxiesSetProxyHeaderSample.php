...
// Single Request.
$results = targetSslProxiesSetProxyHeaderExample($service, $project, $targetSslProxy, $optParams);
...
* @return Operation
*/
function targetSslProxiesSetProxyHeaderExample($service, $project, $targetSslProxy, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->SetProxyHeaderTargetSslProxies($project, $targetSslProxy, $optParams);
	}
	catch (Exception $e)
	{
