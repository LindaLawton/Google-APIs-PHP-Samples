...
$results = interconnectsPatchExample($service, $project, $interconnect, $optParams);
...
* @return Operation
*/
function interconnectsPatchExample($service, $project, $interconnect, $optParams)
{
	try
	{
		...
		return $service->interconnects->PatchInterconnects($project, $interconnect, $optParams);
	}
	catch (Exception $e)
	{
