...
print_r(instanceGroupManagersSetAutoHealingPoliciesExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersSetAutoHealingPoliciesExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->SetAutoHealingPoliciesInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
