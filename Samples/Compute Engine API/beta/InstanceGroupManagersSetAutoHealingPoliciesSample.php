...
print_r(setAutoHealingPolicies($service, $project, $zone, $instanceGroupManager));
...
*/
function setAutoHealingPolicies($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->setAutoHealingPolicies($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
