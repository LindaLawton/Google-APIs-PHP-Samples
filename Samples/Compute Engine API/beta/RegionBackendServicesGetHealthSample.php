...
// Single Request.
$results = regionBackendServicesGetHealthExample($service, $project, $region, $backendService, $optParams);
...
*/
function regionBackendServicesGetHealthExample($service, $project, $region, $backendService, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->GetHealthRegionBackendServices($project, $region, $backendService, $optParams);
	}
	catch (Exception $e)
	{
