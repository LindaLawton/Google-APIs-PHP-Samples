...
print_r(regionBackendServicesGetHealthExample($service, $project, $region, $backendService));
...
* @return BackendServiceGroupHealth</returns>
*/
function regionBackendServicesGetHealthExample($service, $project, $region, $backendService)
{
	try
	{
		...
		if (backendService == null)
			throw new Exception("backendService is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (region == null)
			throw new Exception("region is required.");
		// Make the request and return the results.
		return $service->regionBackendServices->GetHealthRegionBackendServices($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
