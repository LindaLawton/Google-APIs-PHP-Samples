...
print_r(removeInstances($service, $project, $zone, $instanceGroup));
...
*/
function removeInstances($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->removeInstances($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
