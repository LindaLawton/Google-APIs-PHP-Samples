...
// Single Request.
$results = instanceGroupsRemoveInstancesExample($service, $project, $zone, $instanceGroup, $optParams);
...
* @return Operation
*/
function instanceGroupsRemoveInstancesExample($service, $project, $zone, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->RemoveInstancesInstanceGroups($project, $zone, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
