...
// Single Request.
$results = regionOperationsListExample($service, $project, $region, $optParams);
...
*/
function regionOperationsListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionOperations->ListRegionOperations($project, $region, $optParams);
	}
	catch (Exception $e)
	{
