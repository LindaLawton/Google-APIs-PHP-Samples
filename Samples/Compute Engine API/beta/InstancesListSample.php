...
// Single Request.
$results = instancesListExample($service, $project, $zone, $optParams);
...
* @return InstanceList
*/
function instancesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->instances->ListInstances($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
