...
print_r(targetVpnGatewaysListExample($service, $project, $region));
...
* @return TargetVpnGatewayList</returns>
*/
function targetVpnGatewaysListExample($service, $project, $region)
{
	try
	{
		...
		return $service->targetVpnGateways->ListTargetVpnGateways($project, $region);
	}
	catch (Exception $ex)
	{
