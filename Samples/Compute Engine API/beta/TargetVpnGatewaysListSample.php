...
// Single Request.
$results = targetVpnGatewaysListExample($service, $project, $region, $optParams);
...
*/
function targetVpnGatewaysListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->targetVpnGateways->ListTargetVpnGateways($project, $region, $optParams);
	}
	catch (Exception $e)
	{
