...
$results = globalAddressesDeleteExample($service, $project, $address, $optParams);
...
* @return Operation
*/
function globalAddressesDeleteExample($service, $project, $address, $optParams)
{
	try
	{
		...
		return $service->globalAddresses->DeleteGlobalAddresses($project, $address, $optParams);
	}
	catch (Exception $e)
	{
