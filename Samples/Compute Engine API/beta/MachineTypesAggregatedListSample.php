...
print_r(machineTypesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of machine types.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return MachineTypeAggregatedList</returns>
*/
function machineTypesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->machineTypes->AggregatedListMachineTypes($project);
	}
	catch (Exception $ex)
	{
