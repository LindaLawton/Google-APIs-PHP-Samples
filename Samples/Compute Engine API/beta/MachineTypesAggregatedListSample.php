...
// Single Request.
$results = machineTypesAggregatedListExample($service, $project, $optParams);
...
*/
function machineTypesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->machineTypes->AggregatedListMachineTypes($project, $optParams);
	}
	catch (Exception $e)
	{
