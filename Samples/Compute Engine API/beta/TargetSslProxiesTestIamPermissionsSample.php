...
// Single Request.
$results = targetSslProxiesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function targetSslProxiesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->TestIamPermissionsTargetSslProxies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
