...
// Single Request.
$results = backendBucketsDeleteExample($service, $project, $backendBucket, $optParams);
...
* @return Operation
*/
function backendBucketsDeleteExample($service, $project, $backendBucket, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->DeleteBackendBuckets($project, $backendBucket, $optParams);
	}
	catch (Exception $e)
	{
