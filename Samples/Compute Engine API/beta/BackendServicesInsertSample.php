...
print_r(backendServicesInsertExample($service, $project));
...
*/
function backendServicesInsertExample($service, $project)
{
	try
	{
		...
		return $service->backendServices->InsertBackendServices($project);
	}
	catch (Exception $ex)
	{
