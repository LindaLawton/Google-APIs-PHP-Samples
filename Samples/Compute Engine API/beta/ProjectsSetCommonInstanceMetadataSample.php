...
// Single Request.
$results = projectsSetCommonInstanceMetadataExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsSetCommonInstanceMetadataExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->SetCommonInstanceMetadataProjects($project, $optParams);
	}
	catch (Exception $e)
	{
