...
print_r(firewallsGetExample($service, $project, $firewall));
...
* @return Firewall</returns>
*/
function firewallsGetExample($service, $project, $firewall)
{
	try
	{
		...
		return $service->firewalls->GetFirewalls($project, $firewall);
	}
	catch (Exception $ex)
	{
