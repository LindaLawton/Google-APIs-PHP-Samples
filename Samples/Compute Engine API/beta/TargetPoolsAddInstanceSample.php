...
// Single Request.
$results = targetPoolsAddInstanceExample($service, $project, $region, $targetPool, $optParams);
...
* @return Operation
*/
function targetPoolsAddInstanceExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->AddInstanceTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
