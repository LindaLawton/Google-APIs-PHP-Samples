...
// Single Request.
$results = backendBucketsInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function backendBucketsInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->InsertBackendBuckets($project, $optParams);
	}
	catch (Exception $e)
	{
