...
print_r(targetVpnGatewaysTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function targetVpnGatewaysTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->targetVpnGateways->TestIamPermissionsTargetVpnGateways($project, $region, $resource);
	}
	catch (Exception $ex)
	{
