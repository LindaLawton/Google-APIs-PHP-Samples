...
// Single Request.
$results = globalForwardingRulesListExample($service, $project, $optParams);
...
*/
function globalForwardingRulesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->ListGlobalForwardingRules($project, $optParams);
	}
	catch (Exception $e)
	{
