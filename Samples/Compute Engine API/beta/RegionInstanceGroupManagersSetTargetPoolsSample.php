...
print_r(regionInstanceGroupManagersSetTargetPoolsExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersSetTargetPoolsExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->SetTargetPoolsRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
