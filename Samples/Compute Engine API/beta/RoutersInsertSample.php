...
$results = routersInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function routersInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->routers->InsertRouters($project, $region, $optParams);
	}
	catch (Exception $e)
	{
