...
print_r(testIamPermissions($service, $project, $zone, $resource));
...
*/
function testIamPermissions($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->testIamPermissions($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
