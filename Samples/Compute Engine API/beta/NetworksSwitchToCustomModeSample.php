...
// Single Request.
$results = networksSwitchToCustomModeExample($service, $project, $network, $optParams);
...
* @return Operation
*/
function networksSwitchToCustomModeExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->SwitchToCustomModeNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
