...
print_r(networksSwitchToCustomModeExample($service, $project, $network));
...
*/
function networksSwitchToCustomModeExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->SwitchToCustomModeNetworks($project, $network);
	}
	catch (Exception $ex)
	{
