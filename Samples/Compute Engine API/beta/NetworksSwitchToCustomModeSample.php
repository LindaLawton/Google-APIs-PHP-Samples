...
print_r(switchToCustomMode($service, $project, $network));
...
*/
function switchToCustomMode($service, $project, $network)
{
	try
	{
		...
		return $service->switchToCustomMode($project, $network);
	}
	catch (Exception $ex)
	{
