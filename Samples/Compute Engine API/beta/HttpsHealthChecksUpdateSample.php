...
// Single Request.
$results = httpsHealthChecksUpdateExample($service, $project, $httpsHealthCheck, $optParams);
...
* @return Operation
*/
function httpsHealthChecksUpdateExample($service, $project, $httpsHealthCheck, $optParams)
{
	try
	{
		...
		if (httpsHealthCheck == null)
			throw new Exception("httpsHealthCheck is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->httpsHealthChecks->UpdateHttpsHealthChecks($project, $httpsHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
