...
print_r(interconnectsTestIamPermissionsExample($service, $project, $resource));
...
*/
function interconnectsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->interconnects->TestIamPermissionsInterconnects($project, $resource);
	}
	catch (Exception $ex)
	{
