...
// Single Request.
$results = interconnectsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function interconnectsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnects->TestIamPermissionsInterconnects($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
