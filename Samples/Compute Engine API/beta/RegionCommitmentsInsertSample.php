...
print_r(regionCommitmentsInsertExample($service, $project, $region));
...
*/
function regionCommitmentsInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionCommitments->InsertRegionCommitments($project, $region);
	}
	catch (Exception $ex)
	{
