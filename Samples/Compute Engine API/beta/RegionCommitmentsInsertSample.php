...
// Single Request.
$results = regionCommitmentsInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionCommitmentsInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionCommitments->InsertRegionCommitments($project, $region, $optParams);
	}
	catch (Exception $e)
	{
