...
print_r(routesTestIamPermissionsExample($service, $project, $resource));
...
*/
function routesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->routes->TestIamPermissionsRoutes($project, $resource);
	}
	catch (Exception $ex)
	{
