...
// Single Request.
$results = routesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function routesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->routes->TestIamPermissionsRoutes($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
