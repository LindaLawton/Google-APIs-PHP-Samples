...
print_r(targetVpnGatewaysAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of target VPN gateways.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return TargetVpnGatewayAggregatedList</returns>
*/
function targetVpnGatewaysAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->targetVpnGateways->AggregatedListTargetVpnGateways($project);
	}
	catch (Exception $ex)
	{
