...
print_r(snapshotsListExample($service, $project));

/**
* Retrieves the list of Snapshot resources contained within the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return SnapshotList</returns>
*/
function snapshotsListExample($service, $project)
{
	try
	{
		...
		return $service->snapshots->ListSnapshots($project);
	}
	catch (Exception $ex)
	{
