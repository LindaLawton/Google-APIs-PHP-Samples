...
print_r(backendServicesSetSecurityPolicyExample($service, $project, $backendService));
...
*/
function backendServicesSetSecurityPolicyExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->SetSecurityPolicyBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
