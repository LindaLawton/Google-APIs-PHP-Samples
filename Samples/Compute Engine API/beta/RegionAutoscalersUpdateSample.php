...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'autoscaler' => '[YourValue]',  // Name of the autoscaler to update.
...
// Single Request.
$results = regionAutoscalersUpdateExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionAutoscalersUpdateExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionAutoscalers->UpdateRegionAutoscalers($project, $region, $optParams);
	}
	catch (Exception $e)
	{
