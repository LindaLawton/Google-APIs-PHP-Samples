...
// Single Request.
$results = healthChecksUpdateExample($service, $project, $healthCheck, $optParams);
...
* @return Operation
*/
function healthChecksUpdateExample($service, $project, $healthCheck, $optParams)
{
	try
	{
		...
		return $service->healthChecks->UpdateHealthChecks($project, $healthCheck, $optParams);
	}
	catch (Exception $e)
	{
