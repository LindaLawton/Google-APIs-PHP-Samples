...
// Single Request.
$results = targetHttpProxiesGetExample($service, $project, $targetHttpProxy, $optParams);
...
*/
function targetHttpProxiesGetExample($service, $project, $targetHttpProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpProxies->GetTargetHttpProxies($project, $targetHttpProxy, $optParams);
	}
	catch (Exception $e)
	{
