...
print_r(targetHttpProxiesGetExample($service, $project, $targetHttpProxy));
...
* @return TargetHttpProxy</returns>
*/
function targetHttpProxiesGetExample($service, $project, $targetHttpProxy)
{
	try
	{
		...
		return $service->targetHttpProxies->GetTargetHttpProxies($project, $targetHttpProxy);
	}
	catch (Exception $ex)
	{
