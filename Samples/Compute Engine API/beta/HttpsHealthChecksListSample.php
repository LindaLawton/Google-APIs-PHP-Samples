...
// Single Request.
$results = httpsHealthChecksListExample($service, $project, $optParams);
...
*/
function httpsHealthChecksListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->httpsHealthChecks->ListHttpsHealthChecks($project, $optParams);
	}
	catch (Exception $e)
	{
