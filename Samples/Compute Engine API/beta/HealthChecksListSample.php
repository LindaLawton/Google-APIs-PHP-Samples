...
print_r(healthChecksListExample($service, $project));

/**
* Retrieves the list of HealthCheck resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return HealthCheckList</returns>
*/
function healthChecksListExample($service, $project)
{
	try
	{
		...
		return $service->healthChecks->ListHealthChecks($project);
	}
	catch (Exception $ex)
	{
