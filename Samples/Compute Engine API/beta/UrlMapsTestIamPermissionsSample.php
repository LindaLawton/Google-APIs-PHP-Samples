...
// Single Request.
$results = urlMapsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function urlMapsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->urlMaps->TestIamPermissionsUrlMaps($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
