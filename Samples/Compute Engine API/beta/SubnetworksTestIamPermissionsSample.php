...
print_r(subnetworksTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function subnetworksTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->subnetworks->TestIamPermissionsSubnetworks($project, $region, $resource);
	}
	catch (Exception $ex)
	{
