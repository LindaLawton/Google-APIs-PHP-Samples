...
// Single Request.
$results = subnetworksTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function subnetworksTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->subnetworks->TestIamPermissionsSubnetworks($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
