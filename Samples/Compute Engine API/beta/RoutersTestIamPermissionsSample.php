...
print_r(routersTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function routersTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->routers->TestIamPermissionsRouters($project, $region, $resource);
	}
	catch (Exception $ex)
	{
