...
print_r(regionAutoscalersTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function regionAutoscalersTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionAutoscalers->TestIamPermissionsRegionAutoscalers($project, $region, $resource);
	}
	catch (Exception $ex)
	{
