...
print_r(addHealthCheck($service, $project, $region, $targetPool));
...
*/
function addHealthCheck($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->addHealthCheck($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
