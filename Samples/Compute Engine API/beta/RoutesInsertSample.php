...
$results = routesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function routesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->routes->InsertRoutes($project, $optParams);
	}
	catch (Exception $e)
	{
