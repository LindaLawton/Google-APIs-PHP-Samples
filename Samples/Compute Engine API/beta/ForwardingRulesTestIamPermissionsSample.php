...
print_r(testIamPermissions($service, $project, $region, $resource));
...
*/
function testIamPermissions($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->testIamPermissions($project, $region, $resource);
	}
	catch (Exception $ex)
	{
