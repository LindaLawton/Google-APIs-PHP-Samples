...
print_r(forwardingRulesTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function forwardingRulesTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->forwardingRules->TestIamPermissionsForwardingRules($project, $region, $resource);
	}
	catch (Exception $ex)
	{
