...
print_r(forwardingRulesDeleteExample($service, $project, $region, $forwardingRule));
...
*/
function forwardingRulesDeleteExample($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->forwardingRules->DeleteForwardingRules($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
