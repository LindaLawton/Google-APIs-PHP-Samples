...
// Single Request.
$results = regionInstanceGroupManagersUpdateExample($service, $project, $region, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function regionInstanceGroupManagersUpdateExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->UpdateRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
