...
// Single Request.
$results = networksTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function networksTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->networks->TestIamPermissionsNetworks($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
