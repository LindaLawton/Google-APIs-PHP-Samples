...
print_r(networksTestIamPermissionsExample($service, $project, $resource));
...
*/
function networksTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->networks->TestIamPermissionsNetworks($project, $resource);
	}
	catch (Exception $ex)
	{
