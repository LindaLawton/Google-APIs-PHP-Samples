...
// Single Request.
$results = targetInstancesAggregatedListExample($service, $project, $optParams);
...
*/
function targetInstancesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetInstances->AggregatedListTargetInstances($project, $optParams);
	}
	catch (Exception $e)
	{
