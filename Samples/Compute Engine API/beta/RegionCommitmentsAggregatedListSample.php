...
print_r(regionCommitmentsAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of commitments.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return CommitmentAggregatedList</returns>
*/
function regionCommitmentsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->regionCommitments->AggregatedListRegionCommitments($project);
	}
	catch (Exception $ex)
	{
