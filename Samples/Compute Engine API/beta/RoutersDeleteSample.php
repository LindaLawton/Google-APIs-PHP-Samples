...
print_r(routersDeleteExample($service, $project, $region, $router));
...
*/
function routersDeleteExample($service, $project, $region, $router)
{
	try
	{
		...
		return $service->routers->DeleteRouters($project, $region, $router);
	}
	catch (Exception $ex)
	{
