...
print_r(instancesUpdateAccessConfigExample($service, $project, $zone, $instance, $networkInterface));
...
*/
function instancesUpdateAccessConfigExample($service, $project, $zone, $instance, $networkInterface)
{
	try
	{
		...
		return $service->instances->UpdateAccessConfigInstances($project, $zone, $instance, $networkInterface);
	}
	catch (Exception $ex)
	{
