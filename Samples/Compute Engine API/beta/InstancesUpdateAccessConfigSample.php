...
print_r(updateAccessConfig($service, $project, $zone, $instance, $networkInterface));
...
*/
function updateAccessConfig($service, $project, $zone, $instance, $networkInterface)
{
	try
	{
		...
		return $service->updateAccessConfig($project, $zone, $instance, $networkInterface);
	}
	catch (Exception $ex)
	{
