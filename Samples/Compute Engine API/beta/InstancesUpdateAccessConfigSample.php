...
$results = instancesUpdateAccessConfigExample($service, $project, $zone, $instance, $networkInterface, $optParams);
...
* @return Operation
*/
function instancesUpdateAccessConfigExample($service, $project, $zone, $instance, $networkInterface, $optParams)
{
	try
	{
		...
		return $service->instances->UpdateAccessConfigInstances($project, $zone, $instance, $networkInterface, $optParams);
	}
	catch (Exception $e)
	{
