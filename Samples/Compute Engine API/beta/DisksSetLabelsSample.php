...
print_r(disksSetLabelsExample($service, $project, $zone, $resource));
...
*/
function disksSetLabelsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->disks->SetLabelsDisks($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
