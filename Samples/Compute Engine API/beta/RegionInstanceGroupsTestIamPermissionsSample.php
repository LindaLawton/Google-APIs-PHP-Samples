...
$results = regionInstanceGroupsTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function regionInstanceGroupsTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroups->TestIamPermissionsRegionInstanceGroups($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
