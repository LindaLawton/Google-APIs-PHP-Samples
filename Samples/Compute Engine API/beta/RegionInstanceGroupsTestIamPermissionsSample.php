...
print_r(regionInstanceGroupsTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function regionInstanceGroupsTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionInstanceGroups->TestIamPermissionsRegionInstanceGroups($project, $region, $resource);
	}
	catch (Exception $ex)
	{
