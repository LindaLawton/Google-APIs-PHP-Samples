...
print_r(setBackendService($service, $project, $targetTcpProxy));
...
*/
function setBackendService($service, $project, $targetTcpProxy)
{
	try
	{
		...
		return $service->setBackendService($project, $targetTcpProxy);
	}
	catch (Exception $ex)
	{
