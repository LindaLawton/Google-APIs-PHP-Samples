...
print_r(abandonInstances($service, $project, $region, $instanceGroupManager));
...
*/
function abandonInstances($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->abandonInstances($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
