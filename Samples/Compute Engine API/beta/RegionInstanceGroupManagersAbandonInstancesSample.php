...
print_r(regionInstanceGroupManagersAbandonInstancesExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersAbandonInstancesExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->AbandonInstancesRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
