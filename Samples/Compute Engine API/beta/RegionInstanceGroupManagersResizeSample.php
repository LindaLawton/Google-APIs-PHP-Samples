...
print_r(resize($service, $project, $region, $instanceGroupManager, $size));
...
*/
function resize($service, $project, $region, $instanceGroupManager, $size)
{
	try
	{
		...
		return $service->resize($project, $region, $instanceGroupManager, $size);
	}
	catch (Exception $ex)
	{
