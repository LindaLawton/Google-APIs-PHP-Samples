...
print_r(instanceGroupManagersInsertExample($service, $project, $zone));
...
*/
function instanceGroupManagersInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->instanceGroupManagers->InsertInstanceGroupManagers($project, $zone);
	}
	catch (Exception $ex)
	{
