...
$results = imagesListExample($service, $project, $optParams);
...
* @return ImageList
*/
function imagesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->images->ListImages($project, $optParams);
	}
	catch (Exception $e)
	{
