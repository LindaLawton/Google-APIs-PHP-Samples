...
$results = targetHttpsProxiesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function targetHttpsProxiesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->InsertTargetHttpsProxies($project, $optParams);
	}
	catch (Exception $e)
	{
