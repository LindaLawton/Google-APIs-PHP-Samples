...
// Single Request.
$results = autoscalersTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function autoscalersTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->autoscalers->TestIamPermissionsAutoscalers($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
