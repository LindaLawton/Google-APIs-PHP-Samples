...
// Single Request.
$results = targetPoolsTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function targetPoolsTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->targetPools->TestIamPermissionsTargetPools($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
