...
print_r(targetPoolsTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function targetPoolsTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->targetPools->TestIamPermissionsTargetPools($project, $region, $resource);
	}
	catch (Exception $ex)
	{
