...
// Single Request.
$results = addressesSetLabelsExample($service, $project, $region, $resource, $optParams);
...
* @return Operation
*/
function addressesSetLabelsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->addresses->SetLabelsAddresses($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
