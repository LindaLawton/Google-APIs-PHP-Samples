...
$results = httpsHealthChecksPatchExample($service, $project, $httpsHealthCheck, $optParams);
...
* @return Operation
*/
function httpsHealthChecksPatchExample($service, $project, $httpsHealthCheck, $optParams)
{
	try
	{
		...
		return $service->httpsHealthChecks->PatchHttpsHealthChecks($project, $httpsHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
