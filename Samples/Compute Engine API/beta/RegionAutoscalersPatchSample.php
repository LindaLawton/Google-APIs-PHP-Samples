...
print_r(regionAutoscalersPatchExample($service, $project, $region));
...
*/
function regionAutoscalersPatchExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionAutoscalers->PatchRegionAutoscalers($project, $region);
	}
	catch (Exception $ex)
	{
