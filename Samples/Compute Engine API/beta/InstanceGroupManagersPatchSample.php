...
print_r(instanceGroupManagersPatchExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersPatchExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->PatchInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
