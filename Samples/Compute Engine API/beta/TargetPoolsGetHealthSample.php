...
print_r(targetPoolsGetHealthExample($service, $project, $region, $targetPool));
...
* @return TargetPoolInstanceHealth</returns>
*/
function targetPoolsGetHealthExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->GetHealthTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
