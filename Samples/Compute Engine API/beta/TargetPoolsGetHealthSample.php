...
print_r(getHealth($service, $project, $region, $targetPool));
...
*/
function getHealth($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->getHealth($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
