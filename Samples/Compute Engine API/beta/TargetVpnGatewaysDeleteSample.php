...
// Single Request.
$results = targetVpnGatewaysDeleteExample($service, $project, $region, $targetVpnGateway, $optParams);
...
* @return Operation
*/
function targetVpnGatewaysDeleteExample($service, $project, $region, $targetVpnGateway, $optParams)
{
	try
	{
		...
		if (targetVpnGateway == null)
			throw new Exception("targetVpnGateway is required.");
		// Make the request and return the results.
		return $service->targetVpnGateways->DeleteTargetVpnGateways($project, $region, $targetVpnGateway, $optParams);
	}
	catch (Exception $e)
	{
