...
print_r(routersPreviewExample($service, $project, $region, $router));
...
* @return RoutersPreviewResponse</returns>
*/
function routersPreviewExample($service, $project, $region, $router)
{
	try
	{
		...
		return $service->routers->PreviewRouters($project, $region, $router);
	}
	catch (Exception $ex)
	{
