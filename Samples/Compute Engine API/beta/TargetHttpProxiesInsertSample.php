...
// Single Request.
$results = targetHttpProxiesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function targetHttpProxiesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetHttpProxies->InsertTargetHttpProxies($project, $optParams);
	}
	catch (Exception $e)
	{
