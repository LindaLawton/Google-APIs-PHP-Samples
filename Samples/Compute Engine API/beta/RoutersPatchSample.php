...
$results = routersPatchExample($service, $project, $region, $router, $optParams);
...
* @return Operation
*/
function routersPatchExample($service, $project, $region, $router, $optParams)
{
	try
	{
		...
		return $service->routers->PatchRouters($project, $region, $router, $optParams);
	}
	catch (Exception $e)
	{
