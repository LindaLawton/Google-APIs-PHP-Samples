...
print_r(routersPatchExample($service, $project, $region, $router));
...
*/
function routersPatchExample($service, $project, $region, $router)
{
	try
	{
		...
		return $service->routers->PatchRouters($project, $region, $router);
	}
	catch (Exception $ex)
	{
