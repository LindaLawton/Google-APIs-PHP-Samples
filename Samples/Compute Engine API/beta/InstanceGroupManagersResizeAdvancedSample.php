...
print_r(resizeAdvanced($service, $project, $zone, $instanceGroupManager));
...
*/
function resizeAdvanced($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->resizeAdvanced($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
