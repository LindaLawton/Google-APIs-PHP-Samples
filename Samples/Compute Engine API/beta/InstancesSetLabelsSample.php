...
// Single Request.
$results = instancesSetLabelsExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetLabelsExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetLabelsInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
