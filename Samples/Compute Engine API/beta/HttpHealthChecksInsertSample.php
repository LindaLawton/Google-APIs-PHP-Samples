...
// Single Request.
$results = httpHealthChecksInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function httpHealthChecksInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->httpHealthChecks->InsertHttpHealthChecks($project, $optParams);
	}
	catch (Exception $e)
	{
