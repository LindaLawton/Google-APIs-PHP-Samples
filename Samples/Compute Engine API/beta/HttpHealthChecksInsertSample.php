...
print_r(httpHealthChecksInsertExample($service, $project));
...
*/
function httpHealthChecksInsertExample($service, $project)
{
	try
	{
		...
		return $service->httpHealthChecks->InsertHttpHealthChecks($project);
	}
	catch (Exception $ex)
	{
