...
print_r(setBackup($service, $project, $region, $targetPool));
...
*/
function setBackup($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->setBackup($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
