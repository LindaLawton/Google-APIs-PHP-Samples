...
print_r(targetHttpProxiesTestIamPermissionsExample($service, $project, $resource));
...
*/
function targetHttpProxiesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->targetHttpProxies->TestIamPermissionsTargetHttpProxies($project, $resource);
	}
	catch (Exception $ex)
	{
