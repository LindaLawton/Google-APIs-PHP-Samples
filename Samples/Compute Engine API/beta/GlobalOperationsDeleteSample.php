...
print_r(globalOperationsDeleteExample($service, $project, $operation));
...
*/
function globalOperationsDeleteExample($service, $project, $operation)
{
	try
	{
		...
		return $service->globalOperations->DeleteGlobalOperations($project, $operation);
	}
	catch (Exception $ex)
	{
