...
print_r(regionBackendServicesTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function regionBackendServicesTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionBackendServices->TestIamPermissionsRegionBackendServices($project, $region, $resource);
	}
	catch (Exception $ex)
	{
