...
print_r(instanceGroupManagersUpdateExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersUpdateExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->UpdateInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
