...
$results = instancesDeleteExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesDeleteExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->DeleteInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
