...
print_r(instancesDeleteExample($service, $project, $zone, $instance));
...
*/
function instancesDeleteExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->DeleteInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
