...
// Single Request.
$results = diskTypesListExample($service, $project, $zone, $optParams);
...
* @return DiskTypeList
*/
function diskTypesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->diskTypes->ListDiskTypes($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
