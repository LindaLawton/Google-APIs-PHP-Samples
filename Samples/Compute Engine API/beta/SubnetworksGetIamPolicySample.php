...
print_r(subnetworksGetIamPolicyExample($service, $project, $region, $resource));
...
*/
function subnetworksGetIamPolicyExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->subnetworks->GetIamPolicySubnetworks($project, $region, $resource);
	}
	catch (Exception $ex)
	{
