...
// Single Request.
$results = interconnectLocationsListExample($service, $project, $optParams);
...
*/
function interconnectLocationsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->interconnectLocations->ListInterconnectLocations($project, $optParams);
	}
	catch (Exception $e)
	{
