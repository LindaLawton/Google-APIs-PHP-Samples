...
print_r(interconnectLocationsListExample($service, $project));

/**
* Retrieves the list of interconnect locations available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return InterconnectLocationList</returns>
*/
function interconnectLocationsListExample($service, $project)
{
	try
	{
		...
		return $service->interconnectLocations->ListInterconnectLocations($project);
	}
	catch (Exception $ex)
	{
