...
// Single Request.
$results = globalForwardingRulesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function globalForwardingRulesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->TestIamPermissionsGlobalForwardingRules($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
