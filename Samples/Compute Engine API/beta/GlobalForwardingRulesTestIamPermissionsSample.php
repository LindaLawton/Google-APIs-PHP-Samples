...
print_r(globalForwardingRulesTestIamPermissionsExample($service, $project, $resource));
...
*/
function globalForwardingRulesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->globalForwardingRules->TestIamPermissionsGlobalForwardingRules($project, $resource);
	}
	catch (Exception $ex)
	{
