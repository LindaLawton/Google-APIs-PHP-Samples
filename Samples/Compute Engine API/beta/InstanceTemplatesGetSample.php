...
print_r(instanceTemplatesGetExample($service, $project, $instanceTemplate));
...
* @return InstanceTemplate</returns>
*/
function instanceTemplatesGetExample($service, $project, $instanceTemplate)
{
	try
	{
		...
		return $service->instanceTemplates->GetInstanceTemplates($project, $instanceTemplate);
	}
	catch (Exception $ex)
	{
