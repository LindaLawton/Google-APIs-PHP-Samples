...
print_r(instanceTemplatesTestIamPermissionsExample($service, $project, $resource));
...
*/
function instanceTemplatesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->instanceTemplates->TestIamPermissionsInstanceTemplates($project, $resource);
	}
	catch (Exception $ex)
	{
