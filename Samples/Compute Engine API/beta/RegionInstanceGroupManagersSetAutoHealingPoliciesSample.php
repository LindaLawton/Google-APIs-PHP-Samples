...
// Single Request.
$results = regionInstanceGroupManagersSetAutoHealingPoliciesExample($service, $project, $region, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function regionInstanceGroupManagersSetAutoHealingPoliciesExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->SetAutoHealingPoliciesRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
