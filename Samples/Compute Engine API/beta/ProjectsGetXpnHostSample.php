...
// Single Request.
$results = projectsGetXpnHostExample($service, $project, $optParams);
...
* @return Project
*/
function projectsGetXpnHostExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->GetXpnHostProjects($project, $optParams);
	}
	catch (Exception $e)
	{
