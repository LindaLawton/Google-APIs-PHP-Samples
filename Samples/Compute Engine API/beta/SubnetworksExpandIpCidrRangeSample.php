...
print_r(expandIpCidrRange($service, $project, $region, $subnetwork));
...
*/
function expandIpCidrRange($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->expandIpCidrRange($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
