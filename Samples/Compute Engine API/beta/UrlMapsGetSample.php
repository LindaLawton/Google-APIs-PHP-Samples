...
// Single Request.
$results = urlMapsGetExample($service, $project, $urlMap, $optParams);
...
* @return UrlMap
*/
function urlMapsGetExample($service, $project, $urlMap, $optParams)
{
	try
	{
		...
		return $service->urlMaps->GetUrlMaps($project, $urlMap, $optParams);
	}
	catch (Exception $e)
	{
