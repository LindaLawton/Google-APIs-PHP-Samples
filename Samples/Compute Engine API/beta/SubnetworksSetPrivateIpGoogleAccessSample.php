...
// Single Request.
$results = subnetworksSetPrivateIpGoogleAccessExample($service, $project, $region, $subnetwork, $optParams);
...
* @return Operation
*/
function subnetworksSetPrivateIpGoogleAccessExample($service, $project, $region, $subnetwork, $optParams)
{
	try
	{
		...
		if (subnetwork == null)
			throw new Exception("subnetwork is required.");
		// Make the request and return the results.
		return $service->subnetworks->SetPrivateIpGoogleAccessSubnetworks($project, $region, $subnetwork, $optParams);
	}
	catch (Exception $e)
	{
