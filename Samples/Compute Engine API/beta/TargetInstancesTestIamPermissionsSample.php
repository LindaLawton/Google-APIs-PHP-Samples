...
// Single Request.
$results = targetInstancesTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function targetInstancesTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->targetInstances->TestIamPermissionsTargetInstances($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
