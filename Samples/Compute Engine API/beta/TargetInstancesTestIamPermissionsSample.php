...
print_r(targetInstancesTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function targetInstancesTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->targetInstances->TestIamPermissionsTargetInstances($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
