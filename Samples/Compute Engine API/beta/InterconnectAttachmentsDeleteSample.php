...
print_r(delete($service, $project, $region, $interconnectAttachment));
...
*/
function delete($service, $project, $region, $interconnectAttachment)
{
	try
	{
		...
		return $service->delete($project, $region, $interconnectAttachment);
	}
	catch (Exception $ex)
	{
