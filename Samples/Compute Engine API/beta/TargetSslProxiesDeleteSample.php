...
print_r(targetSslProxiesDeleteExample($service, $project, $targetSslProxy));
...
*/
function targetSslProxiesDeleteExample($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->targetSslProxies->DeleteTargetSslProxies($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
