...
# UnOfficial Compute Engine API beta Samples for PHP
...
These samples show how to access the [Compute Engine API beta](https://developers.google.com/compute/docs/reference/latest/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
