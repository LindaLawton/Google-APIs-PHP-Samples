...
// Single Request.
$results = targetHttpsProxiesSetSslCertificatesExample($service, $project, $targetHttpsProxy, $optParams);
...
* @return Operation
*/
function targetHttpsProxiesSetSslCertificatesExample($service, $project, $targetHttpsProxy, $optParams)
{
	try
	{
		...
		if (targetHttpsProxy == null)
			throw new Exception("targetHttpsProxy is required.");
		// Make the request and return the results.
		return $service->targetHttpsProxies->SetSslCertificatesTargetHttpsProxies($project, $targetHttpsProxy, $optParams);
	}
	catch (Exception $e)
	{
