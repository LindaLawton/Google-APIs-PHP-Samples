...
print_r(autoscalersAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of autoscalers.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return AutoscalerAggregatedList</returns>
*/
function autoscalersAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->autoscalers->AggregatedListAutoscalers($project);
	}
	catch (Exception $ex)
	{
