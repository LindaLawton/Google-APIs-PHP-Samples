...
print_r(instancesAttachDiskExample($service, $project, $zone, $instance));
...
*/
function instancesAttachDiskExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->AttachDiskInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
