...
$results = instancesGetExample($service, $project, $zone, $instance, $optParams);
...
* @return Instance
*/
function instancesGetExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->GetInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
