...
print_r(setSslCertificates($service, $project, $targetSslProxy));
...
*/
function setSslCertificates($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->setSslCertificates($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
