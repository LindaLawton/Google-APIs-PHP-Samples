...
// Single Request.
$results = targetSslProxiesSetSslCertificatesExample($service, $project, $targetSslProxy, $optParams);
...
* @return Operation
*/
function targetSslProxiesSetSslCertificatesExample($service, $project, $targetSslProxy, $optParams)
{
	try
	{
		...
		if (targetSslProxy == null)
			throw new Exception("targetSslProxy is required.");
		// Make the request and return the results.
		return $service->targetSslProxies->SetSslCertificatesTargetSslProxies($project, $targetSslProxy, $optParams);
	}
	catch (Exception $e)
	{
