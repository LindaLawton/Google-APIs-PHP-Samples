...
// Single Request.
$results = healthChecksTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function healthChecksTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->healthChecks->TestIamPermissionsHealthChecks($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
