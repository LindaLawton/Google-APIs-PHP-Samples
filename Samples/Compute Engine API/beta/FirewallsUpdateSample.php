...
// Single Request.
$results = firewallsUpdateExample($service, $project, $firewall, $optParams);
...
* @return Operation
*/
function firewallsUpdateExample($service, $project, $firewall, $optParams)
{
	try
	{
		...
		return $service->firewalls->UpdateFirewalls($project, $firewall, $optParams);
	}
	catch (Exception $e)
	{
