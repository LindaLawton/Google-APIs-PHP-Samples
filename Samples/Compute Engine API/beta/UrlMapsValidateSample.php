...
// Single Request.
$results = urlMapsValidateExample($service, $project, $urlMap, $optParams);
...
*/
function urlMapsValidateExample($service, $project, $urlMap, $optParams)
{
	try
	{
		...
		return $service->urlMaps->ValidateUrlMaps($project, $urlMap, $optParams);
	}
	catch (Exception $e)
	{
