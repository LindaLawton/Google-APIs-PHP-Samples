...
print_r(acceleratorTypesListExample($service, $project, $zone));
...
* @return AcceleratorTypeList</returns>
*/
function acceleratorTypesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->acceleratorTypes->ListAcceleratorTypes($project, $zone);
	}
	catch (Exception $ex)
	{
