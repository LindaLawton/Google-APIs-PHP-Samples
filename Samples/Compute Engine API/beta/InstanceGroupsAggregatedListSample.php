...
print_r(instanceGroupsAggregatedListExample($service, $project));

/**
* Retrieves the list of instance groups and sorts them by zone.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return InstanceGroupAggregatedList</returns>
*/
function instanceGroupsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->instanceGroups->AggregatedListInstanceGroups($project);
	}
	catch (Exception $ex)
	{
