...
$results = httpsHealthChecksGetExample($service, $project, $httpsHealthCheck, $optParams);
...
*/
function httpsHealthChecksGetExample($service, $project, $httpsHealthCheck, $optParams)
{
	try
	{
		...
		return $service->httpsHealthChecks->GetHttpsHealthChecks($project, $httpsHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
