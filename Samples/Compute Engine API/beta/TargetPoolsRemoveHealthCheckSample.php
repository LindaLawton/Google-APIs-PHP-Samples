...
print_r(removeHealthCheck($service, $project, $region, $targetPool));
...
*/
function removeHealthCheck($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->removeHealthCheck($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
