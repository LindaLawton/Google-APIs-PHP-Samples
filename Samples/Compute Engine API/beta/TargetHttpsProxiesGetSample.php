...
$results = targetHttpsProxiesGetExample($service, $project, $targetHttpsProxy, $optParams);
...
*/
function targetHttpsProxiesGetExample($service, $project, $targetHttpsProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->GetTargetHttpsProxies($project, $targetHttpsProxy, $optParams);
	}
	catch (Exception $e)
	{
