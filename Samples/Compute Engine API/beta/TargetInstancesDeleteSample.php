...
// Single Request.
$results = targetInstancesDeleteExample($service, $project, $zone, $targetInstance, $optParams);
...
* @return Operation
*/
function targetInstancesDeleteExample($service, $project, $zone, $targetInstance, $optParams)
{
	try
	{
		...
		if (targetInstance == null)
			throw new Exception("targetInstance is required.");
		if (zone == null)
			throw new Exception("zone is required.");
		// Make the request and return the results.
		return $service->targetInstances->DeleteTargetInstances($project, $zone, $targetInstance, $optParams);
	}
	catch (Exception $e)
	{
