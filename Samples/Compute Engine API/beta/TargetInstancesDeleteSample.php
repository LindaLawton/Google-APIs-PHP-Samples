...
print_r(targetInstancesDeleteExample($service, $project, $zone, $targetInstance));
...
*/
function targetInstancesDeleteExample($service, $project, $zone, $targetInstance)
{
	try
	{
		...
		return $service->targetInstances->DeleteTargetInstances($project, $zone, $targetInstance);
	}
	catch (Exception $ex)
	{
