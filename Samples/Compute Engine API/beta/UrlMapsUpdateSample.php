...
print_r(urlMapsUpdateExample($service, $project, $urlMap));
...
*/
function urlMapsUpdateExample($service, $project, $urlMap)
{
	try
	{
		...
		return $service->urlMaps->UpdateUrlMaps($project, $urlMap);
	}
	catch (Exception $ex)
	{
