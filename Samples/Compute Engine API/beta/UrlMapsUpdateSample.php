...
// Single Request.
$results = urlMapsUpdateExample($service, $project, $urlMap, $optParams);
...
* @return Operation
*/
function urlMapsUpdateExample($service, $project, $urlMap, $optParams)
{
	try
	{
		...
		return $service->urlMaps->UpdateUrlMaps($project, $urlMap, $optParams);
	}
	catch (Exception $e)
	{
