...
print_r(regionInstanceGroupManagersPatchExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersPatchExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->PatchRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
