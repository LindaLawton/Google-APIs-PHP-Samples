...
// Single Request.
$results = regionInstanceGroupManagersPatchExample($service, $project, $region, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function regionInstanceGroupManagersPatchExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->PatchRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
