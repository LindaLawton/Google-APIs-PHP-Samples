...
print_r(regionAutoscalersListExample($service, $project, $region));
...
* @return RegionAutoscalerList</returns>
*/
function regionAutoscalersListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionAutoscalers->ListRegionAutoscalers($project, $region);
	}
	catch (Exception $ex)
	{
