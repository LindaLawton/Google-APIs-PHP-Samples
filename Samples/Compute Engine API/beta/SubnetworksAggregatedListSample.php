...
print_r(subnetworksAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of subnetworks.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return SubnetworkAggregatedList</returns>
*/
function subnetworksAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->subnetworks->AggregatedListSubnetworks($project);
	}
	catch (Exception $ex)
	{
