...
$results = subnetworksAggregatedListExample($service, $project, $optParams);
...
*/
function subnetworksAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->subnetworks->AggregatedListSubnetworks($project, $optParams);
	}
	catch (Exception $e)
	{
