...
// Single Request.
$results = instancesUpdateNetworkInterfaceExample($service, $project, $zone, $instance, $networkInterface, $optParams);
...
* @return Operation
*/
function instancesUpdateNetworkInterfaceExample($service, $project, $zone, $instance, $networkInterface, $optParams)
{
	try
	{
		...
		return $service->instances->UpdateNetworkInterfaceInstances($project, $zone, $instance, $networkInterface, $optParams);
	}
	catch (Exception $e)
	{
