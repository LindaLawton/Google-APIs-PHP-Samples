...
print_r(instancesUpdateNetworkInterfaceExample($service, $project, $zone, $instance, $networkInterface));
...
*/
function instancesUpdateNetworkInterfaceExample($service, $project, $zone, $instance, $networkInterface)
{
	try
	{
		...
		return $service->instances->UpdateNetworkInterfaceInstances($project, $zone, $instance, $networkInterface);
	}
	catch (Exception $ex)
	{
