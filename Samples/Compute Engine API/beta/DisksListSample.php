...
// Single Request.
$results = disksListExample($service, $project, $zone, $optParams);
...
* @return DiskList
*/
function disksListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->disks->ListDisks($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
