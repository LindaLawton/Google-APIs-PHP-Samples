...
print_r(globalForwardingRulesSetTargetExample($service, $project, $forwardingRule));
...
*/
function globalForwardingRulesSetTargetExample($service, $project, $forwardingRule)
{
	try
	{
		...
		return $service->globalForwardingRules->SetTargetGlobalForwardingRules($project, $forwardingRule);
	}
	catch (Exception $ex)
	{
