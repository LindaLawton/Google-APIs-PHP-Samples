...
print_r(get($service, $project, $region, $targetVpnGateway));
...
*/
function get($service, $project, $region, $targetVpnGateway)
{
	try
	{
		...
		return $service->get($project, $region, $targetVpnGateway);
	}
	catch (Exception $ex)
	{
