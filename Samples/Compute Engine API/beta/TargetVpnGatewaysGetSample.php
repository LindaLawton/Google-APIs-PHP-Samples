...
$results = targetVpnGatewaysGetExample($service, $project, $region, $targetVpnGateway, $optParams);
...
*/
function targetVpnGatewaysGetExample($service, $project, $region, $targetVpnGateway, $optParams)
{
	try
	{
		...
		return $service->targetVpnGateways->GetTargetVpnGateways($project, $region, $targetVpnGateway, $optParams);
	}
	catch (Exception $e)
	{
