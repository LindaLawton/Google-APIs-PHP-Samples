...
print_r(securityPoliciesInsertExample($service, $project));
...
*/
function securityPoliciesInsertExample($service, $project)
{
	try
	{
		...
		return $service->securityPolicies->InsertSecurityPolicies($project);
	}
	catch (Exception $ex)
	{
