...
print_r(instanceGroupManagersTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function instanceGroupManagersTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->instanceGroupManagers->TestIamPermissionsInstanceGroupManagers($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
