...
// Single Request.
$results = targetInstancesGetExample($service, $project, $zone, $targetInstance, $optParams);
...
*/
function targetInstancesGetExample($service, $project, $zone, $targetInstance, $optParams)
{
	try
	{
		...
		return $service->targetInstances->GetTargetInstances($project, $zone, $targetInstance, $optParams);
	}
	catch (Exception $e)
	{
