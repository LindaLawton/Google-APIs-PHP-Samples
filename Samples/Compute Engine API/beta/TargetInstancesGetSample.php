...
print_r(targetInstancesGetExample($service, $project, $zone, $targetInstance));
...
* @return TargetInstance</returns>
*/
function targetInstancesGetExample($service, $project, $zone, $targetInstance)
{
	try
	{
		...
		return $service->targetInstances->GetTargetInstances($project, $zone, $targetInstance);
	}
	catch (Exception $ex)
	{
