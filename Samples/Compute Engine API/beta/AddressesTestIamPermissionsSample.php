...
print_r(addressesTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function addressesTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->addresses->TestIamPermissionsAddresses($project, $region, $resource);
	}
	catch (Exception $ex)
	{
