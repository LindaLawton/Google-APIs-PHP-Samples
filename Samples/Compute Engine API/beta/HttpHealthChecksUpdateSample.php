...
print_r(httpHealthChecksUpdateExample($service, $project, $httpHealthCheck));
...
*/
function httpHealthChecksUpdateExample($service, $project, $httpHealthCheck)
{
	try
	{
		...
		return $service->httpHealthChecks->UpdateHttpHealthChecks($project, $httpHealthCheck);
	}
	catch (Exception $ex)
	{
