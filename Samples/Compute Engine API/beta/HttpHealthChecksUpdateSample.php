...
// Single Request.
$results = httpHealthChecksUpdateExample($service, $project, $httpHealthCheck, $optParams);
...
* @return Operation
*/
function httpHealthChecksUpdateExample($service, $project, $httpHealthCheck, $optParams)
{
	try
	{
		...
		return $service->httpHealthChecks->UpdateHttpHealthChecks($project, $httpHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
