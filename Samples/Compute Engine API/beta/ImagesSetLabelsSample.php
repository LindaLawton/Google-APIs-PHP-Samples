...
// Single Request.
$results = imagesSetLabelsExample($service, $project, $resource, $optParams);
...
* @return Operation
*/
function imagesSetLabelsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->images->SetLabelsImages($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
