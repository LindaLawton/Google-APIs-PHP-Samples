...
// Single Request.
$results = regionBackendServicesUpdateExample($service, $project, $region, $backendService, $optParams);
...
* @return Operation
*/
function regionBackendServicesUpdateExample($service, $project, $region, $backendService, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->UpdateRegionBackendServices($project, $region, $backendService, $optParams);
	}
	catch (Exception $e)
	{
