...
print_r(vpnTunnelsTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function vpnTunnelsTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->vpnTunnels->TestIamPermissionsVpnTunnels($project, $region, $resource);
	}
	catch (Exception $ex)
	{
