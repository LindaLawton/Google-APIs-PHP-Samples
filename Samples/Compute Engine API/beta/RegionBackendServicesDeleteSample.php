...
print_r(regionBackendServicesDeleteExample($service, $project, $region, $backendService));
...
*/
function regionBackendServicesDeleteExample($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->regionBackendServices->DeleteRegionBackendServices($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
