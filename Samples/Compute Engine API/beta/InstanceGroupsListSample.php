...
$results = instanceGroupsListExample($service, $project, $zone, $optParams);
...
*/
function instanceGroupsListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->ListInstanceGroups($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
