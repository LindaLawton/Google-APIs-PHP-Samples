...
$results = networksAddPeeringExample($service, $project, $network, $optParams);
...
* @return Operation
*/
function networksAddPeeringExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->AddPeeringNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
