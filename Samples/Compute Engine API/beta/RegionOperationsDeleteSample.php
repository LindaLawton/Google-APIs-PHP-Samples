...
print_r(regionOperationsDeleteExample($service, $project, $region, $operation));
...
*/
function regionOperationsDeleteExample($service, $project, $region, $operation)
{
	try
	{
		...
		return $service->regionOperations->DeleteRegionOperations($project, $region, $operation);
	}
	catch (Exception $ex)
	{
