...
// Single Request.
$results = instanceTemplatesDeleteExample($service, $project, $instanceTemplate, $optParams);
...
* @return Operation
*/
function instanceTemplatesDeleteExample($service, $project, $instanceTemplate, $optParams)
{
	try
	{
		...
		if (instanceTemplate == null)
			throw new Exception("instanceTemplate is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->instanceTemplates->DeleteInstanceTemplates($project, $instanceTemplate, $optParams);
	}
	catch (Exception $e)
	{
