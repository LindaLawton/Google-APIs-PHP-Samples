...
print_r(instanceTemplatesDeleteExample($service, $project, $instanceTemplate));
...
*/
function instanceTemplatesDeleteExample($service, $project, $instanceTemplate)
{
	try
	{
		...
		return $service->instanceTemplates->DeleteInstanceTemplates($project, $instanceTemplate);
	}
	catch (Exception $ex)
	{
