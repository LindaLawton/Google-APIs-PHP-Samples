...
$results = healthChecksPatchExample($service, $project, $healthCheck, $optParams);
...
* @return Operation
*/
function healthChecksPatchExample($service, $project, $healthCheck, $optParams)
{
	try
	{
		...
		return $service->healthChecks->PatchHealthChecks($project, $healthCheck, $optParams);
	}
	catch (Exception $e)
	{
