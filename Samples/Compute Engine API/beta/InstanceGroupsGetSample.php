...
print_r(instanceGroupsGetExample($service, $project, $zone, $instanceGroup));
...
*/
function instanceGroupsGetExample($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->instanceGroups->GetInstanceGroups($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
