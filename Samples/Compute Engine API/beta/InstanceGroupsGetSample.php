...
// Single Request.
$results = instanceGroupsGetExample($service, $project, $zone, $instanceGroup, $optParams);
...
*/
function instanceGroupsGetExample($service, $project, $zone, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->GetInstanceGroups($project, $zone, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
