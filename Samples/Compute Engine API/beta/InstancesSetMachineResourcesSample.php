...
print_r(setMachineResources($service, $project, $zone, $instance));
...
*/
function setMachineResources($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->setMachineResources($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
