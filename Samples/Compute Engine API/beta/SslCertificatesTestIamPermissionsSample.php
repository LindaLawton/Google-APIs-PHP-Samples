...
print_r(sslCertificatesTestIamPermissionsExample($service, $project, $resource));
...
*/
function sslCertificatesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->sslCertificates->TestIamPermissionsSslCertificates($project, $resource);
	}
	catch (Exception $ex)
	{
