...
// Single Request.
$results = sslCertificatesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function sslCertificatesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->sslCertificates->TestIamPermissionsSslCertificates($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
