...
print_r(regionInstanceGroupsListInstancesExample($service, $project, $region, $instanceGroup));
...
* @return RegionInstanceGroupsListInstances</returns>
*/
function regionInstanceGroupsListInstancesExample($service, $project, $region, $instanceGroup)
{
	try
	{
		...
		return $service->regionInstanceGroups->ListInstancesRegionInstanceGroups($project, $region, $instanceGroup);
	}
	catch (Exception $ex)
	{
