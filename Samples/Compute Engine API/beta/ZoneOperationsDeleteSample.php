...
$results = zoneOperationsDeleteExample($service, $project, $zone, $operation, $optParams);
...
*/
function zoneOperationsDeleteExample($service, $project, $zone, $operation, $optParams)
{
	try
	{
		...
		return $service->zoneOperations->DeleteZoneOperations($project, $zone, $operation, $optParams);
	}
	catch (Exception $e)
	{
