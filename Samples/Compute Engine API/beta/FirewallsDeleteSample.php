...
print_r(firewallsDeleteExample($service, $project, $firewall));
...
*/
function firewallsDeleteExample($service, $project, $firewall)
{
	try
	{
		...
		return $service->firewalls->DeleteFirewalls($project, $firewall);
	}
	catch (Exception $ex)
	{
