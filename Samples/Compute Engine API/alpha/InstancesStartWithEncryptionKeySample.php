...
print_r(instancesStartWithEncryptionKeyExample($service, $project, $zone, $instance));
...
*/
function instancesStartWithEncryptionKeyExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->StartWithEncryptionKeyInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
