...
print_r(projectsSetUsageExportBucketExample($service, $project));
...
*/
function projectsSetUsageExportBucketExample($service, $project)
{
	try
	{
		...
		return $service->projects->SetUsageExportBucketProjects($project);
	}
	catch (Exception $ex)
	{
