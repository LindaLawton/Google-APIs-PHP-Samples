...
print_r(sslPoliciesGetExample($service, $project, $sslPolicy));
...
* @return SslPolicy</returns>
*/
function sslPoliciesGetExample($service, $project, $sslPolicy)
{
	try
	{
		...
		return $service->sslPolicies->GetSslPolicies($project, $sslPolicy);
	}
	catch (Exception $ex)
	{
