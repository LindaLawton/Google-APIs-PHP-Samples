...
// Single Request.
$results = sslPoliciesGetExample($service, $project, $sslPolicy, $optParams);
...
* @return SslPolicy
*/
function sslPoliciesGetExample($service, $project, $sslPolicy, $optParams)
{
	try
	{
		...
		return $service->sslPolicies->GetSslPolicies($project, $sslPolicy, $optParams);
	}
	catch (Exception $e)
	{
