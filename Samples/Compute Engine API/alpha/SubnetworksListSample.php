...
// Single Request.
$results = subnetworksListExample($service, $project, $region, $optParams);
...
*/
function subnetworksListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->subnetworks->ListSubnetworks($project, $region, $optParams);
	}
	catch (Exception $e)
	{
