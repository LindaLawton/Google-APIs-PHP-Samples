...
// Single Request.
$results = routersListExample($service, $project, $region, $optParams);
...
* @return RouterList
*/
function routersListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->routers->ListRouters($project, $region, $optParams);
	}
	catch (Exception $e)
	{
