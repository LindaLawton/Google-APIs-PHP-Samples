...
print_r(regionInstanceGroupManagersInsertExample($service, $project, $region));
...
*/
function regionInstanceGroupManagersInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->InsertRegionInstanceGroupManagers($project, $region);
	}
	catch (Exception $ex)
	{
