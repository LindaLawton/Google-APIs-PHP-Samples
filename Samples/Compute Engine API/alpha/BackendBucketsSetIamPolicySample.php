...
print_r(backendBucketsSetIamPolicyExample($service, $project, $resource));
...
*/
function backendBucketsSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->backendBuckets->SetIamPolicyBackendBuckets($project, $resource);
	}
	catch (Exception $ex)
	{
