...
// Single Request.
$results = backendBucketsSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function backendBucketsSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->SetIamPolicyBackendBuckets($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
