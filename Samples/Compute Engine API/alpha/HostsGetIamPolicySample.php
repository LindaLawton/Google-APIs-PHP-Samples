...
print_r(hostsGetIamPolicyExample($service, $project, $zone, $resource));
...
*/
function hostsGetIamPolicyExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->hosts->GetIamPolicyHosts($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
