...
// Single Request.
$results = hostsGetIamPolicyExample($service, $project, $zone, $resource, $optParams);
...
* @return Policy
*/
function hostsGetIamPolicyExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->hosts->GetIamPolicyHosts($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
