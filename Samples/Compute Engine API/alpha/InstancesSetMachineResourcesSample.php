...
// Single Request.
$results = instancesSetMachineResourcesExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetMachineResourcesExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetMachineResourcesInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
