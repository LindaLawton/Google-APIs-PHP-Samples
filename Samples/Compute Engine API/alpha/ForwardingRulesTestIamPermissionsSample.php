...
// Single Request.
$results = forwardingRulesTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function forwardingRulesTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->TestIamPermissionsForwardingRules($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
