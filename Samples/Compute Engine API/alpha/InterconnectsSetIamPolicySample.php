...
$results = interconnectsSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function interconnectsSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnects->SetIamPolicyInterconnects($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
