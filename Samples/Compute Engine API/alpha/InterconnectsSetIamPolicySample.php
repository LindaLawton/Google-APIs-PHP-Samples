...
print_r(interconnectsSetIamPolicyExample($service, $project, $resource));
...
*/
function interconnectsSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->interconnects->SetIamPolicyInterconnects($project, $resource);
	}
	catch (Exception $ex)
	{
