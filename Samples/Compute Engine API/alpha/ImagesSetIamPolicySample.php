...
// Single Request.
$results = imagesSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function imagesSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->images->SetIamPolicyImages($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
