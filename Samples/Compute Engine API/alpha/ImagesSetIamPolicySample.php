...
print_r(imagesSetIamPolicyExample($service, $project, $resource));
...
*/
function imagesSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->images->SetIamPolicyImages($project, $resource);
	}
	catch (Exception $ex)
	{
