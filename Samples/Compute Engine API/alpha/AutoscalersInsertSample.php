...
// Single Request.
$results = autoscalersInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function autoscalersInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->autoscalers->InsertAutoscalers($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
