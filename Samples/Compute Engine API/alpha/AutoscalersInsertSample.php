...
print_r(autoscalersInsertExample($service, $project, $zone));
...
*/
function autoscalersInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->autoscalers->InsertAutoscalers($project, $zone);
	}
	catch (Exception $ex)
	{
