...
print_r(addSignedUrlKey($service, $project, $backendService));
...
*/
function addSignedUrlKey($service, $project, $backendService)
{
	try
	{
		...
		return $service->addSignedUrlKey($project, $backendService);
	}
	catch (Exception $ex)
	{
