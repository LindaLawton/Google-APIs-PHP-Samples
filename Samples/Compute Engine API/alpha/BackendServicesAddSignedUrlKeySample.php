...
print_r(backendServicesAddSignedUrlKeyExample($service, $project, $backendService));
...
*/
function backendServicesAddSignedUrlKeyExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->AddSignedUrlKeyBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
