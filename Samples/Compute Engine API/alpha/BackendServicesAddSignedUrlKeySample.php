...
// Single Request.
$results = backendServicesAddSignedUrlKeyExample($service, $project, $backendService, $optParams);
...
* @return Operation
*/
function backendServicesAddSignedUrlKeyExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->AddSignedUrlKeyBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
