...
// Single Request.
$results = snapshotsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function snapshotsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->TestIamPermissionsSnapshots($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
