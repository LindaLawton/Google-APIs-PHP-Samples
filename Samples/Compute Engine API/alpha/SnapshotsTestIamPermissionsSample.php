...
print_r(snapshotsTestIamPermissionsExample($service, $project, $resource));
...
*/
function snapshotsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->snapshots->TestIamPermissionsSnapshots($project, $resource);
	}
	catch (Exception $ex)
	{
