...
print_r(snapshotsGetIamPolicyExample($service, $project, $resource));
...
*/
function snapshotsGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->snapshots->GetIamPolicySnapshots($project, $resource);
	}
	catch (Exception $ex)
	{
