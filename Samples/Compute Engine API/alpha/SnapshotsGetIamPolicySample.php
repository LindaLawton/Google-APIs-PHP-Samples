...
// Single Request.
$results = snapshotsGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function snapshotsGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->GetIamPolicySnapshots($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
