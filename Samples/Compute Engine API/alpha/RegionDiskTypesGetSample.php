...
print_r(regionDiskTypesGetExample($service, $project, $region, $diskType));
...
* @return DiskType</returns>
*/
function regionDiskTypesGetExample($service, $project, $region, $diskType)
{
	try
	{
		...
		return $service->regionDiskTypes->GetRegionDiskTypes($project, $region, $diskType);
	}
	catch (Exception $ex)
	{
