...
$results = regionDiskTypesGetExample($service, $project, $region, $diskType, $optParams);
...
* @return DiskType
*/
function regionDiskTypesGetExample($service, $project, $region, $diskType, $optParams)
{
	try
	{
		...
		if (diskType == null)
			throw new Exception("diskType is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (region == null)
			throw new Exception("region is required.");
		// Make the request and return the results.
		return $service->regionDiskTypes->GetRegionDiskTypes($project, $region, $diskType, $optParams);
	}
	catch (Exception $e)
	{
