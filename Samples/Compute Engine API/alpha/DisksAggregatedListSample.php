...
// Single Request.
$results = disksAggregatedListExample($service, $project, $optParams);
...
*/
function disksAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->disks->AggregatedListDisks($project, $optParams);
	}
	catch (Exception $e)
	{
