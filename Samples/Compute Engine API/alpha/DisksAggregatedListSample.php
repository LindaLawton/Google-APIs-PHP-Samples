...
print_r(disksAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of persistent disks.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return DiskAggregatedList</returns>
*/
function disksAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->disks->AggregatedListDisks($project);
	}
	catch (Exception $ex)
	{
