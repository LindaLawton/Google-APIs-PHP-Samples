...
print_r(setProxyHeader($service, $project, $targetTcpProxy));
...
*/
function setProxyHeader($service, $project, $targetTcpProxy)
{
	try
	{
		...
		return $service->setProxyHeader($project, $targetTcpProxy);
	}
	catch (Exception $ex)
	{
