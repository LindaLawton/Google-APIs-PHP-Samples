...
// Single Request.
$results = instancesSetServiceAccountExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetServiceAccountExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetServiceAccountInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
