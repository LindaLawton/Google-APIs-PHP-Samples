...
$results = licenseCodesSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function licenseCodesSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->licenseCodes->SetIamPolicyLicenseCodes($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
