...
print_r(diskTypesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of disk types.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return DiskTypeAggregatedList</returns>
*/
function diskTypesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->diskTypes->AggregatedListDiskTypes($project);
	}
	catch (Exception $ex)
	{
