...
// Single Request.
$results = diskTypesAggregatedListExample($service, $project, $optParams);
...
*/
function diskTypesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->diskTypes->AggregatedListDiskTypes($project, $optParams);
	}
	catch (Exception $e)
	{
