...
print_r(instancesAddAccessConfigExample($service, $project, $zone, $instance, $networkInterface));
...
*/
function instancesAddAccessConfigExample($service, $project, $zone, $instance, $networkInterface)
{
	try
	{
		...
		return $service->instances->AddAccessConfigInstances($project, $zone, $instance, $networkInterface);
	}
	catch (Exception $ex)
	{
