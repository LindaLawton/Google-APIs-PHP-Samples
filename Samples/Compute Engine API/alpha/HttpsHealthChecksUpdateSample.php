...
print_r(httpsHealthChecksUpdateExample($service, $project, $httpsHealthCheck));
...
*/
function httpsHealthChecksUpdateExample($service, $project, $httpsHealthCheck)
{
	try
	{
		...
		return $service->httpsHealthChecks->UpdateHttpsHealthChecks($project, $httpsHealthCheck);
	}
	catch (Exception $ex)
	{
