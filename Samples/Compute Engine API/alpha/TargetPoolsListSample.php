...
// Single Request.
$results = targetPoolsListExample($service, $project, $region, $optParams);
...
*/
function targetPoolsListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->targetPools->ListTargetPools($project, $region, $optParams);
	}
	catch (Exception $e)
	{
