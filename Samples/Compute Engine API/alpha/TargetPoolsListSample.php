...
print_r(targetPoolsListExample($service, $project, $region));
...
* @return TargetPoolList</returns>
*/
function targetPoolsListExample($service, $project, $region)
{
	try
	{
		...
		return $service->targetPools->ListTargetPools($project, $region);
	}
	catch (Exception $ex)
	{
