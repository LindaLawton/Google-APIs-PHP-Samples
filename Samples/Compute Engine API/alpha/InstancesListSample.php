...
print_r(instancesListExample($service, $project, $zone));
...
* @return InstanceList</returns>
*/
function instancesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->instances->ListInstances($project, $zone);
	}
	catch (Exception $ex)
	{
