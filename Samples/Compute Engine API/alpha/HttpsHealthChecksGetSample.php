...
print_r(httpsHealthChecksGetExample($service, $project, $httpsHealthCheck));
...
* @return HttpsHealthCheck</returns>
*/
function httpsHealthChecksGetExample($service, $project, $httpsHealthCheck)
{
	try
	{
		...
		return $service->httpsHealthChecks->GetHttpsHealthChecks($project, $httpsHealthCheck);
	}
	catch (Exception $ex)
	{
