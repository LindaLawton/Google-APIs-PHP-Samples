...
// Single Request.
$results = targetPoolsRemoveInstanceExample($service, $project, $region, $targetPool, $optParams);
...
* @return Operation
*/
function targetPoolsRemoveInstanceExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->RemoveInstanceTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
