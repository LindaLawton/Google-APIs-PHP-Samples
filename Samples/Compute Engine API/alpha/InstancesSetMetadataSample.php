...
print_r(instancesSetMetadataExample($service, $project, $zone, $instance));
...
*/
function instancesSetMetadataExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SetMetadataInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
