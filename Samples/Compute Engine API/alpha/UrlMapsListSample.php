...
// Single Request.
$results = urlMapsListExample($service, $project, $optParams);
...
* @return UrlMapList
*/
function urlMapsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->urlMaps->ListUrlMaps($project, $optParams);
	}
	catch (Exception $e)
	{
