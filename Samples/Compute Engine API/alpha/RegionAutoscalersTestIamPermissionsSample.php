...
// Single Request.
$results = regionAutoscalersTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function regionAutoscalersTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionAutoscalers->TestIamPermissionsRegionAutoscalers($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
