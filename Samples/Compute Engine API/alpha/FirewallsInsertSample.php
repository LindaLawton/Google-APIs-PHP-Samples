...
// Single Request.
$results = firewallsInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function firewallsInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->firewalls->InsertFirewalls($project, $optParams);
	}
	catch (Exception $e)
	{
