...
print_r(networksGetExample($service, $project, $network));
...
* @return Network</returns>
*/
function networksGetExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->GetNetworks($project, $network);
	}
	catch (Exception $ex)
	{
