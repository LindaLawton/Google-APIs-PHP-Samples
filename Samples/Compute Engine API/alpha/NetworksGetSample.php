...
// Single Request.
$results = networksGetExample($service, $project, $network, $optParams);
...
* @return Network
*/
function networksGetExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->GetNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
