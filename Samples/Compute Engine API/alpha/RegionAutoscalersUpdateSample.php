...
print_r(regionAutoscalersUpdateExample($service, $project, $region));
...
*/
function regionAutoscalersUpdateExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionAutoscalers->UpdateRegionAutoscalers($project, $region);
	}
	catch (Exception $ex)
	{
