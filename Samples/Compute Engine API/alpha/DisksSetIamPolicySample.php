...
print_r(disksSetIamPolicyExample($service, $project, $zone, $resource));
...
*/
function disksSetIamPolicyExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->disks->SetIamPolicyDisks($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
