...
print_r(setIamPolicy($service, $project, $zone, $resource));
...
*/
function setIamPolicy($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->setIamPolicy($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
