...
$results = disksSetIamPolicyExample($service, $project, $zone, $resource, $optParams);
...
* @return Policy
*/
function disksSetIamPolicyExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->disks->SetIamPolicyDisks($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
