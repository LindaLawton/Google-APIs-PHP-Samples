...
print_r(interconnectsListExample($service, $project));

/**
* Retrieves the list of interconnect available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return InterconnectList</returns>
*/
function interconnectsListExample($service, $project)
{
	try
	{
		...
		return $service->interconnects->ListInterconnects($project);
	}
	catch (Exception $ex)
	{
