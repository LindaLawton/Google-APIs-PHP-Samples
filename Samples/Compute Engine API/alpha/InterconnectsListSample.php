...
$results = interconnectsListExample($service, $project, $optParams);
...
*/
function interconnectsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->interconnects->ListInterconnects($project, $optParams);
	}
	catch (Exception $e)
	{
