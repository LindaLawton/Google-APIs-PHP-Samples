...
$results = regionAutoscalersListExample($service, $project, $region, $optParams);
...
*/
function regionAutoscalersListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionAutoscalers->ListRegionAutoscalers($project, $region, $optParams);
	}
	catch (Exception $e)
	{
