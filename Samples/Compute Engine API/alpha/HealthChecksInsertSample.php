...
// Single Request.
$results = healthChecksInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function healthChecksInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->healthChecks->InsertHealthChecks($project, $optParams);
	}
	catch (Exception $e)
	{
