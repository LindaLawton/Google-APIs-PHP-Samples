...
$results = targetSslProxiesSetBackendServiceExample($service, $project, $targetSslProxy, $optParams);
...
* @return Operation
*/
function targetSslProxiesSetBackendServiceExample($service, $project, $targetSslProxy, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->SetBackendServiceTargetSslProxies($project, $targetSslProxy, $optParams);
	}
	catch (Exception $e)
	{
