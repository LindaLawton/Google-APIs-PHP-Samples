...
print_r(instancesListReferrersExample($service, $project, $zone, $instance));
...
* @return InstanceListReferrers</returns>
*/
function instancesListReferrersExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->ListReferrersInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
