...
print_r(listReferrers($service, $project, $zone, $instance));
...
*/
function listReferrers($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->listReferrers($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
