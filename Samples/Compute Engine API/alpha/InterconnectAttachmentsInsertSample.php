...
// Single Request.
$results = interconnectAttachmentsInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function interconnectAttachmentsInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->InsertInterconnectAttachments($project, $region, $optParams);
	}
	catch (Exception $e)
	{
