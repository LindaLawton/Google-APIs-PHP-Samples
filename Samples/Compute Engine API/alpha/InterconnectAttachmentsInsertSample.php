...
print_r(interconnectAttachmentsInsertExample($service, $project, $region));
...
*/
function interconnectAttachmentsInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->interconnectAttachments->InsertInterconnectAttachments($project, $region);
	}
	catch (Exception $ex)
	{
