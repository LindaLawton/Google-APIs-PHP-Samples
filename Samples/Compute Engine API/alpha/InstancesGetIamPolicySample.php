...
print_r(instancesGetIamPolicyExample($service, $project, $zone, $resource));
...
*/
function instancesGetIamPolicyExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->instances->GetIamPolicyInstances($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
