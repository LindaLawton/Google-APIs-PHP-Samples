...
// Single Request.
$results = instancesGetIamPolicyExample($service, $project, $zone, $resource, $optParams);
...
* @return Policy
*/
function instancesGetIamPolicyExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->instances->GetIamPolicyInstances($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
