...
print_r(getIamPolicy($service, $project, $zone, $resource));
...
*/
function getIamPolicy($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->getIamPolicy($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
