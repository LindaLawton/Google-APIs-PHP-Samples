...
print_r(getIamPolicy($service, $project, $region, $resource));
...
*/
function getIamPolicy($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->getIamPolicy($project, $region, $resource);
	}
	catch (Exception $ex)
	{
