...
// Single Request.
$results = interconnectAttachmentsGetIamPolicyExample($service, $project, $region, $resource, $optParams);
...
* @return Policy
*/
function interconnectAttachmentsGetIamPolicyExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->GetIamPolicyInterconnectAttachments($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
