...
print_r(interconnectAttachmentsGetIamPolicyExample($service, $project, $region, $resource));
...
*/
function interconnectAttachmentsGetIamPolicyExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->interconnectAttachments->GetIamPolicyInterconnectAttachments($project, $region, $resource);
	}
	catch (Exception $ex)
	{
