...
print_r(healthChecksTestIamPermissionsExample($service, $project, $resource));
...
*/
function healthChecksTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->healthChecks->TestIamPermissionsHealthChecks($project, $resource);
	}
	catch (Exception $ex)
	{
