...
print_r(routersAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of routers.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return RouterAggregatedList</returns>
*/
function routersAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->routers->AggregatedListRouters($project);
	}
	catch (Exception $ex)
	{
