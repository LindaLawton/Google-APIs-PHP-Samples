...
print_r(imagesSetLabelsExample($service, $project, $resource));
...
*/
function imagesSetLabelsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->images->SetLabelsImages($project, $resource);
	}
	catch (Exception $ex)
	{
