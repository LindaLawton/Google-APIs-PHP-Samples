...
print_r(urlMapsGetExample($service, $project, $urlMap));
...
* @return UrlMap</returns>
*/
function urlMapsGetExample($service, $project, $urlMap)
{
	try
	{
		...
		return $service->urlMaps->GetUrlMaps($project, $urlMap);
	}
	catch (Exception $ex)
	{
