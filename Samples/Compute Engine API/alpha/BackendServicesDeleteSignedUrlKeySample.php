...
print_r(deleteSignedUrlKey($service, $project, $backendService, $keyName));
...
*/
function deleteSignedUrlKey($service, $project, $backendService, $keyName)
{
	try
	{
		...
		return $service->deleteSignedUrlKey($project, $backendService, $keyName);
	}
	catch (Exception $ex)
	{
