...
print_r(backendServicesDeleteSignedUrlKeyExample($service, $project, $backendService, $keyName));
...
*/
function backendServicesDeleteSignedUrlKeyExample($service, $project, $backendService, $keyName)
{
	try
	{
		...
		return $service->backendServices->DeleteSignedUrlKeyBackendServices($project, $backendService, $keyName);
	}
	catch (Exception $ex)
	{
