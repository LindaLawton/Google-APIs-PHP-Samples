...
$results = backendServicesDeleteSignedUrlKeyExample($service, $project, $backendService, $keyName, $optParams);
...
* @return Operation
*/
function backendServicesDeleteSignedUrlKeyExample($service, $project, $backendService, $keyName, $optParams)
{
	try
	{
		...
		return $service->backendServices->DeleteSignedUrlKeyBackendServices($project, $backendService, $keyName, $optParams);
	}
	catch (Exception $e)
	{
