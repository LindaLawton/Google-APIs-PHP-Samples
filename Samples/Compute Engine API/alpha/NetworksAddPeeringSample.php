...
print_r(networksAddPeeringExample($service, $project, $network));
...
*/
function networksAddPeeringExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->AddPeeringNetworks($project, $network);
	}
	catch (Exception $ex)
	{
