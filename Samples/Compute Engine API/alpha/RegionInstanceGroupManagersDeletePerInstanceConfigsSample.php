...
print_r(regionInstanceGroupManagersDeletePerInstanceConfigsExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersDeletePerInstanceConfigsExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->DeletePerInstanceConfigsRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
