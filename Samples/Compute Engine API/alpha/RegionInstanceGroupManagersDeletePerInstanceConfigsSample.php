...
print_r(deletePerInstanceConfigs($service, $project, $region, $instanceGroupManager));
...
*/
function deletePerInstanceConfigs($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->deletePerInstanceConfigs($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
