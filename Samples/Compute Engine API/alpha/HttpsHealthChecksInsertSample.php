...
// Single Request.
$results = httpsHealthChecksInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function httpsHealthChecksInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->httpsHealthChecks->InsertHttpsHealthChecks($project, $optParams);
	}
	catch (Exception $e)
	{
