...
print_r(patch($service, $project, $zone, $instanceGroupManager));
...
*/
function patch($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->patch($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
