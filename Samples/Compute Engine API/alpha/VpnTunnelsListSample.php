...
print_r(vpnTunnelsListExample($service, $project, $region));
...
* @return VpnTunnelList</returns>
*/
function vpnTunnelsListExample($service, $project, $region)
{
	try
	{
		...
		return $service->vpnTunnels->ListVpnTunnels($project, $region);
	}
	catch (Exception $ex)
	{
