...
// Single Request.
$results = backendServicesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function backendServicesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->backendServices->InsertBackendServices($project, $optParams);
	}
	catch (Exception $e)
	{
