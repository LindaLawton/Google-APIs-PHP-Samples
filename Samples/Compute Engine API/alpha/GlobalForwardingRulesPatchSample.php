...
// Single Request.
$results = globalForwardingRulesPatchExample($service, $project, $forwardingRule, $optParams);
...
* @return Operation
*/
function globalForwardingRulesPatchExample($service, $project, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->PatchGlobalForwardingRules($project, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
