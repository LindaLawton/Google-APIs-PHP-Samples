...
print_r(globalForwardingRulesPatchExample($service, $project, $forwardingRule));
...
*/
function globalForwardingRulesPatchExample($service, $project, $forwardingRule)
{
	try
	{
		...
		return $service->globalForwardingRules->PatchGlobalForwardingRules($project, $forwardingRule);
	}
	catch (Exception $ex)
	{
