...
print_r(networksListIpOwnersExample($service, $project, $network));
...
*/
function networksListIpOwnersExample($service, $project, $network)
{
	try
	{
		...
		return $service->networks->ListIpOwnersNetworks($project, $network);
	}
	catch (Exception $ex)
	{
