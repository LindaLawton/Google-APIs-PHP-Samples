...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ipCidrRange' => '[YourValue]',  // (Optional) IP CIDR range filter, example: "10.128.10.0/30".
  ...
  //'ownerProjects' => '[YourValue]',  // (Optional) Project IDs filter, example: "project-1,project-2".
            
  //'ownerTypes' => '[YourValue]',  // (Optional) Owner types filter, example: "instance,forwardingRule".
  ...
  //'subnetName' => '[YourValue]',  // (Optional) Subnetwork name filter.
            
  //'subnetRegion' => '[YourValue]',  // (Optional) Subnetwork region filter.
  'fields' => '*'
);
// Single Request.
$results = networksListIpOwnersExample($service, $project, $network, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $network, $optParams);	
...
* @return IpOwnerList
*/
function networksListIpOwnersExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->ListIpOwnersNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
