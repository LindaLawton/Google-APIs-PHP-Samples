...
print_r(regionDisksTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function regionDisksTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionDisks->TestIamPermissionsRegionDisks($project, $region, $resource);
	}
	catch (Exception $ex)
	{
