...
// Single Request.
$results = regionDisksTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function regionDisksTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionDisks->TestIamPermissionsRegionDisks($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
