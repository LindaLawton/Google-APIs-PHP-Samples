...
// Single Request.
$results = instanceGroupManagersUpdatePerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function instanceGroupManagersUpdatePerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->UpdatePerInstanceConfigsInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
