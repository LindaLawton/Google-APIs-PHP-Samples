...
print_r(updatePerInstanceConfigs($service, $project, $zone, $instanceGroupManager));
...
*/
function updatePerInstanceConfigs($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->updatePerInstanceConfigs($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
