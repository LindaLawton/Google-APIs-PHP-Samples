...
print_r(interconnectAttachmentsListExample($service, $project, $region));
...
* @return InterconnectAttachmentList</returns>
*/
function interconnectAttachmentsListExample($service, $project, $region)
{
	try
	{
		...
		return $service->interconnectAttachments->ListInterconnectAttachments($project, $region);
	}
	catch (Exception $ex)
	{
