...
// Single Request.
$results = hostsTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function hostsTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->hosts->TestIamPermissionsHosts($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
