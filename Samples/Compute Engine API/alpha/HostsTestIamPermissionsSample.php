...
print_r(hostsTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function hostsTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->hosts->TestIamPermissionsHosts($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
