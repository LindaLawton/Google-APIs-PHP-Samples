...
print_r(backendServicesListExample($service, $project));
...
*/
function backendServicesListExample($service, $project)
{
	try
	{
		...
		return $service->backendServices->ListBackendServices($project);
	}
	catch (Exception $ex)
	{
