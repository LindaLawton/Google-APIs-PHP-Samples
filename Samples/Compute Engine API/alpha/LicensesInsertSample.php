...
$results = licensesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function licensesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->licenses->InsertLicenses($project, $optParams);
	}
	catch (Exception $e)
	{
