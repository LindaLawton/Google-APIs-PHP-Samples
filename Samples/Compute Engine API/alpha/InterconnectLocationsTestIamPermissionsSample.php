...
// Single Request.
$results = interconnectLocationsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function interconnectLocationsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnectLocations->TestIamPermissionsInterconnectLocations($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
