...
print_r(interconnectLocationsTestIamPermissionsExample($service, $project, $resource));
...
*/
function interconnectLocationsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->interconnectLocations->TestIamPermissionsInterconnectLocations($project, $resource);
	}
	catch (Exception $ex)
	{
