...
print_r(licensesGetExample($service, $project, $license));
...
* @return License</returns>
*/
function licensesGetExample($service, $project, $license)
{
	try
	{
		...
		return $service->licenses->GetLicenses($project, $license);
	}
	catch (Exception $ex)
	{
