...
print_r(instanceGroupsTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function instanceGroupsTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->instanceGroups->TestIamPermissionsInstanceGroups($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
