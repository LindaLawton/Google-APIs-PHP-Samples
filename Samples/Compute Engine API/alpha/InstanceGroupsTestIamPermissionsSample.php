...
$results = instanceGroupsTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function instanceGroupsTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->instanceGroups->TestIamPermissionsInstanceGroups($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
