...
$results = autoscalersDeleteExample($service, $project, $zone, $autoscaler, $optParams);
...
* @return Operation
*/
function autoscalersDeleteExample($service, $project, $zone, $autoscaler, $optParams)
{
	try
	{
		...
		return $service->autoscalers->DeleteAutoscalers($project, $zone, $autoscaler, $optParams);
	}
	catch (Exception $e)
	{
