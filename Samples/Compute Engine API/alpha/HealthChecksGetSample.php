...
// Single Request.
$results = healthChecksGetExample($service, $project, $healthCheck, $optParams);
...
* @return HealthCheck
*/
function healthChecksGetExample($service, $project, $healthCheck, $optParams)
{
	try
	{
		...
		return $service->healthChecks->GetHealthChecks($project, $healthCheck, $optParams);
	}
	catch (Exception $e)
	{
