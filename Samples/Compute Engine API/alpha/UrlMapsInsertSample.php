...
$results = urlMapsInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function urlMapsInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->urlMaps->InsertUrlMaps($project, $optParams);
	}
	catch (Exception $e)
	{
