...
print_r(globalAddressesInsertExample($service, $project));
...
*/
function globalAddressesInsertExample($service, $project)
{
	try
	{
		...
		return $service->globalAddresses->InsertGlobalAddresses($project);
	}
	catch (Exception $ex)
	{
