...
print_r(regionAutoscalersInsertExample($service, $project, $region));
...
*/
function regionAutoscalersInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionAutoscalers->InsertRegionAutoscalers($project, $region);
	}
	catch (Exception $ex)
	{
