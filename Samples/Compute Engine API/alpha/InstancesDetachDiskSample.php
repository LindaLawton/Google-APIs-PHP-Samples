...
print_r(detachDisk($service, $project, $zone, $instance, $deviceName));
...
*/
function detachDisk($service, $project, $zone, $instance, $deviceName)
{
	try
	{
		...
		return $service->detachDisk($project, $zone, $instance, $deviceName);
	}
	catch (Exception $ex)
	{
