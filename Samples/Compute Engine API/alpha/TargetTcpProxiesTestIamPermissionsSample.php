...
print_r(targetTcpProxiesTestIamPermissionsExample($service, $project, $resource));
...
*/
function targetTcpProxiesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->targetTcpProxies->TestIamPermissionsTargetTcpProxies($project, $resource);
	}
	catch (Exception $ex)
	{
