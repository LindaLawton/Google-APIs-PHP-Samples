...
// Single Request.
$results = targetTcpProxiesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function targetTcpProxiesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->targetTcpProxies->TestIamPermissionsTargetTcpProxies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
