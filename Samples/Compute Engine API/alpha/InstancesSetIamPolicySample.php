...
$results = instancesSetIamPolicyExample($service, $project, $zone, $resource, $optParams);
...
* @return Policy
*/
function instancesSetIamPolicyExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->instances->SetIamPolicyInstances($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
