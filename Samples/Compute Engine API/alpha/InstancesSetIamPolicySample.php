...
print_r(instancesSetIamPolicyExample($service, $project, $zone, $resource));
...
*/
function instancesSetIamPolicyExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->instances->SetIamPolicyInstances($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
