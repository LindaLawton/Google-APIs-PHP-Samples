...
print_r(httpsHealthChecksDeleteExample($service, $project, $httpsHealthCheck));
...
*/
function httpsHealthChecksDeleteExample($service, $project, $httpsHealthCheck)
{
	try
	{
		...
		return $service->httpsHealthChecks->DeleteHttpsHealthChecks($project, $httpsHealthCheck);
	}
	catch (Exception $ex)
	{
