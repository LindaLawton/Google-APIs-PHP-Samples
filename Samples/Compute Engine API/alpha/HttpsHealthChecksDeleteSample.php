...
// Single Request.
$results = httpsHealthChecksDeleteExample($service, $project, $httpsHealthCheck, $optParams);
...
* @return Operation
*/
function httpsHealthChecksDeleteExample($service, $project, $httpsHealthCheck, $optParams)
{
	try
	{
		...
		return $service->httpsHealthChecks->DeleteHttpsHealthChecks($project, $httpsHealthCheck, $optParams);
	}
	catch (Exception $e)
	{
