...
// Single Request.
$results = targetPoolsGetExample($service, $project, $region, $targetPool, $optParams);
...
* @return TargetPool
*/
function targetPoolsGetExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->GetTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
