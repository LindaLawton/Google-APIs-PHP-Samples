...
print_r(targetPoolsGetExample($service, $project, $region, $targetPool));
...
* @return TargetPool</returns>
*/
function targetPoolsGetExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->GetTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
