...
print_r(listInstances($service, $project, $zone, $instanceGroup));
...
*/
function listInstances($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->listInstances($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
