...
$results = vpnTunnelsAggregatedListExample($service, $project, $optParams);
...
*/
function vpnTunnelsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->vpnTunnels->AggregatedListVpnTunnels($project, $optParams);
	}
	catch (Exception $e)
	{
