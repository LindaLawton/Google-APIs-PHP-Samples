...
// Single Request.
$results = targetInstancesInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function targetInstancesInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->targetInstances->InsertTargetInstances($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
