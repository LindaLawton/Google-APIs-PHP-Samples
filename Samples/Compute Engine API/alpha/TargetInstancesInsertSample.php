...
print_r(targetInstancesInsertExample($service, $project, $zone));
...
*/
function targetInstancesInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->targetInstances->InsertTargetInstances($project, $zone);
	}
	catch (Exception $ex)
	{
