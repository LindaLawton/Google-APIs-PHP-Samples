...
print_r(instanceGroupManagersAggregatedListExample($service, $project));

/**
* Retrieves the list of managed instance groups and groups them by zone.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return InstanceGroupManagerAggregatedList</returns>
*/
function instanceGroupManagersAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->instanceGroupManagers->AggregatedListInstanceGroupManagers($project);
	}
	catch (Exception $ex)
	{
