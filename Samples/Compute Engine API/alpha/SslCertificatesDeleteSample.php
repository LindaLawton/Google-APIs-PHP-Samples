...
print_r(sslCertificatesDeleteExample($service, $project, $sslCertificate));
...
*/
function sslCertificatesDeleteExample($service, $project, $sslCertificate)
{
	try
	{
		...
		return $service->sslCertificates->DeleteSslCertificates($project, $sslCertificate);
	}
	catch (Exception $ex)
	{
