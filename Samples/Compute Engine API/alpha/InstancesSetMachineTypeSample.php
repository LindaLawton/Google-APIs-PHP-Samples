...
print_r(setMachineType($service, $project, $zone, $instance));
...
*/
function setMachineType($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->setMachineType($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
