...
print_r(firewallsUpdateExample($service, $project, $firewall));
...
*/
function firewallsUpdateExample($service, $project, $firewall)
{
	try
	{
		...
		return $service->firewalls->UpdateFirewalls($project, $firewall);
	}
	catch (Exception $ex)
	{
