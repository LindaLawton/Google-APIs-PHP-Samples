...
print_r(securityPoliciesGetExample($service, $project, $securityPolicy));
...
* @return SecurityPolicy</returns>
*/
function securityPoliciesGetExample($service, $project, $securityPolicy)
{
	try
	{
		...
		return $service->securityPolicies->GetSecurityPolicies($project, $securityPolicy);
	}
	catch (Exception $ex)
	{
