...
// Single Request.
$results = securityPoliciesGetExample($service, $project, $securityPolicy, $optParams);
...
*/
function securityPoliciesGetExample($service, $project, $securityPolicy, $optParams)
{
	try
	{
		...
		return $service->securityPolicies->GetSecurityPolicies($project, $securityPolicy, $optParams);
	}
	catch (Exception $e)
	{
