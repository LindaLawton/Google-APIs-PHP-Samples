...
$results = networksListExample($service, $project, $optParams);
...
* @return NetworkList
*/
function networksListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->networks->ListNetworks($project, $optParams);
	}
	catch (Exception $e)
	{
