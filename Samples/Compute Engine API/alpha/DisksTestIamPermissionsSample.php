...
// Single Request.
$results = disksTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function disksTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->disks->TestIamPermissionsDisks($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
