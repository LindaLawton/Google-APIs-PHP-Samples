...
print_r(disksTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function disksTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->disks->TestIamPermissionsDisks($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
