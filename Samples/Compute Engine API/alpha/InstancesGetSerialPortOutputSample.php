...
print_r(instancesGetSerialPortOutputExample($service, $project, $zone, $instance));
...
* @return SerialPortOutput</returns>
*/
function instancesGetSerialPortOutputExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->GetSerialPortOutputInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
