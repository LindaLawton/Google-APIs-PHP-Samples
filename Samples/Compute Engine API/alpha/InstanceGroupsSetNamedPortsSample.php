...
print_r(instanceGroupsSetNamedPortsExample($service, $project, $zone, $instanceGroup));
...
*/
function instanceGroupsSetNamedPortsExample($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->instanceGroups->SetNamedPortsInstanceGroups($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
