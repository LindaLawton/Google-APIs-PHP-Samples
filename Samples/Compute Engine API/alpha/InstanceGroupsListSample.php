...
print_r(instanceGroupsListExample($service, $project, $zone));
...
* @return InstanceGroupList</returns>
*/
function instanceGroupsListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->instanceGroups->ListInstanceGroups($project, $zone);
	}
	catch (Exception $ex)
	{
