...
print_r(projectsDisableXpnResourceExample($service, $project));
...
*/
function projectsDisableXpnResourceExample($service, $project)
{
	try
	{
		...
		return $service->projects->DisableXpnResourceProjects($project);
	}
	catch (Exception $ex)
	{
