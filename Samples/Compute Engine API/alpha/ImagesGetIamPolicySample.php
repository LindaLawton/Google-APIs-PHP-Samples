...
print_r(imagesGetIamPolicyExample($service, $project, $resource));
...
*/
function imagesGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->images->GetIamPolicyImages($project, $resource);
	}
	catch (Exception $ex)
	{
