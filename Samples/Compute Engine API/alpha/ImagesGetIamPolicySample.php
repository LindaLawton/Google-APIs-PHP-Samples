...
// Single Request.
$results = imagesGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function imagesGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->images->GetIamPolicyImages($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
