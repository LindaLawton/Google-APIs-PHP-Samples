...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'autoscaler' => '[YourValue]',  //Name of the autoscaler to patch.
...
// Single Request.
$results = regionAutoscalersPatchExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionAutoscalersPatchExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionAutoscalers->PatchRegionAutoscalers($project, $region, $optParams);
	}
	catch (Exception $e)
	{
