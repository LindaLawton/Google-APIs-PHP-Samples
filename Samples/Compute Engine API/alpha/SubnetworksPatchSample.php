...
print_r(subnetworksPatchExample($service, $project, $region, $subnetwork));
...
*/
function subnetworksPatchExample($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->subnetworks->PatchSubnetworks($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
