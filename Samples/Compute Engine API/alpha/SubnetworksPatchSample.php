...
// Single Request.
$results = subnetworksPatchExample($service, $project, $region, $subnetwork, $optParams);
...
* @return Operation
*/
function subnetworksPatchExample($service, $project, $region, $subnetwork, $optParams)
{
	try
	{
		...
		return $service->subnetworks->PatchSubnetworks($project, $region, $subnetwork, $optParams);
	}
	catch (Exception $e)
	{
