...
print_r(hostTypesGetExample($service, $project, $zone, $hostType));
...
* @return HostType</returns>
*/
function hostTypesGetExample($service, $project, $zone, $hostType)
{
	try
	{
		...
		return $service->hostTypes->GetHostTypes($project, $zone, $hostType);
	}
	catch (Exception $ex)
	{
