...
// Single Request.
$results = hostTypesGetExample($service, $project, $zone, $hostType, $optParams);
...
* @return HostType
*/
function hostTypesGetExample($service, $project, $zone, $hostType, $optParams)
{
	try
	{
		...
		if (hostType == null)
			throw new Exception("hostType is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (zone == null)
			throw new Exception("zone is required.");
		// Make the request and return the results.
		return $service->hostTypes->GetHostTypes($project, $zone, $hostType, $optParams);
	}
	catch (Exception $e)
	{
