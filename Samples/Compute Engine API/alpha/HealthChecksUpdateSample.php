...
print_r(healthChecksUpdateExample($service, $project, $healthCheck));
...
*/
function healthChecksUpdateExample($service, $project, $healthCheck)
{
	try
	{
		...
		return $service->healthChecks->UpdateHealthChecks($project, $healthCheck);
	}
	catch (Exception $ex)
	{
