...
// Single Request.
$results = snapshotsSetLabelsExample($service, $project, $resource, $optParams);
...
* @return Operation
*/
function snapshotsSetLabelsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->SetLabelsSnapshots($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
