...
print_r(snapshotsSetLabelsExample($service, $project, $resource));
...
*/
function snapshotsSetLabelsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->snapshots->SetLabelsSnapshots($project, $resource);
	}
	catch (Exception $ex)
	{
