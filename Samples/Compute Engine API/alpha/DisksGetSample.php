...
// Single Request.
$results = disksGetExample($service, $project, $zone, $disk, $optParams);
...
* @return Disk
*/
function disksGetExample($service, $project, $zone, $disk, $optParams)
{
	try
	{
		...
		return $service->disks->GetDisks($project, $zone, $disk, $optParams);
	}
	catch (Exception $e)
	{
