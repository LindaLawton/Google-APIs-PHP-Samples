...
print_r(securityPoliciesTestIamPermissionsExample($service, $project, $resource));
...
*/
function securityPoliciesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->securityPolicies->TestIamPermissionsSecurityPolicies($project, $resource);
	}
	catch (Exception $ex)
	{
