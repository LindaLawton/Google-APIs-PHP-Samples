...
// Single Request.
$results = securityPoliciesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function securityPoliciesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->securityPolicies->TestIamPermissionsSecurityPolicies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
