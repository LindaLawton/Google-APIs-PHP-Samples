...
print_r(urlMapsTestIamPermissionsExample($service, $project, $resource));
...
*/
function urlMapsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->urlMaps->TestIamPermissionsUrlMaps($project, $resource);
	}
	catch (Exception $ex)
	{
