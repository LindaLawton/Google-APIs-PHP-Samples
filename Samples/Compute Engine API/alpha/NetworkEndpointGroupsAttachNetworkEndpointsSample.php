...
print_r(attachNetworkEndpoints($service, $project, $zone, $networkEndpointGroup));
...
*/
function attachNetworkEndpoints($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->attachNetworkEndpoints($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
