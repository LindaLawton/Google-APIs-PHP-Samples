...
print_r(networkEndpointGroupsAttachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup));
...
*/
function networkEndpointGroupsAttachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->networkEndpointGroups->AttachNetworkEndpointsNetworkEndpointGroups($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
