...
// Single Request.
$results = networkEndpointGroupsAttachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup, $optParams);
...
* @return Operation
*/
function networkEndpointGroupsAttachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->AttachNetworkEndpointsNetworkEndpointGroups($project, $zone, $networkEndpointGroup, $optParams);
	}
	catch (Exception $e)
	{
