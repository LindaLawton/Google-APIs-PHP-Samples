...
print_r(setMinCpuPlatform($service, $project, $zone, $instance));
...
*/
function setMinCpuPlatform($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->setMinCpuPlatform($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
