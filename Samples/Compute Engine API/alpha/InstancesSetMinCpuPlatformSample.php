...
// Single Request.
$results = instancesSetMinCpuPlatformExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetMinCpuPlatformExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetMinCpuPlatformInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
