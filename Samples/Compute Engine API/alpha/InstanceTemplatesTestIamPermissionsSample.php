...
$results = instanceTemplatesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function instanceTemplatesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->instanceTemplates->TestIamPermissionsInstanceTemplates($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
