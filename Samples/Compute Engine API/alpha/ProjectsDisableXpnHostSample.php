...
// Single Request.
$results = projectsDisableXpnHostExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsDisableXpnHostExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->DisableXpnHostProjects($project, $optParams);
	}
	catch (Exception $e)
	{
