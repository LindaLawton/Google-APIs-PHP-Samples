...
print_r(projectsDisableXpnHostExample($service, $project));
...
*/
function projectsDisableXpnHostExample($service, $project)
{
	try
	{
		...
		return $service->projects->DisableXpnHostProjects($project);
	}
	catch (Exception $ex)
	{
