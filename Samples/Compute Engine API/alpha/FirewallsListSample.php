...
// Single Request.
$results = firewallsListExample($service, $project, $optParams);
...
* @return FirewallList
*/
function firewallsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->firewalls->ListFirewalls($project, $optParams);
	}
	catch (Exception $e)
	{
