...
print_r(regionOperationsGetExample($service, $project, $region, $operation));
...
*/
function regionOperationsGetExample($service, $project, $region, $operation)
{
	try
	{
		...
		return $service->regionOperations->GetRegionOperations($project, $region, $operation);
	}
	catch (Exception $ex)
	{
