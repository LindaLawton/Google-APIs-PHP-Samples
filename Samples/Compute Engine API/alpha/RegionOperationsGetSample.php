...
// Single Request.
$results = regionOperationsGetExample($service, $project, $region, $operation, $optParams);
...
* @return Operation
*/
function regionOperationsGetExample($service, $project, $region, $operation, $optParams)
{
	try
	{
		...
		return $service->regionOperations->GetRegionOperations($project, $region, $operation, $optParams);
	}
	catch (Exception $e)
	{
