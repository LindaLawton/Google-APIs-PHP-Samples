...
// Single Request.
$results = backendServicesSetSecurityPolicyExample($service, $project, $backendService, $optParams);
...
* @return Operation
*/
function backendServicesSetSecurityPolicyExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->SetSecurityPolicyBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
