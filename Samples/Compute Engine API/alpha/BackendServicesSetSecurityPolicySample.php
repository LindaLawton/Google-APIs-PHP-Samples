...
print_r(setSecurityPolicy($service, $project, $backendService));
...
*/
function setSecurityPolicy($service, $project, $backendService)
{
	try
	{
		...
		return $service->setSecurityPolicy($project, $backendService);
	}
	catch (Exception $ex)
	{
