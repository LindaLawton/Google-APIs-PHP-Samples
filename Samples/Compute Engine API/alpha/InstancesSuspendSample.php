...
print_r(instancesSuspendExample($service, $project, $zone, $instance));
...
*/
function instancesSuspendExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SuspendInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
