...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'discardLocalSsd' => '[YourValue]',  // If true, discard the contents of any attached localSSD partitions. Default value is false (== preserve localSSD data).
...
// Single Request.
$results = instancesSuspendExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSuspendExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SuspendInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
