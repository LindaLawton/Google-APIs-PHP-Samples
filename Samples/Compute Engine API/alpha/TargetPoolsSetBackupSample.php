...
print_r(targetPoolsSetBackupExample($service, $project, $region, $targetPool));
...
*/
function targetPoolsSetBackupExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->SetBackupTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
