...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'failoverRatio' => '[YourValue]',  // New failoverRatio value for the target pool.
...
// Single Request.
$results = targetPoolsSetBackupExample($service, $project, $region, $targetPool, $optParams);
...
* @return Operation
*/
function targetPoolsSetBackupExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		if (targetPool == null)
			throw new Exception("targetPool is required.");
		// Make the request and return the results.
		return $service->targetPools->SetBackupTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
