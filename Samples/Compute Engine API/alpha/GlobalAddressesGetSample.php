...
// Single Request.
$results = globalAddressesGetExample($service, $project, $address, $optParams);
...
* @return Address
*/
function globalAddressesGetExample($service, $project, $address, $optParams)
{
	try
	{
		...
		return $service->globalAddresses->GetGlobalAddresses($project, $address, $optParams);
	}
	catch (Exception $e)
	{
