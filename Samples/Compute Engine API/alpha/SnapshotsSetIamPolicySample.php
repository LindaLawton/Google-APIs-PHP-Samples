...
// Single Request.
$results = snapshotsSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function snapshotsSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->snapshots->SetIamPolicySnapshots($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
