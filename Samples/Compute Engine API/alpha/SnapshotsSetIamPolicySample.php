...
print_r(snapshotsSetIamPolicyExample($service, $project, $resource));
...
*/
function snapshotsSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->snapshots->SetIamPolicySnapshots($project, $resource);
	}
	catch (Exception $ex)
	{
