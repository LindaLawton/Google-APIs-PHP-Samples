...
print_r(regionDisksDeleteExample($service, $project, $region, $disk));
...
*/
function regionDisksDeleteExample($service, $project, $region, $disk)
{
	try
	{
		...
		return $service->regionDisks->DeleteRegionDisks($project, $region, $disk);
	}
	catch (Exception $ex)
	{
