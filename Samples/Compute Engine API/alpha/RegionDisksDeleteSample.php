...
$results = regionDisksDeleteExample($service, $project, $region, $disk, $optParams);
...
* @return Operation
*/
function regionDisksDeleteExample($service, $project, $region, $disk, $optParams)
{
	try
	{
		...
		return $service->regionDisks->DeleteRegionDisks($project, $region, $disk, $optParams);
	}
	catch (Exception $e)
	{
