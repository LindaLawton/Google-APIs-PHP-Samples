...
// Single Request.
$results = routersTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function routersTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->routers->TestIamPermissionsRouters($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
