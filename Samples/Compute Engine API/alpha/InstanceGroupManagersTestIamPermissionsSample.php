...
$results = instanceGroupManagersTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function instanceGroupManagersTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->TestIamPermissionsInstanceGroupManagers($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
