...
// Single Request.
$results = networkEndpointGroupsInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function networkEndpointGroupsInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->InsertNetworkEndpointGroups($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
