...
print_r(networkEndpointGroupsInsertExample($service, $project, $zone));
...
*/
function networkEndpointGroupsInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->networkEndpointGroups->InsertNetworkEndpointGroups($project, $zone);
	}
	catch (Exception $ex)
	{
