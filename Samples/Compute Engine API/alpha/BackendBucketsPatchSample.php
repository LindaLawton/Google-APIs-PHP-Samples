...
// Single Request.
$results = backendBucketsPatchExample($service, $project, $backendBucket, $optParams);
...
* @return Operation
*/
function backendBucketsPatchExample($service, $project, $backendBucket, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->PatchBackendBuckets($project, $backendBucket, $optParams);
	}
	catch (Exception $e)
	{
