 ...
 * Initializes an Compute.alpha service object.
 * @param string API key
 * @return An authorized Compute.alpha service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Compute Sample");
		...
		// Create authenticated Compute service
