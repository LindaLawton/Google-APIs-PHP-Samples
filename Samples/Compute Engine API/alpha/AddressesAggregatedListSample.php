...
print_r(addressesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of addresses.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return AddressAggregatedList</returns>
*/
function addressesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->addresses->AggregatedListAddresses($project);
	}
	catch (Exception $ex)
	{
