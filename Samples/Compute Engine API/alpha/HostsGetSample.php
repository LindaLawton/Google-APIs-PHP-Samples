...
$results = hostsGetExample($service, $project, $zone, $host, $optParams);
...
* @return Host
*/
function hostsGetExample($service, $project, $zone, $host, $optParams)
{
	try
	{
		...
		return $service->hosts->GetHosts($project, $zone, $host, $optParams);
	}
	catch (Exception $e)
	{
