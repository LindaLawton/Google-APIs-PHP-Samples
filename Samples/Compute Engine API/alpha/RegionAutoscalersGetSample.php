...
$results = regionAutoscalersGetExample($service, $project, $region, $autoscaler, $optParams);
...
* @return Autoscaler
*/
function regionAutoscalersGetExample($service, $project, $region, $autoscaler, $optParams)
{
	try
	{
		...
		return $service->regionAutoscalers->GetRegionAutoscalers($project, $region, $autoscaler, $optParams);
	}
	catch (Exception $e)
	{
