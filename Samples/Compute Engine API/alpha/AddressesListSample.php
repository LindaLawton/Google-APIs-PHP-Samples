...
print_r(addressesListExample($service, $project, $region));
...
*/
function addressesListExample($service, $project, $region)
{
	try
	{
		...
		return $service->addresses->ListAddresses($project, $region);
	}
	catch (Exception $ex)
	{
