...
$results = backendServicesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function backendServicesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->backendServices->TestIamPermissionsBackendServices($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
