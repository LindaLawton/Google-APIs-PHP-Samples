...
print_r(addSignedUrlKey($service, $project, $backendBucket));
...
*/
function addSignedUrlKey($service, $project, $backendBucket)
{
	try
	{
		...
		return $service->addSignedUrlKey($project, $backendBucket);
	}
	catch (Exception $ex)
	{
