...
$results = backendBucketsAddSignedUrlKeyExample($service, $project, $backendBucket, $optParams);
...
* @return Operation
*/
function backendBucketsAddSignedUrlKeyExample($service, $project, $backendBucket, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->AddSignedUrlKeyBackendBuckets($project, $backendBucket, $optParams);
	}
	catch (Exception $e)
	{
