...
print_r(backendBucketsAddSignedUrlKeyExample($service, $project, $backendBucket));
...
*/
function backendBucketsAddSignedUrlKeyExample($service, $project, $backendBucket)
{
	try
	{
		...
		return $service->backendBuckets->AddSignedUrlKeyBackendBuckets($project, $backendBucket);
	}
	catch (Exception $ex)
	{
