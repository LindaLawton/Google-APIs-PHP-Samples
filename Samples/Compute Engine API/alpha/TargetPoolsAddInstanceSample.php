...
print_r(targetPoolsAddInstanceExample($service, $project, $region, $targetPool));
...
*/
function targetPoolsAddInstanceExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->AddInstanceTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
