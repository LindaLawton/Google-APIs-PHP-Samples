...
print_r(setInstanceTemplate($service, $project, $region, $instanceGroupManager));
...
*/
function setInstanceTemplate($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->setInstanceTemplate($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
