...
$results = targetHttpsProxiesSetSslPolicyExample($service, $project, $targetHttpsProxy, $optParams);
...
* @return Operation
*/
function targetHttpsProxiesSetSslPolicyExample($service, $project, $targetHttpsProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetSslPolicyTargetHttpsProxies($project, $targetHttpsProxy, $optParams);
	}
	catch (Exception $e)
	{
