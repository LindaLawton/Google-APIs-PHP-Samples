...
print_r(setSslPolicy($service, $project, $targetHttpsProxy));
...
*/
function setSslPolicy($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->setSslPolicy($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
