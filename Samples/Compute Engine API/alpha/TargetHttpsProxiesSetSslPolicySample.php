...
print_r(targetHttpsProxiesSetSslPolicyExample($service, $project, $targetHttpsProxy));
...
*/
function targetHttpsProxiesSetSslPolicyExample($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetSslPolicyTargetHttpsProxies($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
