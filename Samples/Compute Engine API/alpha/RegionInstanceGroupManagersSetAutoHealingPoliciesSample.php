...
print_r(setAutoHealingPolicies($service, $project, $region, $instanceGroupManager));
...
*/
function setAutoHealingPolicies($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->setAutoHealingPolicies($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
