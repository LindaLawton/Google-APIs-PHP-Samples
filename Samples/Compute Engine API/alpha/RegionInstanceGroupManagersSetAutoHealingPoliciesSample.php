...
print_r(regionInstanceGroupManagersSetAutoHealingPoliciesExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersSetAutoHealingPoliciesExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->SetAutoHealingPoliciesRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
