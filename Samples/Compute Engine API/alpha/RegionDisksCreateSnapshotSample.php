...
// Single Request.
$results = regionDisksCreateSnapshotExample($service, $project, $region, $disk, $optParams);
...
* @return Operation
*/
function regionDisksCreateSnapshotExample($service, $project, $region, $disk, $optParams)
{
	try
	{
		...
		return $service->regionDisks->CreateSnapshotRegionDisks($project, $region, $disk, $optParams);
	}
	catch (Exception $e)
	{
