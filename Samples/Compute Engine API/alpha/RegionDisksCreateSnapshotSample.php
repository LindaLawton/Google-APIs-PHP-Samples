...
print_r(createSnapshot($service, $project, $region, $disk));
...
*/
function createSnapshot($service, $project, $region, $disk)
{
	try
	{
		...
		return $service->createSnapshot($project, $region, $disk);
	}
	catch (Exception $ex)
	{
