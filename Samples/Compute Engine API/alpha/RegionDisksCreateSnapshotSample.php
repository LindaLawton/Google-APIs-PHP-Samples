...
print_r(regionDisksCreateSnapshotExample($service, $project, $region, $disk));
...
*/
function regionDisksCreateSnapshotExample($service, $project, $region, $disk)
{
	try
	{
		...
		return $service->regionDisks->CreateSnapshotRegionDisks($project, $region, $disk);
	}
	catch (Exception $ex)
	{
