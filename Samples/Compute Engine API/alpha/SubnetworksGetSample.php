...
print_r(subnetworksGetExample($service, $project, $region, $subnetwork));
...
* @return Subnetwork</returns>
*/
function subnetworksGetExample($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->subnetworks->GetSubnetworks($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
