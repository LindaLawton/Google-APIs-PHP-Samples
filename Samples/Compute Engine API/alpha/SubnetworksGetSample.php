...
// Single Request.
$results = subnetworksGetExample($service, $project, $region, $subnetwork, $optParams);
...
* @return Subnetwork
*/
function subnetworksGetExample($service, $project, $region, $subnetwork, $optParams)
{
	try
	{
		...
		return $service->subnetworks->GetSubnetworks($project, $region, $subnetwork, $optParams);
	}
	catch (Exception $e)
	{
