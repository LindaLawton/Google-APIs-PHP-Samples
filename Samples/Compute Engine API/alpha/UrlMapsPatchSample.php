...
print_r(urlMapsPatchExample($service, $project, $urlMap));
...
*/
function urlMapsPatchExample($service, $project, $urlMap)
{
	try
	{
		...
		return $service->urlMaps->PatchUrlMaps($project, $urlMap);
	}
	catch (Exception $ex)
	{
