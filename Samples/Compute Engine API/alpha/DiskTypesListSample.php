...
print_r(diskTypesListExample($service, $project, $zone));
...
* @return DiskTypeList</returns>
*/
function diskTypesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->diskTypes->ListDiskTypes($project, $zone);
	}
	catch (Exception $ex)
	{
