...
// Single Request.
$results = targetVpnGatewaysTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function targetVpnGatewaysTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->targetVpnGateways->TestIamPermissionsTargetVpnGateways($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
