...
$results = projectsGetXpnResourcesExample($service, $project, $optParams);
...
*/
function projectsGetXpnResourcesExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->GetXpnResourcesProjects($project, $optParams);
	}
	catch (Exception $e)
	{
