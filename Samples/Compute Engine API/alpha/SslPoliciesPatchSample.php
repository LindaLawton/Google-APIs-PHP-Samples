...
// Single Request.
$results = sslPoliciesPatchExample($service, $project, $sslPolicy, $optParams);
...
* @return Operation
*/
function sslPoliciesPatchExample($service, $project, $sslPolicy, $optParams)
{
	try
	{
		...
		return $service->sslPolicies->PatchSslPolicies($project, $sslPolicy, $optParams);
	}
	catch (Exception $e)
	{
