...
print_r(sslPoliciesPatchExample($service, $project, $sslPolicy));
...
*/
function sslPoliciesPatchExample($service, $project, $sslPolicy)
{
	try
	{
		...
		return $service->sslPolicies->PatchSslPolicies($project, $sslPolicy);
	}
	catch (Exception $ex)
	{
