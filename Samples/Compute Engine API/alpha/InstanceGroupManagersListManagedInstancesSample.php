...
// Single Request.
$results = instanceGroupManagersListManagedInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
*/
function instanceGroupManagersListManagedInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->ListManagedInstancesInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
