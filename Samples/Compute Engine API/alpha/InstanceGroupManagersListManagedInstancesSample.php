...
print_r(instanceGroupManagersListManagedInstancesExample($service, $project, $zone, $instanceGroupManager));
...
* @return InstanceGroupManagersListManagedInstancesResponse</returns>
*/
function instanceGroupManagersListManagedInstancesExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->ListManagedInstancesInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
