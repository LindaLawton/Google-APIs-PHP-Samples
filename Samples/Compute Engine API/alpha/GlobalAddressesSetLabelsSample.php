...
// Single Request.
$results = globalAddressesSetLabelsExample($service, $project, $resource, $optParams);
...
* @return Operation
*/
function globalAddressesSetLabelsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->globalAddresses->SetLabelsGlobalAddresses($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
