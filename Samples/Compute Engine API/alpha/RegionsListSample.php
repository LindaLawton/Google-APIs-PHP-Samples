...
$results = regionsListExample($service, $project, $optParams);
...
* @return RegionList
*/
function regionsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->regions->ListRegions($project, $optParams);
	}
	catch (Exception $e)
	{
