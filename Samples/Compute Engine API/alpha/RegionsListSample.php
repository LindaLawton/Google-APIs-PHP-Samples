...
print_r(regionsListExample($service, $project));

/**
* Retrieves the list of region resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return RegionList</returns>
*/
function regionsListExample($service, $project)
{
	try
	{
		...
		return $service->regions->ListRegions($project);
	}
	catch (Exception $ex)
	{
