...
print_r(targetHttpsProxiesSetSslCertificatesExample($service, $project, $targetHttpsProxy));
...
*/
function targetHttpsProxiesSetSslCertificatesExample($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetSslCertificatesTargetHttpsProxies($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
