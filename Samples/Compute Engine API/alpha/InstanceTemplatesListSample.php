...
print_r(instanceTemplatesListExample($service, $project));
...
* @return InstanceTemplateList</returns>
*/
function instanceTemplatesListExample($service, $project)
{
	try
	{
		...
		return $service->instanceTemplates->ListInstanceTemplates($project);
	}
	catch (Exception $ex)
	{
