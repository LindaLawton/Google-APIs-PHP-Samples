...
// Single Request.
$results = instanceTemplatesListExample($service, $project, $optParams);
...
*/
function instanceTemplatesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instanceTemplates->ListInstanceTemplates($project, $optParams);
	}
	catch (Exception $e)
	{
