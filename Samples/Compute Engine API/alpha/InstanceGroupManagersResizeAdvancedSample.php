...
print_r(instanceGroupManagersResizeAdvancedExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersResizeAdvancedExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->ResizeAdvancedInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
