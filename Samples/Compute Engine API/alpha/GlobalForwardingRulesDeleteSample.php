...
print_r(globalForwardingRulesDeleteExample($service, $project, $forwardingRule));
...
*/
function globalForwardingRulesDeleteExample($service, $project, $forwardingRule)
{
	try
	{
		...
		return $service->globalForwardingRules->DeleteGlobalForwardingRules($project, $forwardingRule);
	}
	catch (Exception $ex)
	{
