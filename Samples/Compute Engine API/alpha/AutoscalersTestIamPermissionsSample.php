...
print_r(autoscalersTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function autoscalersTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->autoscalers->TestIamPermissionsAutoscalers($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
