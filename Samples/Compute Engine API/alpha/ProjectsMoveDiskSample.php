...
// Single Request.
$results = projectsMoveDiskExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsMoveDiskExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->MoveDiskProjects($project, $optParams);
	}
	catch (Exception $e)
	{
