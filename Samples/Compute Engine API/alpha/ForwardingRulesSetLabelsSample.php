...
print_r(forwardingRulesSetLabelsExample($service, $project, $region, $resource));
...
*/
function forwardingRulesSetLabelsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->forwardingRules->SetLabelsForwardingRules($project, $region, $resource);
	}
	catch (Exception $ex)
	{
