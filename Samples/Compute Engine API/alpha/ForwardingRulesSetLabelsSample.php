...
$results = forwardingRulesSetLabelsExample($service, $project, $region, $resource, $optParams);
...
* @return Operation
*/
function forwardingRulesSetLabelsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->SetLabelsForwardingRules($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
