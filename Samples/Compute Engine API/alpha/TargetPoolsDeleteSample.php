...
// Single Request.
$results = targetPoolsDeleteExample($service, $project, $region, $targetPool, $optParams);
...
* @return Operation
*/
function targetPoolsDeleteExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->DeleteTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
