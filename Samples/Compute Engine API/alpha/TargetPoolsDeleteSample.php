...
print_r(targetPoolsDeleteExample($service, $project, $region, $targetPool));
...
*/
function targetPoolsDeleteExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->DeleteTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
