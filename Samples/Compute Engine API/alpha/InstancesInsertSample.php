...
* @return Operation
*/
function instancesInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->instances->InsertInstances($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
