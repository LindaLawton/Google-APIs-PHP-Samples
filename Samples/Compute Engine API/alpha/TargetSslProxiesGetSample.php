...
$results = targetSslProxiesGetExample($service, $project, $targetSslProxy, $optParams);
...
*/
function targetSslProxiesGetExample($service, $project, $targetSslProxy, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->GetTargetSslProxies($project, $targetSslProxy, $optParams);
	}
	catch (Exception $e)
	{
