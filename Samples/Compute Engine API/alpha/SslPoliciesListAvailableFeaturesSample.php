...
print_r(sslPoliciesListAvailableFeaturesExample($service, $project));

/**
* Lists all features that can be specified in the SSL policy when using custom profile.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return SslPoliciesListAvailableFeaturesResponse</returns>
*/
function sslPoliciesListAvailableFeaturesExample($service, $project)
{
	try
	{
		...
		return $service->sslPolicies->ListAvailableFeaturesSslPolicies($project);
	}
	catch (Exception $ex)
	{
