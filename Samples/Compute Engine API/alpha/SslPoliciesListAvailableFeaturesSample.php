...
// Single Request.
$results = sslPoliciesListAvailableFeaturesExample($service, $project, $optParams);
...
*/
function sslPoliciesListAvailableFeaturesExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->sslPolicies->ListAvailableFeaturesSslPolicies($project, $optParams);
	}
	catch (Exception $e)
	{
