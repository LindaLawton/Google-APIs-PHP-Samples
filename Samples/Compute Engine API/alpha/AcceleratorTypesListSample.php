...
$results = acceleratorTypesListExample($service, $project, $zone, $optParams);
...
*/
function acceleratorTypesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->acceleratorTypes->ListAcceleratorTypes($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
