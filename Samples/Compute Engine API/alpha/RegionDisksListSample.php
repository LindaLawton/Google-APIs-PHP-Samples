...
$results = regionDisksListExample($service, $project, $region, $optParams);
...
* @return DiskList
*/
function regionDisksListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionDisks->ListRegionDisks($project, $region, $optParams);
	}
	catch (Exception $e)
	{
