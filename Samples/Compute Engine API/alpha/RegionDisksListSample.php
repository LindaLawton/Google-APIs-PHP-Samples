...
print_r(regionDisksListExample($service, $project, $region));
...
* @return DiskList</returns>
*/
function regionDisksListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionDisks->ListRegionDisks($project, $region);
	}
	catch (Exception $ex)
	{
