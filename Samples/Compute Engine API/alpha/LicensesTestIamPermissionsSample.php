...
print_r(licensesTestIamPermissionsExample($service, $project, $resource));
...
*/
function licensesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->licenses->TestIamPermissionsLicenses($project, $resource);
	}
	catch (Exception $ex)
	{
