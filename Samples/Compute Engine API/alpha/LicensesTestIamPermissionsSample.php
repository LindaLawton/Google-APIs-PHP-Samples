...
$results = licensesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function licensesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->licenses->TestIamPermissionsLicenses($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
