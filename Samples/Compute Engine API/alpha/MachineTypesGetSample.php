...
// Single Request.
$results = machineTypesGetExample($service, $project, $zone, $machineType, $optParams);
...
* @return MachineType
*/
function machineTypesGetExample($service, $project, $zone, $machineType, $optParams)
{
	try
	{
		...
		if (machineType == null)
			throw new Exception("machineType is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (zone == null)
			throw new Exception("zone is required.");
		// Make the request and return the results.
		return $service->machineTypes->GetMachineTypes($project, $zone, $machineType, $optParams);
	}
	catch (Exception $e)
	{
