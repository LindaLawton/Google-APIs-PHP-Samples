...
print_r(machineTypesGetExample($service, $project, $zone, $machineType));
...
* @return MachineType</returns>
*/
function machineTypesGetExample($service, $project, $zone, $machineType)
{
	try
	{
		...
		return $service->machineTypes->GetMachineTypes($project, $zone, $machineType);
	}
	catch (Exception $ex)
	{
