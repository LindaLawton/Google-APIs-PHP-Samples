...
$results = targetHttpProxiesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function targetHttpProxiesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->targetHttpProxies->TestIamPermissionsTargetHttpProxies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
