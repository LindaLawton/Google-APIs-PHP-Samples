...
// Single Request.
$results = routersGetExample($service, $project, $region, $router, $optParams);
...
* @return Router
*/
function routersGetExample($service, $project, $region, $router, $optParams)
{
	try
	{
		...
		return $service->routers->GetRouters($project, $region, $router, $optParams);
	}
	catch (Exception $e)
	{
