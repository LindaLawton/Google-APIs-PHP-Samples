...
print_r(interconnectsInsertExample($service, $project));
...
*/
function interconnectsInsertExample($service, $project)
{
	try
	{
		...
		return $service->interconnects->InsertInterconnects($project);
	}
	catch (Exception $ex)
	{
