...
print_r(interconnectsPatchExample($service, $project, $interconnect));
...
*/
function interconnectsPatchExample($service, $project, $interconnect)
{
	try
	{
		...
		return $service->interconnects->PatchInterconnects($project, $interconnect);
	}
	catch (Exception $ex)
	{
