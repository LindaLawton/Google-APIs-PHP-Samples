...
$results = projectsSetDefaultServiceAccountExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsSetDefaultServiceAccountExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->SetDefaultServiceAccountProjects($project, $optParams);
	}
	catch (Exception $e)
	{
