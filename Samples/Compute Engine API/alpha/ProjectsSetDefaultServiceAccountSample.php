...
print_r(projectsSetDefaultServiceAccountExample($service, $project));
...
*/
function projectsSetDefaultServiceAccountExample($service, $project)
{
	try
	{
		...
		return $service->projects->SetDefaultServiceAccountProjects($project);
	}
	catch (Exception $ex)
	{
