...
print_r(targetHttpsProxiesTestIamPermissionsExample($service, $project, $resource));
...
*/
function targetHttpsProxiesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->targetHttpsProxies->TestIamPermissionsTargetHttpsProxies($project, $resource);
	}
	catch (Exception $ex)
	{
