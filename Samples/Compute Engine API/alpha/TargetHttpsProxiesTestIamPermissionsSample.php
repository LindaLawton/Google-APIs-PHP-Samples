...
// Single Request.
$results = targetHttpsProxiesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function targetHttpsProxiesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->TestIamPermissionsTargetHttpsProxies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
