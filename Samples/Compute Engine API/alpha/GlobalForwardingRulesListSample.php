...
print_r(globalForwardingRulesListExample($service, $project));

/**
* Retrieves a list of GlobalForwardingRule resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return ForwardingRuleList</returns>
*/
function globalForwardingRulesListExample($service, $project)
{
	try
	{
		...
		return $service->globalForwardingRules->ListGlobalForwardingRules($project);
	}
	catch (Exception $ex)
	{
