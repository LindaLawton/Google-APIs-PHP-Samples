...
print_r(listPerInstanceConfigs($service, $project, $region, $instanceGroupManager));
...
*/
function listPerInstanceConfigs($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->listPerInstanceConfigs($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
