...
// Single Request.
$results = regionInstanceGroupManagersListPerInstanceConfigsExample($service, $project, $region, $instanceGroupManager, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $region, $instanceGroupManager, $optParams);	
...
*/
function regionInstanceGroupManagersListPerInstanceConfigsExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ListPerInstanceConfigsRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
