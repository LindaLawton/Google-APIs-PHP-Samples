...
print_r(regionInstanceGroupManagersListPerInstanceConfigsExample($service, $project, $region, $instanceGroupManager));
...
* @return RegionInstanceGroupManagersListInstanceConfigsResp</returns>
*/
function regionInstanceGroupManagersListPerInstanceConfigsExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ListPerInstanceConfigsRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
