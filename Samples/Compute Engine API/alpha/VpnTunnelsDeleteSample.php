...
print_r(vpnTunnelsDeleteExample($service, $project, $region, $vpnTunnel));
...
*/
function vpnTunnelsDeleteExample($service, $project, $region, $vpnTunnel)
{
	try
	{
		...
		return $service->vpnTunnels->DeleteVpnTunnels($project, $region, $vpnTunnel);
	}
	catch (Exception $ex)
	{
