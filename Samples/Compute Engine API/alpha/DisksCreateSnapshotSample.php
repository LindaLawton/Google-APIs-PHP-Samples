...
// Single Request.
$results = disksCreateSnapshotExample($service, $project, $zone, $disk, $optParams);
...
* @return Operation
*/
function disksCreateSnapshotExample($service, $project, $zone, $disk, $optParams)
{
	try
	{
		...
		return $service->disks->CreateSnapshotDisks($project, $zone, $disk, $optParams);
	}
	catch (Exception $e)
	{
