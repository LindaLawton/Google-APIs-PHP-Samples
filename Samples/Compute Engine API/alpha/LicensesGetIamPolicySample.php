...
// Single Request.
$results = licensesGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function licensesGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->licenses->GetIamPolicyLicenses($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
