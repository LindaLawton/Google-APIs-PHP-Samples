...
print_r(licensesGetIamPolicyExample($service, $project, $resource));
...
*/
function licensesGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->licenses->GetIamPolicyLicenses($project, $resource);
	}
	catch (Exception $ex)
	{
