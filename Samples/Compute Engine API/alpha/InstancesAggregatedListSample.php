...
// Single Request.
$results = instancesAggregatedListExample($service, $project, $optParams);
...
*/
function instancesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->instances->AggregatedListInstances($project, $optParams);
	}
	catch (Exception $e)
	{
