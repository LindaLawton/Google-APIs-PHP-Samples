...
// Single Request.
$results = networkEndpointGroupsTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function networkEndpointGroupsTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->TestIamPermissionsNetworkEndpointGroups($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
