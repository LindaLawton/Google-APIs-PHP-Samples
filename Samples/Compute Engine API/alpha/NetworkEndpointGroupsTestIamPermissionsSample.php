...
print_r(networkEndpointGroupsTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function networkEndpointGroupsTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->networkEndpointGroups->TestIamPermissionsNetworkEndpointGroups($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
