...
print_r(imagesGetFromFamilyExample($service, $project, $family));
...
* @return Image</returns>
*/
function imagesGetFromFamilyExample($service, $project, $family)
{
	try
	{
		...
		return $service->images->GetFromFamilyImages($project, $family);
	}
	catch (Exception $ex)
	{
