...
// Single Request.
$results = imagesGetFromFamilyExample($service, $project, $family, $optParams);
...
* @return Image
*/
function imagesGetFromFamilyExample($service, $project, $family, $optParams)
{
	try
	{
		...
		if (family == null)
			throw new Exception("family is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->images->GetFromFamilyImages($project, $family, $optParams);
	}
	catch (Exception $e)
	{
