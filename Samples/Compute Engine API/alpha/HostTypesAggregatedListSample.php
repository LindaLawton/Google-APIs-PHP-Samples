...
// Single Request.
$results = hostTypesAggregatedListExample($service, $project, $optParams);
...
* @return HostTypeAggregatedList
*/
function hostTypesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->hostTypes->AggregatedListHostTypes($project, $optParams);
	}
	catch (Exception $e)
	{
