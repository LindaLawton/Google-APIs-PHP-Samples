...
print_r(hostTypesAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of host types.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return HostTypeAggregatedList</returns>
*/
function hostTypesAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->hostTypes->AggregatedListHostTypes($project);
	}
	catch (Exception $ex)
	{
