...
$results = targetPoolsAddHealthCheckExample($service, $project, $region, $targetPool, $optParams);
...
* @return Operation
*/
function targetPoolsAddHealthCheckExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->AddHealthCheckTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
