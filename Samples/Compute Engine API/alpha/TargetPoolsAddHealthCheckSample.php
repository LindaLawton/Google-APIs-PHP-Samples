...
print_r(targetPoolsAddHealthCheckExample($service, $project, $region, $targetPool));
...
*/
function targetPoolsAddHealthCheckExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->AddHealthCheckTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
