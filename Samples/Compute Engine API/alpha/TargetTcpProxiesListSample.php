...
// Single Request.
$results = targetTcpProxiesListExample($service, $project, $optParams);
...
*/
function targetTcpProxiesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetTcpProxies->ListTargetTcpProxies($project, $optParams);
	}
	catch (Exception $e)
	{
