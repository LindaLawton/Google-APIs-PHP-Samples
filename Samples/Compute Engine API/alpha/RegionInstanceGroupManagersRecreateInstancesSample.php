...
// Single Request.
$results = regionInstanceGroupManagersRecreateInstancesExample($service, $project, $region, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function regionInstanceGroupManagersRecreateInstancesExample($service, $project, $region, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->RecreateInstancesRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
