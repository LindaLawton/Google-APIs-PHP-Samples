...
print_r(recreateInstances($service, $project, $region, $instanceGroupManager));
...
*/
function recreateInstances($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->recreateInstances($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
