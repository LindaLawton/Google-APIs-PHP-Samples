...
print_r(urlMapsValidateExample($service, $project, $urlMap));
...
* @return UrlMapsValidateResponse</returns>
*/
function urlMapsValidateExample($service, $project, $urlMap)
{
	try
	{
		...
		return $service->urlMaps->ValidateUrlMaps($project, $urlMap);
	}
	catch (Exception $ex)
	{
