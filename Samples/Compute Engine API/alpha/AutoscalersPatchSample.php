...
// Single Request.
$results = autoscalersPatchExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function autoscalersPatchExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->autoscalers->PatchAutoscalers($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
