...
// Single Request.
$results = targetPoolsGetHealthExample($service, $project, $region, $targetPool, $optParams);
...
*/
function targetPoolsGetHealthExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->GetHealthTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
