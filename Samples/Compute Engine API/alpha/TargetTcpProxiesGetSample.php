...
print_r(targetTcpProxiesGetExample($service, $project, $targetTcpProxy));
...
* @return TargetTcpProxy</returns>
*/
function targetTcpProxiesGetExample($service, $project, $targetTcpProxy)
{
	try
	{
		...
		return $service->targetTcpProxies->GetTargetTcpProxies($project, $targetTcpProxy);
	}
	catch (Exception $ex)
	{
