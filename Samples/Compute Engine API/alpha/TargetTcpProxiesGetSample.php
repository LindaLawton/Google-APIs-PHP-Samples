...
// Single Request.
$results = targetTcpProxiesGetExample($service, $project, $targetTcpProxy, $optParams);
...
*/
function targetTcpProxiesGetExample($service, $project, $targetTcpProxy, $optParams)
{
	try
	{
		...
		return $service->targetTcpProxies->GetTargetTcpProxies($project, $targetTcpProxy, $optParams);
	}
	catch (Exception $e)
	{
