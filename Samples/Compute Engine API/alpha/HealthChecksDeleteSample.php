...
print_r(healthChecksDeleteExample($service, $project, $healthCheck));
...
*/
function healthChecksDeleteExample($service, $project, $healthCheck)
{
	try
	{
		...
		return $service->healthChecks->DeleteHealthChecks($project, $healthCheck);
	}
	catch (Exception $ex)
	{
