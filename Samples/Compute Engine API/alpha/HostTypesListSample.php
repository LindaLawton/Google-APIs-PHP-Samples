...
// Single Request.
$results = hostTypesListExample($service, $project, $zone, $optParams);
...
* @return HostTypeList
*/
function hostTypesListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->hostTypes->ListHostTypes($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
