...
print_r(hostTypesListExample($service, $project, $zone));
...
* @return HostTypeList</returns>
*/
function hostTypesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->hostTypes->ListHostTypes($project, $zone);
	}
	catch (Exception $ex)
	{
