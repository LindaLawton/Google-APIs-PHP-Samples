...
print_r(regionBackendServicesGetExample($service, $project, $region, $backendService));
...
* @return BackendService</returns>
*/
function regionBackendServicesGetExample($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->regionBackendServices->GetRegionBackendServices($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
