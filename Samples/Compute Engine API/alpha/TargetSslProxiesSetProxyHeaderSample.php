...
print_r(targetSslProxiesSetProxyHeaderExample($service, $project, $targetSslProxy));
...
*/
function targetSslProxiesSetProxyHeaderExample($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->targetSslProxies->SetProxyHeaderTargetSslProxies($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
