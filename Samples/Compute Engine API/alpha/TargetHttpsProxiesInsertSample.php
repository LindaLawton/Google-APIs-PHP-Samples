...
print_r(targetHttpsProxiesInsertExample($service, $project));
...
*/
function targetHttpsProxiesInsertExample($service, $project)
{
	try
	{
		...
		return $service->targetHttpsProxies->InsertTargetHttpsProxies($project);
	}
	catch (Exception $ex)
	{
