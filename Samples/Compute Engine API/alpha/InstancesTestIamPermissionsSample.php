...
// Single Request.
$results = instancesTestIamPermissionsExample($service, $project, $zone, $resource, $optParams);
...
*/
function instancesTestIamPermissionsExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->instances->TestIamPermissionsInstances($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
