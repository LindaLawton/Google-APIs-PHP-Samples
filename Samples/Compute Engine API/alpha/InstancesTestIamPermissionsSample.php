...
print_r(instancesTestIamPermissionsExample($service, $project, $zone, $resource));
...
*/
function instancesTestIamPermissionsExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->instances->TestIamPermissionsInstances($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
