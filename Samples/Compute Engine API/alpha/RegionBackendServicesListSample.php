...
print_r(regionBackendServicesListExample($service, $project, $region));
...
* @return BackendServiceList</returns>
*/
function regionBackendServicesListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionBackendServices->ListRegionBackendServices($project, $region);
	}
	catch (Exception $ex)
	{
