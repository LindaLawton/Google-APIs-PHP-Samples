...
print_r(regionDiskTypesListExample($service, $project, $region));
...
* @return RegionDiskTypeList</returns>
*/
function regionDiskTypesListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionDiskTypes->ListRegionDiskTypes($project, $region);
	}
	catch (Exception $ex)
	{
