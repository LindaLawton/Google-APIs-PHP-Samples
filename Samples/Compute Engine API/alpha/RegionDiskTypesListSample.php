...
// Single Request.
$results = regionDiskTypesListExample($service, $project, $region, $optParams);
...
*/
function regionDiskTypesListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionDiskTypes->ListRegionDiskTypes($project, $region, $optParams);
	}
	catch (Exception $e)
	{
