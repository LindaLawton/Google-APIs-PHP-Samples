...
print_r(hostsDeleteExample($service, $project, $zone, $host));
...
*/
function hostsDeleteExample($service, $project, $zone, $host)
{
	try
	{
		...
		return $service->hosts->DeleteHosts($project, $zone, $host);
	}
	catch (Exception $ex)
	{
