...
// Single Request.
$results = hostsDeleteExample($service, $project, $zone, $host, $optParams);
...
* @return Operation
*/
function hostsDeleteExample($service, $project, $zone, $host, $optParams)
{
	try
	{
		...
		return $service->hosts->DeleteHosts($project, $zone, $host, $optParams);
	}
	catch (Exception $e)
	{
