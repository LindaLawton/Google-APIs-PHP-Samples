...
print_r(targetPoolsAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of target pools.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return TargetPoolAggregatedList</returns>
*/
function targetPoolsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->targetPools->AggregatedListTargetPools($project);
	}
	catch (Exception $ex)
	{
