...
// Single Request.
$results = sslPoliciesListExample($service, $project, $optParams);
...
*/
function sslPoliciesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->sslPolicies->ListSslPolicies($project, $optParams);
	}
	catch (Exception $e)
	{
