...
print_r(sslPoliciesListExample($service, $project));
...
* @return SslPoliciesList</returns>
*/
function sslPoliciesListExample($service, $project)
{
	try
	{
		...
		return $service->sslPolicies->ListSslPolicies($project);
	}
	catch (Exception $ex)
	{
