...
print_r(licensesSetIamPolicyExample($service, $project, $resource));
...
*/
function licensesSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->licenses->SetIamPolicyLicenses($project, $resource);
	}
	catch (Exception $ex)
	{
