...
$results = licensesSetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function licensesSetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->licenses->SetIamPolicyLicenses($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
