...
print_r(sslPoliciesDeleteExample($service, $project, $sslPolicy));
...
*/
function sslPoliciesDeleteExample($service, $project, $sslPolicy)
{
	try
	{
		...
		return $service->sslPolicies->DeleteSslPolicies($project, $sslPolicy);
	}
	catch (Exception $ex)
	{
