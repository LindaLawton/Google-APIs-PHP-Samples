...
// Single Request.
$results = sslPoliciesDeleteExample($service, $project, $sslPolicy, $optParams);
...
* @return Operation
*/
function sslPoliciesDeleteExample($service, $project, $sslPolicy, $optParams)
{
	try
	{
		...
		if (sslPolicy == null)
			throw new Exception("sslPolicy is required.");
		// Make the request and return the results.
		return $service->sslPolicies->DeleteSslPolicies($project, $sslPolicy, $optParams);
	}
	catch (Exception $e)
	{
