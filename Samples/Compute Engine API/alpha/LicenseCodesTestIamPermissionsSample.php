...
// Single Request.
$results = licenseCodesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function licenseCodesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->licenseCodes->TestIamPermissionsLicenseCodes($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
