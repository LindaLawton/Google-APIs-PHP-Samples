...
print_r(licenseCodesTestIamPermissionsExample($service, $project, $resource));
...
*/
function licenseCodesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->licenseCodes->TestIamPermissionsLicenseCodes($project, $resource);
	}
	catch (Exception $ex)
	{
