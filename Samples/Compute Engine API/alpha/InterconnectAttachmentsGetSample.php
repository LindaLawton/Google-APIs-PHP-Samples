...
print_r(interconnectAttachmentsGetExample($service, $project, $region, $interconnectAttachment));
...
* @return InterconnectAttachment</returns>
*/
function interconnectAttachmentsGetExample($service, $project, $region, $interconnectAttachment)
{
	try
	{
		...
		return $service->interconnectAttachments->GetInterconnectAttachments($project, $region, $interconnectAttachment);
	}
	catch (Exception $ex)
	{
