...
print_r(get($service, $project, $region, $interconnectAttachment));
...
*/
function get($service, $project, $region, $interconnectAttachment)
{
	try
	{
		...
		return $service->get($project, $region, $interconnectAttachment);
	}
	catch (Exception $ex)
	{
