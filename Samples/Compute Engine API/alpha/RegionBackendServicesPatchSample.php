...
print_r(regionBackendServicesPatchExample($service, $project, $region, $backendService));
...
*/
function regionBackendServicesPatchExample($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->regionBackendServices->PatchRegionBackendServices($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
