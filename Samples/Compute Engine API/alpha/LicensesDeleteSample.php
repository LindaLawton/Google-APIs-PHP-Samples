...
print_r(licensesDeleteExample($service, $project, $license));
...
*/
function licensesDeleteExample($service, $project, $license)
{
	try
	{
		...
		return $service->licenses->DeleteLicenses($project, $license);
	}
	catch (Exception $ex)
	{
