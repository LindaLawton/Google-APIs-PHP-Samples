...
// Single Request.
$results = licensesDeleteExample($service, $project, $license, $optParams);
...
* @return Operation
*/
function licensesDeleteExample($service, $project, $license, $optParams)
{
	try
	{
		...
		return $service->licenses->DeleteLicenses($project, $license, $optParams);
	}
	catch (Exception $e)
	{
