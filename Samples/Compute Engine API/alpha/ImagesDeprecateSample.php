...
print_r(imagesDeprecateExample($service, $project, $image));
...
*/
function imagesDeprecateExample($service, $project, $image)
{
	try
	{
		...
		return $service->images->DeprecateImages($project, $image);
	}
	catch (Exception $ex)
	{
