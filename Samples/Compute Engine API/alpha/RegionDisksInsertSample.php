...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'sourceImage' => '[YourValue]',  //Optional. Source image to restore onto a disk.
  'fields' => '*'
);
// Single Request.
$results = regionDisksInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function regionDisksInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionDisks->InsertRegionDisks($project, $region, $optParams);
	}
	catch (Exception $e)
	{
