...
print_r(regionDisksInsertExample($service, $project, $region));
...
*/
function regionDisksInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionDisks->InsertRegionDisks($project, $region);
	}
	catch (Exception $ex)
	{
