...
print_r(targetHttpProxiesSetUrlMapExample($service, $project, $targetHttpProxy));
...
*/
function targetHttpProxiesSetUrlMapExample($service, $project, $targetHttpProxy)
{
	try
	{
		...
		return $service->targetHttpProxies->SetUrlMapTargetHttpProxies($project, $targetHttpProxy);
	}
	catch (Exception $ex)
	{
