...
$results = targetHttpProxiesSetUrlMapExample($service, $project, $targetHttpProxy, $optParams);
...
* @return Operation
*/
function targetHttpProxiesSetUrlMapExample($service, $project, $targetHttpProxy, $optParams)
{
	try
	{
		...
		if (targetHttpProxy == null)
			throw new Exception("targetHttpProxy is required.");
		// Make the request and return the results.
		return $service->targetHttpProxies->SetUrlMapTargetHttpProxies($project, $targetHttpProxy, $optParams);
	}
	catch (Exception $e)
	{
