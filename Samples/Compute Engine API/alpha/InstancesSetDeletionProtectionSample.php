...
print_r(setDeletionProtection($service, $project, $zone, $resource));
...
*/
function setDeletionProtection($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->setDeletionProtection($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
