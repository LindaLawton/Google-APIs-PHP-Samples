...
print_r(instancesSetDeletionProtectionExample($service, $project, $zone, $resource));
...
*/
function instancesSetDeletionProtectionExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->instances->SetDeletionProtectionInstances($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
