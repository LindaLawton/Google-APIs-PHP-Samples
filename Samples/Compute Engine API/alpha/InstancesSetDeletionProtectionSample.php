...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'deletionProtection' => '[YourValue]',  // Whether the resource should be protected against deletion.
...
// Single Request.
$results = instancesSetDeletionProtectionExample($service, $project, $zone, $resource, $optParams);
...
* @return Operation
*/
function instancesSetDeletionProtectionExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->instances->SetDeletionProtectionInstances($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
