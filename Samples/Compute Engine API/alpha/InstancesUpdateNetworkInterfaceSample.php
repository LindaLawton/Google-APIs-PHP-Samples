...
print_r(updateNetworkInterface($service, $project, $zone, $instance, $networkInterface));
...
*/
function updateNetworkInterface($service, $project, $zone, $instance, $networkInterface)
{
	try
	{
		...
		return $service->updateNetworkInterface($project, $zone, $instance, $networkInterface);
	}
	catch (Exception $ex)
	{
