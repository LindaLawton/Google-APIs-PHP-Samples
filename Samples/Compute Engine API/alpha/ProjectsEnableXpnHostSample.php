...
$results = projectsEnableXpnHostExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsEnableXpnHostExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->EnableXpnHostProjects($project, $optParams);
	}
	catch (Exception $e)
	{
