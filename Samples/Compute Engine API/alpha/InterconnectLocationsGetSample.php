...
print_r(interconnectLocationsGetExample($service, $project, $interconnectLocation));
...
* @return InterconnectLocation</returns>
*/
function interconnectLocationsGetExample($service, $project, $interconnectLocation)
{
	try
	{
		...
		if (interconnectLocation == null)
			throw new Exception("interconnectLocation is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->interconnectLocations->GetInterconnectLocations($project, $interconnectLocation);
	}
	catch (Exception $ex)
	{
