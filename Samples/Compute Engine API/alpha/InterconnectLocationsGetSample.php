...
// Single Request.
$results = interconnectLocationsGetExample($service, $project, $interconnectLocation, $optParams);
...
*/
function interconnectLocationsGetExample($service, $project, $interconnectLocation, $optParams)
{
	try
	{
		...
		return $service->interconnectLocations->GetInterconnectLocations($project, $interconnectLocation, $optParams);
	}
	catch (Exception $e)
	{
