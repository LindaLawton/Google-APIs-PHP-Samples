...
$results = regionInstanceGroupManagersTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function regionInstanceGroupManagersTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->TestIamPermissionsRegionInstanceGroupManagers($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
