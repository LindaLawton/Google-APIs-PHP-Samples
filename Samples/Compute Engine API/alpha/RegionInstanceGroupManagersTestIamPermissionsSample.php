...
print_r(regionInstanceGroupManagersTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function regionInstanceGroupManagersTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->TestIamPermissionsRegionInstanceGroupManagers($project, $region, $resource);
	}
	catch (Exception $ex)
	{
