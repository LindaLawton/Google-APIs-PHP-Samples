...
print_r(subnetworksDeleteExample($service, $project, $region, $subnetwork));
...
*/
function subnetworksDeleteExample($service, $project, $region, $subnetwork)
{
	try
	{
		...
		return $service->subnetworks->DeleteSubnetworks($project, $region, $subnetwork);
	}
	catch (Exception $ex)
	{
