...
print_r(deleteSignedUrlKey($service, $project, $backendBucket, $keyName));
...
*/
function deleteSignedUrlKey($service, $project, $backendBucket, $keyName)
{
	try
	{
		...
		return $service->deleteSignedUrlKey($project, $backendBucket, $keyName);
	}
	catch (Exception $ex)
	{
