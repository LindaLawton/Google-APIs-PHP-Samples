...
print_r(backendBucketsDeleteSignedUrlKeyExample($service, $project, $backendBucket, $keyName));
...
*/
function backendBucketsDeleteSignedUrlKeyExample($service, $project, $backendBucket, $keyName)
{
	try
	{
		...
		return $service->backendBuckets->DeleteSignedUrlKeyBackendBuckets($project, $backendBucket, $keyName);
	}
	catch (Exception $ex)
	{
