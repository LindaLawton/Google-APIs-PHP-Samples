...
// Single Request.
$results = backendBucketsDeleteSignedUrlKeyExample($service, $project, $backendBucket, $keyName, $optParams);
...
* @return Operation
*/
function backendBucketsDeleteSignedUrlKeyExample($service, $project, $backendBucket, $keyName, $optParams)
{
	try
	{
		...
		if (backendBucket == null)
			throw new Exception("backendBucket is required.");
		if (keyName == null)
			throw new Exception("keyName is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->backendBuckets->DeleteSignedUrlKeyBackendBuckets($project, $backendBucket, $keyName, $optParams);
	}
	catch (Exception $e)
	{
