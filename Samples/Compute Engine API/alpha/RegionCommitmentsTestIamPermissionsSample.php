...
// Single Request.
$results = regionCommitmentsTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function regionCommitmentsTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionCommitments->TestIamPermissionsRegionCommitments($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
