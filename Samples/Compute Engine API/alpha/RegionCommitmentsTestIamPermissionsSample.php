...
print_r(regionCommitmentsTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function regionCommitmentsTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionCommitments->TestIamPermissionsRegionCommitments($project, $region, $resource);
	}
	catch (Exception $ex)
	{
