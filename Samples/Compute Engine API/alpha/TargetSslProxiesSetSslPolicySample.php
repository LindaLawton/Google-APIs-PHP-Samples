...
// Single Request.
$results = targetSslProxiesSetSslPolicyExample($service, $project, $targetSslProxy, $optParams);
...
* @return Operation
*/
function targetSslProxiesSetSslPolicyExample($service, $project, $targetSslProxy, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->SetSslPolicyTargetSslProxies($project, $targetSslProxy, $optParams);
	}
	catch (Exception $e)
	{
