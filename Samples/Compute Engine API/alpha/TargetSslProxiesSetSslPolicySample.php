...
print_r(targetSslProxiesSetSslPolicyExample($service, $project, $targetSslProxy));
...
*/
function targetSslProxiesSetSslPolicyExample($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->targetSslProxies->SetSslPolicyTargetSslProxies($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
