...
print_r(setSslPolicy($service, $project, $targetSslProxy));
...
*/
function setSslPolicy($service, $project, $targetSslProxy)
{
	try
	{
		...
		return $service->setSslPolicy($project, $targetSslProxy);
	}
	catch (Exception $ex)
	{
