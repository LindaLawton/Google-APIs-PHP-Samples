...
// Single Request.
$results = networkEndpointGroupsGetExample($service, $project, $zone, $networkEndpointGroup, $optParams);
...
*/
function networkEndpointGroupsGetExample($service, $project, $zone, $networkEndpointGroup, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->GetNetworkEndpointGroups($project, $zone, $networkEndpointGroup, $optParams);
	}
	catch (Exception $e)
	{
