...
print_r(get($service, $project, $zone, $networkEndpointGroup));
...
*/
function get($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->get($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
