...
print_r(networkEndpointGroupsGetExample($service, $project, $zone, $networkEndpointGroup));
...
* @return NetworkEndpointGroup</returns>
*/
function networkEndpointGroupsGetExample($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->networkEndpointGroups->GetNetworkEndpointGroups($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
