...
print_r(listNetworkEndpoints($service, $project, $zone, $networkEndpointGroup));
...
*/
function listNetworkEndpoints($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->listNetworkEndpoints($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
