...
// Single Request.
$results = networkEndpointGroupsListNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $zone, $networkEndpointGroup, $optParams);	
...
*/
function networkEndpointGroupsListNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup, $optParams)
{
	try
	{
		...
		if (networkEndpointGroup == null)
			throw new Exception("networkEndpointGroup is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (zone == null)
			throw new Exception("zone is required.");
		// Make the request and return the results.
		return $service->networkEndpointGroups->ListNetworkEndpointsNetworkEndpointGroups($project, $zone, $networkEndpointGroup, $optParams);
	}
	catch (Exception $e)
	{
