...
print_r(networkEndpointGroupsListNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup));
...
* @return NetworkEndpointGroupsListNetworkEndpoints</returns>
*/
function networkEndpointGroupsListNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->networkEndpointGroups->ListNetworkEndpointsNetworkEndpointGroups($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
