...
// Single Request.
$results = instancesSetTagsExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSetTagsExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SetTagsInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
