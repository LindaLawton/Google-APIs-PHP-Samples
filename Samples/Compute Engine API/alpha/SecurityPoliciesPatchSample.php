...
// Single Request.
$results = securityPoliciesPatchExample($service, $project, $securityPolicy, $optParams);
...
* @return Operation
*/
function securityPoliciesPatchExample($service, $project, $securityPolicy, $optParams)
{
	try
	{
		...
		return $service->securityPolicies->PatchSecurityPolicies($project, $securityPolicy, $optParams);
	}
	catch (Exception $e)
	{
