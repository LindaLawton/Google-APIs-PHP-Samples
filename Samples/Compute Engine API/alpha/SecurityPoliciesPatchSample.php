...
print_r(securityPoliciesPatchExample($service, $project, $securityPolicy));
...
*/
function securityPoliciesPatchExample($service, $project, $securityPolicy)
{
	try
	{
		...
		return $service->securityPolicies->PatchSecurityPolicies($project, $securityPolicy);
	}
	catch (Exception $ex)
	{
