...
print_r(autoscalersUpdateExample($service, $project, $zone));
...
*/
function autoscalersUpdateExample($service, $project, $zone)
{
	try
	{
		...
		return $service->autoscalers->UpdateAutoscalers($project, $zone);
	}
	catch (Exception $ex)
	{
