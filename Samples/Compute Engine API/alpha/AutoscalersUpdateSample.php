...
// Single Request.
$results = autoscalersUpdateExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function autoscalersUpdateExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->autoscalers->UpdateAutoscalers($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
