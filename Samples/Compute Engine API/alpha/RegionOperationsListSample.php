...
print_r(regionOperationsListExample($service, $project, $region));
...
*/
function regionOperationsListExample($service, $project, $region)
{
	try
	{
		...
		return $service->regionOperations->ListRegionOperations($project, $region);
	}
	catch (Exception $ex)
	{
