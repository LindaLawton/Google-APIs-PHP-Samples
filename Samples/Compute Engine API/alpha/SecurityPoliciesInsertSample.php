...
// Single Request.
$results = securityPoliciesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function securityPoliciesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->securityPolicies->InsertSecurityPolicies($project, $optParams);
	}
	catch (Exception $e)
	{
