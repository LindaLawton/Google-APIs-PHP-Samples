...
print_r(hostsAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of hosts.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return HostAggregatedList</returns>
*/
function hostsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->hosts->AggregatedListHosts($project);
	}
	catch (Exception $ex)
	{
