...
$results = hostsAggregatedListExample($service, $project, $optParams);
...
* @return HostAggregatedList
*/
function hostsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->hosts->AggregatedListHosts($project, $optParams);
	}
	catch (Exception $e)
	{
