...
// Single Request.
$results = regionInstanceGroupManagersListExample($service, $project, $region, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $region, $optParams);	
...
*/
function regionInstanceGroupManagersListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ListRegionInstanceGroupManagers($project, $region, $optParams);
	}
	catch (Exception $e)
	{
