...
print_r(applyUpdatesToInstances($service, $project, $zone, $instanceGroupManager));
...
*/
function applyUpdatesToInstances($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->applyUpdatesToInstances($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
