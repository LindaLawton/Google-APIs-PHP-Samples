...
// Single Request.
$results = instanceGroupManagersApplyUpdatesToInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function instanceGroupManagersApplyUpdatesToInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->ApplyUpdatesToInstancesInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
