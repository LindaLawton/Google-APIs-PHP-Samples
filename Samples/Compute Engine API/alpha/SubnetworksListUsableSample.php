...
print_r(subnetworksListUsableExample($service, $project));

/**
* Retrieves an aggregated list of usable subnetworks.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return UsableSubnetworksAggregatedList</returns>
*/
function subnetworksListUsableExample($service, $project)
{
	try
	{
		...
		return $service->subnetworks->ListUsableSubnetworks($project);
	}
	catch (Exception $ex)
	{
