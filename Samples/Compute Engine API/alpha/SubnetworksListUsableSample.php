...
// Single Request.
$results = subnetworksListUsableExample($service, $project, $optParams);
...
*/
function subnetworksListUsableExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->subnetworks->ListUsableSubnetworks($project, $optParams);
	}
	catch (Exception $e)
	{
