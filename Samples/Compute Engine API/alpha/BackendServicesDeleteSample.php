...
print_r(backendServicesDeleteExample($service, $project, $backendService));
...
*/
function backendServicesDeleteExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->DeleteBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
