...
print_r(backendBucketsTestIamPermissionsExample($service, $project, $resource));
...
*/
function backendBucketsTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->backendBuckets->TestIamPermissionsBackendBuckets($project, $resource);
	}
	catch (Exception $ex)
	{
