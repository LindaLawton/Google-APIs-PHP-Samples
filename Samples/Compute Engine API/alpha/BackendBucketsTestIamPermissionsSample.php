...
// Single Request.
$results = backendBucketsTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function backendBucketsTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->TestIamPermissionsBackendBuckets($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
