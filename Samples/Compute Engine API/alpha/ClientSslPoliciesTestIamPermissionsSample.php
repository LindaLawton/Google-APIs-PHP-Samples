...
print_r(clientSslPoliciesTestIamPermissionsExample($service, $project, $resource));
...
*/
function clientSslPoliciesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->clientSslPolicies->TestIamPermissionsClientSslPolicies($project, $resource);
	}
	catch (Exception $ex)
	{
