...
// Single Request.
$results = clientSslPoliciesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function clientSslPoliciesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->clientSslPolicies->TestIamPermissionsClientSslPolicies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
