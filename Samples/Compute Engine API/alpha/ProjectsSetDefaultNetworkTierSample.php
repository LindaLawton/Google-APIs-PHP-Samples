...
print_r(projectsSetDefaultNetworkTierExample($service, $project));
...
*/
function projectsSetDefaultNetworkTierExample($service, $project)
{
	try
	{
		...
		return $service->projects->SetDefaultNetworkTierProjects($project);
	}
	catch (Exception $ex)
	{
