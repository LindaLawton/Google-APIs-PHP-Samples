...
// Single Request.
$results = projectsSetDefaultNetworkTierExample($service, $project, $optParams);
...
* @return Operation
*/
function projectsSetDefaultNetworkTierExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->SetDefaultNetworkTierProjects($project, $optParams);
	}
	catch (Exception $e)
	{
