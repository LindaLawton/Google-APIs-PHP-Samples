...
// Single Request.
$results = regionDisksSetLabelsExample($service, $project, $region, $resource, $optParams);
...
* @return Operation
*/
function regionDisksSetLabelsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionDisks->SetLabelsRegionDisks($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
