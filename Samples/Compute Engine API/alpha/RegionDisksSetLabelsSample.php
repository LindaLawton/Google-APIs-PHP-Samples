...
print_r(regionDisksSetLabelsExample($service, $project, $region, $resource));
...
*/
function regionDisksSetLabelsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->regionDisks->SetLabelsRegionDisks($project, $region, $resource);
	}
	catch (Exception $ex)
	{
