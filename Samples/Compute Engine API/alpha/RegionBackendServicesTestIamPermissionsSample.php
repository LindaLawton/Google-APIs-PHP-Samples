...
// Single Request.
$results = regionBackendServicesTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function regionBackendServicesTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->regionBackendServices->TestIamPermissionsRegionBackendServices($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
