...
// Single Request.
$results = subnetworksExpandIpCidrRangeExample($service, $project, $region, $subnetwork, $optParams);
...
* @return Operation
*/
function subnetworksExpandIpCidrRangeExample($service, $project, $region, $subnetwork, $optParams)
{
	try
	{
		...
		return $service->subnetworks->ExpandIpCidrRangeSubnetworks($project, $region, $subnetwork, $optParams);
	}
	catch (Exception $e)
	{
