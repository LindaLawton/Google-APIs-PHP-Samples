...
print_r(sslPoliciesTestIamPermissionsExample($service, $project, $resource));
...
*/
function sslPoliciesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->sslPolicies->TestIamPermissionsSslPolicies($project, $resource);
	}
	catch (Exception $ex)
	{
