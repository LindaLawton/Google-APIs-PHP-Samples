...
// Single Request.
$results = sslPoliciesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function sslPoliciesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->sslPolicies->TestIamPermissionsSslPolicies($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
