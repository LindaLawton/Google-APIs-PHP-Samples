...
print_r(disksGetIamPolicyExample($service, $project, $zone, $resource));
...
*/
function disksGetIamPolicyExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->disks->GetIamPolicyDisks($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
