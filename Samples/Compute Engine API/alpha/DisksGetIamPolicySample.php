...
// Single Request.
$results = disksGetIamPolicyExample($service, $project, $zone, $resource, $optParams);
...
* @return Policy
*/
function disksGetIamPolicyExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->disks->GetIamPolicyDisks($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
