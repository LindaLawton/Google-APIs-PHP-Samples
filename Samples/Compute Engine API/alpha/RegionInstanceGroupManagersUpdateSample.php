...
print_r(update($service, $project, $region, $instanceGroupManager));
...
*/
function update($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->update($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
