...
// Single Request.
$results = sslPoliciesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function sslPoliciesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->sslPolicies->InsertSslPolicies($project, $optParams);
	}
	catch (Exception $e)
	{
