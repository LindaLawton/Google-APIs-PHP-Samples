...
print_r(projectsSetCommonInstanceMetadataExample($service, $project));
...
*/
function projectsSetCommonInstanceMetadataExample($service, $project)
{
	try
	{
		...
		return $service->projects->SetCommonInstanceMetadataProjects($project);
	}
	catch (Exception $ex)
	{
