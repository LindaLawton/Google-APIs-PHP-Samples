...
$results = instancesSetDiskAutoDeleteExample($service, $project, $zone, $instance, $autoDelete, $deviceName, $optParams);
...
* @return Operation
*/
function instancesSetDiskAutoDeleteExample($service, $project, $zone, $instance, $autoDelete, $deviceName, $optParams)
{
	try
	{
		...
		if (autoDelete == null)
			throw new Exception("autoDelete is required.");
		if (deviceName == null)
		...
		return $service->instances->SetDiskAutoDeleteInstances($project, $zone, $instance, $autoDelete, $deviceName, $optParams);
	}
	catch (Exception $e)
	{
