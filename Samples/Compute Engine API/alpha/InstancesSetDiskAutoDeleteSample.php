...
print_r(setDiskAutoDelete($service, $project, $zone, $instance, $autoDelete, $deviceName));
...
*/
function setDiskAutoDelete($service, $project, $zone, $instance, $autoDelete, $deviceName)
{
	try
	{
		...
		return $service->setDiskAutoDelete($project, $zone, $instance, $autoDelete, $deviceName);
	}
	catch (Exception $ex)
	{
