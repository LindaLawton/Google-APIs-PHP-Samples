...
// Single Request.
$results = instancesStopExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesStopExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->StopInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
