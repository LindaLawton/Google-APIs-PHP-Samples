...
print_r(regionInstanceGroupManagersResizeExample($service, $project, $region, $instanceGroupManager, $size));
...
*/
function regionInstanceGroupManagersResizeExample($service, $project, $region, $instanceGroupManager, $size)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ResizeRegionInstanceGroupManagers($project, $region, $instanceGroupManager, $size);
	}
	catch (Exception $ex)
	{
