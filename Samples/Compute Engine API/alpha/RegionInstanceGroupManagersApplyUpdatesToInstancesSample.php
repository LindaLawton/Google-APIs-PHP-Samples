...
print_r(applyUpdatesToInstances($service, $project, $region, $instanceGroupManager));
...
*/
function applyUpdatesToInstances($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->applyUpdatesToInstances($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
