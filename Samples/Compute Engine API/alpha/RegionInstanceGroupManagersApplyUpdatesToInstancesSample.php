...
print_r(regionInstanceGroupManagersApplyUpdatesToInstancesExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersApplyUpdatesToInstancesExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->ApplyUpdatesToInstancesRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
