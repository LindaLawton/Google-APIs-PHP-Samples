...
$results = networkEndpointGroupsAggregatedListExample($service, $project, $optParams);
...
*/
function networkEndpointGroupsAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->AggregatedListNetworkEndpointGroups($project, $optParams);
	}
	catch (Exception $e)
	{
