...
print_r(networkEndpointGroupsAggregatedListExample($service, $project));

/**
* Retrieves the list of network endpoint groups and sorts them by zone.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return NetworkEndpointGroupAggregatedList</returns>
*/
function networkEndpointGroupsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->networkEndpointGroups->AggregatedListNetworkEndpointGroups($project);
	}
	catch (Exception $ex)
	{
