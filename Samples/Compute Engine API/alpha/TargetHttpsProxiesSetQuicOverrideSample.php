...
print_r(setQuicOverride($service, $project, $targetHttpsProxy));
...
*/
function setQuicOverride($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->setQuicOverride($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
