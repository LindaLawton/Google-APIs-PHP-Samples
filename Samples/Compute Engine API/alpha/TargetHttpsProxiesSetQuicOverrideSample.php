...
// Single Request.
$results = targetHttpsProxiesSetQuicOverrideExample($service, $project, $targetHttpsProxy, $optParams);
...
* @return Operation
*/
function targetHttpsProxiesSetQuicOverrideExample($service, $project, $targetHttpsProxy, $optParams)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetQuicOverrideTargetHttpsProxies($project, $targetHttpsProxy, $optParams);
	}
	catch (Exception $e)
	{
