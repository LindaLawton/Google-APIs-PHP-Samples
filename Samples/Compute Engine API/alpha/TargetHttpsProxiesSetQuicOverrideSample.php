...
print_r(targetHttpsProxiesSetQuicOverrideExample($service, $project, $targetHttpsProxy));
...
*/
function targetHttpsProxiesSetQuicOverrideExample($service, $project, $targetHttpsProxy)
{
	try
	{
		...
		return $service->targetHttpsProxies->SetQuicOverrideTargetHttpsProxies($project, $targetHttpsProxy);
	}
	catch (Exception $ex)
	{
