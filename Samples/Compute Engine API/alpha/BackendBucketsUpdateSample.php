...
// Single Request.
$results = backendBucketsUpdateExample($service, $project, $backendBucket, $optParams);
...
* @return Operation
*/
function backendBucketsUpdateExample($service, $project, $backendBucket, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->UpdateBackendBuckets($project, $backendBucket, $optParams);
	}
	catch (Exception $e)
	{
