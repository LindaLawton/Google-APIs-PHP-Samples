...
print_r(backendBucketsUpdateExample($service, $project, $backendBucket));
...
*/
function backendBucketsUpdateExample($service, $project, $backendBucket)
{
	try
	{
		...
		return $service->backendBuckets->UpdateBackendBuckets($project, $backendBucket);
	}
	catch (Exception $ex)
	{
