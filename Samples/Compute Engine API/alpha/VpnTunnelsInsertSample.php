...
// Single Request.
$results = vpnTunnelsInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function vpnTunnelsInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->vpnTunnels->InsertVpnTunnels($project, $region, $optParams);
	}
	catch (Exception $e)
	{
