...
// Single Request.
$results = subnetworksGetIamPolicyExample($service, $project, $region, $resource, $optParams);
...
* @return Policy
*/
function subnetworksGetIamPolicyExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->subnetworks->GetIamPolicySubnetworks($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
