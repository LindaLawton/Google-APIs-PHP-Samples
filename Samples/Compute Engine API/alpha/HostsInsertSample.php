...
$results = hostsInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function hostsInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->hosts->InsertHosts($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
