...
print_r(globalAddressesDeleteExample($service, $project, $address));
...
*/
function globalAddressesDeleteExample($service, $project, $address)
{
	try
	{
		...
		return $service->globalAddresses->DeleteGlobalAddresses($project, $address);
	}
	catch (Exception $ex)
	{
