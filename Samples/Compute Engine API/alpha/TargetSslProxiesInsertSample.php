...
// Single Request.
$results = targetSslProxiesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function targetSslProxiesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->InsertTargetSslProxies($project, $optParams);
	}
	catch (Exception $e)
	{
