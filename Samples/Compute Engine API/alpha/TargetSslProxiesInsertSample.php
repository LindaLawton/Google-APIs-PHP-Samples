...
print_r(targetSslProxiesInsertExample($service, $project));
...
*/
function targetSslProxiesInsertExample($service, $project)
{
	try
	{
		...
		return $service->targetSslProxies->InsertTargetSslProxies($project);
	}
	catch (Exception $ex)
	{
