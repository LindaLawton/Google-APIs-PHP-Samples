...
// Single Request.
$results = diskTypesGetExample($service, $project, $zone, $diskType, $optParams);
...
* @return DiskType
*/
function diskTypesGetExample($service, $project, $zone, $diskType, $optParams)
{
	try
	{
		...
		return $service->diskTypes->GetDiskTypes($project, $zone, $diskType, $optParams);
	}
	catch (Exception $e)
	{
