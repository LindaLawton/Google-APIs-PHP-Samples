...
print_r(diskTypesGetExample($service, $project, $zone, $diskType));
...
*/
function diskTypesGetExample($service, $project, $zone, $diskType)
{
	try
	{
		...
		return $service->diskTypes->GetDiskTypes($project, $zone, $diskType);
	}
	catch (Exception $ex)
	{
