...
// Single Request.
$results = networksPatchExample($service, $project, $network, $optParams);
...
* @return Operation
*/
function networksPatchExample($service, $project, $network, $optParams)
{
	try
	{
		...
		return $service->networks->PatchNetworks($project, $network, $optParams);
	}
	catch (Exception $e)
	{
