...
print_r(disksResizeExample($service, $project, $zone, $disk));
...
*/
function disksResizeExample($service, $project, $zone, $disk)
{
	try
	{
		...
		return $service->disks->ResizeDisks($project, $zone, $disk);
	}
	catch (Exception $ex)
	{
