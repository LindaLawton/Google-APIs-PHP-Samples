...
print_r(httpsHealthChecksTestIamPermissionsExample($service, $project, $resource));
...
*/
function httpsHealthChecksTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->httpsHealthChecks->TestIamPermissionsHttpsHealthChecks($project, $resource);
	}
	catch (Exception $ex)
	{
