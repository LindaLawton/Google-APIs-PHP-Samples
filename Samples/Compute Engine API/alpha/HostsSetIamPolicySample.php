...
$results = hostsSetIamPolicyExample($service, $project, $zone, $resource, $optParams);
...
* @return Policy
*/
function hostsSetIamPolicyExample($service, $project, $zone, $resource, $optParams)
{
	try
	{
		...
		return $service->hosts->SetIamPolicyHosts($project, $zone, $resource, $optParams);
	}
	catch (Exception $e)
	{
