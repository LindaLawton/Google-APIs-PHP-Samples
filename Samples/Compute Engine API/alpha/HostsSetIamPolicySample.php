...
print_r(hostsSetIamPolicyExample($service, $project, $zone, $resource));
...
*/
function hostsSetIamPolicyExample($service, $project, $zone, $resource)
{
	try
	{
		...
		return $service->hosts->SetIamPolicyHosts($project, $zone, $resource);
	}
	catch (Exception $ex)
	{
