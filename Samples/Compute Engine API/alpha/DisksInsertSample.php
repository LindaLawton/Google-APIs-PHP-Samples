...
// Single Request.
$results = disksInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function disksInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->disks->InsertDisks($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
