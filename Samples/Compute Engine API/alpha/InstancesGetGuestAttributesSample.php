...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'variableKey' => '[YourValue]',  //Specifies the key for the guest attributes entry.
  'fields' => '*'
);
// Single Request.
$results = instancesGetGuestAttributesExample($service, $project, $zone, $instance, $optParams);
...
*/
function instancesGetGuestAttributesExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->GetGuestAttributesInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
