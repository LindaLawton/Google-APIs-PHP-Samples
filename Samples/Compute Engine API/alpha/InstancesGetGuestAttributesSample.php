...
print_r(getGuestAttributes($service, $project, $zone, $instance));
...
*/
function getGuestAttributes($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->getGuestAttributes($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
