...
print_r(instancesGetGuestAttributesExample($service, $project, $zone, $instance));
...
* @return GuestAttributes</returns>
*/
function instancesGetGuestAttributesExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->GetGuestAttributesInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
