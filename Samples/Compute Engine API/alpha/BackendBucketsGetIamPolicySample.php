...
print_r(backendBucketsGetIamPolicyExample($service, $project, $resource));
...
*/
function backendBucketsGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->backendBuckets->GetIamPolicyBackendBuckets($project, $resource);
	}
	catch (Exception $ex)
	{
