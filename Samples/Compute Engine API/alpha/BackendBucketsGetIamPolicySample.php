...
// Single Request.
$results = backendBucketsGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function backendBucketsGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->backendBuckets->GetIamPolicyBackendBuckets($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
