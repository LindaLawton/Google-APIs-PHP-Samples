...
print_r(update($service, $project, $zone, $instanceGroupManager));
...
*/
function update($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->update($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
