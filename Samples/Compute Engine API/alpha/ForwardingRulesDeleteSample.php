...
$results = forwardingRulesDeleteExample($service, $project, $region, $forwardingRule, $optParams);
...
* @return Operation
*/
function forwardingRulesDeleteExample($service, $project, $region, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->DeleteForwardingRules($project, $region, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
