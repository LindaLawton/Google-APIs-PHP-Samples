...
print_r(delete($service, $project, $region, $forwardingRule));
...
*/
function delete($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->delete($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
