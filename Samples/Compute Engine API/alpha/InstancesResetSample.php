...
print_r(instancesResetExample($service, $project, $zone, $instance));
...
*/
function instancesResetExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->ResetInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
