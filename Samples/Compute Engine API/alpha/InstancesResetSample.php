...
// Single Request.
$results = instancesResetExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesResetExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->ResetInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
