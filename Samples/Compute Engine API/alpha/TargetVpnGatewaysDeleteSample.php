...
print_r(targetVpnGatewaysDeleteExample($service, $project, $region, $targetVpnGateway));
...
*/
function targetVpnGatewaysDeleteExample($service, $project, $region, $targetVpnGateway)
{
	try
	{
		...
		return $service->targetVpnGateways->DeleteTargetVpnGateways($project, $region, $targetVpnGateway);
	}
	catch (Exception $ex)
	{
