...
// Single Request.
$results = targetPoolsRemoveHealthCheckExample($service, $project, $region, $targetPool, $optParams);
...
* @return Operation
*/
function targetPoolsRemoveHealthCheckExample($service, $project, $region, $targetPool, $optParams)
{
	try
	{
		...
		return $service->targetPools->RemoveHealthCheckTargetPools($project, $region, $targetPool, $optParams);
	}
	catch (Exception $e)
	{
