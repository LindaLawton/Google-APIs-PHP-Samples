...
print_r(targetPoolsRemoveHealthCheckExample($service, $project, $region, $targetPool));
...
*/
function targetPoolsRemoveHealthCheckExample($service, $project, $region, $targetPool)
{
	try
	{
		...
		return $service->targetPools->RemoveHealthCheckTargetPools($project, $region, $targetPool);
	}
	catch (Exception $ex)
	{
