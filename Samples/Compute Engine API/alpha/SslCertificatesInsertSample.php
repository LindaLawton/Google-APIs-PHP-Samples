...
// Single Request.
$results = sslCertificatesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function sslCertificatesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->sslCertificates->InsertSslCertificates($project, $optParams);
	}
	catch (Exception $e)
	{
