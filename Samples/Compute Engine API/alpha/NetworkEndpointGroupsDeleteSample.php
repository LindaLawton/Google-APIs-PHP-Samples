...
print_r(delete($service, $project, $zone, $networkEndpointGroup));
...
*/
function delete($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->delete($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
