...
print_r(networkEndpointGroupsDeleteExample($service, $project, $zone, $networkEndpointGroup));
...
*/
function networkEndpointGroupsDeleteExample($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->networkEndpointGroups->DeleteNetworkEndpointGroups($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
