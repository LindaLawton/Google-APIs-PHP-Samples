...
// Single Request.
$results = networkEndpointGroupsDeleteExample($service, $project, $zone, $networkEndpointGroup, $optParams);
...
* @return Operation
*/
function networkEndpointGroupsDeleteExample($service, $project, $zone, $networkEndpointGroup, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->DeleteNetworkEndpointGroups($project, $zone, $networkEndpointGroup, $optParams);
	}
	catch (Exception $e)
	{
