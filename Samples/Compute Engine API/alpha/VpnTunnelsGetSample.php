...
print_r(vpnTunnelsGetExample($service, $project, $region, $vpnTunnel));
...
* @return VpnTunnel</returns>
*/
function vpnTunnelsGetExample($service, $project, $region, $vpnTunnel)
{
	try
	{
		...
		return $service->vpnTunnels->GetVpnTunnels($project, $region, $vpnTunnel);
	}
	catch (Exception $ex)
	{
