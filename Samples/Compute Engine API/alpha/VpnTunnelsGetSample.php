...
$results = vpnTunnelsGetExample($service, $project, $region, $vpnTunnel, $optParams);
...
* @return VpnTunnel
*/
function vpnTunnelsGetExample($service, $project, $region, $vpnTunnel, $optParams)
{
	try
	{
		...
		return $service->vpnTunnels->GetVpnTunnels($project, $region, $vpnTunnel, $optParams);
	}
	catch (Exception $e)
	{
