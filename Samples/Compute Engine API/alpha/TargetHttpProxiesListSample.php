...
// Single Request.
$results = targetHttpProxiesListExample($service, $project, $optParams);
...
*/
function targetHttpProxiesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetHttpProxies->ListTargetHttpProxies($project, $optParams);
	}
	catch (Exception $e)
	{
