...
print_r(interconnectsGetIamPolicyExample($service, $project, $resource));
...
*/
function interconnectsGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->interconnects->GetIamPolicyInterconnects($project, $resource);
	}
	catch (Exception $ex)
	{
