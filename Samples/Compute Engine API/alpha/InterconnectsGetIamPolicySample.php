...
$results = interconnectsGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function interconnectsGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnects->GetIamPolicyInterconnects($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
