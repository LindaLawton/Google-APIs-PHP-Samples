...
// Single Request.
$results = instancesSimulateMaintenanceEventExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesSimulateMaintenanceEventExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->SimulateMaintenanceEventInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
