...
print_r(simulateMaintenanceEvent($service, $project, $zone, $instance));
...
*/
function simulateMaintenanceEvent($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->simulateMaintenanceEvent($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
