...
print_r(instancesSimulateMaintenanceEventExample($service, $project, $zone, $instance));
...
*/
function instancesSimulateMaintenanceEventExample($service, $project, $zone, $instance)
{
	try
	{
		...
		return $service->instances->SimulateMaintenanceEventInstances($project, $zone, $instance);
	}
	catch (Exception $ex)
	{
