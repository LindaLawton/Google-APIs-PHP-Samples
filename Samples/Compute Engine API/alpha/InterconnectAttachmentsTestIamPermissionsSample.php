...
print_r(interconnectAttachmentsTestIamPermissionsExample($service, $project, $region, $resource));
...
*/
function interconnectAttachmentsTestIamPermissionsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->interconnectAttachments->TestIamPermissionsInterconnectAttachments($project, $region, $resource);
	}
	catch (Exception $ex)
	{
