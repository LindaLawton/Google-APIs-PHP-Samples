...
$results = interconnectAttachmentsTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function interconnectAttachmentsTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->TestIamPermissionsInterconnectAttachments($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
