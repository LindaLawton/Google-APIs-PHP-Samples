...
print_r(instancesDeleteAccessConfigExample($service, $project, $zone, $instance, $accessConfig, $networkInterface));
...
*/
function instancesDeleteAccessConfigExample($service, $project, $zone, $instance, $accessConfig, $networkInterface)
{
	try
	{
		...
		return $service->instances->DeleteAccessConfigInstances($project, $zone, $instance, $accessConfig, $networkInterface);
	}
	catch (Exception $ex)
	{
