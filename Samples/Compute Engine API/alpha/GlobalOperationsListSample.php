...
// Single Request.
$results = globalOperationsListExample($service, $project, $optParams);
...
*/
function globalOperationsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->globalOperations->ListGlobalOperations($project, $optParams);
	}
	catch (Exception $e)
	{
