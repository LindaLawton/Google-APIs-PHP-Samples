...
$results = interconnectsGetExample($service, $project, $interconnect, $optParams);
...
* @return Interconnect
*/
function interconnectsGetExample($service, $project, $interconnect, $optParams)
{
	try
	{
		...
		return $service->interconnects->GetInterconnects($project, $interconnect, $optParams);
	}
	catch (Exception $e)
	{
