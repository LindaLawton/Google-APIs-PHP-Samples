...
print_r(interconnectsGetExample($service, $project, $interconnect));
...
* @return Interconnect</returns>
*/
function interconnectsGetExample($service, $project, $interconnect)
{
	try
	{
		...
		return $service->interconnects->GetInterconnects($project, $interconnect);
	}
	catch (Exception $ex)
	{
