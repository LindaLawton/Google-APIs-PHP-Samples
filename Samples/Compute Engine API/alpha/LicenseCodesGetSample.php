...
// Single Request.
$results = licenseCodesGetExample($service, $project, $licenseCode, $optParams);
...
* @return LicenseCode
*/
function licenseCodesGetExample($service, $project, $licenseCode, $optParams)
{
	try
	{
		...
		if (licenseCode == null)
			throw new Exception("licenseCode is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->licenseCodes->GetLicenseCodes($project, $licenseCode, $optParams);
	}
	catch (Exception $e)
	{
