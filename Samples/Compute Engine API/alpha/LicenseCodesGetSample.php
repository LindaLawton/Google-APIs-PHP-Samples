...
print_r(licenseCodesGetExample($service, $project, $licenseCode));
...
* @return LicenseCode</returns>
*/
function licenseCodesGetExample($service, $project, $licenseCode)
{
	try
	{
		...
		return $service->licenseCodes->GetLicenseCodes($project, $licenseCode);
	}
	catch (Exception $ex)
	{
