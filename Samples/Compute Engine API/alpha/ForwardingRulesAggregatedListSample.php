...
// Single Request.
$results = forwardingRulesAggregatedListExample($service, $project, $optParams);
...
*/
function forwardingRulesAggregatedListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->AggregatedListForwardingRules($project, $optParams);
	}
	catch (Exception $e)
	{
