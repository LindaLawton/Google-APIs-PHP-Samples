...
print_r(backendBucketsDeleteExample($service, $project, $backendBucket));
...
*/
function backendBucketsDeleteExample($service, $project, $backendBucket)
{
	try
	{
		...
		return $service->backendBuckets->DeleteBackendBuckets($project, $backendBucket);
	}
	catch (Exception $ex)
	{
