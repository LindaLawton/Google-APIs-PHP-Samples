...
print_r(listPerInstanceConfigs($service, $project, $zone, $instanceGroupManager));
...
*/
function listPerInstanceConfigs($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->listPerInstanceConfigs($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
