...
print_r(instanceGroupManagersListPerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager));
...
* @return InstanceGroupManagersListPerInstanceConfigsResp</returns>
*/
function instanceGroupManagersListPerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->ListPerInstanceConfigsInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
