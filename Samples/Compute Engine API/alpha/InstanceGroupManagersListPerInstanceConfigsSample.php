...
$results = instanceGroupManagersListPerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $zone, $instanceGroupManager, $optParams);	
...
*/
function instanceGroupManagersListPerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->ListPerInstanceConfigsInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
