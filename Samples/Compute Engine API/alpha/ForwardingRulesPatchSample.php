...
$results = forwardingRulesPatchExample($service, $project, $region, $forwardingRule, $optParams);
...
* @return Operation
*/
function forwardingRulesPatchExample($service, $project, $region, $forwardingRule, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->PatchForwardingRules($project, $region, $forwardingRule, $optParams);
	}
	catch (Exception $e)
	{
