...
print_r(forwardingRulesPatchExample($service, $project, $region, $forwardingRule));
...
*/
function forwardingRulesPatchExample($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->forwardingRules->PatchForwardingRules($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
