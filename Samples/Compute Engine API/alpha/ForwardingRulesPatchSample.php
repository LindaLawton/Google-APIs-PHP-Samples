...
print_r(patch($service, $project, $region, $forwardingRule));
...
*/
function patch($service, $project, $region, $forwardingRule)
{
	try
	{
		...
		return $service->patch($project, $region, $forwardingRule);
	}
	catch (Exception $ex)
	{
