...
// Single Request.
$results = addressesDeleteExample($service, $project, $region, $address, $optParams);
...
* @return Operation
*/
function addressesDeleteExample($service, $project, $region, $address, $optParams)
{
	try
	{
		...
		return $service->addresses->DeleteAddresses($project, $region, $address, $optParams);
	}
	catch (Exception $e)
	{
