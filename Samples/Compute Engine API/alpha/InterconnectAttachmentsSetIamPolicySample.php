...
print_r(interconnectAttachmentsSetIamPolicyExample($service, $project, $region, $resource));
...
*/
function interconnectAttachmentsSetIamPolicyExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->interconnectAttachments->SetIamPolicyInterconnectAttachments($project, $region, $resource);
	}
	catch (Exception $ex)
	{
