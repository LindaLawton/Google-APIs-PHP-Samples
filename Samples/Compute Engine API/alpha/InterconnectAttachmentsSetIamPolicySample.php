...
// Single Request.
$results = interconnectAttachmentsSetIamPolicyExample($service, $project, $region, $resource, $optParams);
...
* @return Policy
*/
function interconnectAttachmentsSetIamPolicyExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->interconnectAttachments->SetIamPolicyInterconnectAttachments($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
