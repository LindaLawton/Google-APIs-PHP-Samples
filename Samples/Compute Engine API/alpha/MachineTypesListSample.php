...
print_r(machineTypesListExample($service, $project, $zone));
...
* @return MachineTypeList</returns>
*/
function machineTypesListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->machineTypes->ListMachineTypes($project, $zone);
	}
	catch (Exception $ex)
	{
