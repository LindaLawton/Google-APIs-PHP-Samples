...
print_r(getHealth($service, $project, $region, $backendService));
...
*/
function getHealth($service, $project, $region, $backendService)
{
	try
	{
		...
		return $service->getHealth($project, $region, $backendService);
	}
	catch (Exception $ex)
	{
