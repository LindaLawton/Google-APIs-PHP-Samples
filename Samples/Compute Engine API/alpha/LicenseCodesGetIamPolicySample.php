...
// Single Request.
$results = licenseCodesGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function licenseCodesGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->licenseCodes->GetIamPolicyLicenseCodes($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
