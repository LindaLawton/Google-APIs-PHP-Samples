...
print_r(licenseCodesGetIamPolicyExample($service, $project, $resource));
...
*/
function licenseCodesGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->licenseCodes->GetIamPolicyLicenseCodes($project, $resource);
	}
	catch (Exception $ex)
	{
