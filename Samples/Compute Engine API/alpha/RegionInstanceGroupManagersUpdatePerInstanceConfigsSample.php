...
print_r(updatePerInstanceConfigs($service, $project, $region, $instanceGroupManager));
...
*/
function updatePerInstanceConfigs($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->updatePerInstanceConfigs($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
