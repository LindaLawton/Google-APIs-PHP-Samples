...
print_r(regionInstanceGroupManagersUpdatePerInstanceConfigsExample($service, $project, $region, $instanceGroupManager));
...
*/
function regionInstanceGroupManagersUpdatePerInstanceConfigsExample($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->regionInstanceGroupManagers->UpdatePerInstanceConfigsRegionInstanceGroupManagers($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
