...
print_r(patch($service, $project, $region, $instanceGroupManager));
...
*/
function patch($service, $project, $region, $instanceGroupManager)
{
	try
	{
		...
		return $service->patch($project, $region, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
