...
print_r(vpnTunnelsSetLabelsExample($service, $project, $region, $resource));
...
*/
function vpnTunnelsSetLabelsExample($service, $project, $region, $resource)
{
	try
	{
		...
		return $service->vpnTunnels->SetLabelsVpnTunnels($project, $region, $resource);
	}
	catch (Exception $ex)
	{
