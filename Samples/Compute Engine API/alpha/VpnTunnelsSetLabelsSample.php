...
// Single Request.
$results = vpnTunnelsSetLabelsExample($service, $project, $region, $resource, $optParams);
...
* @return Operation
*/
function vpnTunnelsSetLabelsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->vpnTunnels->SetLabelsVpnTunnels($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
