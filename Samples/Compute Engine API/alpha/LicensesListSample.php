...
// Single Request.
$results = licensesListExample($service, $project, $optParams);
...
*/
function licensesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->licenses->ListLicenses($project, $optParams);
	}
	catch (Exception $e)
	{
