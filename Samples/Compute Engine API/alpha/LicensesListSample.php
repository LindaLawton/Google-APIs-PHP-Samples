...
print_r(licensesListExample($service, $project));
...
* @return LicensesListResponse</returns>
*/
function licensesListExample($service, $project)
{
	try
	{
		...
		return $service->licenses->ListLicenses($project);
	}
	catch (Exception $ex)
	{
