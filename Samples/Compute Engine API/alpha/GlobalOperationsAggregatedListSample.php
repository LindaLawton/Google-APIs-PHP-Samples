...
print_r(globalOperationsAggregatedListExample($service, $project));

/**
* Retrieves an aggregated list of all operations.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return OperationAggregatedList</returns>
*/
function globalOperationsAggregatedListExample($service, $project)
{
	try
	{
		...
		return $service->globalOperations->AggregatedListGlobalOperations($project);
	}
	catch (Exception $ex)
	{
