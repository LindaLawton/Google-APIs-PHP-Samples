...
// Single Request.
$results = regionInstanceGroupsSetNamedPortsExample($service, $project, $region, $instanceGroup, $optParams);
...
* @return Operation
*/
function regionInstanceGroupsSetNamedPortsExample($service, $project, $region, $instanceGroup, $optParams)
{
	try
	{
		...
		return $service->regionInstanceGroups->SetNamedPortsRegionInstanceGroups($project, $region, $instanceGroup, $optParams);
	}
	catch (Exception $e)
	{
