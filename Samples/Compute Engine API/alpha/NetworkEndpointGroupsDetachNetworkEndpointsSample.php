...
print_r(detachNetworkEndpoints($service, $project, $zone, $networkEndpointGroup));
...
*/
function detachNetworkEndpoints($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->detachNetworkEndpoints($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
