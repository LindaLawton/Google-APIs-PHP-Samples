...
// Single Request.
$results = networkEndpointGroupsDetachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup, $optParams);
...
* @return Operation
*/
function networkEndpointGroupsDetachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->DetachNetworkEndpointsNetworkEndpointGroups($project, $zone, $networkEndpointGroup, $optParams);
	}
	catch (Exception $e)
	{
