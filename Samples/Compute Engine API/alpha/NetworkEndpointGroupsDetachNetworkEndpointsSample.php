...
print_r(networkEndpointGroupsDetachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup));
...
*/
function networkEndpointGroupsDetachNetworkEndpointsExample($service, $project, $zone, $networkEndpointGroup)
{
	try
	{
		...
		return $service->networkEndpointGroups->DetachNetworkEndpointsNetworkEndpointGroups($project, $zone, $networkEndpointGroup);
	}
	catch (Exception $ex)
	{
