...
// Single Request.
$results = routersGetRouterStatusExample($service, $project, $region, $router, $optParams);
...
*/
function routersGetRouterStatusExample($service, $project, $region, $router, $optParams)
{
	try
	{
		...
		return $service->routers->GetRouterStatusRouters($project, $region, $router, $optParams);
	}
	catch (Exception $e)
	{
