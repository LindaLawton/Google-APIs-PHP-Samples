...
print_r(getRouterStatus($service, $project, $region, $router));
...
*/
function getRouterStatus($service, $project, $region, $router)
{
	try
	{
		...
		return $service->getRouterStatus($project, $region, $router);
	}
	catch (Exception $ex)
	{
