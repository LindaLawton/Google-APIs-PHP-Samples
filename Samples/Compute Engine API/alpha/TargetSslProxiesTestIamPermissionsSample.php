...
print_r(targetSslProxiesTestIamPermissionsExample($service, $project, $resource));
...
*/
function targetSslProxiesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->targetSslProxies->TestIamPermissionsTargetSslProxies($project, $resource);
	}
	catch (Exception $ex)
	{
