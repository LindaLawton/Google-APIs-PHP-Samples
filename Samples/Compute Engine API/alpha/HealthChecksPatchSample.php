...
print_r(healthChecksPatchExample($service, $project, $healthCheck));
...
*/
function healthChecksPatchExample($service, $project, $healthCheck)
{
	try
	{
		...
		return $service->healthChecks->PatchHealthChecks($project, $healthCheck);
	}
	catch (Exception $ex)
	{
