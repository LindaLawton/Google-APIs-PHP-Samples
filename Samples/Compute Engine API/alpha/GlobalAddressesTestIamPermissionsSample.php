...
// Single Request.
$results = globalAddressesTestIamPermissionsExample($service, $project, $resource, $optParams);
...
*/
function globalAddressesTestIamPermissionsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->globalAddresses->TestIamPermissionsGlobalAddresses($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
