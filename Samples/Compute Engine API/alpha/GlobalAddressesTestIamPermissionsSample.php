...
print_r(globalAddressesTestIamPermissionsExample($service, $project, $resource));
...
*/
function globalAddressesTestIamPermissionsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->globalAddresses->TestIamPermissionsGlobalAddresses($project, $resource);
	}
	catch (Exception $ex)
	{
