...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'forceAttach' => '[YourValue]',  // Whether to force attach the disk even if it's currently attached to another instance. This is only available for regional disks.
...
// Single Request.
$results = instancesAttachDiskExample($service, $project, $zone, $instance, $optParams);
...
* @return Operation
*/
function instancesAttachDiskExample($service, $project, $zone, $instance, $optParams)
{
	try
	{
		...
		return $service->instances->AttachDiskInstances($project, $zone, $instance, $optParams);
	}
	catch (Exception $e)
	{
