...
// Single Request.
$results = interconnectAttachmentsDeleteExample($service, $project, $region, $interconnectAttachment, $optParams);
...
* @return Operation
*/
function interconnectAttachmentsDeleteExample($service, $project, $region, $interconnectAttachment, $optParams)
{
	try
	{
		...
		if (interconnectAttachment == null)
			throw new Exception("interconnectAttachment is required.");
		if (project == null)
			throw new Exception("project is required.");
		if (region == null)
			throw new Exception("region is required.");
		// Make the request and return the results.
		return $service->interconnectAttachments->DeleteInterconnectAttachments($project, $region, $interconnectAttachment, $optParams);
	}
	catch (Exception $e)
	{
