...
print_r(interconnectAttachmentsDeleteExample($service, $project, $region, $interconnectAttachment));
...
*/
function interconnectAttachmentsDeleteExample($service, $project, $region, $interconnectAttachment)
{
	try
	{
		...
		return $service->interconnectAttachments->DeleteInterconnectAttachments($project, $region, $interconnectAttachment);
	}
	catch (Exception $ex)
	{
