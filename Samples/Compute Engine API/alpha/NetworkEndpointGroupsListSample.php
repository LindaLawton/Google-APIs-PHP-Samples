...
// Single Request.
$results = networkEndpointGroupsListExample($service, $project, $zone, $optParams);
...
*/
function networkEndpointGroupsListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->networkEndpointGroups->ListNetworkEndpointGroups($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
