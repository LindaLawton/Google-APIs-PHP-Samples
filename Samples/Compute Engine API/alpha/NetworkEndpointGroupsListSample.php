...
print_r(networkEndpointGroupsListExample($service, $project, $zone));
...
* @return NetworkEndpointGroupList</returns>
*/
function networkEndpointGroupsListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->networkEndpointGroups->ListNetworkEndpointGroups($project, $zone);
	}
	catch (Exception $ex)
	{
