...
// Single Request.
$results = regionDisksGetExample($service, $project, $region, $disk, $optParams);
...
* @return Disk
*/
function regionDisksGetExample($service, $project, $region, $disk, $optParams)
{
	try
	{
		...
		return $service->regionDisks->GetRegionDisks($project, $region, $disk, $optParams);
	}
	catch (Exception $e)
	{
