...
print_r(regionDisksGetExample($service, $project, $region, $disk));
...
* @return Disk</returns>
*/
function regionDisksGetExample($service, $project, $region, $disk)
{
	try
	{
		...
		return $service->regionDisks->GetRegionDisks($project, $region, $disk);
	}
	catch (Exception $ex)
	{
