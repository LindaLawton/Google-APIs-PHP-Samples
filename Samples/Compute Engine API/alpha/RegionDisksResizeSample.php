...
print_r(regionDisksResizeExample($service, $project, $region, $disk));
...
*/
function regionDisksResizeExample($service, $project, $region, $disk)
{
	try
	{
		...
		return $service->regionDisks->ResizeRegionDisks($project, $region, $disk);
	}
	catch (Exception $ex)
	{
