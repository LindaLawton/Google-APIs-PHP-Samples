...
$results = regionDisksResizeExample($service, $project, $region, $disk, $optParams);
...
* @return Operation
*/
function regionDisksResizeExample($service, $project, $region, $disk, $optParams)
{
	try
	{
		...
		return $service->regionDisks->ResizeRegionDisks($project, $region, $disk, $optParams);
	}
	catch (Exception $e)
	{
