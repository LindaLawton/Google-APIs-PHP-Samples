...
// Single Request.
$results = globalForwardingRulesSetLabelsExample($service, $project, $resource, $optParams);
...
* @return Operation
*/
function globalForwardingRulesSetLabelsExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->globalForwardingRules->SetLabelsGlobalForwardingRules($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
