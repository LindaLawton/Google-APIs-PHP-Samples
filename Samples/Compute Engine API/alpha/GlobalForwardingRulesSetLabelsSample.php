...
print_r(globalForwardingRulesSetLabelsExample($service, $project, $resource));
...
*/
function globalForwardingRulesSetLabelsExample($service, $project, $resource)
{
	try
	{
		...
		return $service->globalForwardingRules->SetLabelsGlobalForwardingRules($project, $resource);
	}
	catch (Exception $ex)
	{
