...
// Single Request.
$results = hostsListExample($service, $project, $zone, $optParams);
...
* @return HostList
*/
function hostsListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->hosts->ListHosts($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
