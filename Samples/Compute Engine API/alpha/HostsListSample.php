...
print_r(hostsListExample($service, $project, $zone));
...
* @return HostList</returns>
*/
function hostsListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->hosts->ListHosts($project, $zone);
	}
	catch (Exception $ex)
	{
