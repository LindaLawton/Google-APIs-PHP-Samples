...
print_r(addInstances($service, $project, $zone, $instanceGroup));
...
*/
function addInstances($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->addInstances($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
