...
print_r(instanceGroupsAddInstancesExample($service, $project, $zone, $instanceGroup));
...
*/
function instanceGroupsAddInstancesExample($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->instanceGroups->AddInstancesInstanceGroups($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
