...
// Single Request.
$results = addressesTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function addressesTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->addresses->TestIamPermissionsAddresses($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
