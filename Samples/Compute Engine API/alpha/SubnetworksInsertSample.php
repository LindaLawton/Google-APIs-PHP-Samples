...
print_r(subnetworksInsertExample($service, $project, $region));
...
*/
function subnetworksInsertExample($service, $project, $region)
{
	try
	{
		...
		return $service->subnetworks->InsertSubnetworks($project, $region);
	}
	catch (Exception $ex)
	{
