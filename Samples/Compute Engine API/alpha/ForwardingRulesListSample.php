...
// Single Request.
$results = forwardingRulesListExample($service, $project, $region, $optParams);
...
*/
function forwardingRulesListExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->forwardingRules->ListForwardingRules($project, $region, $optParams);
	}
	catch (Exception $e)
	{
