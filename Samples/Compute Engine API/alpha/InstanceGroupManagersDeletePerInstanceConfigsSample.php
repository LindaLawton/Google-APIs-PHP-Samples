...
print_r(deletePerInstanceConfigs($service, $project, $zone, $instanceGroupManager));
...
*/
function deletePerInstanceConfigs($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->deletePerInstanceConfigs($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
