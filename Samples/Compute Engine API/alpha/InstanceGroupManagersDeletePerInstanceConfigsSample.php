...
print_r(instanceGroupManagersDeletePerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersDeletePerInstanceConfigsExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->DeletePerInstanceConfigsInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
