...
print_r(instanceGroupsRemoveInstancesExample($service, $project, $zone, $instanceGroup));
...
*/
function instanceGroupsRemoveInstancesExample($service, $project, $zone, $instanceGroup)
{
	try
	{
		...
		return $service->instanceGroups->RemoveInstancesInstanceGroups($project, $zone, $instanceGroup);
	}
	catch (Exception $ex)
	{
