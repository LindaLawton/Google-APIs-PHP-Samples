...
// Single Request.
$results = targetPoolsInsertExample($service, $project, $region, $optParams);
...
* @return Operation
*/
function targetPoolsInsertExample($service, $project, $region, $optParams)
{
	try
	{
		...
		return $service->targetPools->InsertTargetPools($project, $region, $optParams);
	}
	catch (Exception $e)
	{
