...
// Single Request.
$results = backendServicesGetHealthExample($service, $project, $backendService, $optParams);
...
*/
function backendServicesGetHealthExample($service, $project, $backendService, $optParams)
{
	try
	{
		...
		return $service->backendServices->GetHealthBackendServices($project, $backendService, $optParams);
	}
	catch (Exception $e)
	{
