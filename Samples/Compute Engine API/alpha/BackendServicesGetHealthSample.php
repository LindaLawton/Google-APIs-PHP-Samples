...
print_r(backendServicesGetHealthExample($service, $project, $backendService));
...
*/
function backendServicesGetHealthExample($service, $project, $backendService)
{
	try
	{
		...
		return $service->backendServices->GetHealthBackendServices($project, $backendService);
	}
	catch (Exception $ex)
	{
