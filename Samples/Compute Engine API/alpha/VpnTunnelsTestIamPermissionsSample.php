...
// Single Request.
$results = vpnTunnelsTestIamPermissionsExample($service, $project, $region, $resource, $optParams);
...
*/
function vpnTunnelsTestIamPermissionsExample($service, $project, $region, $resource, $optParams)
{
	try
	{
		...
		return $service->vpnTunnels->TestIamPermissionsVpnTunnels($project, $region, $resource, $optParams);
	}
	catch (Exception $e)
	{
