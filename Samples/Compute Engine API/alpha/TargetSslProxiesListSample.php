...
// Single Request.
$results = targetSslProxiesListExample($service, $project, $optParams);
...
*/
function targetSslProxiesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->targetSslProxies->ListTargetSslProxies($project, $optParams);
	}
	catch (Exception $e)
	{
