...
print_r(targetSslProxiesListExample($service, $project));

/**
* Retrieves the list of TargetSslProxy resources available to the specified project.
* @service Authenticated Compute service.
* @project Project ID for this request.
* @return TargetSslProxyList</returns>
*/
function targetSslProxiesListExample($service, $project)
{
	try
	{
		...
		return $service->targetSslProxies->ListTargetSslProxies($project);
	}
	catch (Exception $ex)
	{
