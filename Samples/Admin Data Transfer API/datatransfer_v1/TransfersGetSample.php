...
// Single Request.
$results = transfersGetExample($service, $dataTransferId, $optParams);
...
* @return DataTransfer
*/
function transfersGetExample($service, $dataTransferId, $optParams)
{
	try
	{
		...
		if (dataTransferId == null)
			throw new Exception("dataTransferId is required.");
		// Make the request and return the results.
		return $service->transfers->GetTransfers($dataTransferId, $optParams);
	}
	catch (Exception $e)
	{
