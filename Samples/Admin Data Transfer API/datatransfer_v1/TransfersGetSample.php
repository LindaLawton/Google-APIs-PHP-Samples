...
print_r(transfersGetExample($service, $dataTransferId));
...
* @return DataTransfer</returns>
*/
function transfersGetExample($service, $dataTransferId)
{
	try
	{
		...
		return $service->transfers->GetTransfers($dataTransferId);
	}
	catch (Exception $ex)
	{
