...
print_r(transfersListExample($service));

/**
* Lists the transfers for a customer by source user, destination user, or status.
* @service Authenticated Datatransfer service.
* @return DataTransfersListResponse</returns>
*/
function transfersListExample($service)
{
	try
	{
		...
		return $service->transfers->ListTransfers();
	}
	catch (Exception $ex)
	{
