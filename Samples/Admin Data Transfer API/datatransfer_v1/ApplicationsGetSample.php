...
print_r(applicationsGetExample($service, $applicationId));

/**
* Retrieves information about an application for the given application ID.
* @service Authenticated Datatransfer service.
* @applicationId ID of the application resource to be retrieved.
* @return Application</returns>
*/
function applicationsGetExample($service, $applicationId)
{
	try
	{
		...
		return $service->applications->GetApplications($applicationId);
	}
	catch (Exception $ex)
	{
