...
// Single Request.
$results = applicationsGetExample($service, $applicationId, $optParams);
...
* @return Application
*/
function applicationsGetExample($service, $applicationId, $optParams)
{
	try
	{
		...
		return $service->applications->GetApplications($applicationId, $optParams);
	}
	catch (Exception $e)
	{
