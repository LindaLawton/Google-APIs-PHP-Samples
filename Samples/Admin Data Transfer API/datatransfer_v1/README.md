...
# UnOfficial Admin Data Transfer API datatransfer_v1 Samples for PHP

## API Description

Transfers user data from one user to another.

[Official Documentation](https://developers.google.com/admin-sdk/data-transfer/)

## Sample Description

These samples show how to access the [Admin Data Transfer API datatransfer_v1](https://developers.google.com/admin-sdk/data-transfer/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
