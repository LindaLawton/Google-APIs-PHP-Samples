...
// Single Request.
$results = applicationsListExample($service, $optParams);
...
*/
function applicationsListExample($service, $optParams)
{
	try
	{
		...
		return $service->applications->ListApplications($optParams);
	}
	catch (Exception $e)
	{
