...
print_r(applicationsListExample($service));

/**
* Lists the applications available for data transfer for a customer.
* @service Authenticated Datatransfer service.
* @return ApplicationsListResponse</returns>
*/
function applicationsListExample($service)
{
	try
	{
		...
		return $service->applications->ListApplications();
	}
	catch (Exception $ex)
	{
