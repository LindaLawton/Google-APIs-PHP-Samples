...
# Unoffical Cloud Video Intelligence API Samples for PHP
...
These samples show how to access the [Cloud Video Intelligence API](https://cloud.google.com/video-intelligence/docs/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
