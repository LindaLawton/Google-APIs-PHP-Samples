...
# UnOfficial Cloud Spanner API v1 Samples for PHP
...
These samples show how to access the [Cloud Spanner API v1](https://cloud.google.com/spanner/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
