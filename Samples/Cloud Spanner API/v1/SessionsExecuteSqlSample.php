...
print_r(sessionsExecuteSqlExample($service, $session));
...
* @return ResultSet</returns>
*/
function sessionsExecuteSqlExample($service, $session)
{
	try
	{
		...
		return $service->sessions->ExecuteSqlSessions($session);
	}
	catch (Exception $ex)
	{
