...
// Single Request.
$results = sessionsExecuteSqlExample($service, $session, $optParams);
...
* @return ResultSet
*/
function sessionsExecuteSqlExample($service, $session, $optParams)
{
	try
	{
		...
		return $service->sessions->ExecuteSqlSessions($session, $optParams);
	}
	catch (Exception $e)
	{
