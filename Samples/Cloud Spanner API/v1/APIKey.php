 ...
 * Initializes an Spanner.v1 service object.
 * @param string API key
 * @return An authorized Spanner.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Spanner Sample");
		...
		// Create authenticated Spanner service
		return new Google_Service_Spanner($client);
	} catch (Exception $e) {
