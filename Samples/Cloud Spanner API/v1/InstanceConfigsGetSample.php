...
// Single Request.
$results = instanceConfigsGetExample($service, $name, $optParams);
...
*/
function instanceConfigsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->instanceConfigs->GetInstanceConfigs($name, $optParams);
	}
	catch (Exception $e)
	{
