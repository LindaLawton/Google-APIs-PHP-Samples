...
print_r(instanceConfigsGetExample($service, $name));
...
* @return InstanceConfig</returns>
*/
function instanceConfigsGetExample($service, $name)
{
	try
	{
		...
		return $service->instanceConfigs->GetInstanceConfigs($name);
	}
	catch (Exception $ex)
	{
