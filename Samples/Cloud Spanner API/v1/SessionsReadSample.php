...
// Single Request.
$results = sessionsReadExample($service, $session, $optParams);
...
* @return ResultSet
*/
function sessionsReadExample($service, $session, $optParams)
{
	try
	{
		...
		return $service->sessions->ReadSessions($session, $optParams);
	}
	catch (Exception $e)
	{
