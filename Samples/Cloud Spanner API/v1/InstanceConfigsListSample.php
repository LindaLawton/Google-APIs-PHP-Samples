...
print_r(instanceConfigsListExample($service, $parent));
...
`projects/<project>`.
* @return ListInstanceConfigsResponse</returns>
*/
function instanceConfigsListExample($service, $parent)
{
	try
	{
		...
		return $service->instanceConfigs->ListInstanceConfigs($parent);
	}
	catch (Exception $ex)
	{
