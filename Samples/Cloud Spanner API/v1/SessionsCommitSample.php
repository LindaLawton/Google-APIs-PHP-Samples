...
// Single Request.
$results = sessionsCommitExample($service, $session, $optParams);
...
*/
function sessionsCommitExample($service, $session, $optParams)
{
	try
	{
		...
		return $service->sessions->CommitSessions($session, $optParams);
	}
	catch (Exception $e)
	{
