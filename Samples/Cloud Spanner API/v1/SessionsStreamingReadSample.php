...
// Single Request.
$results = sessionsStreamingReadExample($service, $session, $optParams);
...
*/
function sessionsStreamingReadExample($service, $session, $optParams)
{
	try
	{
		...
		return $service->sessions->StreamingReadSessions($session, $optParams);
	}
	catch (Exception $e)
	{
