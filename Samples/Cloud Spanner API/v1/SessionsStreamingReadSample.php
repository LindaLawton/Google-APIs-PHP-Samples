...
print_r(sessionsStreamingReadExample($service, $session));
...
*/
function sessionsStreamingReadExample($service, $session)
{
	try
	{
		...
		return $service->sessions->StreamingReadSessions($session);
	}
	catch (Exception $ex)
	{
