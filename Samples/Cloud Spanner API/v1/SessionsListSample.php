...
print_r(sessionsListExample($service, $database));

/**
* Lists all sessions in a given database.
* @service Authenticated Spanner service.
* @database Required. The database in which to list sessions.
* @return ListSessionsResponse</returns>
*/
function sessionsListExample($service, $database)
{
	try
	{
		...
		return $service->sessions->ListSessions($database);
	}
	catch (Exception $ex)
	{
