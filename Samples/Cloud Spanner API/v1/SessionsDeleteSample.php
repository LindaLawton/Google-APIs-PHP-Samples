...
// Single Request.
$results = sessionsDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function sessionsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->sessions->DeleteSessions($name, $optParams);
	}
	catch (Exception $e)
	{
