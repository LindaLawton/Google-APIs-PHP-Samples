...
// Single Request.
$results = sessionsExecuteStreamingSqlExample($service, $session, $optParams);
...
*/
function sessionsExecuteStreamingSqlExample($service, $session, $optParams)
{
	try
	{
		...
		return $service->sessions->ExecuteStreamingSqlSessions($session, $optParams);
	}
	catch (Exception $e)
	{
