...
print_r(sessionsExecuteStreamingSqlExample($service, $session));
...
* @return PartialResultSet</returns>
*/
function sessionsExecuteStreamingSqlExample($service, $session)
{
	try
	{
		...
		return $service->sessions->ExecuteStreamingSqlSessions($session);
	}
	catch (Exception $ex)
	{
