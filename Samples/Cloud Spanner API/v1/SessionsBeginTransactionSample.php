...
print_r(sessionsBeginTransactionExample($service, $session));
...
*/
function sessionsBeginTransactionExample($service, $session)
{
	try
	{
		...
		return $service->sessions->BeginTransactionSessions($session);
	}
	catch (Exception $ex)
	{
