...
$results = sessionsBeginTransactionExample($service, $session, $optParams);
...
* @return Transaction
*/
function sessionsBeginTransactionExample($service, $session, $optParams)
{
	try
	{
		...
		return $service->sessions->BeginTransactionSessions($session, $optParams);
	}
	catch (Exception $e)
	{
