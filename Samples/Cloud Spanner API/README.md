...
# Unoffical Cloud Spanner API Samples for PHP
...
These samples show how to access the [Cloud Spanner API](https://cloud.google.com/spanner/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
