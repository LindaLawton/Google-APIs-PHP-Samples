 ...
 * Initializes an Adsense.v1.4 service object.
 * @param string API key
 * @return An authorized Adsense.v1.4 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Adsense Sample");
		...
		// Create authenticated Adsense service
		return new Google_Service_Adsense($client);
	} catch (Exception $e) {
