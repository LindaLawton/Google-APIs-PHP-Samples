...
print_r(savedadstylesListExample($service));

/**
* List all saved ad styles in the user's account.
* @service Authenticated Adsense service.
* @return SavedAdStyles</returns>
*/
function savedadstylesListExample($service)
{
	try
	{
		...
		return $service->savedadstyles->ListSavedadstyles();
	}
	catch (Exception $ex)
	{
