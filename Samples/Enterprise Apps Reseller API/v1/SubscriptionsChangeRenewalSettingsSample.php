...
print_r(changeRenewalSettings($service, $customerId, $subscriptionId));
...
*/
function changeRenewalSettings($service, $customerId, $subscriptionId)
{
	try
	{
		...
		return $service->changeRenewalSettings($customerId, $subscriptionId);
	}
	catch (Exception $ex)
	{
