 ...
 * Initializes an Reseller.v1 service object.
 * @param string API key
 * @return An authorized Reseller.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Reseller Sample");
		...
		// Create authenticated Reseller service
		return new Google_Service_Reseller($client);
	} catch (Exception $e) {
