...
print_r(delete($service, $customerId, $subscriptionId, $deletionType));
...
*/
function delete($service, $customerId, $subscriptionId, $deletionType)
{
	try
	{
		...
		return $service->delete($customerId, $subscriptionId, $deletionType);
	}
	catch (Exception $ex)
	{
