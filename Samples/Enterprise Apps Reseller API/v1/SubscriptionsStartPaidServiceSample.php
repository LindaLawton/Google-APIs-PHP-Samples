...
print_r(startPaidService($service, $customerId, $subscriptionId));
...
*/
function startPaidService($service, $customerId, $subscriptionId)
{
	try
	{
		...
		return $service->startPaidService($customerId, $subscriptionId);
	}
	catch (Exception $ex)
	{
