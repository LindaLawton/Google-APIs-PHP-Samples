...
print_r(resellernotifyUnregisterExample($service));

/**
* Unregisters a Reseller for receiving notifications.
* @service Authenticated Reseller service.
* @return ResellernotifyResource</returns>
*/
function resellernotifyUnregisterExample($service)
{
	try
	{
		...
		return $service->resellernotify->UnregisterResellernotify();
	}
	catch (Exception $ex)
	{
