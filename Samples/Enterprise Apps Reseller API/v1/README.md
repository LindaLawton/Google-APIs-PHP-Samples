...
# UnOfficial Enterprise Apps Reseller API v1 Samples for PHP

## API Description

Creates and manages your customers and their subscriptions.

[Official Documentation](https://developers.google.com/google-apps/reseller/)

## Sample Description

These samples show how to access the [Enterprise Apps Reseller API v1](https://developers.google.com/google-apps/reseller/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
