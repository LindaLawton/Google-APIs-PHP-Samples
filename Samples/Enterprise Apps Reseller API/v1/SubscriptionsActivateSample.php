...
print_r(activate($service, $customerId, $subscriptionId));
...
*/
function activate($service, $customerId, $subscriptionId)
{
	try
	{
		...
		return $service->activate($customerId, $subscriptionId);
	}
	catch (Exception $ex)
	{
