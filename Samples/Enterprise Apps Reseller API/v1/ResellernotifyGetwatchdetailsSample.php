...
// Single Request.
$results = resellernotifyGetwatchdetailsExample($service, $optParams);
...
*/
function resellernotifyGetwatchdetailsExample($service, $optParams)
{
	try
	{
		...
		return $service->resellernotify->GetwatchdetailsResellernotify($optParams);
	}
	catch (Exception $e)
	{
