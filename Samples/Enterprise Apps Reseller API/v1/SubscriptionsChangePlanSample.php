...
print_r(changePlan($service, $customerId, $subscriptionId));
...
*/
function changePlan($service, $customerId, $subscriptionId)
{
	try
	{
		...
		return $service->changePlan($customerId, $subscriptionId);
	}
	catch (Exception $ex)
	{
