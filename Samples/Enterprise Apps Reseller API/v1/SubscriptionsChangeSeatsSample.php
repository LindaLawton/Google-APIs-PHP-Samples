...
print_r(changeSeats($service, $customerId, $subscriptionId));
...
*/
function changeSeats($service, $customerId, $subscriptionId)
{
	try
	{
		...
		return $service->changeSeats($customerId, $subscriptionId);
	}
	catch (Exception $ex)
	{
