...
print_r(metricDescriptorsListExample($service, $project));
...
* @return ListMetricDescriptorsResponse</returns>
*/
function metricDescriptorsListExample($service, $project)
{
	try
	{
		...
		return $service->metricDescriptors->ListMetricDescriptors($project);
	}
	catch (Exception $ex)
	{
