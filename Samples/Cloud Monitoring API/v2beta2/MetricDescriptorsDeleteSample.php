...
print_r(metricDescriptorsDeleteExample($service, $project, $metric));
...
* @return DeleteMetricDescriptorResponse</returns>
*/
function metricDescriptorsDeleteExample($service, $project, $metric)
{
	try
	{
		...
		return $service->metricDescriptors->DeleteMetricDescriptors($project, $metric);
	}
	catch (Exception $ex)
	{
