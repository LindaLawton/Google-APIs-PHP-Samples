...
// Single Request.
$results = metricDescriptorsDeleteExample($service, $project, $metric, $optParams);
...
* @return DeleteMetricDescriptorResponse
*/
function metricDescriptorsDeleteExample($service, $project, $metric, $optParams)
{
	try
	{
		...
		return $service->metricDescriptors->DeleteMetricDescriptors($project, $metric, $optParams);
	}
	catch (Exception $e)
	{
