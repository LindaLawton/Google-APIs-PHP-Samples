...
print_r(metricDescriptorsCreateExample($service, $project));
...
* @return MetricDescriptor</returns>
*/
function metricDescriptorsCreateExample($service, $project)
{
	try
	{
		...
		return $service->metricDescriptors->CreateMetricDescriptors($project);
	}
	catch (Exception $ex)
	{
