...
// Single Request.
$results = metricDescriptorsCreateExample($service, $project, $optParams);
...
*/
function metricDescriptorsCreateExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->metricDescriptors->CreateMetricDescriptors($project, $optParams);
	}
	catch (Exception $e)
	{
