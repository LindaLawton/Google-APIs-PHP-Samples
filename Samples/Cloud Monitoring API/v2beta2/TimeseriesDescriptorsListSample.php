...
print_r(timeseriesDescriptorsListExample($service, $project, $metric, $youngest));
...
* @return ListTimeseriesDescriptorsResponse</returns>
*/
function timeseriesDescriptorsListExample($service, $project, $metric, $youngest)
{
	try
	{
		...
		return $service->timeseriesDescriptors->ListTimeseriesDescriptors($project, $metric, $youngest);
	}
	catch (Exception $ex)
	{
