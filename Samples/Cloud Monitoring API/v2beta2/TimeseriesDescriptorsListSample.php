...
* @return ListTimeseriesDescriptorsResponse
*/
function timeseriesDescriptorsListExample($service, $project, $metric, $youngest, $optParams)
{
	try
	{
		...
		return $service->timeseriesDescriptors->ListTimeseriesDescriptors($project, $metric, $youngest, $optParams);
	}
	catch (Exception $e)
	{
