...
print_r(timeseriesListExample($service, $project, $metric, $youngest));
...
* @return ListTimeseriesResponse</returns>
*/
function timeseriesListExample($service, $project, $metric, $youngest)
{
	try
	{
		...
		return $service->timeseries->ListTimeseries($project, $metric, $youngest);
	}
	catch (Exception $ex)
	{
