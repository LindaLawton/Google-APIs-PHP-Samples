...
// About 
// 
// Unofficial sample for the Cloudmonitoring v2beta2 API for PHP. 
 ...
 * Initializes an Cloudmonitoring.v2beta2 service object.
 * @param string API key
 * @return An authorized Cloudmonitoring.v2beta2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudmonitoring Sample");
		...
		// Create authenticated Cloudmonitoring service
		return new Google_Service_Cloudmonitoring($client);
	} catch (Exception $e) {
