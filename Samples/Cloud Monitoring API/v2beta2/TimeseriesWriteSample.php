...
print_r(timeseriesWriteExample($service, $project));
...
* @return WriteTimeseriesResponse</returns>
*/
function timeseriesWriteExample($service, $project)
{
	try
	{
		...
		return $service->timeseries->WriteTimeseries($project);
	}
	catch (Exception $ex)
	{
