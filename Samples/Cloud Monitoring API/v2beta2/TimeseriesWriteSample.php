...
$results = timeseriesWriteExample($service, $project, $optParams);
...
* @return WriteTimeseriesResponse
*/
function timeseriesWriteExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->timeseries->WriteTimeseries($project, $optParams);
	}
	catch (Exception $e)
	{
