...
// Single Request.
$results = functionsGetExample($service, $name, $optParams);
...
*/
function functionsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->functions->GetFunctions($name, $optParams);
	}
	catch (Exception $e)
	{
