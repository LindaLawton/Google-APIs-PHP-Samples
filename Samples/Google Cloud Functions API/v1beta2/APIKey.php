 ...
 * Initializes an Cloudfunctions.v1beta2 service object.
 * @param string API key
 * @return An authorized Cloudfunctions.v1beta2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudfunctions Sample");
		...
		// Create authenticated Cloudfunctions service
		return new Google_Service_Cloudfunctions($client);
	} catch (Exception $e) {
