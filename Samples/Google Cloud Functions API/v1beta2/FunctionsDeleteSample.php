...
$results = functionsDeleteExample($service, $name, $optParams);
...
* @return Operation
*/
function functionsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->functions->DeleteFunctions($name, $optParams);
	}
	catch (Exception $e)
	{
