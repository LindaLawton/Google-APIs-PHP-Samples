...
// Single Request.
$results = functionsCreateExample($service, $location, $optParams);
...
* @return Operation
*/
function functionsCreateExample($service, $location, $optParams)
{
	try
	{
		...
		return $service->functions->CreateFunctions($location, $optParams);
	}
	catch (Exception $e)
	{
