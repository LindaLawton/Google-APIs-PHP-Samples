...
print_r(functionsCallExample($service, $name));
...
* @return CallFunctionResponse</returns>
*/
function functionsCallExample($service, $name)
{
	try
	{
		...
		return $service->functions->CallFunctions($name);
	}
	catch (Exception $ex)
	{
