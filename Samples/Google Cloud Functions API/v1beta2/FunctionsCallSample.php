...
$results = functionsCallExample($service, $name, $optParams);
...
*/
function functionsCallExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->functions->CallFunctions($name, $optParams);
	}
	catch (Exception $e)
	{
