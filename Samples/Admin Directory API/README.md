...
# Unoffical Admin Directory API Samples for PHP
...
These samples show how to access the [Admin Directory API](https://developers.google.com/admin-sdk/directory/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
