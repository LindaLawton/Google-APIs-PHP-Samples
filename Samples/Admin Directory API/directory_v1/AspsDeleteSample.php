...
$results = aspsDeleteExample($service, $userKey, $codeId, $optParams);
...
*/
function aspsDeleteExample($service, $userKey, $codeId, $optParams)
{
	try
	{
		...
		if (codeId == null)
			throw new Exception("codeId is required.");
		if (userKey == null)
			throw new Exception("userKey is required.");
		// Make the request and return the results.
		return $service->asps->DeleteAsps($userKey, $codeId, $optParams);
	}
	catch (Exception $e)
	{
