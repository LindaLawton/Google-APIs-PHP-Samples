...
print_r(schemasDeleteExample($service, $customerId, $schemaKey));
...
*/
function schemasDeleteExample($service, $customerId, $schemaKey)
{
	try
	{
		...
		return $service->schemas->DeleteSchemas($customerId, $schemaKey);
	}
	catch (Exception $ex)
	{
