...
$results = schemasDeleteExample($service, $customerId, $schemaKey, $optParams);
...
*/
function schemasDeleteExample($service, $customerId, $schemaKey, $optParams)
{
	try
	{
		...
		return $service->schemas->DeleteSchemas($customerId, $schemaKey, $optParams);
	}
	catch (Exception $e)
	{
