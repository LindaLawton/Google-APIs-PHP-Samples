...
print_r(notificationsDeleteExample($service, $customer, $notificationId));
...
*/
function notificationsDeleteExample($service, $customer, $notificationId)
{
	try
	{
		...
		return $service->notifications->DeleteNotifications($customer, $notificationId);
	}
	catch (Exception $ex)
	{
