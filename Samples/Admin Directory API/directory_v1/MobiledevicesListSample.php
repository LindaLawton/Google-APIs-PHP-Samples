...
print_r(mobiledevicesListExample($service, $customerId));

/**
* Retrieve all Mobile Devices of a customer (paginated)
* @service Authenticated Directory service.
* @customerId Immutable ID of the G Suite account
* @return MobileDevices</returns>
*/
function mobiledevicesListExample($service, $customerId)
{
	try
	{
		...
		return $service->mobiledevices->ListMobiledevices($customerId);
	}
	catch (Exception $ex)
	{
