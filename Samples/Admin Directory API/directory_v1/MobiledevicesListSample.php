...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'query' => '[YourValue]',  // Search string in the format given at http://support.google.com/a/bin/answer.py?hl=en&answer=1408863#search
            
  //'sortOrder' => '[YourValue]',  // Whether to return results in ascending or descending order. Only of use when orderBy is also used
  'fields' => '*'
);
// Single Request.
$results = mobiledevicesListExample($service, $customerId, $optParams);
...
*/
function mobiledevicesListExample($service, $customerId, $optParams)
{
	try
	{
		...
		return $service->mobiledevices->ListMobiledevices($customerId, $optParams);
	}
	catch (Exception $e)
	{
