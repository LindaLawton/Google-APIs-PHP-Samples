...
$results = aliasesDeleteExample($service, $userKey, $alias, $optParams);
...
*/
function aliasesDeleteExample($service, $userKey, $alias, $optParams)
{
	try
	{
		...
		return $service->aliases->DeleteAliases($userKey, $alias, $optParams);
	}
	catch (Exception $e)
	{
