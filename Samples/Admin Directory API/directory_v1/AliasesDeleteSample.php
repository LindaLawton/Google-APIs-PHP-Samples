...
print_r(aliasesDeleteExample($service, $userKey, $alias));
...
*/
function aliasesDeleteExample($service, $userKey, $alias)
{
	try
	{
		...
		return $service->aliases->DeleteAliases($userKey, $alias);
	}
	catch (Exception $ex)
	{
