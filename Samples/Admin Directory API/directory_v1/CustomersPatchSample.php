...
// Single Request.
$results = customersPatchExample($service, $customerKey, $optParams);
...
* @return Customer
*/
function customersPatchExample($service, $customerKey, $optParams)
{
	try
	{
		...
		return $service->customers->PatchCustomers($customerKey, $optParams);
	}
	catch (Exception $e)
	{
