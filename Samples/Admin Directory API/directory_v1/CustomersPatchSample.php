...
print_r(customersPatchExample($service, $customerKey));
...
*/
function customersPatchExample($service, $customerKey)
{
	try
	{
		...
		return $service->customers->PatchCustomers($customerKey);
	}
	catch (Exception $ex)
	{
