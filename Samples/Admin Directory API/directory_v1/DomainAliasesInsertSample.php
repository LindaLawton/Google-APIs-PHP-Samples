...
// Single Request.
$results = domainAliasesInsertExample($service, $customer, $optParams);
...
* @return DomainAlias
*/
function domainAliasesInsertExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->domainAliases->InsertDomainAliases($customer, $optParams);
	}
	catch (Exception $e)
	{
