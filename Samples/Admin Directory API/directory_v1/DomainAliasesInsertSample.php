...
print_r(domainAliasesInsertExample($service, $customer));
...
*/
function domainAliasesInsertExample($service, $customer)
{
	try
	{
		...
		return $service->domainAliases->InsertDomainAliases($customer);
	}
	catch (Exception $ex)
	{
