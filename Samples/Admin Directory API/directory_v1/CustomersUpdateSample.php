...
// Single Request.
$results = customersUpdateExample($service, $customerKey, $optParams);
...
* @return Customer
*/
function customersUpdateExample($service, $customerKey, $optParams)
{
	try
	{
		...
		if (customerKey == null)
			throw new Exception("customerKey is required.");
		// Make the request and return the results.
		return $service->customers->UpdateCustomers($customerKey, $optParams);
	}
	catch (Exception $e)
	{
