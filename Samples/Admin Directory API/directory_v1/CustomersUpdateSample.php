...
print_r(customersUpdateExample($service, $customerKey));
...
*/
function customersUpdateExample($service, $customerKey)
{
	try
	{
		...
		return $service->customers->UpdateCustomers($customerKey);
	}
	catch (Exception $ex)
	{
