...
print_r(notificationsPatchExample($service, $customer, $notificationId));
...
*/
function notificationsPatchExample($service, $customer, $notificationId)
{
	try
	{
		...
		return $service->notifications->PatchNotifications($customer, $notificationId);
	}
	catch (Exception $ex)
	{
