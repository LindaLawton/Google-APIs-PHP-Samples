...
// Single Request.
$results = notificationsPatchExample($service, $customer, $notificationId, $optParams);
...
* @return Notification
*/
function notificationsPatchExample($service, $customer, $notificationId, $optParams)
{
	try
	{
		...
		return $service->notifications->PatchNotifications($customer, $notificationId, $optParams);
	}
	catch (Exception $e)
	{
