...
$results = membersInsertExample($service, $groupKey, $optParams);
...
* @return Member
*/
function membersInsertExample($service, $groupKey, $optParams)
{
	try
	{
		...
		return $service->members->InsertMembers($groupKey, $optParams);
	}
	catch (Exception $e)
	{
