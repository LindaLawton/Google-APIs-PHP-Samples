...
// Single Request.
$results = aliasesInsertExample($service, $userKey, $optParams);
...
* @return Alias
*/
function aliasesInsertExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->aliases->InsertAliases($userKey, $optParams);
	}
	catch (Exception $e)
	{
