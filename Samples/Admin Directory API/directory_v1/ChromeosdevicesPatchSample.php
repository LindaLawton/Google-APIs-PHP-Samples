...
// Single Request.
$results = chromeosdevicesPatchExample($service, $customerId, $deviceId, $optParams);
...
*/
function chromeosdevicesPatchExample($service, $customerId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->chromeosdevices->PatchChromeosdevices($customerId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
