...
print_r(chromeosdevicesPatchExample($service, $customerId, $deviceId));
...
*/
function chromeosdevicesPatchExample($service, $customerId, $deviceId)
{
	try
	{
		...
		return $service->chromeosdevices->PatchChromeosdevices($customerId, $deviceId);
	}
	catch (Exception $ex)
	{
