...
$results = mobiledevicesDeleteExample($service, $customerId, $resourceId, $optParams);
...
*/
function mobiledevicesDeleteExample($service, $customerId, $resourceId, $optParams)
{
	try
	{
		...
		return $service->mobiledevices->DeleteMobiledevices($customerId, $resourceId, $optParams);
	}
	catch (Exception $e)
	{
