...
print_r(mobiledevicesDeleteExample($service, $customerId, $resourceId));
...
*/
function mobiledevicesDeleteExample($service, $customerId, $resourceId)
{
	try
	{
		...
		return $service->mobiledevices->DeleteMobiledevices($customerId, $resourceId);
	}
	catch (Exception $ex)
	{
