...
print_r(domainsGetExample($service, $customer, $domainName));
...
* @return Domains</returns>
*/
function domainsGetExample($service, $customer, $domainName)
{
	try
	{
		...
		return $service->domains->GetDomains($customer, $domainName);
	}
	catch (Exception $ex)
	{
