...
// Single Request.
$results = domainsGetExample($service, $customer, $domainName, $optParams);
...
* @return Domains
*/
function domainsGetExample($service, $customer, $domainName, $optParams)
{
	try
	{
		...
		return $service->domains->GetDomains($customer, $domainName, $optParams);
	}
	catch (Exception $e)
	{
