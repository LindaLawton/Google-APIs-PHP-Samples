...
// Single Request.
$results = aspsGetExample($service, $userKey, $codeId, $optParams);
...
* @return Asp
*/
function aspsGetExample($service, $userKey, $codeId, $optParams)
{
	try
	{
		...
		return $service->asps->GetAsps($userKey, $codeId, $optParams);
	}
	catch (Exception $e)
	{
