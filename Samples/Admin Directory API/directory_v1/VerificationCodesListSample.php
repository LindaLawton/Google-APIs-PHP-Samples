...
print_r(verificationCodesListExample($service, $userKey));
...
* @return VerificationCodes</returns>
*/
function verificationCodesListExample($service, $userKey)
{
	try
	{
		...
		return $service->verificationCodes->ListVerificationCodes($userKey);
	}
	catch (Exception $ex)
	{
