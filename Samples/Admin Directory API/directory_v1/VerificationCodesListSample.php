...
// Single Request.
$results = verificationCodesListExample($service, $userKey, $optParams);
...
*/
function verificationCodesListExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->verificationCodes->ListVerificationCodes($userKey, $optParams);
	}
	catch (Exception $e)
	{
