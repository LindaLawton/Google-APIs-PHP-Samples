...
print_r(update($service, $customer, $calendarResourceId));
...
*/
function update($service, $customer, $calendarResourceId)
{
	try
	{
		...
		return $service->update($customer, $calendarResourceId);
	}
	catch (Exception $ex)
	{
