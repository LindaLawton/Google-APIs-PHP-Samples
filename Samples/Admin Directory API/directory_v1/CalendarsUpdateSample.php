...
// Single Request.
$results = calendarsUpdateExample($service, $customer, $calendarResourceId, $optParams);
...
*/
function calendarsUpdateExample($service, $customer, $calendarResourceId, $optParams)
{
	try
	{
		...
		return $service->calendars->UpdateCalendars($customer, $calendarResourceId, $optParams);
	}
	catch (Exception $e)
	{
