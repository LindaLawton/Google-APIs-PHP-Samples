...
print_r(calendarsUpdateExample($service, $customer, $calendarResourceId));
...
* @return CalendarResource</returns>
*/
function calendarsUpdateExample($service, $customer, $calendarResourceId)
{
	try
	{
		...
		return $service->calendars->UpdateCalendars($customer, $calendarResourceId);
	}
	catch (Exception $ex)
	{
