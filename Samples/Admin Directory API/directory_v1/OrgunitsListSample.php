...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'orgUnitPath' => '[YourValue]',  // the URL-encoded organization unit's path or its Id
            
  //'type' => '[YourValue]',  // Whether to return all sub-organizations or just immediate children
  'fields' => '*'
);
// Single Request.
$results = orgunitsListExample($service, $customerId, $optParams);
...
* @return OrgUnits
*/
function orgunitsListExample($service, $customerId, $optParams)
{
	try
	{
		...
		return $service->orgunits->ListOrgunits($customerId, $optParams);
	}
	catch (Exception $e)
	{
