...
print_r(orgunitsListExample($service, $customerId));

/**
* Retrieve all Organization Units
* @service Authenticated Directory service.
* @customerId Immutable ID of the G Suite account
* @return OrgUnits</returns>
*/
function orgunitsListExample($service, $customerId)
{
	try
	{
		...
		return $service->orgunits->ListOrgunits($customerId);
	}
	catch (Exception $ex)
	{
