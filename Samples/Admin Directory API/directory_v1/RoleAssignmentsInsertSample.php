...
// Single Request.
$results = roleAssignmentsInsertExample($service, $customer, $optParams);
...
*/
function roleAssignmentsInsertExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->roleAssignments->InsertRoleAssignments($customer, $optParams);
	}
	catch (Exception $e)
	{
