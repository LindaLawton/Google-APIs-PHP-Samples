...
print_r(roleAssignmentsInsertExample($service, $customer));
...
*/
function roleAssignmentsInsertExample($service, $customer)
{
	try
	{
		...
		return $service->roleAssignments->InsertRoleAssignments($customer);
	}
	catch (Exception $ex)
	{
