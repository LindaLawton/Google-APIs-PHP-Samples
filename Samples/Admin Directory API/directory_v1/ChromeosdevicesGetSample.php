...
// Single Request.
$results = chromeosdevicesGetExample($service, $customerId, $deviceId, $optParams);
...
*/
function chromeosdevicesGetExample($service, $customerId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->chromeosdevices->GetChromeosdevices($customerId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
