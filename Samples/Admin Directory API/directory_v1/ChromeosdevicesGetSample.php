...
print_r(chromeosdevicesGetExample($service, $customerId, $deviceId));
...
*/
function chromeosdevicesGetExample($service, $customerId, $deviceId)
{
	try
	{
		...
		return $service->chromeosdevices->GetChromeosdevices($customerId, $deviceId);
	}
	catch (Exception $ex)
	{
