...
print_r(schemasPatchExample($service, $customerId, $schemaKey));
...
*/
function schemasPatchExample($service, $customerId, $schemaKey)
{
	try
	{
		...
		return $service->schemas->PatchSchemas($customerId, $schemaKey);
	}
	catch (Exception $ex)
	{
