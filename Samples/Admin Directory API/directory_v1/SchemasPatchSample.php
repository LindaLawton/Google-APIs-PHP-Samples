...
$results = schemasPatchExample($service, $customerId, $schemaKey, $optParams);
...
* @return Schema
*/
function schemasPatchExample($service, $customerId, $schemaKey, $optParams)
{
	try
	{
		...
		return $service->schemas->PatchSchemas($customerId, $schemaKey, $optParams);
	}
	catch (Exception $e)
	{
