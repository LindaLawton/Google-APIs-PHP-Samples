...
// Single Request.
$results = notificationsUpdateExample($service, $customer, $notificationId, $optParams);
...
* @return Notification
*/
function notificationsUpdateExample($service, $customer, $notificationId, $optParams)
{
	try
	{
		...
		return $service->notifications->UpdateNotifications($customer, $notificationId, $optParams);
	}
	catch (Exception $e)
	{
