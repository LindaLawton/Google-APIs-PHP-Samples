...
print_r(notificationsUpdateExample($service, $customer, $notificationId));
...
* @return Notification</returns>
*/
function notificationsUpdateExample($service, $customer, $notificationId)
{
	try
	{
		...
		return $service->notifications->UpdateNotifications($customer, $notificationId);
	}
	catch (Exception $ex)
	{
