...
// Single Request.
$results = mobiledevicesGetExample($service, $customerId, $resourceId, $optParams);
...
* @return MobileDevice
*/
function mobiledevicesGetExample($service, $customerId, $resourceId, $optParams)
{
	try
	{
		...
		return $service->mobiledevices->GetMobiledevices($customerId, $resourceId, $optParams);
	}
	catch (Exception $e)
	{
