...
print_r(mobiledevicesGetExample($service, $customerId, $resourceId));
...
* @return MobileDevice</returns>
*/
function mobiledevicesGetExample($service, $customerId, $resourceId)
{
	try
	{
		...
		return $service->mobiledevices->GetMobiledevices($customerId, $resourceId);
	}
	catch (Exception $ex)
	{
