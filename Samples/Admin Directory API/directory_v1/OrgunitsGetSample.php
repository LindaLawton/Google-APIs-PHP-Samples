...
// Single Request.
$results = orgunitsGetExample($service, $customerId, $orgUnitPath, $optParams);
...
* @return OrgUnit
*/
function orgunitsGetExample($service, $customerId, $orgUnitPath, $optParams)
{
	try
	{
		...
		return $service->orgunits->GetOrgunits($customerId, $orgUnitPath, $optParams);
	}
	catch (Exception $e)
	{
