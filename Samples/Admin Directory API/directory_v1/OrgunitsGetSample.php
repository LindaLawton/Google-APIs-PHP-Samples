...
print_r(orgunitsGetExample($service, $customerId, $orgUnitPath));
...
*/
function orgunitsGetExample($service, $customerId, $orgUnitPath)
{
	try
	{
		...
		return $service->orgunits->GetOrgunits($customerId, $orgUnitPath);
	}
	catch (Exception $ex)
	{
