...
// Single Request.
$results = tokensListExample($service, $userKey, $optParams);
...
* @return Tokens
*/
function tokensListExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->tokens->ListTokens($userKey, $optParams);
	}
	catch (Exception $e)
	{
