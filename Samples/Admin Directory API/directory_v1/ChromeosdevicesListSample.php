...
print_r(chromeosdevicesListExample($service, $customerId));

/**
* Retrieve all Chrome OS Devices of a customer (paginated)
* @service Authenticated Directory service.
* @customerId Immutable ID of the G Suite account
* @return ChromeOsDevices</returns>
*/
function chromeosdevicesListExample($service, $customerId)
{
	try
	{
		...
		return $service->chromeosdevices->ListChromeosdevices($customerId);
	}
	catch (Exception $ex)
	{
