...
// Single Request.
$results = membersGetExample($service, $groupKey, $memberKey, $optParams);
...
* @return Member
*/
function membersGetExample($service, $groupKey, $memberKey, $optParams)
{
	try
	{
		...
		return $service->members->GetMembers($groupKey, $memberKey, $optParams);
	}
	catch (Exception $e)
	{
