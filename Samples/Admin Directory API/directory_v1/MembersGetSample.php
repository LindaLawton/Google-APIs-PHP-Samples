...
print_r(membersGetExample($service, $groupKey, $memberKey));
...
*/
function membersGetExample($service, $groupKey, $memberKey)
{
	try
	{
		...
		return $service->members->GetMembers($groupKey, $memberKey);
	}
	catch (Exception $ex)
	{
