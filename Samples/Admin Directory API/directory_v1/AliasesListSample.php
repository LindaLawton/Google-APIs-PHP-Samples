...
// Single Request.
$results = aliasesListExample($service, $userKey, $optParams);
...
* @return Aliases
*/
function aliasesListExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->aliases->ListAliases($userKey, $optParams);
	}
	catch (Exception $e)
	{
