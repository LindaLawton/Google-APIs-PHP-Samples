...
$results = photosGetExample($service, $userKey, $optParams);
...
* @return UserPhoto
*/
function photosGetExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->photos->GetPhotos($userKey, $optParams);
	}
	catch (Exception $e)
	{
