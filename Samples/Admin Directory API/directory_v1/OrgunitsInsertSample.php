...
// Single Request.
$results = orgunitsInsertExample($service, $customerId, $optParams);
...
* @return OrgUnit
*/
function orgunitsInsertExample($service, $customerId, $optParams)
{
	try
	{
		...
		return $service->orgunits->InsertOrgunits($customerId, $optParams);
	}
	catch (Exception $e)
	{
