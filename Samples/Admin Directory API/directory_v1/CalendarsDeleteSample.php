...
print_r(calendarsDeleteExample($service, $customer, $calendarResourceId));
...
*/
function calendarsDeleteExample($service, $customer, $calendarResourceId)
{
	try
	{
		...
		return $service->calendars->DeleteCalendars($customer, $calendarResourceId);
	}
	catch (Exception $ex)
	{
