...
print_r(delete($service, $customer, $calendarResourceId));
...
*/
function delete($service, $customer, $calendarResourceId)
{
	try
	{
		...
		return $service->delete($customer, $calendarResourceId);
	}
	catch (Exception $ex)
	{
