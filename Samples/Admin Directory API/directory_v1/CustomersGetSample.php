...
// Single Request.
$results = customersGetExample($service, $customerKey, $optParams);
...
* @return Customer
*/
function customersGetExample($service, $customerKey, $optParams)
{
	try
	{
		...
		return $service->customers->GetCustomers($customerKey, $optParams);
	}
	catch (Exception $e)
	{
