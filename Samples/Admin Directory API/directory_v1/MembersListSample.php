...
do {
	...
	$results = filesListExample($service, $groupKey, $optParams);	
...
* @return Members
*/
function membersListExample($service, $groupKey, $optParams)
{
	try
	{
		...
		return $service->members->ListMembers($groupKey, $optParams);
	}
	catch (Exception $e)
	{
