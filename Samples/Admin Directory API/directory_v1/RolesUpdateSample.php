...
// Single Request.
$results = rolesUpdateExample($service, $customer, $roleId, $optParams);
...
* @return Role
*/
function rolesUpdateExample($service, $customer, $roleId, $optParams)
{
	try
	{
		...
		return $service->roles->UpdateRoles($customer, $roleId, $optParams);
	}
	catch (Exception $e)
	{
