...
print_r(tokensDeleteExample($service, $userKey, $clientId));
...
*/
function tokensDeleteExample($service, $userKey, $clientId)
{
	try
	{
		...
		return $service->tokens->DeleteTokens($userKey, $clientId);
	}
	catch (Exception $ex)
	{
