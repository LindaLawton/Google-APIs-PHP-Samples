...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'event' => '[YourValue]',  // Event on which subscription is intended (if subscribing)
  'fields' => '*'
);
// Single Request.
$results = aliasesWatchExample($service, $userKey, $optParams);
...
* @return Channel
*/
function aliasesWatchExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->aliases->WatchAliases($userKey, $optParams);
	}
	catch (Exception $e)
	{
