...
$results = roleAssignmentsGetExample($service, $customer, $roleAssignmentId, $optParams);
...
*/
function roleAssignmentsGetExample($service, $customer, $roleAssignmentId, $optParams)
{
	try
	{
		...
		return $service->roleAssignments->GetRoleAssignments($customer, $roleAssignmentId, $optParams);
	}
	catch (Exception $e)
	{
