...
print_r(roleAssignmentsGetExample($service, $customer, $roleAssignmentId));
...
* @return RoleAssignment</returns>
*/
function roleAssignmentsGetExample($service, $customer, $roleAssignmentId)
{
	try
	{
		...
		return $service->roleAssignments->GetRoleAssignments($customer, $roleAssignmentId);
	}
	catch (Exception $ex)
	{
