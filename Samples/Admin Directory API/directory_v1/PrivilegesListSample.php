...
print_r(privilegesListExample($service, $customer));

/**
* Retrieves a paginated list of all privileges for a customer.
* @service Authenticated Directory service.
* @customer Immutable ID of the G Suite account.
* @return Privileges</returns>
*/
function privilegesListExample($service, $customer)
{
	try
	{
		...
		return $service->privileges->ListPrivileges($customer);
	}
	catch (Exception $ex)
	{
