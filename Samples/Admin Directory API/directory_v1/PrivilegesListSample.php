...
// Single Request.
$results = privilegesListExample($service, $customer, $optParams);
...
* @return Privileges
*/
function privilegesListExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->privileges->ListPrivileges($customer, $optParams);
	}
	catch (Exception $e)
	{
