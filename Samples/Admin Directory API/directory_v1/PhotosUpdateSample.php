...
print_r(photosUpdateExample($service, $userKey));

/**
* Add a photo for the user
* @service Authenticated Directory service.
* @userKey Email or immutable Id of the user
* @return UserPhoto</returns>
*/
function photosUpdateExample($service, $userKey)
{
	try
	{
		...
		return $service->photos->UpdatePhotos($userKey);
	}
	catch (Exception $ex)
	{
