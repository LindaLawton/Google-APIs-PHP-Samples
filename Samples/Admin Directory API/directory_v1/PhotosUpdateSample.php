...
// Single Request.
$results = photosUpdateExample($service, $userKey, $optParams);
...
* @return UserPhoto
*/
function photosUpdateExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->photos->UpdatePhotos($userKey, $optParams);
	}
	catch (Exception $e)
	{
