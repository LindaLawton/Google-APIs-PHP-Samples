...
print_r(schemasGetExample($service, $customerId, $schemaKey));
...
*/
function schemasGetExample($service, $customerId, $schemaKey)
{
	try
	{
		...
		return $service->schemas->GetSchemas($customerId, $schemaKey);
	}
	catch (Exception $ex)
	{
