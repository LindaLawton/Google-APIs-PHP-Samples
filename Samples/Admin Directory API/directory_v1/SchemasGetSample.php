...
$results = schemasGetExample($service, $customerId, $schemaKey, $optParams);
...
* @return Schema
*/
function schemasGetExample($service, $customerId, $schemaKey, $optParams)
{
	try
	{
		...
		return $service->schemas->GetSchemas($customerId, $schemaKey, $optParams);
	}
	catch (Exception $e)
	{
