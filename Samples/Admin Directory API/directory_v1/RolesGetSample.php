...
// Single Request.
$results = rolesGetExample($service, $customer, $roleId, $optParams);
...
* @return Role
*/
function rolesGetExample($service, $customer, $roleId, $optParams)
{
	try
	{
		...
		return $service->roles->GetRoles($customer, $roleId, $optParams);
	}
	catch (Exception $e)
	{
