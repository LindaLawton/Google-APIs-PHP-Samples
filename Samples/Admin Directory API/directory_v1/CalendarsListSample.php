...
print_r(calendarsListExample($service, $customer));
...
* @return CalendarResources</returns>
*/
function calendarsListExample($service, $customer)
{
	try
	{
		...
		return $service->calendars->ListCalendars($customer);
	}
	catch (Exception $ex)
	{
