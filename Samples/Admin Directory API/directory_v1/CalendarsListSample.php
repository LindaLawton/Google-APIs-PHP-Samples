...
// Single Request.
$results = calendarsListExample($service, $customer, $optParams);
...
*/
function calendarsListExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->calendars->ListCalendars($customer, $optParams);
	}
	catch (Exception $e)
	{
