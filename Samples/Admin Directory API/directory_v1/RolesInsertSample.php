...
// Single Request.
$results = rolesInsertExample($service, $customer, $optParams);
...
* @return Role
*/
function rolesInsertExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->roles->InsertRoles($customer, $optParams);
	}
	catch (Exception $e)
	{
