...
print_r(schemasListExample($service, $customerId));

/**
* Retrieve all schemas for a customer
* @service Authenticated Directory service.
* @customerId Immutable ID of the G Suite account
* @return Schemas</returns>
*/
function schemasListExample($service, $customerId)
{
	try
	{
		...
		return $service->schemas->ListSchemas($customerId);
	}
	catch (Exception $ex)
	{
