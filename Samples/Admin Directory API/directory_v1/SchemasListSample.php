...
// Single Request.
$results = schemasListExample($service, $customerId, $optParams);
...
* @return Schemas
*/
function schemasListExample($service, $customerId, $optParams)
{
	try
	{
		...
		return $service->schemas->ListSchemas($customerId, $optParams);
	}
	catch (Exception $e)
	{
