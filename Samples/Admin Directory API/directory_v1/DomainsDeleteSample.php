...
print_r(domainsDeleteExample($service, $customer, $domainName));
...
*/
function domainsDeleteExample($service, $customer, $domainName)
{
	try
	{
		...
		return $service->domains->DeleteDomains($customer, $domainName);
	}
	catch (Exception $ex)
	{
