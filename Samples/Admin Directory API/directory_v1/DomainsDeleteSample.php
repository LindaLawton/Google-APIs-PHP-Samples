...
$results = domainsDeleteExample($service, $customer, $domainName, $optParams);
...
*/
function domainsDeleteExample($service, $customer, $domainName, $optParams)
{
	try
	{
		...
		return $service->domains->DeleteDomains($customer, $domainName, $optParams);
	}
	catch (Exception $e)
	{
