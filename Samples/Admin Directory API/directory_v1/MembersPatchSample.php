...
// Single Request.
$results = membersPatchExample($service, $groupKey, $memberKey, $optParams);
...
* @return Member
*/
function membersPatchExample($service, $groupKey, $memberKey, $optParams)
{
	try
	{
		...
		return $service->members->PatchMembers($groupKey, $memberKey, $optParams);
	}
	catch (Exception $e)
	{
