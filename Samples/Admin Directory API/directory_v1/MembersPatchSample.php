...
print_r(membersPatchExample($service, $groupKey, $memberKey));
...
*/
function membersPatchExample($service, $groupKey, $memberKey)
{
	try
	{
		...
		return $service->members->PatchMembers($groupKey, $memberKey);
	}
	catch (Exception $ex)
	{
