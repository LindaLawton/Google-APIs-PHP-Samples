...
$results = domainAliasesDeleteExample($service, $customer, $domainAliasName, $optParams);
...
*/
function domainAliasesDeleteExample($service, $customer, $domainAliasName, $optParams)
{
	try
	{
		...
		if (domainAliasName == null)
			throw new Exception("domainAliasName is required.");
		// Make the request and return the results.
		return $service->domainAliases->DeleteDomainAliases($customer, $domainAliasName, $optParams);
	}
	catch (Exception $e)
	{
