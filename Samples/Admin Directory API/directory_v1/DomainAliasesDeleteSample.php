...
print_r(domainAliasesDeleteExample($service, $customer, $domainAliasName));
...
*/
function domainAliasesDeleteExample($service, $customer, $domainAliasName)
{
	try
	{
		...
		return $service->domainAliases->DeleteDomainAliases($customer, $domainAliasName);
	}
	catch (Exception $ex)
	{
