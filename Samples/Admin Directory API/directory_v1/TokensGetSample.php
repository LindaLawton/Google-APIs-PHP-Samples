...
// Single Request.
$results = tokensGetExample($service, $userKey, $clientId, $optParams);
...
* @return Token
*/
function tokensGetExample($service, $userKey, $clientId, $optParams)
{
	try
	{
		...
		return $service->tokens->GetTokens($userKey, $clientId, $optParams);
	}
	catch (Exception $e)
	{
