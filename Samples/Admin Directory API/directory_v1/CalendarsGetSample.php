...
print_r(calendarsGetExample($service, $customer, $calendarResourceId));
...
*/
function calendarsGetExample($service, $customer, $calendarResourceId)
{
	try
	{
		...
		return $service->calendars->GetCalendars($customer, $calendarResourceId);
	}
	catch (Exception $ex)
	{
