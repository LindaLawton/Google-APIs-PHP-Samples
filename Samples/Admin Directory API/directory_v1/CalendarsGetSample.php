...
// Single Request.
$results = calendarsGetExample($service, $customer, $calendarResourceId, $optParams);
...
*/
function calendarsGetExample($service, $customer, $calendarResourceId, $optParams)
{
	try
	{
		...
		return $service->calendars->GetCalendars($customer, $calendarResourceId, $optParams);
	}
	catch (Exception $e)
	{
