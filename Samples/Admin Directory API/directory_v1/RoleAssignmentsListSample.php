...
print_r(roleAssignmentsListExample($service, $customer));

/**
* Retrieves a paginated list of all roleAssignments.
* @service Authenticated Directory service.
* @customer Immutable ID of the G Suite account.
* @return RoleAssignments</returns>
*/
function roleAssignmentsListExample($service, $customer)
{
	try
	{
		...
		return $service->roleAssignments->ListRoleAssignments($customer);
	}
	catch (Exception $ex)
	{
