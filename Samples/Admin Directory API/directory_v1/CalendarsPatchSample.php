...
print_r(calendarsPatchExample($service, $customer, $calendarResourceId));
...
*/
function calendarsPatchExample($service, $customer, $calendarResourceId)
{
	try
	{
		...
		return $service->calendars->PatchCalendars($customer, $calendarResourceId);
	}
	catch (Exception $ex)
	{
