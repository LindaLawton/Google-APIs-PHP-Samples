...
// Single Request.
$results = calendarsPatchExample($service, $customer, $calendarResourceId, $optParams);
...
*/
function calendarsPatchExample($service, $customer, $calendarResourceId, $optParams)
{
	try
	{
		...
		return $service->calendars->PatchCalendars($customer, $calendarResourceId, $optParams);
	}
	catch (Exception $e)
	{
