...
print_r(notificationsGetExample($service, $customer, $notificationId));
...
*/
function notificationsGetExample($service, $customer, $notificationId)
{
	try
	{
		...
		return $service->notifications->GetNotifications($customer, $notificationId);
	}
	catch (Exception $ex)
	{
