...
$results = notificationsGetExample($service, $customer, $notificationId, $optParams);
...
* @return Notification
*/
function notificationsGetExample($service, $customer, $notificationId, $optParams)
{
	try
	{
		...
		return $service->notifications->GetNotifications($customer, $notificationId, $optParams);
	}
	catch (Exception $e)
	{
