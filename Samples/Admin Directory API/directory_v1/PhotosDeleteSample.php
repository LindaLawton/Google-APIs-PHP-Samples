...
$results = photosDeleteExample($service, $userKey, $optParams);
...
*/
function photosDeleteExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->photos->DeletePhotos($userKey, $optParams);
	}
	catch (Exception $e)
	{
