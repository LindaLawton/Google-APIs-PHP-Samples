...
print_r(domainAliasesGetExample($service, $customer, $domainAliasName));
...
* @return DomainAlias</returns>
*/
function domainAliasesGetExample($service, $customer, $domainAliasName)
{
	try
	{
		...
		return $service->domainAliases->GetDomainAliases($customer, $domainAliasName);
	}
	catch (Exception $ex)
	{
