...
// Single Request.
$results = domainAliasesGetExample($service, $customer, $domainAliasName, $optParams);
...
* @return DomainAlias
*/
function domainAliasesGetExample($service, $customer, $domainAliasName, $optParams)
{
	try
	{
		...
		return $service->domainAliases->GetDomainAliases($customer, $domainAliasName, $optParams);
	}
	catch (Exception $e)
	{
