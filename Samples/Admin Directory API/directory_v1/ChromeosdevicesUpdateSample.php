...
print_r(chromeosdevicesUpdateExample($service, $customerId, $deviceId));
...
* @return ChromeOsDevice</returns>
*/
function chromeosdevicesUpdateExample($service, $customerId, $deviceId)
{
	try
	{
		...
		return $service->chromeosdevices->UpdateChromeosdevices($customerId, $deviceId);
	}
	catch (Exception $ex)
	{
