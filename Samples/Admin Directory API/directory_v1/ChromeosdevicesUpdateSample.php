...
$results = chromeosdevicesUpdateExample($service, $customerId, $deviceId, $optParams);
...
*/
function chromeosdevicesUpdateExample($service, $customerId, $deviceId, $optParams)
{
	try
	{
		...
		return $service->chromeosdevices->UpdateChromeosdevices($customerId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
