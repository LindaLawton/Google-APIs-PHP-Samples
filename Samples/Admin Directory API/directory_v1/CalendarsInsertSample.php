...
// Single Request.
$results = calendarsInsertExample($service, $customer, $optParams);
...
*/
function calendarsInsertExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->calendars->InsertCalendars($customer, $optParams);
	}
	catch (Exception $e)
	{
