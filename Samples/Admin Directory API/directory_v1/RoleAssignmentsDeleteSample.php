...
print_r(roleAssignmentsDeleteExample($service, $customer, $roleAssignmentId));
...
*/
function roleAssignmentsDeleteExample($service, $customer, $roleAssignmentId)
{
	try
	{
		...
		return $service->roleAssignments->DeleteRoleAssignments($customer, $roleAssignmentId);
	}
	catch (Exception $ex)
	{
