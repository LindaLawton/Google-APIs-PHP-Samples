...
$results = roleAssignmentsDeleteExample($service, $customer, $roleAssignmentId, $optParams);
...
*/
function roleAssignmentsDeleteExample($service, $customer, $roleAssignmentId, $optParams)
{
	try
	{
		...
		if (roleAssignmentId == null)
			throw new Exception("roleAssignmentId is required.");
		// Make the request and return the results.
		return $service->roleAssignments->DeleteRoleAssignments($customer, $roleAssignmentId, $optParams);
	}
	catch (Exception $e)
	{
