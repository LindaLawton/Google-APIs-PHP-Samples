...
print_r(notificationsListExample($service, $customer));

/**
* Retrieves a list of notifications.
* @service Authenticated Directory service.
* @customer The unique ID for the customer's G Suite account.
* @return Notifications</returns>
*/
function notificationsListExample($service, $customer)
{
	try
	{
		...
		return $service->notifications->ListNotifications($customer);
	}
	catch (Exception $ex)
	{
