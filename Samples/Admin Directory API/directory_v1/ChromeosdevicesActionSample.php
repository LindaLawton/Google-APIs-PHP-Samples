...
print_r(chromeosdevicesActionExample($service, $customerId, $resourceId));
...
*/
function chromeosdevicesActionExample($service, $customerId, $resourceId)
{
	try
	{
		...
		return $service->chromeosdevices->ActionChromeosdevices($customerId, $resourceId);
	}
	catch (Exception $ex)
	{
