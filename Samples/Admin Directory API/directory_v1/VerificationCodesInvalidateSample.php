...
print_r(verificationCodesInvalidateExample($service, $userKey));
...
*/
function verificationCodesInvalidateExample($service, $userKey)
{
	try
	{
		...
		return $service->verificationCodes->InvalidateVerificationCodes($userKey);
	}
	catch (Exception $ex)
	{
