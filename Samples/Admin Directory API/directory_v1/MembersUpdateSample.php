...
print_r(membersUpdateExample($service, $groupKey, $memberKey));
...
*/
function membersUpdateExample($service, $groupKey, $memberKey)
{
	try
	{
		...
		return $service->members->UpdateMembers($groupKey, $memberKey);
	}
	catch (Exception $ex)
	{
