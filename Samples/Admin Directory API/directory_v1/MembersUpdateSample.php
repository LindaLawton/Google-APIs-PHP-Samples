...
// Single Request.
$results = membersUpdateExample($service, $groupKey, $memberKey, $optParams);
...
* @return Member
*/
function membersUpdateExample($service, $groupKey, $memberKey, $optParams)
{
	try
	{
		...
		return $service->members->UpdateMembers($groupKey, $memberKey, $optParams);
	}
	catch (Exception $e)
	{
