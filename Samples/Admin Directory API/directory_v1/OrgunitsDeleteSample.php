...
print_r(orgunitsDeleteExample($service, $customerId, $orgUnitPath));
...
*/
function orgunitsDeleteExample($service, $customerId, $orgUnitPath)
{
	try
	{
		...
		return $service->orgunits->DeleteOrgunits($customerId, $orgUnitPath);
	}
	catch (Exception $ex)
	{
