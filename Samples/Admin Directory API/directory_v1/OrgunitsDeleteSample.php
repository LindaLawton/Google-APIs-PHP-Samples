...
$results = orgunitsDeleteExample($service, $customerId, $orgUnitPath, $optParams);
...
*/
function orgunitsDeleteExample($service, $customerId, $orgUnitPath, $optParams)
{
	try
	{
		...
		return $service->orgunits->DeleteOrgunits($customerId, $orgUnitPath, $optParams);
	}
	catch (Exception $e)
	{
