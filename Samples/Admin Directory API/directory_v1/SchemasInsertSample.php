...
// Single Request.
$results = schemasInsertExample($service, $customerId, $optParams);
...
* @return Schema
*/
function schemasInsertExample($service, $customerId, $optParams)
{
	try
	{
		...
		return $service->schemas->InsertSchemas($customerId, $optParams);
	}
	catch (Exception $e)
	{
