...
print_r(orgunitsUpdateExample($service, $customerId, $orgUnitPath));
...
* @return OrgUnit</returns>
*/
function orgunitsUpdateExample($service, $customerId, $orgUnitPath)
{
	try
	{
		...
		return $service->orgunits->UpdateOrgunits($customerId, $orgUnitPath);
	}
	catch (Exception $ex)
	{
