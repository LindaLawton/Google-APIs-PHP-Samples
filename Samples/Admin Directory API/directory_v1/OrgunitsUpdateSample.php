...
$results = orgunitsUpdateExample($service, $customerId, $orgUnitPath, $optParams);
...
* @return OrgUnit
*/
function orgunitsUpdateExample($service, $customerId, $orgUnitPath, $optParams)
{
	try
	{
		...
		return $service->orgunits->UpdateOrgunits($customerId, $orgUnitPath, $optParams);
	}
	catch (Exception $e)
	{
