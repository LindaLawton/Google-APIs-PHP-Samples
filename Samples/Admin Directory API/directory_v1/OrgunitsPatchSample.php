...
// Single Request.
$results = orgunitsPatchExample($service, $customerId, $orgUnitPath, $optParams);
...
* @return OrgUnit
*/
function orgunitsPatchExample($service, $customerId, $orgUnitPath, $optParams)
{
	try
	{
		...
		return $service->orgunits->PatchOrgunits($customerId, $orgUnitPath, $optParams);
	}
	catch (Exception $e)
	{
