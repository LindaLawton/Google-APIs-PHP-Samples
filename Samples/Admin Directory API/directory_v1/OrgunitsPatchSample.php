...
print_r(orgunitsPatchExample($service, $customerId, $orgUnitPath));
...
*/
function orgunitsPatchExample($service, $customerId, $orgUnitPath)
{
	try
	{
		...
		return $service->orgunits->PatchOrgunits($customerId, $orgUnitPath);
	}
	catch (Exception $ex)
	{
