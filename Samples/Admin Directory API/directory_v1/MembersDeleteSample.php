...
$results = membersDeleteExample($service, $groupKey, $memberKey, $optParams);
...
*/
function membersDeleteExample($service, $groupKey, $memberKey, $optParams)
{
	try
	{
		...
		if (groupKey == null)
			throw new Exception("groupKey is required.");
		if (memberKey == null)
			throw new Exception("memberKey is required.");
		// Make the request and return the results.
		return $service->members->DeleteMembers($groupKey, $memberKey, $optParams);
	}
	catch (Exception $e)
	{
