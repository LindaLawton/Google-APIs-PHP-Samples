...
print_r(membersDeleteExample($service, $groupKey, $memberKey));
...
*/
function membersDeleteExample($service, $groupKey, $memberKey)
{
	try
	{
		...
		return $service->members->DeleteMembers($groupKey, $memberKey);
	}
	catch (Exception $ex)
	{
