...
$results = rolesDeleteExample($service, $customer, $roleId, $optParams);
...
*/
function rolesDeleteExample($service, $customer, $roleId, $optParams)
{
	try
	{
		...
		return $service->roles->DeleteRoles($customer, $roleId, $optParams);
	}
	catch (Exception $e)
	{
