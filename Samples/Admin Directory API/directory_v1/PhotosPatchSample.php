...
// Single Request.
$results = photosPatchExample($service, $userKey, $optParams);
...
* @return UserPhoto
*/
function photosPatchExample($service, $userKey, $optParams)
{
	try
	{
		...
		return $service->photos->PatchPhotos($userKey, $optParams);
	}
	catch (Exception $e)
	{
