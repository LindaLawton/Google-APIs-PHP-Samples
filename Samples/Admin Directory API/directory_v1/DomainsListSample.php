...
// Single Request.
$results = domainsListExample($service, $customer, $optParams);
...
* @return Domains2
*/
function domainsListExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->domains->ListDomains($customer, $optParams);
	}
	catch (Exception $e)
	{
