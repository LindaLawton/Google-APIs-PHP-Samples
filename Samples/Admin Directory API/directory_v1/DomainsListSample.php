...
print_r(domainsListExample($service, $customer));

/**
* Lists the domains of the customer.
* @service Authenticated Directory service.
* @customer Immutable ID of the G Suite account.
* @return Domains2</returns>
*/
function domainsListExample($service, $customer)
{
	try
	{
		...
		return $service->domains->ListDomains($customer);
	}
	catch (Exception $ex)
	{
