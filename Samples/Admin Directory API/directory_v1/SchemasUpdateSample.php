...
// Single Request.
$results = schemasUpdateExample($service, $customerId, $schemaKey, $optParams);
...
* @return Schema
*/
function schemasUpdateExample($service, $customerId, $schemaKey, $optParams)
{
	try
	{
		...
		if (schemaKey == null)
			throw new Exception("schemaKey is required.");
		// Make the request and return the results.
		return $service->schemas->UpdateSchemas($customerId, $schemaKey, $optParams);
	}
	catch (Exception $e)
	{
