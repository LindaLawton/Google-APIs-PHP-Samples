...
print_r(schemasUpdateExample($service, $customerId, $schemaKey));
...
*/
function schemasUpdateExample($service, $customerId, $schemaKey)
{
	try
	{
		...
		return $service->schemas->UpdateSchemas($customerId, $schemaKey);
	}
	catch (Exception $ex)
	{
