...
// Single Request.
$results = rolesPatchExample($service, $customer, $roleId, $optParams);
...
* @return Role
*/
function rolesPatchExample($service, $customer, $roleId, $optParams)
{
	try
	{
		...
		return $service->roles->PatchRoles($customer, $roleId, $optParams);
	}
	catch (Exception $e)
	{
