...
// Single Request.
$results = rolesListExample($service, $customer, $optParams);
...
* @return Roles
*/
function rolesListExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->roles->ListRoles($customer, $optParams);
	}
	catch (Exception $e)
	{
