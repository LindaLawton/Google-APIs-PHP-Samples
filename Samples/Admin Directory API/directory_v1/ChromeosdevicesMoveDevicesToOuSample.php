...
$results = chromeosdevicesMoveDevicesToOuExample($service, $customerId, $orgUnitPath, $optParams);
...
*/
function chromeosdevicesMoveDevicesToOuExample($service, $customerId, $orgUnitPath, $optParams)
{
	try
	{
		...
		if (orgUnitPath == null)
			throw new Exception("orgUnitPath is required.");
		// Make the request and return the results.
		return $service->chromeosdevices->MoveDevicesToOuChromeosdevices($customerId, $orgUnitPath, $optParams);
	}
	catch (Exception $e)
	{
