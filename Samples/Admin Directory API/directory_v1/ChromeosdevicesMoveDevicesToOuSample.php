...
print_r(moveDevicesToOu($service, $customerId, $orgUnitPath));
...
*/
function moveDevicesToOu($service, $customerId, $orgUnitPath)
{
	try
	{
		...
		return $service->moveDevicesToOu($customerId, $orgUnitPath);
	}
	catch (Exception $ex)
	{
