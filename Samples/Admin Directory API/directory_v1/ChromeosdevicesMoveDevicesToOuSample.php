...
print_r(chromeosdevicesMoveDevicesToOuExample($service, $customerId, $orgUnitPath));
...
*/
function chromeosdevicesMoveDevicesToOuExample($service, $customerId, $orgUnitPath)
{
	try
	{
		...
		return $service->chromeosdevices->MoveDevicesToOuChromeosdevices($customerId, $orgUnitPath);
	}
	catch (Exception $ex)
	{
