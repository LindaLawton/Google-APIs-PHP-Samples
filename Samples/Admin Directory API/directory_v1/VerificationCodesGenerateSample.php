...
print_r(verificationCodesGenerateExample($service, $userKey));
...
*/
function verificationCodesGenerateExample($service, $userKey)
{
	try
	{
		...
		return $service->verificationCodes->GenerateVerificationCodes($userKey);
	}
	catch (Exception $ex)
	{
