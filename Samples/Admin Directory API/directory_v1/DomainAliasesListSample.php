...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'parentDomainName' => '[YourValue]',  //Name of the parent domain for which domain aliases are to be fetched.
  'fields' => '*'
);
// Single Request.
$results = domainAliasesListExample($service, $customer, $optParams);
...
*/
function domainAliasesListExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->domainAliases->ListDomainAliases($customer, $optParams);
	}
	catch (Exception $e)
	{
