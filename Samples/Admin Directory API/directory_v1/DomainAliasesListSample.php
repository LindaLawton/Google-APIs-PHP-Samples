...
print_r(domainAliasesListExample($service, $customer));

/**
* Lists the domain aliases of the customer.
* @service Authenticated Directory service.
* @customer Immutable ID of the G Suite account.
* @return DomainAliases</returns>
*/
function domainAliasesListExample($service, $customer)
{
	try
	{
		...
		return $service->domainAliases->ListDomainAliases($customer);
	}
	catch (Exception $ex)
	{
