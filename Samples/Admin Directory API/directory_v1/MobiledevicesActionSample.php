...
print_r(mobiledevicesActionExample($service, $customerId, $resourceId));
...
*/
function mobiledevicesActionExample($service, $customerId, $resourceId)
{
	try
	{
		...
		return $service->mobiledevices->ActionMobiledevices($customerId, $resourceId);
	}
	catch (Exception $ex)
	{
