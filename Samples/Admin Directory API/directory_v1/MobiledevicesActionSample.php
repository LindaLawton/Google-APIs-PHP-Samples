...
$results = mobiledevicesActionExample($service, $customerId, $resourceId, $optParams);
...
*/
function mobiledevicesActionExample($service, $customerId, $resourceId, $optParams)
{
	try
	{
		...
		return $service->mobiledevices->ActionMobiledevices($customerId, $resourceId, $optParams);
	}
	catch (Exception $e)
	{
