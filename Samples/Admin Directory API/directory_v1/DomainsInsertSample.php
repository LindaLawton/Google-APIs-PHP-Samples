...
// Single Request.
$results = domainsInsertExample($service, $customer, $optParams);
...
* @return Domains
*/
function domainsInsertExample($service, $customer, $optParams)
{
	try
	{
		...
		return $service->domains->InsertDomains($customer, $optParams);
	}
	catch (Exception $e)
	{
