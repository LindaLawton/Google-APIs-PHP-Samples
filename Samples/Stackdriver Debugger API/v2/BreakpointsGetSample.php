...
// Single Request.
$results = breakpointsGetExample($service, $debuggeeId, $breakpointId, $optParams);
...
*/
function breakpointsGetExample($service, $debuggeeId, $breakpointId, $optParams)
{
	try
	{
		...
		return $service->breakpoints->GetBreakpoints($debuggeeId, $breakpointId, $optParams);
	}
	catch (Exception $e)
	{
