...
print_r(breakpointsGetExample($service, $debuggeeId, $breakpointId));
...
* @return GetBreakpointResponse</returns>
*/
function breakpointsGetExample($service, $debuggeeId, $breakpointId)
{
	try
	{
		...
		return $service->breakpoints->GetBreakpoints($debuggeeId, $breakpointId);
	}
	catch (Exception $ex)
	{
