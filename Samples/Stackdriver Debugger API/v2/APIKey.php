...
// About 
// 
// Unofficial sample for the Clouddebugger v2 API for PHP. 
 ...
 * Initializes an Clouddebugger.v2 service object.
 * @param string API key
 * @return An authorized Clouddebugger.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Clouddebugger Sample");
		...
		// Create authenticated Clouddebugger service
		return new Google_Service_Clouddebugger($client);
	} catch (Exception $e) {
