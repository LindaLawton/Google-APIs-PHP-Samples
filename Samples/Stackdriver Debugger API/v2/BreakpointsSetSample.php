...
print_r(breakpointsSetExample($service, $debuggeeId));

/**
* Sets the breakpoint to the debuggee.
* @service Authenticated Clouddebugger service.
* @debuggeeId ID of the debuggee where the breakpoint is to be set.
* @return SetBreakpointResponse</returns>
*/
function breakpointsSetExample($service, $debuggeeId)
{
	try
	{
		...
		return $service->breakpoints->SetBreakpoints($debuggeeId);
	}
	catch (Exception $ex)
	{
