...
// Single Request.
$results = breakpointsSetExample($service, $debuggeeId, $optParams);
...
*/
function breakpointsSetExample($service, $debuggeeId, $optParams)
{
	try
	{
		...
		return $service->breakpoints->SetBreakpoints($debuggeeId, $optParams);
	}
	catch (Exception $e)
	{
