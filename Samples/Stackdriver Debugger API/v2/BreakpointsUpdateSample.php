...
print_r(breakpointsUpdateExample($service, $debuggeeId, $id));
...
* @return UpdateActiveBreakpointResponse</returns>
*/
function breakpointsUpdateExample($service, $debuggeeId, $id)
{
	try
	{
		...
		return $service->breakpoints->UpdateBreakpoints($debuggeeId, $id);
	}
	catch (Exception $ex)
	{
