...
print_r(breakpointsDeleteExample($service, $debuggeeId, $breakpointId));
...
*/
function breakpointsDeleteExample($service, $debuggeeId, $breakpointId)
{
	try
	{
		...
		return $service->breakpoints->DeleteBreakpoints($debuggeeId, $breakpointId);
	}
	catch (Exception $ex)
	{
