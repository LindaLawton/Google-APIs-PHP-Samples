...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'clientVersion' => '[YourValue]',  //The client version making the call.Schema: `domain/type/version` (e.g., `google.com/intellij/v1`).
  'fields' => '*'
);
// Single Request.
$results = breakpointsDeleteExample($service, $debuggeeId, $breakpointId, $optParams);
...
* @return Empty
*/
function breakpointsDeleteExample($service, $debuggeeId, $breakpointId, $optParams)
{
	try
	{
		...
		if (breakpointId == null)
			throw new Exception("breakpointId is required.");
		if (debuggeeId == null)
			throw new Exception("debuggeeId is required.");
		// Make the request and return the results.
		return $service->breakpoints->DeleteBreakpoints($debuggeeId, $breakpointId, $optParams);
	}
	catch (Exception $e)
	{
