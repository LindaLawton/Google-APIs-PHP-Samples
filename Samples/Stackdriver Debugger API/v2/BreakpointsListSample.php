...
print_r(breakpointsListExample($service, $debuggeeId));
...
* @return ListActiveBreakpointsResponse</returns>
*/
function breakpointsListExample($service, $debuggeeId)
{
	try
	{
		...
		return $service->breakpoints->ListBreakpoints($debuggeeId);
	}
	catch (Exception $ex)
	{
