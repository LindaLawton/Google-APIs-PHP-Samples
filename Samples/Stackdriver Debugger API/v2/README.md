...
# UnOfficial Stackdriver Debugger API v2 Samples for PHP

## API Description

Examines the call stack and variables of a running application without stopping or slowing it down.

[Official Documentation](http://cloud.google.com/debugger)

## Sample Description

These samples show how to access the [Stackdriver Debugger API v2](http://cloud.google.com/debugger) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
