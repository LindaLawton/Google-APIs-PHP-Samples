...
print_r(templatesLaunchExample($service, $projectId));

/**
* Launch a template.
* @service Authenticated Dataflow service.
* @projectId Required. The ID of the Cloud Platform project that the job belongs to.
* @return LaunchTemplateResponse</returns>
*/
function templatesLaunchExample($service, $projectId)
{
	try
	{
		...
		return $service->templates->LaunchTemplates($projectId);
	}
	catch (Exception $ex)
	{
