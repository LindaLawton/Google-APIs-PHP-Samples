...
// Single Request.
$results = templatesCreateExample($service, $projectId, $optParams);
...
* @return Job
*/
function templatesCreateExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->templates->CreateTemplates($projectId, $optParams);
	}
	catch (Exception $e)
	{
