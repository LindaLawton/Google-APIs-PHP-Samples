...
print_r(templatesGetExample($service, $projectId));
...
* @return GetTemplateResponse</returns>
*/
function templatesGetExample($service, $projectId)
{
	try
	{
		...
		return $service->templates->GetTemplates($projectId);
	}
	catch (Exception $ex)
	{
