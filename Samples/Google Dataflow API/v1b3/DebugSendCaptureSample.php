...
// Single Request.
$results = debugSendCaptureExample($service, $projectId, $jobId, $optParams);
...
*/
function debugSendCaptureExample($service, $projectId, $jobId, $optParams)
{
	try
	{
		...
		return $service->debug->SendCaptureDebug($projectId, $jobId, $optParams);
	}
	catch (Exception $e)
	{
