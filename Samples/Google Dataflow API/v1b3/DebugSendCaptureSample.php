...
print_r(debugSendCaptureExample($service, $projectId, $jobId));
...
* @return SendDebugCaptureResponse</returns>
*/
function debugSendCaptureExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->debug->SendCaptureDebug($projectId, $jobId);
	}
	catch (Exception $ex)
	{
