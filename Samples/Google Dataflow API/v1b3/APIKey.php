 ...
 * Initializes an Dataflow.v1b3 service object.
 * @param string API key
 * @return An authorized Dataflow.v1b3 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Dataflow Sample");
		...
		// Create authenticated Dataflow service
		return new Google_Service_Dataflow($client);
	} catch (Exception $e) {
