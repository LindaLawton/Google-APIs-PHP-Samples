...
// Single Request.
$results = workItemsLeaseExample($service, $projectId, $jobId, $optParams);
...
*/
function workItemsLeaseExample($service, $projectId, $jobId, $optParams)
{
	try
	{
		...
		return $service->workItems->LeaseWorkItems($projectId, $jobId, $optParams);
	}
	catch (Exception $e)
	{
