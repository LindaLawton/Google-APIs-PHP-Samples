...
print_r(workItemsLeaseExample($service, $projectId, $jobId));
...
* @return LeaseWorkItemResponse</returns>
*/
function workItemsLeaseExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->workItems->LeaseWorkItems($projectId, $jobId);
	}
	catch (Exception $ex)
	{
