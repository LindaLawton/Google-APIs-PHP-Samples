...
print_r(messagesListExample($service, $projectId, $jobId));
...
* @return ListJobMessagesResponse</returns>
*/
function messagesListExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->messages->ListMessages($projectId, $jobId);
	}
	catch (Exception $ex)
	{
