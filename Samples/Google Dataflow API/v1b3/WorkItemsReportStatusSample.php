...
print_r(workItemsReportStatusExample($service, $projectId, $jobId));
...
* @return ReportWorkItemStatusResponse</returns>
*/
function workItemsReportStatusExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->workItems->ReportStatusWorkItems($projectId, $jobId);
	}
	catch (Exception $ex)
	{
