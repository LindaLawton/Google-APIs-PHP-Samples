...
// Single Request.
$results = debugGetConfigExample($service, $projectId, $jobId, $optParams);
...
*/
function debugGetConfigExample($service, $projectId, $jobId, $optParams)
{
	try
	{
		...
		return $service->debug->GetConfigDebug($projectId, $jobId, $optParams);
	}
	catch (Exception $e)
	{
