...
print_r(debugGetConfigExample($service, $projectId, $jobId));
...
* @return GetDebugConfigResponse</returns>
*/
function debugGetConfigExample($service, $projectId, $jobId)
{
	try
	{
		...
		return $service->debug->GetConfigDebug($projectId, $jobId);
	}
	catch (Exception $ex)
	{
