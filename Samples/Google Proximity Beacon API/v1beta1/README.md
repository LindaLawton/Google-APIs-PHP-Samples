...
# UnOfficial Google Proximity Beacon API v1beta1 Samples for PHP

## API Description

Registers, manages, indexes, and searches beacons.

[Official Documentation](https://developers.google.com/beacons/proximity/)

## Sample Description

These samples show how to access the [Google Proximity Beacon API v1beta1](https://developers.google.com/beacons/proximity/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
