...
print_r(namespacesUpdateExample($service, $namespaceName));
...
* @return Namespace</returns>
*/
function namespacesUpdateExample($service, $namespaceName)
{
	try
	{
		...
		return $service->namespaces->UpdateNamespaces($namespaceName);
	}
	catch (Exception $ex)
	{
