...
print_r(attachmentsListExample($service, $beaconName));
...
Required.
* @return ListBeaconAttachmentsResponse</returns>
*/
function attachmentsListExample($service, $beaconName)
{
	try
	{
		...
		return $service->attachments->ListAttachments($beaconName);
	}
	catch (Exception $ex)
	{
