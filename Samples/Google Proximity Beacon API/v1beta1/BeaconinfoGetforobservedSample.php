...
$results = beaconinfoGetforobservedExample($service, $optParams);
...
*/
function beaconinfoGetforobservedExample($service, $optParams)
{
	try
	{
		...
		return $service->beaconinfo->GetforobservedBeaconinfo($optParams);
	}
	catch (Exception $e)
	{
