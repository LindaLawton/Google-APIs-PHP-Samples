...
print_r(beaconinfoGetforobservedExample($service));
...
* @return GetInfoForObservedBeaconsResponse</returns>
*/
function beaconinfoGetforobservedExample($service)
{
	try
	{
		...
		return $service->beaconinfo->GetforobservedBeaconinfo();
	}
	catch (Exception $ex)
	{
