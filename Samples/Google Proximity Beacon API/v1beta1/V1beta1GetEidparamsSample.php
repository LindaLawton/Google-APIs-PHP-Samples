...
print_r(v1beta1GetEidparamsExample($service));
...
* @return EphemeralIdRegistrationParams</returns>
*/
function v1beta1GetEidparamsExample($service)
{
	try
	{
		...
		return $service->v1beta1->GetEidparamsV1beta1();
	}
	catch (Exception $ex)
	{
