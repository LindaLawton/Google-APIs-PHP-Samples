...
print_r(attachmentsDeleteExample($service, $attachmentName));
...
*/
function attachmentsDeleteExample($service, $attachmentName)
{
	try
	{
		...
		return $service->attachments->DeleteAttachments($attachmentName);
	}
	catch (Exception $ex)
	{
