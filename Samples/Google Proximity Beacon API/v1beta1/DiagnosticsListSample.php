...
print_r(diagnosticsListExample($service, $beaconName));
...
* @return ListDiagnosticsResponse</returns>
*/
function diagnosticsListExample($service, $beaconName)
{
	try
	{
		...
		return $service->diagnostics->ListDiagnostics($beaconName);
	}
	catch (Exception $ex)
	{
