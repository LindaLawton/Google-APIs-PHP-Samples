...
print_r(attachmentsCreateExample($service, $beaconName));
...
*/
function attachmentsCreateExample($service, $beaconName)
{
	try
	{
		...
		return $service->attachments->CreateAttachments($beaconName);
	}
	catch (Exception $ex)
	{
