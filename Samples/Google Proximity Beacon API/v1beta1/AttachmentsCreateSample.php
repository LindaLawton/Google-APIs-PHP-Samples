...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'projectId' => '[YourValue]',  //The project id of the project the attachment will belong to. Ifthe project id is not specified then the project making the requestis used.Optional.
  'fields' => '*'
);
// Single Request.
$results = attachmentsCreateExample($service, $beaconName, $optParams);
