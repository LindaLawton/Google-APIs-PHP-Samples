 ...
 * Initializes an Proximitybeacon.v1beta1 service object.
 * @param string API key
 * @return An authorized Proximitybeacon.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Proximitybeacon Sample");
		...
		// Create authenticated Proximitybeacon service
		return new Google_Service_Proximitybeacon($client);
	} catch (Exception $e) {
