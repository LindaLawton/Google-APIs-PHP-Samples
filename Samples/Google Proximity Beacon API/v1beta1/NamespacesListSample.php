...
print_r(namespacesListExample($service));
...
* @return ListNamespacesResponse</returns>
*/
function namespacesListExample($service)
{
	try
	{
		...
		return $service->namespaces->ListNamespaces();
	}
	catch (Exception $ex)
	{
