...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'projectId' => '[YourValue]',  // The project id to list namespaces under.Optional.
  'fields' => '*'
);
// Single Request.
$results = namespacesListExample($service, $optParams);
...
*/
function namespacesListExample($service, $optParams)
{
	try
	{
		...
		return $service->namespaces->ListNamespaces($optParams);
	}
	catch (Exception $e)
	{
