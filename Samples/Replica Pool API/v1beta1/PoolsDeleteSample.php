...
print_r(poolsDeleteExample($service, $projectName, $zone, $poolName));
...
*/
function poolsDeleteExample($service, $projectName, $zone, $poolName)
{
	try
	{
		...
		return $service->pools->DeletePools($projectName, $zone, $poolName);
	}
	catch (Exception $ex)
	{
