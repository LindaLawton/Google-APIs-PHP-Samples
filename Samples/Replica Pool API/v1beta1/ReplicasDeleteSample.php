...
// Single Request.
$results = replicasDeleteExample($service, $projectName, $zone, $poolName, $replicaName, $optParams);
...
* @return Replica
*/
function replicasDeleteExample($service, $projectName, $zone, $poolName, $replicaName, $optParams)
{
	try
	{
		...
		return $service->replicas->DeleteReplicas($projectName, $zone, $poolName, $replicaName, $optParams);
	}
	catch (Exception $e)
	{
