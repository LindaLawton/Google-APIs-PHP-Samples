...
print_r(delete($service, $projectName, $zone, $poolName, $replicaName));
...
*/
function delete($service, $projectName, $zone, $poolName, $replicaName)
{
	try
	{
		...
		return $service->delete($projectName, $zone, $poolName, $replicaName);
	}
	catch (Exception $ex)
	{
