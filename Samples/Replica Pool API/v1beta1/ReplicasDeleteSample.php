...
print_r(replicasDeleteExample($service, $projectName, $zone, $poolName, $replicaName));
...
*/
function replicasDeleteExample($service, $projectName, $zone, $poolName, $replicaName)
{
	try
	{
		...
		return $service->replicas->DeleteReplicas($projectName, $zone, $poolName, $replicaName);
	}
	catch (Exception $ex)
	{
