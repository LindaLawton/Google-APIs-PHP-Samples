...
// Single Request.
$results = replicasGetExample($service, $projectName, $zone, $poolName, $replicaName, $optParams);
...
* @return Replica
*/
function replicasGetExample($service, $projectName, $zone, $poolName, $replicaName, $optParams)
{
	try
	{
		...
		return $service->replicas->GetReplicas($projectName, $zone, $poolName, $replicaName, $optParams);
	}
	catch (Exception $e)
	{
