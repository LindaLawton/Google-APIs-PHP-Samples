...
print_r(replicasGetExample($service, $projectName, $zone, $poolName, $replicaName));
...
*/
function replicasGetExample($service, $projectName, $zone, $poolName, $replicaName)
{
	try
	{
		...
		return $service->replicas->GetReplicas($projectName, $zone, $poolName, $replicaName);
	}
	catch (Exception $ex)
	{
