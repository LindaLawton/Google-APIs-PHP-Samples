...
print_r(get($service, $projectName, $zone, $poolName, $replicaName));
...
*/
function get($service, $projectName, $zone, $poolName, $replicaName)
{
	try
	{
		...
		return $service->get($projectName, $zone, $poolName, $replicaName);
	}
	catch (Exception $ex)
	{
