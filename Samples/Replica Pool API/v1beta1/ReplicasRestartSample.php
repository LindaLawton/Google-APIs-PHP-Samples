...
print_r(replicasRestartExample($service, $projectName, $zone, $poolName, $replicaName));
...
*/
function replicasRestartExample($service, $projectName, $zone, $poolName, $replicaName)
{
	try
	{
		...
		return $service->replicas->RestartReplicas($projectName, $zone, $poolName, $replicaName);
	}
	catch (Exception $ex)
	{
