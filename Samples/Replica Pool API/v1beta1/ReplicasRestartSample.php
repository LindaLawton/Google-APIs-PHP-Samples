...
// Single Request.
$results = replicasRestartExample($service, $projectName, $zone, $poolName, $replicaName, $optParams);
...
* @return Replica
*/
function replicasRestartExample($service, $projectName, $zone, $poolName, $replicaName, $optParams)
{
	try
	{
		...
		return $service->replicas->RestartReplicas($projectName, $zone, $poolName, $replicaName, $optParams);
	}
	catch (Exception $e)
	{
