...
print_r(updatetemplate($service, $projectName, $zone, $poolName));
...
*/
function updatetemplate($service, $projectName, $zone, $poolName)
{
	try
	{
		...
		return $service->updatetemplate($projectName, $zone, $poolName);
	}
	catch (Exception $ex)
	{
