...
print_r(poolsUpdatetemplateExample($service, $projectName, $zone, $poolName));
...
*/
function poolsUpdatetemplateExample($service, $projectName, $zone, $poolName)
{
	try
	{
		...
		return $service->pools->UpdatetemplatePools($projectName, $zone, $poolName);
	}
	catch (Exception $ex)
	{
