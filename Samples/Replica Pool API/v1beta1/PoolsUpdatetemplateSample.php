...
$results = poolsUpdatetemplateExample($service, $projectName, $zone, $poolName, $optParams);
...
*/
function poolsUpdatetemplateExample($service, $projectName, $zone, $poolName, $optParams)
{
	try
	{
		...
		return $service->pools->UpdatetemplatePools($projectName, $zone, $poolName, $optParams);
	}
	catch (Exception $e)
	{
