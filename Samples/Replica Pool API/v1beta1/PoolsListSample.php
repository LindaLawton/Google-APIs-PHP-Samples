...
print_r(poolsListExample($service, $projectName, $zone));
...
* @return PoolsListResponse</returns>
*/
function poolsListExample($service, $projectName, $zone)
{
	try
	{
		...
		return $service->pools->ListPools($projectName, $zone);
	}
	catch (Exception $ex)
	{
