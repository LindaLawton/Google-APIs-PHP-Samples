...
print_r(poolsResizeExample($service, $projectName, $zone, $poolName));
...
* @return Pool</returns>
*/
function poolsResizeExample($service, $projectName, $zone, $poolName)
{
	try
	{
		...
		return $service->pools->ResizePools($projectName, $zone, $poolName);
	}
	catch (Exception $ex)
	{
