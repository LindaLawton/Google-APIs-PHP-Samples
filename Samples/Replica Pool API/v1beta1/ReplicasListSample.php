...
print_r(replicasListExample($service, $projectName, $zone, $poolName));
...
* @return ReplicasListResponse</returns>
*/
function replicasListExample($service, $projectName, $zone, $poolName)
{
	try
	{
		...
		return $service->replicas->ListReplicas($projectName, $zone, $poolName);
	}
	catch (Exception $ex)
	{
