...
print_r(poolsInsertExample($service, $projectName, $zone));
...
* @return Pool</returns>
*/
function poolsInsertExample($service, $projectName, $zone)
{
	try
	{
		...
		return $service->pools->InsertPools($projectName, $zone);
	}
	catch (Exception $ex)
	{
