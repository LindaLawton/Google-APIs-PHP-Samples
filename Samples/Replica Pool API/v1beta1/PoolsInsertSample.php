...
$results = poolsInsertExample($service, $projectName, $zone, $optParams);
...
* @return Pool
*/
function poolsInsertExample($service, $projectName, $zone, $optParams)
{
	try
	{
		...
		return $service->pools->InsertPools($projectName, $zone, $optParams);
	}
	catch (Exception $e)
	{
