...
// Single Request.
$results = poolsGetExample($service, $projectName, $zone, $poolName, $optParams);
...
* @return Pool
*/
function poolsGetExample($service, $projectName, $zone, $poolName, $optParams)
{
	try
	{
		...
		return $service->pools->GetPools($projectName, $zone, $poolName, $optParams);
	}
	catch (Exception $e)
	{
