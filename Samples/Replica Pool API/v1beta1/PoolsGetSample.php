...
print_r(poolsGetExample($service, $projectName, $zone, $poolName));
...
* @return Pool</returns>
*/
function poolsGetExample($service, $projectName, $zone, $poolName)
{
	try
	{
		...
		return $service->pools->GetPools($projectName, $zone, $poolName);
	}
	catch (Exception $ex)
	{
