...
# Unoffical Replica Pool API Samples for PHP
...
These samples show how to access the [Replica Pool API](https://developers.google.com/compute/docs/replica-pool/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
