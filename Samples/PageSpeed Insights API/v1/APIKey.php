 ...
 * Initializes an Pagespeedonline.v1 service object.
 * @param string API key
 * @return An authorized Pagespeedonline.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Pagespeedonline Sample");
		...
		// Create authenticated Pagespeedonline service
		return new Google_Service_Pagespeedonline($client);
	} catch (Exception $e) {
