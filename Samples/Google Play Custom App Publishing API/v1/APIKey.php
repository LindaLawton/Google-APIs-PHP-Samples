...
// About 
// 
// Unofficial sample for the Playcustomapp v1 API for PHP. 
 ...
 * Initializes an Playcustomapp.v1 service object.
 * @param string API key
 * @return An authorized Playcustomapp.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Playcustomapp Sample");
		...
		// Create authenticated Playcustomapp service
		return new Google_Service_Playcustomapp($client);
	} catch (Exception $e) {
