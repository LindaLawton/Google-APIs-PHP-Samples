...
// Single Request.
$results = creativeFieldValuesDeleteExample($service, $profileId, $creativeFieldId, $id, $optParams);
...
*/
function creativeFieldValuesDeleteExample($service, $profileId, $creativeFieldId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->creativeFieldValues->DeleteCreativeFieldValues($profileId, $creativeFieldId, $id, $optParams);
	}
	catch (Exception $e)
	{
