...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  // Select only inventory items with these IDs.
            
  //'inPlan' => '[YourValue]',  // Select only inventory items that are in plan.
            
  //'maxResults' => '[YourValue]',  // Maximum number of results to return.
            
  //'orderId' => '[YourValue]',  // Select only inventory items that belong to specified orders.
            
  //'pageToken' => '[YourValue]',  // Value of the nextPageToken from the previous result page.
            
  //'siteId' => '[YourValue]',  // Select only inventory items that are associated with these sites.
            
  //'sortField' => '[YourValue]',  // Field by which to sort the list.
            
  //'sortOrder' => '[YourValue]',  // Order of sorted results.
            
  //'type' => '[YourValue]',  // Select only inventory items with this type.
  'fields' => '*'
);
// Single Request.
$results = inventoryItemsListExample($service, $profileId, $projectId, $optParams);
...
*/
function inventoryItemsListExample($service, $profileId, $projectId, $optParams)
{
	try
	{
		...
		return $service->inventoryItems->ListInventoryItems($profileId, $projectId, $optParams);
	}
	catch (Exception $e)
	{
