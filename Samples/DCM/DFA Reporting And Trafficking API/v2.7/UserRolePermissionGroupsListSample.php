...
// Single Request.
$results = userRolePermissionGroupsListExample($service, $profileId, $optParams);
...
*/
function userRolePermissionGroupsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->userRolePermissionGroups->ListUserRolePermissionGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
