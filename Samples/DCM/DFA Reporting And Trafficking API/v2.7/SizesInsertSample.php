...
// Single Request.
$results = sizesInsertExample($service, $profileId, $optParams);
...
* @return Size
*/
function sizesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->sizes->InsertSizes($profileId, $optParams);
	}
	catch (Exception $e)
	{
