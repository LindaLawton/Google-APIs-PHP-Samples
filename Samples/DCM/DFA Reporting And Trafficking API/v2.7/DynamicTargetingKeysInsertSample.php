...
// Single Request.
$results = dynamicTargetingKeysInsertExample($service, $profileId, $optParams);
...
*/
function dynamicTargetingKeysInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->dynamicTargetingKeys->InsertDynamicTargetingKeys($profileId, $optParams);
	}
	catch (Exception $e)
	{
