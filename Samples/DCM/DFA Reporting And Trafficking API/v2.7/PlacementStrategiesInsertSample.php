...
// Single Request.
$results = placementStrategiesInsertExample($service, $profileId, $optParams);
...
*/
function placementStrategiesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->placementStrategies->InsertPlacementStrategies($profileId, $optParams);
	}
	catch (Exception $e)
	{
