...
// Single Request.
$results = accountsPatchExample($service, $profileId, $id, $optParams);
...
* @return Account
*/
function accountsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->accounts->PatchAccounts($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
