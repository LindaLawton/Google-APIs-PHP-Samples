...
// Single Request.
$results = userRolePermissionGroupsGetExample($service, $profileId, $id, $optParams);
...
*/
function userRolePermissionGroupsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->userRolePermissionGroups->GetUserRolePermissionGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
