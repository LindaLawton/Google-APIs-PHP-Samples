...
// Single Request.
$results = advertiserGroupsGetExample($service, $profileId, $id, $optParams);
...
*/
function advertiserGroupsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->advertiserGroups->GetAdvertiserGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
