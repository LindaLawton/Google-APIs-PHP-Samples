...
// Single Request.
$results = changeLogsGetExample($service, $profileId, $id, $optParams);
...
* @return ChangeLog
*/
function changeLogsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->changeLogs->GetChangeLogs($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
