...
// Single Request.
$results = advertiserGroupsUpdateExample($service, $profileId, $optParams);
...
*/
function advertiserGroupsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->advertiserGroups->UpdateAdvertiserGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
