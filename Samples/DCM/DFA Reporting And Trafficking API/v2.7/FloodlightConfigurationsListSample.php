...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  //Set of IDs of floodlight configurations to retrieve. Required field; otherwise an empty list will be returned.
  'fields' => '*'
);
// Single Request.
$results = floodlightConfigurationsListExample($service, $profileId, $optParams);
...
*/
function floodlightConfigurationsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightConfigurations->ListFloodlightConfigurations($profileId, $optParams);
	}
	catch (Exception $e)
	{
