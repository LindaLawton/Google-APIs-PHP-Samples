...
// Single Request.
$results = languagesListExample($service, $profileId, $optParams);
...
*/
function languagesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->languages->ListLanguages($profileId, $optParams);
	}
	catch (Exception $e)
	{
