...
// Single Request.
$results = creativeAssetsInsertExample($service, $profileId, $advertiserId, $optParams);
...
*/
function creativeAssetsInsertExample($service, $profileId, $advertiserId, $optParams)
{
	try
	{
		...
		return $service->creativeAssets->InsertCreativeAssets($profileId, $advertiserId, $optParams);
	}
	catch (Exception $e)
	{
