...
// Single Request.
$results = accountsGetExample($service, $profileId, $id, $optParams);
...
* @return Account
*/
function accountsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->accounts->GetAccounts($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
