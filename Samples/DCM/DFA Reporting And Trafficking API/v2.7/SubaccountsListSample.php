...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  //Select only subaccounts with these IDs.
  ...
  //'searchString' => '[YourValue]',  //Allows searching for objects by name or ID. Wildcards (*) are allowed. For example, "subaccount*2015" will return objects with names like "subaccount June 2015", "subaccount April 2015", or simply "subaccount 2015". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of "subaccount" will match objects with name "my subaccount", "subaccount 2015", or simply "subaccount".
...
// Single Request.
$results = subaccountsListExample($service, $profileId, $optParams);
...
*/
function subaccountsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->subaccounts->ListSubaccounts($profileId, $optParams);
	}
	catch (Exception $e)
	{
