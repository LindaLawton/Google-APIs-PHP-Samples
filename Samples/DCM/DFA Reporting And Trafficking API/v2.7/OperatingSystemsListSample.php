...
// Single Request.
$results = operatingSystemsListExample($service, $profileId, $optParams);
...
*/
function operatingSystemsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->operatingSystems->ListOperatingSystems($profileId, $optParams);
	}
	catch (Exception $e)
	{
