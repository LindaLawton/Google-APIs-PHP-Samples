...
// Single Request.
$results = creativesInsertExample($service, $profileId, $optParams);
...
* @return Creative
*/
function creativesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creatives->InsertCreatives($profileId, $optParams);
	}
	catch (Exception $e)
	{
