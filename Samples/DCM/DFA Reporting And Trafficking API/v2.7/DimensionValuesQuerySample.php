...
// Single Request.
$results = dimensionValuesQueryExample($service, $profileId, $optParams);
...
*/
function dimensionValuesQueryExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->dimensionValues->QueryDimensionValues($profileId, $optParams);
	}
	catch (Exception $e)
	{
