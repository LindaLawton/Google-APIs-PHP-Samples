...
// Single Request.
$results = remarketingListSharesPatchExample($service, $profileId, $remarketingListId, $optParams);
...
*/
function remarketingListSharesPatchExample($service, $profileId, $remarketingListId, $optParams)
{
	try
	{
		...
		if (remarketingListId == null)
			throw new Exception("remarketingListId is required.");
		// Make the request and return the results.
		return $service->remarketingListShares->PatchRemarketingListShares($profileId, $remarketingListId, $optParams);
	}
	catch (Exception $e)
	{
