...
// Single Request.
$results = advertisersPatchExample($service, $profileId, $id, $optParams);
...
* @return Advertiser
*/
function advertisersPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->advertisers->PatchAdvertisers($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
