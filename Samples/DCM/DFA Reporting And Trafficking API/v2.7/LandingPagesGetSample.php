...
// Single Request.
$results = landingPagesGetExample($service, $profileId, $campaignId, $id, $optParams);
...
* @return LandingPage
*/
function landingPagesGetExample($service, $profileId, $campaignId, $id, $optParams)
{
	try
	{
		...
		return $service->landingPages->GetLandingPages($profileId, $campaignId, $id, $optParams);
	}
	catch (Exception $e)
	{
