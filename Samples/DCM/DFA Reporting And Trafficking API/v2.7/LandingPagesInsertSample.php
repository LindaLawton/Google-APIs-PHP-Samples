...
// Single Request.
$results = landingPagesInsertExample($service, $profileId, $campaignId, $optParams);
...
* @return LandingPage
*/
function landingPagesInsertExample($service, $profileId, $campaignId, $optParams)
{
	try
	{
		...
		return $service->landingPages->InsertLandingPages($profileId, $campaignId, $optParams);
	}
	catch (Exception $e)
	{
