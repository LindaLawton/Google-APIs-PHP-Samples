...
// Single Request.
$results = creativeFieldValuesInsertExample($service, $profileId, $creativeFieldId, $optParams);
...
*/
function creativeFieldValuesInsertExample($service, $profileId, $creativeFieldId, $optParams)
{
	try
	{
		...
		return $service->creativeFieldValues->InsertCreativeFieldValues($profileId, $creativeFieldId, $optParams);
	}
	catch (Exception $e)
	{
