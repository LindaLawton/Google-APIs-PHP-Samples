...
// Single Request.
$results = targetingTemplatesPatchExample($service, $profileId, $id, $optParams);
...
*/
function targetingTemplatesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->targetingTemplates->PatchTargetingTemplates($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
