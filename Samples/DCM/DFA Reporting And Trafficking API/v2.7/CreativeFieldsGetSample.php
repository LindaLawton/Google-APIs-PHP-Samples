...
// Single Request.
$results = creativeFieldsGetExample($service, $profileId, $id, $optParams);
...
*/
function creativeFieldsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->creativeFields->GetCreativeFields($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
