...
// Single Request.
$results = creativeGroupsPatchExample($service, $profileId, $id, $optParams);
...
*/
function creativeGroupsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->creativeGroups->PatchCreativeGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
