...
// Single Request.
$results = floodlightActivitiesPatchExample($service, $profileId, $id, $optParams);
...
*/
function floodlightActivitiesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->floodlightActivities->PatchFloodlightActivities($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
