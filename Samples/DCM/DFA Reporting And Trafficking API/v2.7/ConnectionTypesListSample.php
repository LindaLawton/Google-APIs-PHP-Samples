...
// Single Request.
$results = connectionTypesListExample($service, $profileId, $optParams);
...
*/
function connectionTypesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->connectionTypes->ListConnectionTypes($profileId, $optParams);
	}
	catch (Exception $e)
	{
