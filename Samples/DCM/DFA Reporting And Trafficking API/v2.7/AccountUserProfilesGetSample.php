...
// Single Request.
$results = accountUserProfilesGetExample($service, $profileId, $id, $optParams);
...
*/
function accountUserProfilesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->accountUserProfiles->GetAccountUserProfiles($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
