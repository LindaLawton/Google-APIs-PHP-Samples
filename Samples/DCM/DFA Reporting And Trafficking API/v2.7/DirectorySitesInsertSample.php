...
// Single Request.
$results = directorySitesInsertExample($service, $profileId, $optParams);
...
*/
function directorySitesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->directorySites->InsertDirectorySites($profileId, $optParams);
	}
	catch (Exception $e)
	{
