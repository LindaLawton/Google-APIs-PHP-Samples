...
// Single Request.
$results = orderDocumentsGetExample($service, $profileId, $projectId, $id, $optParams);
...
*/
function orderDocumentsGetExample($service, $profileId, $projectId, $id, $optParams)
{
	try
	{
		...
		return $service->orderDocuments->GetOrderDocuments($profileId, $projectId, $id, $optParams);
	}
	catch (Exception $e)
	{
