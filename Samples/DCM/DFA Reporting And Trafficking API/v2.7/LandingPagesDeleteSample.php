...
// Single Request.
$results = landingPagesDeleteExample($service, $profileId, $campaignId, $id, $optParams);
...
*/
function landingPagesDeleteExample($service, $profileId, $campaignId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->landingPages->DeleteLandingPages($profileId, $campaignId, $id, $optParams);
	}
	catch (Exception $e)
	{
