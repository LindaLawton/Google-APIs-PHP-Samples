...
// Single Request.
$results = advertiserGroupsDeleteExample($service, $profileId, $id, $optParams);
...
*/
function advertiserGroupsDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->advertiserGroups->DeleteAdvertiserGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
