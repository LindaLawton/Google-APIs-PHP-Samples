...
// Single Request.
$results = subaccountsGetExample($service, $profileId, $id, $optParams);
...
* @return Subaccount
*/
function subaccountsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->subaccounts->GetSubaccounts($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
