...
// Single Request.
$results = adsGetExample($service, $profileId, $id, $optParams);
...
* @return Ad
*/
function adsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->ads->GetAds($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
