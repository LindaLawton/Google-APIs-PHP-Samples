...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'height' => '[YourValue]',  // Select only sizes with this height.
            
  //'iabStandard' => '[YourValue]',  // Select only IAB standard sizes.
            
  //'ids' => '[YourValue]',  // Select only sizes with these IDs.
            
  //'width' => '[YourValue]',  // Select only sizes with this width.
  'fields' => '*'
);
// Single Request.
$results = sizesListExample($service, $profileId, $optParams);
...
*/
function sizesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->sizes->ListSizes($profileId, $optParams);
	}
	catch (Exception $e)
	{
