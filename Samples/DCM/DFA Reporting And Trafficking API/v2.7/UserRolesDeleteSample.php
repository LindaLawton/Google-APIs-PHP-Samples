...
// Single Request.
$results = userRolesDeleteExample($service, $profileId, $id, $optParams);
...
*/
function userRolesDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->userRoles->DeleteUserRoles($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
