...
// Single Request.
$results = projectsGetExample($service, $profileId, $id, $optParams);
...
* @return Project
*/
function projectsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->projects->GetProjects($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
