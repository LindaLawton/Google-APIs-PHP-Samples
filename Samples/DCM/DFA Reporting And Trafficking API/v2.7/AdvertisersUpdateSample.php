...
// Single Request.
$results = advertisersUpdateExample($service, $profileId, $optParams);
...
* @return Advertiser
*/
function advertisersUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->advertisers->UpdateAdvertisers($profileId, $optParams);
	}
	catch (Exception $e)
	{
