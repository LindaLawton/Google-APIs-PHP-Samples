...
// Single Request.
$results = eventTagsGetExample($service, $profileId, $id, $optParams);
...
* @return EventTag
*/
function eventTagsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->eventTags->GetEventTags($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
