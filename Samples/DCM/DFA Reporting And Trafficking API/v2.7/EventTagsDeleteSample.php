...
// Single Request.
$results = eventTagsDeleteExample($service, $profileId, $id, $optParams);
...
*/
function eventTagsDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->eventTags->DeleteEventTags($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
