...
// Single Request.
$results = advertisersInsertExample($service, $profileId, $optParams);
...
* @return Advertiser
*/
function advertisersInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->advertisers->InsertAdvertisers($profileId, $optParams);
	}
	catch (Exception $e)
	{
