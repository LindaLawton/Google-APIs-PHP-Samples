...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  // Select only creative field values with these IDs.
  ...
  //'searchString' => '[YourValue]',  // Allows searching for creative field values by their values. Wildcards (e.g. *) are not allowed.
...
// Single Request.
$results = creativeFieldValuesListExample($service, $profileId, $creativeFieldId, $optParams);
...
do {
	...
	$results = filesListExample($service, $profileId, $creativeFieldId, $optParams);	
...
*/
function creativeFieldValuesListExample($service, $profileId, $creativeFieldId, $optParams)
{
	try
	{
		...
		if (creativeFieldId == null)
			throw new Exception("creativeFieldId is required.");
		if (profileId == null)
			throw new Exception("profileId is required.");
		// Make the request and return the results.
		return $service->creativeFieldValues->ListCreativeFieldValues($profileId, $creativeFieldId, $optParams);
	}
	catch (Exception $e)
	{
