...
// Single Request.
$results = creativesGetExample($service, $profileId, $id, $optParams);
...
* @return Creative
*/
function creativesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->creatives->GetCreatives($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
