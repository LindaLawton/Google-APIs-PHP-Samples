...
// Single Request.
$results = creativesPatchExample($service, $profileId, $id, $optParams);
...
* @return Creative
*/
function creativesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->creatives->PatchCreatives($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
