...
// Single Request.
$results = floodlightActivityGroupsGetExample($service, $profileId, $id, $optParams);
...
*/
function floodlightActivityGroupsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->floodlightActivityGroups->GetFloodlightActivityGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
