...
// Single Request.
$results = floodlightActivityGroupsUpdateExample($service, $profileId, $optParams);
...
*/
function floodlightActivityGroupsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightActivityGroups->UpdateFloodlightActivityGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
