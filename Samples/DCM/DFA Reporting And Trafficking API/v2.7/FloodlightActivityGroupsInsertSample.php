...
// Single Request.
$results = floodlightActivityGroupsInsertExample($service, $profileId, $optParams);
...
*/
function floodlightActivityGroupsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightActivityGroups->InsertFloodlightActivityGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
