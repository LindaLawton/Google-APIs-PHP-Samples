...
// Single Request.
$results = creativesUpdateExample($service, $profileId, $optParams);
...
* @return Creative
*/
function creativesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creatives->UpdateCreatives($profileId, $optParams);
	}
	catch (Exception $e)
	{
