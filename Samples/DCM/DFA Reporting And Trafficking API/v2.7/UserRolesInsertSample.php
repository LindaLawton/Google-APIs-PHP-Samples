...
// Single Request.
$results = userRolesInsertExample($service, $profileId, $optParams);
...
* @return UserRole
*/
function userRolesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->userRoles->InsertUserRoles($profileId, $optParams);
	}
	catch (Exception $e)
	{
