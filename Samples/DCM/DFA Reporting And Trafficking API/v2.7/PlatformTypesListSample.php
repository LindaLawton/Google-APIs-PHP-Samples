...
// Single Request.
$results = platformTypesListExample($service, $profileId, $optParams);
...
*/
function platformTypesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->platformTypes->ListPlatformTypes($profileId, $optParams);
	}
	catch (Exception $e)
	{
