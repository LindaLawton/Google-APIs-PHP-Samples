...
// Single Request.
$results = remarketingListSharesGetExample($service, $profileId, $remarketingListId, $optParams);
...
*/
function remarketingListSharesGetExample($service, $profileId, $remarketingListId, $optParams)
{
	try
	{
		...
		return $service->remarketingListShares->GetRemarketingListShares($profileId, $remarketingListId, $optParams);
	}
	catch (Exception $e)
	{
