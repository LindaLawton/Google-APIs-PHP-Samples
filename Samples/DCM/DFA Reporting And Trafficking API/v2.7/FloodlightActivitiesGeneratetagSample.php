...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'floodlightActivityId' => '[YourValue]',  // Floodlight activity ID for which we want to generate a tag.
  'fields' => '*'
);
// Single Request.
$results = floodlightActivitiesGeneratetagExample($service, $profileId, $optParams);
...
*/
function floodlightActivitiesGeneratetagExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightActivities->GeneratetagFloodlightActivities($profileId, $optParams);
	}
	catch (Exception $e)
	{
