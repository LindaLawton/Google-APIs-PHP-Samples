 ...
 * Initializes an Dfareporting.v2.7 service object.
 * @param string API key
 * @return An authorized Dfareporting.v2.7 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Dfareporting Sample");
		...
		// Create authenticated Dfareporting service
		return new Google_Service_Dfareporting($client);
	} catch (Exception $e) {
