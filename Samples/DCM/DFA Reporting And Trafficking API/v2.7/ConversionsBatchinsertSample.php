...
// Single Request.
$results = conversionsBatchinsertExample($service, $profileId, $optParams);
...
*/
function conversionsBatchinsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->conversions->BatchinsertConversions($profileId, $optParams);
	}
	catch (Exception $e)
	{
