...
// Single Request.
$results = placementGroupsGetExample($service, $profileId, $id, $optParams);
...
*/
function placementGroupsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->placementGroups->GetPlacementGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
