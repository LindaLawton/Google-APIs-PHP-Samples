...
// Single Request.
$results = campaignCreativeAssociationsListExample($service, $profileId, $campaignId, $optParams);
...
do {
	...
	$results = filesListExample($service, $profileId, $campaignId, $optParams);	
...
*/
function campaignCreativeAssociationsListExample($service, $profileId, $campaignId, $optParams)
{
	try
	{
		...
		if (campaignId == null)
			throw new Exception("campaignId is required.");
		if (profileId == null)
			throw new Exception("profileId is required.");
		// Make the request and return the results.
		return $service->campaignCreativeAssociations->ListCampaignCreativeAssociations($profileId, $campaignId, $optParams);
	}
	catch (Exception $e)
	{
