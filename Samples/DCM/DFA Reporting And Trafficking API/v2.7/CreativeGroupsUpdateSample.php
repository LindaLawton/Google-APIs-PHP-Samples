...
// Single Request.
$results = creativeGroupsUpdateExample($service, $profileId, $optParams);
...
*/
function creativeGroupsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creativeGroups->UpdateCreativeGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
