...
// Single Request.
$results = remarketingListsPatchExample($service, $profileId, $id, $optParams);
...
*/
function remarketingListsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->remarketingLists->PatchRemarketingLists($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
