...
// Single Request.
$results = postalCodesGetExample($service, $profileId, $code, $optParams);
...
* @return PostalCode
*/
function postalCodesGetExample($service, $profileId, $code, $optParams)
{
	try
	{
		...
		return $service->postalCodes->GetPostalCodes($profileId, $code, $optParams);
	}
	catch (Exception $e)
	{
