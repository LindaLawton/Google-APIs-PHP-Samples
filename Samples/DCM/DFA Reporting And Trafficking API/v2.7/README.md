...
# UnOfficial DCM/DFA Reporting And Trafficking API v2.7 Samples for PHP
...
These samples show how to access the [DCM/DFA Reporting And Trafficking API v2.7](https://developers.google.com/doubleclick-advertisers/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
