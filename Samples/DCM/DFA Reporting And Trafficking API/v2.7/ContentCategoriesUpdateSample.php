...
// Single Request.
$results = contentCategoriesUpdateExample($service, $profileId, $optParams);
...
*/
function contentCategoriesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->contentCategories->UpdateContentCategories($profileId, $optParams);
	}
	catch (Exception $e)
	{
