...
// Single Request.
$results = accountUserProfilesUpdateExample($service, $profileId, $optParams);
...
*/
function accountUserProfilesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->accountUserProfiles->UpdateAccountUserProfiles($profileId, $optParams);
	}
	catch (Exception $e)
	{
