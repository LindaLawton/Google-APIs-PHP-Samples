...
// Single Request.
$results = browsersListExample($service, $profileId, $optParams);
...
*/
function browsersListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->browsers->ListBrowsers($profileId, $optParams);
	}
	catch (Exception $e)
	{
