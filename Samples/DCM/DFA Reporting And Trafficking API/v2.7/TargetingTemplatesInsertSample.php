...
// Single Request.
$results = targetingTemplatesInsertExample($service, $profileId, $optParams);
...
*/
function targetingTemplatesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->targetingTemplates->InsertTargetingTemplates($profileId, $optParams);
	}
	catch (Exception $e)
	{
