...
// Single Request.
$results = subaccountsInsertExample($service, $profileId, $optParams);
...
* @return Subaccount
*/
function subaccountsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->subaccounts->InsertSubaccounts($profileId, $optParams);
	}
	catch (Exception $e)
	{
