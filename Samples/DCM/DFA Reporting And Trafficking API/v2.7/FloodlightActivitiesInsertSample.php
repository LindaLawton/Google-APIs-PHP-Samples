...
// Single Request.
$results = floodlightActivitiesInsertExample($service, $profileId, $optParams);
...
*/
function floodlightActivitiesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightActivities->InsertFloodlightActivities($profileId, $optParams);
	}
	catch (Exception $e)
	{
