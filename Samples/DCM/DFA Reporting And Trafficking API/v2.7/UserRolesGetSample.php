...
// Single Request.
$results = userRolesGetExample($service, $profileId, $id, $optParams);
...
* @return UserRole
*/
function userRolesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->userRoles->GetUserRoles($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
