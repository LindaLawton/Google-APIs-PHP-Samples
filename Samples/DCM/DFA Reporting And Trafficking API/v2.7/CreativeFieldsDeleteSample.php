...
// Single Request.
$results = creativeFieldsDeleteExample($service, $profileId, $id, $optParams);
...
*/
function creativeFieldsDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->creativeFields->DeleteCreativeFields($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
