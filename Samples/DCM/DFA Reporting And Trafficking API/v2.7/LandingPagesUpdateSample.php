...
// Single Request.
$results = landingPagesUpdateExample($service, $profileId, $campaignId, $optParams);
...
* @return LandingPage
*/
function landingPagesUpdateExample($service, $profileId, $campaignId, $optParams)
{
	try
	{
		...
		return $service->landingPages->UpdateLandingPages($profileId, $campaignId, $optParams);
	}
	catch (Exception $e)
	{
