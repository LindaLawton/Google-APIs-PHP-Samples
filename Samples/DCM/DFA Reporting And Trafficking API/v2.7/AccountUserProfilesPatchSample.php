...
// Single Request.
$results = accountUserProfilesPatchExample($service, $profileId, $id, $optParams);
...
*/
function accountUserProfilesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->accountUserProfiles->PatchAccountUserProfiles($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
