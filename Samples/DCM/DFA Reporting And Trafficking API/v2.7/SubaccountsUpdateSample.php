...
// Single Request.
$results = subaccountsUpdateExample($service, $profileId, $optParams);
...
* @return Subaccount
*/
function subaccountsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->subaccounts->UpdateSubaccounts($profileId, $optParams);
	}
	catch (Exception $e)
	{
