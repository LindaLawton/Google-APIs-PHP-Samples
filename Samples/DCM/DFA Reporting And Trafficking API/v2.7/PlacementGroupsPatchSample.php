...
// Single Request.
$results = placementGroupsPatchExample($service, $profileId, $id, $optParams);
...
*/
function placementGroupsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->placementGroups->PatchPlacementGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
