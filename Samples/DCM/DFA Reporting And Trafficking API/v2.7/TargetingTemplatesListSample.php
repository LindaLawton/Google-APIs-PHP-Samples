...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'advertiserId' => '[YourValue]',  // Select only targeting templates with this advertiser ID.
            
  //'ids' => '[YourValue]',  // Select only targeting templates with these IDs.
  ...
  //'searchString' => '[YourValue]',  // Allows searching for objects by name or ID. Wildcards (*) are allowed. For example, "template*2015" will return objects with names like "template June 2015", "template April 2015", or simply "template 2015". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of "template" will match objects with name "my template", "template 2015", or simply "template".
...
// Single Request.
$results = targetingTemplatesListExample($service, $profileId, $optParams);
...
*/
function targetingTemplatesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->targetingTemplates->ListTargetingTemplates($profileId, $optParams);
	}
	catch (Exception $e)
	{
