...
// Single Request.
$results = userProfilesListExample($service, $optParams);
...
*/
function userProfilesListExample($service, $optParams)
{
	try
	{
		...
		return $service->userProfiles->ListUserProfiles($optParams);
	}
	catch (Exception $e)
	{
