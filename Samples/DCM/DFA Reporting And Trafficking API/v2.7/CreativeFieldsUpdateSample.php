...
// Single Request.
$results = creativeFieldsUpdateExample($service, $profileId, $optParams);
...
*/
function creativeFieldsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creativeFields->UpdateCreativeFields($profileId, $optParams);
	}
	catch (Exception $e)
	{
