...
// Single Request.
$results = accountPermissionsListExample($service, $profileId, $optParams);
...
*/
function accountPermissionsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->accountPermissions->ListAccountPermissions($profileId, $optParams);
	}
	catch (Exception $e)
	{
