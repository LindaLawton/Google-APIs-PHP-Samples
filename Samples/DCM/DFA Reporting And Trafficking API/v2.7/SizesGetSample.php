...
// Single Request.
$results = sizesGetExample($service, $profileId, $id, $optParams);
...
* @return Size
*/
function sizesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->sizes->GetSizes($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
