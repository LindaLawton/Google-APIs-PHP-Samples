...
// Single Request.
$results = placementStrategiesPatchExample($service, $profileId, $id, $optParams);
...
*/
function placementStrategiesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->placementStrategies->PatchPlacementStrategies($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
