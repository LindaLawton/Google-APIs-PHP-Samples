...
// Single Request.
$results = floodlightConfigurationsPatchExample($service, $profileId, $id, $optParams);
...
*/
function floodlightConfigurationsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->floodlightConfigurations->PatchFloodlightConfigurations($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
