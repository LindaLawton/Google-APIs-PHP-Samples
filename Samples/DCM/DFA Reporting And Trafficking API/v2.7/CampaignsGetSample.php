...
// Single Request.
$results = campaignsGetExample($service, $profileId, $id, $optParams);
...
* @return Campaign
*/
function campaignsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->campaigns->GetCampaigns($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
