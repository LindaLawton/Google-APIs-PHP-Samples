...
// Single Request.
$results = ordersGetExample($service, $profileId, $projectId, $id, $optParams);
...
* @return Order
*/
function ordersGetExample($service, $profileId, $projectId, $id, $optParams)
{
	try
	{
		...
		return $service->orders->GetOrders($profileId, $projectId, $id, $optParams);
	}
	catch (Exception $e)
	{
