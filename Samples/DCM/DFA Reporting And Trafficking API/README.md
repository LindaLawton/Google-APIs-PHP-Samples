...
# Unoffical DCM/DFA Reporting And Trafficking API Samples for PHP
...
These samples show how to access the [DCM/DFA Reporting And Trafficking API](https://developers.google.com/doubleclick-advertisers/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
