...
// Single Request.
$results = videoFormatsGetExample($service, $profileId, $id, $optParams);
...
* @return VideoFormat
*/
function videoFormatsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->videoFormats->GetVideoFormats($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
