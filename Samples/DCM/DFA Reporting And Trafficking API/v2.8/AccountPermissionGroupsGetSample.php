...
// Single Request.
$results = accountPermissionGroupsGetExample($service, $profileId, $id, $optParams);
...
*/
function accountPermissionGroupsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->accountPermissionGroups->GetAccountPermissionGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
