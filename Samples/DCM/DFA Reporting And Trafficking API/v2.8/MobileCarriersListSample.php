...
// Single Request.
$results = mobileCarriersListExample($service, $profileId, $optParams);
...
*/
function mobileCarriersListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->mobileCarriers->ListMobileCarriers($profileId, $optParams);
	}
	catch (Exception $e)
	{
