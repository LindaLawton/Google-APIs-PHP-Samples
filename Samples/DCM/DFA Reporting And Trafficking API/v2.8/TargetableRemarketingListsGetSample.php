...
// Single Request.
$results = targetableRemarketingListsGetExample($service, $profileId, $id, $optParams);
...
*/
function targetableRemarketingListsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->targetableRemarketingLists->GetTargetableRemarketingLists($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
