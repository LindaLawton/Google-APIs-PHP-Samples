...
// Single Request.
$results = sitesGetExample($service, $profileId, $id, $optParams);
...
* @return Site
*/
function sitesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->sites->GetSites($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
