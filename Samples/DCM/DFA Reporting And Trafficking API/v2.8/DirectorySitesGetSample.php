...
// Single Request.
$results = directorySitesGetExample($service, $profileId, $id, $optParams);
...
*/
function directorySitesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->directorySites->GetDirectorySites($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
