...
// Single Request.
$results = advertisersGetExample($service, $profileId, $id, $optParams);
...
* @return Advertiser
*/
function advertisersGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->advertisers->GetAdvertisers($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
