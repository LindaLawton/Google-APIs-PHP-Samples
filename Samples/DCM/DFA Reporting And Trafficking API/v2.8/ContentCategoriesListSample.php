...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  //Select only content categories with these IDs.
  ...
  //'searchString' => '[YourValue]',  //Allows searching for objects by name or ID. Wildcards (*) are allowed. For example, "contentcategory*2015" will return objects with names like "contentcategory June 2015", "contentcategory April 2015", or simply "contentcategory 2015". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of "contentcategory" will match objects with name "my contentcategory", "contentcategory 2015", or simply "contentcategory".
...
// Single Request.
$results = contentCategoriesListExample($service, $profileId, $optParams);
...
*/
function contentCategoriesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->contentCategories->ListContentCategories($profileId, $optParams);
	}
	catch (Exception $e)
	{
