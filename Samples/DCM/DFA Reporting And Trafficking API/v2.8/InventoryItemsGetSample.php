...
// Single Request.
$results = inventoryItemsGetExample($service, $profileId, $projectId, $id, $optParams);
...
*/
function inventoryItemsGetExample($service, $profileId, $projectId, $id, $optParams)
{
	try
	{
		...
		return $service->inventoryItems->GetInventoryItems($profileId, $projectId, $id, $optParams);
	}
	catch (Exception $e)
	{
