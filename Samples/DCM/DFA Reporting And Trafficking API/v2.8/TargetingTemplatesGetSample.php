...
// Single Request.
$results = targetingTemplatesGetExample($service, $profileId, $id, $optParams);
...
*/
function targetingTemplatesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->targetingTemplates->GetTargetingTemplates($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
