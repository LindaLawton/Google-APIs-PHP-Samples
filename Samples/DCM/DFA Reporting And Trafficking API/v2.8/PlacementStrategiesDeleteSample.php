...
// Single Request.
$results = placementStrategiesDeleteExample($service, $profileId, $id, $optParams);
...
*/
function placementStrategiesDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->placementStrategies->DeletePlacementStrategies($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
