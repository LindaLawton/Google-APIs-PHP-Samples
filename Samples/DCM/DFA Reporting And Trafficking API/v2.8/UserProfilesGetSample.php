...
// Single Request.
$results = userProfilesGetExample($service, $profileId, $optParams);
...
* @return UserProfile
*/
function userProfilesGetExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->userProfiles->GetUserProfiles($profileId, $optParams);
	}
	catch (Exception $e)
	{
