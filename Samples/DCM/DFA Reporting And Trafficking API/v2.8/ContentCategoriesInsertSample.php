...
// Single Request.
$results = contentCategoriesInsertExample($service, $profileId, $optParams);
...
*/
function contentCategoriesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->contentCategories->InsertContentCategories($profileId, $optParams);
	}
	catch (Exception $e)
	{
