...
// Single Request.
$results = creativeFieldValuesGetExample($service, $profileId, $creativeFieldId, $id, $optParams);
...
*/
function creativeFieldValuesGetExample($service, $profileId, $creativeFieldId, $id, $optParams)
{
	try
	{
		...
		return $service->creativeFieldValues->GetCreativeFieldValues($profileId, $creativeFieldId, $id, $optParams);
	}
	catch (Exception $e)
	{
