...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  //Select only advertiser groups with these IDs.
  ...
  //'searchString' => '[YourValue]',  //Allows searching for objects by name or ID. Wildcards (*) are allowed. For example, "advertiser*2015" will return objects with names like "advertiser group June 2015", "advertiser group April 2015", or simply "advertiser group 2015". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of "advertisergroup" will match objects with name "my advertisergroup", "advertisergroup 2015", or simply "advertisergroup".
...
// Single Request.
$results = advertiserGroupsListExample($service, $profileId, $optParams);
...
*/
function advertiserGroupsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->advertiserGroups->ListAdvertiserGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
