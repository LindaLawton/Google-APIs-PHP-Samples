...
// Single Request.
$results = metrosListExample($service, $profileId, $optParams);
...
*/
function metrosListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->metros->ListMetros($profileId, $optParams);
	}
	catch (Exception $e)
	{
