...
// Single Request.
$results = remarketingListsInsertExample($service, $profileId, $optParams);
...
*/
function remarketingListsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->remarketingLists->InsertRemarketingLists($profileId, $optParams);
	}
	catch (Exception $e)
	{
