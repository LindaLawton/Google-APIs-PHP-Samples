...
// Single Request.
$results = connectionTypesGetExample($service, $profileId, $id, $optParams);
...
*/
function connectionTypesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->connectionTypes->GetConnectionTypes($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
