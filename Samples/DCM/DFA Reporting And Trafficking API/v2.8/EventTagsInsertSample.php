...
// Single Request.
$results = eventTagsInsertExample($service, $profileId, $optParams);
...
* @return EventTag
*/
function eventTagsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->eventTags->InsertEventTags($profileId, $optParams);
	}
	catch (Exception $e)
	{
