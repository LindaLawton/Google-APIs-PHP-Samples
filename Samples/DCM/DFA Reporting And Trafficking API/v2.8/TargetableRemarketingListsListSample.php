...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'active' => '[YourValue]',  // Select only active or only inactive targetable remarketing lists.
...
// Single Request.
$results = targetableRemarketingListsListExample($service, $profileId, $advertiserId, $optParams);
...
*/
function targetableRemarketingListsListExample($service, $profileId, $advertiserId, $optParams)
{
	try
	{
		...
		return $service->targetableRemarketingLists->ListTargetableRemarketingLists($profileId, $advertiserId, $optParams);
	}
	catch (Exception $e)
	{
