...
// Single Request.
$results = creativeFieldsPatchExample($service, $profileId, $id, $optParams);
...
*/
function creativeFieldsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->creativeFields->PatchCreativeFields($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
