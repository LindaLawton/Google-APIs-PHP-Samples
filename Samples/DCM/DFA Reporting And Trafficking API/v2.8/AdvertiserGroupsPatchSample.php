...
// Single Request.
$results = advertiserGroupsPatchExample($service, $profileId, $id, $optParams);
...
*/
function advertiserGroupsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->advertiserGroups->PatchAdvertiserGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
