...
// Single Request.
$results = floodlightActivitiesGetExample($service, $profileId, $id, $optParams);
...
*/
function floodlightActivitiesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->floodlightActivities->GetFloodlightActivities($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
