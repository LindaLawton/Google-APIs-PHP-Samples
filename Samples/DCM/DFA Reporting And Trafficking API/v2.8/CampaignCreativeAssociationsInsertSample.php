...
// Single Request.
$results = campaignCreativeAssociationsInsertExample($service, $profileId, $campaignId, $optParams);
...
*/
function campaignCreativeAssociationsInsertExample($service, $profileId, $campaignId, $optParams)
{
	try
	{
		...
		return $service->campaignCreativeAssociations->InsertCampaignCreativeAssociations($profileId, $campaignId, $optParams);
	}
	catch (Exception $e)
	{
