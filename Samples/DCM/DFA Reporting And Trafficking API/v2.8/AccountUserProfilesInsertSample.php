...
// Single Request.
$results = accountUserProfilesInsertExample($service, $profileId, $optParams);
...
*/
function accountUserProfilesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->accountUserProfiles->InsertAccountUserProfiles($profileId, $optParams);
	}
	catch (Exception $e)
	{
