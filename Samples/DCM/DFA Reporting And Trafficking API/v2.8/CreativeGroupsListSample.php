...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'advertiserIds' => '[YourValue]',  //Select only creative groups that belong to these advertisers.
            
  //'groupNumber' => '[YourValue]',  //Select only creative groups that belong to this subgroup.
            
  //'ids' => '[YourValue]',  //Select only creative groups with these IDs.
...
// Single Request.
$results = creativeGroupsListExample($service, $profileId, $optParams);
...
*/
function creativeGroupsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creativeGroups->ListCreativeGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
