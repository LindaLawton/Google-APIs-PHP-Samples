...
// Single Request.
$results = adsPatchExample($service, $profileId, $id, $optParams);
...
* @return Ad
*/
function adsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->ads->PatchAds($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
