...
// Single Request.
$results = accountActiveAdSummariesGetExample($service, $profileId, $summaryAccountId, $optParams);
...
*/
function accountActiveAdSummariesGetExample($service, $profileId, $summaryAccountId, $optParams)
{
	try
	{
		...
		if (summaryAccountId == null)
			throw new Exception("summaryAccountId is required.");
		// Make the request and return the results.
		return $service->accountActiveAdSummaries->GetAccountActiveAdSummaries($profileId, $summaryAccountId, $optParams);
	}
	catch (Exception $e)
	{
