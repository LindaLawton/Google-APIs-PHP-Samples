...
// Single Request.
$results = accountsUpdateExample($service, $profileId, $optParams);
...
* @return Account
*/
function accountsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->accounts->UpdateAccounts($profileId, $optParams);
	}
	catch (Exception $e)
	{
