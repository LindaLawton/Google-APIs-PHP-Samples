...
// Single Request.
$results = mobileCarriersGetExample($service, $profileId, $id, $optParams);
...
*/
function mobileCarriersGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->mobileCarriers->GetMobileCarriers($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
