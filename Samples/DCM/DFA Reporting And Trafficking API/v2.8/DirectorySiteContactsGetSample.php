...
// Single Request.
$results = directorySiteContactsGetExample($service, $profileId, $id, $optParams);
...
* @return DirectorySiteContact
*/
function directorySiteContactsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->directorySiteContacts->GetDirectorySiteContacts($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
