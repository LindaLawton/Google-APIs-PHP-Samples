...
// Single Request.
$results = landingPagesListExample($service, $profileId, $campaignId, $optParams);
...
*/
function landingPagesListExample($service, $profileId, $campaignId, $optParams)
{
	try
	{
		...
		return $service->landingPages->ListLandingPages($profileId, $campaignId, $optParams);
	}
	catch (Exception $e)
	{
