...
// Single Request.
$results = eventTagsUpdateExample($service, $profileId, $optParams);
...
* @return EventTag
*/
function eventTagsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->eventTags->UpdateEventTags($profileId, $optParams);
	}
	catch (Exception $e)
	{
