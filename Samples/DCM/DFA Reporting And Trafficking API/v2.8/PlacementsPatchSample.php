...
// Single Request.
$results = placementsPatchExample($service, $profileId, $id, $optParams);
...
* @return Placement
*/
function placementsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->placements->PatchPlacements($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
