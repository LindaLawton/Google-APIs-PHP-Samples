...
// Single Request.
$results = countriesGetExample($service, $profileId, $dartId, $optParams);
...
* @return Country
*/
function countriesGetExample($service, $profileId, $dartId, $optParams)
{
	try
	{
		...
		return $service->countries->GetCountries($profileId, $dartId, $optParams);
	}
	catch (Exception $e)
	{
