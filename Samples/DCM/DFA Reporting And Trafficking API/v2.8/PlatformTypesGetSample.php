...
// Single Request.
$results = platformTypesGetExample($service, $profileId, $id, $optParams);
...
* @return PlatformType
*/
function platformTypesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->platformTypes->GetPlatformTypes($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
