...
// Single Request.
$results = adsUpdateExample($service, $profileId, $optParams);
...
* @return Ad
*/
function adsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->ads->UpdateAds($profileId, $optParams);
	}
	catch (Exception $e)
	{
