...
// Single Request.
$results = floodlightActivitiesDeleteExample($service, $profileId, $id, $optParams);
...
*/
function floodlightActivitiesDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->floodlightActivities->DeleteFloodlightActivities($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
