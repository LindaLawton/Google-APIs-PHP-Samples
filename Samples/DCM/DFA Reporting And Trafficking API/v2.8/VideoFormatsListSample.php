...
// Single Request.
$results = videoFormatsListExample($service, $profileId, $optParams);
...
*/
function videoFormatsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->videoFormats->ListVideoFormats($profileId, $optParams);
	}
	catch (Exception $e)
	{
