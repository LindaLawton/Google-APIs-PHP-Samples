...
// Single Request.
$results = floodlightConfigurationsUpdateExample($service, $profileId, $optParams);
...
*/
function floodlightConfigurationsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightConfigurations->UpdateFloodlightConfigurations($profileId, $optParams);
	}
	catch (Exception $e)
	{
