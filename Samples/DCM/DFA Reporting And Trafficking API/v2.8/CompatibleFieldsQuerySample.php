...
// Single Request.
$results = compatibleFieldsQueryExample($service, $profileId, $optParams);
...
*/
function compatibleFieldsQueryExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->compatibleFields->QueryCompatibleFields($profileId, $optParams);
	}
	catch (Exception $e)
	{
