...
// Single Request.
$results = creativeFieldValuesPatchExample($service, $profileId, $creativeFieldId, $id, $optParams);
...
*/
function creativeFieldValuesPatchExample($service, $profileId, $creativeFieldId, $id, $optParams)
{
	try
	{
		...
		return $service->creativeFieldValues->PatchCreativeFieldValues($profileId, $creativeFieldId, $id, $optParams);
	}
	catch (Exception $e)
	{
