...
// Single Request.
$results = sitesInsertExample($service, $profileId, $optParams);
...
* @return Site
*/
function sitesInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->sites->InsertSites($profileId, $optParams);
	}
	catch (Exception $e)
	{
