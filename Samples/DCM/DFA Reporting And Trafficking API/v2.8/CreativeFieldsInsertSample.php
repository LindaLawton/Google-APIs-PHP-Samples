...
// Single Request.
$results = creativeFieldsInsertExample($service, $profileId, $optParams);
...
*/
function creativeFieldsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creativeFields->InsertCreativeFields($profileId, $optParams);
	}
	catch (Exception $e)
	{
