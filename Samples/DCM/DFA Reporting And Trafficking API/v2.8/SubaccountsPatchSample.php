...
// Single Request.
$results = subaccountsPatchExample($service, $profileId, $id, $optParams);
...
* @return Subaccount
*/
function subaccountsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->subaccounts->PatchSubaccounts($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
