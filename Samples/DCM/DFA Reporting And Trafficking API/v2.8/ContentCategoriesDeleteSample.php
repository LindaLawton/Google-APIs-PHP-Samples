...
// Single Request.
$results = contentCategoriesDeleteExample($service, $profileId, $id, $optParams);
...
*/
function contentCategoriesDeleteExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->contentCategories->DeleteContentCategories($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
