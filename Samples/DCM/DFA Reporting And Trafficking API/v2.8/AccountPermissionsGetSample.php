...
// Single Request.
$results = accountPermissionsGetExample($service, $profileId, $id, $optParams);
...
*/
function accountPermissionsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->accountPermissions->GetAccountPermissions($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
