...
// Single Request.
$results = contentCategoriesGetExample($service, $profileId, $id, $optParams);
...
*/
function contentCategoriesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->contentCategories->GetContentCategories($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
