...
# UnOfficial DCM/DFA Reporting And Trafficking API v2.8 Samples for PHP

## API Description

Manages your DoubleClick Campaign Manager ad campaigns and reports.

[Official Documentation](https://developers.google.com/doubleclick-advertisers/)

## Sample Description

These samples show how to access the [DCM/DFA Reporting And Trafficking API v2.8](https://developers.google.com/doubleclick-advertisers/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
