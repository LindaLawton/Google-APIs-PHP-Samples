...
// Single Request.
$results = userRolePermissionsGetExample($service, $profileId, $id, $optParams);
...
*/
function userRolePermissionsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->userRolePermissions->GetUserRolePermissions($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
