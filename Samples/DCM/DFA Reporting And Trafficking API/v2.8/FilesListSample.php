...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageToken' => '[YourValue]',  //The value of the nextToken from the previous result page.
            
  //'sortField' => '[YourValue]',  //The field by which to sort the list.
            
  //'sortOrder' => '[YourValue]',  //Order of sorted results.
  'fields' => '*'
);
// Single Request.
$results = filesListExample($service, $profileId, $reportId, $optParams);
...
* @return FileList
*/
function filesListExample($service, $profileId, $reportId, $optParams)
{
	try
	{
		...
		return $service->files->ListFiles($profileId, $reportId, $optParams);
	}
	catch (Exception $e)
	{
