...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ids' => '[YourValue]',  //Select only user role permissions with these IDs.
  'fields' => '*'
);
// Single Request.
$results = userRolePermissionsListExample($service, $profileId, $optParams);
...
*/
function userRolePermissionsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->userRolePermissions->ListUserRolePermissions($profileId, $optParams);
	}
	catch (Exception $e)
	{
