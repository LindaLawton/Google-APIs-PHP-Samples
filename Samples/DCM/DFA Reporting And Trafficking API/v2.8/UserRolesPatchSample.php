...
// Single Request.
$results = userRolesPatchExample($service, $profileId, $id, $optParams);
...
* @return UserRole
*/
function userRolesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->userRoles->PatchUserRoles($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
