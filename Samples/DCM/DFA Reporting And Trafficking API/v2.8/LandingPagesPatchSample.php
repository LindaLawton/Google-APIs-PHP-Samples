...
// Single Request.
$results = landingPagesPatchExample($service, $profileId, $campaignId, $id, $optParams);
...
* @return LandingPage
*/
function landingPagesPatchExample($service, $profileId, $campaignId, $id, $optParams)
{
	try
	{
		...
		return $service->landingPages->PatchLandingPages($profileId, $campaignId, $id, $optParams);
	}
	catch (Exception $e)
	{
