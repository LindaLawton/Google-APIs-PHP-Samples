...
// Single Request.
$results = dynamicTargetingKeysDeleteExample($service, $profileId, $objectId, $name, $objectType, $optParams);
...
*/
function dynamicTargetingKeysDeleteExample($service, $profileId, $objectId, $name, $objectType, $optParams)
{
	try
	{
		...
		if (objectId == null)
			throw new Exception("objectId is required.");
		if (objectType == null)
			throw new Exception("objectType is required.");
		if (profileId == null)
			throw new Exception("profileId is required.");
		// Make the request and return the results.
		 $service->dynamicTargetingKeys->DeleteDynamicTargetingKeys($profileId, $objectId, $name, $objectType, $optParams);
	}
	catch (Exception $e)
	{
