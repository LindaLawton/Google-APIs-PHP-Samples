...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'advertiserIds' => '[YourValue]',  // Select only creative fields that belong to these advertisers.
            
  //'ids' => '[YourValue]',  // Select only creative fields with these IDs.
...
// Single Request.
$results = creativeFieldsListExample($service, $profileId, $optParams);
...
*/
function creativeFieldsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creativeFields->ListCreativeFields($profileId, $optParams);
	}
	catch (Exception $e)
	{
