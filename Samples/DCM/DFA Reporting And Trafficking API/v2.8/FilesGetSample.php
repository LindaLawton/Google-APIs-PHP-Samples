...
// Single Request.
$results = filesGetExample($service, $profileId, $reportId, $fileId, $optParams);
...
* @return File
*/
function filesGetExample($service, $profileId, $reportId, $fileId, $optParams)
{
	try
	{
		...
		return $service->files->GetFiles($profileId, $reportId, $fileId, $optParams);
	}
	catch (Exception $e)
	{
