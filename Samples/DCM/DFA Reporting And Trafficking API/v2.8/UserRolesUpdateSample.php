...
// Single Request.
$results = userRolesUpdateExample($service, $profileId, $optParams);
...
* @return UserRole
*/
function userRolesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->userRoles->UpdateUserRoles($profileId, $optParams);
	}
	catch (Exception $e)
	{
