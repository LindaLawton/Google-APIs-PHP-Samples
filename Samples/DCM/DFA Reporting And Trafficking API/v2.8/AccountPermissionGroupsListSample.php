...
// Single Request.
$results = accountPermissionGroupsListExample($service, $profileId, $optParams);
...
*/
function accountPermissionGroupsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->accountPermissionGroups->ListAccountPermissionGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
