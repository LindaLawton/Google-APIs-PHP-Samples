...
// Single Request.
$results = campaignsUpdateExample($service, $profileId, $optParams);
...
* @return Campaign
*/
function campaignsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->campaigns->UpdateCampaigns($profileId, $optParams);
	}
	catch (Exception $e)
	{
