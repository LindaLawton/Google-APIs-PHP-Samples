...
// Single Request.
$results = floodlightActivitiesUpdateExample($service, $profileId, $optParams);
...
*/
function floodlightActivitiesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->floodlightActivities->UpdateFloodlightActivities($profileId, $optParams);
	}
	catch (Exception $e)
	{
