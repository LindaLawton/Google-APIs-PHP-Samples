...
// Single Request.
$results = contentCategoriesPatchExample($service, $profileId, $id, $optParams);
...
*/
function contentCategoriesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->contentCategories->PatchContentCategories($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
