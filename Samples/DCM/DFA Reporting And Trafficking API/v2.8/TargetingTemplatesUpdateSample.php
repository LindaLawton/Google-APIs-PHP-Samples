...
// Single Request.
$results = targetingTemplatesUpdateExample($service, $profileId, $optParams);
...
*/
function targetingTemplatesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->targetingTemplates->UpdateTargetingTemplates($profileId, $optParams);
	}
	catch (Exception $e)
	{
