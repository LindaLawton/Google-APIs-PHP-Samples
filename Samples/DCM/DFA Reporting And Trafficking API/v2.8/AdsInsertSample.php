...
// Single Request.
$results = adsInsertExample($service, $profileId, $optParams);
...
* @return Ad
*/
function adsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->ads->InsertAds($profileId, $optParams);
	}
	catch (Exception $e)
	{
