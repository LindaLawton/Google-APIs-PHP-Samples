...
// Single Request.
$results = remarketingListsUpdateExample($service, $profileId, $optParams);
...
*/
function remarketingListsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->remarketingLists->UpdateRemarketingLists($profileId, $optParams);
	}
	catch (Exception $e)
	{
