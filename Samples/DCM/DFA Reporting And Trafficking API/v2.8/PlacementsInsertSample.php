...
// Single Request.
$results = placementsInsertExample($service, $profileId, $optParams);
...
* @return Placement
*/
function placementsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->placements->InsertPlacements($profileId, $optParams);
	}
	catch (Exception $e)
	{
