...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'directorySiteIds' => '[YourValue]',  // Select only directory site contacts with these directory site IDs. This is a required field.
            
  //'ids' => '[YourValue]',  // Select only directory site contacts with these IDs.
  ...
  //'searchString' => '[YourValue]',  // Allows searching for objects by name, ID or email. Wildcards (*) are allowed. For example, "directory site contact*2015" will return objects with names like "directory site contact June 2015", "directory site contact April 2015", or simply "directory site contact 2015". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of "directory site contact" will match objects with name "my directory site contact", "directory site contact 2015", or simply "directory site contact".
...
// Single Request.
$results = directorySiteContactsListExample($service, $profileId, $optParams);
...
* @return DirectorySiteContactsListResponse
*/
function directorySiteContactsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->directorySiteContacts->ListDirectorySiteContacts($profileId, $optParams);
	}
	catch (Exception $e)
	{
