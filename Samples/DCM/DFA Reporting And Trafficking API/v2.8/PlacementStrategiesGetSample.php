...
// Single Request.
$results = placementStrategiesGetExample($service, $profileId, $id, $optParams);
...
*/
function placementStrategiesGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->placementStrategies->GetPlacementStrategies($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
