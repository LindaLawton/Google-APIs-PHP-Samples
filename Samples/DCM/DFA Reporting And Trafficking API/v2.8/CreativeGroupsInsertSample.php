...
// Single Request.
$results = creativeGroupsInsertExample($service, $profileId, $optParams);
...
*/
function creativeGroupsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->creativeGroups->InsertCreativeGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
