...
// Single Request.
$results = placementsGetExample($service, $profileId, $id, $optParams);
...
* @return Placement
*/
function placementsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->placements->GetPlacements($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
