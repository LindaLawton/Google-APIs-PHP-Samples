...
// Single Request.
$results = conversionsBatchupdateExample($service, $profileId, $optParams);
...
*/
function conversionsBatchupdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->conversions->BatchupdateConversions($profileId, $optParams);
	}
	catch (Exception $e)
	{
