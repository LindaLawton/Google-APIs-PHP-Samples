...
// Single Request.
$results = regionsListExample($service, $profileId, $optParams);
...
*/
function regionsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->regions->ListRegions($profileId, $optParams);
	}
	catch (Exception $e)
	{
