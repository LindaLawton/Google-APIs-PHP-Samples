...
// Single Request.
$results = advertiserGroupsInsertExample($service, $profileId, $optParams);
...
*/
function advertiserGroupsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->advertiserGroups->InsertAdvertiserGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
