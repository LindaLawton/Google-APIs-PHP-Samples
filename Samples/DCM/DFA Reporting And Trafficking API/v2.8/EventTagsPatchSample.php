...
// Single Request.
$results = eventTagsPatchExample($service, $profileId, $id, $optParams);
...
* @return EventTag
*/
function eventTagsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->eventTags->PatchEventTags($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
