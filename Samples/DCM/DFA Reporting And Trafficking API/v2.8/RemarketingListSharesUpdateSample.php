...
// Single Request.
$results = remarketingListSharesUpdateExample($service, $profileId, $optParams);
...
*/
function remarketingListSharesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->remarketingListShares->UpdateRemarketingListShares($profileId, $optParams);
	}
	catch (Exception $e)
	{
