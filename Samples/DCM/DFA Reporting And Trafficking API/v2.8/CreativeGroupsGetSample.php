...
// Single Request.
$results = creativeGroupsGetExample($service, $profileId, $id, $optParams);
...
*/
function creativeGroupsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->creativeGroups->GetCreativeGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
