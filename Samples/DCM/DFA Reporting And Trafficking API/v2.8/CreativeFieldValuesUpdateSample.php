...
// Single Request.
$results = creativeFieldValuesUpdateExample($service, $profileId, $creativeFieldId, $optParams);
...
*/
function creativeFieldValuesUpdateExample($service, $profileId, $creativeFieldId, $optParams)
{
	try
	{
		...
		return $service->creativeFieldValues->UpdateCreativeFieldValues($profileId, $creativeFieldId, $optParams);
	}
	catch (Exception $e)
	{
