...
// Single Request.
$results = sitesPatchExample($service, $profileId, $id, $optParams);
...
* @return Site
*/
function sitesPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->sites->PatchSites($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
