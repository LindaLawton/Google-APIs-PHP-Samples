...
// Single Request.
$results = floodlightConfigurationsGetExample($service, $profileId, $id, $optParams);
...
*/
function floodlightConfigurationsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->floodlightConfigurations->GetFloodlightConfigurations($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
