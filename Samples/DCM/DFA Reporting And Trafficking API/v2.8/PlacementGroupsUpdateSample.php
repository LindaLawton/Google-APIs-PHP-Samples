...
// Single Request.
$results = placementGroupsUpdateExample($service, $profileId, $optParams);
...
*/
function placementGroupsUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->placementGroups->UpdatePlacementGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
