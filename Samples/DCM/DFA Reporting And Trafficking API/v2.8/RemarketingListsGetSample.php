...
// Single Request.
$results = remarketingListsGetExample($service, $profileId, $id, $optParams);
...
*/
function remarketingListsGetExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->remarketingLists->GetRemarketingLists($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
