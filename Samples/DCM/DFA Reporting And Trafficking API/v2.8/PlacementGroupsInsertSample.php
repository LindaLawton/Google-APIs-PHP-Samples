...
// Single Request.
$results = placementGroupsInsertExample($service, $profileId, $optParams);
...
*/
function placementGroupsInsertExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->placementGroups->InsertPlacementGroups($profileId, $optParams);
	}
	catch (Exception $e)
	{
