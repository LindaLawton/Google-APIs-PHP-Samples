...
// Single Request.
$results = campaignsPatchExample($service, $profileId, $id, $optParams);
...
* @return Campaign
*/
function campaignsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->campaigns->PatchCampaigns($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
