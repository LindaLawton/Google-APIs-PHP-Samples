...
// Single Request.
$results = operatingSystemsGetExample($service, $profileId, $dartId, $optParams);
...
*/
function operatingSystemsGetExample($service, $profileId, $dartId, $optParams)
{
	try
	{
		...
		if (dartId == null)
			throw new Exception("dartId is required.");
		if (profileId == null)
			throw new Exception("profileId is required.");
		// Make the request and return the results.
		return $service->operatingSystems->GetOperatingSystems($profileId, $dartId, $optParams);
	}
	catch (Exception $e)
	{
