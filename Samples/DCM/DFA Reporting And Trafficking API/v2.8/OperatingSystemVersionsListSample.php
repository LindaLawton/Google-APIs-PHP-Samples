...
// Single Request.
$results = operatingSystemVersionsListExample($service, $profileId, $optParams);
...
*/
function operatingSystemVersionsListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->operatingSystemVersions->ListOperatingSystemVersions($profileId, $optParams);
	}
	catch (Exception $e)
	{
