...
// Single Request.
$results = countriesListExample($service, $profileId, $optParams);
...
*/
function countriesListExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->countries->ListCountries($profileId, $optParams);
	}
	catch (Exception $e)
	{
