...
// Single Request.
$results = sitesUpdateExample($service, $profileId, $optParams);
...
* @return Site
*/
function sitesUpdateExample($service, $profileId, $optParams)
{
	try
	{
		...
		return $service->sites->UpdateSites($profileId, $optParams);
	}
	catch (Exception $e)
	{
