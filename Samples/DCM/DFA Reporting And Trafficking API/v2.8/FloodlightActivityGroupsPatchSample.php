...
// Single Request.
$results = floodlightActivityGroupsPatchExample($service, $profileId, $id, $optParams);
...
*/
function floodlightActivityGroupsPatchExample($service, $profileId, $id, $optParams)
{
	try
	{
		...
		return $service->floodlightActivityGroups->PatchFloodlightActivityGroups($profileId, $id, $optParams);
	}
	catch (Exception $e)
	{
