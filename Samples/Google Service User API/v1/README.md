...
# UnOfficial Google Service User API v1 Samples for PHP
...
These samples show how to access the [Google Service User API v1](https://cloud.google.com/service-management/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
