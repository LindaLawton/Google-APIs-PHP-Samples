...
// Single Request.
$results = servicesEnableExample($service, $name, $optParams);
...
* @return Operation
*/
function servicesEnableExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->services->EnableServices($name, $optParams);
	}
	catch (Exception $e)
	{
