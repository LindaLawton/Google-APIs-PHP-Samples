...
// Single Request.
$results = servicesDisableExample($service, $name, $optParams);
...
* @return Operation
*/
function servicesDisableExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->services->DisableServices($name, $optParams);
	}
	catch (Exception $e)
	{
