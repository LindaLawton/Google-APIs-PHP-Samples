...
// Single Request.
$results = servicesListExample($service, $parent, $optParams);
...
* @service Authenticated Serviceuser service.
* @optParams Optional paramaters are not required by a request.
* @parent List enabled services for the specified parent.

An example valid parent would be:
- projects/my-project
* @return ListEnabledServicesResponse
*/
function servicesListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->services->ListServices($parent, $optParams);
	}
	catch (Exception $e)
	{
