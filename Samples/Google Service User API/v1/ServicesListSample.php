...
print_r(servicesListExample($service, $parent));
...
- projects/my-project
* @return ListEnabledServicesResponse</returns>
*/
function servicesListExample($service, $parent)
{
	try
	{
		...
		return $service->services->ListServices($parent);
	}
	catch (Exception $ex)
	{
