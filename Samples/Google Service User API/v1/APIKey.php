...
// About 
// 
// Unofficial sample for the Service User v1 API for PHP. 
 ...
 * Initializes an Serviceuser.v1 service object.
 * @param string API key
 * @return An authorized Serviceuser.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Serviceuser Sample");
		...
		// Create authenticated Serviceuser service
		return new Google_Service_Serviceuser($client);
	} catch (Exception $e) {
