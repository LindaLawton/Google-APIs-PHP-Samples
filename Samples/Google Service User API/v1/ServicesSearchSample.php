...
print_r(servicesSearchExample($service));
...
* @return SearchServicesResponse</returns>
*/
function servicesSearchExample($service)
{
	try
	{
		...
		return $service->services->SearchServices();
	}
	catch (Exception $ex)
	{
