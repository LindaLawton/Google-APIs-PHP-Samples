...
# Unoffical Google Cloud IoT API Samples for PHP
...
These samples show how to access the [Google Cloud IoT API](https://cloud.google.com/iot) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
