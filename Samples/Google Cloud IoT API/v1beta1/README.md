...
# UnOfficial Google Cloud IoT API v1beta1 Samples for PHP

## API Description

Registers and manages IoT (Internet of Things) devices that connect to the Google Cloud Platform.

[Official Documentation](https://cloud.google.com/iot)

## Sample Description

These samples show how to access the [Google Cloud IoT API v1beta1](https://cloud.google.com/iot) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
