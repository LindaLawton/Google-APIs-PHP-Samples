 ...
 * Initializes an Cloudiot.v1beta1 service object.
 * @param string API key
 * @return An authorized Cloudiot.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudiot Sample");
		...
		// Create authenticated Cloudiot service
		return new Google_Service_Cloudiot($client);
	} catch (Exception $e) {
