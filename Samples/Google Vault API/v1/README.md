...
# UnOfficial Google Vault API v1 Samples for PHP

## API Description

Archiving and eDiscovery for G Suite.

[Official Documentation](https://developers.google.com/vault)

## Sample Description

These samples show how to access the [Google Vault API v1](https://developers.google.com/vault) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
