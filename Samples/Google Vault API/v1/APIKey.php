 ...
 * Initializes an Vault.v1 service object.
 * @param string API key
 * @return An authorized Vault.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Vault Sample");
		...
		// Create authenticated Vault service
		return new Google_Service_Vault($client);
	} catch (Exception $e) {
