...
$results = archiveInsertExample($service, $groupId, $optParams);


/**
* Inserts a new mail into the archive of the Google group.
* @service Authenticated Groupsmigration service.
* @optParams Optional paramaters are not required by a request.
* @groupId The group ID
* @return Groups
*/
function archiveInsertExample($service, $groupId, $optParams)
{
	try
	{
		...
		return $service->archive->InsertArchive($groupId, $optParams);
	}
	catch (Exception $e)
	{
