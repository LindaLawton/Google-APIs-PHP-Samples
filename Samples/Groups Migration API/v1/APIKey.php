...
// About 
// 
// Unofficial sample for the Groups Migration v1 API for PHP. 
 ...
 * Initializes an Groupsmigration.v1 service object.
 * @param string API key
 * @return An authorized Groupsmigration.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Groupsmigration Sample");
		...
		// Create authenticated Groupsmigration service
		return new Google_Service_Groupsmigration($client);
	} catch (Exception $e) {
