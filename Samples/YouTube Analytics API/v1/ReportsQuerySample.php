...
print_r(reportsQueryExample($service, $ids, $start-date, $end-date, $metrics));
...
*/
function reportsQueryExample($service, $ids, $start-date, $end-date, $metrics)
{
	try
	{
		...
		return $service->reports->QueryReports($ids, $start-date, $end-date, $metrics);
	}
	catch (Exception $ex)
	{
