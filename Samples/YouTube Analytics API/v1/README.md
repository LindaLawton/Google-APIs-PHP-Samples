...
# UnOfficial YouTube Analytics API v1 Samples for PHP
...
These samples show how to access the [YouTube Analytics API v1](http://developers.google.com/youtube/analytics/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
