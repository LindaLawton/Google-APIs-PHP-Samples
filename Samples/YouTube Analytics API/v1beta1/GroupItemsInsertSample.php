...
// Single Request.
$results = groupItemsInsertExample($service, $optParams);
...
* @return GroupItem
*/
function groupItemsInsertExample($service, $optParams)
{
	try
	{
		...
		return $service->groupItems->InsertGroupItems($optParams);
	}
	catch (Exception $e)
	{
