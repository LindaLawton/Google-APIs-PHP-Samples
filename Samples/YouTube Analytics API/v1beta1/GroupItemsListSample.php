...
// Single Request.
$results = groupItemsListExample($service, $groupId, $optParams);
...
* @return GroupItemListResponse
*/
function groupItemsListExample($service, $groupId, $optParams)
{
	try
	{
		...
		return $service->groupItems->ListGroupItems($groupId, $optParams);
	}
	catch (Exception $e)
	{
