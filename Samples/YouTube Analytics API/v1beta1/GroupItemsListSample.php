...
print_r(groupItemsListExample($service, $groupId));
...
* @return GroupItemListResponse</returns>
*/
function groupItemsListExample($service, $groupId)
{
	try
	{
		...
		return $service->groupItems->ListGroupItems($groupId);
	}
	catch (Exception $ex)
	{
