...
$results = groupItemsDeleteExample($service, $id, $optParams);
...
*/
function groupItemsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->groupItems->DeleteGroupItems($id, $optParams);
	}
	catch (Exception $e)
	{
