...
// About 
// 
// Unofficial sample for the Youtubeanalytics v1beta1 API for PHP. 
 ...
 * Initializes an Youtubeanalytics.v1beta1 service object.
 * @param string API key
 * @return An authorized Youtubeanalytics.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Youtubeanalytics Sample");
		...
		// Create authenticated Youtubeanalytics service
