...
# UnOfficial YouTube Analytics API v1beta1 Samples for PHP

## API Description

Retrieves your YouTube Analytics data.

[Official Documentation](http://developers.google.com/youtube/analytics/)

## Sample Description

These samples show how to access the [YouTube Analytics API v1beta1](http://developers.google.com/youtube/analytics/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
