...
// Single Request.
$results = postsSearchExample($service, $blogId, $q, $optParams);
...
* @return PostList
*/
function postsSearchExample($service, $blogId, $q, $optParams)
{
	try
	{
		...
		return $service->posts->SearchPosts($blogId, $q, $optParams);
	}
	catch (Exception $e)
	{
