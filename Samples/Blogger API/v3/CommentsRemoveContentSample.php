...
$results = commentsRemoveContentExample($service, $blogId, $postId, $commentId, $optParams);
...
* @return Comment
*/
function commentsRemoveContentExample($service, $blogId, $postId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->RemoveContentComments($blogId, $postId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
