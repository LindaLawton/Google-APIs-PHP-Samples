...
print_r(removeContent($service, $blogId, $postId, $commentId));
...
*/
function removeContent($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->removeContent($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
