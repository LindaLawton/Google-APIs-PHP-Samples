...
print_r(commentsRemoveContentExample($service, $blogId, $postId, $commentId));
...
*/
function commentsRemoveContentExample($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->comments->RemoveContentComments($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
