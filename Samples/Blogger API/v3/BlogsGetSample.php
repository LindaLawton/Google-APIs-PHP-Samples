...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxPosts' => '[YourValue]',  // Maximum number of posts to pull back with the blog.
            
  //'view' => '[YourValue]',  // Access level with which to view the blog. Note that some fields require elevated access.
  'fields' => '*'
);
// Single Request.
$results = blogsGetExample($service, $blogId, $optParams);
...
* @return Blog
*/
function blogsGetExample($service, $blogId, $optParams)
{
	try
	{
		...
		return $service->blogs->GetBlogs($blogId, $optParams);
	}
	catch (Exception $e)
	{
