...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'isDraft' => '[YourValue]',  //Whether to create the page as a draft (default: false).
  'fields' => '*'
);
// Single Request.
$results = pagesInsertExample($service, $blogId, $optParams);
...
* @return Page
*/
function pagesInsertExample($service, $blogId, $optParams)
{
	try
	{
		...
		return $service->pages->InsertPages($blogId, $optParams);
	}
	catch (Exception $e)
	{
