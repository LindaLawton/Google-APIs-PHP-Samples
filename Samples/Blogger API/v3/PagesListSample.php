...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'fetchBodies' => '[YourValue]',  // Whether to retrieve the Page bodies.
            
  //'maxResults' => '[YourValue]',  // Maximum number of Pages to fetch.
...
// Single Request.
$results = pagesListExample($service, $blogId, $optParams);
...
* @return PageList
*/
function pagesListExample($service, $blogId, $optParams)
{
	try
	{
		...
		return $service->pages->ListPages($blogId, $optParams);
	}
	catch (Exception $e)
	{
