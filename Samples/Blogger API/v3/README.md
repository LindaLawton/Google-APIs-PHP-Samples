...
# UnOfficial Blogger API v3 Samples for PHP

## API Description

API for access to the data within Blogger.

[Official Documentation](https://developers.google.com/blogger/docs/3.0/getting_started)

## Sample Description

These samples show how to access the [Blogger API v3](https://developers.google.com/blogger/docs/3.0/getting_started) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
