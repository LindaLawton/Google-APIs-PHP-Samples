...
print_r(pageViewsGetExample($service, $blogId));

/**
* Retrieve pageview stats for a Blog.
* @service Authenticated Blogger service.
* @blogId The ID of the blog to get.
* @return Pageviews</returns>
*/
function pageViewsGetExample($service, $blogId)
{
	try
	{
		...
		return $service->pageViews->GetPageViews($blogId);
	}
	catch (Exception $ex)
	{
