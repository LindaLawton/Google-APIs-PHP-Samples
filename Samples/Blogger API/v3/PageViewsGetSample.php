...
// Single Request.
$results = pageViewsGetExample($service, $blogId, $optParams);
...
* @return Pageviews
*/
function pageViewsGetExample($service, $blogId, $optParams)
{
	try
	{
		...
		return $service->pageViews->GetPageViews($blogId, $optParams);
	}
	catch (Exception $e)
	{
