...
$results = commentsDeleteExample($service, $blogId, $postId, $commentId, $optParams);
...
*/
function commentsDeleteExample($service, $blogId, $postId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->DeleteComments($blogId, $postId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
