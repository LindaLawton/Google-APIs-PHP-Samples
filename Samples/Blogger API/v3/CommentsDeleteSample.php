...
print_r(commentsDeleteExample($service, $blogId, $postId, $commentId));
...
*/
function commentsDeleteExample($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->comments->DeleteComments($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
