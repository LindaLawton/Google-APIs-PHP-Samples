...
// Single Request.
$results = pagesRevertExample($service, $blogId, $pageId, $optParams);
...
* @return Page
*/
function pagesRevertExample($service, $blogId, $pageId, $optParams)
{
	try
	{
		...
		return $service->pages->RevertPages($blogId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
