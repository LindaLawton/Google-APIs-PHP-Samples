...
print_r(blogUserInfosGetExample($service, $userId, $blogId));
...
* @return BlogUserInfo</returns>
*/
function blogUserInfosGetExample($service, $userId, $blogId)
{
	try
	{
		...
		return $service->blogUserInfos->GetBlogUserInfos($userId, $blogId);
	}
	catch (Exception $ex)
	{
