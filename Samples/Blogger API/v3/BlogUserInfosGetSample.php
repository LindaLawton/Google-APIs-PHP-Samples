...
// Single Request.
$results = blogUserInfosGetExample($service, $userId, $blogId, $optParams);
...
* @return BlogUserInfo
*/
function blogUserInfosGetExample($service, $userId, $blogId, $optParams)
{
	try
	{
		...
		return $service->blogUserInfos->GetBlogUserInfos($userId, $blogId, $optParams);
	}
	catch (Exception $e)
	{
