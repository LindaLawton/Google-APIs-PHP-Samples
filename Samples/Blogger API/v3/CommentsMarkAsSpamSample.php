...
print_r(commentsMarkAsSpamExample($service, $blogId, $postId, $commentId));
...
*/
function commentsMarkAsSpamExample($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->comments->MarkAsSpamComments($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
