...
print_r(markAsSpam($service, $blogId, $postId, $commentId));
...
*/
function markAsSpam($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->markAsSpam($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
