...
$results = commentsMarkAsSpamExample($service, $blogId, $postId, $commentId, $optParams);
...
* @return Comment
*/
function commentsMarkAsSpamExample($service, $blogId, $postId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->MarkAsSpamComments($blogId, $postId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
