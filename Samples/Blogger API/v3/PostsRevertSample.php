...
// Single Request.
$results = postsRevertExample($service, $blogId, $postId, $optParams);
...
* @return Post
*/
function postsRevertExample($service, $blogId, $postId, $optParams)
{
	try
	{
		...
		return $service->posts->RevertPosts($blogId, $postId, $optParams);
	}
	catch (Exception $e)
	{
