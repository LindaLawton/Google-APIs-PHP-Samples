...
$results = postsDeleteExample($service, $blogId, $postId, $optParams);
...
*/
function postsDeleteExample($service, $blogId, $postId, $optParams)
{
	try
	{
		...
		return $service->posts->DeletePosts($blogId, $postId, $optParams);
	}
	catch (Exception $e)
	{
