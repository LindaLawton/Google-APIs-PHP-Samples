...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxComments' => '[YourValue]',  // Maximum number of comments to retrieve with the returned post.
            
  //'publish' => '[YourValue]',  // Whether a publish action should be performed when the post is updated (default: false).
            
  //'revert' => '[YourValue]',  // Whether a revert action should be performed when the post is updated (default: false).
  'fields' => '*'
);
// Single Request.
$results = postsUpdateExample($service, $blogId, $postId, $optParams);
...
* @return Post
*/
function postsUpdateExample($service, $blogId, $postId, $optParams)
{
	try
	{
		...
		return $service->posts->UpdatePosts($blogId, $postId, $optParams);
	}
	catch (Exception $e)
	{
