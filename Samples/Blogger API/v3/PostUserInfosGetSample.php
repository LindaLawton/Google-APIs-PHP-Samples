...
print_r(postUserInfosGetExample($service, $userId, $blogId, $postId));
...
* @return PostUserInfo</returns>
*/
function postUserInfosGetExample($service, $userId, $blogId, $postId)
{
	try
	{
		...
		return $service->postUserInfos->GetPostUserInfos($userId, $blogId, $postId);
	}
	catch (Exception $ex)
	{
