...
// Single Request.
$results = postUserInfosGetExample($service, $userId, $blogId, $postId, $optParams);
...
* @return PostUserInfo
*/
function postUserInfosGetExample($service, $userId, $blogId, $postId, $optParams)
{
	try
	{
		...
		return $service->postUserInfos->GetPostUserInfos($userId, $blogId, $postId, $optParams);
	}
	catch (Exception $e)
	{
