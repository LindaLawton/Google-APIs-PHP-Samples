...
print_r(postUserInfosListExample($service, $userId, $blogId));
...
* @return PostUserInfosList</returns>
*/
function postUserInfosListExample($service, $userId, $blogId)
{
	try
	{
		...
		return $service->postUserInfos->ListPostUserInfos($userId, $blogId);
	}
	catch (Exception $ex)
	{
