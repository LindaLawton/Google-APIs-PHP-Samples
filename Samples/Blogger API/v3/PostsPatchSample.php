...
// Single Request.
$results = postsPatchExample($service, $blogId, $postId, $optParams);
...
* @return Post
*/
function postsPatchExample($service, $blogId, $postId, $optParams)
{
	try
	{
		...
		return $service->posts->PatchPosts($blogId, $postId, $optParams);
	}
	catch (Exception $e)
	{
