...
// Single Request.
$results = commentsListExample($service, $blogId, $postId, $optParams);
...
do {
	...
	$results = filesListExample($service, $blogId, $postId, $optParams);	
...
* @return CommentList
*/
function commentsListExample($service, $blogId, $postId, $optParams)
{
	try
	{
		...
		return $service->comments->ListComments($blogId, $postId, $optParams);
	}
	catch (Exception $e)
	{
