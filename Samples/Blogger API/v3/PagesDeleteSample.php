...
$results = pagesDeleteExample($service, $blogId, $pageId, $optParams);
...
*/
function pagesDeleteExample($service, $blogId, $pageId, $optParams)
{
	try
	{
		...
		return $service->pages->DeletePages($blogId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
