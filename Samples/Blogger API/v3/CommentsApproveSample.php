...
print_r(commentsApproveExample($service, $blogId, $postId, $commentId));
...
*/
function commentsApproveExample($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->comments->ApproveComments($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
