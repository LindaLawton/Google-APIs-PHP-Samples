...
// Single Request.
$results = commentsApproveExample($service, $blogId, $postId, $commentId, $optParams);
...
* @return Comment
*/
function commentsApproveExample($service, $blogId, $postId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->ApproveComments($blogId, $postId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
