...
$results = pagesPublishExample($service, $blogId, $pageId, $optParams);
...
* @return Page
*/
function pagesPublishExample($service, $blogId, $pageId, $optParams)
{
	try
	{
		...
		return $service->pages->PublishPages($blogId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
