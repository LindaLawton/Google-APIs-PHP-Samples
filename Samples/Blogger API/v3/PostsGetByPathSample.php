...
// Single Request.
$results = postsGetByPathExample($service, $blogId, $path, $optParams);
...
* @return Post
*/
function postsGetByPathExample($service, $blogId, $path, $optParams)
{
	try
	{
		...
		return $service->posts->GetByPathPosts($blogId, $path, $optParams);
	}
	catch (Exception $e)
	{
