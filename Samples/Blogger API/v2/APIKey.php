 ...
 * Initializes an Blogger.v2 service object.
 * @param string API key
 * @return An authorized Blogger.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Blogger Sample");
		...
		// Create authenticated Blogger service
