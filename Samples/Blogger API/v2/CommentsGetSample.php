...
print_r(commentsGetExample($service, $blogId, $postId, $commentId));
...
* @return Comment</returns>
*/
function commentsGetExample($service, $blogId, $postId, $commentId)
{
	try
	{
		...
		return $service->comments->GetComments($blogId, $postId, $commentId);
	}
	catch (Exception $ex)
	{
