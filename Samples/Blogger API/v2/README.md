...
# UnOfficial Blogger API v2 Samples for PHP

## API Description

API for access to the data within Blogger.

[Official Documentation](https://developers.google.com/blogger/docs/2.0/json/getting_started)

## Sample Description

These samples show how to access the [Blogger API v2](https://developers.google.com/blogger/docs/2.0/json/getting_started) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
