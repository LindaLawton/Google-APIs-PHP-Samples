...
// Single Request.
$results = pagesGetExample($service, $blogId, $pageId, $optParams);
...
* @return Page
*/
function pagesGetExample($service, $blogId, $pageId, $optParams)
{
	try
	{
		...
		return $service->pages->GetPages($blogId, $pageId, $optParams);
	}
	catch (Exception $e)
	{
