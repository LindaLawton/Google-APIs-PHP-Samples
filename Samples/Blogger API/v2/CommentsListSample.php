...
print_r(commentsListExample($service, $blogId, $postId));
...
* @return CommentList</returns>
*/
function commentsListExample($service, $blogId, $postId)
{
	try
	{
		...
		return $service->comments->ListComments($blogId, $postId);
	}
	catch (Exception $ex)
	{
