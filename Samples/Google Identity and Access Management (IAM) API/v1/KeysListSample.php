...
print_r(keysListExample($service, $name));
...
* @return ListServiceAccountKeysResponse</returns>
*/
function keysListExample($service, $name)
{
	try
	{
		...
		return $service->keys->ListKeys($name);
	}
	catch (Exception $ex)
	{
