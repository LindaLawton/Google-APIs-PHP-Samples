...
// Single Request.
$results = rolesQueryGrantableRolesExample($service, $optParams);
...
*/
function rolesQueryGrantableRolesExample($service, $optParams)
{
	try
	{
		...
		return $service->roles->QueryGrantableRolesRoles($optParams);
	}
	catch (Exception $e)
	{
