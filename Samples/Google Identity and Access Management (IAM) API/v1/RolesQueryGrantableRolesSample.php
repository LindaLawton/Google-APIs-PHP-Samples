...
print_r(rolesQueryGrantableRolesExample($service));
...
* @return QueryGrantableRolesResponse</returns>
*/
function rolesQueryGrantableRolesExample($service)
{
	try
	{
		...
		return $service->roles->QueryGrantableRolesRoles();
	}
	catch (Exception $ex)
	{
