...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'etag' => '[YourValue]',  // Used to perform a consistent read-modify-write.
  'fields' => '*'
);
// Single Request.
$results = rolesDeleteExample($service, $name, $optParams);
...
* @return Role
*/
function rolesDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->roles->DeleteRoles($name, $optParams);
	}
	catch (Exception $e)
	{
