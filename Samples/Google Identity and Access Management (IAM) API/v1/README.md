...
# UnOfficial Google Identity and Access Management (IAM) API v1 Samples for PHP

## API Description

Manages identity and access control for Google Cloud Platform resources, including the creation of service accounts, which you can use to authenticate to Google and make API calls.

[Official Documentation](https://cloud.google.com/iam/)

## Sample Description

These samples show how to access the [Google Identity and Access Management (IAM) API v1](https://cloud.google.com/iam/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
