...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  //A mask describing which fields in the Role have changed.
  'fields' => '*'
);
// Single Request.
$results = rolesPatchExample($service, $name, $optParams);
...
* @return Role
*/
function rolesPatchExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->roles->PatchRoles($name, $optParams);
	}
	catch (Exception $e)
	{
