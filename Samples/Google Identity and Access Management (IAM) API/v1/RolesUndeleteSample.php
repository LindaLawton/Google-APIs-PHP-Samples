...
// Single Request.
$results = rolesUndeleteExample($service, $name, $optParams);
...
* @return Role
*/
function rolesUndeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->roles->UndeleteRoles($name, $optParams);
	}
	catch (Exception $e)
	{
