...
// Single Request.
$results = rolesCreateExample($service, $parent, $optParams);
...
* @return Role
*/
function rolesCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->roles->CreateRoles($parent, $optParams);
	}
	catch (Exception $e)
	{
