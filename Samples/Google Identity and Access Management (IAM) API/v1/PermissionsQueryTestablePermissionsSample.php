...
// Single Request.
$results = permissionsQueryTestablePermissionsExample($service, $optParams);
...
*/
function permissionsQueryTestablePermissionsExample($service, $optParams)
{
	try
	{
		...
		return $service->permissions->QueryTestablePermissionsPermissions($optParams);
	}
	catch (Exception $e)
	{
