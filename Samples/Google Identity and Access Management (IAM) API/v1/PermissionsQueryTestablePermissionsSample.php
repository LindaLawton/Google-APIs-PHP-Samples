...
print_r(permissionsQueryTestablePermissionsExample($service));
...
* @return QueryTestablePermissionsResponse</returns>
*/
function permissionsQueryTestablePermissionsExample($service)
{
	try
	{
		...
		return $service->permissions->QueryTestablePermissionsPermissions();
	}
	catch (Exception $ex)
	{
