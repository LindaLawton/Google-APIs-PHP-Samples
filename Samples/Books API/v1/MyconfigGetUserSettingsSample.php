...
// Single Request.
$results = myconfigGetUserSettingsExample($service, $optParams);
...
* @return Usersettings
*/
function myconfigGetUserSettingsExample($service, $optParams)
{
	try
	{
		...
		return $service->myconfig->GetUserSettingsMyconfig($optParams);
	}
	catch (Exception $e)
	{
