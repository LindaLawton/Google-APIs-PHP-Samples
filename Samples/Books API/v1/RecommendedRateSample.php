...
print_r(recommendedRateExample($service, $rating, $volumeId));
...
* @return BooksVolumesRecommendedRateResponse</returns>
*/
function recommendedRateExample($service, $rating, $volumeId)
{
	try
	{
		...
		return $service->recommended->RateRecommended($rating, $volumeId);
	}
	catch (Exception $ex)
	{
