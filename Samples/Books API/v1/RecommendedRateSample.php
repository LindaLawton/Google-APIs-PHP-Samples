...
// Single Request.
$results = recommendedRateExample($service, $rating, $volumeId, $optParams);
...
*/
function recommendedRateExample($service, $rating, $volumeId, $optParams)
{
	try
	{
		...
		return $service->recommended->RateRecommended($rating, $volumeId, $optParams);
	}
	catch (Exception $e)
	{
