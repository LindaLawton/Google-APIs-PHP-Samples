...
$results = myconfigReleaseDownloadAccessExample($service, $volumeIds, $cpksver, $optParams);
...
*/
function myconfigReleaseDownloadAccessExample($service, $volumeIds, $cpksver, $optParams)
{
	try
	{
		...
		return $service->myconfig->ReleaseDownloadAccessMyconfig($volumeIds, $cpksver, $optParams);
	}
	catch (Exception $e)
	{
