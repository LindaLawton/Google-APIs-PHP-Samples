...
print_r(releaseDownloadAccess($service, $volumeIds, $cpksver));
...
*/
function releaseDownloadAccess($service, $volumeIds, $cpksver)
{
	try
	{
		...
		return $service->releaseDownloadAccess($volumeIds, $cpksver);
	}
	catch (Exception $ex)
	{
