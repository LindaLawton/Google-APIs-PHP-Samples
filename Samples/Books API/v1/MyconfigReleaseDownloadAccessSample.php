...
print_r(myconfigReleaseDownloadAccessExample($service, $volumeIds, $cpksver));
...
* @return DownloadAccesses</returns>
*/
function myconfigReleaseDownloadAccessExample($service, $volumeIds, $cpksver)
{
	try
	{
		...
		if (volumeIds == null)
			throw new Exception("volumeIds is required.");
		// Make the request and return the results.
		return $service->myconfig->ReleaseDownloadAccessMyconfig($volumeIds, $cpksver);
	}
	catch (Exception $ex)
	{
