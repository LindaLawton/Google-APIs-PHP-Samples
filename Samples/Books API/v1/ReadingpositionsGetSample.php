...
print_r(readingpositionsGetExample($service, $volumeId));

/**
* Retrieves my reading position information for a volume.
* @service Authenticated Books service.
* @volumeId ID of volume for which to retrieve a reading position.
* @return ReadingPosition</returns>
*/
function readingpositionsGetExample($service, $volumeId)
{
	try
	{
		...
		return $service->readingpositions->GetReadingpositions($volumeId);
	}
	catch (Exception $ex)
	{
