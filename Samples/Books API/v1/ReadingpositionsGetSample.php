...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'contentVersion' => '[YourValue]',  // Volume content version for which this reading position is requested.
            
  //'source' => '[YourValue]',  // String to identify the originator of this request.
  'fields' => '*'
);
// Single Request.
$results = readingpositionsGetExample($service, $volumeId, $optParams);
...
*/
function readingpositionsGetExample($service, $volumeId, $optParams)
{
	try
	{
		...
		return $service->readingpositions->GetReadingpositions($volumeId, $optParams);
	}
	catch (Exception $e)
	{
