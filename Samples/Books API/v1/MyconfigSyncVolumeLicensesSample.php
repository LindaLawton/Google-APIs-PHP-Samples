...
* @return Volumes
*/
function myconfigSyncVolumeLicensesExample($service, $source, $nonce, $cpksver, $optParams)
{
	try
	{
		...
		return $service->myconfig->SyncVolumeLicensesMyconfig($source, $nonce, $cpksver, $optParams);
	}
	catch (Exception $e)
	{
