...
print_r(syncVolumeLicenses($service, $source, $nonce, $cpksver));
...
*/
function syncVolumeLicenses($service, $source, $nonce, $cpksver)
{
	try
	{
		...
		return $service->syncVolumeLicenses($source, $nonce, $cpksver);
	}
	catch (Exception $ex)
	{
