...
print_r(myconfigSyncVolumeLicensesExample($service, $source, $nonce, $cpksver));
...
* @return Volumes</returns>
*/
function myconfigSyncVolumeLicensesExample($service, $source, $nonce, $cpksver)
{
	try
	{
		...
		return $service->myconfig->SyncVolumeLicensesMyconfig($source, $nonce, $cpksver);
	}
	catch (Exception $ex)
	{
