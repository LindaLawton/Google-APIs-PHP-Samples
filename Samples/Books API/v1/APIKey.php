 ...
 * Initializes an Books.v1 service object.
 * @param string API key
 * @return An authorized Books.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Books Sample");
		...
		// Create authenticated Books service
