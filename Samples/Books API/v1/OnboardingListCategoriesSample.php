...
// Single Request.
$results = onboardingListCategoriesExample($service, $optParams);
...
* @return Category
*/
function onboardingListCategoriesExample($service, $optParams)
{
	try
	{
		...
		return $service->onboarding->ListCategoriesOnboarding($optParams);
	}
	catch (Exception $e)
	{
