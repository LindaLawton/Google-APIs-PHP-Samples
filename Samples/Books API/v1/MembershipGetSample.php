...
print_r(membershipGetExample($service, $series_id));

/**
* Returns Series membership data given the series id.
* @service Authenticated Books service.
* @series_id String that identifies the series
* @return Seriesmembership</returns>
*/
function membershipGetExample($service, $series_id)
{
	try
	{
		...
		return $service->membership->GetMembership($series_id);
	}
	catch (Exception $ex)
	{
