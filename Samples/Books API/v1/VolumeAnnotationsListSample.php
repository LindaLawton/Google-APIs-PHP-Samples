...
print_r(volumeAnnotationsListExample($service, $volumeId, $layerId, $contentVersion));
...
* @return Volumeannotations</returns>
*/
function volumeAnnotationsListExample($service, $volumeId, $layerId, $contentVersion)
{
	try
	{
		...
		return $service->volumeAnnotations->ListVolumeAnnotations($volumeId, $layerId, $contentVersion);
	}
	catch (Exception $ex)
	{
