...
print_r(list($service, $volumeId, $layerId, $contentVersion));
...
*/
function list($service, $volumeId, $layerId, $contentVersion)
{
	try
	{
		...
		return $service->list($volumeId, $layerId, $contentVersion);
	}
	catch (Exception $ex)
	{
