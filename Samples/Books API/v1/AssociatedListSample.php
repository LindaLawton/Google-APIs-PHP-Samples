...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'association' => '[YourValue]',  //Association type.
            
  //'locale' => '[YourValue]',  //ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'. Used for generating recommendations.
            
  //'maxAllowedMaturityRating' => '[YourValue]',  //The maximum allowed maturity rating of returned recommendations. Books with a higher maturity rating are filtered out.
            
  //'source' => '[YourValue]',  //String to identify the originator of this request.
  'fields' => '*'
);
// Single Request.
$results = associatedListExample($service, $volumeId, $optParams);
...
* @return Volumes
*/
function associatedListExample($service, $volumeId, $optParams)
{
	try
	{
		...
		return $service->associated->ListAssociated($volumeId, $optParams);
	}
	catch (Exception $e)
	{
