...
print_r(myconfigUpdateUserSettingsExample($service));

/**
* Sets the settings for the user. If a sub-object is specified, it will overwrite the existing sub-object stored in the server. Unspecified sub-objects will retain the existing value.
* @service Authenticated Books service.
* @return Usersettings</returns>
*/
function myconfigUpdateUserSettingsExample($service)
{
	try
	{
		...
		return $service->myconfig->UpdateUserSettingsMyconfig();
	}
	catch (Exception $ex)
	{
