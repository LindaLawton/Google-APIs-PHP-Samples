...
// Single Request.
$results = myconfigUpdateUserSettingsExample($service, $optParams);
...
* @return Usersettings
*/
function myconfigUpdateUserSettingsExample($service, $optParams)
{
	try
	{
		...
		return $service->myconfig->UpdateUserSettingsMyconfig($optParams);
	}
	catch (Exception $e)
	{
