...
# UnOfficial Books API v1 Samples for PHP
...
These samples show how to access the [Books API v1](https://developers.google.com/books/docs/v1/getting_started) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
