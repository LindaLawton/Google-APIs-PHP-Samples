...
print_r(onboardingListCategoryVolumesExample($service));

/**
* List available volumes under categories for onboarding experience.
* @service Authenticated Books service.
* @return Volume2</returns>
*/
function onboardingListCategoryVolumesExample($service)
{
	try
	{
		...
		return $service->onboarding->ListCategoryVolumesOnboarding();
	}
	catch (Exception $ex)
	{
