...
print_r(personalizedstreamGetExample($service));

/**
* Returns a stream of personalized book clusters
* @service Authenticated Books service.
* @return Discoveryclusters</returns>
*/
function personalizedstreamGetExample($service)
{
	try
	{
		...
		return $service->personalizedstream->GetPersonalizedstream();
	}
	catch (Exception $ex)
	{
