...
// Single Request.
$results = personalizedstreamGetExample($service, $optParams);
...
*/
function personalizedstreamGetExample($service, $optParams)
{
	try
	{
		...
		return $service->personalizedstream->GetPersonalizedstream($optParams);
	}
	catch (Exception $e)
	{
