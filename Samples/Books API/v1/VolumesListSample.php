...
print_r(volumesListExample($service, $shelf));
...
*/
function volumesListExample($service, $shelf)
{
	try
	{
		...
		if (shelf == null)
			throw new Exception("shelf is required.");
		// Make the request and return the results.
		return $service->volumes->ListVolumes($shelf);
	}
	catch (Exception $ex)
	{
