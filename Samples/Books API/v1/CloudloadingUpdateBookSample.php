...
$results = cloudloadingUpdateBookExample($service, $optParams);
...
*/
function cloudloadingUpdateBookExample($service, $optParams)
{
	try
	{
		...
		return $service->cloudloading->UpdateBookCloudloading($optParams);
	}
	catch (Exception $e)
	{
