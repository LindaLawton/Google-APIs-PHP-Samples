...
print_r(cloudloadingUpdateBookExample($service));

/**
* 
* @service Authenticated Books service.
* @return BooksCloudloadingResource</returns>
*/
function cloudloadingUpdateBookExample($service)
{
	try
	{
		...
		return $service->cloudloading->UpdateBookCloudloading();
	}
	catch (Exception $ex)
	{
