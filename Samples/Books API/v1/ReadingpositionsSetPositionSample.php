...
print_r(readingpositionsSetPositionExample($service, $volumeId, $timestamp, $position));
...
*/
function readingpositionsSetPositionExample($service, $volumeId, $timestamp, $position)
{
	try
	{
		...
		return $service->readingpositions->SetPositionReadingpositions($volumeId, $timestamp, $position);
	}
	catch (Exception $ex)
	{
