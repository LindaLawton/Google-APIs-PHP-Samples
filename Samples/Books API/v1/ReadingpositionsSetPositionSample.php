...
print_r(setPosition($service, $volumeId, $timestamp, $position));
...
*/
function setPosition($service, $volumeId, $timestamp, $position)
{
	try
	{
		...
		return $service->setPosition($volumeId, $timestamp, $position);
	}
	catch (Exception $ex)
	{
