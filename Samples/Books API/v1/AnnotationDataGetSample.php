...
print_r(get($service, $volumeId, $layerId, $annotationDataId, $contentVersion));
...
*/
function get($service, $volumeId, $layerId, $annotationDataId, $contentVersion)
{
	try
	{
		...
		return $service->get($volumeId, $layerId, $annotationDataId, $contentVersion);
	}
	catch (Exception $ex)
	{
