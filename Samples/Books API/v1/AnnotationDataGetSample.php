...
print_r(annotationDataGetExample($service, $volumeId, $layerId, $annotationDataId, $contentVersion));
...
* @return Annotationdata</returns>
*/
function annotationDataGetExample($service, $volumeId, $layerId, $annotationDataId, $contentVersion)
{
	try
	{
		...
		if (annotationDataId == null)
			throw new Exception("annotationDataId is required.");
		...
		return $service->annotationData->GetAnnotationData($volumeId, $layerId, $annotationDataId, $contentVersion);
	}
	catch (Exception $ex)
	{
