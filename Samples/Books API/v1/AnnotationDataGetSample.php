...
*/
function annotationDataGetExample($service, $volumeId, $layerId, $annotationDataId, $contentVersion, $optParams)
{
	try
	{
		...
		return $service->annotationData->GetAnnotationData($volumeId, $layerId, $annotationDataId, $contentVersion, $optParams);
	}
	catch (Exception $e)
	{
