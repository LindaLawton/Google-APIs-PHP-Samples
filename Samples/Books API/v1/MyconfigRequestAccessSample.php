...
print_r(requestAccess($service, $source, $volumeId, $nonce, $cpksver));
...
*/
function requestAccess($service, $source, $volumeId, $nonce, $cpksver)
{
	try
	{
		...
		return $service->requestAccess($source, $volumeId, $nonce, $cpksver);
	}
	catch (Exception $ex)
	{
