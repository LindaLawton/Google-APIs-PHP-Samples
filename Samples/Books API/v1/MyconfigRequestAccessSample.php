...
print_r(myconfigRequestAccessExample($service, $source, $volumeId, $nonce, $cpksver));
...
* @return RequestAccess</returns>
*/
function myconfigRequestAccessExample($service, $source, $volumeId, $nonce, $cpksver)
{
	try
	{
		...
		return $service->myconfig->RequestAccessMyconfig($source, $volumeId, $nonce, $cpksver);
	}
	catch (Exception $ex)
	{
