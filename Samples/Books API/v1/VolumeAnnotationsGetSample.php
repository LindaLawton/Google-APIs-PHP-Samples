...
print_r(volumeAnnotationsGetExample($service, $volumeId, $layerId, $annotationId));
...
* @return Volumeannotation</returns>
*/
function volumeAnnotationsGetExample($service, $volumeId, $layerId, $annotationId)
{
	try
	{
		...
		return $service->volumeAnnotations->GetVolumeAnnotations($volumeId, $layerId, $annotationId);
	}
	catch (Exception $ex)
	{
