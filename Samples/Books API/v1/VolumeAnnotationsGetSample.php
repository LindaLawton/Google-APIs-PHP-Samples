...
// Single Request.
$results = volumeAnnotationsGetExample($service, $volumeId, $layerId, $annotationId, $optParams);
...
*/
function volumeAnnotationsGetExample($service, $volumeId, $layerId, $annotationId, $optParams)
{
	try
	{
		...
		return $service->volumeAnnotations->GetVolumeAnnotations($volumeId, $layerId, $annotationId, $optParams);
	}
	catch (Exception $e)
	{
