...
$results = dictionaryListOfflineMetadataExample($service, $cpksver, $optParams);
...
* @return Metadata
*/
function dictionaryListOfflineMetadataExample($service, $cpksver, $optParams)
{
	try
	{
		...
		return $service->dictionary->ListOfflineMetadataDictionary($cpksver, $optParams);
	}
	catch (Exception $e)
	{
