...
print_r(dictionaryListOfflineMetadataExample($service, $cpksver));
...
*/
function dictionaryListOfflineMetadataExample($service, $cpksver)
{
	try
	{
		...
		return $service->dictionary->ListOfflineMetadataDictionary($cpksver);
	}
	catch (Exception $ex)
	{
