...
$results = cloudloadingDeleteBookExample($service, $volumeId, $optParams);
...
*/
function cloudloadingDeleteBookExample($service, $volumeId, $optParams)
{
	try
	{
		...
		return $service->cloudloading->DeleteBookCloudloading($volumeId, $optParams);
	}
	catch (Exception $e)
	{
