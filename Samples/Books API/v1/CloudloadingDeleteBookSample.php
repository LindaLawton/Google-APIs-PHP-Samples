...
print_r(cloudloadingDeleteBookExample($service, $volumeId));
...
*/
function cloudloadingDeleteBookExample($service, $volumeId)
{
	try
	{
		...
		return $service->cloudloading->DeleteBookCloudloading($volumeId);
	}
	catch (Exception $ex)
	{
