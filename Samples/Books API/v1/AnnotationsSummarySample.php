...
$results = annotationsSummaryExample($service, $layerIds, $volumeId, $optParams);
...
*/
function annotationsSummaryExample($service, $layerIds, $volumeId, $optParams)
{
	try
	{
		...
		return $service->annotations->SummaryAnnotations($layerIds, $volumeId, $optParams);
	}
	catch (Exception $e)
	{
