...
print_r(annotationsSummaryExample($service, $layerIds, $volumeId));
...
* @return AnnotationsSummary</returns>
*/
function annotationsSummaryExample($service, $layerIds, $volumeId)
{
	try
	{
		...
		if (layerIds == null)
			throw new Exception("layerIds is required.");
		if (volumeId == null)
			throw new Exception("volumeId is required.");
		// Make the request and return the results.
		return $service->annotations->SummaryAnnotations($layerIds, $volumeId);
	}
	catch (Exception $ex)
	{
