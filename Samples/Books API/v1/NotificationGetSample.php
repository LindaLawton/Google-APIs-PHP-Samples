...
print_r(notificationGetExample($service, $notification_id));
...
*/
function notificationGetExample($service, $notification_id)
{
	try
	{
		...
		return $service->notification->GetNotification($notification_id);
	}
	catch (Exception $ex)
	{
