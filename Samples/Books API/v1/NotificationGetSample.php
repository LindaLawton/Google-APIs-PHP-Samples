...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'locale' => '[YourValue]',  //ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'. Used for generating notification title and body.
            
  //'source' => '[YourValue]',  //String to identify the originator of this request.
  'fields' => '*'
);
// Single Request.
$results = notificationGetExample($service, $notification_id, $optParams);
...
* @return Notification
*/
function notificationGetExample($service, $notification_id, $optParams)
{
	try
	{
		...
		return $service->notification->GetNotification($notification_id, $optParams);
	}
	catch (Exception $e)
	{
