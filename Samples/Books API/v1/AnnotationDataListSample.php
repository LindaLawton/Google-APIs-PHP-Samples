...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'annotationDataId' => '[YourValue]',  //The list of Annotation Data Ids to retrieve. Pagination is ignored if this is set.
...
// Single Request.
$results = annotationDataListExample($service, $volumeId, $layerId, $contentVersion, $optParams);
...
*/
function annotationDataListExample($service, $volumeId, $layerId, $contentVersion, $optParams)
{
	try
	{
		...
		return $service->annotationData->ListAnnotationData($volumeId, $layerId, $contentVersion, $optParams);
	}
	catch (Exception $e)
	{
