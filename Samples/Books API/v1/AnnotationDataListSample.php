...
print_r(annotationDataListExample($service, $volumeId, $layerId, $contentVersion));
...
* @return Annotationsdata</returns>
*/
function annotationDataListExample($service, $volumeId, $layerId, $contentVersion)
{
	try
	{
		...
		return $service->annotationData->ListAnnotationData($volumeId, $layerId, $contentVersion);
	}
	catch (Exception $ex)
	{
