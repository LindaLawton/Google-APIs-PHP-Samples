 ...
 * Initializes an Firebasedynamiclinks.v1 service object.
 * @param string API key
 * @return An authorized Firebasedynamiclinks.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Firebasedynamiclinks Sample");
		...
		// Create authenticated Firebasedynamiclinks service
		return new Google_Service_Firebasedynamiclinks($client);
	} catch (Exception $e) {
