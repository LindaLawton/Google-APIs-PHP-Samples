...
# UnOfficial Firebase Dynamic Links API v1 Samples for PHP

## API Description

Programmatically creates and manages Firebase Dynamic Links.

[Official Documentation](https://firebase.google.com/docs/dynamic-links/)

## Sample Description

These samples show how to access the [Firebase Dynamic Links API v1](https://firebase.google.com/docs/dynamic-links/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
