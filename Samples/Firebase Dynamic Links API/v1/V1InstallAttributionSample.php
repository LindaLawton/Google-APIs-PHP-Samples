...
// Single Request.
$results = v1InstallAttributionExample($service, $optParams);
...
*/
function v1InstallAttributionExample($service, $optParams)
{
	try
	{
		...
		return $service->v1->InstallAttributionV1($optParams);
	}
	catch (Exception $e)
	{
