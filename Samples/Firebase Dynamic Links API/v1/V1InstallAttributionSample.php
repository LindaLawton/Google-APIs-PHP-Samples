...
print_r(v1InstallAttributionExample($service));

/**
* Get iOS strong/weak-match info for post-install attribution.
* @service Authenticated Firebasedynamiclinks service.
* @return GetIosPostInstallAttributionResponse</returns>
*/
function v1InstallAttributionExample($service)
{
	try
	{
		...
		return $service->v1->InstallAttributionV1();
	}
	catch (Exception $ex)
	{
