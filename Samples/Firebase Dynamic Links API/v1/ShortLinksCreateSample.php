...
// Single Request.
$results = shortLinksCreateExample($service, $optParams);
...
*/
function shortLinksCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->shortLinks->CreateShortLinks($optParams);
	}
	catch (Exception $e)
	{
