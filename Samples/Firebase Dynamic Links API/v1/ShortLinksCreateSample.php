...
print_r(shortLinksCreateExample($service));
...
* @return CreateShortDynamicLinkResponse</returns>
*/
function shortLinksCreateExample($service)
{
	try
	{
		...
		return $service->shortLinks->CreateShortLinks();
	}
	catch (Exception $ex)
	{
