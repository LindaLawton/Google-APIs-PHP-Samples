...
print_r(v1GetLinkStatsExample($service, $dynamicLink));
...
* @return DynamicLinkStats</returns>
*/
function v1GetLinkStatsExample($service, $dynamicLink)
{
	try
	{
		...
		return $service->v1->GetLinkStatsV1($dynamicLink);
	}
	catch (Exception $ex)
	{
