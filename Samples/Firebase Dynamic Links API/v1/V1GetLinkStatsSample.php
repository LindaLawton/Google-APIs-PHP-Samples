...
// About 
// 
// Unofficial sample for the Firebase Dynamic Links v1 API for PHP. 
...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'durationDays' => '[YourValue]',  // The span of time requested in days.
  'fields' => '*'
);
// Single Request.
$results = v1GetLinkStatsExample($service, $dynamicLink, $optParams);
...
* @service Authenticated Firebasedynamiclinks service.
* @optParams Optional paramaters are not required by a request.
* @dynamicLink Dynamic Link URL. e.g. https://abcd.app.goo.gl/wxyz
* @return DynamicLinkStats
*/
function v1GetLinkStatsExample($service, $dynamicLink, $optParams)
{
	try
	{
		...
		if (dynamicLink == null)
			throw new Exception("dynamicLink is required.");
		// Make the request and return the results.
		return $service->v1->GetLinkStatsV1($dynamicLink, $optParams);
	}
	catch (Exception $e)
	{
