...
# UnOfficial URL Shortener API v1 Samples for PHP

## API Description

Lets you create, inspect, and manage goo.gl short URLs

[Official Documentation](https://developers.google.com/url-shortener/v1/getting_started)

## Sample Description

These samples show how to access the [URL Shortener API v1](https://developers.google.com/url-shortener/v1/getting_started) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
