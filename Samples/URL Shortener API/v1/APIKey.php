...
// About 
// 
// Unofficial sample for the Urlshortener v1 API for PHP. 
 ...
 * Initializes an Urlshortener.v1 service object.
 * @param string API key
 * @return An authorized Urlshortener.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Urlshortener Sample");
		...
		// Create authenticated Urlshortener service
		return new Google_Service_Urlshortener($client);
	} catch (Exception $e) {
