...
$results = urlGetExample($service, $shortUrl, $optParams);


/**
* Expands a short URL or gets creation time and analytics.
* @service Authenticated Urlshortener service.
* @optParams Optional paramaters are not required by a request.
* @shortUrl The short URL, including the protocol.
* @return Url
*/
function urlGetExample($service, $shortUrl, $optParams)
{
	try
	{
		...
		if (shortUrl == null)
			throw new Exception("shortUrl is required.");
		// Make the request and return the results.
		return $service->url->GetUrl($shortUrl, $optParams);
	}
	catch (Exception $e)
	{
