...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'dnsName' => '[YourValue]',  //Restricts the list to return only zones with this domain name.
...
// Single Request.
$results = managedZonesListExample($service, $project, $optParams);
...
*/
function managedZonesListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->managedZones->ListManagedZones($project, $optParams);
	}
	catch (Exception $e)
	{
