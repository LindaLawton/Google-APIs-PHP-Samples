...
print_r(managedZonesUpdateExample($service, $project, $managedZone));
...
*/
function managedZonesUpdateExample($service, $project, $managedZone)
{
	try
	{
		...
		return $service->managedZones->UpdateManagedZones($project, $managedZone);
	}
	catch (Exception $ex)
	{
