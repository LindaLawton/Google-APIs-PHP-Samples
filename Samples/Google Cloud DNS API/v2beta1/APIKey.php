 ...
 * Initializes an Dns.v2beta1 service object.
 * @param string API key
 * @return An authorized Dns.v2beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Dns Sample");
		...
		// Create authenticated Dns service
