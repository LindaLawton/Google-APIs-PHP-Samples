...
print_r(changesCreateExample($service, $project, $managedZone));
...
*/
function changesCreateExample($service, $project, $managedZone)
{
	try
	{
		...
		return $service->changes->CreateChanges($project, $managedZone);
	}
	catch (Exception $ex)
	{
