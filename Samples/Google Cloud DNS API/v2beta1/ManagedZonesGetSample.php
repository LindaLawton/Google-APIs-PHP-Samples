...
print_r(managedZonesGetExample($service, $project, $managedZone));
...
* @return ManagedZone</returns>
*/
function managedZonesGetExample($service, $project, $managedZone)
{
	try
	{
		...
		return $service->managedZones->GetManagedZones($project, $managedZone);
	}
	catch (Exception $ex)
	{
