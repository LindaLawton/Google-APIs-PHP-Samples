...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'sortBy' => '[YourValue]',  //Sorting criterion. The only supported values are START_TIME and ID.
  'fields' => '*'
);
// Single Request.
$results = managedZoneOperationsListExample($service, $project, $managedZone, $optParams);
...
*/
function managedZoneOperationsListExample($service, $project, $managedZone, $optParams)
{
	try
	{
		...
		return $service->managedZoneOperations->ListManagedZoneOperations($project, $managedZone, $optParams);
	}
	catch (Exception $e)
	{
