...
print_r(changesGetExample($service, $project, $managedZone, $changeId));
...
* @return Change</returns>
*/
function changesGetExample($service, $project, $managedZone, $changeId)
{
	try
	{
		...
		return $service->changes->GetChanges($project, $managedZone, $changeId);
	}
	catch (Exception $ex)
	{
