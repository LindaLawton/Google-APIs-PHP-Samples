...
print_r(managedZonesPatchExample($service, $project, $managedZone));
...
*/
function managedZonesPatchExample($service, $project, $managedZone)
{
	try
	{
		...
		return $service->managedZones->PatchManagedZones($project, $managedZone);
	}
	catch (Exception $ex)
	{
