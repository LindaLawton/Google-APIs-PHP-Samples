...
print_r(managedZoneOperationsGetExample($service, $project, $managedZone, $operation));
...
*/
function managedZoneOperationsGetExample($service, $project, $managedZone, $operation)
{
	try
	{
		...
		return $service->managedZoneOperations->GetManagedZoneOperations($project, $managedZone, $operation);
	}
	catch (Exception $ex)
	{
