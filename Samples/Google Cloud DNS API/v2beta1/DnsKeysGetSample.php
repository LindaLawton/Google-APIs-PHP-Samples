...
print_r(dnsKeysGetExample($service, $project, $managedZone, $dnsKeyId));
...
* @return DnsKey</returns>
*/
function dnsKeysGetExample($service, $project, $managedZone, $dnsKeyId)
{
	try
	{
		...
		return $service->dnsKeys->GetDnsKeys($project, $managedZone, $dnsKeyId);
	}
	catch (Exception $ex)
	{
