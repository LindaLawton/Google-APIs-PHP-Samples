...
// Single Request.
$results = dnsKeysGetExample($service, $project, $managedZone, $dnsKeyId, $optParams);
...
* @return DnsKey
*/
function dnsKeysGetExample($service, $project, $managedZone, $dnsKeyId, $optParams)
{
	try
	{
		...
		if (dnsKeyId == null)
			throw new Exception("dnsKeyId is required.");
		if (managedZone == null)
			throw new Exception("managedZone is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->dnsKeys->GetDnsKeys($project, $managedZone, $dnsKeyId, $optParams);
	}
	catch (Exception $e)
	{
