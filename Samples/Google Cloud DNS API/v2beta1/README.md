...
# UnOfficial Google Cloud DNS API v2beta1 Samples for PHP

## API Description

Configures and serves authoritative DNS records.

[Official Documentation](https://developers.google.com/cloud-dns)

## Sample Description

These samples show how to access the [Google Cloud DNS API v2beta1](https://developers.google.com/cloud-dns) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
