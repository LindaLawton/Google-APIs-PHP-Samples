...
print_r(dnsKeysListExample($service, $project, $managedZone));
...
* @return DnsKeysListResponse</returns>
*/
function dnsKeysListExample($service, $project, $managedZone)
{
	try
	{
		...
		return $service->dnsKeys->ListDnsKeys($project, $managedZone);
	}
	catch (Exception $ex)
	{
