...
print_r(changesListExample($service, $project, $managedZone));
...
* @return ChangesListResponse</returns>
*/
function changesListExample($service, $project, $managedZone)
{
	try
	{
		...
		return $service->changes->ListChanges($project, $managedZone);
	}
	catch (Exception $ex)
	{
