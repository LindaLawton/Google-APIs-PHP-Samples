...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'name' => '[YourValue]',  // Restricts the list to return only records with this fully qualified domain name.
  ...
  //'type' => '[YourValue]',  // Restricts the list to return only records of this type. If present, the "name" parameter must also be present.
  'fields' => '*'
);
// Single Request.
$results = resourceRecordSetsListExample($service, $project, $managedZone, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $managedZone, $optParams);	
} while($results->getNextPageToken());  

/**
* Enumerate ResourceRecordSets that have been created but not yet deleted.
* @service Authenticated Dns service.
...
*/
function resourceRecordSetsListExample($service, $project, $managedZone, $optParams)
{
	try
	{
		...
		if (managedZone == null)
			throw new Exception("managedZone is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->resourceRecordSets->ListResourceRecordSets($project, $managedZone, $optParams);
	}
	catch (Exception $e)
	{
