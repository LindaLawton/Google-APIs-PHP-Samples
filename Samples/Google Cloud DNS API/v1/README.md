...
# UnOfficial Google Cloud DNS API v1 Samples for PHP
...
These samples show how to access the [Google Cloud DNS API v1](https://developers.google.com/cloud-dns) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
