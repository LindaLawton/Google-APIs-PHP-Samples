...
print_r(googleServiceAccountsGetExample($service, $projectId));
...
Required.
* @return GoogleServiceAccount</returns>
*/
function googleServiceAccountsGetExample($service, $projectId)
{
	try
	{
		...
		return $service->googleServiceAccounts->GetGoogleServiceAccounts($projectId);
	}
	catch (Exception $ex)
	{
