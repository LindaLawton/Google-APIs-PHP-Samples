...
// Single Request.
$results = googleServiceAccountsGetExample($service, $projectId, $optParams);
...
*/
function googleServiceAccountsGetExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->googleServiceAccounts->GetGoogleServiceAccounts($projectId, $optParams);
	}
	catch (Exception $e)
	{
