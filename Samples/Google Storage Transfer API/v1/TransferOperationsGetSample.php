...
print_r(transferOperationsGetExample($service, $name));
...
*/
function transferOperationsGetExample($service, $name)
{
	try
	{
		...
		return $service->transferOperations->GetTransferOperations($name);
	}
	catch (Exception $ex)
	{
