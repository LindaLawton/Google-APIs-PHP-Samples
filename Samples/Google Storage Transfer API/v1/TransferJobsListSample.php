...
print_r(transferJobsListExample($service));

/**
* Lists transfer jobs.
* @service Authenticated Storagetransfer service.
* @return ListTransferJobsResponse</returns>
*/
function transferJobsListExample($service)
{
	try
	{
		...
		return $service->transferJobs->ListTransferJobs();
	}
	catch (Exception $ex)
	{
