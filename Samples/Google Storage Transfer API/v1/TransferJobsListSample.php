...
// Single Request.
$results = transferJobsListExample($service, $optParams);
...
*/
function transferJobsListExample($service, $optParams)
{
	try
	{
		...
		return $service->transferJobs->ListTransferJobs($optParams);
	}
	catch (Exception $e)
	{
