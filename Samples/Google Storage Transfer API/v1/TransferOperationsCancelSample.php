...
// Single Request.
$results = transferOperationsCancelExample($service, $name, $optParams);
...
* @return Empty
*/
function transferOperationsCancelExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->transferOperations->CancelTransferOperations($name, $optParams);
	}
	catch (Exception $e)
	{
