...
print_r(transferOperationsCancelExample($service, $name));
...
*/
function transferOperationsCancelExample($service, $name)
{
	try
	{
		...
		return $service->transferOperations->CancelTransferOperations($name);
	}
	catch (Exception $ex)
	{
