...
print_r(transferOperationsListExample($service, $name));
...
*/
function transferOperationsListExample($service, $name)
{
	try
	{
		...
		return $service->transferOperations->ListTransferOperations($name);
	}
	catch (Exception $ex)
	{
