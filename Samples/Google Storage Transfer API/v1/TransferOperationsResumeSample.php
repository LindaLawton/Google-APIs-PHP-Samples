...
// Single Request.
$results = transferOperationsResumeExample($service, $name, $optParams);
...
* @return Empty
*/
function transferOperationsResumeExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->transferOperations->ResumeTransferOperations($name, $optParams);
	}
	catch (Exception $e)
	{
