...
print_r(transferOperationsResumeExample($service, $name));
...
*/
function transferOperationsResumeExample($service, $name)
{
	try
	{
		...
		return $service->transferOperations->ResumeTransferOperations($name);
	}
	catch (Exception $ex)
	{
