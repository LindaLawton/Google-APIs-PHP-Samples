...
// Single Request.
$results = transferJobsCreateExample($service, $optParams);
...
* @return TransferJob
*/
function transferJobsCreateExample($service, $optParams)
{
	try
	{
		...
		return $service->transferJobs->CreateTransferJobs($optParams);
	}
	catch (Exception $e)
	{
