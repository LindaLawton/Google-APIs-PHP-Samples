 ...
 * Initializes an Storagetransfer.v1 service object.
 * @param string API key
 * @return An authorized Storagetransfer.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Storagetransfer Sample");
		...
		// Create authenticated Storagetransfer service
		return new Google_Service_Storagetransfer($client);
	} catch (Exception $e) {
