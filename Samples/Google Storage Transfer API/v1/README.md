...
# UnOfficial Google Storage Transfer API v1 Samples for PHP

## API Description

Transfers data from external data sources to a Google Cloud Storage bucket or between Google Cloud Storage buckets.

[Official Documentation](https://cloud.google.com/storage/transfer)

## Sample Description

These samples show how to access the [Google Storage Transfer API v1](https://cloud.google.com/storage/transfer) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
