...
// Single Request.
$results = transferJobsPatchExample($service, $jobName, $optParams);
...
* @return TransferJob
*/
function transferJobsPatchExample($service, $jobName, $optParams)
{
	try
	{
		...
		return $service->transferJobs->PatchTransferJobs($jobName, $optParams);
	}
	catch (Exception $e)
	{
