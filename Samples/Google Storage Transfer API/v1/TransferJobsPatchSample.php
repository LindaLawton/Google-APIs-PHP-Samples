...
print_r(transferJobsPatchExample($service, $jobName));
...
Required.
* @return TransferJob</returns>
*/
function transferJobsPatchExample($service, $jobName)
{
	try
	{
		...
		return $service->transferJobs->PatchTransferJobs($jobName);
	}
	catch (Exception $ex)
	{
