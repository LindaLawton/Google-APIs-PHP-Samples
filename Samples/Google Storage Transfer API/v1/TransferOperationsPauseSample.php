...
print_r(transferOperationsPauseExample($service, $name));
...
*/
function transferOperationsPauseExample($service, $name)
{
	try
	{
		...
		return $service->transferOperations->PauseTransferOperations($name);
	}
	catch (Exception $ex)
	{
