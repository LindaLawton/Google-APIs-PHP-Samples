...
// Single Request.
$results = transferOperationsPauseExample($service, $name, $optParams);
...
* @return Empty
*/
function transferOperationsPauseExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->transferOperations->PauseTransferOperations($name, $optParams);
	}
	catch (Exception $e)
	{
