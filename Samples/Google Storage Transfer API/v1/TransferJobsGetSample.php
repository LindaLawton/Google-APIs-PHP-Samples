...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'projectId' => '[YourValue]',  // The ID of the Google Cloud Platform Console project that owns the job.Required.
  'fields' => '*'
);
// Single Request.
$results = transferJobsGetExample($service, $jobName, $optParams);
...
* @return TransferJob
*/
function transferJobsGetExample($service, $jobName, $optParams)
{
	try
	{
		...
		if (jobName == null)
			throw new Exception("jobName is required.");
		// Make the request and return the results.
		return $service->transferJobs->GetTransferJobs($jobName, $optParams);
	}
	catch (Exception $e)
	{
