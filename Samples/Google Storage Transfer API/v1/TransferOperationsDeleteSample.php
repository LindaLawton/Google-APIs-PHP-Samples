...
print_r(transferOperationsDeleteExample($service, $name));
...
*/
function transferOperationsDeleteExample($service, $name)
{
	try
	{
		...
		return $service->transferOperations->DeleteTransferOperations($name);
	}
	catch (Exception $ex)
	{
