...
$results = transferOperationsDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function transferOperationsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->transferOperations->DeleteTransferOperations($name, $optParams);
	}
	catch (Exception $e)
	{
