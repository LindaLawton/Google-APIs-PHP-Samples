...
$results = user_permissionsListExample($service, $parent, $optParams);
...
*/
function user_permissionsListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->user_permissions->ListUser_permissions($parent, $optParams);
	}
	catch (Exception $e)
	{
