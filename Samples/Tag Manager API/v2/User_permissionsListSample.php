...
print_r(user_permissionsListExample($service, $parent));
...
* @return ListUserPermissionsResponse</returns>
*/
function user_permissionsListExample($service, $parent)
{
	try
	{
		...
		return $service->user_permissions->ListUser_permissions($parent);
	}
	catch (Exception $ex)
	{
