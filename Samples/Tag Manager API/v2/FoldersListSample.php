...
print_r(foldersListExample($service, $parent));
...
* @return ListFoldersResponse</returns>
*/
function foldersListExample($service, $parent)
{
	try
	{
		...
		return $service->folders->ListFolders($parent);
	}
	catch (Exception $ex)
	{
