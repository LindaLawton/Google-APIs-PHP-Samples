...
// Single Request.
$results = foldersListExample($service, $parent, $optParams);
...
*/
function foldersListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->folders->ListFolders($parent, $optParams);
	}
	catch (Exception $e)
	{
