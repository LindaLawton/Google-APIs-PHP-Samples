...
// Single Request.
$results = versionsLiveExample($service, $parent, $optParams);
...
*/
function versionsLiveExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->versions->LiveVersions($parent, $optParams);
	}
	catch (Exception $e)
	{
