...
$results = version_headersListExample($service, $parent, $optParams);
...
*/
function version_headersListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->version_headers->ListVersion_headers($parent, $optParams);
	}
	catch (Exception $e)
	{
