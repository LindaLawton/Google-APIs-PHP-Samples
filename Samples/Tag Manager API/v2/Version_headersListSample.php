...
print_r(version_headersListExample($service, $parent));
...
*/
function version_headersListExample($service, $parent)
{
	try
	{
		...
		return $service->version_headers->ListVersion_headers($parent);
	}
	catch (Exception $ex)
	{
