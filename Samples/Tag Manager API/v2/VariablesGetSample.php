...
// Single Request.
$results = variablesGetExample($service, $path, $optParams);
...
* @return Variable
*/
function variablesGetExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->variables->GetVariables($path, $optParams);
	}
	catch (Exception $e)
	{
