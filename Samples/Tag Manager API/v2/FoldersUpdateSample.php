...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'fingerprint' => '[YourValue]',  // When provided, this fingerprint must match the fingerprint of the folder in storage.
  'fields' => '*'
);
// Single Request.
$results = foldersUpdateExample($service, $path, $optParams);
...
* @return Folder
*/
function foldersUpdateExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->folders->UpdateFolders($path, $optParams);
	}
	catch (Exception $e)
	{
