...
// Single Request.
$results = triggersListExample($service, $parent, $optParams);
...
*/
function triggersListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->triggers->ListTriggers($parent, $optParams);
	}
	catch (Exception $e)
	{
