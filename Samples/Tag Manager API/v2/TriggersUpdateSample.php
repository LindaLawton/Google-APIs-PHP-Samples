...
// Single Request.
$results = triggersUpdateExample($service, $path, $optParams);
...
* @return Trigger
*/
function triggersUpdateExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->triggers->UpdateTriggers($path, $optParams);
	}
	catch (Exception $e)
	{
