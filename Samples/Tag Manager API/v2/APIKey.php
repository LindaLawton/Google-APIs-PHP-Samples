 ...
 * Initializes an Tagmanager.v2 service object.
 * @param string API key
 * @return An authorized Tagmanager.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Tagmanager Sample");
		...
		// Create authenticated Tagmanager service
