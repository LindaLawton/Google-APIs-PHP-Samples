...
print_r(foldersMove_entities_to_folderExample($service, $path));
...
*/
function foldersMove_entities_to_folderExample($service, $path)
{
	try
	{
		...
		return $service->folders->Move_entities_to_folderFolders($path);
	}
	catch (Exception $ex)
	{
