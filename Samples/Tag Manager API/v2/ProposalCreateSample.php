...
print_r(proposalCreateExample($service, $parent));
...
* @return WorkspaceProposal</returns>
*/
function proposalCreateExample($service, $parent)
{
	try
	{
		...
		return $service->proposal->CreateProposal($parent);
	}
	catch (Exception $ex)
	{
