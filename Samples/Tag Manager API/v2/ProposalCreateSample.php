...
// Single Request.
$results = proposalCreateExample($service, $parent, $optParams);
...
*/
function proposalCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->proposal->CreateProposal($parent, $optParams);
	}
	catch (Exception $e)
	{
