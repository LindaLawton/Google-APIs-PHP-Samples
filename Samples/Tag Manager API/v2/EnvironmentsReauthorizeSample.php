...
print_r(environmentsReauthorizeExample($service, $path));
...
*/
function environmentsReauthorizeExample($service, $path)
{
	try
	{
		...
		return $service->environments->ReauthorizeEnvironments($path);
	}
	catch (Exception $ex)
	{
