...
// Single Request.
$results = environmentsReauthorizeExample($service, $path, $optParams);
...
* @return Environment
*/
function environmentsReauthorizeExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->environments->ReauthorizeEnvironments($path, $optParams);
	}
	catch (Exception $e)
	{
