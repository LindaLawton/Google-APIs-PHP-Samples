...
$results = versionsDeleteExample($service, $path, $optParams);
...
*/
function versionsDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->versions->DeleteVersions($path, $optParams);
	}
	catch (Exception $e)
	{
