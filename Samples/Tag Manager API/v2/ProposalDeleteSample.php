...
$results = proposalDeleteExample($service, $path, $optParams);
...
*/
function proposalDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->proposal->DeleteProposal($path, $optParams);
	}
	catch (Exception $e)
	{
