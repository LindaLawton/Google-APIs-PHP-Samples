...
$results = variablesDeleteExample($service, $path, $optParams);
...
*/
function variablesDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->variables->DeleteVariables($path, $optParams);
	}
	catch (Exception $e)
	{
