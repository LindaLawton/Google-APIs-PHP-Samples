...
print_r(user_permissionsGetExample($service, $path));
...
*/
function user_permissionsGetExample($service, $path)
{
	try
	{
		...
		return $service->user_permissions->GetUser_permissions($path);
	}
	catch (Exception $ex)
	{
