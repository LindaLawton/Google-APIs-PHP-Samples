...
$results = user_permissionsGetExample($service, $path, $optParams);
...
*/
function user_permissionsGetExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->user_permissions->GetUser_permissions($path, $optParams);
	}
	catch (Exception $e)
	{
