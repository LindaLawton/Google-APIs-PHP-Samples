...
// Single Request.
$results = user_permissionsUpdateExample($service, $path, $optParams);
...
*/
function user_permissionsUpdateExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->user_permissions->UpdateUser_permissions($path, $optParams);
	}
	catch (Exception $e)
	{
