...
print_r(user_permissionsUpdateExample($service, $path));
...
*/
function user_permissionsUpdateExample($service, $path)
{
	try
	{
		...
		return $service->user_permissions->UpdateUser_permissions($path);
	}
	catch (Exception $ex)
	{
