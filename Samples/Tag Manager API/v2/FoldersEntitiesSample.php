...
// Single Request.
$results = foldersEntitiesExample($service, $path, $optParams);
...
do {
	...
	$results = filesListExample($service, $path, $optParams);	
...
*/
function foldersEntitiesExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->folders->EntitiesFolders($path, $optParams);
	}
	catch (Exception $e)
	{
