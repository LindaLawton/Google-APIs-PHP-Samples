...
# UnOfficial Tag Manager API v2 Samples for PHP

## API Description

Accesses Tag Manager accounts and containers.

[Official Documentation](https://developers.google.com/tag-manager/api/v2/)

## Sample Description

These samples show how to access the [Tag Manager API v2](https://developers.google.com/tag-manager/api/v2/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
