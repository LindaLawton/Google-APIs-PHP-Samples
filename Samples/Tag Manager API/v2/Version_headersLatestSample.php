...
// Single Request.
$results = version_headersLatestExample($service, $parent, $optParams);
...
*/
function version_headersLatestExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->version_headers->LatestVersion_headers($parent, $optParams);
	}
	catch (Exception $e)
	{
