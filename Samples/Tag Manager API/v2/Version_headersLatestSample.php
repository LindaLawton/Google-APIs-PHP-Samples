...
print_r(version_headersLatestExample($service, $parent));
...
* @return ContainerVersionHeader</returns>
*/
function version_headersLatestExample($service, $parent)
{
	try
	{
		...
		return $service->version_headers->LatestVersion_headers($parent);
	}
	catch (Exception $ex)
	{
