...
// Single Request.
$results = versionsPublishExample($service, $path, $optParams);
...
*/
function versionsPublishExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->versions->PublishVersions($path, $optParams);
	}
	catch (Exception $e)
	{
