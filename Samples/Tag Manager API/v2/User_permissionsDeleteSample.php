...
$results = user_permissionsDeleteExample($service, $path, $optParams);
...
*/
function user_permissionsDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->user_permissions->DeleteUser_permissions($path, $optParams);
	}
	catch (Exception $e)
	{
