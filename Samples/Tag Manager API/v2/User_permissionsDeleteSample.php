...
print_r(user_permissionsDeleteExample($service, $path));
...
*/
function user_permissionsDeleteExample($service, $path)
{
	try
	{
		...
		return $service->user_permissions->DeleteUser_permissions($path);
	}
	catch (Exception $ex)
	{
