...
// Single Request.
$results = versionsSet_latestExample($service, $path, $optParams);
...
*/
function versionsSet_latestExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->versions->Set_latestVersions($path, $optParams);
	}
	catch (Exception $e)
	{
