...
// Single Request.
$results = versionsUpdateExample($service, $path, $optParams);
...
*/
function versionsUpdateExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->versions->UpdateVersions($path, $optParams);
	}
	catch (Exception $e)
	{
