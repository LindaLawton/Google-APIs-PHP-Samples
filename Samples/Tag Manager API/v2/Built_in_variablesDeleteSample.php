...
print_r(built_in_variablesDeleteExample($service, $path));
...
*/
function built_in_variablesDeleteExample($service, $path)
{
	try
	{
		...
		return $service->built_in_variables->DeleteBuilt_in_variables($path);
	}
	catch (Exception $ex)
	{
