...
// Single Request.
$results = environmentsListExample($service, $parent, $optParams);
...
*/
function environmentsListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->environments->ListEnvironments($parent, $optParams);
	}
	catch (Exception $e)
	{
