...
print_r(environmentsCreateExample($service, $parent));
...
*/
function environmentsCreateExample($service, $parent)
{
	try
	{
		...
		return $service->environments->CreateEnvironments($parent);
	}
	catch (Exception $ex)
	{
