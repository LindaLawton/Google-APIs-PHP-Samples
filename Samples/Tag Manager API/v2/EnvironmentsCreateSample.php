...
// Single Request.
$results = environmentsCreateExample($service, $parent, $optParams);
...
* @return Environment
*/
function environmentsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->environments->CreateEnvironments($parent, $optParams);
	}
	catch (Exception $e)
	{
