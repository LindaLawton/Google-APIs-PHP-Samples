...
$results = foldersDeleteExample($service, $path, $optParams);
...
*/
function foldersDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->folders->DeleteFolders($path, $optParams);
	}
	catch (Exception $e)
	{
