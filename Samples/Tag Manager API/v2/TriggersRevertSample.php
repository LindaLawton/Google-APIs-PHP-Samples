...
// Single Request.
$results = triggersRevertExample($service, $path, $optParams);
...
*/
function triggersRevertExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->triggers->RevertTriggers($path, $optParams);
	}
	catch (Exception $e)
	{
