...
print_r(triggersRevertExample($service, $path));
...
* @return RevertTriggerResponse</returns>
*/
function triggersRevertExample($service, $path)
{
	try
	{
		...
		return $service->triggers->RevertTriggers($path);
	}
	catch (Exception $ex)
	{
