...
print_r(built_in_variablesListExample($service, $parent));
...
* @return ListEnabledBuiltInVariablesResponse</returns>
*/
function built_in_variablesListExample($service, $parent)
{
	try
	{
		...
		return $service->built_in_variables->ListBuilt_in_variables($parent);
	}
	catch (Exception $ex)
	{
