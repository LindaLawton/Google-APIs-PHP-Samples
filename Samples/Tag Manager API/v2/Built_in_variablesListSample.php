...
// Single Request.
$results = built_in_variablesListExample($service, $parent, $optParams);
...
*/
function built_in_variablesListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->built_in_variables->ListBuilt_in_variables($parent, $optParams);
	}
	catch (Exception $e)
	{
