...
print_r(built_in_variablesRevertExample($service, $path));
...
* @return RevertBuiltInVariableResponse</returns>
*/
function built_in_variablesRevertExample($service, $path)
{
	try
	{
		...
		return $service->built_in_variables->RevertBuilt_in_variables($path);
	}
	catch (Exception $ex)
	{
