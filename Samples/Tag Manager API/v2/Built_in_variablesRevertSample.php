...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'type' => '[YourValue]',  // The type of built-in variable to revert.
  'fields' => '*'
);
// Single Request.
$results = built_in_variablesRevertExample($service, $path, $optParams);
...
*/
function built_in_variablesRevertExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->built_in_variables->RevertBuilt_in_variables($path, $optParams);
	}
	catch (Exception $e)
	{
