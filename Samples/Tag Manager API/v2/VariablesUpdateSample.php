...
// Single Request.
$results = variablesUpdateExample($service, $path, $optParams);
...
* @return Variable
*/
function variablesUpdateExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->variables->UpdateVariables($path, $optParams);
	}
	catch (Exception $e)
	{
