...
// Single Request.
$results = foldersRevertExample($service, $path, $optParams);
...
*/
function foldersRevertExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->folders->RevertFolders($path, $optParams);
	}
	catch (Exception $e)
	{
