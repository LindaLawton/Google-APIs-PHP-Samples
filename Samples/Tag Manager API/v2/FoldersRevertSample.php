...
print_r(foldersRevertExample($service, $path));
...
* @return RevertFolderResponse</returns>
*/
function foldersRevertExample($service, $path)
{
	try
	{
		...
		return $service->folders->RevertFolders($path);
	}
	catch (Exception $ex)
	{
