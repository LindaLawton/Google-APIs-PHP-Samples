...
$results = versionsUndeleteExample($service, $path, $optParams);
...
*/
function versionsUndeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->versions->UndeleteVersions($path, $optParams);
	}
	catch (Exception $e)
	{
