...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'containerVersionId' => '[YourValue]',  // The GTM ContainerVersion ID. Specify published to retrieve the currently published version.
  'fields' => '*'
);
// Single Request.
$results = versionsGetExample($service, $path, $optParams);
...
*/
function versionsGetExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->versions->GetVersions($path, $optParams);
	}
	catch (Exception $e)
	{
