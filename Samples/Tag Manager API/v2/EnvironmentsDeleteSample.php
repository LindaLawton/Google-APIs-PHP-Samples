...
$results = environmentsDeleteExample($service, $path, $optParams);
...
*/
function environmentsDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->environments->DeleteEnvironments($path, $optParams);
	}
	catch (Exception $e)
	{
