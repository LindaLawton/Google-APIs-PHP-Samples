...
print_r(variablesRevertExample($service, $path));
...
* @return RevertVariableResponse</returns>
*/
function variablesRevertExample($service, $path)
{
	try
	{
		...
		return $service->variables->RevertVariables($path);
	}
	catch (Exception $ex)
	{
