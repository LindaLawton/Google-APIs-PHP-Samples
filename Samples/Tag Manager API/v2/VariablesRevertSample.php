...
// Single Request.
$results = variablesRevertExample($service, $path, $optParams);
...
*/
function variablesRevertExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->variables->RevertVariables($path, $optParams);
	}
	catch (Exception $e)
	{
