...
print_r(user_permissionsCreateExample($service, $parent));

/**
* Creates a user's Account & Container access.
* @service Authenticated Tagmanager service.
* @parent GTM Account's API relative path. Example: accounts/{account_id}
* @return UserPermission</returns>
*/
function user_permissionsCreateExample($service, $parent)
{
	try
	{
		...
		return $service->user_permissions->CreateUser_permissions($parent);
	}
	catch (Exception $ex)
	{
