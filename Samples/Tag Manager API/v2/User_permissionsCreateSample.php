...
$results = user_permissionsCreateExample($service, $parent, $optParams);
...
*/
function user_permissionsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->user_permissions->CreateUser_permissions($parent, $optParams);
	}
	catch (Exception $e)
	{
