...
$results = triggersDeleteExample($service, $path, $optParams);
...
*/
function triggersDeleteExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->triggers->DeleteTriggers($path, $optParams);
	}
	catch (Exception $e)
	{
