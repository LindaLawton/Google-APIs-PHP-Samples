...
$results = triggersCreateExample($service, $parent, $optParams);
...
* @return Trigger
*/
function triggersCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->triggers->CreateTriggers($parent, $optParams);
	}
	catch (Exception $e)
	{
