...
print_r(foldersCreateExample($service, $parent));
...
* @return Folder</returns>
*/
function foldersCreateExample($service, $parent)
{
	try
	{
		...
		return $service->folders->CreateFolders($parent);
	}
	catch (Exception $ex)
	{
