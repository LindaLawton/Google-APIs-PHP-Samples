...
// Single Request.
$results = foldersCreateExample($service, $parent, $optParams);
...
* @return Folder
*/
function foldersCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->folders->CreateFolders($parent, $optParams);
	}
	catch (Exception $e)
	{
