...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'type' => '[YourValue]',  // The types of built-in variables to enable.
  'fields' => '*'
);
// Single Request.
$results = built_in_variablesCreateExample($service, $parent, $optParams);
...
*/
function built_in_variablesCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->built_in_variables->CreateBuilt_in_variables($parent, $optParams);
	}
	catch (Exception $e)
	{
