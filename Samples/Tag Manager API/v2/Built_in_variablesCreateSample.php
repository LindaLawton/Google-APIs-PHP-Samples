...
print_r(built_in_variablesCreateExample($service, $parent));
...
* @return CreateBuiltInVariableResponse</returns>
*/
function built_in_variablesCreateExample($service, $parent)
{
	try
	{
		...
		return $service->built_in_variables->CreateBuilt_in_variables($parent);
	}
	catch (Exception $ex)
	{
