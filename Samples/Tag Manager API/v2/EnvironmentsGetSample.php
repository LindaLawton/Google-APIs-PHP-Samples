...
$results = environmentsGetExample($service, $path, $optParams);
...
* @return Environment
*/
function environmentsGetExample($service, $path, $optParams)
{
	try
	{
		...
		return $service->environments->GetEnvironments($path, $optParams);
	}
	catch (Exception $e)
	{
