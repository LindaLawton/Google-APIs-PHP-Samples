...
$results = environmentsCreateExample($service, $accountId, $containerId, $optParams);
...
* @return Environment
*/
function environmentsCreateExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->environments->CreateEnvironments($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
