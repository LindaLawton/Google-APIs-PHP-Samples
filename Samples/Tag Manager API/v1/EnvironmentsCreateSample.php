...
print_r(environmentsCreateExample($service, $accountId, $containerId));
...
*/
function environmentsCreateExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->environments->CreateEnvironments($accountId, $containerId);
	}
	catch (Exception $ex)
	{
