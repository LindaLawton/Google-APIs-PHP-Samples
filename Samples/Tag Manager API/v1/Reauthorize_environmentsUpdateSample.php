...
print_r(update($service, $accountId, $containerId, $environmentId));
...
*/
function update($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->update($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
