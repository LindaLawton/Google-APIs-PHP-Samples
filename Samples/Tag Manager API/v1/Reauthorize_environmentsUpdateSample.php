...
print_r(reauthorize_environmentsUpdateExample($service, $accountId, $containerId, $environmentId));
...
* @return Environment</returns>
*/
function reauthorize_environmentsUpdateExample($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->reauthorize_environments->UpdateReauthorize_environments($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
