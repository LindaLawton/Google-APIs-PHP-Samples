...
print_r(permissionsUpdateExample($service, $accountId, $permissionId));
...
* @return UserAccess</returns>
*/
function permissionsUpdateExample($service, $accountId, $permissionId)
{
	try
	{
		...
		return $service->permissions->UpdatePermissions($accountId, $permissionId);
	}
	catch (Exception $ex)
	{
