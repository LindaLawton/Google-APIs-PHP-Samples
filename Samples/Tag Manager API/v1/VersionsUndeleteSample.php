...
print_r(undelete($service, $accountId, $containerId, $containerVersionId));
...
*/
function undelete($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->undelete($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
