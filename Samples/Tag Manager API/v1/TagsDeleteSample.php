...
print_r(tagsDeleteExample($service, $accountId, $containerId, $tagId));
...
*/
function tagsDeleteExample($service, $accountId, $containerId, $tagId)
{
	try
	{
		...
		return $service->tags->DeleteTags($accountId, $containerId, $tagId);
	}
	catch (Exception $ex)
	{
