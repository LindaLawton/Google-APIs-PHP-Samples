...
print_r(delete($service, $accountId, $containerId, $tagId));
...
*/
function delete($service, $accountId, $containerId, $tagId)
{
	try
	{
		...
		return $service->delete($accountId, $containerId, $tagId);
	}
	catch (Exception $ex)
	{
