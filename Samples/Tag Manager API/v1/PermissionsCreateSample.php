...
// Single Request.
$results = permissionsCreateExample($service, $accountId, $optParams);
...
* @return UserAccess
*/
function permissionsCreateExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->permissions->CreatePermissions($accountId, $optParams);
	}
	catch (Exception $e)
	{
