...
print_r(permissionsCreateExample($service, $accountId));
...
*/
function permissionsCreateExample($service, $accountId)
{
	try
	{
		...
		return $service->permissions->CreatePermissions($accountId);
	}
	catch (Exception $ex)
	{
