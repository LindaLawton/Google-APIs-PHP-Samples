...
print_r(restore($service, $accountId, $containerId, $containerVersionId));
...
*/
function restore($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->restore($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
