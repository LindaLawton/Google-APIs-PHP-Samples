...
print_r(environmentsListExample($service, $accountId, $containerId));
...
* @return ListEnvironmentsResponse</returns>
*/
function environmentsListExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->environments->ListEnvironments($accountId, $containerId);
	}
	catch (Exception $ex)
	{
