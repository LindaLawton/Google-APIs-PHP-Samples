...
print_r(variablesGetExample($service, $accountId, $containerId, $variableId));
...
*/
function variablesGetExample($service, $accountId, $containerId, $variableId)
{
	try
	{
		...
		return $service->variables->GetVariables($accountId, $containerId, $variableId);
	}
	catch (Exception $ex)
	{
