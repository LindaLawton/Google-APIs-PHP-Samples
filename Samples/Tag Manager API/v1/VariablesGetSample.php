...
print_r(get($service, $accountId, $containerId, $variableId));
...
*/
function get($service, $accountId, $containerId, $variableId)
{
	try
	{
		...
		return $service->get($accountId, $containerId, $variableId);
	}
	catch (Exception $ex)
	{
