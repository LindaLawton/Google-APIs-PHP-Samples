...
print_r(versionsCreateExample($service, $accountId, $containerId));
...
* @return CreateContainerVersionResponse</returns>
*/
function versionsCreateExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->versions->CreateVersions($accountId, $containerId);
	}
	catch (Exception $ex)
	{
