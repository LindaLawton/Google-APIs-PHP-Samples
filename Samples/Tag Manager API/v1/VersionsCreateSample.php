...
// Single Request.
$results = versionsCreateExample($service, $accountId, $containerId, $optParams);
...
*/
function versionsCreateExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->versions->CreateVersions($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
