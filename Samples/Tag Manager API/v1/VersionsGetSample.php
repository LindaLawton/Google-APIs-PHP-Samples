...
print_r(versionsGetExample($service, $accountId, $containerId, $containerVersionId));
...
*/
function versionsGetExample($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->versions->GetVersions($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
