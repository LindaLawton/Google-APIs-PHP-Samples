...
print_r(get($service, $accountId, $containerId, $containerVersionId));
...
*/
function get($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->get($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
