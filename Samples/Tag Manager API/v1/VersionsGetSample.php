...
// Single Request.
$results = versionsGetExample($service, $accountId, $containerId, $containerVersionId, $optParams);
...
*/
function versionsGetExample($service, $accountId, $containerId, $containerVersionId, $optParams)
{
	try
	{
		...
		return $service->versions->GetVersions($accountId, $containerId, $containerVersionId, $optParams);
	}
	catch (Exception $e)
	{
