...
$results = environmentsGetExample($service, $accountId, $containerId, $environmentId, $optParams);
...
* @return Environment
*/
function environmentsGetExample($service, $accountId, $containerId, $environmentId, $optParams)
{
	try
	{
		...
		return $service->environments->GetEnvironments($accountId, $containerId, $environmentId, $optParams);
	}
	catch (Exception $e)
	{
