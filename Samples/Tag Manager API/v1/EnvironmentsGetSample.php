...
print_r(get($service, $accountId, $containerId, $environmentId));
...
*/
function get($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->get($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
