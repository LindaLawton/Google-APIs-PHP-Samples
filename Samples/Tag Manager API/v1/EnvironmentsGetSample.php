...
print_r(environmentsGetExample($service, $accountId, $containerId, $environmentId));
...
*/
function environmentsGetExample($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->environments->GetEnvironments($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
