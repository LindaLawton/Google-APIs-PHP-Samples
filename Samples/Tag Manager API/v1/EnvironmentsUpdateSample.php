...
print_r(environmentsUpdateExample($service, $accountId, $containerId, $environmentId));
...
*/
function environmentsUpdateExample($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->environments->UpdateEnvironments($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
