...
print_r(entitiesListExample($service, $accountId, $containerId, $folderId));
...
* @return FolderEntities</returns>
*/
function entitiesListExample($service, $accountId, $containerId, $folderId)
{
	try
	{
		...
		return $service->entities->ListEntities($accountId, $containerId, $folderId);
	}
	catch (Exception $ex)
	{
