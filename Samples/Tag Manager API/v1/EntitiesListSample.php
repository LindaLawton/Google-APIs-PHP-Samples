...
// Single Request.
$results = entitiesListExample($service, $accountId, $containerId, $folderId, $optParams);
...
*/
function entitiesListExample($service, $accountId, $containerId, $folderId, $optParams)
{
	try
	{
		...
		return $service->entities->ListEntities($accountId, $containerId, $folderId, $optParams);
	}
	catch (Exception $e)
	{
