...
print_r(list($service, $accountId, $containerId, $folderId));
...
*/
function list($service, $accountId, $containerId, $folderId)
{
	try
	{
		...
		return $service->list($accountId, $containerId, $folderId);
	}
	catch (Exception $ex)
	{
