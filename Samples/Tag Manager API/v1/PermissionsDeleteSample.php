...
print_r(permissionsDeleteExample($service, $accountId, $permissionId));
...
*/
function permissionsDeleteExample($service, $accountId, $permissionId)
{
	try
	{
		...
		return $service->permissions->DeletePermissions($accountId, $permissionId);
	}
	catch (Exception $ex)
	{
