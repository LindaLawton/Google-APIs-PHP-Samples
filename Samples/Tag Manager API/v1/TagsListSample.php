...
print_r(tagsListExample($service, $accountId, $containerId));
...
* @return ListTagsResponse</returns>
*/
function tagsListExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->tags->ListTags($accountId, $containerId);
	}
	catch (Exception $ex)
	{
