...
// Single Request.
$results = tagsListExample($service, $accountId, $containerId, $optParams);
...
*/
function tagsListExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->tags->ListTags($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
