...
print_r(variablesListExample($service, $accountId, $containerId));
...
* @return ListVariablesResponse</returns>
*/
function variablesListExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->variables->ListVariables($accountId, $containerId);
	}
	catch (Exception $ex)
	{
