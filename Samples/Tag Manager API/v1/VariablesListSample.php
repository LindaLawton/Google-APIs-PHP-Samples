...
// Single Request.
$results = variablesListExample($service, $accountId, $containerId, $optParams);
...
*/
function variablesListExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->variables->ListVariables($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
