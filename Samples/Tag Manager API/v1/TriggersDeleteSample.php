...
print_r(delete($service, $accountId, $containerId, $triggerId));
...
*/
function delete($service, $accountId, $containerId, $triggerId)
{
	try
	{
		...
		return $service->delete($accountId, $containerId, $triggerId);
	}
	catch (Exception $ex)
	{
