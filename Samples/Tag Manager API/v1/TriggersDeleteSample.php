...
print_r(triggersDeleteExample($service, $accountId, $containerId, $triggerId));
...
*/
function triggersDeleteExample($service, $accountId, $containerId, $triggerId)
{
	try
	{
		...
		return $service->triggers->DeleteTriggers($accountId, $containerId, $triggerId);
	}
	catch (Exception $ex)
	{
