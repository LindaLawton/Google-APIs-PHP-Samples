...
print_r(tagsCreateExample($service, $accountId, $containerId));
...
* @return Tag</returns>
*/
function tagsCreateExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->tags->CreateTags($accountId, $containerId);
	}
	catch (Exception $ex)
	{
