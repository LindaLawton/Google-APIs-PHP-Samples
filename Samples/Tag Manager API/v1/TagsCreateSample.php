...
// Single Request.
$results = tagsCreateExample($service, $accountId, $containerId, $optParams);
...
* @return Tag
*/
function tagsCreateExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->tags->CreateTags($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
