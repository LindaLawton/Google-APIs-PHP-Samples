...
print_r(tagsGetExample($service, $accountId, $containerId, $tagId));
...
* @return Tag</returns>
*/
function tagsGetExample($service, $accountId, $containerId, $tagId)
{
	try
	{
		...
		return $service->tags->GetTags($accountId, $containerId, $tagId);
	}
	catch (Exception $ex)
	{
