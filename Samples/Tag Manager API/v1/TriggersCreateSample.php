...
// Single Request.
$results = triggersCreateExample($service, $accountId, $containerId, $optParams);
...
* @return Trigger
*/
function triggersCreateExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->triggers->CreateTriggers($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
