...
print_r(triggersCreateExample($service, $accountId, $containerId));
...
*/
function triggersCreateExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->triggers->CreateTriggers($accountId, $containerId);
	}
	catch (Exception $ex)
	{
