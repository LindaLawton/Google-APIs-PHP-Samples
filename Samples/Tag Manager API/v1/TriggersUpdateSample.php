...
print_r(update($service, $accountId, $containerId, $triggerId));
...
*/
function update($service, $accountId, $containerId, $triggerId)
{
	try
	{
		...
		return $service->update($accountId, $containerId, $triggerId);
	}
	catch (Exception $ex)
	{
