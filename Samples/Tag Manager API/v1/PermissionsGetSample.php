...
print_r(permissionsGetExample($service, $accountId, $permissionId));
...
*/
function permissionsGetExample($service, $accountId, $permissionId)
{
	try
	{
		...
		return $service->permissions->GetPermissions($accountId, $permissionId);
	}
	catch (Exception $ex)
	{
