...
print_r(variablesCreateExample($service, $accountId, $containerId));
...
*/
function variablesCreateExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->variables->CreateVariables($accountId, $containerId);
	}
	catch (Exception $ex)
	{
