...
// Single Request.
$results = variablesCreateExample($service, $accountId, $containerId, $optParams);
...
* @return Variable
*/
function variablesCreateExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->variables->CreateVariables($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
