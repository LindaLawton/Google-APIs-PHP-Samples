...
# UnOfficial Tag Manager API v1 Samples for PHP

## API Description

Accesses Tag Manager accounts and containers.

[Official Documentation](https://developers.google.com/tag-manager/api/v1/)

## Sample Description

These samples show how to access the [Tag Manager API v1](https://developers.google.com/tag-manager/api/v1/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
