...
print_r(variablesUpdateExample($service, $accountId, $containerId, $variableId));
...
*/
function variablesUpdateExample($service, $accountId, $containerId, $variableId)
{
	try
	{
		...
		return $service->variables->UpdateVariables($accountId, $containerId, $variableId);
	}
	catch (Exception $ex)
	{
