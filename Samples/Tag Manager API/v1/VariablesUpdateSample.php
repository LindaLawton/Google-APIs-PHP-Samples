...
print_r(update($service, $accountId, $containerId, $variableId));
...
*/
function update($service, $accountId, $containerId, $variableId)
{
	try
	{
		...
		return $service->update($accountId, $containerId, $variableId);
	}
	catch (Exception $ex)
	{
