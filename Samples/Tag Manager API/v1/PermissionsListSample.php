...
// Single Request.
$results = permissionsListExample($service, $accountId, $optParams);
...
*/
function permissionsListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->permissions->ListPermissions($accountId, $optParams);
	}
	catch (Exception $e)
	{
