...
print_r(permissionsListExample($service, $accountId));
...
* @return ListAccountUsersResponse</returns>
*/
function permissionsListExample($service, $accountId)
{
	try
	{
		...
		return $service->permissions->ListPermissions($accountId);
	}
	catch (Exception $ex)
	{
