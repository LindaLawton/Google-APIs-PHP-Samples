...
print_r(patch($service, $accountId, $containerId, $environmentId));
...
*/
function patch($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->patch($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
