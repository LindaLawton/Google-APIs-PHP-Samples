...
print_r(environmentsPatchExample($service, $accountId, $containerId, $environmentId));
...
*/
function environmentsPatchExample($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->environments->PatchEnvironments($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
