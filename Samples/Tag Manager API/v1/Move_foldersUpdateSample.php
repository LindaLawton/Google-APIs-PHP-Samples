...
print_r(move_foldersUpdateExample($service, $accountId, $containerId, $folderId));
...
*/
function move_foldersUpdateExample($service, $accountId, $containerId, $folderId)
{
	try
	{
		...
		return $service->move_folders->UpdateMove_folders($accountId, $containerId, $folderId);
	}
	catch (Exception $ex)
	{
