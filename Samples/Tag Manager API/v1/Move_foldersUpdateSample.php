...
print_r(update($service, $accountId, $containerId, $folderId));
...
*/
function update($service, $accountId, $containerId, $folderId)
{
	try
	{
		...
		return $service->update($accountId, $containerId, $folderId);
	}
	catch (Exception $ex)
	{
