...
print_r(publish($service, $accountId, $containerId, $containerVersionId));
...
*/
function publish($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->publish($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
