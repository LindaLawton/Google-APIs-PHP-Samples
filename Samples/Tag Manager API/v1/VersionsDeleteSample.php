...
print_r(delete($service, $accountId, $containerId, $containerVersionId));
...
*/
function delete($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->delete($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
