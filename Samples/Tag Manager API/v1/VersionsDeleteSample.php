...
print_r(versionsDeleteExample($service, $accountId, $containerId, $containerVersionId));
...
*/
function versionsDeleteExample($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->versions->DeleteVersions($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
