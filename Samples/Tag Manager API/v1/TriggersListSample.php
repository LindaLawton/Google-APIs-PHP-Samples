...
// Single Request.
$results = triggersListExample($service, $accountId, $containerId, $optParams);
...
*/
function triggersListExample($service, $accountId, $containerId, $optParams)
{
	try
	{
		...
		return $service->triggers->ListTriggers($accountId, $containerId, $optParams);
	}
	catch (Exception $e)
	{
