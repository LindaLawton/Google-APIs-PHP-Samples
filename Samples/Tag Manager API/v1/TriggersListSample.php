...
print_r(triggersListExample($service, $accountId, $containerId));
...
* @return ListTriggersResponse</returns>
*/
function triggersListExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->triggers->ListTriggers($accountId, $containerId);
	}
	catch (Exception $ex)
	{
