...
print_r(versionsListExample($service, $accountId, $containerId));
...
* @return ListContainerVersionsResponse</returns>
*/
function versionsListExample($service, $accountId, $containerId)
{
	try
	{
		...
		return $service->versions->ListVersions($accountId, $containerId);
	}
	catch (Exception $ex)
	{
