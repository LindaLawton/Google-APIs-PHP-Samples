...
print_r(delete($service, $accountId, $containerId, $variableId));
...
*/
function delete($service, $accountId, $containerId, $variableId)
{
	try
	{
		...
		return $service->delete($accountId, $containerId, $variableId);
	}
	catch (Exception $ex)
	{
