...
print_r(variablesDeleteExample($service, $accountId, $containerId, $variableId));
...
*/
function variablesDeleteExample($service, $accountId, $containerId, $variableId)
{
	try
	{
		...
		return $service->variables->DeleteVariables($accountId, $containerId, $variableId);
	}
	catch (Exception $ex)
	{
