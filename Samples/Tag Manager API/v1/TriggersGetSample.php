...
print_r(triggersGetExample($service, $accountId, $containerId, $triggerId));
...
*/
function triggersGetExample($service, $accountId, $containerId, $triggerId)
{
	try
	{
		...
		return $service->triggers->GetTriggers($accountId, $containerId, $triggerId);
	}
	catch (Exception $ex)
	{
