...
print_r(get($service, $accountId, $containerId, $triggerId));
...
*/
function get($service, $accountId, $containerId, $triggerId)
{
	try
	{
		...
		return $service->get($accountId, $containerId, $triggerId);
	}
	catch (Exception $ex)
	{
