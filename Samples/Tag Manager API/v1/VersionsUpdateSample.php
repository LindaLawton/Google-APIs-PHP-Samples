...
print_r(update($service, $accountId, $containerId, $containerVersionId));
...
*/
function update($service, $accountId, $containerId, $containerVersionId)
{
	try
	{
		...
		return $service->update($accountId, $containerId, $containerVersionId);
	}
	catch (Exception $ex)
	{
