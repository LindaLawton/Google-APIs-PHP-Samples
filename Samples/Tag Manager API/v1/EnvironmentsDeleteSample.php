...
print_r(delete($service, $accountId, $containerId, $environmentId));
...
*/
function delete($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->delete($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
