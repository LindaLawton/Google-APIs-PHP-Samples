...
print_r(environmentsDeleteExample($service, $accountId, $containerId, $environmentId));
...
*/
function environmentsDeleteExample($service, $accountId, $containerId, $environmentId)
{
	try
	{
		...
		return $service->environments->DeleteEnvironments($accountId, $containerId, $environmentId);
	}
	catch (Exception $ex)
	{
