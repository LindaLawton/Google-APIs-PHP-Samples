...
print_r(tagsUpdateExample($service, $accountId, $containerId, $tagId));
...
* @return Tag</returns>
*/
function tagsUpdateExample($service, $accountId, $containerId, $tagId)
{
	try
	{
		...
		return $service->tags->UpdateTags($accountId, $containerId, $tagId);
	}
	catch (Exception $ex)
	{
