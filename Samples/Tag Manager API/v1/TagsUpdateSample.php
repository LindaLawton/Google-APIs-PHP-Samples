...
print_r(update($service, $accountId, $containerId, $tagId));
...
* @return Tag</returns>
*/
function update($service, $accountId, $containerId, $tagId)
{
	try
	{
		...
		return $service->update($accountId, $containerId, $tagId);
	}
	catch (Exception $ex)
	{
