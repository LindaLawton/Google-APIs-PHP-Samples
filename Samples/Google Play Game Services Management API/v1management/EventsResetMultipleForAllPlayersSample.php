...
$results = eventsResetMultipleForAllPlayersExample($service, $optParams);
...
*/
function eventsResetMultipleForAllPlayersExample($service, $optParams)
{
	try
	{
		...
		return $service->events->ResetMultipleForAllPlayersEvents($optParams);
	}
	catch (Exception $e)
	{
