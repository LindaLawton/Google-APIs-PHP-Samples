...
print_r(eventsResetMultipleForAllPlayersExample($service));
...
*/
function eventsResetMultipleForAllPlayersExample($service)
{
	try
	{
		...
		return $service->events->ResetMultipleForAllPlayersEvents();
	}
	catch (Exception $ex)
	{
