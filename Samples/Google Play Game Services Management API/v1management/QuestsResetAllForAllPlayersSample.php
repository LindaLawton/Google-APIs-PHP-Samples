...
print_r(questsResetAllForAllPlayersExample($service));
...
*/
function questsResetAllForAllPlayersExample($service)
{
	try
	{
		...
		return $service->quests->ResetAllForAllPlayersQuests();
	}
	catch (Exception $ex)
	{
