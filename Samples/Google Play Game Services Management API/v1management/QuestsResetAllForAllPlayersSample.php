...
$results = questsResetAllForAllPlayersExample($service, $optParams);
...
*/
function questsResetAllForAllPlayersExample($service, $optParams)
{
	try
	{
		...
		return $service->quests->ResetAllForAllPlayersQuests($optParams);
	}
	catch (Exception $e)
	{
