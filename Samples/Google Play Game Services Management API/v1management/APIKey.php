 ...
 * Initializes an Gamesmanagement.v1management service object.
 * @param string API key
 * @return An authorized Gamesmanagement.v1management service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Gamesmanagement Sample");
		...
		// Create authenticated Gamesmanagement service
		return new Google_Service_Gamesmanagement($client);
	} catch (Exception $e) {
