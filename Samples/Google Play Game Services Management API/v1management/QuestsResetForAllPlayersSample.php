...
print_r(questsResetForAllPlayersExample($service, $questId));
...
*/
function questsResetForAllPlayersExample($service, $questId)
{
	try
	{
		...
		return $service->quests->ResetForAllPlayersQuests($questId);
	}
	catch (Exception $ex)
	{
