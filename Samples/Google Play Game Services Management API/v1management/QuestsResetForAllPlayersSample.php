...
$results = questsResetForAllPlayersExample($service, $questId, $optParams);
...
*/
function questsResetForAllPlayersExample($service, $questId, $optParams)
{
	try
	{
		...
		if (questId == null)
			throw new Exception("questId is required.");
		// Make the request and return the results.
		return $service->quests->ResetForAllPlayersQuests($questId, $optParams);
	}
	catch (Exception $e)
	{
