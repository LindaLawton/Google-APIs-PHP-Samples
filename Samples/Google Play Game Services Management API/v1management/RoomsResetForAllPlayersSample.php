...
$results = roomsResetForAllPlayersExample($service, $optParams);
...
*/
function roomsResetForAllPlayersExample($service, $optParams)
{
	try
	{
		...
		return $service->rooms->ResetForAllPlayersRooms($optParams);
	}
	catch (Exception $e)
	{
