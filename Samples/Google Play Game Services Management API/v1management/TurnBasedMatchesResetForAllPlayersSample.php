...
print_r(turnBasedMatchesResetForAllPlayersExample($service));
...
*/
function turnBasedMatchesResetForAllPlayersExample($service)
{
	try
	{
		...
		return $service->turnBasedMatches->ResetForAllPlayersTurnBasedMatches();
	}
	catch (Exception $ex)
	{
