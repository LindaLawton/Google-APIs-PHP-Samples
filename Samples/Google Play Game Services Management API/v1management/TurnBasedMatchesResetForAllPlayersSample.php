...
$results = turnBasedMatchesResetForAllPlayersExample($service, $optParams);
...
*/
function turnBasedMatchesResetForAllPlayersExample($service, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->ResetForAllPlayersTurnBasedMatches($optParams);
	}
	catch (Exception $e)
	{
