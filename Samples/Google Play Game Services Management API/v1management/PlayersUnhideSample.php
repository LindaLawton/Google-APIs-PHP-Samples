...
print_r(playersUnhideExample($service, $applicationId, $playerId));
...
*/
function playersUnhideExample($service, $applicationId, $playerId)
{
	try
	{
		...
		return $service->players->UnhidePlayers($applicationId, $playerId);
	}
	catch (Exception $ex)
	{
