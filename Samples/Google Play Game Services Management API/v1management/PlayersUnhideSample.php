...
$results = playersUnhideExample($service, $applicationId, $playerId, $optParams);
...
*/
function playersUnhideExample($service, $applicationId, $playerId, $optParams)
{
	try
	{
		...
		return $service->players->UnhidePlayers($applicationId, $playerId, $optParams);
	}
	catch (Exception $e)
	{
