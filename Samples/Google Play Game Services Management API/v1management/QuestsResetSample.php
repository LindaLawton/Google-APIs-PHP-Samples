...
$results = questsResetExample($service, $questId, $optParams);
...
*/
function questsResetExample($service, $questId, $optParams)
{
	try
	{
		...
		return $service->quests->ResetQuests($questId, $optParams);
	}
	catch (Exception $e)
	{
