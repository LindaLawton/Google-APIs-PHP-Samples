...
print_r(questsResetMultipleForAllPlayersExample($service));
...
*/
function questsResetMultipleForAllPlayersExample($service)
{
	try
	{
		...
		return $service->quests->ResetMultipleForAllPlayersQuests();
	}
	catch (Exception $ex)
	{
