...
$results = questsResetMultipleForAllPlayersExample($service, $optParams);
...
*/
function questsResetMultipleForAllPlayersExample($service, $optParams)
{
	try
	{
		...
		return $service->quests->ResetMultipleForAllPlayersQuests($optParams);
	}
	catch (Exception $e)
	{
