...
$results = playersHideExample($service, $applicationId, $playerId, $optParams);
...
*/
function playersHideExample($service, $applicationId, $playerId, $optParams)
{
	try
	{
		...
		return $service->players->HidePlayers($applicationId, $playerId, $optParams);
	}
	catch (Exception $e)
	{
