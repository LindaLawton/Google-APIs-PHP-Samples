...
print_r(playersHideExample($service, $applicationId, $playerId));
...
*/
function playersHideExample($service, $applicationId, $playerId)
{
	try
	{
		...
		return $service->players->HidePlayers($applicationId, $playerId);
	}
	catch (Exception $ex)
	{
