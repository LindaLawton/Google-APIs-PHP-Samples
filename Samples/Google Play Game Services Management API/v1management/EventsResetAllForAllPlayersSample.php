...
print_r(eventsResetAllForAllPlayersExample($service));
...
*/
function eventsResetAllForAllPlayersExample($service)
{
	try
	{
		...
		return $service->events->ResetAllForAllPlayersEvents();
	}
	catch (Exception $ex)
	{
