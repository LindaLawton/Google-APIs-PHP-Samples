...
$results = eventsResetAllForAllPlayersExample($service, $optParams);
...
*/
function eventsResetAllForAllPlayersExample($service, $optParams)
{
	try
	{
		...
		return $service->events->ResetAllForAllPlayersEvents($optParams);
	}
	catch (Exception $e)
	{
