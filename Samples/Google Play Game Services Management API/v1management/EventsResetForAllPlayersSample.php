...
print_r(eventsResetForAllPlayersExample($service, $eventId));
...
*/
function eventsResetForAllPlayersExample($service, $eventId)
{
	try
	{
		...
		return $service->events->ResetForAllPlayersEvents($eventId);
	}
	catch (Exception $ex)
	{
