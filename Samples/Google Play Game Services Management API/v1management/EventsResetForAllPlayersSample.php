...
$results = eventsResetForAllPlayersExample($service, $eventId, $optParams);
...
*/
function eventsResetForAllPlayersExample($service, $eventId, $optParams)
{
	try
	{
		...
		return $service->events->ResetForAllPlayersEvents($eventId, $optParams);
	}
	catch (Exception $e)
	{
