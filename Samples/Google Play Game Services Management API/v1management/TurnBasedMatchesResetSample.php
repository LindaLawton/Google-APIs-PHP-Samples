...
$results = turnBasedMatchesResetExample($service, $optParams);
...
*/
function turnBasedMatchesResetExample($service, $optParams)
{
	try
	{
		...
		return $service->turnBasedMatches->ResetTurnBasedMatches($optParams);
	}
	catch (Exception $e)
	{
