...
$results = eventsResetExample($service, $eventId, $optParams);
...
*/
function eventsResetExample($service, $eventId, $optParams)
{
	try
	{
		...
		return $service->events->ResetEvents($eventId, $optParams);
	}
	catch (Exception $e)
	{
