...
# Unoffical Google Play Game Services Management API Samples for PHP
...
These samples show how to access the [Google Play Game Services Management API](https://developers.google.com/games/services) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
