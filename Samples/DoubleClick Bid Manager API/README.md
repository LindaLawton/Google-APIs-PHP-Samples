...
# Unoffical DoubleClick Bid Manager API Samples for PHP
...
These samples show how to access the [DoubleClick Bid Manager API](https://developers.google.com/bid-manager/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
