...
$results = reportsListreportsExample($service, $queryId, $optParams);
...
*/
function reportsListreportsExample($service, $queryId, $optParams)
{
	try
	{
		...
		return $service->reports->ListreportsReports($queryId, $optParams);
	}
	catch (Exception $e)
	{
