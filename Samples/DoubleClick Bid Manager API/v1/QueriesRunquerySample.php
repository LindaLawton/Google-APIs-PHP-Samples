...
$results = queriesRunqueryExample($service, $queryId, $optParams);
...
*/
function queriesRunqueryExample($service, $queryId, $optParams)
{
	try
	{
		...
		return $service->queries->RunqueryQueries($queryId, $optParams);
	}
	catch (Exception $e)
	{
