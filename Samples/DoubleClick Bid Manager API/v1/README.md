...
# UnOfficial DoubleClick Bid Manager API v1 Samples for PHP

## API Description

API for viewing and managing your reports in DoubleClick Bid Manager.

[Official Documentation](https://developers.google.com/bid-manager/)

## Sample Description

These samples show how to access the [DoubleClick Bid Manager API v1](https://developers.google.com/bid-manager/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
