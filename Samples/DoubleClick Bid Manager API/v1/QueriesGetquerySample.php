...
// Single Request.
$results = queriesGetqueryExample($service, $queryId, $optParams);
...
* @return Query
*/
function queriesGetqueryExample($service, $queryId, $optParams)
{
	try
	{
		...
		return $service->queries->GetqueryQueries($queryId, $optParams);
	}
	catch (Exception $e)
	{
