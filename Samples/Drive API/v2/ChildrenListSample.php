...
print_r(childrenListExample($service, $folderId));

/**
* Lists a folder's children.
* @service Authenticated Drive service.
* @folderId The ID of the folder.
* @return ChildList</returns>
*/
function childrenListExample($service, $folderId)
{
	try
	{
		...
		return $service->children->ListChildren($folderId);
	}
	catch (Exception $ex)
	{
