...
// Single Request.
$results = teamdrivesInsertExample($service, $requestId, $optParams);
...
* @return TeamDrive
*/
function teamdrivesInsertExample($service, $requestId, $optParams)
{
	try
	{
		...
		return $service->teamdrives->InsertTeamdrives($requestId, $optParams);
	}
	catch (Exception $e)
	{
