...
print_r(teamdrivesInsertExample($service, $requestId));
...
*/
function teamdrivesInsertExample($service, $requestId)
{
	try
	{
		...
		return $service->teamdrives->InsertTeamdrives($requestId);
	}
	catch (Exception $ex)
	{
