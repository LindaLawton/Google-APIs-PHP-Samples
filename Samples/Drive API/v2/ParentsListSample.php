...
// Single Request.
$results = parentsListExample($service, $fileId, $optParams);
...
* @return ParentList
*/
function parentsListExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->parents->ListParents($fileId, $optParams);
	}
	catch (Exception $e)
	{
