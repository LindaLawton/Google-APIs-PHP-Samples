...
// Single Request.
$results = permissionsPatchExample($service, $fileId, $permissionId, $optParams);
...
* @return Permission
*/
function permissionsPatchExample($service, $fileId, $permissionId, $optParams)
{
	try
	{
		...
		return $service->permissions->PatchPermissions($fileId, $permissionId, $optParams);
	}
	catch (Exception $e)
	{
