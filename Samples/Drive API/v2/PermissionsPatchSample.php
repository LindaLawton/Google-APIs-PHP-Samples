...
print_r(permissionsPatchExample($service, $fileId, $permissionId));
...
*/
function permissionsPatchExample($service, $fileId, $permissionId)
{
	try
	{
		...
		return $service->permissions->PatchPermissions($fileId, $permissionId);
	}
	catch (Exception $ex)
	{
