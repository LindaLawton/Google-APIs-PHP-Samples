...
print_r(propertiesUpdateExample($service, $fileId, $propertyKey));
...
*/
function propertiesUpdateExample($service, $fileId, $propertyKey)
{
	try
	{
		...
		return $service->properties->UpdateProperties($fileId, $propertyKey);
	}
	catch (Exception $ex)
	{
