...
$results = propertiesUpdateExample($service, $fileId, $propertyKey, $optParams);
...
* @return Property
*/
function propertiesUpdateExample($service, $fileId, $propertyKey, $optParams)
{
	try
	{
		...
		return $service->properties->UpdateProperties($fileId, $propertyKey, $optParams);
	}
	catch (Exception $e)
	{
