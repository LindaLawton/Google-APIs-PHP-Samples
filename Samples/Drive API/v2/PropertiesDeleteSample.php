...
print_r(propertiesDeleteExample($service, $fileId, $propertyKey));
...
*/
function propertiesDeleteExample($service, $fileId, $propertyKey)
{
	try
	{
		...
		return $service->properties->DeleteProperties($fileId, $propertyKey);
	}
	catch (Exception $ex)
	{
