...
print_r(childrenDeleteExample($service, $folderId, $childId));
...
*/
function childrenDeleteExample($service, $folderId, $childId)
{
	try
	{
		...
		return $service->children->DeleteChildren($folderId, $childId);
	}
	catch (Exception $ex)
	{
