...
print_r(commentsDeleteExample($service, $fileId, $commentId));
...
*/
function commentsDeleteExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->comments->DeleteComments($fileId, $commentId);
	}
	catch (Exception $ex)
	{
