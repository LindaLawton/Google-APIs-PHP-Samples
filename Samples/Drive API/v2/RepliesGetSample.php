...
print_r(repliesGetExample($service, $fileId, $commentId, $replyId));
...
*/
function repliesGetExample($service, $fileId, $commentId, $replyId)
{
	try
	{
		...
		return $service->replies->GetReplies($fileId, $commentId, $replyId);
	}
	catch (Exception $ex)
	{
