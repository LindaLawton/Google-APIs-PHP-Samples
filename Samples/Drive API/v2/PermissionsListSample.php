...
print_r(permissionsListExample($service, $fileId));

/**
* Lists a file's or Team Drive's permissions.
* @service Authenticated Drive service.
* @fileId The ID for the file or Team Drive.
* @return PermissionList</returns>
*/
function permissionsListExample($service, $fileId)
{
	try
	{
		...
		return $service->permissions->ListPermissions($fileId);
	}
	catch (Exception $ex)
	{
