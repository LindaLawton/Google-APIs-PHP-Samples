...
print_r(repliesInsertExample($service, $fileId, $commentId));
...
*/
function repliesInsertExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->replies->InsertReplies($fileId, $commentId);
	}
	catch (Exception $ex)
	{
