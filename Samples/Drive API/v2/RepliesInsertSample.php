...
// Single Request.
$results = repliesInsertExample($service, $fileId, $commentId, $optParams);
...
* @return CommentReply
*/
function repliesInsertExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->replies->InsertReplies($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
