...
$results = repliesPatchExample($service, $fileId, $commentId, $replyId, $optParams);
...
* @return CommentReply
*/
function repliesPatchExample($service, $fileId, $commentId, $replyId, $optParams)
{
	try
	{
		...
		return $service->replies->PatchReplies($fileId, $commentId, $replyId, $optParams);
	}
	catch (Exception $e)
	{
