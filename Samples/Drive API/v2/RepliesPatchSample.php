...
print_r(repliesPatchExample($service, $fileId, $commentId, $replyId));
...
*/
function repliesPatchExample($service, $fileId, $commentId, $replyId)
{
	try
	{
		...
		return $service->replies->PatchReplies($fileId, $commentId, $replyId);
	}
	catch (Exception $ex)
	{
