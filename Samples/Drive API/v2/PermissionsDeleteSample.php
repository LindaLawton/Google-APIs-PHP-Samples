...
$results = permissionsDeleteExample($service, $fileId, $permissionId, $optParams);
...
*/
function permissionsDeleteExample($service, $fileId, $permissionId, $optParams)
{
	try
	{
		...
		return $service->permissions->DeletePermissions($fileId, $permissionId, $optParams);
	}
	catch (Exception $e)
	{
