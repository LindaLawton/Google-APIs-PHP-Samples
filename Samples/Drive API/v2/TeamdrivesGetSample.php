...
// Single Request.
$results = teamdrivesGetExample($service, $teamDriveId, $optParams);
...
* @return TeamDrive
*/
function teamdrivesGetExample($service, $teamDriveId, $optParams)
{
	try
	{
		...
		return $service->teamdrives->GetTeamdrives($teamDriveId, $optParams);
	}
	catch (Exception $e)
	{
