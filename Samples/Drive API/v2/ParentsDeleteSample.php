...
print_r(parentsDeleteExample($service, $fileId, $parentId));
...
*/
function parentsDeleteExample($service, $fileId, $parentId)
{
	try
	{
		...
		return $service->parents->DeleteParents($fileId, $parentId);
	}
	catch (Exception $ex)
	{
