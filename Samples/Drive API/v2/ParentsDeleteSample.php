...
$results = parentsDeleteExample($service, $fileId, $parentId, $optParams);
...
*/
function parentsDeleteExample($service, $fileId, $parentId, $optParams)
{
	try
	{
		...
		return $service->parents->DeleteParents($fileId, $parentId, $optParams);
	}
	catch (Exception $e)
	{
