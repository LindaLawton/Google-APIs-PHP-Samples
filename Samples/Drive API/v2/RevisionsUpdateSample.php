...
print_r(revisionsUpdateExample($service, $fileId, $revisionId));
...
* @return Revision</returns>
*/
function revisionsUpdateExample($service, $fileId, $revisionId)
{
	try
	{
		...
		return $service->revisions->UpdateRevisions($fileId, $revisionId);
	}
	catch (Exception $ex)
	{
