...
print_r(permissionsUpdateExample($service, $fileId, $permissionId));
...
*/
function permissionsUpdateExample($service, $fileId, $permissionId)
{
	try
	{
		...
		return $service->permissions->UpdatePermissions($fileId, $permissionId);
	}
	catch (Exception $ex)
	{
