...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeDeleted' => '[YourValue]',  // If set, this will succeed when retrieving a deleted comment, and will include any deleted replies.
  'fields' => '*'
);
// Single Request.
$results = commentsGetExample($service, $fileId, $commentId, $optParams);
...
* @return Comment
*/
function commentsGetExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->GetComments($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
