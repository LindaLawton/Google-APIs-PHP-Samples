...
$results = commentsPatchExample($service, $fileId, $commentId, $optParams);
...
* @return Comment
*/
function commentsPatchExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->PatchComments($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
