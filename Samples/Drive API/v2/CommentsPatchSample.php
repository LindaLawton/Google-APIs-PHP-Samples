...
print_r(commentsPatchExample($service, $fileId, $commentId));
...
*/
function commentsPatchExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->comments->PatchComments($fileId, $commentId);
	}
	catch (Exception $ex)
	{
