...
$results = filesExportExample($service, $fileId, $mimeType, $optParams);
...
*/
function filesExportExample($service, $fileId, $mimeType, $optParams)
{
	try
	{
		...
		return $service->files->ExportFiles($fileId, $mimeType, $optParams);
	}
	catch (Exception $e)
	{
