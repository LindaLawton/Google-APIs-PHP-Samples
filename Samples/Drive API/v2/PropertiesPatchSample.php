...
print_r(propertiesPatchExample($service, $fileId, $propertyKey));
...
*/
function propertiesPatchExample($service, $fileId, $propertyKey)
{
	try
	{
		...
		return $service->properties->PatchProperties($fileId, $propertyKey);
	}
	catch (Exception $ex)
	{
