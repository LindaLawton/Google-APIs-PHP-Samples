...
$results = propertiesPatchExample($service, $fileId, $propertyKey, $optParams);
...
* @return Property
*/
function propertiesPatchExample($service, $fileId, $propertyKey, $optParams)
{
	try
	{
		...
		return $service->properties->PatchProperties($fileId, $propertyKey, $optParams);
	}
	catch (Exception $e)
	{
