...
$results = commentsInsertExample($service, $fileId, $optParams);
...
* @return Comment
*/
function commentsInsertExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->comments->InsertComments($fileId, $optParams);
	}
	catch (Exception $e)
	{
