...
// Single Request.
$results = propertiesInsertExample($service, $fileId, $optParams);
...
* @return Property
*/
function propertiesInsertExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->properties->InsertProperties($fileId, $optParams);
	}
	catch (Exception $e)
	{
