...
// Single Request.
$results = parentsGetExample($service, $fileId, $parentId, $optParams);
...
*/
function parentsGetExample($service, $fileId, $parentId, $optParams)
{
	try
	{
		...
		return $service->parents->GetParents($fileId, $parentId, $optParams);
	}
	catch (Exception $e)
	{
