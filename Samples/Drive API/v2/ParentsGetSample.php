...
print_r(parentsGetExample($service, $fileId, $parentId));
...
* @return ParentReference</returns>
*/
function parentsGetExample($service, $fileId, $parentId)
{
	try
	{
		...
		return $service->parents->GetParents($fileId, $parentId);
	}
	catch (Exception $ex)
	{
