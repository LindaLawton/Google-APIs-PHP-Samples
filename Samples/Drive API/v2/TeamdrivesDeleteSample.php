...
$results = teamdrivesDeleteExample($service, $teamDriveId, $optParams);
...
*/
function teamdrivesDeleteExample($service, $teamDriveId, $optParams)
{
	try
	{
		...
		return $service->teamdrives->DeleteTeamdrives($teamDriveId, $optParams);
	}
	catch (Exception $e)
	{
