...
print_r(propertiesListExample($service, $fileId));

/**
* Lists a file's properties.
* @service Authenticated Drive service.
* @fileId The ID of the file.
* @return PropertyList</returns>
*/
function propertiesListExample($service, $fileId)
{
	try
	{
		...
		return $service->properties->ListProperties($fileId);
	}
	catch (Exception $ex)
	{
