...
// Single Request.
$results = propertiesListExample($service, $fileId, $optParams);
...
* @return PropertyList
*/
function propertiesListExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->properties->ListProperties($fileId, $optParams);
	}
	catch (Exception $e)
	{
