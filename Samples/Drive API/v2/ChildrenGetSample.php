...
// Single Request.
$results = childrenGetExample($service, $folderId, $childId, $optParams);
...
*/
function childrenGetExample($service, $folderId, $childId, $optParams)
{
	try
	{
		...
		if (childId == null)
			throw new Exception("childId is required.");
		if (folderId == null)
			throw new Exception("folderId is required.");
		// Make the request and return the results.
		return $service->children->GetChildren($folderId, $childId, $optParams);
	}
	catch (Exception $e)
	{
