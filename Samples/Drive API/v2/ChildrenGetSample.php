...
print_r(childrenGetExample($service, $folderId, $childId));
...
* @return ChildReference</returns>
*/
function childrenGetExample($service, $folderId, $childId)
{
	try
	{
		...
		return $service->children->GetChildren($folderId, $childId);
	}
	catch (Exception $ex)
	{
