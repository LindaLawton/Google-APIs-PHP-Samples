...
// Single Request.
$results = filesUntrashExample($service, $fileId, $optParams);
...
* @return File
*/
function filesUntrashExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->files->UntrashFiles($fileId, $optParams);
	}
	catch (Exception $e)
	{
