...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // Maximum number of Team Drives to return.
            
  //'pageToken' => '[YourValue]',  // Page token for Team Drives.
  'fields' => '*'
);
// Single Request.
$results = teamdrivesListExample($service, $optParams);
...
*/
function teamdrivesListExample($service, $optParams)
{
	try
	{
		...
		return $service->teamdrives->ListTeamdrives($optParams);
	}
	catch (Exception $e)
	{
