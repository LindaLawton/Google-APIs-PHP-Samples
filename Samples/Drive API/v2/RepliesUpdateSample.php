...
print_r(repliesUpdateExample($service, $fileId, $commentId, $replyId));
...
* @return CommentReply</returns>
*/
function repliesUpdateExample($service, $fileId, $commentId, $replyId)
{
	try
	{
		...
		return $service->replies->UpdateReplies($fileId, $commentId, $replyId);
	}
	catch (Exception $ex)
	{
