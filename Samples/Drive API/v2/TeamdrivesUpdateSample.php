...
print_r(teamdrivesUpdateExample($service, $teamDriveId));

/**
* Updates a Team Drive's metadata
* @service Authenticated Drive service.
* @teamDriveId The ID of the Team Drive
* @return TeamDrive</returns>
*/
function teamdrivesUpdateExample($service, $teamDriveId)
{
	try
	{
		...
		return $service->teamdrives->UpdateTeamdrives($teamDriveId);
	}
	catch (Exception $ex)
	{
