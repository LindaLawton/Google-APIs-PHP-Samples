...
print_r(changesGetStartPageTokenExample($service));

/**
* Gets the starting pageToken for listing future changes.
* @service Authenticated Drive service.
* @return StartPageToken</returns>
*/
function changesGetStartPageTokenExample($service)
{
	try
	{
		...
		return $service->changes->GetStartPageTokenChanges();
	}
	catch (Exception $ex)
	{
