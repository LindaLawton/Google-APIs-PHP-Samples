...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'teamDriveId' => '[YourValue]',  // The ID of the Team Drive for which the starting pageToken for listing future changes from that Team Drive will be returned.
  'fields' => '*'
);
// Single Request.
$results = changesGetStartPageTokenExample($service, $optParams);
...
*/
function changesGetStartPageTokenExample($service, $optParams)
{
	try
	{
		...
		return $service->changes->GetStartPageTokenChanges($optParams);
	}
	catch (Exception $e)
	{
