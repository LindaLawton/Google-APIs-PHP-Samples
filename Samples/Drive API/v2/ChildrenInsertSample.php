...
// Single Request.
$results = childrenInsertExample($service, $folderId, $optParams);
...
*/
function childrenInsertExample($service, $folderId, $optParams)
{
	try
	{
		...
		return $service->children->InsertChildren($folderId, $optParams);
	}
	catch (Exception $e)
	{
