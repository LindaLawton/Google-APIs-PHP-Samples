...
// Single Request.
$results = revisionsPatchExample($service, $fileId, $revisionId, $optParams);
...
* @return Revision
*/
function revisionsPatchExample($service, $fileId, $revisionId, $optParams)
{
	try
	{
		...
		return $service->revisions->PatchRevisions($fileId, $revisionId, $optParams);
	}
	catch (Exception $e)
	{
