...
print_r(revisionsPatchExample($service, $fileId, $revisionId));
...
*/
function revisionsPatchExample($service, $fileId, $revisionId)
{
	try
	{
		...
		return $service->revisions->PatchRevisions($fileId, $revisionId);
	}
	catch (Exception $ex)
	{
