...
print_r(repliesListExample($service, $fileId, $commentId));
...
* @return CommentReplyList</returns>
*/
function repliesListExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->replies->ListReplies($fileId, $commentId);
	}
	catch (Exception $ex)
	{
