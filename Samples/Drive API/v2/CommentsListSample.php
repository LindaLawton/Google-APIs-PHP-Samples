...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeDeleted' => '[YourValue]',  // If set, all comments and replies, including deleted comments and replies (with content stripped) will be returned.
            
  //'maxResults' => '[YourValue]',  // The maximum number of discussions to include in the response, used for paging.
  ...
  //'updatedMin' => '[YourValue]',  // Only discussions that were updated after this timestamp will be returned. Formatted as an RFC 3339 timestamp.
  'fields' => '*'
);
// Single Request.
...
do {
	...
	$results = filesListExample($service, $fileId, $optParams);	
...
* @return CommentList
*/
function commentsListExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->comments->ListComments($fileId, $optParams);
	}
	catch (Exception $e)
	{
