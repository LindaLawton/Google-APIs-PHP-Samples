...
// Single Request.
$results = permissionsGetIdForEmailExample($service, $email, $optParams);
...
* @return PermissionId
*/
function permissionsGetIdForEmailExample($service, $email, $optParams)
{
	try
	{
		...
		return $service->permissions->GetIdForEmailPermissions($email, $optParams);
	}
	catch (Exception $e)
	{
