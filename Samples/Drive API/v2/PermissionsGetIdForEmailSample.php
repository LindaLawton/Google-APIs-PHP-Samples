...
print_r(permissionsGetIdForEmailExample($service, $email));

/**
* Returns the permission ID for an email address.
* @service Authenticated Drive service.
* @email The email address for which to return a permission ID
* @return PermissionId</returns>
*/
function permissionsGetIdForEmailExample($service, $email)
{
	try
	{
		...
		return $service->permissions->GetIdForEmailPermissions($email);
	}
	catch (Exception $ex)
	{
