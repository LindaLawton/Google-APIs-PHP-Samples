...
print_r(repliesDeleteExample($service, $fileId, $commentId, $replyId));
...
*/
function repliesDeleteExample($service, $fileId, $commentId, $replyId)
{
	try
	{
		...
		return $service->replies->DeleteReplies($fileId, $commentId, $replyId);
	}
	catch (Exception $ex)
	{
