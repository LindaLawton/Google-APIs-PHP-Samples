...
print_r(propertiesGetExample($service, $fileId, $propertyKey));
...
*/
function propertiesGetExample($service, $fileId, $propertyKey)
{
	try
	{
		...
		return $service->properties->GetProperties($fileId, $propertyKey);
	}
	catch (Exception $ex)
	{
