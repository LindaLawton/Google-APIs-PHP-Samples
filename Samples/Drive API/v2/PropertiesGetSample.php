...
$results = propertiesGetExample($service, $fileId, $propertyKey, $optParams);
...
* @return Property
*/
function propertiesGetExample($service, $fileId, $propertyKey, $optParams)
{
	try
	{
		...
		return $service->properties->GetProperties($fileId, $propertyKey, $optParams);
	}
	catch (Exception $e)
	{
