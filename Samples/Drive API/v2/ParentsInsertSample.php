...
$results = parentsInsertExample($service, $fileId, $optParams);
...
*/
function parentsInsertExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->parents->InsertParents($fileId, $optParams);
	}
	catch (Exception $e)
	{
