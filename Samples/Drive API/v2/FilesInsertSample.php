...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pinned' => '[YourValue]',  // Whether to pin the head revision of the uploaded file. A file can have a maximum of 200 pinned revisions.
  ...
  //'visibility' => '[YourValue]',  // The visibility of the new file. This parameter is only relevant when convert=false.
  'fields' => '*'
);
// Single Request.
$results = filesInsertExample($service, $optParams);
...
* @return File
*/
function filesInsertExample($service, $optParams)
{
	try
	{
		...
		return $service->files->InsertFiles($optParams);
	}
	catch (Exception $e)
	{
