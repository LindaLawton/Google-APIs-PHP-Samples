...
print_r(revisionsDeleteExample($service, $fileId, $revisionId));
...
*/
function revisionsDeleteExample($service, $fileId, $revisionId)
{
	try
	{
		...
		return $service->revisions->DeleteRevisions($fileId, $revisionId);
	}
	catch (Exception $ex)
	{
