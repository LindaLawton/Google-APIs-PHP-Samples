...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeDeleted' => '[YourValue]',  //Whether to return deleted replies. Deleted replies will not include their original content.
  'fields' => '*'
);
// Single Request.
$results = repliesGetExample($service, $fileId, $commentId, $replyId, $optParams);
...
* @return Reply
*/
function repliesGetExample($service, $fileId, $commentId, $replyId, $optParams)
{
	try
	{
		...
		if (replyId == null)
			throw new Exception("replyId is required.");
		// Make the request and return the results.
		return $service->replies->GetReplies($fileId, $commentId, $replyId, $optParams);
	}
	catch (Exception $e)
	{
