...
print_r(repliesCreateExample($service, $fileId, $commentId));
...
*/
function repliesCreateExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->replies->CreateReplies($fileId, $commentId);
	}
	catch (Exception $ex)
	{
