...
// Single Request.
$results = repliesCreateExample($service, $fileId, $commentId, $optParams);
...
* @return Reply
*/
function repliesCreateExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->replies->CreateReplies($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
