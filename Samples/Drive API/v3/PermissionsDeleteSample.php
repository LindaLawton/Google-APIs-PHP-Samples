...
print_r(permissionsDeleteExample($service, $fileId, $permissionId));
...
*/
function permissionsDeleteExample($service, $fileId, $permissionId)
{
	try
	{
		...
		return $service->permissions->DeletePermissions($fileId, $permissionId);
	}
	catch (Exception $ex)
	{
