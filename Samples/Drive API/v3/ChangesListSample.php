...
$results = changesListExample($service, $pageToken, $optParams);
...
* @return ChangeList
*/
function changesListExample($service, $pageToken, $optParams)
{
	try
	{
		...
		return $service->changes->ListChanges($pageToken, $optParams);
	}
	catch (Exception $e)
	{
