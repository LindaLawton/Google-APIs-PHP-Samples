...
print_r(changesListExample($service, $pageToken));
...
* @return ChangeList</returns>
*/
function changesListExample($service, $pageToken)
{
	try
	{
		...
		return $service->changes->ListChanges($pageToken);
	}
	catch (Exception $ex)
	{
