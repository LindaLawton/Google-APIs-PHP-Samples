...
print_r(commentsGetExample($service, $fileId, $commentId));
...
*/
function commentsGetExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->comments->GetComments($fileId, $commentId);
	}
	catch (Exception $ex)
	{
