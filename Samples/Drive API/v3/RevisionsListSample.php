...
print_r(revisionsListExample($service, $fileId));

/**
* Lists a file's revisions.
* @service Authenticated Drive service.
* @fileId The ID of the file.
* @return RevisionList</returns>
*/
function revisionsListExample($service, $fileId)
{
	try
	{
		...
		return $service->revisions->ListRevisions($fileId);
	}
	catch (Exception $ex)
	{
