...
// Single Request.
$results = teamdrivesUpdateExample($service, $teamDriveId, $optParams);
...
* @return TeamDrive
*/
function teamdrivesUpdateExample($service, $teamDriveId, $optParams)
{
	try
	{
		...
		if (teamDriveId == null)
			throw new Exception("teamDriveId is required.");
		// Make the request and return the results.
		return $service->teamdrives->UpdateTeamdrives($teamDriveId, $optParams);
	}
	catch (Exception $e)
	{
