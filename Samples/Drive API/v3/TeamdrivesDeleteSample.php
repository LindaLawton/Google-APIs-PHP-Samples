...
print_r(teamdrivesDeleteExample($service, $teamDriveId));
...
*/
function teamdrivesDeleteExample($service, $teamDriveId)
{
	try
	{
		...
		return $service->teamdrives->DeleteTeamdrives($teamDriveId);
	}
	catch (Exception $ex)
	{
