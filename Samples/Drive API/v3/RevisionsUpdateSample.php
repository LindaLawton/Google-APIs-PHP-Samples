...
// Single Request.
$results = revisionsUpdateExample($service, $fileId, $revisionId, $optParams);
...
* @return Revision
*/
function revisionsUpdateExample($service, $fileId, $revisionId, $optParams)
{
	try
	{
		...
		return $service->revisions->UpdateRevisions($fileId, $revisionId, $optParams);
	}
	catch (Exception $e)
	{
