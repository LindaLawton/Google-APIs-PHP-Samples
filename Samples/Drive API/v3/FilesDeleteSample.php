...
$results = filesDeleteExample($service, $fileId, $optParams);
...
*/
function filesDeleteExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->files->DeleteFiles($fileId, $optParams);
	}
	catch (Exception $e)
	{
