...
$results = commentsDeleteExample($service, $fileId, $commentId, $optParams);
...
*/
function commentsDeleteExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->DeleteComments($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
