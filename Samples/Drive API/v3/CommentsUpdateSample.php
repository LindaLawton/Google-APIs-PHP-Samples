...
print_r(commentsUpdateExample($service, $fileId, $commentId));
...
*/
function commentsUpdateExample($service, $fileId, $commentId)
{
	try
	{
		...
		return $service->comments->UpdateComments($fileId, $commentId);
	}
	catch (Exception $ex)
	{
