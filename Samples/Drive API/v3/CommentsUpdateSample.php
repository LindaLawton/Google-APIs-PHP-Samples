...
$results = commentsUpdateExample($service, $fileId, $commentId, $optParams);
...
* @return Comment
*/
function commentsUpdateExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->comments->UpdateComments($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
