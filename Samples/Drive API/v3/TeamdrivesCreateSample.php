...
print_r(teamdrivesCreateExample($service, $requestId));
...
*/
function teamdrivesCreateExample($service, $requestId)
{
	try
	{
		...
		return $service->teamdrives->CreateTeamdrives($requestId);
	}
	catch (Exception $ex)
	{
