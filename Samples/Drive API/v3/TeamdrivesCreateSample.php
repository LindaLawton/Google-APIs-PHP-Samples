...
$results = teamdrivesCreateExample($service, $requestId, $optParams);
...
* @return TeamDrive
*/
function teamdrivesCreateExample($service, $requestId, $optParams)
{
	try
	{
		...
		return $service->teamdrives->CreateTeamdrives($requestId, $optParams);
	}
	catch (Exception $e)
	{
