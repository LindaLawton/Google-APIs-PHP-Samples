...
// Single Request.
$results = commentsCreateExample($service, $fileId, $optParams);
...
* @return Comment
*/
function commentsCreateExample($service, $fileId, $optParams)
{
	try
	{
		...
		return $service->comments->CreateComments($fileId, $optParams);
	}
	catch (Exception $e)
	{
