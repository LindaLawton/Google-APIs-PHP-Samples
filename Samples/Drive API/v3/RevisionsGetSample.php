...
print_r(revisionsGetExample($service, $fileId, $revisionId));
...
*/
function revisionsGetExample($service, $fileId, $revisionId)
{
	try
	{
		...
		return $service->revisions->GetRevisions($fileId, $revisionId);
	}
	catch (Exception $ex)
	{
