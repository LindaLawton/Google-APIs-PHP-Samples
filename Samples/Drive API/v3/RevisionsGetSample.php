...
// Single Request.
$results = revisionsGetExample($service, $fileId, $revisionId, $optParams);
...
* @return Revision
*/
function revisionsGetExample($service, $fileId, $revisionId, $optParams)
{
	try
	{
		...
		return $service->revisions->GetRevisions($fileId, $revisionId, $optParams);
	}
	catch (Exception $e)
	{
