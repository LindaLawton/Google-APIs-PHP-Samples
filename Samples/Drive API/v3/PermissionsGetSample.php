...
// Single Request.
$results = permissionsGetExample($service, $fileId, $permissionId, $optParams);
...
* @return Permission
*/
function permissionsGetExample($service, $fileId, $permissionId, $optParams)
{
	try
	{
		...
		return $service->permissions->GetPermissions($fileId, $permissionId, $optParams);
	}
	catch (Exception $e)
	{
