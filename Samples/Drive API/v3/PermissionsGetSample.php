...
print_r(permissionsGetExample($service, $fileId, $permissionId));
...
*/
function permissionsGetExample($service, $fileId, $permissionId)
{
	try
	{
		...
		return $service->permissions->GetPermissions($fileId, $permissionId);
	}
	catch (Exception $ex)
	{
