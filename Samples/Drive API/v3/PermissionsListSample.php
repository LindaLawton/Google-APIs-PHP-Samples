...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pageSize' => '[YourValue]',  // The maximum number of permissions to return per page. When not set for files in a Team Drive, at most 100 results will be returned. When not set for files that are not in a Team Drive, the entire list will be returned.
