...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'includeDeleted' => '[YourValue]',  // Whether to include deleted replies. Deleted replies will not include their original content.
            
  //'pageSize' => '[YourValue]',  // The maximum number of replies to return per page.
...
do {
	...
	$results = filesListExample($service, $fileId, $commentId, $optParams);	
...
* @return ReplyList
*/
function repliesListExample($service, $fileId, $commentId, $optParams)
{
	try
	{
		...
		return $service->replies->ListReplies($fileId, $commentId, $optParams);
	}
	catch (Exception $e)
	{
