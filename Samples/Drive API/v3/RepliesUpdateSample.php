...
// Single Request.
$results = repliesUpdateExample($service, $fileId, $commentId, $replyId, $optParams);
...
* @return Reply
*/
function repliesUpdateExample($service, $fileId, $commentId, $replyId, $optParams)
{
	try
	{
		...
		return $service->replies->UpdateReplies($fileId, $commentId, $replyId, $optParams);
	}
	catch (Exception $e)
	{
