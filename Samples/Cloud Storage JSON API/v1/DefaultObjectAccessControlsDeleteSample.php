...
$results = defaultObjectAccessControlsDeleteExample($service, $bucket, $entity, $optParams);
...
*/
function defaultObjectAccessControlsDeleteExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->DeleteDefaultObjectAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
