...
// Single Request.
$results = notificationsGetExample($service, $bucket, $notification, $optParams);
...
* @return Notification
*/
function notificationsGetExample($service, $bucket, $notification, $optParams)
{
	try
	{
		...
		return $service->notifications->GetNotifications($bucket, $notification, $optParams);
	}
	catch (Exception $e)
	{
