...
print_r(notificationsGetExample($service, $bucket, $notification));
...
*/
function notificationsGetExample($service, $bucket, $notification)
{
	try
	{
		...
		return $service->notifications->GetNotifications($bucket, $notification);
	}
	catch (Exception $ex)
	{
