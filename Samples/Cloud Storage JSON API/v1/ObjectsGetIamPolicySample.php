...
print_r(objectsGetIamPolicyExample($service, $bucket, $object));
...
*/
function objectsGetIamPolicyExample($service, $bucket, $object)
{
	try
	{
		...
		return $service->objects->GetIamPolicyObjects($bucket, $object);
	}
	catch (Exception $ex)
	{
