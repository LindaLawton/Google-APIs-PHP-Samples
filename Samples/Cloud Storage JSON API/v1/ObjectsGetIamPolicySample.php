...
// Single Request.
$results = objectsGetIamPolicyExample($service, $bucket, $object, $optParams);
...
* @return Policy
*/
function objectsGetIamPolicyExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objects->GetIamPolicyObjects($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
