...
$results = serviceAccountGetExample($service, $projectId, $optParams);
...
*/
function serviceAccountGetExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->serviceAccount->GetServiceAccount($projectId, $optParams);
	}
	catch (Exception $e)
	{
