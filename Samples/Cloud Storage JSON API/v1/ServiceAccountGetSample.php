...
print_r(serviceAccountGetExample($service, $projectId));
...
*/
function serviceAccountGetExample($service, $projectId)
{
	try
	{
		...
		return $service->serviceAccount->GetServiceAccount($projectId);
	}
	catch (Exception $ex)
	{
