...
print_r(defaultObjectAccessControlsGetExample($service, $bucket, $entity));
...
*/
function defaultObjectAccessControlsGetExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->GetDefaultObjectAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
