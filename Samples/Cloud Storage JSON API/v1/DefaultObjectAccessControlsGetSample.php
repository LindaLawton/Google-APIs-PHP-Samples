...
// Single Request.
$results = defaultObjectAccessControlsGetExample($service, $bucket, $entity, $optParams);
...
*/
function defaultObjectAccessControlsGetExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->GetDefaultObjectAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
