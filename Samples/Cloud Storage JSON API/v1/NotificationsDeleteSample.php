...
print_r(notificationsDeleteExample($service, $bucket, $notification));
...
*/
function notificationsDeleteExample($service, $bucket, $notification)
{
	try
	{
		...
		return $service->notifications->DeleteNotifications($bucket, $notification);
	}
	catch (Exception $ex)
	{
