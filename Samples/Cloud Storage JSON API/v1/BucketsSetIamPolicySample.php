...
// Single Request.
$results = bucketsSetIamPolicyExample($service, $bucket, $optParams);
...
* @return Policy
*/
function bucketsSetIamPolicyExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->buckets->SetIamPolicyBuckets($bucket, $optParams);
	}
	catch (Exception $e)
	{
