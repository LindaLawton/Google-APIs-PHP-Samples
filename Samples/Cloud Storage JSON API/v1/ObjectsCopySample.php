...
print_r(objectsCopyExample($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject));
...
*/
function objectsCopyExample($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject)
{
	try
	{
		...
		return $service->objects->CopyObjects($sourceBucket, $sourceObject, $destinationBucket, $destinationObject);
	}
	catch (Exception $ex)
	{
