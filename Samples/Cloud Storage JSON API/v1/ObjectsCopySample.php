...
print_r(copy($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject));
...
*/
function copy($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject)
{
	try
	{
		...
		return $service->copy($sourceBucket, $sourceObject, $destinationBucket, $destinationObject);
	}
	catch (Exception $ex)
	{
