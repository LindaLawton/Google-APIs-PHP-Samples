...
print_r(testIamPermissions($service, $bucket, $object, $permissions));
...
*/
function testIamPermissions($service, $bucket, $object, $permissions)
{
	try
	{
		...
		return $service->testIamPermissions($bucket, $object, $permissions);
	}
	catch (Exception $ex)
	{
