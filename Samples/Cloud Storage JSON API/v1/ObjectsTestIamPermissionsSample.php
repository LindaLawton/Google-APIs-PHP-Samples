...
print_r(objectsTestIamPermissionsExample($service, $bucket, $object, $permissions));
...
*/
function objectsTestIamPermissionsExample($service, $bucket, $object, $permissions)
{
	try
	{
		...
		return $service->objects->TestIamPermissionsObjects($bucket, $object, $permissions);
	}
	catch (Exception $ex)
	{
