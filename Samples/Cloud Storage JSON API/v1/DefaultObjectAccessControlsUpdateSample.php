...
// Single Request.
$results = defaultObjectAccessControlsUpdateExample($service, $bucket, $entity, $optParams);
...
*/
function defaultObjectAccessControlsUpdateExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->UpdateDefaultObjectAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
