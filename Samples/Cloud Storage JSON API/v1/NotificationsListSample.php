...
$results = notificationsListExample($service, $bucket, $optParams);
...
*/
function notificationsListExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->notifications->ListNotifications($bucket, $optParams);
	}
	catch (Exception $e)
	{
