...
print_r(objectsSetIamPolicyExample($service, $bucket, $object));
...
*/
function objectsSetIamPolicyExample($service, $bucket, $object)
{
	try
	{
		...
		return $service->objects->SetIamPolicyObjects($bucket, $object);
	}
	catch (Exception $ex)
	{
