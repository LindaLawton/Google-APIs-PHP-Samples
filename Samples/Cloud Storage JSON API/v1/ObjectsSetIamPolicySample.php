...
// Single Request.
$results = objectsSetIamPolicyExample($service, $bucket, $object, $optParams);
...
* @return Policy
*/
function objectsSetIamPolicyExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objects->SetIamPolicyObjects($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
