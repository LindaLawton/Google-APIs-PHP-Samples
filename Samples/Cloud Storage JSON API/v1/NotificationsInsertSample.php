...
print_r(notificationsInsertExample($service, $bucket));
...
*/
function notificationsInsertExample($service, $bucket)
{
	try
	{
		...
		return $service->notifications->InsertNotifications($bucket);
	}
	catch (Exception $ex)
	{
