...
// Single Request.
$results = notificationsInsertExample($service, $bucket, $optParams);
...
* @return Notification
*/
function notificationsInsertExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->notifications->InsertNotifications($bucket, $optParams);
	}
	catch (Exception $e)
	{
