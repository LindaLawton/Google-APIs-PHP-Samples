...
// Single Request.
$results = bucketsGetIamPolicyExample($service, $bucket, $optParams);
...
* @return Policy
*/
function bucketsGetIamPolicyExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->buckets->GetIamPolicyBuckets($bucket, $optParams);
	}
	catch (Exception $e)
	{
