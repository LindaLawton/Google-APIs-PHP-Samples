...
print_r(testIamPermissions($service, $bucket, $permissions));
...
*/
function testIamPermissions($service, $bucket, $permissions)
{
	try
	{
		...
		return $service->testIamPermissions($bucket, $permissions);
	}
	catch (Exception $ex)
	{
