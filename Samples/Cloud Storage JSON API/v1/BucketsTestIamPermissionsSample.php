...
print_r(bucketsTestIamPermissionsExample($service, $bucket, $permissions));
...
*/
function bucketsTestIamPermissionsExample($service, $bucket, $permissions)
{
	try
	{
		...
		return $service->buckets->TestIamPermissionsBuckets($bucket, $permissions);
	}
	catch (Exception $ex)
	{
