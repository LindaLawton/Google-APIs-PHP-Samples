...
// Single Request.
$results = bucketsTestIamPermissionsExample($service, $bucket, $permissions, $optParams);
...
*/
function bucketsTestIamPermissionsExample($service, $bucket, $permissions, $optParams)
{
	try
	{
		...
		return $service->buckets->TestIamPermissionsBuckets($bucket, $permissions, $optParams);
	}
	catch (Exception $e)
	{
