...
print_r(objectsRewriteExample($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject));
...
* @return RewriteResponse</returns>
*/
function objectsRewriteExample($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject)
{
	try
	{
		...
		return $service->objects->RewriteObjects($sourceBucket, $sourceObject, $destinationBucket, $destinationObject);
	}
	catch (Exception $ex)
	{
