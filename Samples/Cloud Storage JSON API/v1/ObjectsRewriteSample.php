...
print_r(rewrite($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject));
...
*/
function rewrite($service, $sourceBucket, $sourceObject, $destinationBucket, $destinationObject)
{
	try
	{
		...
		return $service->rewrite($sourceBucket, $sourceObject, $destinationBucket, $destinationObject);
	}
	catch (Exception $ex)
	{
