...
// Single Request.
$results = objectsUpdateExample($service, $bucket, $object, $optParams);
...
* @return Object
*/
function objectsUpdateExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objects->UpdateObjects($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
