...
print_r(objectsComposeExample($service, $destinationBucket, $destinationObject));
...
*/
function objectsComposeExample($service, $destinationBucket, $destinationObject)
{
	try
	{
		...
		return $service->objects->ComposeObjects($destinationBucket, $destinationObject);
	}
	catch (Exception $ex)
	{
