...
// Single Request.
$results = objectsComposeExample($service, $destinationBucket, $destinationObject, $optParams);
...
* @return Object
*/
function objectsComposeExample($service, $destinationBucket, $destinationObject, $optParams)
{
	try
	{
		...
		return $service->objects->ComposeObjects($destinationBucket, $destinationObject, $optParams);
	}
	catch (Exception $e)
	{
