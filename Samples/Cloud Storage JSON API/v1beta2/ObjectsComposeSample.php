...
print_r(compose($service, $destinationBucket, $destinationObject));
...
*/
function compose($service, $destinationBucket, $destinationObject)
{
	try
	{
		...
		return $service->compose($destinationBucket, $destinationObject);
	}
	catch (Exception $ex)
	{
