...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'generation' => '[YourValue]',  // If present, permanently deletes a specific revision of this object (as opposed to the latest version, the default).
            
  //'ifGenerationMatch' => '[YourValue]',  // Makes the operation conditional on whether the object's current generation matches the given value.
            
  //'ifGenerationNotMatch' => '[YourValue]',  // Makes the operation conditional on whether the object's current generation does not match the given value.
...
// Single Request.
$results = objectsDeleteExample($service, $bucket, $object, $optParams);
...
*/
function objectsDeleteExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		// Make the request and return the results.
		 $service->objects->DeleteObjects($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
