...
// Single Request.
$results = objectsPatchExample($service, $bucket, $object, $optParams);
...
* @return Object
*/
function objectsPatchExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objects->PatchObjects($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
