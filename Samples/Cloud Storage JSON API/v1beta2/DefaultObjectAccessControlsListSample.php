...
*/
function defaultObjectAccessControlsListExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->ListDefaultObjectAccessControls($bucket, $optParams);
	}
	catch (Exception $e)
	{
