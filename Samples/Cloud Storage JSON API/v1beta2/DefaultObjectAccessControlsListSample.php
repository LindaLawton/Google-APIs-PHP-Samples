...
print_r(defaultObjectAccessControlsListExample($service, $bucket));
...
*/
function defaultObjectAccessControlsListExample($service, $bucket)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->ListDefaultObjectAccessControls($bucket);
	}
	catch (Exception $ex)
	{
