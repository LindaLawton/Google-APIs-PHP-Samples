...
print_r(defaultObjectAccessControlsInsertExample($service, $bucket));
...
*/
function defaultObjectAccessControlsInsertExample($service, $bucket)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->InsertDefaultObjectAccessControls($bucket);
	}
	catch (Exception $ex)
	{
