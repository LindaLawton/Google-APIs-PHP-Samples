...
// Single Request.
$results = defaultObjectAccessControlsInsertExample($service, $bucket, $optParams);
...
*/
function defaultObjectAccessControlsInsertExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->InsertDefaultObjectAccessControls($bucket, $optParams);
	}
	catch (Exception $e)
	{
