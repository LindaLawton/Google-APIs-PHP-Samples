...
print_r(defaultObjectAccessControlsDeleteExample($service, $bucket, $entity));
...
*/
function defaultObjectAccessControlsDeleteExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->DeleteDefaultObjectAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
