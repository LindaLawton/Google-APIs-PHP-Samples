...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ifGenerationMatch' => '[YourValue]',  // Makes the operation conditional on whether the object's generation matches the given value.
            
  //'ifGenerationNotMatch' => '[YourValue]',  // Makes the operation conditional on whether the object's generation does not match the given value.
...
* @return Object
*/
function objectsGetExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objects->GetObjects($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
