...
print_r(defaultObjectAccessControlsUpdateExample($service, $bucket, $entity));
...
*/
function defaultObjectAccessControlsUpdateExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->UpdateDefaultObjectAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
