...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'maxResults' => '[YourValue]',  // Maximum number of buckets to return.
...
* @return Buckets
*/
function bucketsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->buckets->ListBuckets($project, $optParams);
	}
	catch (Exception $e)
	{
