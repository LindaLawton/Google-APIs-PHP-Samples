...
// Single Request.
$results = defaultObjectAccessControlsPatchExample($service, $bucket, $entity, $optParams);
...
*/
function defaultObjectAccessControlsPatchExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->PatchDefaultObjectAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
