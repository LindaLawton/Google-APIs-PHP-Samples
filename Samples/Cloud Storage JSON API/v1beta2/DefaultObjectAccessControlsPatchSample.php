...
print_r(defaultObjectAccessControlsPatchExample($service, $bucket, $entity));
...
*/
function defaultObjectAccessControlsPatchExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->defaultObjectAccessControls->PatchDefaultObjectAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
