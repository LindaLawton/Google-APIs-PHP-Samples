...
$results = bucketsGetExample($service, $bucket, $optParams);
...
* @return Bucket
*/
function bucketsGetExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->buckets->GetBuckets($bucket, $optParams);
	}
	catch (Exception $e)
	{
