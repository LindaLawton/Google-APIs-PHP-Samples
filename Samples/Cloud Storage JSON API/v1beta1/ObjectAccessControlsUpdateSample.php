...
print_r(objectAccessControlsUpdateExample($service, $bucket, $object, $entity));
...
* @return ObjectAccessControl</returns>
*/
function objectAccessControlsUpdateExample($service, $bucket, $object, $entity)
{
	try
	{
		...
		return $service->objectAccessControls->UpdateObjectAccessControls($bucket, $object, $entity);
	}
	catch (Exception $ex)
	{
