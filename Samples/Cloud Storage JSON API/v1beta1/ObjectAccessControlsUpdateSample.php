...
// Single Request.
$results = objectAccessControlsUpdateExample($service, $bucket, $object, $entity, $optParams);
...
*/
function objectAccessControlsUpdateExample($service, $bucket, $object, $entity, $optParams)
{
	try
	{
		...
		return $service->objectAccessControls->UpdateObjectAccessControls($bucket, $object, $entity, $optParams);
	}
	catch (Exception $e)
	{
