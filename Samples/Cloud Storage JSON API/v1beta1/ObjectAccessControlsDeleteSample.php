...
print_r(objectAccessControlsDeleteExample($service, $bucket, $object, $entity));
...
*/
function objectAccessControlsDeleteExample($service, $bucket, $object, $entity)
{
	try
	{
		...
		return $service->objectAccessControls->DeleteObjectAccessControls($bucket, $object, $entity);
	}
	catch (Exception $ex)
	{
