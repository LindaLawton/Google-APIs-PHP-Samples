...
// Single Request.
$results = bucketsPatchExample($service, $bucket, $optParams);
...
* @return Bucket
*/
function bucketsPatchExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->buckets->PatchBuckets($bucket, $optParams);
	}
	catch (Exception $e)
	{
