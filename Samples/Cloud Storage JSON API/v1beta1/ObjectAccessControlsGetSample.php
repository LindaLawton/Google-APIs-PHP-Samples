...
$results = objectAccessControlsGetExample($service, $bucket, $object, $entity, $optParams);
...
*/
function objectAccessControlsGetExample($service, $bucket, $object, $entity, $optParams)
{
	try
	{
		...
		return $service->objectAccessControls->GetObjectAccessControls($bucket, $object, $entity, $optParams);
	}
	catch (Exception $e)
	{
