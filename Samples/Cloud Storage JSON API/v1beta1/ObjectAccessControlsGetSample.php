...
print_r(objectAccessControlsGetExample($service, $bucket, $object, $entity));
...
*/
function objectAccessControlsGetExample($service, $bucket, $object, $entity)
{
	try
	{
		...
		return $service->objectAccessControls->GetObjectAccessControls($bucket, $object, $entity);
	}
	catch (Exception $ex)
	{
