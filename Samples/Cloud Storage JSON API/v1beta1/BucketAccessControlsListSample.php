...
// Single Request.
$results = bucketAccessControlsListExample($service, $bucket, $optParams);
...
*/
function bucketAccessControlsListExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->bucketAccessControls->ListBucketAccessControls($bucket, $optParams);
	}
	catch (Exception $e)
	{
