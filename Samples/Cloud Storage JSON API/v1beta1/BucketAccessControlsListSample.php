...
print_r(bucketAccessControlsListExample($service, $bucket));

/**
* Retrieves ACL entries on the specified bucket.
* @service Authenticated Storage service.
* @bucket Name of a bucket.
* @return BucketAccessControls</returns>
*/
function bucketAccessControlsListExample($service, $bucket)
{
	try
	{
		...
		return $service->bucketAccessControls->ListBucketAccessControls($bucket);
	}
	catch (Exception $ex)
	{
