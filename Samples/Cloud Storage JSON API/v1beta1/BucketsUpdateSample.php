...
print_r(bucketsUpdateExample($service, $bucket));

/**
* Updates a bucket.
* @service Authenticated Storage service.
* @bucket Name of a bucket.
* @return Bucket</returns>
*/
function bucketsUpdateExample($service, $bucket)
{
	try
	{
		...
		return $service->buckets->UpdateBuckets($bucket);
	}
	catch (Exception $ex)
	{
