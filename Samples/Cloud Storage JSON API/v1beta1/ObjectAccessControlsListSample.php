...
// Single Request.
$results = objectAccessControlsListExample($service, $bucket, $object, $optParams);
...
*/
function objectAccessControlsListExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objectAccessControls->ListObjectAccessControls($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
