...
print_r(objectAccessControlsListExample($service, $bucket, $object));
...
* @return ObjectAccessControls</returns>
*/
function objectAccessControlsListExample($service, $bucket, $object)
{
	try
	{
		...
		return $service->objectAccessControls->ListObjectAccessControls($bucket, $object);
	}
	catch (Exception $ex)
	{
