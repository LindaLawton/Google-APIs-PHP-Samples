...
$results = bucketAccessControlsGetExample($service, $bucket, $entity, $optParams);
...
*/
function bucketAccessControlsGetExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->bucketAccessControls->GetBucketAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
