...
print_r(bucketAccessControlsGetExample($service, $bucket, $entity));
...
*/
function bucketAccessControlsGetExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->bucketAccessControls->GetBucketAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
