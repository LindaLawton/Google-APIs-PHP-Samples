...
print_r(bucketAccessControlsInsertExample($service, $bucket));
...
*/
function bucketAccessControlsInsertExample($service, $bucket)
{
	try
	{
		...
		return $service->bucketAccessControls->InsertBucketAccessControls($bucket);
	}
	catch (Exception $ex)
	{
