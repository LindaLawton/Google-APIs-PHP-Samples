...
// Single Request.
$results = bucketAccessControlsInsertExample($service, $bucket, $optParams);
...
*/
function bucketAccessControlsInsertExample($service, $bucket, $optParams)
{
	try
	{
		...
		return $service->bucketAccessControls->InsertBucketAccessControls($bucket, $optParams);
	}
	catch (Exception $e)
	{
