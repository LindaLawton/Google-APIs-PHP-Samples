...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // Maximum number of buckets to return.
...
// Single Request.
$results = bucketsListExample($service, $projectId, $optParams);
...
* @return Buckets
*/
function bucketsListExample($service, $projectId, $optParams)
{
	try
	{
		...
		return $service->buckets->ListBuckets($projectId, $optParams);
	}
	catch (Exception $e)
	{
