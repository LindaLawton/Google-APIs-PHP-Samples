...
print_r(objectsDeleteExample($service, $bucket, $object));
...
*/
function objectsDeleteExample($service, $bucket, $object)
{
	try
	{
		...
		return $service->objects->DeleteObjects($bucket, $object);
	}
	catch (Exception $ex)
	{
