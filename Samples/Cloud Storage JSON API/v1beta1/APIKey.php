 ...
 * Initializes an Storage.v1beta1 service object.
 * @param string API key
 * @return An authorized Storage.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Storage Sample");
		...
		// Create authenticated Storage service
