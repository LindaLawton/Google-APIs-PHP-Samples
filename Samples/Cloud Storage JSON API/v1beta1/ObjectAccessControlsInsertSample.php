...
print_r(objectAccessControlsInsertExample($service, $bucket, $object));
...
*/
function objectAccessControlsInsertExample($service, $bucket, $object)
{
	try
	{
		...
		return $service->objectAccessControls->InsertObjectAccessControls($bucket, $object);
	}
	catch (Exception $ex)
	{
