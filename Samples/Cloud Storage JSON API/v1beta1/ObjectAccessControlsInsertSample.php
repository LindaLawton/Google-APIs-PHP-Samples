...
// Single Request.
$results = objectAccessControlsInsertExample($service, $bucket, $object, $optParams);
...
*/
function objectAccessControlsInsertExample($service, $bucket, $object, $optParams)
{
	try
	{
		...
		return $service->objectAccessControls->InsertObjectAccessControls($bucket, $object, $optParams);
	}
	catch (Exception $e)
	{
