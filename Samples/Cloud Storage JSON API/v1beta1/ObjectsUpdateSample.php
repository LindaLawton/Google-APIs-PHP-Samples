...
print_r(objectsUpdateExample($service, $bucket, $object));
...
*/
function objectsUpdateExample($service, $bucket, $object)
{
	try
	{
		...
		return $service->objects->UpdateObjects($bucket, $object);
	}
	catch (Exception $ex)
	{
