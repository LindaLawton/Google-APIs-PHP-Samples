...
print_r(bucketAccessControlsDeleteExample($service, $bucket, $entity));
...
*/
function bucketAccessControlsDeleteExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->bucketAccessControls->DeleteBucketAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
