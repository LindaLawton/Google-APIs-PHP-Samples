...
print_r(bucketAccessControlsPatchExample($service, $bucket, $entity));
...
*/
function bucketAccessControlsPatchExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->bucketAccessControls->PatchBucketAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
