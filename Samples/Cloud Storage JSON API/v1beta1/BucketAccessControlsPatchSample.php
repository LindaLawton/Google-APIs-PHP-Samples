...
// Single Request.
$results = bucketAccessControlsPatchExample($service, $bucket, $entity, $optParams);
...
*/
function bucketAccessControlsPatchExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->bucketAccessControls->PatchBucketAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
