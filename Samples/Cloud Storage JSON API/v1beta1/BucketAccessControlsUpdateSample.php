...
// Single Request.
$results = bucketAccessControlsUpdateExample($service, $bucket, $entity, $optParams);
...
*/
function bucketAccessControlsUpdateExample($service, $bucket, $entity, $optParams)
{
	try
	{
		...
		return $service->bucketAccessControls->UpdateBucketAccessControls($bucket, $entity, $optParams);
	}
	catch (Exception $e)
	{
