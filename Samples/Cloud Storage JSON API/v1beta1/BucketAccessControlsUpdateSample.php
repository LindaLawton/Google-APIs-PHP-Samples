...
print_r(bucketAccessControlsUpdateExample($service, $bucket, $entity));
...
* @return BucketAccessControl</returns>
*/
function bucketAccessControlsUpdateExample($service, $bucket, $entity)
{
	try
	{
		...
		return $service->bucketAccessControls->UpdateBucketAccessControls($bucket, $entity);
	}
	catch (Exception $ex)
	{
