...
// Single Request.
$results = objectAccessControlsPatchExample($service, $bucket, $object, $entity, $optParams);
...
*/
function objectAccessControlsPatchExample($service, $bucket, $object, $entity, $optParams)
{
	try
	{
		...
		return $service->objectAccessControls->PatchObjectAccessControls($bucket, $object, $entity, $optParams);
	}
	catch (Exception $e)
	{
