...
print_r(objectAccessControlsPatchExample($service, $bucket, $object, $entity));
...
*/
function objectAccessControlsPatchExample($service, $bucket, $object, $entity)
{
	try
	{
		...
		return $service->objectAccessControls->PatchObjectAccessControls($bucket, $object, $entity);
	}
	catch (Exception $ex)
	{
