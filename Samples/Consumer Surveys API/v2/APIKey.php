 ...
 * Initializes an Consumersurveys.v2 service object.
 * @param string API key
 * @return An authorized Consumersurveys.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Consumersurveys Sample");
		...
		// Create authenticated Consumersurveys service
		return new Google_Service_Consumersurveys($client);
	} catch (Exception $e) {
