...
# Unoffical Consumer Surveys API Samples for PHP
...
These samples show how to access the [Consumer Surveys API](https://www.google.com/search?q=Consumer+Surveys) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
