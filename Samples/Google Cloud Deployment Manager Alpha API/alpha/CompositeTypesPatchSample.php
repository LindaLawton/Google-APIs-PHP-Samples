...
$results = compositeTypesPatchExample($service, $project, $compositeType, $optParams);
...
* @return Operation
*/
function compositeTypesPatchExample($service, $project, $compositeType, $optParams)
{
	try
	{
		...
		return $service->compositeTypes->PatchCompositeTypes($project, $compositeType, $optParams);
	}
	catch (Exception $e)
	{
