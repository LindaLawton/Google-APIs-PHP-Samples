...
print_r(compositeTypesPatchExample($service, $project, $compositeType));
...
*/
function compositeTypesPatchExample($service, $project, $compositeType)
{
	try
	{
		...
		return $service->compositeTypes->PatchCompositeTypes($project, $compositeType);
	}
	catch (Exception $ex)
	{
