...
print_r(compositeTypesListExample($service, $project));

/**
* Lists all composite types for Deployment Manager.
* @service Authenticated Deploymentmanageralpha service.
* @project The project ID for this request.
* @return CompositeTypesListResponse</returns>
*/
function compositeTypesListExample($service, $project)
{
	try
	{
		...
		return $service->compositeTypes->ListCompositeTypes($project);
	}
	catch (Exception $ex)
	{
