...
// Single Request.
$results = compositeTypesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function compositeTypesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->compositeTypes->InsertCompositeTypes($project, $optParams);
	}
	catch (Exception $e)
	{
