...
print_r(typeProvidersPatchExample($service, $project, $typeProvider));
...
*/
function typeProvidersPatchExample($service, $project, $typeProvider)
{
	try
	{
		...
		return $service->typeProviders->PatchTypeProviders($project, $typeProvider);
	}
	catch (Exception $ex)
	{
