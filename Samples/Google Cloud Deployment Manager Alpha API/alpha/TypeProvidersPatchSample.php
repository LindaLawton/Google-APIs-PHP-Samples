...
// Single Request.
$results = typeProvidersPatchExample($service, $project, $typeProvider, $optParams);
...
* @return Operation
*/
function typeProvidersPatchExample($service, $project, $typeProvider, $optParams)
{
	try
	{
		...
		return $service->typeProviders->PatchTypeProviders($project, $typeProvider, $optParams);
	}
	catch (Exception $e)
	{
