...
// Single Request.
$results = typeProvidersGetTypeExample($service, $project, $typeProvider, $type, $optParams);
...
* @return TypeInfo
*/
function typeProvidersGetTypeExample($service, $project, $typeProvider, $type, $optParams)
{
	try
	{
		...
		return $service->typeProviders->GetTypeTypeProviders($project, $typeProvider, $type, $optParams);
	}
	catch (Exception $e)
	{
