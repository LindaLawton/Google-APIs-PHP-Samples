...
$results = typesDeleteExample($service, $project, $type, $optParams);
...
* @return Operation
*/
function typesDeleteExample($service, $project, $type, $optParams)
{
	try
	{
		...
		return $service->types->DeleteTypes($project, $type, $optParams);
	}
	catch (Exception $e)
	{
