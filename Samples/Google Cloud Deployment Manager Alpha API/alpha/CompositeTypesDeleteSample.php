...
// Single Request.
$results = compositeTypesDeleteExample($service, $project, $compositeType, $optParams);
...
* @return Operation
*/
function compositeTypesDeleteExample($service, $project, $compositeType, $optParams)
{
	try
	{
		...
		return $service->compositeTypes->DeleteCompositeTypes($project, $compositeType, $optParams);
	}
	catch (Exception $e)
	{
