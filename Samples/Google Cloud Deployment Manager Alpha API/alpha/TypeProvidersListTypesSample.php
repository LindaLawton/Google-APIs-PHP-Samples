...
// Single Request.
$results = typeProvidersListTypesExample($service, $project, $typeProvider, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $typeProvider, $optParams);	
...
*/
function typeProvidersListTypesExample($service, $project, $typeProvider, $optParams)
{
	try
	{
		...
		if (typeProvider == null)
			throw new Exception("typeProvider is required.");
		// Make the request and return the results.
		return $service->typeProviders->ListTypesTypeProviders($project, $typeProvider, $optParams);
	}
	catch (Exception $e)
	{
