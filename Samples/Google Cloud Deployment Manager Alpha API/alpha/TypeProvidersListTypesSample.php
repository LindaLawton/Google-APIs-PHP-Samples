...
print_r(typeProvidersListTypesExample($service, $project, $typeProvider));
...
* @return TypeProvidersListTypesResponse</returns>
*/
function typeProvidersListTypesExample($service, $project, $typeProvider)
{
	try
	{
		...
		return $service->typeProviders->ListTypesTypeProviders($project, $typeProvider);
	}
	catch (Exception $ex)
	{
