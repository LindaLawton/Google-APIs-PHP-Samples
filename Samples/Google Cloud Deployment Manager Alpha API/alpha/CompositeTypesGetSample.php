...
print_r(compositeTypesGetExample($service, $project, $compositeType));
...
* @return CompositeType</returns>
*/
function compositeTypesGetExample($service, $project, $compositeType)
{
	try
	{
		...
		return $service->compositeTypes->GetCompositeTypes($project, $compositeType);
	}
	catch (Exception $ex)
	{
