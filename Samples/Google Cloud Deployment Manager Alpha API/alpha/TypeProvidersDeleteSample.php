...
print_r(typeProvidersDeleteExample($service, $project, $typeProvider));
...
*/
function typeProvidersDeleteExample($service, $project, $typeProvider)
{
	try
	{
		...
		return $service->typeProviders->DeleteTypeProviders($project, $typeProvider);
	}
	catch (Exception $ex)
	{
