...
// Single Request.
$results = typesGetExample($service, $project, $type, $optParams);
...
* @return Type
*/
function typesGetExample($service, $project, $type, $optParams)
{
	try
	{
		...
		return $service->types->GetTypes($project, $type, $optParams);
	}
	catch (Exception $e)
	{
