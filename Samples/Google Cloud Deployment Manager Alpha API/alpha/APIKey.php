...
// About 
// 
// Unofficial sample for the Deploymentmanageralpha alpha API for PHP. 
 ...
 * Initializes an Deploymentmanageralpha.alpha service object.
 * @param string API key
 * @return An authorized Deploymentmanageralpha.alpha service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Deploymentmanageralpha Sample");
		...
		// Create authenticated Deploymentmanageralpha service
		return new Google_Service_Deploymentmanageralpha($client);
	} catch (Exception $e) {
