...
// Single Request.
$results = typeProvidersInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function typeProvidersInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->typeProviders->InsertTypeProviders($project, $optParams);
	}
	catch (Exception $e)
	{
