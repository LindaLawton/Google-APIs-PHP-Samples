...
print_r(typeProvidersInsertExample($service, $project));
...
*/
function typeProvidersInsertExample($service, $project)
{
	try
	{
		...
		return $service->typeProviders->InsertTypeProviders($project);
	}
	catch (Exception $ex)
	{
