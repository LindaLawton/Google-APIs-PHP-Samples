...
// Single Request.
$results = typesInsertExample($service, $project, $optParams);
...
* @return Operation
*/
function typesInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->types->InsertTypes($project, $optParams);
	}
	catch (Exception $e)
	{
