...
// Single Request.
$results = typesUpdateExample($service, $project, $type, $optParams);
...
* @return Operation
*/
function typesUpdateExample($service, $project, $type, $optParams)
{
	try
	{
		...
		return $service->types->UpdateTypes($project, $type, $optParams);
	}
	catch (Exception $e)
	{
