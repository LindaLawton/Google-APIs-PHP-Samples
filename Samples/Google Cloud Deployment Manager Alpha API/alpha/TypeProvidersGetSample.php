...
// Single Request.
$results = typeProvidersGetExample($service, $project, $typeProvider, $optParams);
...
* @return TypeProvider
*/
function typeProvidersGetExample($service, $project, $typeProvider, $optParams)
{
	try
	{
		...
		return $service->typeProviders->GetTypeProviders($project, $typeProvider, $optParams);
	}
	catch (Exception $e)
	{
