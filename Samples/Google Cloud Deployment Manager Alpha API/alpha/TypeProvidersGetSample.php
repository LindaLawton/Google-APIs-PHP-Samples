...
print_r(typeProvidersGetExample($service, $project, $typeProvider));
...
* @return TypeProvider</returns>
*/
function typeProvidersGetExample($service, $project, $typeProvider)
{
	try
	{
		...
		return $service->typeProviders->GetTypeProviders($project, $typeProvider);
	}
	catch (Exception $ex)
	{
