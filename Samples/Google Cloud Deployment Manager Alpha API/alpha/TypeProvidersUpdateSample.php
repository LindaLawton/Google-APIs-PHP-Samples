...
print_r(typeProvidersUpdateExample($service, $project, $typeProvider));
...
*/
function typeProvidersUpdateExample($service, $project, $typeProvider)
{
	try
	{
		...
		return $service->typeProviders->UpdateTypeProviders($project, $typeProvider);
	}
	catch (Exception $ex)
	{
