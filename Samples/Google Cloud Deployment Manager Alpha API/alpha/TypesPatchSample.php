...
$results = typesPatchExample($service, $project, $type, $optParams);
...
* @return Operation
*/
function typesPatchExample($service, $project, $type, $optParams)
{
	try
	{
		...
		return $service->types->PatchTypes($project, $type, $optParams);
	}
	catch (Exception $e)
	{
