...
print_r(dataGetExample($service, $ids, $start-date, $end-date, $metrics));
...
*/
function dataGetExample($service, $ids, $start-date, $end-date, $metrics)
{
	try
	{
		...
		return $service->data->GetData($ids, $start-date, $end-date, $metrics);
	}
	catch (Exception $ex)
	{
