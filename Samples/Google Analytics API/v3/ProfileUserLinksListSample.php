...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  //The maximum number of profile-user links to include in this response.
            
  //'start-index' => '[YourValue]',  //An index of the first profile-user link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
  'fields' => '*'
);
// Single Request.
$results = profileUserLinksListExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
*/
function profileUserLinksListExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profileUserLinks->ListProfileUserLinks($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
