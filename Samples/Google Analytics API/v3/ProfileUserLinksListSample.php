...
print_r(profileUserLinksListExample($service, $accountId, $webPropertyId, $profileId));
...
* @return EntityUserLinks</returns>
*/
function profileUserLinksListExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profileUserLinks->ListProfileUserLinks($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
