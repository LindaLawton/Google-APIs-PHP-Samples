...
print_r(customMetricsGetExample($service, $accountId, $webPropertyId, $customMetricId));
...
*/
function customMetricsGetExample($service, $accountId, $webPropertyId, $customMetricId)
{
	try
	{
		...
		return $service->customMetrics->GetCustomMetrics($accountId, $webPropertyId, $customMetricId);
	}
	catch (Exception $ex)
	{
