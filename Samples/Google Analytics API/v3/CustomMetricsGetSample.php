...
// Single Request.
$results = customMetricsGetExample($service, $accountId, $webPropertyId, $customMetricId, $optParams);
...
* @return CustomMetric
*/
function customMetricsGetExample($service, $accountId, $webPropertyId, $customMetricId, $optParams)
{
	try
	{
		...
		return $service->customMetrics->GetCustomMetrics($accountId, $webPropertyId, $customMetricId, $optParams);
	}
	catch (Exception $e)
	{
