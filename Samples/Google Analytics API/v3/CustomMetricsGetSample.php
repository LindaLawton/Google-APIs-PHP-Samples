...
print_r(get($service, $accountId, $webPropertyId, $customMetricId));
...
*/
function get($service, $accountId, $webPropertyId, $customMetricId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $customMetricId);
	}
	catch (Exception $ex)
	{
