...
print_r(accountUserLinksInsertExample($service, $accountId));
...
*/
function accountUserLinksInsertExample($service, $accountId)
{
	try
	{
		...
		return $service->accountUserLinks->InsertAccountUserLinks($accountId);
	}
	catch (Exception $ex)
	{
