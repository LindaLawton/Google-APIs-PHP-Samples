...
// Single Request.
$results = accountUserLinksInsertExample($service, $accountId, $optParams);
...
*/
function accountUserLinksInsertExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->accountUserLinks->InsertAccountUserLinks($accountId, $optParams);
	}
	catch (Exception $e)
	{
