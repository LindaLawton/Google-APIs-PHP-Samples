...
$results = accountUserLinksDeleteExample($service, $accountId, $linkId, $optParams);
...
*/
function accountUserLinksDeleteExample($service, $accountId, $linkId, $optParams)
{
	try
	{
		...
		return $service->accountUserLinks->DeleteAccountUserLinks($accountId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
