...
print_r(accountUserLinksDeleteExample($service, $accountId, $linkId));
...
*/
function accountUserLinksDeleteExample($service, $accountId, $linkId)
{
	try
	{
		...
		return $service->accountUserLinks->DeleteAccountUserLinks($accountId, $linkId);
	}
	catch (Exception $ex)
	{
