...
print_r(profileFilterLinksDeleteExample($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function profileFilterLinksDeleteExample($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->profileFilterLinks->DeleteProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
