...
print_r(delete($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function delete($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
