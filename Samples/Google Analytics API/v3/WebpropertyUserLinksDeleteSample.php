...
print_r(webpropertyUserLinksDeleteExample($service, $accountId, $webPropertyId, $linkId));
...
*/
function webpropertyUserLinksDeleteExample($service, $accountId, $webPropertyId, $linkId)
{
	try
	{
		...
		return $service->webpropertyUserLinks->DeleteWebpropertyUserLinks($accountId, $webPropertyId, $linkId);
	}
	catch (Exception $ex)
	{
