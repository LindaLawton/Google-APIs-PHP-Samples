...
$results = webpropertyUserLinksDeleteExample($service, $accountId, $webPropertyId, $linkId, $optParams);
...
*/
function webpropertyUserLinksDeleteExample($service, $accountId, $webPropertyId, $linkId, $optParams)
{
	try
	{
		...
		return $service->webpropertyUserLinks->DeleteWebpropertyUserLinks($accountId, $webPropertyId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
