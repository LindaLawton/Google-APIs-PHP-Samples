...
print_r(delete($service, $accountId, $webPropertyId, $linkId));
...
*/
function delete($service, $accountId, $webPropertyId, $linkId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $linkId);
	}
	catch (Exception $ex)
	{
