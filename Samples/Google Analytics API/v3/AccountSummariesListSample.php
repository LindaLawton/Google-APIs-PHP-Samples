...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  //The maximum number of account summaries to include in this response, where the largest acceptable value is 1000.
...
// Single Request.
$results = accountSummariesListExample($service, $optParams);
...
*/
function accountSummariesListExample($service, $optParams)
{
	try
	{
		...
		return $service->accountSummaries->ListAccountSummaries($optParams);
	}
	catch (Exception $e)
	{
