...
print_r(accountSummariesListExample($service));

/**
* Lists account summaries (lightweight tree comprised of accounts/properties/profiles) to which the user has access.
* @service Authenticated Analytics service.
* @return AccountSummaries</returns>
*/
function accountSummariesListExample($service)
{
	try
	{
		...
		return $service->accountSummaries->ListAccountSummaries();
	}
	catch (Exception $ex)
	{
