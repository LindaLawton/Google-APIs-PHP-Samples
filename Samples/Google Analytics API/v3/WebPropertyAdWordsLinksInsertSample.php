...
// Single Request.
$results = webPropertyAdWordsLinksInsertExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function webPropertyAdWordsLinksInsertExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->InsertWebPropertyAdWordsLinks($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
