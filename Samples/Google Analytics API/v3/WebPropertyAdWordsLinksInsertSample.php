...
print_r(webPropertyAdWordsLinksInsertExample($service, $accountId, $webPropertyId));
...
*/
function webPropertyAdWordsLinksInsertExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->InsertWebPropertyAdWordsLinks($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
