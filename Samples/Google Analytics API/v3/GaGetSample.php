...
print_r(gaGetExample($service, $ids, $start-date, $end-date, $metrics));
...
* @return GaData</returns>
*/
function gaGetExample($service, $ids, $start-date, $end-date, $metrics)
{
	try
	{
		...
		return $service->ga->GetGa($ids, $start-date, $end-date, $metrics);
	}
	catch (Exception $ex)
	{
