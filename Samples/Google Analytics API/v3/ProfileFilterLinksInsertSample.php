...
print_r(insert($service, $accountId, $webPropertyId, $profileId));
...
*/
function insert($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->insert($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
