...
$results = profileFilterLinksInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
*/
function profileFilterLinksInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profileFilterLinks->InsertProfileFilterLinks($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
