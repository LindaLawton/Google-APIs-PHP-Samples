...
print_r(profileFilterLinksInsertExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function profileFilterLinksInsertExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profileFilterLinks->InsertProfileFilterLinks($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
