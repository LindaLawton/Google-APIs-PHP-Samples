...
$results = goalsPatchExample($service, $accountId, $webPropertyId, $profileId, $goalId, $optParams);
...
* @return Goal
*/
function goalsPatchExample($service, $accountId, $webPropertyId, $profileId, $goalId, $optParams)
{
	try
	{
		...
		return $service->goals->PatchGoals($accountId, $webPropertyId, $profileId, $goalId, $optParams);
	}
	catch (Exception $e)
	{
