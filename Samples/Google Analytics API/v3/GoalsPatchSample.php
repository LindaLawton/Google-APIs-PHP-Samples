...
print_r(goalsPatchExample($service, $accountId, $webPropertyId, $profileId, $goalId));
...
* @return Goal</returns>
*/
function goalsPatchExample($service, $accountId, $webPropertyId, $profileId, $goalId)
{
	try
	{
		...
		return $service->goals->PatchGoals($accountId, $webPropertyId, $profileId, $goalId);
	}
	catch (Exception $ex)
	{
