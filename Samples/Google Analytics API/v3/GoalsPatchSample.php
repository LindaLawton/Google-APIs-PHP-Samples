...
print_r(patch($service, $accountId, $webPropertyId, $profileId, $goalId));
...
* @return Goal</returns>
*/
function patch($service, $accountId, $webPropertyId, $profileId, $goalId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $profileId, $goalId);
	}
	catch (Exception $ex)
	{
