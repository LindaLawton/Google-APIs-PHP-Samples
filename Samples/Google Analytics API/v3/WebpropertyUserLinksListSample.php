...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of webProperty-user Links to include in this response.
            
  //'start-index' => '[YourValue]',  // An index of the first webProperty-user link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
  'fields' => '*'
);
// Single Request.
$results = webpropertyUserLinksListExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function webpropertyUserLinksListExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->webpropertyUserLinks->ListWebpropertyUserLinks($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
