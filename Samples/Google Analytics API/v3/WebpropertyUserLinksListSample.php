...
print_r(webpropertyUserLinksListExample($service, $accountId, $webPropertyId));
...
*/
function webpropertyUserLinksListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webpropertyUserLinks->ListWebpropertyUserLinks($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
