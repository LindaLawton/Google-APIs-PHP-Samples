...
print_r(get($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function get($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
