...
print_r(remarketingAudienceGetExample($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function remarketingAudienceGetExample($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->remarketingAudience->GetRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
