...
// Single Request.
$results = remarketingAudienceGetExample($service, $accountId, $webPropertyId, $remarketingAudienceId, $optParams);
...
*/
function remarketingAudienceGetExample($service, $accountId, $webPropertyId, $remarketingAudienceId, $optParams)
{
	try
	{
		...
		return $service->remarketingAudience->GetRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId, $optParams);
	}
	catch (Exception $e)
	{
