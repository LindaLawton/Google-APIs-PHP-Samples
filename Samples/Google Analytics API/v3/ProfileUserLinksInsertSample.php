...
// Single Request.
$results = profileUserLinksInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
*/
function profileUserLinksInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profileUserLinks->InsertProfileUserLinks($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
