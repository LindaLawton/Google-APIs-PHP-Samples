...
print_r(profileUserLinksInsertExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function profileUserLinksInsertExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profileUserLinks->InsertProfileUserLinks($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
