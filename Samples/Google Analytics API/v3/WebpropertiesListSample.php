...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  //The maximum number of web properties to include in this response.
...
// Single Request.
$results = webpropertiesListExample($service, $accountId, $optParams);
...
*/
function webpropertiesListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->webproperties->ListWebproperties($accountId, $optParams);
	}
	catch (Exception $e)
	{
