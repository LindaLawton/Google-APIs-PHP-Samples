...
print_r(webpropertiesListExample($service, $accountId));
...
* @return Webproperties</returns>
*/
function webpropertiesListExample($service, $accountId)
{
	try
	{
		...
		return $service->webproperties->ListWebproperties($accountId);
	}
	catch (Exception $ex)
	{
