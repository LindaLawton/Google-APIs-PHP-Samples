...
$results = unsampledReportsDeleteExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams);
...
*/
function unsampledReportsDeleteExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams)
{
	try
	{
		...
		if (unsampledReportId == null)
			throw new Exception("unsampledReportId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->unsampledReports->DeleteUnsampledReports($accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams);
	}
	catch (Exception $e)
	{
