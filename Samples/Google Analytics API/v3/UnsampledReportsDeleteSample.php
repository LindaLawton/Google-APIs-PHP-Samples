...
print_r(delete($service, $accountId, $webPropertyId, $profileId, $unsampledReportId));
...
*/
function delete($service, $accountId, $webPropertyId, $profileId, $unsampledReportId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $profileId, $unsampledReportId);
	}
	catch (Exception $ex)
	{
