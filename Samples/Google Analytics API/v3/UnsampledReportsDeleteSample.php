...
print_r(unsampledReportsDeleteExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId));
...
*/
function unsampledReportsDeleteExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId)
{
	try
	{
		...
		return $service->unsampledReports->DeleteUnsampledReports($accountId, $webPropertyId, $profileId, $unsampledReportId);
	}
	catch (Exception $ex)
	{
