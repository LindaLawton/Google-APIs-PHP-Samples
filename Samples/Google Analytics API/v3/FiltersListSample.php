...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of filters to include in this response.
...
// Single Request.
$results = filtersListExample($service, $accountId, $optParams);
...
* @return Filters
*/
function filtersListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->filters->ListFilters($accountId, $optParams);
	}
	catch (Exception $e)
	{
