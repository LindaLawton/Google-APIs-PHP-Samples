...
print_r(webPropertyAdWordsLinksDeleteExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function webPropertyAdWordsLinksDeleteExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->DeleteWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
