...
print_r(delete($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function delete($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
