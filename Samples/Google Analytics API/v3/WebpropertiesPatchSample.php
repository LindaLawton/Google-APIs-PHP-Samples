...
print_r(webpropertiesPatchExample($service, $accountId, $webPropertyId));
...
*/
function webpropertiesPatchExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webproperties->PatchWebproperties($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
