...
// Single Request.
$results = webpropertiesPatchExample($service, $accountId, $webPropertyId, $optParams);
...
* @return Webproperty
*/
function webpropertiesPatchExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->webproperties->PatchWebproperties($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
