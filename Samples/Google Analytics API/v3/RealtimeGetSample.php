...
print_r(realtimeGetExample($service, $ids, $metrics));
...
* @return RealtimeData</returns>
*/
function realtimeGetExample($service, $ids, $metrics)
{
	try
	{
		...
		return $service->realtime->GetRealtime($ids, $metrics);
	}
	catch (Exception $ex)
	{
