...
$results = columnsListExample($service, $reportType, $optParams);
...
* @return Columns
*/
function columnsListExample($service, $reportType, $optParams)
{
	try
	{
		...
		return $service->columns->ListColumns($reportType, $optParams);
	}
	catch (Exception $e)
	{
