...
// Single Request.
$results = webpropertiesInsertExample($service, $accountId, $optParams);
...
* @return Webproperty
*/
function webpropertiesInsertExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->webproperties->InsertWebproperties($accountId, $optParams);
	}
	catch (Exception $e)
	{
