...
print_r(webpropertiesInsertExample($service, $accountId));
...
*/
function webpropertiesInsertExample($service, $accountId)
{
	try
	{
		...
		return $service->webproperties->InsertWebproperties($accountId);
	}
	catch (Exception $ex)
	{
