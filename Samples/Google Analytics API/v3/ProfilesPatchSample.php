...
print_r(profilesPatchExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function profilesPatchExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profiles->PatchProfiles($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
