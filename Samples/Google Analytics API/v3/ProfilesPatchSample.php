...
print_r(patch($service, $accountId, $webPropertyId, $profileId));
...
*/
function patch($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
