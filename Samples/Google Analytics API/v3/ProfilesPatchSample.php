...
$results = profilesPatchExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
* @return Profile
*/
function profilesPatchExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profiles->PatchProfiles($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
