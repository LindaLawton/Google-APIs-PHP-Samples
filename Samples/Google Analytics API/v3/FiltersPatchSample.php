...
print_r(filtersPatchExample($service, $accountId, $filterId));
...
*/
function filtersPatchExample($service, $accountId, $filterId)
{
	try
	{
		...
		return $service->filters->PatchFilters($accountId, $filterId);
	}
	catch (Exception $ex)
	{
