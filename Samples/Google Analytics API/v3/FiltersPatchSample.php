...
$results = filtersPatchExample($service, $accountId, $filterId, $optParams);
...
* @return Filter
*/
function filtersPatchExample($service, $accountId, $filterId, $optParams)
{
	try
	{
		...
		return $service->filters->PatchFilters($accountId, $filterId, $optParams);
	}
	catch (Exception $e)
	{
