...
print_r(get($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function get($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
