...
// Single Request.
$results = profileFilterLinksGetExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams);
...
*/
function profileFilterLinksGetExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams)
{
	try
	{
		...
		return $service->profileFilterLinks->GetProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
