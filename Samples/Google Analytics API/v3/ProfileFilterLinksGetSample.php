...
print_r(profileFilterLinksGetExample($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function profileFilterLinksGetExample($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->profileFilterLinks->GetProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
