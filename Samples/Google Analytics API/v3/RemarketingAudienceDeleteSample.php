...
print_r(remarketingAudienceDeleteExample($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function remarketingAudienceDeleteExample($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->remarketingAudience->DeleteRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
