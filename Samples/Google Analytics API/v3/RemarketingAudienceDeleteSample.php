...
print_r(delete($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function delete($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
