...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of custom metrics to include in this response.
...
// Single Request.
$results = customMetricsListExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function customMetricsListExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->customMetrics->ListCustomMetrics($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
