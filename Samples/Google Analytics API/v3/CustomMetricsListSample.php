...
print_r(customMetricsListExample($service, $accountId, $webPropertyId));
...
* @return CustomMetrics</returns>
*/
function customMetricsListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->customMetrics->ListCustomMetrics($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
