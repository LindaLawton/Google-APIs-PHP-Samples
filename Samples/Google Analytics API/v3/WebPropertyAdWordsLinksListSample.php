...
print_r(webPropertyAdWordsLinksListExample($service, $accountId, $webPropertyId));
...
* @return EntityAdWordsLinks</returns>
*/
function webPropertyAdWordsLinksListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->ListWebPropertyAdWordsLinks($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
