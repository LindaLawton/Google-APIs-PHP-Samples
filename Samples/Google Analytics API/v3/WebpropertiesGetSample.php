...
// Single Request.
$results = webpropertiesGetExample($service, $accountId, $webPropertyId, $optParams);
...
* @return Webproperty
*/
function webpropertiesGetExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->webproperties->GetWebproperties($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
