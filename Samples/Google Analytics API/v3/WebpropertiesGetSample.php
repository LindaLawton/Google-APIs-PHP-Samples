...
print_r(webpropertiesGetExample($service, $accountId, $webPropertyId));
...
*/
function webpropertiesGetExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webproperties->GetWebproperties($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
