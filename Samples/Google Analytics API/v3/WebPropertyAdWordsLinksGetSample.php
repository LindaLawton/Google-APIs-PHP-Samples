...
// Single Request.
$results = webPropertyAdWordsLinksGetExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams);
...
*/
function webPropertyAdWordsLinksGetExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->GetWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams);
	}
	catch (Exception $e)
	{
