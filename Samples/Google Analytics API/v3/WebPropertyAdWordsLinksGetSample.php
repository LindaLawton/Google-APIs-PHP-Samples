...
print_r(get($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function get($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
