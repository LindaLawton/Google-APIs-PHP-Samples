...
print_r(webPropertyAdWordsLinksGetExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function webPropertyAdWordsLinksGetExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->GetWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
