...
print_r(webpropertyUserLinksInsertExample($service, $accountId, $webPropertyId));
...
*/
function webpropertyUserLinksInsertExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webpropertyUserLinks->InsertWebpropertyUserLinks($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
