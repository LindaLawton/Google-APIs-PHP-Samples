...
// Single Request.
$results = webpropertyUserLinksInsertExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function webpropertyUserLinksInsertExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->webpropertyUserLinks->InsertWebpropertyUserLinks($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
