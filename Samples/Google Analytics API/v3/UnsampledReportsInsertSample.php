...
$results = unsampledReportsInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
*/
function unsampledReportsInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->unsampledReports->InsertUnsampledReports($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
