...
print_r(unsampledReportsInsertExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function unsampledReportsInsertExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->unsampledReports->InsertUnsampledReports($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
