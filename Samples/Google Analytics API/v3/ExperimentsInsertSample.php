...
print_r(experimentsInsertExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function experimentsInsertExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->experiments->InsertExperiments($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
