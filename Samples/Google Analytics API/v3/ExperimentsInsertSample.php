...
// Single Request.
$results = experimentsInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
* @return Experiment
*/
function experimentsInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->experiments->InsertExperiments($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
