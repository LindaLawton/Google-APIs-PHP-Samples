...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of remarketing audiences to include in this response.
...
// Single Request.
$results = remarketingAudienceListExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function remarketingAudienceListExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->remarketingAudience->ListRemarketingAudience($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
