...
print_r(remarketingAudienceListExample($service, $accountId, $webPropertyId));
...
* @return RemarketingAudiences</returns>
*/
function remarketingAudienceListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->remarketingAudience->ListRemarketingAudience($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
