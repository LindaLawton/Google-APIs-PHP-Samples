...
print_r(customDimensionsGetExample($service, $accountId, $webPropertyId, $customDimensionId));
...
*/
function customDimensionsGetExample($service, $accountId, $webPropertyId, $customDimensionId)
{
	try
	{
		...
		return $service->customDimensions->GetCustomDimensions($accountId, $webPropertyId, $customDimensionId);
	}
	catch (Exception $ex)
	{
