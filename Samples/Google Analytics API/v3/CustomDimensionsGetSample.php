...
$results = customDimensionsGetExample($service, $accountId, $webPropertyId, $customDimensionId, $optParams);
...
*/
function customDimensionsGetExample($service, $accountId, $webPropertyId, $customDimensionId, $optParams)
{
	try
	{
		...
		return $service->customDimensions->GetCustomDimensions($accountId, $webPropertyId, $customDimensionId, $optParams);
	}
	catch (Exception $e)
	{
