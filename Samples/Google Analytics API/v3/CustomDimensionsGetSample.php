...
print_r(get($service, $accountId, $webPropertyId, $customDimensionId));
...
*/
function get($service, $accountId, $webPropertyId, $customDimensionId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $customDimensionId);
	}
	catch (Exception $ex)
	{
