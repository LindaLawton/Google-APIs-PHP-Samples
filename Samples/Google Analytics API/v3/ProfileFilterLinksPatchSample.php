...
print_r(patch($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function patch($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
