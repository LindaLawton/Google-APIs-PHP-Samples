...
print_r(profileFilterLinksPatchExample($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function profileFilterLinksPatchExample($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->profileFilterLinks->PatchProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
