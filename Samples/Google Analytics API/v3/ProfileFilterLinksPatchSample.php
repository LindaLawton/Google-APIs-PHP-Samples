...
// Single Request.
$results = profileFilterLinksPatchExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams);
...
*/
function profileFilterLinksPatchExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams)
{
	try
	{
		...
		return $service->profileFilterLinks->PatchProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
