...
print_r(uploadsDeleteUploadDataExample($service, $accountId, $webPropertyId, $customDataSourceId));
...
*/
function uploadsDeleteUploadDataExample($service, $accountId, $webPropertyId, $customDataSourceId)
{
	try
	{
		...
		return $service->uploads->DeleteUploadDataUploads($accountId, $webPropertyId, $customDataSourceId);
	}
	catch (Exception $ex)
	{
