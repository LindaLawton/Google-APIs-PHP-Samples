...
print_r(deleteUploadData($service, $accountId, $webPropertyId, $customDataSourceId));
...
*/
function deleteUploadData($service, $accountId, $webPropertyId, $customDataSourceId)
{
	try
	{
		...
		return $service->deleteUploadData($accountId, $webPropertyId, $customDataSourceId);
	}
	catch (Exception $ex)
	{
