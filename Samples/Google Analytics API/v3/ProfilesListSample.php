...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of views (profiles) to include in this response.
...
// Single Request.
$results = profilesListExample($service, $accountId, $webPropertyId, $optParams);
...
* @return Profiles
*/
function profilesListExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->profiles->ListProfiles($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
