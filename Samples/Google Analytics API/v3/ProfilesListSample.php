...
print_r(profilesListExample($service, $accountId, $webPropertyId));
...
* @return Profiles</returns>
*/
function profilesListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->profiles->ListProfiles($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
