...
print_r(profileUserLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId));
...
* @return EntityUserLink</returns>
*/
function profileUserLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->profileUserLinks->UpdateProfileUserLinks($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
