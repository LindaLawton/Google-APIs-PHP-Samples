...
// Single Request.
$results = profileUserLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams);
...
*/
function profileUserLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams)
{
	try
	{
		...
		return $service->profileUserLinks->UpdateProfileUserLinks($accountId, $webPropertyId, $profileId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
