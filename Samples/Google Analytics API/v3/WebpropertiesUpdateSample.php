...
$results = webpropertiesUpdateExample($service, $accountId, $webPropertyId, $optParams);
...
* @return Webproperty
*/
function webpropertiesUpdateExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->webproperties->UpdateWebproperties($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
