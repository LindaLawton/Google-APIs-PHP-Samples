...
print_r(webpropertiesUpdateExample($service, $accountId, $webPropertyId));
...
* @return Webproperty</returns>
*/
function webpropertiesUpdateExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->webproperties->UpdateWebproperties($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
