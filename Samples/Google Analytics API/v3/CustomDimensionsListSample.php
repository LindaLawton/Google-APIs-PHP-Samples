...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  //The maximum number of custom dimensions to include in this response.
...
// Single Request.
$results = customDimensionsListExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function customDimensionsListExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->customDimensions->ListCustomDimensions($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
