...
print_r(customDimensionsListExample($service, $accountId, $webPropertyId));
...
* @return CustomDimensions</returns>
*/
function customDimensionsListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->customDimensions->ListCustomDimensions($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
