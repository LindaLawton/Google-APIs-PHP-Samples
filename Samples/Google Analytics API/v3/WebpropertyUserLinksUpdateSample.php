...
// Single Request.
$results = webpropertyUserLinksUpdateExample($service, $accountId, $webPropertyId, $linkId, $optParams);
...
*/
function webpropertyUserLinksUpdateExample($service, $accountId, $webPropertyId, $linkId, $optParams)
{
	try
	{
		...
		return $service->webpropertyUserLinks->UpdateWebpropertyUserLinks($accountId, $webPropertyId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
