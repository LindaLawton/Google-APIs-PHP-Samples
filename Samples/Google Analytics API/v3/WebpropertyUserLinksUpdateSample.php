...
print_r(webpropertyUserLinksUpdateExample($service, $accountId, $webPropertyId, $linkId));
...
*/
function webpropertyUserLinksUpdateExample($service, $accountId, $webPropertyId, $linkId)
{
	try
	{
		...
		return $service->webpropertyUserLinks->UpdateWebpropertyUserLinks($accountId, $webPropertyId, $linkId);
	}
	catch (Exception $ex)
	{
