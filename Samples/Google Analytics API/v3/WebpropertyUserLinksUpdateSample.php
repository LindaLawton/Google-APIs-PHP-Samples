...
print_r(update($service, $accountId, $webPropertyId, $linkId));
...
*/
function update($service, $accountId, $webPropertyId, $linkId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $linkId);
	}
	catch (Exception $ex)
	{
