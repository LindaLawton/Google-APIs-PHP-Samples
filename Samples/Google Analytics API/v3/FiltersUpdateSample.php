...
// Single Request.
$results = filtersUpdateExample($service, $accountId, $filterId, $optParams);
...
* @return Filter
*/
function filtersUpdateExample($service, $accountId, $filterId, $optParams)
{
	try
	{
		...
		if (filterId == null)
			throw new Exception("filterId is required.");
		// Make the request and return the results.
		return $service->filters->UpdateFilters($accountId, $filterId, $optParams);
	}
	catch (Exception $e)
	{
