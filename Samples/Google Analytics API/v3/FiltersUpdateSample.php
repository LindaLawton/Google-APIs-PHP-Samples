...
print_r(filtersUpdateExample($service, $accountId, $filterId));
...
*/
function filtersUpdateExample($service, $accountId, $filterId)
{
	try
	{
		...
		return $service->filters->UpdateFilters($accountId, $filterId);
	}
	catch (Exception $ex)
	{
