...
// Single Request.
$results = customMetricsInsertExample($service, $accountId, $webPropertyId, $optParams);
...
* @return CustomMetric
*/
function customMetricsInsertExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->customMetrics->InsertCustomMetrics($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
