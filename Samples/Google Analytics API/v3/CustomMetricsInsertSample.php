...
print_r(customMetricsInsertExample($service, $accountId, $webPropertyId));
...
*/
function customMetricsInsertExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->customMetrics->InsertCustomMetrics($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
