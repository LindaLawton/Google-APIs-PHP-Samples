...
print_r(patch($service, $accountId, $webPropertyId, $customMetricId));
...
*/
function patch($service, $accountId, $webPropertyId, $customMetricId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $customMetricId);
	}
	catch (Exception $ex)
	{
