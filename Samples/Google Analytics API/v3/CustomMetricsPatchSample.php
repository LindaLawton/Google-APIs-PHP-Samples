...
print_r(customMetricsPatchExample($service, $accountId, $webPropertyId, $customMetricId));
...
*/
function customMetricsPatchExample($service, $accountId, $webPropertyId, $customMetricId)
{
	try
	{
		...
		return $service->customMetrics->PatchCustomMetrics($accountId, $webPropertyId, $customMetricId);
	}
	catch (Exception $ex)
	{
