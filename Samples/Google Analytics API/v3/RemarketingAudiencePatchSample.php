...
print_r(patch($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function patch($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
