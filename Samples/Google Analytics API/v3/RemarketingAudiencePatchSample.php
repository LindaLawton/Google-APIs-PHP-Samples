...
print_r(remarketingAudiencePatchExample($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function remarketingAudiencePatchExample($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->remarketingAudience->PatchRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
