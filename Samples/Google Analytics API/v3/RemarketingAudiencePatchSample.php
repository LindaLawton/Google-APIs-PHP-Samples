...
// Single Request.
$results = remarketingAudiencePatchExample($service, $accountId, $webPropertyId, $remarketingAudienceId, $optParams);
...
*/
function remarketingAudiencePatchExample($service, $accountId, $webPropertyId, $remarketingAudienceId, $optParams)
{
	try
	{
		...
		return $service->remarketingAudience->PatchRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId, $optParams);
	}
	catch (Exception $e)
	{
