...
print_r(update($service, $accountId, $webPropertyId, $customDimensionId));
...
*/
function update($service, $accountId, $webPropertyId, $customDimensionId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $customDimensionId);
	}
	catch (Exception $ex)
	{
