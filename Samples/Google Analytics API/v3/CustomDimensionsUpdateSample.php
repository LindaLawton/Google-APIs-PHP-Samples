...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'ignoreCustomDataSourceLinks' => '[YourValue]',  //Force the update and ignore any warnings related to the custom dimension being linked to a custom data source / data set.
  'fields' => '*'
);
// Single Request.
$results = customDimensionsUpdateExample($service, $accountId, $webPropertyId, $customDimensionId, $optParams);
...
*/
function customDimensionsUpdateExample($service, $accountId, $webPropertyId, $customDimensionId, $optParams)
{
	try
	{
		...
		if (customDimensionId == null)
			throw new Exception("customDimensionId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->customDimensions->UpdateCustomDimensions($accountId, $webPropertyId, $customDimensionId, $optParams);
	}
	catch (Exception $e)
	{
