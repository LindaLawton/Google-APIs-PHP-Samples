...
print_r(customDimensionsUpdateExample($service, $accountId, $webPropertyId, $customDimensionId));
...
* @return CustomDimension</returns>
*/
function customDimensionsUpdateExample($service, $accountId, $webPropertyId, $customDimensionId)
{
	try
	{
		...
		return $service->customDimensions->UpdateCustomDimensions($accountId, $webPropertyId, $customDimensionId);
	}
	catch (Exception $ex)
	{
