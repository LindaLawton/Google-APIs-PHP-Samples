...
print_r(profilesInsertExample($service, $accountId, $webPropertyId));
...
*/
function profilesInsertExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->profiles->InsertProfiles($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
