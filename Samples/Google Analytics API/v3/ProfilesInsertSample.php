...
// Single Request.
$results = profilesInsertExample($service, $accountId, $webPropertyId, $optParams);
...
* @return Profile
*/
function profilesInsertExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->profiles->InsertProfiles($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
