...
print_r(uploadsGetExample($service, $accountId, $webPropertyId, $customDataSourceId, $uploadId));
...
*/
function uploadsGetExample($service, $accountId, $webPropertyId, $customDataSourceId, $uploadId)
{
	try
	{
		...
		return $service->uploads->GetUploads($accountId, $webPropertyId, $customDataSourceId, $uploadId);
	}
	catch (Exception $ex)
	{
