...
// Single Request.
$results = uploadsGetExample($service, $accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams);
...
* @return Upload
*/
function uploadsGetExample($service, $accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams)
{
	try
	{
		...
		if (uploadId == null)
			throw new Exception("uploadId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->uploads->GetUploads($accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams);
	}
	catch (Exception $e)
	{
