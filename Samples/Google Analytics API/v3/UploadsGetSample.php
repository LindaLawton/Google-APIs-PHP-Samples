...
print_r(get($service, $accountId, $webPropertyId, $customDataSourceId, $uploadId));
...
*/
function get($service, $accountId, $webPropertyId, $customDataSourceId, $uploadId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $customDataSourceId, $uploadId);
	}
	catch (Exception $ex)
	{
