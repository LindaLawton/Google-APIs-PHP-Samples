...
$results = profileUserLinksDeleteExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams);
...
*/
function profileUserLinksDeleteExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams)
{
	try
	{
		...
		return $service->profileUserLinks->DeleteProfileUserLinks($accountId, $webPropertyId, $profileId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
