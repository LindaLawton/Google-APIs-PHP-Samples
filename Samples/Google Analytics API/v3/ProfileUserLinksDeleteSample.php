...
print_r(profileUserLinksDeleteExample($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function profileUserLinksDeleteExample($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->profileUserLinks->DeleteProfileUserLinks($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
