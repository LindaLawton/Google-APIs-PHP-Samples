...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of profile filter links to include in this response.
...
// Single Request.
$results = profileFilterLinksListExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
*/
function profileFilterLinksListExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profileFilterLinks->ListProfileFilterLinks($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
