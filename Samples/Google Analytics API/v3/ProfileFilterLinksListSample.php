...
print_r(profileFilterLinksListExample($service, $accountId, $webPropertyId, $profileId));
...
* @return ProfileFilterLinks</returns>
*/
function profileFilterLinksListExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profileFilterLinks->ListProfileFilterLinks($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
