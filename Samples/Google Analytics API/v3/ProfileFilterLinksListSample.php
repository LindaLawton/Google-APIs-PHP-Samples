...
print_r(list($service, $accountId, $webPropertyId, $profileId));
...
*/
function list($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->list($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
