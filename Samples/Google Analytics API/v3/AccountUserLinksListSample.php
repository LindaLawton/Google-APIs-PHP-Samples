...
print_r(accountUserLinksListExample($service, $accountId));
...
*/
function accountUserLinksListExample($service, $accountId)
{
	try
	{
		...
		return $service->accountUserLinks->ListAccountUserLinks($accountId);
	}
	catch (Exception $ex)
	{
