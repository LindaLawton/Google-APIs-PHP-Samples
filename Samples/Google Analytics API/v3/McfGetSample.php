...
print_r(mcfGetExample($service, $ids, $start-date, $end-date, $metrics));
...
* @return McfData</returns>
*/
function mcfGetExample($service, $ids, $start-date, $end-date, $metrics)
{
	try
	{
		...
		return $service->mcf->GetMcf($ids, $start-date, $end-date, $metrics);
	}
	catch (Exception $ex)
	{
