...
print_r(get($service, $ids, $start-date, $end-date, $metrics));
...
*/
function get($service, $ids, $start-date, $end-date, $metrics)
{
	try
	{
		...
		return $service->get($ids, $start-date, $end-date, $metrics);
	}
	catch (Exception $ex)
	{
