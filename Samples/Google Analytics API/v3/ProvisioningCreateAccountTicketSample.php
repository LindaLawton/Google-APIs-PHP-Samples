...
$results = provisioningCreateAccountTicketExample($service, $optParams);
...
*/
function provisioningCreateAccountTicketExample($service, $optParams)
{
	try
	{
		...
		return $service->provisioning->CreateAccountTicketProvisioning($optParams);
	}
	catch (Exception $e)
	{
