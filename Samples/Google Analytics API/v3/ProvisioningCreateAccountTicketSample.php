...
print_r(provisioningCreateAccountTicketExample($service));

/**
* Creates an account ticket.
* @service Authenticated Analytics service.
* @return AccountTicket</returns>
*/
function provisioningCreateAccountTicketExample($service)
{
	try
	{
		...
		return $service->provisioning->CreateAccountTicketProvisioning();
	}
	catch (Exception $ex)
	{
