...
print_r(customDataSourcesListExample($service, $accountId, $webPropertyId));
...
* @return CustomDataSources</returns>
*/
function customDataSourcesListExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->customDataSources->ListCustomDataSources($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
