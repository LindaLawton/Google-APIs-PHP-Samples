...
print_r(get($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function get($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
