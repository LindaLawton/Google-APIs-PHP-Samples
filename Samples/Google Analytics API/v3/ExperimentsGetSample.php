...
print_r(experimentsGetExample($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function experimentsGetExample($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->experiments->GetExperiments($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
