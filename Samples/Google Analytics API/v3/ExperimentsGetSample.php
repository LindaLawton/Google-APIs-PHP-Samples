...
// Single Request.
$results = experimentsGetExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams);
...
* @return Experiment
*/
function experimentsGetExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams)
{
	try
	{
		...
		return $service->experiments->GetExperiments($accountId, $webPropertyId, $profileId, $experimentId, $optParams);
	}
	catch (Exception $e)
	{
