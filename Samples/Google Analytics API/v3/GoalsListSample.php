...
print_r(goalsListExample($service, $accountId, $webPropertyId, $profileId));
...
* @return Goals</returns>
*/
function goalsListExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->goals->ListGoals($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
