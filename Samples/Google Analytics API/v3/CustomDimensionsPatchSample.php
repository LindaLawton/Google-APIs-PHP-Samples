...
print_r(patch($service, $accountId, $webPropertyId, $customDimensionId));
...
*/
function patch($service, $accountId, $webPropertyId, $customDimensionId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $customDimensionId);
	}
	catch (Exception $ex)
	{
