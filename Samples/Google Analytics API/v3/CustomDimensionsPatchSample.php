...
print_r(customDimensionsPatchExample($service, $accountId, $webPropertyId, $customDimensionId));
...
*/
function customDimensionsPatchExample($service, $accountId, $webPropertyId, $customDimensionId)
{
	try
	{
		...
		return $service->customDimensions->PatchCustomDimensions($accountId, $webPropertyId, $customDimensionId);
	}
	catch (Exception $ex)
	{
