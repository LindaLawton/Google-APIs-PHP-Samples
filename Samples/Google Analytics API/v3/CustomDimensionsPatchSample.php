...
// Single Request.
$results = customDimensionsPatchExample($service, $accountId, $webPropertyId, $customDimensionId, $optParams);
...
*/
function customDimensionsPatchExample($service, $accountId, $webPropertyId, $customDimensionId, $optParams)
{
	try
	{
		...
		return $service->customDimensions->PatchCustomDimensions($accountId, $webPropertyId, $customDimensionId, $optParams);
	}
	catch (Exception $e)
	{
