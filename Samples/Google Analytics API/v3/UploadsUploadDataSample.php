...
print_r(uploadData($service, $accountId, $webPropertyId, $customDataSourceId));
...
*/
function uploadData($service, $accountId, $webPropertyId, $customDataSourceId)
{
	try
	{
		...
		return $service->uploadData($accountId, $webPropertyId, $customDataSourceId);
	}
	catch (Exception $ex)
	{
