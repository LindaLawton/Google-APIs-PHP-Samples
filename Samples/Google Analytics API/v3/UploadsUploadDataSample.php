...
// Single Request.
$results = uploadsUploadDataExample($service, $accountId, $webPropertyId, $customDataSourceId, $optParams);
...
* @return Upload
*/
function uploadsUploadDataExample($service, $accountId, $webPropertyId, $customDataSourceId, $optParams)
{
	try
	{
		...
		return $service->uploads->UploadDataUploads($accountId, $webPropertyId, $customDataSourceId, $optParams);
	}
	catch (Exception $e)
	{
