...
print_r(uploadsUploadDataExample($service, $accountId, $webPropertyId, $customDataSourceId));
...
*/
function uploadsUploadDataExample($service, $accountId, $webPropertyId, $customDataSourceId)
{
	try
	{
		...
		return $service->uploads->UploadDataUploads($accountId, $webPropertyId, $customDataSourceId);
	}
	catch (Exception $ex)
	{
