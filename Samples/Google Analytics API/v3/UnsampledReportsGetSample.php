...
print_r(unsampledReportsGetExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId));
...
* @return UnsampledReport</returns>
*/
function unsampledReportsGetExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId)
{
	try
	{
		...
		return $service->unsampledReports->GetUnsampledReports($accountId, $webPropertyId, $profileId, $unsampledReportId);
	}
	catch (Exception $ex)
	{
