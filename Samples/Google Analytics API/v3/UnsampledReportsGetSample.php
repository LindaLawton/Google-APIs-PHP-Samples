...
// Single Request.
$results = unsampledReportsGetExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams);
...
*/
function unsampledReportsGetExample($service, $accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams)
{
	try
	{
		...
		return $service->unsampledReports->GetUnsampledReports($accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams);
	}
	catch (Exception $e)
	{
