...
print_r(get($service, $accountId, $webPropertyId, $profileId, $unsampledReportId));
...
*/
function get($service, $accountId, $webPropertyId, $profileId, $unsampledReportId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $profileId, $unsampledReportId);
	}
	catch (Exception $ex)
	{
