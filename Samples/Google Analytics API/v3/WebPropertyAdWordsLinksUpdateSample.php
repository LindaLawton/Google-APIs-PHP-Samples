...
print_r(update($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function update($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
