...
print_r(webPropertyAdWordsLinksUpdateExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
* @return EntityAdWordsLink</returns>
*/
function webPropertyAdWordsLinksUpdateExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		if (webPropertyAdWordsLinkId == null)
			throw new Exception("webPropertyAdWordsLinkId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->webPropertyAdWordsLinks->UpdateWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
