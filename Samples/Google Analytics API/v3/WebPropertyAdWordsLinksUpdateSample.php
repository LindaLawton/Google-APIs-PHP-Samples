...
// Single Request.
$results = webPropertyAdWordsLinksUpdateExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams);
...
*/
function webPropertyAdWordsLinksUpdateExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->UpdateWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams);
	}
	catch (Exception $e)
	{
