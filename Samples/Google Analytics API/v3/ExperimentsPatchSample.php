...
$results = experimentsPatchExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams);
...
* @return Experiment
*/
function experimentsPatchExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams)
{
	try
	{
		...
		return $service->experiments->PatchExperiments($accountId, $webPropertyId, $profileId, $experimentId, $optParams);
	}
	catch (Exception $e)
	{
