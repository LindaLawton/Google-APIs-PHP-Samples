...
print_r(experimentsPatchExample($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function experimentsPatchExample($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->experiments->PatchExperiments($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
