...
print_r(patch($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function patch($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
