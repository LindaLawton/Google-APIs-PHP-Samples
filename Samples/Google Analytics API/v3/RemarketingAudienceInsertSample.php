...
print_r(remarketingAudienceInsertExample($service, $accountId, $webPropertyId));
...
*/
function remarketingAudienceInsertExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->remarketingAudience->InsertRemarketingAudience($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
