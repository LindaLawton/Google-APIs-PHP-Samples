...
// Single Request.
$results = remarketingAudienceInsertExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function remarketingAudienceInsertExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->remarketingAudience->InsertRemarketingAudience($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
