...
$results = filtersInsertExample($service, $accountId, $optParams);
...
* @return Filter
*/
function filtersInsertExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->filters->InsertFilters($accountId, $optParams);
	}
	catch (Exception $e)
	{
