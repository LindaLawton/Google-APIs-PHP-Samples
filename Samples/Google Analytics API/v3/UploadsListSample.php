...
print_r(uploadsListExample($service, $accountId, $webPropertyId, $customDataSourceId));
...
*/
function uploadsListExample($service, $accountId, $webPropertyId, $customDataSourceId)
{
	try
	{
		...
		return $service->uploads->ListUploads($accountId, $webPropertyId, $customDataSourceId);
	}
	catch (Exception $ex)
	{
