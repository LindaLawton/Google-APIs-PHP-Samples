...
print_r(list($service, $accountId, $webPropertyId, $customDataSourceId));
...
*/
function list($service, $accountId, $webPropertyId, $customDataSourceId)
{
	try
	{
		...
		return $service->list($accountId, $webPropertyId, $customDataSourceId);
	}
	catch (Exception $ex)
	{
