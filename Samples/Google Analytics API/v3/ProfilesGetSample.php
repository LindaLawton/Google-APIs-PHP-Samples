...
// Single Request.
$results = profilesGetExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
* @return Profile
*/
function profilesGetExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profiles->GetProfiles($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
