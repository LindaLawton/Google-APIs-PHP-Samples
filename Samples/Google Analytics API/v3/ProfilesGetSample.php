...
print_r(get($service, $accountId, $webPropertyId, $profileId));
...
*/
function get($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
