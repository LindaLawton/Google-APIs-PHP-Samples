...
print_r(profilesGetExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function profilesGetExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profiles->GetProfiles($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
