...
print_r(customMetricsUpdateExample($service, $accountId, $webPropertyId, $customMetricId));
...
* @return CustomMetric</returns>
*/
function customMetricsUpdateExample($service, $accountId, $webPropertyId, $customMetricId)
{
	try
	{
		...
		return $service->customMetrics->UpdateCustomMetrics($accountId, $webPropertyId, $customMetricId);
	}
	catch (Exception $ex)
	{
