...
print_r(update($service, $accountId, $webPropertyId, $customMetricId));
...
*/
function update($service, $accountId, $webPropertyId, $customMetricId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $customMetricId);
	}
	catch (Exception $ex)
	{
