...
// Single Request.
$results = filtersDeleteExample($service, $accountId, $filterId, $optParams);
...
* @return Filter
*/
function filtersDeleteExample($service, $accountId, $filterId, $optParams)
{
	try
	{
		...
		return $service->filters->DeleteFilters($accountId, $filterId, $optParams);
	}
	catch (Exception $e)
	{
