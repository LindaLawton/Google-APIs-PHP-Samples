...
print_r(filtersDeleteExample($service, $accountId, $filterId));
...
*/
function filtersDeleteExample($service, $accountId, $filterId)
{
	try
	{
		...
		return $service->filters->DeleteFilters($accountId, $filterId);
	}
	catch (Exception $ex)
	{
