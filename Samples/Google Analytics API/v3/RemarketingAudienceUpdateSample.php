...
print_r(update($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
*/
function update($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
