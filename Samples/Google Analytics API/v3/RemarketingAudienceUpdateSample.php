...
print_r(remarketingAudienceUpdateExample($service, $accountId, $webPropertyId, $remarketingAudienceId));
...
* @return RemarketingAudience</returns>
*/
function remarketingAudienceUpdateExample($service, $accountId, $webPropertyId, $remarketingAudienceId)
{
	try
	{
		...
		if (remarketingAudienceId == null)
			throw new Exception("remarketingAudienceId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->remarketingAudience->UpdateRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId);
	}
	catch (Exception $ex)
	{
