...
// Single Request.
$results = remarketingAudienceUpdateExample($service, $accountId, $webPropertyId, $remarketingAudienceId, $optParams);
...
*/
function remarketingAudienceUpdateExample($service, $accountId, $webPropertyId, $remarketingAudienceId, $optParams)
{
	try
	{
		...
		return $service->remarketingAudience->UpdateRemarketingAudience($accountId, $webPropertyId, $remarketingAudienceId, $optParams);
	}
	catch (Exception $e)
	{
