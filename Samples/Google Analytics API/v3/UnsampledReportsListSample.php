...
print_r(unsampledReportsListExample($service, $accountId, $webPropertyId, $profileId));
...
* @return UnsampledReports</returns>
*/
function unsampledReportsListExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->unsampledReports->ListUnsampledReports($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
