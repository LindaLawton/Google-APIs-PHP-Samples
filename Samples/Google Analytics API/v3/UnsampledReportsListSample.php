...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'max-results' => '[YourValue]',  // The maximum number of unsampled reports to include in this response.
            
  //'start-index' => '[YourValue]',  // An index of the first unsampled report to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
  'fields' => '*'
);
// Single Request.
$results = unsampledReportsListExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
*/
function unsampledReportsListExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->unsampledReports->ListUnsampledReports($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
