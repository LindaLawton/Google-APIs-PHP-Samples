...
print_r(webPropertyAdWordsLinksPatchExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function webPropertyAdWordsLinksPatchExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->PatchWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
