...
$results = webPropertyAdWordsLinksPatchExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams);
...
*/
function webPropertyAdWordsLinksPatchExample($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams)
{
	try
	{
		...
		return $service->webPropertyAdWordsLinks->PatchWebPropertyAdWordsLinks($accountId, $webPropertyId, $webPropertyAdWordsLinkId, $optParams);
	}
	catch (Exception $e)
	{
