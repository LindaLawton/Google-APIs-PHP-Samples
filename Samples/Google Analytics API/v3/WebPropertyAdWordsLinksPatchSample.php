...
print_r(patch($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId));
...
*/
function patch($service, $accountId, $webPropertyId, $webPropertyAdWordsLinkId)
{
	try
	{
		...
		return $service->patch($accountId, $webPropertyId, $webPropertyAdWordsLinkId);
	}
	catch (Exception $ex)
	{
