...
print_r(experimentsListExample($service, $accountId, $webPropertyId, $profileId));
...
* @return Experiments</returns>
*/
function experimentsListExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->experiments->ListExperiments($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
