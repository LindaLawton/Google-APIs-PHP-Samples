...
* @return Experiments
*/
function experimentsListExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->experiments->ListExperiments($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
