...
print_r(accountUserLinksUpdateExample($service, $accountId, $linkId));
...
*/
function accountUserLinksUpdateExample($service, $accountId, $linkId)
{
	try
	{
		...
		return $service->accountUserLinks->UpdateAccountUserLinks($accountId, $linkId);
	}
	catch (Exception $ex)
	{
