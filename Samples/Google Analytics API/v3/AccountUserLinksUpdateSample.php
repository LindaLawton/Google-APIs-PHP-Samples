...
// Single Request.
$results = accountUserLinksUpdateExample($service, $accountId, $linkId, $optParams);
...
*/
function accountUserLinksUpdateExample($service, $accountId, $linkId, $optParams)
{
	try
	{
		...
		return $service->accountUserLinks->UpdateAccountUserLinks($accountId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
