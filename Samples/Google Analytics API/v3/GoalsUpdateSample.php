...
// Single Request.
$results = goalsUpdateExample($service, $accountId, $webPropertyId, $profileId, $goalId, $optParams);
...
* @return Goal
*/
function goalsUpdateExample($service, $accountId, $webPropertyId, $profileId, $goalId, $optParams)
{
	try
	{
		...
		if (goalId == null)
			throw new Exception("goalId is required.");
		if (profileId == null)
			throw new Exception("profileId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->goals->UpdateGoals($accountId, $webPropertyId, $profileId, $goalId, $optParams);
	}
	catch (Exception $e)
	{
