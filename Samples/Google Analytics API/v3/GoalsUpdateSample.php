...
print_r(goalsUpdateExample($service, $accountId, $webPropertyId, $profileId, $goalId));
...
* @return Goal</returns>
*/
function goalsUpdateExample($service, $accountId, $webPropertyId, $profileId, $goalId)
{
	try
	{
		...
		return $service->goals->UpdateGoals($accountId, $webPropertyId, $profileId, $goalId);
	}
	catch (Exception $ex)
	{
