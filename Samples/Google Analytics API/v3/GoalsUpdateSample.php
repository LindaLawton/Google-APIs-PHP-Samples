...
print_r(update($service, $accountId, $webPropertyId, $profileId, $goalId));
...
* @return Goal</returns>
*/
function update($service, $accountId, $webPropertyId, $profileId, $goalId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $profileId, $goalId);
	}
	catch (Exception $ex)
	{
