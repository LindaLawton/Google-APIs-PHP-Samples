...
print_r(update($service, $accountId, $webPropertyId, $profileId, $linkId));
...
*/
function update($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
