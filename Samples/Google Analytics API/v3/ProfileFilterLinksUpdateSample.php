...
// Single Request.
$results = profileFilterLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams);
...
*/
function profileFilterLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId, $optParams)
{
	try
	{
		...
		return $service->profileFilterLinks->UpdateProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId, $optParams);
	}
	catch (Exception $e)
	{
