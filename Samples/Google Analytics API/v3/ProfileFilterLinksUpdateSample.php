...
print_r(profileFilterLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId));
...
* @return ProfileFilterLink</returns>
*/
function profileFilterLinksUpdateExample($service, $accountId, $webPropertyId, $profileId, $linkId)
{
	try
	{
		...
		if (linkId == null)
			throw new Exception("linkId is required.");
		if (profileId == null)
			throw new Exception("profileId is required.");
		if (webPropertyId == null)
			throw new Exception("webPropertyId is required.");
		// Make the request and return the results.
		return $service->profileFilterLinks->UpdateProfileFilterLinks($accountId, $webPropertyId, $profileId, $linkId);
	}
	catch (Exception $ex)
	{
