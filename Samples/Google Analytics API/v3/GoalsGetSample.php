...
print_r(get($service, $accountId, $webPropertyId, $profileId, $goalId));
...
* @return Goal</returns>
*/
function get($service, $accountId, $webPropertyId, $profileId, $goalId)
{
	try
	{
		...
		return $service->get($accountId, $webPropertyId, $profileId, $goalId);
	}
	catch (Exception $ex)
	{
