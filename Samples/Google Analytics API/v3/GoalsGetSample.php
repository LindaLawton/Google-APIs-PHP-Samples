...
print_r(goalsGetExample($service, $accountId, $webPropertyId, $profileId, $goalId));
...
* @return Goal</returns>
*/
function goalsGetExample($service, $accountId, $webPropertyId, $profileId, $goalId)
{
	try
	{
		...
		return $service->goals->GetGoals($accountId, $webPropertyId, $profileId, $goalId);
	}
	catch (Exception $ex)
	{
