...
// Single Request.
$results = goalsGetExample($service, $accountId, $webPropertyId, $profileId, $goalId, $optParams);
...
* @return Goal
*/
function goalsGetExample($service, $accountId, $webPropertyId, $profileId, $goalId, $optParams)
{
	try
	{
		...
		return $service->goals->GetGoals($accountId, $webPropertyId, $profileId, $goalId, $optParams);
	}
	catch (Exception $e)
	{
