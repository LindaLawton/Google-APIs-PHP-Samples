...
print_r(customDimensionsInsertExample($service, $accountId, $webPropertyId));
...
*/
function customDimensionsInsertExample($service, $accountId, $webPropertyId)
{
	try
	{
		...
		return $service->customDimensions->InsertCustomDimensions($accountId, $webPropertyId);
	}
	catch (Exception $ex)
	{
