...
// Single Request.
$results = customDimensionsInsertExample($service, $accountId, $webPropertyId, $optParams);
...
*/
function customDimensionsInsertExample($service, $accountId, $webPropertyId, $optParams)
{
	try
	{
		...
		return $service->customDimensions->InsertCustomDimensions($accountId, $webPropertyId, $optParams);
	}
	catch (Exception $e)
	{
