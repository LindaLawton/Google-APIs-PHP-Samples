...
$results = filtersGetExample($service, $accountId, $filterId, $optParams);
...
* @return Filter
*/
function filtersGetExample($service, $accountId, $filterId, $optParams)
{
	try
	{
		...
		return $service->filters->GetFilters($accountId, $filterId, $optParams);
	}
	catch (Exception $e)
	{
