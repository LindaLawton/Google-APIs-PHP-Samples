...
print_r(filtersGetExample($service, $accountId, $filterId));
...
*/
function filtersGetExample($service, $accountId, $filterId)
{
	try
	{
		...
		return $service->filters->GetFilters($accountId, $filterId);
	}
	catch (Exception $ex)
	{
