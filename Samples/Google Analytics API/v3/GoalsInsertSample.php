...
print_r(goalsInsertExample($service, $accountId, $webPropertyId, $profileId));
...
* @return Goal</returns>
*/
function goalsInsertExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->goals->InsertGoals($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
