...
// Single Request.
$results = goalsInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
* @return Goal
*/
function goalsInsertExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->goals->InsertGoals($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
