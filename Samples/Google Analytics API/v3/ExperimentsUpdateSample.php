...
// Single Request.
$results = experimentsUpdateExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams);
...
* @return Experiment
*/
function experimentsUpdateExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams)
{
	try
	{
		...
		return $service->experiments->UpdateExperiments($accountId, $webPropertyId, $profileId, $experimentId, $optParams);
	}
	catch (Exception $e)
	{
