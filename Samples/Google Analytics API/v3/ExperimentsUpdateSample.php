...
print_r(experimentsUpdateExample($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
* @return Experiment</returns>
*/
function experimentsUpdateExample($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->experiments->UpdateExperiments($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
