...
print_r(update($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function update($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
