...
$results = experimentsDeleteExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams);
...
*/
function experimentsDeleteExample($service, $accountId, $webPropertyId, $profileId, $experimentId, $optParams)
{
	try
	{
		...
		return $service->experiments->DeleteExperiments($accountId, $webPropertyId, $profileId, $experimentId, $optParams);
	}
	catch (Exception $e)
	{
