...
print_r(delete($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function delete($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
