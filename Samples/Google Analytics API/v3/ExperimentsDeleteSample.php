...
print_r(experimentsDeleteExample($service, $accountId, $webPropertyId, $profileId, $experimentId));
...
*/
function experimentsDeleteExample($service, $accountId, $webPropertyId, $profileId, $experimentId)
{
	try
	{
		...
		return $service->experiments->DeleteExperiments($accountId, $webPropertyId, $profileId, $experimentId);
	}
	catch (Exception $ex)
	{
