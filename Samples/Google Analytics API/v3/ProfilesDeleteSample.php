...
print_r(delete($service, $accountId, $webPropertyId, $profileId));
...
*/
function delete($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->delete($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
