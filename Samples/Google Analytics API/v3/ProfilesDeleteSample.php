...
print_r(profilesDeleteExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function profilesDeleteExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profiles->DeleteProfiles($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
