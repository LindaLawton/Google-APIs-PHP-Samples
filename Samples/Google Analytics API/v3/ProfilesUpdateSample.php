...
print_r(update($service, $accountId, $webPropertyId, $profileId));
...
*/
function update($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->update($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
