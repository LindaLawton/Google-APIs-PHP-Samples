...
print_r(profilesUpdateExample($service, $accountId, $webPropertyId, $profileId));
...
*/
function profilesUpdateExample($service, $accountId, $webPropertyId, $profileId)
{
	try
	{
		...
		return $service->profiles->UpdateProfiles($accountId, $webPropertyId, $profileId);
	}
	catch (Exception $ex)
	{
