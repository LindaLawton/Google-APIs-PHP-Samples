...
// Single Request.
$results = profilesUpdateExample($service, $accountId, $webPropertyId, $profileId, $optParams);
...
* @return Profile
*/
function profilesUpdateExample($service, $accountId, $webPropertyId, $profileId, $optParams)
{
	try
	{
		...
		return $service->profiles->UpdateProfiles($accountId, $webPropertyId, $profileId, $optParams);
	}
	catch (Exception $e)
	{
