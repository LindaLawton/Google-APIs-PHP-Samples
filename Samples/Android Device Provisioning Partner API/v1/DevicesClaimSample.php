...
$results = devicesClaimExample($service, $partnerId, $optParams);
...
*/
function devicesClaimExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->ClaimDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
