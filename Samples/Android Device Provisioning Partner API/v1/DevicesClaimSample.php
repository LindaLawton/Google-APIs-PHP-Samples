...
print_r(devicesClaimExample($service, $partnerId));
...
* @return ClaimDeviceResponse</returns>
*/
function devicesClaimExample($service, $partnerId)
{
	try
	{
		...
		return $service->devices->ClaimDevices($partnerId);
	}
	catch (Exception $ex)
	{
