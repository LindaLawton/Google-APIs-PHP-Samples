...
// Single Request.
$results = devicesUnclaimExample($service, $partnerId, $optParams);
...
* @return Empty
*/
function devicesUnclaimExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->UnclaimDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
