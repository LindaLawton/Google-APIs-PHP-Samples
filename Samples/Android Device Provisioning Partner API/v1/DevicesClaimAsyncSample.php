...
// Single Request.
$results = devicesClaimAsyncExample($service, $partnerId, $optParams);
...
* @return Operation
*/
function devicesClaimAsyncExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->ClaimAsyncDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
