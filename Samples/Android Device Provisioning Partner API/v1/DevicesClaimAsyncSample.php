...
print_r(devicesClaimAsyncExample($service, $partnerId));
...
*/
function devicesClaimAsyncExample($service, $partnerId)
{
	try
	{
		...
		return $service->devices->ClaimAsyncDevices($partnerId);
	}
	catch (Exception $ex)
	{
