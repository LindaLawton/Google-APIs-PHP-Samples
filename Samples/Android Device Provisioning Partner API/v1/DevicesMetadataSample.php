...
// Single Request.
$results = devicesMetadataExample($service, $metadataOwnerId, $deviceId, $optParams);
...
*/
function devicesMetadataExample($service, $metadataOwnerId, $deviceId, $optParams)
{
	try
	{
		...
		if (metadataOwnerId == null)
			throw new Exception("metadataOwnerId is required.");
		if (deviceId == null)
			throw new Exception("deviceId is required.");
		// Make the request and return the results.
		return $service->devices->MetadataDevices($metadataOwnerId, $deviceId, $optParams);
	}
	catch (Exception $e)
	{
