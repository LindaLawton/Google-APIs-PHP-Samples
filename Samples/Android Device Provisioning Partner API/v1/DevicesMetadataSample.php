...
print_r(devicesMetadataExample($service, $metadataOwnerId, $deviceId));
...
* @return DeviceMetadata</returns>
*/
function devicesMetadataExample($service, $metadataOwnerId, $deviceId)
{
	try
	{
		...
		return $service->devices->MetadataDevices($metadataOwnerId, $deviceId);
	}
	catch (Exception $ex)
	{
