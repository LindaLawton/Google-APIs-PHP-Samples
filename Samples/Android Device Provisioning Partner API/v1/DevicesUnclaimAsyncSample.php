...
print_r(devicesUnclaimAsyncExample($service, $partnerId));
...
*/
function devicesUnclaimAsyncExample($service, $partnerId)
{
	try
	{
		...
		return $service->devices->UnclaimAsyncDevices($partnerId);
	}
	catch (Exception $ex)
	{
