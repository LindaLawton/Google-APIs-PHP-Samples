...
// Single Request.
$results = devicesUnclaimAsyncExample($service, $partnerId, $optParams);
...
* @return Operation
*/
function devicesUnclaimAsyncExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->UnclaimAsyncDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
