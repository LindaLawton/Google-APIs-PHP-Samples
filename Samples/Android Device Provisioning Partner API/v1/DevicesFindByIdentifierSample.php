...
// Single Request.
$results = devicesFindByIdentifierExample($service, $partnerId, $optParams);
...
*/
function devicesFindByIdentifierExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->FindByIdentifierDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
