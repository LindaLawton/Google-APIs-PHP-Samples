...
print_r(devicesFindByIdentifierExample($service, $partnerId));

/**
* Find devices by device identifier.
* @service Authenticated Androidprovisioningpartner service.
* @partnerId ID of the partner.
* @return FindDevicesByDeviceIdentifierResponse</returns>
*/
function devicesFindByIdentifierExample($service, $partnerId)
{
	try
	{
		...
		return $service->devices->FindByIdentifierDevices($partnerId);
	}
	catch (Exception $ex)
	{
