...
# UnOfficial Android Device Provisioning Partner API v1 Samples for PHP

## API Description

Automates reseller integration into zero-touch enrollment by assigning devices to customers and creating device reports.

[Official Documentation](https://developers.google.com/zero-touch/)

## Sample Description

These samples show how to access the [Android Device Provisioning Partner API v1](https://developers.google.com/zero-touch/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
