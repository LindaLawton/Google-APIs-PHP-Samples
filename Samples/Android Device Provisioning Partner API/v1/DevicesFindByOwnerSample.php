...
$results = devicesFindByOwnerExample($service, $partnerId, $optParams);
...
*/
function devicesFindByOwnerExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->FindByOwnerDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
