...
print_r(devicesFindByOwnerExample($service, $partnerId));

/**
* Find devices by ownership.
* @service Authenticated Androidprovisioningpartner service.
* @partnerId ID of the partner.
* @return FindDevicesByOwnerResponse</returns>
*/
function devicesFindByOwnerExample($service, $partnerId)
{
	try
	{
		...
		return $service->devices->FindByOwnerDevices($partnerId);
	}
	catch (Exception $ex)
	{
