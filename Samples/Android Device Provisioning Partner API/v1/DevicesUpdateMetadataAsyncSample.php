...
print_r(devicesUpdateMetadataAsyncExample($service, $partnerId));
...
*/
function devicesUpdateMetadataAsyncExample($service, $partnerId)
{
	try
	{
		...
		return $service->devices->UpdateMetadataAsyncDevices($partnerId);
	}
	catch (Exception $ex)
	{
