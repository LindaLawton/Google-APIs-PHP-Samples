...
$results = devicesUpdateMetadataAsyncExample($service, $partnerId, $optParams);
...
* @return Operation
*/
function devicesUpdateMetadataAsyncExample($service, $partnerId, $optParams)
{
	try
	{
		...
		return $service->devices->UpdateMetadataAsyncDevices($partnerId, $optParams);
	}
	catch (Exception $e)
	{
