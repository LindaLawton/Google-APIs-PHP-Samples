 ...
 * Initializes an Androidprovisioningpartner.v1 service object.
 * @param string API key
 * @return An authorized Androidprovisioningpartner.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Androidprovisioningpartner Sample");
		...
		// Create authenticated Androidprovisioningpartner service
		return new Google_Service_Androidprovisioningpartner($client);
	} catch (Exception $e) {
