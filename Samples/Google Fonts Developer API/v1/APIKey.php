...
// About 
// 
// Unofficial sample for the webfonts v1 API for PHP. 
 ...
 * Initializes an Webfonts.v1 service object.
 * @param string API key
 * @return An authorized Webfonts.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Webfonts Sample");
		...
		// Create authenticated Webfonts service
		return new Google_Service_Webfonts($client);
	} catch (Exception $e) {
