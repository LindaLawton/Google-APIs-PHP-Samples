...
print_r(webfontsListExample($service));

/**
* Retrieves the list of fonts currently served by the Google Fonts Developer API
* @service Authenticated Webfonts service.
* @return WebfontList</returns>
*/
function webfontsListExample($service)
{
	try
	{
		...
		return $service->webfonts->ListWebfonts();
	}
	catch (Exception $ex)
	{
