...
$results = variablesTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function variablesTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->variables->TestIamPermissionsVariables($resource, $optParams);
	}
	catch (Exception $e)
	{
