...
print_r(variablesTestIamPermissionsExample($service, $resource));
...
*/
function variablesTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->variables->TestIamPermissionsVariables($resource);
	}
	catch (Exception $ex)
	{
