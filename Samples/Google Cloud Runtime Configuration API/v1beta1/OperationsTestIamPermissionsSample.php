...
print_r(operationsTestIamPermissionsExample($service, $resource));
...
*/
function operationsTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->operations->TestIamPermissionsOperations($resource);
	}
	catch (Exception $ex)
	{
