...
$results = variablesWatchExample($service, $name, $optParams);
...
* @return Variable
*/
function variablesWatchExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->variables->WatchVariables($name, $optParams);
	}
	catch (Exception $e)
	{
