...
// Single Request.
$results = waitersListExample($service, $parent, $optParams);
...
*/
function waitersListExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->waiters->ListWaiters($parent, $optParams);
	}
	catch (Exception $e)
	{
