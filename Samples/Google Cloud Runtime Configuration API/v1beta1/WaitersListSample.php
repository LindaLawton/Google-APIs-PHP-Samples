...
print_r(waitersListExample($service, $parent));
...
* @return ListWaitersResponse</returns>
*/
function waitersListExample($service, $parent)
{
	try
	{
		...
		return $service->waiters->ListWaiters($parent);
	}
	catch (Exception $ex)
	{
