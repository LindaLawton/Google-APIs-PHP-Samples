...
$results = variablesUpdateExample($service, $name, $optParams);
...
* @return Variable
*/
function variablesUpdateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->variables->UpdateVariables($name, $optParams);
	}
	catch (Exception $e)
	{
