...
// Single Request.
$results = variablesGetExample($service, $name, $optParams);
...
* @return Variable
*/
function variablesGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->variables->GetVariables($name, $optParams);
	}
	catch (Exception $e)
	{
