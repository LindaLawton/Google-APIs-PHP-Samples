...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'recursive' => '[YourValue]',  // Set to `true` to recursively delete multiple variables with the sameprefix.
  'fields' => '*'
);
// Single Request.
$results = variablesDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function variablesDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->variables->DeleteVariables($name, $optParams);
	}
	catch (Exception $e)
	{
