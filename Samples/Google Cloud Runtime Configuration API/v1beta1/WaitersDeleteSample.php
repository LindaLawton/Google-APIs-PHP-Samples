...
// Single Request.
$results = waitersDeleteExample($service, $name, $optParams);
...
* @return Empty
*/
function waitersDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->waiters->DeleteWaiters($name, $optParams);
	}
	catch (Exception $e)
	{
