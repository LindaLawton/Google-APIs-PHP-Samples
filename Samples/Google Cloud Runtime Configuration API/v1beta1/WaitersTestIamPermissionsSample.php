...
$results = waitersTestIamPermissionsExample($service, $resource, $optParams);
...
*/
function waitersTestIamPermissionsExample($service, $resource, $optParams)
{
	try
	{
		...
		return $service->waiters->TestIamPermissionsWaiters($resource, $optParams);
	}
	catch (Exception $e)
	{
