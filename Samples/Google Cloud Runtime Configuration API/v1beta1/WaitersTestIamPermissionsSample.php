...
print_r(waitersTestIamPermissionsExample($service, $resource));
...
*/
function waitersTestIamPermissionsExample($service, $resource)
{
	try
	{
		...
		return $service->waiters->TestIamPermissionsWaiters($resource);
	}
	catch (Exception $ex)
	{
