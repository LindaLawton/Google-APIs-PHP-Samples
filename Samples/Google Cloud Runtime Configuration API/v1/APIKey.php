...
// About 
// 
// Unofficial sample for the Cloud RuntimeConfig v1 API for PHP. 
...
//
// Discovery Doc  https://www.googleapis.com/discovery/v1/apis/runtimeconfig/v1/rest
//
//------------------------------------------------------------------------------
// Installation
//
 ...
 * Initializes an Cloudruntimeconfig.v1 service object.
 * @param string API key
 * @return An authorized Cloudruntimeconfig.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Cloudruntimeconfig Sample");
		...
		// Create authenticated Cloudruntimeconfig service
		return new Google_Service_Cloudruntimeconfig($client);
	} catch (Exception $e) {
