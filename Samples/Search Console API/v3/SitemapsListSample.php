...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'sitemapIndex' => '[YourValue]',  // A URL of a site's sitemap index. For example: http://www.example.com/sitemapindex.xml
  'fields' => '*'
);
// Single Request.
$results = sitemapsListExample($service, $siteUrl, $optParams);
...
*/
function sitemapsListExample($service, $siteUrl, $optParams)
{
	try
	{
		...
		return $service->sitemaps->ListSitemaps($siteUrl, $optParams);
	}
	catch (Exception $e)
	{
