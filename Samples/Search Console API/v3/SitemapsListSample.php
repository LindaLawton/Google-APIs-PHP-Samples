...
print_r(sitemapsListExample($service, $siteUrl));
...
* @return SitemapsListResponse</returns>
*/
function sitemapsListExample($service, $siteUrl)
{
	try
	{
		...
		return $service->sitemaps->ListSitemaps($siteUrl);
	}
	catch (Exception $ex)
	{
