...
$results = urlcrawlerrorssamplesMarkAsFixedExample($service, $siteUrl, $url, $category, $platform, $optParams);
...
*/
function urlcrawlerrorssamplesMarkAsFixedExample($service, $siteUrl, $url, $category, $platform, $optParams)
{
	try
	{
		...
		return $service->urlcrawlerrorssamples->MarkAsFixedUrlcrawlerrorssamples($siteUrl, $url, $category, $platform, $optParams);
	}
	catch (Exception $e)
	{
