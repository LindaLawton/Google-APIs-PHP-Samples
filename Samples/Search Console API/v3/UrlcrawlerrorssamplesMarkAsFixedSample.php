...
print_r(markAsFixed($service, $siteUrl, $url, $category, $platform));
...
*/
function markAsFixed($service, $siteUrl, $url, $category, $platform)
{
	try
	{
		...
		return $service->markAsFixed($siteUrl, $url, $category, $platform);
	}
	catch (Exception $ex)
	{
