...
print_r(urlcrawlerrorssamplesMarkAsFixedExample($service, $siteUrl, $url, $category, $platform));
...
*/
function urlcrawlerrorssamplesMarkAsFixedExample($service, $siteUrl, $url, $category, $platform)
{
	try
	{
		...
		return $service->urlcrawlerrorssamples->MarkAsFixedUrlcrawlerrorssamples($siteUrl, $url, $category, $platform);
	}
	catch (Exception $ex)
	{
