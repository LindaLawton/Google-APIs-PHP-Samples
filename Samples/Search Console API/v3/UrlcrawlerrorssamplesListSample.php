...
// Single Request.
$results = urlcrawlerrorssamplesListExample($service, $siteUrl, $category, $platform, $optParams);
...
* @return UrlCrawlErrorsSamplesListResponse
*/
function urlcrawlerrorssamplesListExample($service, $siteUrl, $category, $platform, $optParams)
{
	try
	{
		...
		return $service->urlcrawlerrorssamples->ListUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams);
	}
	catch (Exception $e)
	{
