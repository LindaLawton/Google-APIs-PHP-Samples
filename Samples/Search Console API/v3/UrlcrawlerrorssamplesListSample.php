...
print_r(urlcrawlerrorssamplesListExample($service, $siteUrl, $category, $platform));
...
* @return UrlCrawlErrorsSamplesListResponse</returns>
*/
function urlcrawlerrorssamplesListExample($service, $siteUrl, $category, $platform)
{
	try
	{
		...
		return $service->urlcrawlerrorssamples->ListUrlcrawlerrorssamples($siteUrl, $category, $platform);
	}
	catch (Exception $ex)
	{
