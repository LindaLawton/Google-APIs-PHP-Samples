...
# UnOfficial Search Console API v3 Samples for PHP
...
These samples show how to access the [Search Console API v3](https://developers.google.com/webmaster-tools/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
