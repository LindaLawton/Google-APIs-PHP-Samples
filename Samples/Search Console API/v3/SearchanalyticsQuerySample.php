...
print_r(searchanalyticsQueryExample($service, $siteUrl));
...
* @return SearchAnalyticsQueryResponse</returns>
*/
function searchanalyticsQueryExample($service, $siteUrl)
{
	try
	{
		...
		return $service->searchanalytics->QuerySearchanalytics($siteUrl);
	}
	catch (Exception $ex)
	{
