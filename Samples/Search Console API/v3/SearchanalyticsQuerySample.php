...
// Single Request.
$results = searchanalyticsQueryExample($service, $siteUrl, $optParams);
...
*/
function searchanalyticsQueryExample($service, $siteUrl, $optParams)
{
	try
	{
		...
		return $service->searchanalytics->QuerySearchanalytics($siteUrl, $optParams);
	}
	catch (Exception $e)
	{
