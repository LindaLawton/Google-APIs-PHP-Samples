...
print_r(urlcrawlerrorssamplesGetExample($service, $siteUrl, $url, $category, $platform));
...
* @return UrlCrawlErrorsSample</returns>
*/
function urlcrawlerrorssamplesGetExample($service, $siteUrl, $url, $category, $platform)
{
	try
	{
		...
		return $service->urlcrawlerrorssamples->GetUrlcrawlerrorssamples($siteUrl, $url, $category, $platform);
	}
	catch (Exception $ex)
	{
