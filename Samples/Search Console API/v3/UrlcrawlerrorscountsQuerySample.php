...
print_r(urlcrawlerrorscountsQueryExample($service, $siteUrl));
...
* @return UrlCrawlErrorsCountsQueryResponse</returns>
*/
function urlcrawlerrorscountsQueryExample($service, $siteUrl)
{
	try
	{
		...
		return $service->urlcrawlerrorscounts->QueryUrlcrawlerrorscounts($siteUrl);
	}
	catch (Exception $ex)
	{
