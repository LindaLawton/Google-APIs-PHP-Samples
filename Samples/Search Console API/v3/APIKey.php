 ...
 * Initializes an Webmasters.v3 service object.
 * @param string API key
 * @return An authorized Webmasters.v3 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Webmasters Sample");
		...
		// Create authenticated Webmasters service
