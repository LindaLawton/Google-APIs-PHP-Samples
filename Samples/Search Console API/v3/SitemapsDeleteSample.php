...
print_r(sitemapsDeleteExample($service, $siteUrl, $feedpath));
...
*/
function sitemapsDeleteExample($service, $siteUrl, $feedpath)
{
	try
	{
		...
		return $service->sitemaps->DeleteSitemaps($siteUrl, $feedpath);
	}
	catch (Exception $ex)
	{
