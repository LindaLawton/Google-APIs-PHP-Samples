...
$results = sitemapsSubmitExample($service, $siteUrl, $feedpath, $optParams);
...
*/
function sitemapsSubmitExample($service, $siteUrl, $feedpath, $optParams)
{
	try
	{
		...
		return $service->sitemaps->SubmitSitemaps($siteUrl, $feedpath, $optParams);
	}
	catch (Exception $e)
	{
