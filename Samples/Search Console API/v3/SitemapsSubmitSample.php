...
print_r(sitemapsSubmitExample($service, $siteUrl, $feedpath));
...
*/
function sitemapsSubmitExample($service, $siteUrl, $feedpath)
{
	try
	{
		...
		return $service->sitemaps->SubmitSitemaps($siteUrl, $feedpath);
	}
	catch (Exception $ex)
	{
