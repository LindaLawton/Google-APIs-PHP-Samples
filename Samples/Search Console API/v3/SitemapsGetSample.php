...
$results = sitemapsGetExample($service, $siteUrl, $feedpath, $optParams);
...
* @return WmxSitemap
*/
function sitemapsGetExample($service, $siteUrl, $feedpath, $optParams)
{
	try
	{
		...
		return $service->sitemaps->GetSitemaps($siteUrl, $feedpath, $optParams);
	}
	catch (Exception $e)
	{
