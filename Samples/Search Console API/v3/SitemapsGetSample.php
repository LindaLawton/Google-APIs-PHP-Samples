...
print_r(sitemapsGetExample($service, $siteUrl, $feedpath));
...
* @return WmxSitemap</returns>
*/
function sitemapsGetExample($service, $siteUrl, $feedpath)
{
	try
	{
		...
		return $service->sitemaps->GetSitemaps($siteUrl, $feedpath);
	}
	catch (Exception $ex)
	{
