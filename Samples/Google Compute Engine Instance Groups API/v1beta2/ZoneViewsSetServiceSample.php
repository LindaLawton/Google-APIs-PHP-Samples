...
print_r(setService($service, $project, $zone, $resourceView));
...
*/
function setService($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->setService($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
