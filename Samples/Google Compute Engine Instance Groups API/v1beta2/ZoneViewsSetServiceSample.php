...
* @return Operation
*/
function zoneViewsSetServiceExample($service, $project, $zone, $resourceView, $optParams)
{
	try
	{
		...
		return $service->zoneViews->SetServiceZoneViews($project, $zone, $resourceView, $optParams);
	}
	catch (Exception $e)
	{
