...
print_r(zoneViewsSetServiceExample($service, $project, $zone, $resourceView));
...
*/
function zoneViewsSetServiceExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->SetServiceZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
