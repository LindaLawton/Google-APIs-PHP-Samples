...
# UnOfficial Google Compute Engine Instance Groups API v1beta2 Samples for PHP

## API Description

The Resource View API allows users to create and manage logical sets of Google Compute Engine instances.

[Official Documentation](https://developers.google.com/compute/)

## Sample Description

These samples show how to access the [Google Compute Engine Instance Groups API v1beta2](https://developers.google.com/compute/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
