...
// Single Request.
$results = zoneViewsListExample($service, $project, $zone, $optParams);
...
* @return ZoneViewsList
*/
function zoneViewsListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->zoneViews->ListZoneViews($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
