...
print_r(zoneViewsListExample($service, $project, $zone));
...
* @return ZoneViewsList</returns>
*/
function zoneViewsListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->zoneViews->ListZoneViews($project, $zone);
	}
	catch (Exception $ex)
	{
