...
print_r(zoneViewsAddResourcesExample($service, $project, $zone, $resourceView));
...
*/
function zoneViewsAddResourcesExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->AddResourcesZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
