...
// Single Request.
$results = zoneViewsAddResourcesExample($service, $project, $zone, $resourceView, $optParams);
...
* @return Operation
*/
function zoneViewsAddResourcesExample($service, $project, $zone, $resourceView, $optParams)
{
	try
	{
		...
		return $service->zoneViews->AddResourcesZoneViews($project, $zone, $resourceView, $optParams);
	}
	catch (Exception $e)
	{
