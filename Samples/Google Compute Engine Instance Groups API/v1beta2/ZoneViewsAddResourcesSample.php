...
print_r(addResources($service, $project, $zone, $resourceView));
...
*/
function addResources($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->addResources($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
