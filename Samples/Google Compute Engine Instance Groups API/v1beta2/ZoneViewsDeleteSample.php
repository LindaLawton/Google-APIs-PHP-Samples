...
print_r(zoneViewsDeleteExample($service, $project, $zone, $resourceView));
...
*/
function zoneViewsDeleteExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->DeleteZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
