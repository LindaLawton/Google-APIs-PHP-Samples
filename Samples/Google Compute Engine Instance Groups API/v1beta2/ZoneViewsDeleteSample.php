...
// Single Request.
$results = zoneViewsDeleteExample($service, $project, $zone, $resourceView, $optParams);
...
* @return Operation
*/
function zoneViewsDeleteExample($service, $project, $zone, $resourceView, $optParams)
{
	try
	{
		...
		return $service->zoneViews->DeleteZoneViews($project, $zone, $resourceView, $optParams);
	}
	catch (Exception $e)
	{
