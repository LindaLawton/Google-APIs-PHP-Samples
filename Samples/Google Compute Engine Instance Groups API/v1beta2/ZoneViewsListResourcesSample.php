...
print_r(listResources($service, $project, $zone, $resourceView));
...
*/
function listResources($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->listResources($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
