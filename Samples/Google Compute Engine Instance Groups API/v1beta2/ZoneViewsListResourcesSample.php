...
print_r(zoneViewsListResourcesExample($service, $project, $zone, $resourceView));
...
* @return ZoneViewsListResourcesResponse</returns>
*/
function zoneViewsListResourcesExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->ListResourcesZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
