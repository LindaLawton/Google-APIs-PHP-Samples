...
print_r(getService($service, $project, $zone, $resourceView));
...
*/
function getService($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->getService($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
