...
print_r(zoneViewsGetServiceExample($service, $project, $zone, $resourceView));
...
* @return ZoneViewsGetServiceResponse</returns>
*/
function zoneViewsGetServiceExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->GetServiceZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
