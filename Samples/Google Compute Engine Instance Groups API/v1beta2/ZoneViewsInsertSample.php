...
// Single Request.
$results = zoneViewsInsertExample($service, $project, $zone, $optParams);
...
* @return Operation
*/
function zoneViewsInsertExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->zoneViews->InsertZoneViews($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
