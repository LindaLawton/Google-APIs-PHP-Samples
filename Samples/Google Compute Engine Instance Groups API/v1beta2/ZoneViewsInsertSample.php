...
print_r(zoneViewsInsertExample($service, $project, $zone));
...
*/
function zoneViewsInsertExample($service, $project, $zone)
{
	try
	{
		...
		return $service->zoneViews->InsertZoneViews($project, $zone);
	}
	catch (Exception $ex)
	{
