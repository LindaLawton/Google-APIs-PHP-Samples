...
print_r(zoneViewsRemoveResourcesExample($service, $project, $zone, $resourceView));
...
*/
function zoneViewsRemoveResourcesExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->RemoveResourcesZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
