...
$results = zoneViewsRemoveResourcesExample($service, $project, $zone, $resourceView, $optParams);
...
* @return Operation
*/
function zoneViewsRemoveResourcesExample($service, $project, $zone, $resourceView, $optParams)
{
	try
	{
		...
		return $service->zoneViews->RemoveResourcesZoneViews($project, $zone, $resourceView, $optParams);
	}
	catch (Exception $e)
	{
