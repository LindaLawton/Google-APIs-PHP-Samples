...
print_r(removeResources($service, $project, $zone, $resourceView));
...
*/
function removeResources($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->removeResources($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
