...
print_r(zoneViewsGetExample($service, $project, $zone, $resourceView));
...
* @return ResourceView</returns>
*/
function zoneViewsGetExample($service, $project, $zone, $resourceView)
{
	try
	{
		...
		return $service->zoneViews->GetZoneViews($project, $zone, $resourceView);
	}
	catch (Exception $ex)
	{
