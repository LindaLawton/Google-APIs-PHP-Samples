...
$results = zoneViewsGetExample($service, $project, $zone, $resourceView, $optParams);
...
* @return ResourceView
*/
function zoneViewsGetExample($service, $project, $zone, $resourceView, $optParams)
{
	try
	{
		...
		return $service->zoneViews->GetZoneViews($project, $zone, $resourceView, $optParams);
	}
	catch (Exception $e)
	{
