...
// Single Request.
$results = deploymentsListExample($service, $project, $optParams);
...
*/
function deploymentsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->deployments->ListDeployments($project, $optParams);
	}
	catch (Exception $e)
	{
