...
print_r(deploymentsListExample($service, $project));

/**
* Lists all deployments for a given project.
* @service Authenticated Deploymentmanager service.
* @project The project ID for this request.
* @return DeploymentsListResponse</returns>
*/
function deploymentsListExample($service, $project)
{
	try
	{
		...
		return $service->deployments->ListDeployments($project);
	}
	catch (Exception $ex)
	{
