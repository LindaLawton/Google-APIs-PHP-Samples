...
// Single Request.
$results = operationsGetExample($service, $project, $operation, $optParams);
...
* @return Operation
*/
function operationsGetExample($service, $project, $operation, $optParams)
{
	try
	{
		...
		return $service->operations->GetOperations($project, $operation, $optParams);
	}
	catch (Exception $e)
	{
