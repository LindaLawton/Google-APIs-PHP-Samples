...
print_r(operationsGetExample($service, $project, $operation));
...
*/
function operationsGetExample($service, $project, $operation)
{
	try
	{
		...
		return $service->operations->GetOperations($project, $operation);
	}
	catch (Exception $ex)
	{
