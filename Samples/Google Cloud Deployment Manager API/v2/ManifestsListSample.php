...
print_r(manifestsListExample($service, $project, $deployment));
...
* @return ManifestsListResponse</returns>
*/
function manifestsListExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->manifests->ListManifests($project, $deployment);
	}
	catch (Exception $ex)
	{
