...
// Single Request.
$results = manifestsListExample($service, $project, $deployment, $optParams);
...
do {
	...
	$results = filesListExample($service, $project, $deployment, $optParams);	
...
*/
function manifestsListExample($service, $project, $deployment, $optParams)
{
	try
	{
		...
		return $service->manifests->ListManifests($project, $deployment, $optParams);
	}
	catch (Exception $e)
	{
