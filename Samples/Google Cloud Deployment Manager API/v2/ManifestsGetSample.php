...
print_r(manifestsGetExample($service, $project, $deployment, $manifest));
...
*/
function manifestsGetExample($service, $project, $deployment, $manifest)
{
	try
	{
		...
		return $service->manifests->GetManifests($project, $deployment, $manifest);
	}
	catch (Exception $ex)
	{
