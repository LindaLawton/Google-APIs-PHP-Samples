...
// About 
// 
// Unofficial sample for the Deployment Manager v2 API for PHP. 
...
// Single Request.
$results = manifestsGetExample($service, $project, $deployment, $manifest, $optParams);


/**
* Gets information about a specific manifest.
* @service Authenticated Deploymentmanager service.
...
* @return Manifest
*/
function manifestsGetExample($service, $project, $deployment, $manifest, $optParams)
{
	try
	{
		...
		if (manifest == null)
			throw new Exception("manifest is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->manifests->GetManifests($project, $deployment, $manifest, $optParams);
	}
	catch (Exception $e)
	{
