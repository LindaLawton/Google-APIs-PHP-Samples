...
print_r(deploymentsUpdateExample($service, $project, $deployment));
...
*/
function deploymentsUpdateExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->deployments->UpdateDeployments($project, $deployment);
	}
	catch (Exception $ex)
	{
