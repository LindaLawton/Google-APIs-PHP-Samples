...
print_r(operationsListExample($service, $project));

/**
* Lists all operations for a project.
* @service Authenticated Deploymentmanager service.
* @project The project ID for this request.
* @return OperationsListResponse</returns>
*/
function operationsListExample($service, $project)
{
	try
	{
		...
		return $service->operations->ListOperations($project);
	}
	catch (Exception $ex)
	{
