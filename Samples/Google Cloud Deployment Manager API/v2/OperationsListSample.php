...
$results = operationsListExample($service, $project, $optParams);
...
*/
function operationsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->operations->ListOperations($project, $optParams);
	}
	catch (Exception $e)
	{
