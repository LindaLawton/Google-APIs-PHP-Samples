...
print_r(deploymentsGetExample($service, $project, $deployment));
...
* @return Deployment</returns>
*/
function deploymentsGetExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->deployments->GetDeployments($project, $deployment);
	}
	catch (Exception $ex)
	{
