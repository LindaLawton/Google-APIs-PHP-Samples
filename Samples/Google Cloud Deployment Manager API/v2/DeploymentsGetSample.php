...
// Single Request.
$results = deploymentsGetExample($service, $project, $deployment, $optParams);
...
* @return Deployment
*/
function deploymentsGetExample($service, $project, $deployment, $optParams)
{
	try
	{
		...
		return $service->deployments->GetDeployments($project, $deployment, $optParams);
	}
	catch (Exception $e)
	{
