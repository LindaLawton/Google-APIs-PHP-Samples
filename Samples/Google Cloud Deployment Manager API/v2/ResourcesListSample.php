...
print_r(resourcesListExample($service, $project, $deployment));
...
* @return ResourcesListResponse</returns>
*/
function resourcesListExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->resources->ListResources($project, $deployment);
	}
	catch (Exception $ex)
	{
