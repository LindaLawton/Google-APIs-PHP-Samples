...
print_r(typesListExample($service, $project));

/**
* Lists all resource types for Deployment Manager.
* @service Authenticated Deploymentmanager service.
* @project The project ID for this request.
* @return TypesListResponse</returns>
*/
function typesListExample($service, $project)
{
	try
	{
		...
		return $service->types->ListTypes($project);
	}
	catch (Exception $ex)
	{
