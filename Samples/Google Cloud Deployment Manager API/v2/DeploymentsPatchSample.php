...
print_r(deploymentsPatchExample($service, $project, $deployment));
...
*/
function deploymentsPatchExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->deployments->PatchDeployments($project, $deployment);
	}
	catch (Exception $ex)
	{
