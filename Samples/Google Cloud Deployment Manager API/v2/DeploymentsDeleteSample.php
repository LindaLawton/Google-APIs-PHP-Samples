...
print_r(deploymentsDeleteExample($service, $project, $deployment));
...
*/
function deploymentsDeleteExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->deployments->DeleteDeployments($project, $deployment);
	}
	catch (Exception $ex)
	{
