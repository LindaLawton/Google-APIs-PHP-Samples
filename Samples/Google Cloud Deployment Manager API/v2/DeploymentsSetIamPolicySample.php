...
print_r(deploymentsSetIamPolicyExample($service, $project, $resource));
...
*/
function deploymentsSetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->deployments->SetIamPolicyDeployments($project, $resource);
	}
	catch (Exception $ex)
	{
