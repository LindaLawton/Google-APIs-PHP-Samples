...
$results = deploymentsCancelPreviewExample($service, $project, $deployment, $optParams);
...
* @return Operation
*/
function deploymentsCancelPreviewExample($service, $project, $deployment, $optParams)
{
	try
	{
		...
		return $service->deployments->CancelPreviewDeployments($project, $deployment, $optParams);
	}
	catch (Exception $e)
	{
