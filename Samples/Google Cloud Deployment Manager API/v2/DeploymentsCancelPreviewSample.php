...
print_r(deploymentsCancelPreviewExample($service, $project, $deployment));
...
*/
function deploymentsCancelPreviewExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->deployments->CancelPreviewDeployments($project, $deployment);
	}
	catch (Exception $ex)
	{
