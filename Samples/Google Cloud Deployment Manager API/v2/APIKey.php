 ...
 * Initializes an Deploymentmanager.v2 service object.
 * @param string API key
 * @return An authorized Deploymentmanager.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Deploymentmanager Sample");
		...
		// Create authenticated Deploymentmanager service
		return new Google_Service_Deploymentmanager($client);
	} catch (Exception $e) {
