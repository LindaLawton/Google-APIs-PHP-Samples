...
print_r(resourcesGetExample($service, $project, $deployment, $resource));
...
* @return Resource</returns>
*/
function resourcesGetExample($service, $project, $deployment, $resource)
{
	try
	{
		...
		return $service->resources->GetResources($project, $deployment, $resource);
	}
	catch (Exception $ex)
	{
