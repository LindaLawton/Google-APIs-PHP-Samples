...
$results = deploymentsGetIamPolicyExample($service, $project, $resource, $optParams);
...
* @return Policy
*/
function deploymentsGetIamPolicyExample($service, $project, $resource, $optParams)
{
	try
	{
		...
		return $service->deployments->GetIamPolicyDeployments($project, $resource, $optParams);
	}
	catch (Exception $e)
	{
