...
print_r(deploymentsGetIamPolicyExample($service, $project, $resource));
...
*/
function deploymentsGetIamPolicyExample($service, $project, $resource)
{
	try
	{
		...
		return $service->deployments->GetIamPolicyDeployments($project, $resource);
	}
	catch (Exception $ex)
	{
