...
$results = deploymentsStopExample($service, $project, $deployment, $optParams);
...
* @return Operation
*/
function deploymentsStopExample($service, $project, $deployment, $optParams)
{
	try
	{
		...
		return $service->deployments->StopDeployments($project, $deployment, $optParams);
	}
	catch (Exception $e)
	{
