...
print_r(deploymentsStopExample($service, $project, $deployment));
...
*/
function deploymentsStopExample($service, $project, $deployment)
{
	try
	{
		...
		return $service->deployments->StopDeployments($project, $deployment);
	}
	catch (Exception $ex)
	{
