...
// Single Request.
$results = relyingpartyGetAccountInfoExample($service, $optParams);
...
*/
function relyingpartyGetAccountInfoExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->GetAccountInfoRelyingparty($optParams);
	}
	catch (Exception $e)
	{
