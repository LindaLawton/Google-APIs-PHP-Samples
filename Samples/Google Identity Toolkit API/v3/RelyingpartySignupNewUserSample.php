...
print_r(relyingpartySignupNewUserExample($service));

/**
* Signup new user.
* @service Authenticated Identitytoolkit service.
* @return SignupNewUserResponse</returns>
*/
function relyingpartySignupNewUserExample($service)
{
	try
	{
		...
		return $service->relyingparty->SignupNewUserRelyingparty();
	}
	catch (Exception $ex)
	{
