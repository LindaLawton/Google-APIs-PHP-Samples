...
// Single Request.
$results = relyingpartySignupNewUserExample($service, $optParams);
...
*/
function relyingpartySignupNewUserExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->SignupNewUserRelyingparty($optParams);
	}
	catch (Exception $e)
	{
