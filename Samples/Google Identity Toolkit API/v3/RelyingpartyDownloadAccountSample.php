...
$results = relyingpartyDownloadAccountExample($service, $optParams);
...
*/
function relyingpartyDownloadAccountExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->DownloadAccountRelyingparty($optParams);
	}
	catch (Exception $e)
	{
