...
// Single Request.
$results = relyingpartyVerifyCustomTokenExample($service, $optParams);
...
*/
function relyingpartyVerifyCustomTokenExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->VerifyCustomTokenRelyingparty($optParams);
	}
	catch (Exception $e)
	{
