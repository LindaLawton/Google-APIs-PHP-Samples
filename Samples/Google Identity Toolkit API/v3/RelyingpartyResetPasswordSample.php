...
print_r(relyingpartyResetPasswordExample($service));

/**
* Reset password for a user.
* @service Authenticated Identitytoolkit service.
* @return ResetPasswordResponse</returns>
*/
function relyingpartyResetPasswordExample($service)
{
	try
	{
		...
		return $service->relyingparty->ResetPasswordRelyingparty();
	}
	catch (Exception $ex)
	{
