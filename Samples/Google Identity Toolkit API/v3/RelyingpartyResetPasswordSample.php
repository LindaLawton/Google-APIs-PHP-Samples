...
$results = relyingpartyResetPasswordExample($service, $optParams);
...
*/
function relyingpartyResetPasswordExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->ResetPasswordRelyingparty($optParams);
	}
	catch (Exception $e)
	{
