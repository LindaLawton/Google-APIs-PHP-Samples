...
print_r(relyingpartyDeleteAccountExample($service));

/**
* Delete user account.
* @service Authenticated Identitytoolkit service.
* @return DeleteAccountResponse</returns>
*/
function relyingpartyDeleteAccountExample($service)
{
	try
	{
		...
		return $service->relyingparty->DeleteAccountRelyingparty();
	}
	catch (Exception $ex)
	{
