...
$results = relyingpartyDeleteAccountExample($service, $optParams);
...
*/
function relyingpartyDeleteAccountExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->DeleteAccountRelyingparty($optParams);
	}
	catch (Exception $e)
	{
