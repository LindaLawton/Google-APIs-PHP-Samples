...
# UnOfficial Google Identity Toolkit API v3 Samples for PHP

## API Description

Help the third party sites to implement federated login.

[Official Documentation](https://developers.google.com/identity-toolkit/v3/)

## Sample Description

These samples show how to access the [Google Identity Toolkit API v3](https://developers.google.com/identity-toolkit/v3/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
