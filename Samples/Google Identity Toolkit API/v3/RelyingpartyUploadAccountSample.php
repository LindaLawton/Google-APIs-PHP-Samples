...
// Single Request.
$results = relyingpartyUploadAccountExample($service, $optParams);
...
*/
function relyingpartyUploadAccountExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->UploadAccountRelyingparty($optParams);
	}
	catch (Exception $e)
	{
