...
print_r(relyingpartyUploadAccountExample($service));

/**
* Batch upload existing user accounts.
* @service Authenticated Identitytoolkit service.
* @return UploadAccountResponse</returns>
*/
function relyingpartyUploadAccountExample($service)
{
	try
	{
		...
		return $service->relyingparty->UploadAccountRelyingparty();
	}
	catch (Exception $ex)
	{
