 ...
 * Initializes an Identitytoolkit.v3 service object.
 * @param string API key
 * @return An authorized Identitytoolkit.v3 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Identitytoolkit Sample");
		...
		// Create authenticated Identitytoolkit service
		return new Google_Service_Identitytoolkit($client);
	} catch (Exception $e) {
