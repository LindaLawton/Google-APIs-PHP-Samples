...
// Single Request.
$results = relyingpartyVerifyAssertionExample($service, $optParams);
...
*/
function relyingpartyVerifyAssertionExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->VerifyAssertionRelyingparty($optParams);
	}
	catch (Exception $e)
	{
