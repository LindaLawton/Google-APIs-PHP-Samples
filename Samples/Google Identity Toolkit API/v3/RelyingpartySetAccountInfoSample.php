...
// Single Request.
$results = relyingpartySetAccountInfoExample($service, $optParams);
...
*/
function relyingpartySetAccountInfoExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->SetAccountInfoRelyingparty($optParams);
	}
	catch (Exception $e)
	{
