...
$results = relyingpartySignOutUserExample($service, $optParams);
...
*/
function relyingpartySignOutUserExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->SignOutUserRelyingparty($optParams);
	}
	catch (Exception $e)
	{
