...
// Single Request.
$results = relyingpartyGetPublicKeysExample($service, $optParams);
...
*/
function relyingpartyGetPublicKeysExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->GetPublicKeysRelyingparty($optParams);
	}
	catch (Exception $e)
	{
