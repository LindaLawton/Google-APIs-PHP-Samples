...
$results = relyingpartySendVerificationCodeExample($service, $optParams);
...
*/
function relyingpartySendVerificationCodeExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->SendVerificationCodeRelyingparty($optParams);
	}
	catch (Exception $e)
	{
