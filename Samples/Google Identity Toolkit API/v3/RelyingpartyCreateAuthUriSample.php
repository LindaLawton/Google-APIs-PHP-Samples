...
// Single Request.
$results = relyingpartyCreateAuthUriExample($service, $optParams);
...
*/
function relyingpartyCreateAuthUriExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->CreateAuthUriRelyingparty($optParams);
	}
	catch (Exception $e)
	{
