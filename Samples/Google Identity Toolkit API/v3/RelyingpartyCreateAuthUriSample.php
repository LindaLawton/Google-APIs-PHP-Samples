...
print_r(relyingpartyCreateAuthUriExample($service));

/**
* Creates the URI used by the IdP to authenticate the user.
* @service Authenticated Identitytoolkit service.
* @return CreateAuthUriResponse</returns>
*/
function relyingpartyCreateAuthUriExample($service)
{
	try
	{
		...
		return $service->relyingparty->CreateAuthUriRelyingparty();
	}
	catch (Exception $ex)
	{
