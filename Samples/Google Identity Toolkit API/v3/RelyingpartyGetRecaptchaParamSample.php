...
// Single Request.
$results = relyingpartyGetRecaptchaParamExample($service, $optParams);
...
*/
function relyingpartyGetRecaptchaParamExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->GetRecaptchaParamRelyingparty($optParams);
	}
	catch (Exception $e)
	{
