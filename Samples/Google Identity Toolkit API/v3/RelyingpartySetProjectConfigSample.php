...
$results = relyingpartySetProjectConfigExample($service, $optParams);
...
*/
function relyingpartySetProjectConfigExample($service, $optParams)
{
	try
	{
		...
		return $service->relyingparty->SetProjectConfigRelyingparty($optParams);
	}
	catch (Exception $e)
	{
