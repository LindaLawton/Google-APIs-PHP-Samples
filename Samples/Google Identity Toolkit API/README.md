...
# Unoffical Google Identity Toolkit API Samples for PHP
...
These samples show how to access the [Google Identity Toolkit API](https://developers.google.com/identity-toolkit/v3/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
