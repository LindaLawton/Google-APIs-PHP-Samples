...
# UnOfficial Google OAuth2 API v2 Samples for PHP

## API Description

Obtains end-user authorization grants for use with other Google APIs.

[Official Documentation](https://developers.google.com/accounts/docs/OAuth2)

## Sample Description

These samples show how to access the [Google OAuth2 API v2](https://developers.google.com/accounts/docs/OAuth2) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
