...
// About 
// 
// Unofficial sample for the Oauth2 v2 API for PHP. 
 ...
 * Initializes an Oauth2.v2 service object.
 * @return An authorized Oauth2.v2 service object.
 */
function getAuthenticateOAuth2() {
	try {
		$client = new Google_Client();
		$client->setAuthConfig(__DIR__ . '/client_secrets.json');
		$client->addScope(Google_Service_Oauth2::ANALYTICS_READONLY);
