...
# UnOfficial Google OAuth2 API v1 Samples for PHP
...
These samples show how to access the [Google OAuth2 API v1](https://developers.google.com/accounts/docs/OAuth2) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
