...
# Unoffical Google OAuth2 API Samples for PHP
...
These samples show how to access the [Google OAuth2 API](https://developers.google.com/accounts/docs/OAuth2) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
