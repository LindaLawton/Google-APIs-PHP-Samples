 ...
 * Initializes an Replicapool.v1beta2 service object.
 * @param string API key
 * @return An authorized Replicapool.v1beta2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Replicapool Sample");
		...
		// Create authenticated Replicapool service
		return new Google_Service_Replicapool($client);
	} catch (Exception $e) {
