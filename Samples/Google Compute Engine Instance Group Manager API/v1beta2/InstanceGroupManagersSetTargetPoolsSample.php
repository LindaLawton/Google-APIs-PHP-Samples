...
print_r(setTargetPools($service, $project, $zone, $instanceGroupManager));
...
*/
function setTargetPools($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->setTargetPools($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
