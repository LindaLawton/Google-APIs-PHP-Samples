...
print_r(instanceGroupManagersGetExample($service, $project, $zone, $instanceGroupManager));
...
* @return InstanceGroupManager</returns>
*/
function instanceGroupManagersGetExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->GetInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
