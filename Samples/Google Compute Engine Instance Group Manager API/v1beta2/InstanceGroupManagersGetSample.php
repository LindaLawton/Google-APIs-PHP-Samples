...
// Single Request.
$results = instanceGroupManagersGetExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
*/
function instanceGroupManagersGetExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->GetInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
