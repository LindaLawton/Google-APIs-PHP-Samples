...
print_r(get($service, $project, $zone, $instanceGroupManager));
...
*/
function get($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->get($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
