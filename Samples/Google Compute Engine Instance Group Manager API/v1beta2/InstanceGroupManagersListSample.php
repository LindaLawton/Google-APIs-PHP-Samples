...
print_r(instanceGroupManagersListExample($service, $project, $zone));
...
* @return InstanceGroupManagerList</returns>
*/
function instanceGroupManagersListExample($service, $project, $zone)
{
	try
	{
		...
		return $service->instanceGroupManagers->ListInstanceGroupManagers($project, $zone);
	}
	catch (Exception $ex)
	{
