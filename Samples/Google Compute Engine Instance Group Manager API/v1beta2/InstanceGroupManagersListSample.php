...
// Single Request.
$results = instanceGroupManagersListExample($service, $project, $zone, $optParams);
...
*/
function instanceGroupManagersListExample($service, $project, $zone, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->ListInstanceGroupManagers($project, $zone, $optParams);
	}
	catch (Exception $e)
	{
