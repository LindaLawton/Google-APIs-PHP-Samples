...
print_r(recreateInstances($service, $project, $zone, $instanceGroupManager));
...
*/
function recreateInstances($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->recreateInstances($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
