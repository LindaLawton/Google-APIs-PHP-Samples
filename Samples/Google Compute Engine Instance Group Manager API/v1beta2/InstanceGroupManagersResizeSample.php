...
print_r(instanceGroupManagersResizeExample($service, $project, $zone, $instanceGroupManager, $size));
...
*/
function instanceGroupManagersResizeExample($service, $project, $zone, $instanceGroupManager, $size)
{
	try
	{
		...
		return $service->instanceGroupManagers->ResizeInstanceGroupManagers($project, $zone, $instanceGroupManager, $size);
	}
	catch (Exception $ex)
	{
