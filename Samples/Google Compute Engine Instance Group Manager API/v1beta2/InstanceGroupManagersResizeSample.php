...
print_r(resize($service, $project, $zone, $instanceGroupManager, $size));
...
*/
function resize($service, $project, $zone, $instanceGroupManager, $size)
{
	try
	{
		...
		return $service->resize($project, $zone, $instanceGroupManager, $size);
	}
	catch (Exception $ex)
	{
