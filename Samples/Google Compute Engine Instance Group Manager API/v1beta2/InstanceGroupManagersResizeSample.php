...
// Single Request.
$results = instanceGroupManagersResizeExample($service, $project, $zone, $instanceGroupManager, $size, $optParams);
...
* @return Operation
*/
function instanceGroupManagersResizeExample($service, $project, $zone, $instanceGroupManager, $size, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->ResizeInstanceGroupManagers($project, $zone, $instanceGroupManager, $size, $optParams);
	}
	catch (Exception $e)
	{
