...
print_r(instanceGroupManagersDeleteExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersDeleteExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->DeleteInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
