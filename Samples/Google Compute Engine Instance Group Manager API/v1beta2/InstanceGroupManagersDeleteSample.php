...
print_r(delete($service, $project, $zone, $instanceGroupManager));
...
*/
function delete($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->delete($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
