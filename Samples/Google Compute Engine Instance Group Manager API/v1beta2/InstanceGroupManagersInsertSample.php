...
// Single Request.
$results = instanceGroupManagersInsertExample($service, $project, $zone, $size, $optParams);
...
* @return Operation
*/
function instanceGroupManagersInsertExample($service, $project, $zone, $size, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->InsertInstanceGroupManagers($project, $zone, $size, $optParams);
	}
	catch (Exception $e)
	{
