...
print_r(instanceGroupManagersInsertExample($service, $project, $zone, $size));
...
*/
function instanceGroupManagersInsertExample($service, $project, $zone, $size)
{
	try
	{
		...
		return $service->instanceGroupManagers->InsertInstanceGroupManagers($project, $zone, $size);
	}
	catch (Exception $ex)
	{
