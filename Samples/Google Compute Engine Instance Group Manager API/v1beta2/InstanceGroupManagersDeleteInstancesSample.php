...
// Single Request.
$results = instanceGroupManagersDeleteInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function instanceGroupManagersDeleteInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->DeleteInstancesInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
