...
print_r(deleteInstances($service, $project, $zone, $instanceGroupManager));
...
*/
function deleteInstances($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->deleteInstances($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
