...
print_r(instanceGroupManagersAbandonInstancesExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersAbandonInstancesExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->AbandonInstancesInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
