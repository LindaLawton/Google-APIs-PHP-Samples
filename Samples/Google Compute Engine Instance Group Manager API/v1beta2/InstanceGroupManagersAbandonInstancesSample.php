...
// Single Request.
$results = instanceGroupManagersAbandonInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function instanceGroupManagersAbandonInstancesExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->AbandonInstancesInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
