...
// Single Request.
$results = instanceGroupManagersSetInstanceTemplateExample($service, $project, $zone, $instanceGroupManager, $optParams);
...
* @return Operation
*/
function instanceGroupManagersSetInstanceTemplateExample($service, $project, $zone, $instanceGroupManager, $optParams)
{
	try
	{
		...
		return $service->instanceGroupManagers->SetInstanceTemplateInstanceGroupManagers($project, $zone, $instanceGroupManager, $optParams);
	}
	catch (Exception $e)
	{
