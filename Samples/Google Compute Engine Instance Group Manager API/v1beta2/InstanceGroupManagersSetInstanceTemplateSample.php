...
print_r(instanceGroupManagersSetInstanceTemplateExample($service, $project, $zone, $instanceGroupManager));
...
*/
function instanceGroupManagersSetInstanceTemplateExample($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->instanceGroupManagers->SetInstanceTemplateInstanceGroupManagers($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
