...
print_r(setInstanceTemplate($service, $project, $zone, $instanceGroupManager));
...
*/
function setInstanceTemplate($service, $project, $zone, $instanceGroupManager)
{
	try
	{
		...
		return $service->setInstanceTemplate($project, $zone, $instanceGroupManager);
	}
	catch (Exception $ex)
	{
