 ...
 * Initializes an Tasks.v1 service object.
 * @param string API key
 * @return An authorized Tasks.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Tasks Sample");
		...
		// Create authenticated Tasks service
		return new Google_Service_Tasks($client);
	} catch (Exception $e) {
