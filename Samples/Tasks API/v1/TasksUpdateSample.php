...
// Single Request.
$results = tasksUpdateExample($service, $tasklist, $task, $optParams);
...
* @return Task
*/
function tasksUpdateExample($service, $tasklist, $task, $optParams)
{
	try
	{
		...
		return $service->tasks->UpdateTasks($tasklist, $task, $optParams);
	}
	catch (Exception $e)
	{
