...
// Single Request.
$results = tasksPatchExample($service, $tasklist, $task, $optParams);
...
* @return Task
*/
function tasksPatchExample($service, $tasklist, $task, $optParams)
{
	try
	{
		...
		return $service->tasks->PatchTasks($tasklist, $task, $optParams);
	}
	catch (Exception $e)
	{
