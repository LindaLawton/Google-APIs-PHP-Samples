...
print_r(tasklistsUpdateExample($service, $tasklist));

/**
* Updates the authenticated user's specified task list.
* @service Authenticated Tasks service.
* @tasklist Task list identifier.
* @return TaskList</returns>
*/
function tasklistsUpdateExample($service, $tasklist)
{
	try
	{
		...
		return $service->tasklists->UpdateTasklists($tasklist);
	}
	catch (Exception $ex)
	{
