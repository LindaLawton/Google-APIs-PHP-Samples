...
// Single Request.
$results = tasklistsUpdateExample($service, $tasklist, $optParams);
...
* @return TaskList
*/
function tasklistsUpdateExample($service, $tasklist, $optParams)
{
	try
	{
		...
		return $service->tasklists->UpdateTasklists($tasklist, $optParams);
	}
	catch (Exception $e)
	{
