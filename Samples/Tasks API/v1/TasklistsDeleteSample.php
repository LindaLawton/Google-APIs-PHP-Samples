...
$results = tasklistsDeleteExample($service, $tasklist, $optParams);
...
*/
function tasklistsDeleteExample($service, $tasklist, $optParams)
{
	try
	{
		...
		return $service->tasklists->DeleteTasklists($tasklist, $optParams);
	}
	catch (Exception $e)
	{
