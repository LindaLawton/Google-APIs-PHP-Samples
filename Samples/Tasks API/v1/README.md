...
# UnOfficial Tasks API v1 Samples for PHP

## API Description

Lets you manage your tasks and task lists.

[Official Documentation](https://developers.google.com/google-apps/tasks/firstapp)

## Sample Description

These samples show how to access the [Tasks API v1](https://developers.google.com/google-apps/tasks/firstapp) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
