...
$results = tasksDeleteExample($service, $tasklist, $task, $optParams);
...
*/
function tasksDeleteExample($service, $tasklist, $task, $optParams)
{
	try
	{
		...
		return $service->tasks->DeleteTasks($tasklist, $task, $optParams);
	}
	catch (Exception $e)
	{
