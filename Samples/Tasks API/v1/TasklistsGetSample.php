...
$results = tasklistsGetExample($service, $tasklist, $optParams);
...
* @return TaskList
*/
function tasklistsGetExample($service, $tasklist, $optParams)
{
	try
	{
		...
		return $service->tasklists->GetTasklists($tasklist, $optParams);
	}
	catch (Exception $e)
	{
