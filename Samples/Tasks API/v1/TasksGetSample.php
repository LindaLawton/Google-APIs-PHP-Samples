...
// Single Request.
$results = tasksGetExample($service, $tasklist, $task, $optParams);
...
* @return Task
*/
function tasksGetExample($service, $tasklist, $task, $optParams)
{
	try
	{
		...
		return $service->tasks->GetTasks($tasklist, $task, $optParams);
	}
	catch (Exception $e)
	{
