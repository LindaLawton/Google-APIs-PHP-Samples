...
// Single Request.
$results = tasklistsPatchExample($service, $tasklist, $optParams);
...
* @return TaskList
*/
function tasklistsPatchExample($service, $tasklist, $optParams)
{
	try
	{
		...
		return $service->tasklists->PatchTasklists($tasklist, $optParams);
	}
	catch (Exception $e)
	{
