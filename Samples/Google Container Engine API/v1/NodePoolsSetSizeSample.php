...
print_r(nodePoolsSetSizeExample($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function nodePoolsSetSizeExample($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->nodePools->SetSizeNodePools($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
