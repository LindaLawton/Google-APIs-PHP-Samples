...
print_r(setSize($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function setSize($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->setSize($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
