...
// Single Request.
$results = nodePoolsSetSizeExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams);
...
* @return Operation
*/
function nodePoolsSetSizeExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams)
{
	try
	{
		...
		return $service->nodePools->SetSizeNodePools($projectId, $zone, $clusterId, $nodePoolId, $optParams);
	}
	catch (Exception $e)
	{
