...
// Single Request.
$results = nodePoolsDeleteExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams);
...
* @return Operation
*/
function nodePoolsDeleteExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams)
{
	try
	{
		...
		return $service->nodePools->DeleteNodePools($projectId, $zone, $clusterId, $nodePoolId, $optParams);
	}
	catch (Exception $e)
	{
