...
print_r(update($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function update($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->update($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
