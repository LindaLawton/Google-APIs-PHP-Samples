...
// Single Request.
$results = nodePoolsUpdateExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams);
...
* @return Operation
*/
function nodePoolsUpdateExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams)
{
	try
	{
		...
		return $service->nodePools->UpdateNodePools($projectId, $zone, $clusterId, $nodePoolId, $optParams);
	}
	catch (Exception $e)
	{
