...
print_r(nodePoolsUpdateExample($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function nodePoolsUpdateExample($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->nodePools->UpdateNodePools($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
