...
print_r(nodePoolsAutoscalingExample($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function nodePoolsAutoscalingExample($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->nodePools->AutoscalingNodePools($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
