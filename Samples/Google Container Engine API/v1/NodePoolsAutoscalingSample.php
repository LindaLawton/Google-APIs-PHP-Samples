...
// Single Request.
$results = nodePoolsAutoscalingExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams);
...
* @return Operation
*/
function nodePoolsAutoscalingExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams)
{
	try
	{
		...
		return $service->nodePools->AutoscalingNodePools($projectId, $zone, $clusterId, $nodePoolId, $optParams);
	}
	catch (Exception $e)
	{
