...
print_r(autoscaling($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function autoscaling($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->autoscaling($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
