...
// Single Request.
$results = operationsGetExample($service, $projectId, $zone, $operationId, $optParams);
...
* @return Operation
*/
function operationsGetExample($service, $projectId, $zone, $operationId, $optParams)
{
	try
	{
		...
		return $service->operations->GetOperations($projectId, $zone, $operationId, $optParams);
	}
	catch (Exception $e)
	{
