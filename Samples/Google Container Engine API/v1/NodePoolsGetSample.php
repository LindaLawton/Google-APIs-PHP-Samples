...
// Single Request.
$results = nodePoolsGetExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams);
...
* @return NodePool
*/
function nodePoolsGetExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams)
{
	try
	{
		...
		return $service->nodePools->GetNodePools($projectId, $zone, $clusterId, $nodePoolId, $optParams);
	}
	catch (Exception $e)
	{
