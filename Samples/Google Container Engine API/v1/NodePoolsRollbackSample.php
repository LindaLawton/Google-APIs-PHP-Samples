...
// Single Request.
$results = nodePoolsRollbackExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams);
...
* @return Operation
*/
function nodePoolsRollbackExample($service, $projectId, $zone, $clusterId, $nodePoolId, $optParams)
{
	try
	{
		...
		return $service->nodePools->RollbackNodePools($projectId, $zone, $clusterId, $nodePoolId, $optParams);
	}
	catch (Exception $e)
	{
