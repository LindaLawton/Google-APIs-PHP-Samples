...
// Single Request.
$results = nodePoolsListExample($service, $projectId, $zone, $clusterId, $optParams);
...
*/
function nodePoolsListExample($service, $projectId, $zone, $clusterId, $optParams)
{
	try
	{
		...
		return $service->nodePools->ListNodePools($projectId, $zone, $clusterId, $optParams);
	}
	catch (Exception $e)
	{
