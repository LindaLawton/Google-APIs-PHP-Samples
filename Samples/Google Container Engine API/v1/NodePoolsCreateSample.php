...
// Single Request.
$results = nodePoolsCreateExample($service, $projectId, $zone, $clusterId, $optParams);
...
* @return Operation
*/
function nodePoolsCreateExample($service, $projectId, $zone, $clusterId, $optParams)
{
	try
	{
		...
		return $service->nodePools->CreateNodePools($projectId, $zone, $clusterId, $optParams);
	}
	catch (Exception $e)
	{
