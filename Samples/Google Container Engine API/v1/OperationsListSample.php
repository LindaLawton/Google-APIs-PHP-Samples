...
// Single Request.
$results = operationsListExample($service, $projectId, $zone, $optParams);
...
*/
function operationsListExample($service, $projectId, $zone, $optParams)
{
	try
	{
		...
		return $service->operations->ListOperations($projectId, $zone, $optParams);
	}
	catch (Exception $e)
	{
