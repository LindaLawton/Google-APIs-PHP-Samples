...
// Single Request.
$results = operationsCancelExample($service, $projectId, $zone, $operationId, $optParams);
...
* @return Empty
*/
function operationsCancelExample($service, $projectId, $zone, $operationId, $optParams)
{
	try
	{
		...
		return $service->operations->CancelOperations($projectId, $zone, $operationId, $optParams);
	}
	catch (Exception $e)
	{
