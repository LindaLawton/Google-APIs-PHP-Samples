...
print_r(rollback($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function rollback($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->rollback($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
