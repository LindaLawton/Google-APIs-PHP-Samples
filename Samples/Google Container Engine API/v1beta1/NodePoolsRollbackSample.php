...
// Single Request.
$results = nodePoolsRollbackExample($service, $name, $optParams);
...
* @return Operation
*/
function nodePoolsRollbackExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->nodePools->RollbackNodePools($name, $optParams);
	}
	catch (Exception $e)
	{
