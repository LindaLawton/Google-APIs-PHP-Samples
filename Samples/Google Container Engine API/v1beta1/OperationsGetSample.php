...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'operationId' => '[YourValue]',  // The server-assigned `name` of the operation.This field is deprecated, use name instead.
            
  //'projectId' => '[YourValue]',  // The Google Developers Console [project ID or projectnumber](https://support.google.com/cloud/answer/6158840).This field is deprecated, use name instead.
...
* @return Operation
*/
function operationsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->operations->GetOperations($name, $optParams);
	}
	catch (Exception $e)
	{
