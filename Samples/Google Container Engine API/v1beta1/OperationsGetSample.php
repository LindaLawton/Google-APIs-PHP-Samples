...
print_r(operationsGetExample($service, $projectId, $zone, $operationId));
...
*/
function operationsGetExample($service, $projectId, $zone, $operationId)
{
	try
	{
		...
		return $service->operations->GetOperations($projectId, $zone, $operationId);
	}
	catch (Exception $ex)
	{
