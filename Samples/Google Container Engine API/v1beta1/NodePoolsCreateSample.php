...
// Single Request.
$results = nodePoolsCreateExample($service, $parent, $optParams);
...
* @parent The parent (project, location, cluster id) where the node pool will be created.
Specified in the format 'projects/*/locations/*/clusters/*/nodePools/*'.
* @return Operation
*/
function nodePoolsCreateExample($service, $parent, $optParams)
{
	try
	{
		...
		return $service->nodePools->CreateNodePools($parent, $optParams);
	}
	catch (Exception $e)
	{
