...
print_r(nodePoolsCreateExample($service, $projectId, $zone, $clusterId));
...
*/
function nodePoolsCreateExample($service, $projectId, $zone, $clusterId)
{
	try
	{
		...
		return $service->nodePools->CreateNodePools($projectId, $zone, $clusterId);
	}
	catch (Exception $ex)
	{
