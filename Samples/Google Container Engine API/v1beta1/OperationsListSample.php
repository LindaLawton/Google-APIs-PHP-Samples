...
print_r(operationsListExample($service, $projectId, $zone));
...
This field is deprecated, use parent instead.
* @return ListOperationsResponse</returns>
*/
function operationsListExample($service, $projectId, $zone)
{
	try
	{
		...
		return $service->operations->ListOperations($projectId, $zone);
	}
	catch (Exception $ex)
	{
