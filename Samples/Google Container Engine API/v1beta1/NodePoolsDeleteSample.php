...
print_r(delete($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function delete($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->delete($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
