...
print_r(nodePoolsDeleteExample($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function nodePoolsDeleteExample($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->nodePools->DeleteNodePools($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
