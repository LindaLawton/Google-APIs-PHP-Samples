...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'nodePoolId' => '[YourValue]',  // The name of the node pool to delete.This field is deprecated, use name instead.
  'fields' => '*'
);
// Single Request.
$results = nodePoolsDeleteExample($service, $name, $optParams);
...
* @name The name (project, location, cluster, node pool id) of the node pool to delete.
Specified in the format 'projects/*/locations/*/clusters/*/nodePools/*'.
* @return Operation
*/
function nodePoolsDeleteExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->nodePools->DeleteNodePools($name, $optParams);
	}
	catch (Exception $e)
	{
