 ...
 * Initializes an Container.v1beta1 service object.
 * @param string API key
 * @return An authorized Container.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Container Sample");
		...
		// Create authenticated Container service
		return new Google_Service_Container($client);
	} catch (Exception $e) {
