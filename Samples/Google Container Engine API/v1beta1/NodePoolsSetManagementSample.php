...
print_r(nodePoolsSetManagementExample($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function nodePoolsSetManagementExample($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->nodePools->SetManagementNodePools($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
