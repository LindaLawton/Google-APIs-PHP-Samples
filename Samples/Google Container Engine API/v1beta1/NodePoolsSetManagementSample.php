...
print_r(setManagement($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function setManagement($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->setManagement($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
