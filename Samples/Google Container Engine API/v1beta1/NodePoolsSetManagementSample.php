...
// Single Request.
$results = nodePoolsSetManagementExample($service, $name, $optParams);
...
* @return Operation
*/
function nodePoolsSetManagementExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->nodePools->SetManagementNodePools($name, $optParams);
	}
	catch (Exception $e)
	{
