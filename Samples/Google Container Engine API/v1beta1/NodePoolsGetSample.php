...
print_r(nodePoolsGetExample($service, $projectId, $zone, $clusterId, $nodePoolId));
...
resides.
This field is deprecated, use name instead.
* @return NodePool</returns>
*/
function nodePoolsGetExample($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->nodePools->GetNodePools($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
