...
print_r(get($service, $projectId, $zone, $clusterId, $nodePoolId));
...
*/
function get($service, $projectId, $zone, $clusterId, $nodePoolId)
{
	try
	{
		...
		return $service->get($projectId, $zone, $clusterId, $nodePoolId);
	}
	catch (Exception $ex)
	{
