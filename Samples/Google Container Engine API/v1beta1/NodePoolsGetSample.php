...
* @name The name (project, location, cluster, node pool id) of the node pool to get.
Specified in the format 'projects/*/locations/*/clusters/*/nodePools/*'.
* @return NodePool
*/
function nodePoolsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->nodePools->GetNodePools($name, $optParams);
	}
	catch (Exception $e)
	{
