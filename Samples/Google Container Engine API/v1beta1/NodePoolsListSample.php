...
print_r(nodePoolsListExample($service, $projectId, $zone, $clusterId));
...
This field is deprecated, use parent instead.
* @return ListNodePoolsResponse</returns>
*/
function nodePoolsListExample($service, $projectId, $zone, $clusterId)
{
	try
	{
		...
		return $service->nodePools->ListNodePools($projectId, $zone, $clusterId);
	}
	catch (Exception $ex)
	{
