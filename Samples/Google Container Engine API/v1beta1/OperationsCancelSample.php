...
print_r(operationsCancelExample($service, $projectId, $zone, $operationId));
...
*/
function operationsCancelExample($service, $projectId, $zone, $operationId)
{
	try
	{
		...
		return $service->operations->CancelOperations($projectId, $zone, $operationId);
	}
	catch (Exception $ex)
	{
