...
print_r(tripsSearchExample($service));

/**
* Returns a list of flights.
* @service Authenticated Qpxexpress service.
* @return TripsSearchResponse</returns>
*/
function tripsSearchExample($service)
{
	try
	{
		...
		return $service->trips->SearchTrips();
	}
	catch (Exception $ex)
	{
