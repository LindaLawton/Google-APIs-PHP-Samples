...
# UnOfficial QPX Express API v1 Samples for PHP

## API Description

Finds the least expensive flights between an origin and a destination.

[Official Documentation](http://developers.google.com/qpx-express)

## Sample Description

These samples show how to access the [QPX Express API v1](http://developers.google.com/qpx-express) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
