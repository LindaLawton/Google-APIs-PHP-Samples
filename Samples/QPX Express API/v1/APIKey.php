...
// About 
// 
// Unofficial sample for the QPX Express v1 API for PHP. 
 ...
 * Initializes an Qpxexpress.v1 service object.
 * @param string API key
 * @return An authorized Qpxexpress.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Qpxexpress Sample");
		...
		// Create authenticated Qpxexpress service
		return new Google_Service_Qpxexpress($client);
	} catch (Exception $e) {
