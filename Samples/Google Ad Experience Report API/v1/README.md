...
# UnOfficial Google Ad Experience Report API v1 Samples for PHP

## API Description

View Ad Experience Report data, and get a list of sites that have a significant number of annoying ads.

[Official Documentation](https://developers.google.com/ad-experience-report/)

## Sample Description

These samples show how to access the [Google Ad Experience Report API v1](https://developers.google.com/ad-experience-report/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
