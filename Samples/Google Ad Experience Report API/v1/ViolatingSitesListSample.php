...
$results = violatingSitesListExample($service, $optParams);
...
*/
function violatingSitesListExample($service, $optParams)
{
	try
	{
		...
		return $service->violatingSites->ListViolatingSites($optParams);
	}
	catch (Exception $e)
	{
