...
print_r(violatingSitesListExample($service));

/**
* Lists sites with Ad Experience Report statuses of "Failing" or "Warning".
* @service Authenticated Adexperiencereport service.
* @return ViolatingSitesResponse</returns>
*/
function violatingSitesListExample($service)
{
	try
	{
		...
		return $service->violatingSites->ListViolatingSites();
	}
	catch (Exception $ex)
	{
