...
// About 
// 
// Unofficial sample for the Adexperiencereport v1 API for PHP. 
 ...
 * Initializes an Adexperiencereport.v1 service object.
 * @param string API key
 * @return An authorized Adexperiencereport.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Adexperiencereport Sample");
		...
		// Create authenticated Adexperiencereport service
		return new Google_Service_Adexperiencereport($client);
	} catch (Exception $e) {
