...
# Unoffical Google Ad Experience Report API Samples for PHP
...
These samples show how to access the [Google Ad Experience Report API](https://developers.google.com/ad-experience-report/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
