...
print_r(sessionsUpdateExample($service, $userId, $sessionId));
...
*/
function sessionsUpdateExample($service, $userId, $sessionId)
{
	try
	{
		...
		return $service->sessions->UpdateSessions($userId, $sessionId);
	}
	catch (Exception $ex)
	{
