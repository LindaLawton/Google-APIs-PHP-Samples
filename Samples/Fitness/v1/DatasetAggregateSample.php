...
// Single Request.
$results = datasetAggregateExample($service, $userId, $optParams);
...
*/
function datasetAggregateExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->dataset->AggregateDataset($userId, $optParams);
	}
	catch (Exception $e)
	{
