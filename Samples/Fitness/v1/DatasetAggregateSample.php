...
print_r(datasetAggregateExample($service, $userId));
...
* @return AggregateResponse</returns>
*/
function datasetAggregateExample($service, $userId)
{
	try
	{
		...
		return $service->dataset->AggregateDataset($userId);
	}
	catch (Exception $ex)
	{
