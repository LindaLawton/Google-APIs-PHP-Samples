...
print_r(sessionsDeleteExample($service, $userId, $sessionId));
...
*/
function sessionsDeleteExample($service, $userId, $sessionId)
{
	try
	{
		...
		return $service->sessions->DeleteSessions($userId, $sessionId);
	}
	catch (Exception $ex)
	{
