...
$results = sessionsDeleteExample($service, $userId, $sessionId, $optParams);
...
*/
function sessionsDeleteExample($service, $userId, $sessionId, $optParams)
{
	try
	{
		...
		return $service->sessions->DeleteSessions($userId, $sessionId, $optParams);
	}
	catch (Exception $e)
	{
