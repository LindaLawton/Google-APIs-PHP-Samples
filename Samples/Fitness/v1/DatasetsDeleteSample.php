...
print_r(datasetsDeleteExample($service, $userId, $dataSourceId, $datasetId));
...
*/
function datasetsDeleteExample($service, $userId, $dataSourceId, $datasetId)
{
	try
	{
		...
		return $service->datasets->DeleteDatasets($userId, $dataSourceId, $datasetId);
	}
	catch (Exception $ex)
	{
