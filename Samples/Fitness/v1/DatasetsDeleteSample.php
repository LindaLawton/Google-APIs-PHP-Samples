...
print_r(delete($service, $userId, $dataSourceId, $datasetId));
...
*/
function delete($service, $userId, $dataSourceId, $datasetId)
{
	try
	{
		...
		return $service->delete($userId, $dataSourceId, $datasetId);
	}
	catch (Exception $ex)
	{
