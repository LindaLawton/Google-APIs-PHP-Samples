 ...
 * Initializes an Fitness.v1 service object.
 * @param string API key
 * @return An authorized Fitness.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Fitness Sample");
		...
		// Create authenticated Fitness service
		return new Google_Service_Fitness($client);
	} catch (Exception $e) {
