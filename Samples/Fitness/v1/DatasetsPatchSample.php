...
print_r(patch($service, $userId, $dataSourceId, $datasetId));
...
*/
function patch($service, $userId, $dataSourceId, $datasetId)
{
	try
	{
		...
		return $service->patch($userId, $dataSourceId, $datasetId);
	}
	catch (Exception $ex)
	{
