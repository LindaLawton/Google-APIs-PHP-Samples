...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'currentTimeMillis' => '[YourValue]',  // The client's current time in milliseconds since epoch. Note that the minStartTimeNs and maxEndTimeNs properties in the request body are in nanoseconds instead of milliseconds.
  'fields' => '*'
);
// Single Request.
$results = datasetsPatchExample($service, $userId, $dataSourceId, $datasetId, $optParams);
...
* @return Dataset
*/
function datasetsPatchExample($service, $userId, $dataSourceId, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->PatchDatasets($userId, $dataSourceId, $datasetId, $optParams);
	}
	catch (Exception $e)
	{
