...
print_r(datasetsPatchExample($service, $userId, $dataSourceId, $datasetId));
...
*/
function datasetsPatchExample($service, $userId, $dataSourceId, $datasetId)
{
	try
	{
		...
		return $service->datasets->PatchDatasets($userId, $dataSourceId, $datasetId);
	}
	catch (Exception $ex)
	{
