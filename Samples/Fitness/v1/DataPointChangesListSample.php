...
print_r(dataPointChangesListExample($service, $userId, $dataSourceId));
...
* @return ListDataPointChangesResponse</returns>
*/
function dataPointChangesListExample($service, $userId, $dataSourceId)
{
	try
	{
		...
		return $service->dataPointChanges->ListDataPointChanges($userId, $dataSourceId);
	}
	catch (Exception $ex)
	{
