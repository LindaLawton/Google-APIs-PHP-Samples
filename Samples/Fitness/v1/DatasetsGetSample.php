...
do {
	...
	$results = filesListExample($service, $userId, $dataSourceId, $datasetId, $optParams);	
...
* @return Dataset
*/
function datasetsGetExample($service, $userId, $dataSourceId, $datasetId, $optParams)
{
	try
	{
		...
		return $service->datasets->GetDatasets($userId, $dataSourceId, $datasetId, $optParams);
	}
	catch (Exception $e)
	{
