...
print_r(datasetsGetExample($service, $userId, $dataSourceId, $datasetId));
...
*/
function datasetsGetExample($service, $userId, $dataSourceId, $datasetId)
{
	try
	{
		...
		return $service->datasets->GetDatasets($userId, $dataSourceId, $datasetId);
	}
	catch (Exception $ex)
	{
