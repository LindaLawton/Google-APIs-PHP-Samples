...
// Single Request.
$results = columnUpdateExample($service, $tableId, $columnId, $optParams);
...
* @return Column
*/
function columnUpdateExample($service, $tableId, $columnId, $optParams)
{
	try
	{
		...
		return $service->column->UpdateColumn($tableId, $columnId, $optParams);
	}
	catch (Exception $e)
	{
