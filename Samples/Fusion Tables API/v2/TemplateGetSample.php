...
// Single Request.
$results = templateGetExample($service, $tableId, $templateId, $optParams);
...
* @return Template
*/
function templateGetExample($service, $tableId, $templateId, $optParams)
{
	try
	{
		...
		return $service->template->GetTemplate($tableId, $templateId, $optParams);
	}
	catch (Exception $e)
	{
