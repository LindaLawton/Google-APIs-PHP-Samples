...
print_r(styleUpdateExample($service, $tableId, $styleId));
...
* @return StyleSetting</returns>
*/
function styleUpdateExample($service, $tableId, $styleId)
{
	try
	{
		...
		return $service->style->UpdateStyle($tableId, $styleId);
	}
	catch (Exception $ex)
	{
