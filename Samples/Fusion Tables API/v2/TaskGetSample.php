...
// Single Request.
$results = taskGetExample($service, $tableId, $taskId, $optParams);
...
* @return Task
*/
function taskGetExample($service, $tableId, $taskId, $optParams)
{
	try
	{
		...
		return $service->task->GetTask($tableId, $taskId, $optParams);
	}
	catch (Exception $e)
	{
