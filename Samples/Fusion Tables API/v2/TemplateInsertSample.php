...
// Single Request.
$results = templateInsertExample($service, $tableId, $optParams);
...
* @return Template
*/
function templateInsertExample($service, $tableId, $optParams)
{
	try
	{
		...
		return $service->template->InsertTemplate($tableId, $optParams);
	}
	catch (Exception $e)
	{
