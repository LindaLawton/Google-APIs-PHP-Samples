...
// Single Request.
$results = styleInsertExample($service, $tableId, $optParams);
...
* @return StyleSetting
*/
function styleInsertExample($service, $tableId, $optParams)
{
	try
	{
		...
		return $service->style->InsertStyle($tableId, $optParams);
	}
	catch (Exception $e)
	{
