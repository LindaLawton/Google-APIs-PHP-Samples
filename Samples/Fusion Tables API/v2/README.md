...
# UnOfficial Fusion Tables API v2 Samples for PHP
...
These samples show how to access the [Fusion Tables API v2](https://developers.google.com/fusiontables) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
