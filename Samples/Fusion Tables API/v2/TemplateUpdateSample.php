...
print_r(templateUpdateExample($service, $tableId, $templateId));
...
*/
function templateUpdateExample($service, $tableId, $templateId)
{
	try
	{
		...
		return $service->template->UpdateTemplate($tableId, $templateId);
	}
	catch (Exception $ex)
	{
