 ...
 * Initializes an Fusiontables.v2 service object.
 * @param string API key
 * @return An authorized Fusiontables.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Fusiontables Sample");
		...
		// Create authenticated Fusiontables service
		return new Google_Service_Fusiontables($client);
	} catch (Exception $e) {
