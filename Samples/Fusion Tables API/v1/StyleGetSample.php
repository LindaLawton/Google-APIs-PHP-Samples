...
// Single Request.
$results = styleGetExample($service, $tableId, $styleId, $optParams);
...
* @return StyleSetting
*/
function styleGetExample($service, $tableId, $styleId, $optParams)
{
	try
	{
		...
		return $service->style->GetStyle($tableId, $styleId, $optParams);
	}
	catch (Exception $e)
	{
