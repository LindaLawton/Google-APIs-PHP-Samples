...
print_r(templateDeleteExample($service, $tableId, $templateId));
...
*/
function templateDeleteExample($service, $tableId, $templateId)
{
	try
	{
		...
		return $service->template->DeleteTemplate($tableId, $templateId);
	}
	catch (Exception $ex)
	{
