...
print_r(templateGetExample($service, $tableId, $templateId));
...
*/
function templateGetExample($service, $tableId, $templateId)
{
	try
	{
		...
		return $service->template->GetTemplate($tableId, $templateId);
	}
	catch (Exception $ex)
	{
