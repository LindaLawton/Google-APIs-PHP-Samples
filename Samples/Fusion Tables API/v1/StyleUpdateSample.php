...
$results = styleUpdateExample($service, $tableId, $styleId, $optParams);
...
* @return StyleSetting
*/
function styleUpdateExample($service, $tableId, $styleId, $optParams)
{
	try
	{
		...
		if (styleId == null)
			throw new Exception("styleId is required.");
		if (tableId == null)
			throw new Exception("tableId is required.");
		// Make the request and return the results.
		return $service->style->UpdateStyle($tableId, $styleId, $optParams);
	}
	catch (Exception $e)
	{
