...
$results = tableDeleteExample($service, $tableId, $optParams);
...
*/
function tableDeleteExample($service, $tableId, $optParams)
{
	try
	{
		...
		return $service->table->DeleteTable($tableId, $optParams);
	}
	catch (Exception $e)
	{
