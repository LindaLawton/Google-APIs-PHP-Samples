...
$results = templatePatchExample($service, $tableId, $templateId, $optParams);
...
* @return Template
*/
function templatePatchExample($service, $tableId, $templateId, $optParams)
{
	try
	{
		...
		return $service->template->PatchTemplate($tableId, $templateId, $optParams);
	}
	catch (Exception $e)
	{
