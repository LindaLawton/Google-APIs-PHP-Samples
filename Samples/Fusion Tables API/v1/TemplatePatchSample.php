...
print_r(templatePatchExample($service, $tableId, $templateId));
...
*/
function templatePatchExample($service, $tableId, $templateId)
{
	try
	{
		...
		return $service->template->PatchTemplate($tableId, $templateId);
	}
	catch (Exception $ex)
	{
