...
// Single Request.
$results = columnGetExample($service, $tableId, $columnId, $optParams);
...
* @return Column
*/
function columnGetExample($service, $tableId, $columnId, $optParams)
{
	try
	{
		...
		return $service->column->GetColumn($tableId, $columnId, $optParams);
	}
	catch (Exception $e)
	{
