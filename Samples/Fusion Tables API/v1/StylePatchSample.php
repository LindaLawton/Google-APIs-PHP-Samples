...
$results = stylePatchExample($service, $tableId, $styleId, $optParams);
...
* @return StyleSetting
*/
function stylePatchExample($service, $tableId, $styleId, $optParams)
{
	try
	{
		...
		return $service->style->PatchStyle($tableId, $styleId, $optParams);
	}
	catch (Exception $e)
	{
