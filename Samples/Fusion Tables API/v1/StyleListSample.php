...
print_r(styleListExample($service, $tableId));

/**
* Retrieves a list of styles.
* @service Authenticated Fusiontables service.
* @tableId Table whose styles are being listed
* @return StyleSettingList</returns>
*/
function styleListExample($service, $tableId)
{
	try
	{
		...
		return $service->style->ListStyle($tableId);
	}
	catch (Exception $ex)
	{
