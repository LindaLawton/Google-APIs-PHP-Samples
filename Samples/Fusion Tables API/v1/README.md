...
# UnOfficial Fusion Tables API v1 Samples for PHP

## API Description

API for working with Fusion Tables data.

[Official Documentation](https://developers.google.com/fusiontables)

## Sample Description

These samples show how to access the [Fusion Tables API v1](https://developers.google.com/fusiontables) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
