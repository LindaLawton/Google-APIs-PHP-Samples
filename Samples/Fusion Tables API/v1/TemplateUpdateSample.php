...
// Single Request.
$results = templateUpdateExample($service, $tableId, $templateId, $optParams);
...
* @return Template
*/
function templateUpdateExample($service, $tableId, $templateId, $optParams)
{
	try
	{
		...
		return $service->template->UpdateTemplate($tableId, $templateId, $optParams);
	}
	catch (Exception $e)
	{
