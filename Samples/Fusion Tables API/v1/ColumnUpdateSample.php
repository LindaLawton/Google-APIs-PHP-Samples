...
print_r(columnUpdateExample($service, $tableId, $columnId));
...
*/
function columnUpdateExample($service, $tableId, $columnId)
{
	try
	{
		...
		return $service->column->UpdateColumn($tableId, $columnId);
	}
	catch (Exception $ex)
	{
