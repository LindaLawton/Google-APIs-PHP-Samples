...
print_r(columnPatchExample($service, $tableId, $columnId));
...
*/
function columnPatchExample($service, $tableId, $columnId)
{
	try
	{
		...
		return $service->column->PatchColumn($tableId, $columnId);
	}
	catch (Exception $ex)
	{
