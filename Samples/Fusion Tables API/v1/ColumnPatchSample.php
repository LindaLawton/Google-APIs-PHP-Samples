...
// Single Request.
$results = columnPatchExample($service, $tableId, $columnId, $optParams);
...
* @return Column
*/
function columnPatchExample($service, $tableId, $columnId, $optParams)
{
	try
	{
		...
		return $service->column->PatchColumn($tableId, $columnId, $optParams);
	}
	catch (Exception $e)
	{
