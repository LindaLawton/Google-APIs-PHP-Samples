...
$results = columnDeleteExample($service, $tableId, $columnId, $optParams);
...
*/
function columnDeleteExample($service, $tableId, $columnId, $optParams)
{
	try
	{
		...
		return $service->column->DeleteColumn($tableId, $columnId, $optParams);
	}
	catch (Exception $e)
	{
