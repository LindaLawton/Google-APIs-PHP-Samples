...
print_r(columnDeleteExample($service, $tableId, $columnId));
...
*/
function columnDeleteExample($service, $tableId, $columnId)
{
	try
	{
		...
		return $service->column->DeleteColumn($tableId, $columnId);
	}
	catch (Exception $ex)
	{
