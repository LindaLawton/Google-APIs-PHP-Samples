...
// Single Request.
$results = columnInsertExample($service, $tableId, $optParams);
...
* @return Column
*/
function columnInsertExample($service, $tableId, $optParams)
{
	try
	{
		...
		return $service->column->InsertColumn($tableId, $optParams);
	}
	catch (Exception $e)
	{
