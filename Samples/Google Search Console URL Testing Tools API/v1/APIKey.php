 ...
 * Initializes an Searchconsole.v1 service object.
 * @param string API key
 * @return An authorized Searchconsole.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Searchconsole Sample");
		...
		// Create authenticated Searchconsole service
