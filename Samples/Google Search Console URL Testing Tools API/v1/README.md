...
# UnOfficial Google Search Console URL Testing Tools API v1 Samples for PHP

## API Description

Provides tools for running validation tests against single URLs

[Official Documentation](https://developers.google.com/webmaster-tools/search-console-api/)

## Sample Description

These samples show how to access the [Google Search Console URL Testing Tools API v1](https://developers.google.com/webmaster-tools/search-console-api/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
