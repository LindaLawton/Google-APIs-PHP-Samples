...
// Single Request.
$results = mobileFriendlyTestRunExample($service, $optParams);
...
*/
function mobileFriendlyTestRunExample($service, $optParams)
{
	try
	{
		...
		return $service->mobileFriendlyTest->RunMobileFriendlyTest($optParams);
	}
	catch (Exception $e)
	{
