...
// About 
// 
// Unofficial sample for the Search Console v1 API for PHP. 
...
print_r(mobileFriendlyTestRunExample($service));

/**
* Runs Mobile-Friendly Test for a given URL.
* @service Authenticated Searchconsole service.
* @return RunMobileFriendlyTestResponse</returns>
*/
function mobileFriendlyTestRunExample($service)
{
	try
	{
		...
		return $service->mobileFriendlyTest->RunMobileFriendlyTest();
	}
	catch (Exception $ex)
	{
