...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'target' => '[YourValue]',  // The language to use to return localized, human readable names of supportedlanguages.
            
  //'model' => '[YourValue]',  // The model type for which supported languages should be returned.
  'fields' => '*'
);
// Single Request.
$results = languagesListExample($service, $optParams);
...
*/
function languagesListExample($service, $optParams)
{
	try
	{
		...
		return $service->languages->ListLanguages($optParams);
	}
	catch (Exception $e)
	{
