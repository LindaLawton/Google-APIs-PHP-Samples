...
print_r(translationsListExample($service, $q, $target));
...
* @return TranslationsListResponse</returns>
*/
function translationsListExample($service, $q, $target)
{
	try
	{
		...
		return $service->translations->ListTranslations($q, $target);
	}
	catch (Exception $ex)
	{
