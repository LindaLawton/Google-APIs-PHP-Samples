...
// Single Request.
$results = detectionsDetectExample($service, $optParams);
...
*/
function detectionsDetectExample($service, $optParams)
{
	try
	{
		...
		return $service->detections->DetectDetections($optParams);
	}
	catch (Exception $e)
	{
