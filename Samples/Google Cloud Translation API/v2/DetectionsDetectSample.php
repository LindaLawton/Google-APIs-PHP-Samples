...
print_r(detectionsDetectExample($service));

/**
* Detects the language of text within a request.
* @service Authenticated Translate service.
* @return DetectionsListResponse</returns>
*/
function detectionsDetectExample($service)
{
	try
	{
		...
		return $service->detections->DetectDetections();
	}
	catch (Exception $ex)
	{
