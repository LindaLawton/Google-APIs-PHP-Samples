...
// Single Request.
$results = translationsTranslateExample($service, $optParams);
...
*/
function translationsTranslateExample($service, $optParams)
{
	try
	{
		...
		return $service->translations->TranslateTranslations($optParams);
	}
	catch (Exception $e)
	{
