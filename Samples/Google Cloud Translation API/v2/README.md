...
# UnOfficial Google Cloud Translation API v2 Samples for PHP
...
These samples show how to access the [Google Cloud Translation API v2](https://code.google.com/apis/language/translate/v2/getting_started.html) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
