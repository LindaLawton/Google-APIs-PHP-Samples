 ...
 * Initializes an Translate.v2 service object.
 * @param string API key
 * @return An authorized Translate.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Translate Sample");
		...
		// Create authenticated Translate service
		return new Google_Service_Translate($client);
	} catch (Exception $e) {
