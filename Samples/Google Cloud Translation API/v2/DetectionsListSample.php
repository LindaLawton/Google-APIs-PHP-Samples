...
$results = detectionsListExample($service, $q, $optParams);
...
*/
function detectionsListExample($service, $q, $optParams)
{
	try
	{
		...
		return $service->detections->ListDetections($q, $optParams);
	}
	catch (Exception $e)
	{
