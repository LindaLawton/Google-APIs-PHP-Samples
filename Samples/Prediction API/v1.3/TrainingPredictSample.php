...
$results = trainingPredictExample($service, $data, $optParams);
...
* @return Output
*/
function trainingPredictExample($service, $data, $optParams)
{
	try
	{
		...
		return $service->training->PredictTraining($data, $optParams);
	}
	catch (Exception $e)
	{
