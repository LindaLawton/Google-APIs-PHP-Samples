...
print_r(hostedmodelsPredictExample($service, $hostedModelName));
...
*/
function hostedmodelsPredictExample($service, $hostedModelName)
{
	try
	{
		...
		return $service->hostedmodels->PredictHostedmodels($hostedModelName);
	}
	catch (Exception $ex)
	{
