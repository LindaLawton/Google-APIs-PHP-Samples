...
$results = trainingUpdateExample($service, $data, $optParams);
...
* @return Training
*/
function trainingUpdateExample($service, $data, $optParams)
{
	try
	{
		...
		return $service->training->UpdateTraining($data, $optParams);
	}
	catch (Exception $e)
	{
