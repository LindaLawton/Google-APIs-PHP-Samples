...
// Single Request.
$results = trainedmodelsPredictExample($service, $id, $optParams);
...
* @return Output
*/
function trainedmodelsPredictExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->PredictTrainedmodels($id, $optParams);
	}
	catch (Exception $e)
	{
