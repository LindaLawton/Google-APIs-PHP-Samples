...
$results = trainedmodelsDeleteExample($service, $id, $optParams);
...
*/
function trainedmodelsDeleteExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->DeleteTrainedmodels($id, $optParams);
	}
	catch (Exception $e)
	{
