...
// Single Request.
$results = trainedmodelsInsertExample($service, $optParams);
...
* @return Training
*/
function trainedmodelsInsertExample($service, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->InsertTrainedmodels($optParams);
	}
	catch (Exception $e)
	{
