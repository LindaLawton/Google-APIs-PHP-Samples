...
// Single Request.
$results = trainedmodelsGetExample($service, $id, $optParams);
...
* @return Training
*/
function trainedmodelsGetExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->GetTrainedmodels($id, $optParams);
	}
	catch (Exception $e)
	{
