...
// Single Request.
$results = trainedmodelsAnalyzeExample($service, $project, $id, $optParams);
...
* @return Analyze
*/
function trainedmodelsAnalyzeExample($service, $project, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->AnalyzeTrainedmodels($project, $id, $optParams);
	}
	catch (Exception $e)
	{
