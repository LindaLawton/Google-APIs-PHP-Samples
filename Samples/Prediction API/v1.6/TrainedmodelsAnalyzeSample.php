...
print_r(trainedmodelsAnalyzeExample($service, $project, $id));
...
* @return Analyze</returns>
*/
function trainedmodelsAnalyzeExample($service, $project, $id)
{
	try
	{
		...
		return $service->trainedmodels->AnalyzeTrainedmodels($project, $id);
	}
	catch (Exception $ex)
	{
