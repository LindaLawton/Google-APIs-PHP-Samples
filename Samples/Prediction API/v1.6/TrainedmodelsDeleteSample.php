...
$results = trainedmodelsDeleteExample($service, $project, $id, $optParams);
...
*/
function trainedmodelsDeleteExample($service, $project, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->DeleteTrainedmodels($project, $id, $optParams);
	}
	catch (Exception $e)
	{
