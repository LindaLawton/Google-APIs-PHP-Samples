...
print_r(trainedmodelsDeleteExample($service, $project, $id));
...
*/
function trainedmodelsDeleteExample($service, $project, $id)
{
	try
	{
		...
		return $service->trainedmodels->DeleteTrainedmodels($project, $id);
	}
	catch (Exception $ex)
	{
