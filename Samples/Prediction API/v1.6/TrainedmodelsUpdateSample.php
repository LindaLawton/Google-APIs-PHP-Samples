...
// Single Request.
$results = trainedmodelsUpdateExample($service, $project, $id, $optParams);
...
* @return Insert2
*/
function trainedmodelsUpdateExample($service, $project, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->UpdateTrainedmodels($project, $id, $optParams);
	}
	catch (Exception $e)
	{
