...
print_r(trainedmodelsUpdateExample($service, $project, $id));
...
* @return Insert2</returns>
*/
function trainedmodelsUpdateExample($service, $project, $id)
{
	try
	{
		...
		return $service->trainedmodels->UpdateTrainedmodels($project, $id);
	}
	catch (Exception $ex)
	{
