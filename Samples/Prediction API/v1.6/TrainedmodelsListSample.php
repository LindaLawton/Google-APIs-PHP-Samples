...
print_r(trainedmodelsListExample($service, $project));
...
* @return List</returns>
*/
function trainedmodelsListExample($service, $project)
{
	try
	{
		...
		return $service->trainedmodels->ListTrainedmodels($project);
	}
	catch (Exception $ex)
	{
