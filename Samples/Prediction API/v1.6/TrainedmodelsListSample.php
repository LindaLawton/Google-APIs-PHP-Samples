...
// Single Request.
$results = trainedmodelsListExample($service, $project, $optParams);
...
* @return List
*/
function trainedmodelsListExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->ListTrainedmodels($project, $optParams);
	}
	catch (Exception $e)
	{
