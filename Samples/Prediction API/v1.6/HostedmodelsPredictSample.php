...
// About 
// 
// Unofficial sample for the prediction v1.6 API for PHP. 
...
// Single Request.
$results = hostedmodelsPredictExample($service, $project, $hostedModelName, $optParams);


/**
* Submit input and request an output against a hosted model.
* @service Authenticated Prediction service.
* @optParams Optional paramaters are not required by a request.
* @hostedModelName The name of a hosted model.
* @project The project associated with the model.
* @return Output
*/
function hostedmodelsPredictExample($service, $project, $hostedModelName, $optParams)
{
	try
	{
		...
		if (hostedModelName == null)
			throw new Exception("hostedModelName is required.");
		if (project == null)
			throw new Exception("project is required.");
		// Make the request and return the results.
		return $service->hostedmodels->PredictHostedmodels($project, $hostedModelName, $optParams);
	}
	catch (Exception $e)
	{
