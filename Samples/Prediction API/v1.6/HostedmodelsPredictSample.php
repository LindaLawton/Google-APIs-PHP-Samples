...
print_r(hostedmodelsPredictExample($service, $project, $hostedModelName));
...
*/
function hostedmodelsPredictExample($service, $project, $hostedModelName)
{
	try
	{
		...
		return $service->hostedmodels->PredictHostedmodels($project, $hostedModelName);
	}
	catch (Exception $ex)
	{
