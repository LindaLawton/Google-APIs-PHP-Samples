 ...
 * Initializes an Prediction.v1.6 service object.
 * @param string API key
 * @return An authorized Prediction.v1.6 service object.
 */
function getPublicService($apiKey) {
	try {
		...
		// Create authenticated Prediction service
		return new Google_Service_Prediction($client);
	} catch (Exception $e) {
