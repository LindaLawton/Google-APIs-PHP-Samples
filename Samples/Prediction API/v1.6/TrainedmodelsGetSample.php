...
$results = trainedmodelsGetExample($service, $project, $id, $optParams);
...
* @return Insert2
*/
function trainedmodelsGetExample($service, $project, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->GetTrainedmodels($project, $id, $optParams);
	}
	catch (Exception $e)
	{
