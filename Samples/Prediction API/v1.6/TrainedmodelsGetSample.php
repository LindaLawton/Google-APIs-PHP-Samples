...
print_r(trainedmodelsGetExample($service, $project, $id));
...
*/
function trainedmodelsGetExample($service, $project, $id)
{
	try
	{
		...
		return $service->trainedmodels->GetTrainedmodels($project, $id);
	}
	catch (Exception $ex)
	{
