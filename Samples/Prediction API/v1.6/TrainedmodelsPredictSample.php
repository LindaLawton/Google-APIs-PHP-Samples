...
// Single Request.
$results = trainedmodelsPredictExample($service, $project, $id, $optParams);
...
* @return Output
*/
function trainedmodelsPredictExample($service, $project, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->PredictTrainedmodels($project, $id, $optParams);
	}
	catch (Exception $e)
	{
