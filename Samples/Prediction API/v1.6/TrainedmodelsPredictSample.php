...
print_r(trainedmodelsPredictExample($service, $project, $id));
...
*/
function trainedmodelsPredictExample($service, $project, $id)
{
	try
	{
		...
		return $service->trainedmodels->PredictTrainedmodels($project, $id);
	}
	catch (Exception $ex)
	{
