...
print_r(trainedmodelsInsertExample($service, $project));
...
*/
function trainedmodelsInsertExample($service, $project)
{
	try
	{
		...
		return $service->trainedmodels->InsertTrainedmodels($project);
	}
	catch (Exception $ex)
	{
