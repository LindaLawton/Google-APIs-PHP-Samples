...
// Single Request.
$results = trainedmodelsInsertExample($service, $project, $optParams);
...
* @return Insert2
*/
function trainedmodelsInsertExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->InsertTrainedmodels($project, $optParams);
	}
	catch (Exception $e)
	{
