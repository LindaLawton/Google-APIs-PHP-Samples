...
// Single Request.
$results = trainedmodelsAnalyzeExample($service, $id, $optParams);
...
* @return Analyze
*/
function trainedmodelsAnalyzeExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->AnalyzeTrainedmodels($id, $optParams);
	}
	catch (Exception $e)
	{
