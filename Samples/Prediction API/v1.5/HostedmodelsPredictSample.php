...
// About 
// 
// Unofficial sample for the prediction v1.5 API for PHP. 
...
// Single Request.
$results = hostedmodelsPredictExample($service, $hostedModelName, $optParams);
...
* @return Output
*/
function hostedmodelsPredictExample($service, $hostedModelName, $optParams)
{
	try
	{
		...
		return $service->hostedmodels->PredictHostedmodels($hostedModelName, $optParams);
	}
	catch (Exception $e)
	{
