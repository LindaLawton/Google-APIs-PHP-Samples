...
print_r(trainedmodelsUpdateExample($service, $id));

/**
* Add new data to a trained model.
* @service Authenticated Prediction service.
* @id The unique name for the predictive model.
* @return Training</returns>
*/
function trainedmodelsUpdateExample($service, $id)
{
	try
	{
		...
		return $service->trainedmodels->UpdateTrainedmodels($id);
	}
	catch (Exception $ex)
	{
