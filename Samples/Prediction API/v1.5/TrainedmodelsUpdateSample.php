...
$results = trainedmodelsUpdateExample($service, $id, $optParams);
...
* @return Training
*/
function trainedmodelsUpdateExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->trainedmodels->UpdateTrainedmodels($id, $optParams);
	}
	catch (Exception $e)
	{
