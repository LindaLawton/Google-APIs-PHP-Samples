...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'data' => '[YourValue]',  //mybucket/mydata resource in Google Storage
  'fields' => '*'
);
// Single Request.
$results = trainingInsertExample($service, $optParams);
...
* @return Training
*/
function trainingInsertExample($service, $optParams)
{
	try
	{
		...
		return $service->training->InsertTraining($optParams);
	}
	catch (Exception $e)
	{
