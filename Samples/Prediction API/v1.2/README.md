...
# UnOfficial Prediction API v1.2 Samples for PHP
...
These samples show how to access the [Prediction API v1.2](https://developers.google.com/prediction/docs/developer-guide) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
