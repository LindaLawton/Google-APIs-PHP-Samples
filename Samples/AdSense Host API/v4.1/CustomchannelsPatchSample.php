...
// Single Request.
$results = customchannelsPatchExample($service, $adClientId, $customChannelId, $optParams);
...
*/
function customchannelsPatchExample($service, $adClientId, $customChannelId, $optParams)
{
	try
	{
		...
		return $service->customchannels->PatchCustomchannels($adClientId, $customChannelId, $optParams);
	}
	catch (Exception $e)
	{
