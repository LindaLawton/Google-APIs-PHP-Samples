...
print_r(customchannelsPatchExample($service, $adClientId, $customChannelId));
...
*/
function customchannelsPatchExample($service, $adClientId, $customChannelId)
{
	try
	{
		...
		return $service->customchannels->PatchCustomchannels($adClientId, $customChannelId);
	}
	catch (Exception $ex)
	{
