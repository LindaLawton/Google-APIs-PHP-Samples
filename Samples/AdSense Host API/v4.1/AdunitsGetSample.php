...
print_r(adunitsGetExample($service, $accountId, $adClientId, $adUnitId));
...
*/
function adunitsGetExample($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->adunits->GetAdunits($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
