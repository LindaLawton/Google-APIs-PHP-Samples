...
// Single Request.
$results = adunitsGetExample($service, $accountId, $adClientId, $adUnitId, $optParams);
...
* @return AdUnit
*/
function adunitsGetExample($service, $accountId, $adClientId, $adUnitId, $optParams)
{
	try
	{
		...
		return $service->adunits->GetAdunits($accountId, $adClientId, $adUnitId, $optParams);
	}
	catch (Exception $e)
	{
