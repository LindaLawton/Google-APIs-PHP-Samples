...
print_r(reportsGenerateExample($service, $startDate, $endDate));
...
*/
function reportsGenerateExample($service, $startDate, $endDate)
{
	try
	{
		...
		return $service->reports->GenerateReports($startDate, $endDate);
	}
	catch (Exception $ex)
	{
