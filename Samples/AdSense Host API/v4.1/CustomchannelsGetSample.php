...
print_r(customchannelsGetExample($service, $adClientId, $customChannelId));
...
*/
function customchannelsGetExample($service, $adClientId, $customChannelId)
{
	try
	{
		...
		return $service->customchannels->GetCustomchannels($adClientId, $customChannelId);
	}
	catch (Exception $ex)
	{
