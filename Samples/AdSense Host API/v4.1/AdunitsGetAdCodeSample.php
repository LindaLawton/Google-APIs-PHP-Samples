...
print_r(adunitsGetAdCodeExample($service, $accountId, $adClientId, $adUnitId));
...
* @return AdCode</returns>
*/
function adunitsGetAdCodeExample($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->adunits->GetAdCodeAdunits($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
