...
print_r(getAdCode($service, $accountId, $adClientId, $adUnitId));
...
*/
function getAdCode($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->getAdCode($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
