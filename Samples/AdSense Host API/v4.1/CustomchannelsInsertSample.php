...
print_r(customchannelsInsertExample($service, $adClientId));
...
*/
function customchannelsInsertExample($service, $adClientId)
{
	try
	{
		...
		return $service->customchannels->InsertCustomchannels($adClientId);
	}
	catch (Exception $ex)
	{
