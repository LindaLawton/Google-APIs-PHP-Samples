...
// Single Request.
$results = customchannelsInsertExample($service, $adClientId, $optParams);
...
*/
function customchannelsInsertExample($service, $adClientId, $optParams)
{
	try
	{
		...
		return $service->customchannels->InsertCustomchannels($adClientId, $optParams);
	}
	catch (Exception $e)
	{
