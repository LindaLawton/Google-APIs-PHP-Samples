...
$results = urlchannelsDeleteExample($service, $adClientId, $urlChannelId, $optParams);
...
* @return UrlChannel
*/
function urlchannelsDeleteExample($service, $adClientId, $urlChannelId, $optParams)
{
	try
	{
		...
		if (urlChannelId == null)
			throw new Exception("urlChannelId is required.");
		// Make the request and return the results.
		return $service->urlchannels->DeleteUrlchannels($adClientId, $urlChannelId, $optParams);
	}
	catch (Exception $e)
	{
