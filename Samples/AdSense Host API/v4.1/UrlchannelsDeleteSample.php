...
print_r(urlchannelsDeleteExample($service, $adClientId, $urlChannelId));
...
* @return UrlChannel</returns>
*/
function urlchannelsDeleteExample($service, $adClientId, $urlChannelId)
{
	try
	{
		...
		return $service->urlchannels->DeleteUrlchannels($adClientId, $urlChannelId);
	}
	catch (Exception $ex)
	{
