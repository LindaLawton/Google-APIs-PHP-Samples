...
print_r(adunitsUpdateExample($service, $accountId, $adClientId));
...
*/
function adunitsUpdateExample($service, $accountId, $adClientId)
{
	try
	{
		...
		return $service->adunits->UpdateAdunits($accountId, $adClientId);
	}
	catch (Exception $ex)
	{
