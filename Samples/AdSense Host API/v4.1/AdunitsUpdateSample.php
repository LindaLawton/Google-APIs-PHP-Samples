...
// Single Request.
$results = adunitsUpdateExample($service, $accountId, $adClientId, $optParams);
...
* @return AdUnit
*/
function adunitsUpdateExample($service, $accountId, $adClientId, $optParams)
{
	try
	{
		...
		return $service->adunits->UpdateAdunits($accountId, $adClientId, $optParams);
	}
	catch (Exception $e)
	{
