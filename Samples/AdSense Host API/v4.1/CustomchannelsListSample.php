...
print_r(customchannelsListExample($service, $adClientId));
...
*/
function customchannelsListExample($service, $adClientId)
{
	try
	{
		...
		return $service->customchannels->ListCustomchannels($adClientId);
	}
	catch (Exception $ex)
	{
