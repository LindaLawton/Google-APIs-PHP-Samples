...
// Single Request.
$results = customchannelsListExample($service, $adClientId, $optParams);
...
do {
	...
	$results = filesListExample($service, $adClientId, $optParams);	
...
*/
function customchannelsListExample($service, $adClientId, $optParams)
{
	try
	{
		...
		return $service->customchannels->ListCustomchannels($adClientId, $optParams);
	}
	catch (Exception $e)
	{
