...
print_r(delete($service, $accountId, $adClientId, $adUnitId));
...
*/
function delete($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->delete($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
