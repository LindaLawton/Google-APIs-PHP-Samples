...
// Single Request.
$results = adunitsDeleteExample($service, $accountId, $adClientId, $adUnitId, $optParams);
...
* @return AdUnit
*/
function adunitsDeleteExample($service, $accountId, $adClientId, $adUnitId, $optParams)
{
	try
	{
		...
		return $service->adunits->DeleteAdunits($accountId, $adClientId, $adUnitId, $optParams);
	}
	catch (Exception $e)
	{
