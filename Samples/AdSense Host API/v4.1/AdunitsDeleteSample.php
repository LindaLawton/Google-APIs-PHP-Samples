...
print_r(adunitsDeleteExample($service, $accountId, $adClientId, $adUnitId));
...
* @return AdUnit</returns>
*/
function adunitsDeleteExample($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->adunits->DeleteAdunits($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
