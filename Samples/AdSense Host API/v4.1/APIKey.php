 ...
 * Initializes an Adsensehost.v4.1 service object.
 * @param string API key
 * @return An authorized Adsensehost.v4.1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Adsensehost Sample");
		...
		// Create authenticated Adsensehost service
		return new Google_Service_Adsensehost($client);
	} catch (Exception $e) {
