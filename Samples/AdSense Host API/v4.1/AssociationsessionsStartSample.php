...
print_r(associationsessionsStartExample($service, $productCode, $websiteUrl));
...
* @return AssociationSession</returns>
*/
function associationsessionsStartExample($service, $productCode, $websiteUrl)
{
	try
	{
		...
		return $service->associationsessions->StartAssociationsessions($productCode, $websiteUrl);
	}
	catch (Exception $ex)
	{
