...
// Single Request.
$results = customchannelsUpdateExample($service, $adClientId, $optParams);
...
*/
function customchannelsUpdateExample($service, $adClientId, $optParams)
{
	try
	{
		...
		return $service->customchannels->UpdateCustomchannels($adClientId, $optParams);
	}
	catch (Exception $e)
	{
