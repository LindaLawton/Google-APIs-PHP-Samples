...
print_r(customchannelsUpdateExample($service, $adClientId));
...
*/
function customchannelsUpdateExample($service, $adClientId)
{
	try
	{
		...
		return $service->customchannels->UpdateCustomchannels($adClientId);
	}
	catch (Exception $ex)
	{
