...
$results = adunitsInsertExample($service, $accountId, $adClientId, $optParams);
...
* @return AdUnit
*/
function adunitsInsertExample($service, $accountId, $adClientId, $optParams)
{
	try
	{
		...
		return $service->adunits->InsertAdunits($accountId, $adClientId, $optParams);
	}
	catch (Exception $e)
	{
