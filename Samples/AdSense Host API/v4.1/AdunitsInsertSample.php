...
print_r(adunitsInsertExample($service, $accountId, $adClientId));
...
*/
function adunitsInsertExample($service, $accountId, $adClientId)
{
	try
	{
		...
		return $service->adunits->InsertAdunits($accountId, $adClientId);
	}
	catch (Exception $ex)
	{
