...
print_r(adunitsListExample($service, $accountId, $adClientId));
...
*/
function adunitsListExample($service, $accountId, $adClientId)
{
	try
	{
		...
		return $service->adunits->ListAdunits($accountId, $adClientId);
	}
	catch (Exception $ex)
	{
