...
print_r(customchannelsDeleteExample($service, $adClientId, $customChannelId));
...
*/
function customchannelsDeleteExample($service, $adClientId, $customChannelId)
{
	try
	{
		...
		return $service->customchannels->DeleteCustomchannels($adClientId, $customChannelId);
	}
	catch (Exception $ex)
	{
