...
$results = associationsessionsVerifyExample($service, $token, $optParams);
...
*/
function associationsessionsVerifyExample($service, $token, $optParams)
{
	try
	{
		...
		return $service->associationsessions->VerifyAssociationsessions($token, $optParams);
	}
	catch (Exception $e)
	{
