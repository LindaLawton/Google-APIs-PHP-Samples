...
print_r(associationsessionsVerifyExample($service, $token));
...
*/
function associationsessionsVerifyExample($service, $token)
{
	try
	{
		...
		return $service->associationsessions->VerifyAssociationsessions($token);
	}
	catch (Exception $ex)
	{
