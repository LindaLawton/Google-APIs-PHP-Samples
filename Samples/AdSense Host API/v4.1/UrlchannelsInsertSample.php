...
$results = urlchannelsInsertExample($service, $adClientId, $optParams);
...
* @return UrlChannel
*/
function urlchannelsInsertExample($service, $adClientId, $optParams)
{
	try
	{
		...
		return $service->urlchannels->InsertUrlchannels($adClientId, $optParams);
	}
	catch (Exception $e)
	{
