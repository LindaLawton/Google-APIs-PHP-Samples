...
print_r(urlchannelsInsertExample($service, $adClientId));
...
*/
function urlchannelsInsertExample($service, $adClientId)
{
	try
	{
		...
		return $service->urlchannels->InsertUrlchannels($adClientId);
	}
	catch (Exception $ex)
	{
