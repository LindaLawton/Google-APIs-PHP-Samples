...
print_r(patch($service, $accountId, $adClientId, $adUnitId));
...
*/
function patch($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->patch($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
