...
// Single Request.
$results = adunitsPatchExample($service, $accountId, $adClientId, $adUnitId, $optParams);
...
* @return AdUnit
*/
function adunitsPatchExample($service, $accountId, $adClientId, $adUnitId, $optParams)
{
	try
	{
		...
		return $service->adunits->PatchAdunits($accountId, $adClientId, $adUnitId, $optParams);
	}
	catch (Exception $e)
	{
