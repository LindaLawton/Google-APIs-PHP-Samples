...
print_r(adunitsPatchExample($service, $accountId, $adClientId, $adUnitId));
...
*/
function adunitsPatchExample($service, $accountId, $adClientId, $adUnitId)
{
	try
	{
		...
		return $service->adunits->PatchAdunits($accountId, $adClientId, $adUnitId);
	}
	catch (Exception $ex)
	{
