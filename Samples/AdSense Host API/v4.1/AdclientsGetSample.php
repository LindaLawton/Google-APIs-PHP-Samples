...
$results = adclientsGetExample($service, $adClientId, $optParams);
...
* @return AdClient
*/
function adclientsGetExample($service, $adClientId, $optParams)
{
	try
	{
		...
		return $service->adclients->GetAdclients($adClientId, $optParams);
	}
	catch (Exception $e)
	{
