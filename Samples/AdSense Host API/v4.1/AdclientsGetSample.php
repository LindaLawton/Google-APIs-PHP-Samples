...
print_r(adclientsGetExample($service, $adClientId));

/**
* Get information about one of the ad clients in the Host AdSense account.
* @service Authenticated Adsensehost service.
* @adClientId Ad client to get.
* @return AdClient</returns>
*/
function adclientsGetExample($service, $adClientId)
{
	try
	{
		...
		return $service->adclients->GetAdclients($adClientId);
	}
	catch (Exception $ex)
	{
