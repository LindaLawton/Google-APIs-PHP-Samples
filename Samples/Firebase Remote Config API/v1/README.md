...
# UnOfficial Firebase Remote Config API v1 Samples for PHP
...
These samples show how to access the [Firebase Remote Config API v1](https://firebase.google.com/docs/remote-config/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
