...
print_r(projectsUpdateRemoteConfigExample($service, $project));
...
* @service Authenticated Firebaseremoteconfig service.
* @project The GMP project identifier. Required.
See note at the beginning of this file regarding project ids.
* @return RemoteConfig</returns>
*/
function projectsUpdateRemoteConfigExample($service, $project)
{
	try
	{
		...
		return $service->projects->UpdateRemoteConfigProjects($project);
	}
	catch (Exception $ex)
	{
