...
print_r(projectsGetRemoteConfigExample($service, $project));
...
*/
function projectsGetRemoteConfigExample($service, $project)
{
	try
	{
		...
		return $service->projects->GetRemoteConfigProjects($project);
	}
	catch (Exception $ex)
	{
