...
// Single Request.
$results = projectsGetRemoteConfigExample($service, $project, $optParams);
...
* @return RemoteConfig
*/
function projectsGetRemoteConfigExample($service, $project, $optParams)
{
	try
	{
		...
		return $service->projects->GetRemoteConfigProjects($project, $optParams);
	}
	catch (Exception $e)
	{
