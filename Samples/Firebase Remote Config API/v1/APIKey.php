...
// About 
// 
// Unofficial sample for the Firebase Remote Config v1 API for PHP. 
 ...
 * Initializes an Firebaseremoteconfig.v1 service object.
 * @param string API key
 * @return An authorized Firebaseremoteconfig.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Firebaseremoteconfig Sample");
		...
		// Create authenticated Firebaseremoteconfig service
		return new Google_Service_Firebaseremoteconfig($client);
	} catch (Exception $e) {
