...
print_r(eventsListExample($service, $projectName));
...
* @return ListEventsResponse</returns>
*/
function eventsListExample($service, $projectName)
{
	try
	{
		...
		return $service->events->ListEvents($projectName);
	}
	catch (Exception $ex)
	{
