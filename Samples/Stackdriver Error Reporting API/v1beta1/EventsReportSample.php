...
print_r(eventsReportExample($service, $projectName));
...
* @return ReportErrorEventResponse</returns>
*/
function eventsReportExample($service, $projectName)
{
	try
	{
		...
		return $service->events->ReportEvents($projectName);
	}
	catch (Exception $ex)
	{
