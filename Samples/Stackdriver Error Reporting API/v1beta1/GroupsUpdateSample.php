...
// Single Request.
$results = groupsUpdateExample($service, $name, $optParams);
...
* @return ErrorGroup
*/
function groupsUpdateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->groups->UpdateGroups($name, $optParams);
	}
	catch (Exception $e)
	{
