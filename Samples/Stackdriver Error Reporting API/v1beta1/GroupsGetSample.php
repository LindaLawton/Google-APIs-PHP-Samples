...
print_r(groupsGetExample($service, $groupName));
...
* @return ErrorGroup</returns>
*/
function groupsGetExample($service, $groupName)
{
	try
	{
		...
		return $service->groups->GetGroups($groupName);
	}
	catch (Exception $ex)
	{
