...
$results = groupsGetExample($service, $groupName, $optParams);
...
* @return ErrorGroup
*/
function groupsGetExample($service, $groupName, $optParams)
{
	try
	{
		...
		return $service->groups->GetGroups($groupName, $optParams);
	}
	catch (Exception $e)
	{
