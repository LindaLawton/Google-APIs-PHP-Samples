 ...
 * Initializes an Clouderrorreporting.v1beta1 service object.
 * @param string API key
 * @return An authorized Clouderrorreporting.v1beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Clouderrorreporting Sample");
		...
		// Create authenticated Clouderrorreporting service
		return new Google_Service_Clouderrorreporting($client);
	} catch (Exception $e) {
