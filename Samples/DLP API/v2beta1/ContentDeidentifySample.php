...
print_r(contentDeidentifyExample($service));
...
* @return GooglePrivacyDlpV2beta1DeidentifyContentResponse</returns>
*/
function contentDeidentifyExample($service)
{
	try
	{
		...
		return $service->content->DeidentifyContent();
	}
	catch (Exception $ex)
	{
