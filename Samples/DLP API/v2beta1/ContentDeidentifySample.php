...
// Single Request.
$results = contentDeidentifyExample($service, $optParams);
...
* @return GooglePrivacyDlpV2beta1DeidentifyContentResponse
*/
function contentDeidentifyExample($service, $optParams)
{
	try
	{
		...
		return $service->content->DeidentifyContent($optParams);
	}
	catch (Exception $e)
	{
