...
print_r(contentInspectExample($service));
...
* @return GooglePrivacyDlpV2beta1InspectContentResponse</returns>
*/
function contentInspectExample($service)
{
	try
	{
		...
		return $service->content->InspectContent();
	}
	catch (Exception $ex)
	{
