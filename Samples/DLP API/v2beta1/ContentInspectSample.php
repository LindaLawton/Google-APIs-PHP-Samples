...
// Single Request.
$results = contentInspectExample($service, $optParams);
...
* @return GooglePrivacyDlpV2beta1InspectContentResponse
*/
function contentInspectExample($service, $optParams)
{
	try
	{
		...
		return $service->content->InspectContent($optParams);
	}
	catch (Exception $e)
	{
