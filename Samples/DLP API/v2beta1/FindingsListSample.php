...
print_r(findingsListExample($service, $name));
...
* @return GooglePrivacyDlpV2beta1ListInspectFindingsResponse</returns>
*/
function findingsListExample($service, $name)
{
	try
	{
		...
		return $service->findings->ListFindings($name);
	}
	catch (Exception $ex)
	{
