...
print_r(contentRedactExample($service));
...
* @return GooglePrivacyDlpV2beta1RedactContentResponse</returns>
*/
function contentRedactExample($service)
{
	try
	{
		...
		return $service->content->RedactContent();
	}
	catch (Exception $ex)
	{
