...
$results = contentRedactExample($service, $optParams);
...
* @return GooglePrivacyDlpV2beta1RedactContentResponse
*/
function contentRedactExample($service, $optParams)
{
	try
	{
		...
		return $service->content->RedactContent($optParams);
	}
	catch (Exception $e)
	{
