...
print_r(infoTypesListExample($service, $category));

/**
* Returns sensitive information types for given category.
* @service Authenticated Dlp service.
* @category Category name as returned by ListRootCategories.
* @return GooglePrivacyDlpV2beta1ListInfoTypesResponse</returns>
*/
function infoTypesListExample($service, $category)
{
	try
	{
		...
		return $service->infoTypes->ListInfoTypes($category);
	}
	catch (Exception $ex)
	{
