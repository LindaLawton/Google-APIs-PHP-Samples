...
// Single Request.
$results = dataSourceAnalyzeExample($service, $optParams);
...
*/
function dataSourceAnalyzeExample($service, $optParams)
{
	try
	{
		...
		return $service->dataSource->AnalyzeDataSource($optParams);
	}
	catch (Exception $e)
	{
