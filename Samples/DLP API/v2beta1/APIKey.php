 ...
 * Initializes an Dlp.v2beta1 service object.
 * @param string API key
 * @return An authorized Dlp.v2beta1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Dlp Sample");
		...
		// Create authenticated Dlp service
		return new Google_Service_Dlp($client);
	} catch (Exception $e) {
