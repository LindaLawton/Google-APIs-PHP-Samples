...
# Unoffical DLP API Samples for PHP
...
These samples show how to access the [DLP API](https://cloud.google.com/dlp/docs/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
