...
# Unoffical Enterprise License Manager API Samples for PHP
...
These samples show how to access the [Enterprise License Manager API](https://developers.google.com/google-apps/licensing/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
