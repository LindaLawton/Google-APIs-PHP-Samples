...
print_r(licenseAssignmentsDeleteExample($service, $productId, $skuId, $userId));
...
*/
function licenseAssignmentsDeleteExample($service, $productId, $skuId, $userId)
{
	try
	{
		...
		return $service->licenseAssignments->DeleteLicenseAssignments($productId, $skuId, $userId);
	}
	catch (Exception $ex)
	{
