...
print_r(licenseAssignmentsUpdateExample($service, $productId, $skuId, $userId));
...
* @return LicenseAssignment</returns>
*/
function licenseAssignmentsUpdateExample($service, $productId, $skuId, $userId)
{
	try
	{
		...
		return $service->licenseAssignments->UpdateLicenseAssignments($productId, $skuId, $userId);
	}
	catch (Exception $ex)
	{
