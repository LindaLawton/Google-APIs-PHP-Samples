...
// Single Request.
$results = licenseAssignmentsUpdateExample($service, $productId, $skuId, $userId, $optParams);
...
*/
function licenseAssignmentsUpdateExample($service, $productId, $skuId, $userId, $optParams)
{
	try
	{
		...
		return $service->licenseAssignments->UpdateLicenseAssignments($productId, $skuId, $userId, $optParams);
	}
	catch (Exception $e)
	{
