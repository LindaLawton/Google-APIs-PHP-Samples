...
$results = licenseAssignmentsPatchExample($service, $productId, $skuId, $userId, $optParams);
...
*/
function licenseAssignmentsPatchExample($service, $productId, $skuId, $userId, $optParams)
{
	try
	{
		...
		return $service->licenseAssignments->PatchLicenseAssignments($productId, $skuId, $userId, $optParams);
	}
	catch (Exception $e)
	{
