...
print_r(licenseAssignmentsPatchExample($service, $productId, $skuId, $userId));
...
*/
function licenseAssignmentsPatchExample($service, $productId, $skuId, $userId)
{
	try
	{
		...
		return $service->licenseAssignments->PatchLicenseAssignments($productId, $skuId, $userId);
	}
	catch (Exception $ex)
	{
