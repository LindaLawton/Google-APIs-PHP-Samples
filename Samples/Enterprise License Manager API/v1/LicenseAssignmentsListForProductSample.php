...
print_r(listForProduct($service, $productId, $customerId));
...
*/
function listForProduct($service, $productId, $customerId)
{
	try
	{
		...
		return $service->listForProduct($productId, $customerId);
	}
	catch (Exception $ex)
	{
