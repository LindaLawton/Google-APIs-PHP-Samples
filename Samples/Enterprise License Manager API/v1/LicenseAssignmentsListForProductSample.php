...
print_r(licenseAssignmentsListForProductExample($service, $productId, $customerId));
...
*/
function licenseAssignmentsListForProductExample($service, $productId, $customerId)
{
	try
	{
		...
		return $service->licenseAssignments->ListForProductLicenseAssignments($productId, $customerId);
	}
	catch (Exception $ex)
	{
