...
do {
	...
	$results = filesListExample($service, $productId, $customerId, $optParams);	
...
*/
function licenseAssignmentsListForProductExample($service, $productId, $customerId, $optParams)
{
	try
	{
		...
		return $service->licenseAssignments->ListForProductLicenseAssignments($productId, $customerId, $optParams);
	}
	catch (Exception $e)
	{
