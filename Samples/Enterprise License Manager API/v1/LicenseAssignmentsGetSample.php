...
print_r(licenseAssignmentsGetExample($service, $productId, $skuId, $userId));
...
*/
function licenseAssignmentsGetExample($service, $productId, $skuId, $userId)
{
	try
	{
		...
		return $service->licenseAssignments->GetLicenseAssignments($productId, $skuId, $userId);
	}
	catch (Exception $ex)
	{
