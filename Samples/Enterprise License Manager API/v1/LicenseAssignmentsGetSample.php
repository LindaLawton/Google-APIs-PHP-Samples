...
$results = licenseAssignmentsGetExample($service, $productId, $skuId, $userId, $optParams);
...
*/
function licenseAssignmentsGetExample($service, $productId, $skuId, $userId, $optParams)
{
	try
	{
		...
		return $service->licenseAssignments->GetLicenseAssignments($productId, $skuId, $userId, $optParams);
	}
	catch (Exception $e)
	{
