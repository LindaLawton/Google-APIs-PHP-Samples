...
print_r(listForProductAndSku($service, $productId, $skuId, $customerId));
...
*/
function listForProductAndSku($service, $productId, $skuId, $customerId)
{
	try
	{
		...
		return $service->listForProductAndSku($productId, $skuId, $customerId);
	}
	catch (Exception $ex)
	{
