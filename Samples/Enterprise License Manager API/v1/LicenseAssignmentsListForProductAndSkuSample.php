...
print_r(licenseAssignmentsListForProductAndSkuExample($service, $productId, $skuId, $customerId));
...
* @skuId Name for sku
* @return LicenseAssignmentList</returns>
*/
function licenseAssignmentsListForProductAndSkuExample($service, $productId, $skuId, $customerId)
{
	try
	{
		...
		return $service->licenseAssignments->ListForProductAndSkuLicenseAssignments($productId, $skuId, $customerId);
	}
	catch (Exception $ex)
	{
