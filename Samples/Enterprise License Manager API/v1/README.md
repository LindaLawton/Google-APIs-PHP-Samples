...
# UnOfficial Enterprise License Manager API v1 Samples for PHP

## API Description

Views and manages licenses for your domain.

[Official Documentation](https://developers.google.com/google-apps/licensing/)

## Sample Description

These samples show how to access the [Enterprise License Manager API v1](https://developers.google.com/google-apps/licensing/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
