 ...
 * Initializes an Licensing.v1 service object.
 * @param string API key
 * @return An authorized Licensing.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Licensing Sample");
		...
		// Create authenticated Licensing service
		return new Google_Service_Licensing($client);
	} catch (Exception $e) {
