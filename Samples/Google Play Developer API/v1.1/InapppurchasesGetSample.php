...
print_r(inapppurchasesGetExample($service, $packageName, $productId, $token));
...
* @return InappPurchase</returns>
*/
function inapppurchasesGetExample($service, $packageName, $productId, $token)
{
	try
	{
		...
		return $service->inapppurchases->GetInapppurchases($packageName, $productId, $token);
	}
	catch (Exception $ex)
	{
