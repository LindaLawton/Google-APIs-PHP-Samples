...
// About 
// 
// Unofficial sample for the Android Publisher v1.1 API for PHP. 
...
// Single Request.
$results = inapppurchasesGetExample($service, $packageName, $productId, $token, $optParams);
...
*/
function inapppurchasesGetExample($service, $packageName, $productId, $token, $optParams)
{
	try
	{
		...
		return $service->inapppurchases->GetInapppurchases($packageName, $productId, $token, $optParams);
	}
	catch (Exception $e)
	{
