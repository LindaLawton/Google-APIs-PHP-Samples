 ...
 * Initializes an Androidpublisher.v1.1 service object.
 * @param string API key
 * @return An authorized Androidpublisher.v1.1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Androidpublisher Sample");
		...
		// Create authenticated Androidpublisher service
