...
print_r(purchasesGetExample($service, $packageName, $subscriptionId, $token));
...
*/
function purchasesGetExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->purchases->GetPurchases($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
