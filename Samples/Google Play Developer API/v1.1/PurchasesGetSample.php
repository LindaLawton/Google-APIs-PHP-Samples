...
print_r(get($service, $packageName, $subscriptionId, $token));
...
*/
function get($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->get($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
