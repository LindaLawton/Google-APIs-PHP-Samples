...
$results = purchasesGetExample($service, $packageName, $subscriptionId, $token, $optParams);
...
*/
function purchasesGetExample($service, $packageName, $subscriptionId, $token, $optParams)
{
	try
	{
		...
		return $service->purchases->GetPurchases($packageName, $subscriptionId, $token, $optParams);
	}
	catch (Exception $e)
	{
