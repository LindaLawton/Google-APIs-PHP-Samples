...
print_r(cancel($service, $packageName, $subscriptionId, $token));
...
*/
function cancel($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->cancel($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
