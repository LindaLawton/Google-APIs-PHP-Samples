...
print_r(purchasesCancelExample($service, $packageName, $subscriptionId, $token));
...
*/
function purchasesCancelExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->purchases->CancelPurchases($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
