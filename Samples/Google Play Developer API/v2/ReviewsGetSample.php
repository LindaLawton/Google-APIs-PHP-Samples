...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'translationLanguage' => '[YourValue]',  // 
  'fields' => '*'
);
// Single Request.
$results = reviewsGetExample($service, $packageName, $reviewId, $optParams);
...
* @return Review
*/
function reviewsGetExample($service, $packageName, $reviewId, $optParams)
{
	try
	{
		...
		if (reviewId == null)
			throw new Exception("reviewId is required.");
		// Make the request and return the results.
		return $service->reviews->GetReviews($packageName, $reviewId, $optParams);
	}
	catch (Exception $e)
	{
