...
print_r(reviewsGetExample($service, $packageName, $reviewId));
...
*/
function reviewsGetExample($service, $packageName, $reviewId)
{
	try
	{
		...
		return $service->reviews->GetReviews($packageName, $reviewId);
	}
	catch (Exception $ex)
	{
