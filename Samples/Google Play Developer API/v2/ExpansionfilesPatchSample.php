...
print_r(expansionfilesPatchExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
*/
function expansionfilesPatchExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->expansionfiles->PatchExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
