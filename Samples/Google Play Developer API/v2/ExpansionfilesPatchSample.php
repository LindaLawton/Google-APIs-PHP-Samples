...
print_r(patch($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
*/
function patch($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->patch($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
