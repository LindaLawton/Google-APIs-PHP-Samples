...
// Single Request.
$results = testersGetExample($service, $packageName, $editId, $track, $optParams);
...
* @return Testers
*/
function testersGetExample($service, $packageName, $editId, $track, $optParams)
{
	try
	{
		...
		return $service->testers->GetTesters($packageName, $editId, $track, $optParams);
	}
	catch (Exception $e)
	{
