...
print_r(testersGetExample($service, $packageName, $editId, $track));
...
*/
function testersGetExample($service, $packageName, $editId, $track)
{
	try
	{
		...
		return $service->testers->GetTesters($packageName, $editId, $track);
	}
	catch (Exception $ex)
	{
