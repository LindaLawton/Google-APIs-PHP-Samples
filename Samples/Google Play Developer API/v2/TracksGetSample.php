...
$results = tracksGetExample($service, $packageName, $editId, $track, $optParams);
...
* @return Track
*/
function tracksGetExample($service, $packageName, $editId, $track, $optParams)
{
	try
	{
		...
		return $service->tracks->GetTracks($packageName, $editId, $track, $optParams);
	}
	catch (Exception $e)
	{
