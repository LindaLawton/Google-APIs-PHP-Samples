...
print_r(tracksGetExample($service, $packageName, $editId, $track));
...
*/
function tracksGetExample($service, $packageName, $editId, $track)
{
	try
	{
		...
		return $service->tracks->GetTracks($packageName, $editId, $track);
	}
	catch (Exception $ex)
	{
