...
print_r(apksListExample($service, $packageName, $editId));
...
* @return ApksListResponse</returns>
*/
function apksListExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->apks->ListApks($packageName, $editId);
	}
	catch (Exception $ex)
	{
