...
// Single Request.
$results = apksListExample($service, $packageName, $editId, $optParams);
...
*/
function apksListExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->apks->ListApks($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
