...
print_r(imagesDeleteExample($service, $packageName, $editId, $language, $imageType, $imageId));
...
*/
function imagesDeleteExample($service, $packageName, $editId, $language, $imageType, $imageId)
{
	try
	{
		...
		if (imageId == null)
			throw new Exception("imageId is required.");
		if (imageType == null)
		...
		return $service->images->DeleteImages($packageName, $editId, $language, $imageType, $imageId);
	}
	catch (Exception $ex)
	{
