...
print_r(delete($service, $packageName, $editId, $language, $imageType, $imageId));
...
*/
function delete($service, $packageName, $editId, $language, $imageType, $imageId)
{
	try
	{
		...
		return $service->delete($packageName, $editId, $language, $imageType, $imageId);
	}
	catch (Exception $ex)
	{
