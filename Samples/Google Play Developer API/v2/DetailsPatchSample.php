...
print_r(detailsPatchExample($service, $packageName, $editId));
...
*/
function detailsPatchExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->details->PatchDetails($packageName, $editId);
	}
	catch (Exception $ex)
	{
