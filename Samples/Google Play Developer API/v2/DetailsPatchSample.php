...
// Single Request.
$results = detailsPatchExample($service, $packageName, $editId, $optParams);
...
* @return AppDetails
*/
function detailsPatchExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->details->PatchDetails($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
