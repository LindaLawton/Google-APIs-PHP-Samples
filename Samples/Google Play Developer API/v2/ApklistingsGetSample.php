...
print_r(apklistingsGetExample($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function apklistingsGetExample($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->apklistings->GetApklistings($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
