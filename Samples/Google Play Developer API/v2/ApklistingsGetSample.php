...
// Single Request.
$results = apklistingsGetExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams);
...
* @return ApkListing
*/
function apklistingsGetExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams)
{
	try
	{
		...
		return $service->apklistings->GetApklistings($packageName, $editId, $apkVersionCode, $language, $optParams);
	}
	catch (Exception $e)
	{
