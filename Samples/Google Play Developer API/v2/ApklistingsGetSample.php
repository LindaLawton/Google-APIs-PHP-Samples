...
print_r(get($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function get($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->get($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
