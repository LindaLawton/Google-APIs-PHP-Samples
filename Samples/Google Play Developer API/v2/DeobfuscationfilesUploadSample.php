...
print_r(upload($service, $packageName, $editId, $apkVersionCode, $deobfuscationFileType));
...
*/
function upload($service, $packageName, $editId, $apkVersionCode, $deobfuscationFileType)
{
	try
	{
		...
		return $service->upload($packageName, $editId, $apkVersionCode, $deobfuscationFileType);
	}
	catch (Exception $ex)
	{
