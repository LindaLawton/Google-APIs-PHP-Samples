...
// Single Request.
$results = deobfuscationfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $deobfuscationFileType, $optParams);
...
*/
function deobfuscationfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $deobfuscationFileType, $optParams)
{
	try
	{
		...
		return $service->deobfuscationfiles->UploadDeobfuscationfiles($packageName, $editId, $apkVersionCode, $deobfuscationFileType, $optParams);
	}
	catch (Exception $e)
	{
