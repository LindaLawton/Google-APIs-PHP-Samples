...
print_r(deobfuscationfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $deobfuscationFileType));
...
* @return DeobfuscationFilesUploadResponse</returns>
*/
function deobfuscationfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $deobfuscationFileType)
{
	try
	{
		...
		if (deobfuscationFileType == null)
			throw new Exception("deobfuscationFileType is required.");
		if (editId == null)
			throw new Exception("editId is required.");
		if (packageName == null)
			throw new Exception("packageName is required.");
		// Make the request and return the results.
		return $service->deobfuscationfiles->UploadDeobfuscationfiles($packageName, $editId, $apkVersionCode, $deobfuscationFileType);
	}
	catch (Exception $ex)
	{
