...
# UnOfficial Google Play Developer API v2 Samples for PHP
...
These samples show how to access the [Google Play Developer API v2](https://developers.google.com/android-publisher) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
