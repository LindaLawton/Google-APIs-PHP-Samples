...
print_r(testersPatchExample($service, $packageName, $editId, $track));
...
*/
function testersPatchExample($service, $packageName, $editId, $track)
{
	try
	{
		...
		return $service->testers->PatchTesters($packageName, $editId, $track);
	}
	catch (Exception $ex)
	{
