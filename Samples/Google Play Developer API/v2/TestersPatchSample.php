...
$results = testersPatchExample($service, $packageName, $editId, $track, $optParams);
...
* @return Testers
*/
function testersPatchExample($service, $packageName, $editId, $track, $optParams)
{
	try
	{
		...
		return $service->testers->PatchTesters($packageName, $editId, $track, $optParams);
	}
	catch (Exception $e)
	{
