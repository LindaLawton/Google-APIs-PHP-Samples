...
print_r(apklistingsListExample($service, $packageName, $editId, $apkVersionCode));
...
* @return ApkListingsListResponse</returns>
*/
function apklistingsListExample($service, $packageName, $editId, $apkVersionCode)
{
	try
	{
		...
		return $service->apklistings->ListApklistings($packageName, $editId, $apkVersionCode);
	}
	catch (Exception $ex)
	{
