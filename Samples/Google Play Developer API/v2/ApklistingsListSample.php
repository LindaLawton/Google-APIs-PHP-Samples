...
// Single Request.
$results = apklistingsListExample($service, $packageName, $editId, $apkVersionCode, $optParams);
...
*/
function apklistingsListExample($service, $packageName, $editId, $apkVersionCode, $optParams)
{
	try
	{
		...
		return $service->apklistings->ListApklistings($packageName, $editId, $apkVersionCode, $optParams);
	}
	catch (Exception $e)
	{
