...
print_r(list($service, $packageName, $editId, $apkVersionCode));
...
*/
function list($service, $packageName, $editId, $apkVersionCode)
{
	try
	{
		...
		return $service->list($packageName, $editId, $apkVersionCode);
	}
	catch (Exception $ex)
	{
