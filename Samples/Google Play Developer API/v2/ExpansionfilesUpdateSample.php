...
print_r(expansionfilesUpdateExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
* @return ExpansionFile</returns>
*/
function expansionfilesUpdateExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->expansionfiles->UpdateExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
