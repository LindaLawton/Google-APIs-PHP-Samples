...
// Single Request.
$results = expansionfilesUpdateExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType, $optParams);
...
*/
function expansionfilesUpdateExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType, $optParams)
{
	try
	{
		...
		return $service->expansionfiles->UpdateExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType, $optParams);
	}
	catch (Exception $e)
	{
