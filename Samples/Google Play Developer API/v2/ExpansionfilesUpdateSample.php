...
print_r(update($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
*/
function update($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->update($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
