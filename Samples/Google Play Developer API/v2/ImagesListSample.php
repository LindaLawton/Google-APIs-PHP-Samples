...
print_r(list($service, $packageName, $editId, $language, $imageType));
...
*/
function list($service, $packageName, $editId, $language, $imageType)
{
	try
	{
		...
		return $service->list($packageName, $editId, $language, $imageType);
	}
	catch (Exception $ex)
	{
