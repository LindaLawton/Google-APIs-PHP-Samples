...
// Single Request.
$results = imagesListExample($service, $packageName, $editId, $language, $imageType, $optParams);
...
*/
function imagesListExample($service, $packageName, $editId, $language, $imageType, $optParams)
{
	try
	{
		...
		return $service->images->ListImages($packageName, $editId, $language, $imageType, $optParams);
	}
	catch (Exception $e)
	{
