...
print_r(imagesListExample($service, $packageName, $editId, $language, $imageType));
...
* @return ImagesListResponse</returns>
*/
function imagesListExample($service, $packageName, $editId, $language, $imageType)
{
	try
	{
		...
		return $service->images->ListImages($packageName, $editId, $language, $imageType);
	}
	catch (Exception $ex)
	{
