...
// Single Request.
$results = listingsPatchExample($service, $packageName, $editId, $language, $optParams);
...
* @return Listing
*/
function listingsPatchExample($service, $packageName, $editId, $language, $optParams)
{
	try
	{
		...
		return $service->listings->PatchListings($packageName, $editId, $language, $optParams);
	}
	catch (Exception $e)
	{
