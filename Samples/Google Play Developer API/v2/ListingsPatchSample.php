...
print_r(listingsPatchExample($service, $packageName, $editId, $language));
...
*/
function listingsPatchExample($service, $packageName, $editId, $language)
{
	try
	{
		...
		return $service->listings->PatchListings($packageName, $editId, $language);
	}
	catch (Exception $ex)
	{
