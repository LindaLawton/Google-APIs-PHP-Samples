...
print_r(voidedpurchasesListExample($service, $packageName));
...
* @return VoidedPurchasesListResponse</returns>
*/
function voidedpurchasesListExample($service, $packageName)
{
	try
	{
		...
		return $service->voidedpurchases->ListVoidedpurchases($packageName);
	}
	catch (Exception $ex)
	{
