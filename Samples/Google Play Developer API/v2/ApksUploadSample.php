...
print_r(apksUploadExample($service, $packageName, $editId));
...
* @return Apk</returns>
*/
function apksUploadExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->apks->UploadApks($packageName, $editId);
	}
	catch (Exception $ex)
	{
