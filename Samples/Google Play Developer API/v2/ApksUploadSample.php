...
$results = apksUploadExample($service, $packageName, $editId, $optParams);
...
* @return Apk
*/
function apksUploadExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->apks->UploadApks($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
