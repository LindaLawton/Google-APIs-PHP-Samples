...
print_r(patch($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function patch($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->patch($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
