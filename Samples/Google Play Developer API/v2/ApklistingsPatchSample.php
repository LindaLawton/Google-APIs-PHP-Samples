...
print_r(apklistingsPatchExample($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function apklistingsPatchExample($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->apklistings->PatchApklistings($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
