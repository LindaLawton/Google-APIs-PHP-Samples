...
// Single Request.
$results = apklistingsPatchExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams);
...
* @return ApkListing
*/
function apklistingsPatchExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams)
{
	try
	{
		...
		return $service->apklistings->PatchApklistings($packageName, $editId, $apkVersionCode, $language, $optParams);
	}
	catch (Exception $e)
	{
