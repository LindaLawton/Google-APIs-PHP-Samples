...
print_r(tracksPatchExample($service, $packageName, $editId, $track));
...
*/
function tracksPatchExample($service, $packageName, $editId, $track)
{
	try
	{
		...
		return $service->tracks->PatchTracks($packageName, $editId, $track);
	}
	catch (Exception $ex)
	{
