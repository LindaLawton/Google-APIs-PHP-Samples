...
// Single Request.
$results = tracksPatchExample($service, $packageName, $editId, $track, $optParams);
...
* @return Track
*/
function tracksPatchExample($service, $packageName, $editId, $track, $optParams)
{
	try
	{
		...
		return $service->tracks->PatchTracks($packageName, $editId, $track, $optParams);
	}
	catch (Exception $e)
	{
