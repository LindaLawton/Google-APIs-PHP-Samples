...
print_r(inappproductsInsertExample($service, $packageName));
...
*/
function inappproductsInsertExample($service, $packageName)
{
	try
	{
		...
		return $service->inappproducts->InsertInappproducts($packageName);
	}
	catch (Exception $ex)
	{
