...
print_r(tracksListExample($service, $packageName, $editId));
...
* @return TracksListResponse</returns>
*/
function tracksListExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->tracks->ListTracks($packageName, $editId);
	}
	catch (Exception $ex)
	{
