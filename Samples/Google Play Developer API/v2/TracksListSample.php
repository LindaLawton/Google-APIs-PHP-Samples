...
$results = tracksListExample($service, $packageName, $editId, $optParams);
...
*/
function tracksListExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->tracks->ListTracks($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
