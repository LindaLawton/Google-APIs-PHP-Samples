...
print_r(detailsGetExample($service, $packageName, $editId));
...
*/
function detailsGetExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->details->GetDetails($packageName, $editId);
	}
	catch (Exception $ex)
	{
