...
// Single Request.
$results = detailsGetExample($service, $packageName, $editId, $optParams);
...
* @return AppDetails
*/
function detailsGetExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->details->GetDetails($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
