...
// Single Request.
$results = tracksUpdateExample($service, $packageName, $editId, $track, $optParams);
...
* @return Track
*/
function tracksUpdateExample($service, $packageName, $editId, $track, $optParams)
{
	try
	{
		...
		return $service->tracks->UpdateTracks($packageName, $editId, $track, $optParams);
	}
	catch (Exception $e)
	{
