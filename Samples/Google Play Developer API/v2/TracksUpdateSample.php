...
print_r(tracksUpdateExample($service, $packageName, $editId, $track));
...
*/
function tracksUpdateExample($service, $packageName, $editId, $track)
{
	try
	{
		...
		return $service->tracks->UpdateTracks($packageName, $editId, $track);
	}
	catch (Exception $ex)
	{
