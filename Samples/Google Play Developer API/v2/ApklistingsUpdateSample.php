...
print_r(update($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function update($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->update($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
