...
// Single Request.
$results = apklistingsUpdateExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams);
...
* @return ApkListing
*/
function apklistingsUpdateExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams)
{
	try
	{
		...
		return $service->apklistings->UpdateApklistings($packageName, $editId, $apkVersionCode, $language, $optParams);
	}
	catch (Exception $e)
	{
