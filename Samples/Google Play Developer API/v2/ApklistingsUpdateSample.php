...
print_r(apklistingsUpdateExample($service, $packageName, $editId, $apkVersionCode, $language));
...
* @return ApkListing</returns>
*/
function apklistingsUpdateExample($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->apklistings->UpdateApklistings($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
