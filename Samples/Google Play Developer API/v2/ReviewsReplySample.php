...
// Single Request.
$results = reviewsReplyExample($service, $packageName, $reviewId, $optParams);
...
*/
function reviewsReplyExample($service, $packageName, $reviewId, $optParams)
{
	try
	{
		...
		return $service->reviews->ReplyReviews($packageName, $reviewId, $optParams);
	}
	catch (Exception $e)
	{
