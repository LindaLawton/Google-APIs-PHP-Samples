...
print_r(reviewsReplyExample($service, $packageName, $reviewId));
...
* @reviewId 
* @return ReviewsReplyResponse</returns>
*/
function reviewsReplyExample($service, $packageName, $reviewId)
{
	try
	{
		...
		return $service->reviews->ReplyReviews($packageName, $reviewId);
	}
	catch (Exception $ex)
	{
