...
print_r(get($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
*/
function get($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->get($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
