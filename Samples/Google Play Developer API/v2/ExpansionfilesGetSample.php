...
// Single Request.
$results = expansionfilesGetExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType, $optParams);
...
*/
function expansionfilesGetExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType, $optParams)
{
	try
	{
		...
		return $service->expansionfiles->GetExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType, $optParams);
	}
	catch (Exception $e)
	{
