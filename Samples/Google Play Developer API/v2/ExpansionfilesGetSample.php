...
print_r(expansionfilesGetExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
*/
function expansionfilesGetExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->expansionfiles->GetExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
