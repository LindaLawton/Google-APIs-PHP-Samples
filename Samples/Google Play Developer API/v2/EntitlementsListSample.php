...
print_r(entitlementsListExample($service, $packageName));
...
*/
function entitlementsListExample($service, $packageName)
{
	try
	{
		...
		return $service->entitlements->ListEntitlements($packageName);
	}
	catch (Exception $ex)
	{
