...
print_r(productsGetExample($service, $packageName, $productId, $token));
...
* @return ProductPurchase</returns>
*/
function productsGetExample($service, $packageName, $productId, $token)
{
	try
	{
		...
		return $service->products->GetProducts($packageName, $productId, $token);
	}
	catch (Exception $ex)
	{
