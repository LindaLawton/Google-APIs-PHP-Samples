...
// Single Request.
$results = productsGetExample($service, $packageName, $productId, $token, $optParams);
...
*/
function productsGetExample($service, $packageName, $productId, $token, $optParams)
{
	try
	{
		...
		return $service->products->GetProducts($packageName, $productId, $token, $optParams);
	}
	catch (Exception $e)
	{
