...
$results = subscriptionsRefundExample($service, $packageName, $subscriptionId, $token, $optParams);
...
*/
function subscriptionsRefundExample($service, $packageName, $subscriptionId, $token, $optParams)
{
	try
	{
		...
		return $service->subscriptions->RefundSubscriptions($packageName, $subscriptionId, $token, $optParams);
	}
	catch (Exception $e)
	{
