...
print_r(refund($service, $packageName, $subscriptionId, $token));
...
*/
function refund($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->refund($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
