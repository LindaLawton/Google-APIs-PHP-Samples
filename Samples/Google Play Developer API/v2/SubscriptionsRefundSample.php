...
print_r(subscriptionsRefundExample($service, $packageName, $subscriptionId, $token));
...
*/
function subscriptionsRefundExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->subscriptions->RefundSubscriptions($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
