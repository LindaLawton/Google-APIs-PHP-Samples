...
// Single Request.
$results = detailsUpdateExample($service, $packageName, $editId, $optParams);
...
* @return AppDetails
*/
function detailsUpdateExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->details->UpdateDetails($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
