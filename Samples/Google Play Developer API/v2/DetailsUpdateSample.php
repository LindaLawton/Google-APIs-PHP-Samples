...
print_r(detailsUpdateExample($service, $packageName, $editId));
...
* @return AppDetails</returns>
*/
function detailsUpdateExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->details->UpdateDetails($packageName, $editId);
	}
	catch (Exception $ex)
	{
