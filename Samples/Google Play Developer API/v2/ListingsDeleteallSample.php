...
$results = listingsDeleteallExample($service, $packageName, $editId, $optParams);
...
*/
function listingsDeleteallExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->listings->DeleteallListings($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
