...
print_r(listingsDeleteallExample($service, $packageName, $editId));
...
*/
function listingsDeleteallExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->listings->DeleteallListings($packageName, $editId);
	}
	catch (Exception $ex)
	{
