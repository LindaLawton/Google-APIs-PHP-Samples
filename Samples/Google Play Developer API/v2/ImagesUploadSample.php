...
// Single Request.
$results = imagesUploadExample($service, $packageName, $editId, $language, $imageType, $optParams);
...
*/
function imagesUploadExample($service, $packageName, $editId, $language, $imageType, $optParams)
{
	try
	{
		...
		return $service->images->UploadImages($packageName, $editId, $language, $imageType, $optParams);
	}
	catch (Exception $e)
	{
