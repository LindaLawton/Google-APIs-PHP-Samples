...
print_r(upload($service, $packageName, $editId, $language, $imageType));
...
*/
function upload($service, $packageName, $editId, $language, $imageType)
{
	try
	{
		...
		return $service->upload($packageName, $editId, $language, $imageType);
	}
	catch (Exception $ex)
	{
