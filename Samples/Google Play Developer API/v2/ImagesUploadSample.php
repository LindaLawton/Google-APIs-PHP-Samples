...
print_r(imagesUploadExample($service, $packageName, $editId, $language, $imageType));
...
* @return ImagesUploadResponse</returns>
*/
function imagesUploadExample($service, $packageName, $editId, $language, $imageType)
{
	try
	{
		...
		return $service->images->UploadImages($packageName, $editId, $language, $imageType);
	}
	catch (Exception $ex)
	{
