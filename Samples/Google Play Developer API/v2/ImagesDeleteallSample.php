...
// Single Request.
$results = imagesDeleteallExample($service, $packageName, $editId, $language, $imageType, $optParams);
...
*/
function imagesDeleteallExample($service, $packageName, $editId, $language, $imageType, $optParams)
{
	try
	{
		...
		return $service->images->DeleteallImages($packageName, $editId, $language, $imageType, $optParams);
	}
	catch (Exception $e)
	{
