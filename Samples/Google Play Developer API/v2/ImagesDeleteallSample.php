...
print_r(imagesDeleteallExample($service, $packageName, $editId, $language, $imageType));
...
* @return ImagesDeleteAllResponse</returns>
*/
function imagesDeleteallExample($service, $packageName, $editId, $language, $imageType)
{
	try
	{
		...
		return $service->images->DeleteallImages($packageName, $editId, $language, $imageType);
	}
	catch (Exception $ex)
	{
