...
print_r(deleteall($service, $packageName, $editId, $language, $imageType));
...
*/
function deleteall($service, $packageName, $editId, $language, $imageType)
{
	try
	{
		...
		return $service->deleteall($packageName, $editId, $language, $imageType);
	}
	catch (Exception $ex)
	{
