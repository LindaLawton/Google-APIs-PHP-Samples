...
print_r(apksAddexternallyhostedExample($service, $packageName, $editId));
...
* @return ApksAddExternallyHostedResponse</returns>
*/
function apksAddexternallyhostedExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->apks->AddexternallyhostedApks($packageName, $editId);
	}
	catch (Exception $ex)
	{
