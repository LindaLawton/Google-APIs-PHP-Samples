...
// Single Request.
$results = apksAddexternallyhostedExample($service, $packageName, $editId, $optParams);
...
*/
function apksAddexternallyhostedExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->apks->AddexternallyhostedApks($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
