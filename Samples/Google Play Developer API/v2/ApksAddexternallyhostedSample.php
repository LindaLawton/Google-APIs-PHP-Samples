...
print_r(addexternallyhosted($service, $packageName, $editId));
...
*/
function addexternallyhosted($service, $packageName, $editId)
{
	try
	{
		...
		return $service->addexternallyhosted($packageName, $editId);
	}
	catch (Exception $ex)
	{
