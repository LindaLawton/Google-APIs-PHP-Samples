...
print_r(subscriptionsRevokeExample($service, $packageName, $subscriptionId, $token));
...
*/
function subscriptionsRevokeExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->subscriptions->RevokeSubscriptions($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
