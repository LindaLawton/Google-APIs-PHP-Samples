...
print_r(inappproductsGetExample($service, $packageName, $sku));
...
*/
function inappproductsGetExample($service, $packageName, $sku)
{
	try
	{
		...
		return $service->inappproducts->GetInappproducts($packageName, $sku);
	}
	catch (Exception $ex)
	{
