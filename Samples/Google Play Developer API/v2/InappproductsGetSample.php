...
$results = inappproductsGetExample($service, $packageName, $sku, $optParams);
...
* @return InAppProduct
*/
function inappproductsGetExample($service, $packageName, $sku, $optParams)
{
	try
	{
		...
		return $service->inappproducts->GetInappproducts($packageName, $sku, $optParams);
	}
	catch (Exception $e)
	{
