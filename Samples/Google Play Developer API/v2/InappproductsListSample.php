...
// Single Request.
$results = inappproductsListExample($service, $packageName, $optParams);
...
*/
function inappproductsListExample($service, $packageName, $optParams)
{
	try
	{
		...
		return $service->inappproducts->ListInappproducts($packageName, $optParams);
	}
	catch (Exception $e)
	{
