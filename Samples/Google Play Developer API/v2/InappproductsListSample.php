...
print_r(inappproductsListExample($service, $packageName));
...
* @return InappproductsListResponse</returns>
*/
function inappproductsListExample($service, $packageName)
{
	try
	{
		...
		return $service->inappproducts->ListInappproducts($packageName);
	}
	catch (Exception $ex)
	{
