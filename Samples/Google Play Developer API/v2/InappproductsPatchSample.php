...
print_r(inappproductsPatchExample($service, $packageName, $sku));
...
*/
function inappproductsPatchExample($service, $packageName, $sku)
{
	try
	{
		...
		return $service->inappproducts->PatchInappproducts($packageName, $sku);
	}
	catch (Exception $ex)
	{
