...
// Single Request.
$results = inappproductsPatchExample($service, $packageName, $sku, $optParams);
...
* @return InAppProduct
*/
function inappproductsPatchExample($service, $packageName, $sku, $optParams)
{
	try
	{
		...
		return $service->inappproducts->PatchInappproducts($packageName, $sku, $optParams);
	}
	catch (Exception $e)
	{
