...
print_r(listingsGetExample($service, $packageName, $editId, $language));
...
*/
function listingsGetExample($service, $packageName, $editId, $language)
{
	try
	{
		...
		return $service->listings->GetListings($packageName, $editId, $language);
	}
	catch (Exception $ex)
	{
