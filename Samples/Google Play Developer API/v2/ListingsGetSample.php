...
$results = listingsGetExample($service, $packageName, $editId, $language, $optParams);
...
* @return Listing
*/
function listingsGetExample($service, $packageName, $editId, $language, $optParams)
{
	try
	{
		...
		return $service->listings->GetListings($packageName, $editId, $language, $optParams);
	}
	catch (Exception $e)
	{
