...
$results = testersUpdateExample($service, $packageName, $editId, $track, $optParams);
...
* @return Testers
*/
function testersUpdateExample($service, $packageName, $editId, $track, $optParams)
{
	try
	{
		...
		return $service->testers->UpdateTesters($packageName, $editId, $track, $optParams);
	}
	catch (Exception $e)
	{
