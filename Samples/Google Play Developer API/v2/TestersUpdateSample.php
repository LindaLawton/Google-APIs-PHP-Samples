...
print_r(testersUpdateExample($service, $packageName, $editId, $track));
...
* @track 
* @return Testers</returns>
*/
function testersUpdateExample($service, $packageName, $editId, $track)
{
	try
	{
		...
		return $service->testers->UpdateTesters($packageName, $editId, $track);
	}
	catch (Exception $ex)
	{
