...
$results = inappproductsDeleteExample($service, $packageName, $sku, $optParams);
...
*/
function inappproductsDeleteExample($service, $packageName, $sku, $optParams)
{
	try
	{
		...
		return $service->inappproducts->DeleteInappproducts($packageName, $sku, $optParams);
	}
	catch (Exception $e)
	{
