...
print_r(inappproductsDeleteExample($service, $packageName, $sku));
...
*/
function inappproductsDeleteExample($service, $packageName, $sku)
{
	try
	{
		...
		return $service->inappproducts->DeleteInappproducts($packageName, $sku);
	}
	catch (Exception $ex)
	{
