...
$results = subscriptionsCancelExample($service, $packageName, $subscriptionId, $token, $optParams);
...
*/
function subscriptionsCancelExample($service, $packageName, $subscriptionId, $token, $optParams)
{
	try
	{
		...
		return $service->subscriptions->CancelSubscriptions($packageName, $subscriptionId, $token, $optParams);
	}
	catch (Exception $e)
	{
