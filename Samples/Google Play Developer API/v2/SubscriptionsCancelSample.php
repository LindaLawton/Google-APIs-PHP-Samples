...
print_r(subscriptionsCancelExample($service, $packageName, $subscriptionId, $token));
...
*/
function subscriptionsCancelExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->subscriptions->CancelSubscriptions($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
