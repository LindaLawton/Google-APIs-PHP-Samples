...
print_r(upload($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
*/
function upload($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->upload($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
