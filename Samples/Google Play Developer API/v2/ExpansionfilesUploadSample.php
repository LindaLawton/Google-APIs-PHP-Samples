...
print_r(expansionfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType));
...
* @return ExpansionFilesUploadResponse</returns>
*/
function expansionfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType)
{
	try
	{
		...
		return $service->expansionfiles->UploadExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType);
	}
	catch (Exception $ex)
	{
