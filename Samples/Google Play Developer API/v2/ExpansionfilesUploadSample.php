...
$results = expansionfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType, $optParams);
...
*/
function expansionfilesUploadExample($service, $packageName, $editId, $apkVersionCode, $expansionFileType, $optParams)
{
	try
	{
		...
		return $service->expansionfiles->UploadExpansionfiles($packageName, $editId, $apkVersionCode, $expansionFileType, $optParams);
	}
	catch (Exception $e)
	{
