...
print_r(inappproductsBatchExample($service));

/**
* 
* @service Authenticated Androidpublisher service.
* @return InappproductsBatchResponse</returns>
*/
function inappproductsBatchExample($service)
{
	try
	{
		...
		return $service->inappproducts->BatchInappproducts();
	}
	catch (Exception $ex)
	{
