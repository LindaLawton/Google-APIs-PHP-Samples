...
// Single Request.
$results = inappproductsBatchExample($service, $optParams);
...
* @return InappproductsBatchResponse
*/
function inappproductsBatchExample($service, $optParams)
{
	try
	{
		...
		return $service->inappproducts->BatchInappproducts($optParams);
	}
	catch (Exception $e)
	{
