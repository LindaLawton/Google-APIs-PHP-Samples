...
print_r(defer($service, $packageName, $subscriptionId, $token));
...
*/
function defer($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->defer($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
