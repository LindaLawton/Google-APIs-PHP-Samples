...
print_r(subscriptionsDeferExample($service, $packageName, $subscriptionId, $token));
...
* @return SubscriptionPurchasesDeferResponse</returns>
*/
function subscriptionsDeferExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->subscriptions->DeferSubscriptions($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
