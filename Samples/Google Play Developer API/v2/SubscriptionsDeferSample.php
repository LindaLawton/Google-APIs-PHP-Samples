...
$results = subscriptionsDeferExample($service, $packageName, $subscriptionId, $token, $optParams);
...
*/
function subscriptionsDeferExample($service, $packageName, $subscriptionId, $token, $optParams)
{
	try
	{
		...
		return $service->subscriptions->DeferSubscriptions($packageName, $subscriptionId, $token, $optParams);
	}
	catch (Exception $e)
	{
