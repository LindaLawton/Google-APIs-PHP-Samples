...
print_r(apklistingsDeleteExample($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function apklistingsDeleteExample($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->apklistings->DeleteApklistings($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
