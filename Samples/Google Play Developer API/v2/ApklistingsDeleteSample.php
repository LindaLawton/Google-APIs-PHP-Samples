...
print_r(delete($service, $packageName, $editId, $apkVersionCode, $language));
...
*/
function delete($service, $packageName, $editId, $apkVersionCode, $language)
{
	try
	{
		...
		return $service->delete($packageName, $editId, $apkVersionCode, $language);
	}
	catch (Exception $ex)
	{
