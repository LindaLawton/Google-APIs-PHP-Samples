...
$results = apklistingsDeleteExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams);
...
*/
function apklistingsDeleteExample($service, $packageName, $editId, $apkVersionCode, $language, $optParams)
{
	try
	{
		...
		return $service->apklistings->DeleteApklistings($packageName, $editId, $apkVersionCode, $language, $optParams);
	}
	catch (Exception $e)
	{
