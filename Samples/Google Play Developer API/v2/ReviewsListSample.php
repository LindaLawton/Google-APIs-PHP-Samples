...
print_r(reviewsListExample($service, $packageName));
...
* @return ReviewsListResponse</returns>
*/
function reviewsListExample($service, $packageName)
{
	try
	{
		...
		return $service->reviews->ListReviews($packageName);
	}
	catch (Exception $ex)
	{
