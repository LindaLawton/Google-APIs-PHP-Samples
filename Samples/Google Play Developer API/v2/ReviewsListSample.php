...
// Single Request.
$results = reviewsListExample($service, $packageName, $optParams);
...
*/
function reviewsListExample($service, $packageName, $optParams)
{
	try
	{
		...
		return $service->reviews->ListReviews($packageName, $optParams);
	}
	catch (Exception $e)
	{
