...
print_r(update($service, $packageName, $editId, $language));
...
*/
function update($service, $packageName, $editId, $language)
{
	try
	{
		...
		return $service->update($packageName, $editId, $language);
	}
	catch (Exception $ex)
	{
