...
print_r(listingsUpdateExample($service, $packageName, $editId, $language));
...
* @return Listing</returns>
*/
function listingsUpdateExample($service, $packageName, $editId, $language)
{
	try
	{
		...
		return $service->listings->UpdateListings($packageName, $editId, $language);
	}
	catch (Exception $ex)
	{
