...
// Single Request.
$results = listingsUpdateExample($service, $packageName, $editId, $language, $optParams);
...
* @return Listing
*/
function listingsUpdateExample($service, $packageName, $editId, $language, $optParams)
{
	try
	{
		...
		return $service->listings->UpdateListings($packageName, $editId, $language, $optParams);
	}
	catch (Exception $e)
	{
