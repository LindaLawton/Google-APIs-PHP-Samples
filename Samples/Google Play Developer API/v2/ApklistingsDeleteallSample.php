...
$results = apklistingsDeleteallExample($service, $packageName, $editId, $apkVersionCode, $optParams);
...
*/
function apklistingsDeleteallExample($service, $packageName, $editId, $apkVersionCode, $optParams)
{
	try
	{
		...
		return $service->apklistings->DeleteallApklistings($packageName, $editId, $apkVersionCode, $optParams);
	}
	catch (Exception $e)
	{
