...
print_r(apklistingsDeleteallExample($service, $packageName, $editId, $apkVersionCode));
...
*/
function apklistingsDeleteallExample($service, $packageName, $editId, $apkVersionCode)
{
	try
	{
		...
		return $service->apklistings->DeleteallApklistings($packageName, $editId, $apkVersionCode);
	}
	catch (Exception $ex)
	{
