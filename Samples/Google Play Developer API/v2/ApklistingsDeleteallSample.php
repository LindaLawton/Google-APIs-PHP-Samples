...
print_r(deleteall($service, $packageName, $editId, $apkVersionCode));
...
*/
function deleteall($service, $packageName, $editId, $apkVersionCode)
{
	try
	{
		...
		return $service->deleteall($packageName, $editId, $apkVersionCode);
	}
	catch (Exception $ex)
	{
