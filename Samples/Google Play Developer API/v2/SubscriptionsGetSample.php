...
print_r(subscriptionsGetExample($service, $packageName, $subscriptionId, $token));
...
* @return SubscriptionPurchase</returns>
*/
function subscriptionsGetExample($service, $packageName, $subscriptionId, $token)
{
	try
	{
		...
		return $service->subscriptions->GetSubscriptions($packageName, $subscriptionId, $token);
	}
	catch (Exception $ex)
	{
