...
// Single Request.
$results = inappproductsUpdateExample($service, $packageName, $sku, $optParams);
...
* @return InAppProduct
*/
function inappproductsUpdateExample($service, $packageName, $sku, $optParams)
{
	try
	{
		...
		return $service->inappproducts->UpdateInappproducts($packageName, $sku, $optParams);
	}
	catch (Exception $e)
	{
