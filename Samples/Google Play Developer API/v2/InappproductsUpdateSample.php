...
print_r(inappproductsUpdateExample($service, $packageName, $sku));
...
* @return InAppProduct</returns>
*/
function inappproductsUpdateExample($service, $packageName, $sku)
{
	try
	{
		...
		return $service->inappproducts->UpdateInappproducts($packageName, $sku);
	}
	catch (Exception $ex)
	{
