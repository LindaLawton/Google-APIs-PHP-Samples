...
print_r(listingsDeleteExample($service, $packageName, $editId, $language));
...
*/
function listingsDeleteExample($service, $packageName, $editId, $language)
{
	try
	{
		...
		return $service->listings->DeleteListings($packageName, $editId, $language);
	}
	catch (Exception $ex)
	{
