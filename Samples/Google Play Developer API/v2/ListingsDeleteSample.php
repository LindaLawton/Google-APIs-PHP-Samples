...
print_r(delete($service, $packageName, $editId, $language));
...
*/
function delete($service, $packageName, $editId, $language)
{
	try
	{
		...
		return $service->delete($packageName, $editId, $language);
	}
	catch (Exception $ex)
	{
