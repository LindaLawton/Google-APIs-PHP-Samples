...
print_r(listingsListExample($service, $packageName, $editId));
...
* @return ListingsListResponse</returns>
*/
function listingsListExample($service, $packageName, $editId)
{
	try
	{
		...
		return $service->listings->ListListings($packageName, $editId);
	}
	catch (Exception $ex)
	{
