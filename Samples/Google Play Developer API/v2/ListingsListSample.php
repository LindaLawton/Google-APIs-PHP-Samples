...
// Single Request.
$results = listingsListExample($service, $packageName, $editId, $optParams);
...
*/
function listingsListExample($service, $packageName, $editId, $optParams)
{
	try
	{
		...
		return $service->listings->ListListings($packageName, $editId, $optParams);
	}
	catch (Exception $e)
	{
