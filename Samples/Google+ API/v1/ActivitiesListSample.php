...
print_r(activitiesListExample($service, $userId, $collection));
...
* @return ActivityFeed</returns>
*/
function activitiesListExample($service, $userId, $collection)
{
	try
	{
		...
		return $service->activities->ListActivities($userId, $collection);
	}
	catch (Exception $ex)
	{
