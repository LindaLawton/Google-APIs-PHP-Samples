...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'orderBy' => '[YourValue]',  //Specifies how to order search results.
...
// Single Request.
$results = activitiesSearchExample($service, $query, $optParams);
...
* @return ActivityFeed
*/
function activitiesSearchExample($service, $query, $optParams)
{
	try
	{
		...
		return $service->activities->SearchActivities($query, $optParams);
	}
	catch (Exception $e)
	{
