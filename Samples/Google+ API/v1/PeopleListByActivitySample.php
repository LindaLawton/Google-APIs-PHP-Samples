...
$results = peopleListByActivityExample($service, $activityId, $collection, $optParams);
...
do {
	...
	$results = filesListExample($service, $activityId, $collection, $optParams);	
...
* @return PeopleFeed
*/
function peopleListByActivityExample($service, $activityId, $collection, $optParams)
{
	try
	{
		...
		return $service->people->ListByActivityPeople($activityId, $collection, $optParams);
	}
	catch (Exception $e)
	{
