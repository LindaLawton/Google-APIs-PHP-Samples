...
# UnOfficial Google+ API v1 Samples for PHP

## API Description

Builds on top of the Google+ platform.

[Official Documentation](https://developers.google.com/+/api/)

## Sample Description

These samples show how to access the [Google+ API v1](https://developers.google.com/+/api/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
