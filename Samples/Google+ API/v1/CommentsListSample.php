...
print_r(commentsListExample($service, $activityId));

/**
* List all of the comments for an activity.
* @service Authenticated Plus service.
* @activityId The ID of the activity to get comments for.
* @return CommentFeed</returns>
*/
function commentsListExample($service, $activityId)
{
	try
	{
		...
		return $service->comments->ListComments($activityId);
	}
	catch (Exception $ex)
	{
