...
do {
	...
	$results = filesListExample($service, $activityId, $optParams);	
...
* @return CommentFeed
*/
function commentsListExample($service, $activityId, $optParams)
{
	try
	{
		...
		return $service->comments->ListComments($activityId, $optParams);
	}
	catch (Exception $e)
	{
