 ...
 * Initializes an Plus.v1 service object.
 * @param string API key
 * @return An authorized Plus.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Plus Sample");
		...
		// Create authenticated Plus service
