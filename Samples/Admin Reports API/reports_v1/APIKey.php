 ...
 * Initializes an Reports.reports_v1 service object.
 * @param string API key
 * @return An authorized Reports.reports_v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Reports Sample");
		...
		// Create authenticated Reports service
