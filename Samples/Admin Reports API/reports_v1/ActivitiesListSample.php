...
print_r(activitiesListExample($service, $userKey, $applicationName));
...
* @return Activities</returns>
*/
function activitiesListExample($service, $userKey, $applicationName)
{
	try
	{
		...
		return $service->activities->ListActivities($userKey, $applicationName);
	}
	catch (Exception $ex)
	{
