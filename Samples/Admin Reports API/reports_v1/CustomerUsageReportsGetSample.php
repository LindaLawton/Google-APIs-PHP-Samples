...
print_r(customerUsageReportsGetExample($service, $date));
...
*/
function customerUsageReportsGetExample($service, $date)
{
	try
	{
		...
		return $service->customerUsageReports->GetCustomerUsageReports($date);
	}
	catch (Exception $ex)
	{
