...
do {
	...
	$results = filesListExample($service, $date, $optParams);	
...
* @return UsageReports
*/
function customerUsageReportsGetExample($service, $date, $optParams)
{
	try
	{
		...
		return $service->customerUsageReports->GetCustomerUsageReports($date, $optParams);
	}
	catch (Exception $e)
	{
