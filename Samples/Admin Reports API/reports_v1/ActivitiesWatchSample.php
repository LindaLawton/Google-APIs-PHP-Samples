...
print_r(activitiesWatchExample($service, $userKey, $applicationName));
...
*/
function activitiesWatchExample($service, $userKey, $applicationName)
{
	try
	{
		...
		return $service->activities->WatchActivities($userKey, $applicationName);
	}
	catch (Exception $ex)
	{
