...
print_r(userUsageReportGetExample($service, $userKey, $date));
...
* @return UsageReports</returns>
*/
function userUsageReportGetExample($service, $userKey, $date)
{
	try
	{
		...
		return $service->userUsageReport->GetUserUsageReport($userKey, $date);
	}
	catch (Exception $ex)
	{
