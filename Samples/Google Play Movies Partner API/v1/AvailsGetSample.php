...
print_r(availsGetExample($service, $accountId, $availId));
...
* @return Avail</returns>
*/
function availsGetExample($service, $accountId, $availId)
{
	try
	{
		...
		return $service->avails->GetAvails($accountId, $availId);
	}
	catch (Exception $ex)
	{
