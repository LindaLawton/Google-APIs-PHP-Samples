...
// Single Request.
$results = availsGetExample($service, $accountId, $availId, $optParams);
...
* @return Avail
*/
function availsGetExample($service, $accountId, $availId, $optParams)
{
	try
	{
		...
		if (availId == null)
			throw new Exception("availId is required.");
		if (accountId == null)
			throw new Exception("accountId is required.");
		// Make the request and return the results.
		return $service->avails->GetAvails($accountId, $availId, $optParams);
	}
	catch (Exception $e)
	{
