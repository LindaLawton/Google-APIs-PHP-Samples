...
$results = countryGetExample($service, $accountId, $videoId, $country, $optParams);
...
* @return StoreInfo
*/
function countryGetExample($service, $accountId, $videoId, $country, $optParams)
{
	try
	{
		...
		return $service->country->GetCountry($accountId, $videoId, $country, $optParams);
	}
	catch (Exception $e)
	{
