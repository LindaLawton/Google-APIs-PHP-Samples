...
print_r(countryGetExample($service, $accountId, $videoId, $country));
...
*/
function countryGetExample($service, $accountId, $videoId, $country)
{
	try
	{
		...
		return $service->country->GetCountry($accountId, $videoId, $country);
	}
	catch (Exception $ex)
	{
