...
print_r(ordersListExample($service, $accountId));
...
* @return ListOrdersResponse</returns>
*/
function ordersListExample($service, $accountId)
{
	try
	{
		...
		return $service->orders->ListOrders($accountId);
	}
	catch (Exception $ex)
	{
