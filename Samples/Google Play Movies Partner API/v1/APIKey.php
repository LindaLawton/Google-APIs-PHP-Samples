 ...
 * Initializes an Playmovies.v1 service object.
 * @param string API key
 * @return An authorized Playmovies.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Playmovies Sample");
		...
		// Create authenticated Playmovies service
		return new Google_Service_Playmovies($client);
	} catch (Exception $e) {
