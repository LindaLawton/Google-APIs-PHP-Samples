...
# UnOfficial Google Play Movies Partner API v1 Samples for PHP

## API Description

Gets the delivery status of titles for Google Play Movies Partners.

[Official Documentation](https://developers.google.com/playmoviespartner/)

## Sample Description

These samples show how to access the [Google Play Movies Partner API v1](https://developers.google.com/playmoviespartner/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
