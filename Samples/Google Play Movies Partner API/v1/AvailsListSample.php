...
print_r(availsListExample($service, $accountId));
...
* @return ListAvailsResponse</returns>
*/
function availsListExample($service, $accountId)
{
	try
	{
		...
		return $service->avails->ListAvails($accountId);
	}
	catch (Exception $ex)
	{
