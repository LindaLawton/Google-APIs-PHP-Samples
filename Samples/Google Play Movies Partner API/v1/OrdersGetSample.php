...
print_r(ordersGetExample($service, $accountId, $orderId));
...
*/
function ordersGetExample($service, $accountId, $orderId)
{
	try
	{
		...
		return $service->orders->GetOrders($accountId, $orderId);
	}
	catch (Exception $ex)
	{
