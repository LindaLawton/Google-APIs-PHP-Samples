...
# Unoffical Stackdriver Monitoring API Samples for PHP
...
These samples show how to access the [Stackdriver Monitoring API](https://cloud.google.com/monitoring/api/) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
