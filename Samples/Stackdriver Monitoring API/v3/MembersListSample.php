...
print_r(membersListExample($service, $name));
...
* @return ListGroupMembersResponse</returns>
*/
function membersListExample($service, $name)
{
	try
	{
		...
		return $service->members->ListMembers($name);
	}
	catch (Exception $ex)
	{
