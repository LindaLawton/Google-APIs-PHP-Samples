...
// Single Request.
$results = metricDescriptorsGetExample($service, $name, $optParams);
...
*/
function metricDescriptorsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->metricDescriptors->GetMetricDescriptors($name, $optParams);
	}
	catch (Exception $e)
	{
