...
print_r(metricDescriptorsGetExample($service, $name));
...
*/
function metricDescriptorsGetExample($service, $name)
{
	try
	{
		...
		return $service->metricDescriptors->GetMetricDescriptors($name);
	}
	catch (Exception $ex)
	{
