...
print_r(monitoredResourceDescriptorsGetExample($service, $name));
...
* @return MonitoredResourceDescriptor</returns>
*/
function monitoredResourceDescriptorsGetExample($service, $name)
{
	try
	{
		...
		return $service->monitoredResourceDescriptors->GetMonitoredResourceDescriptors($name);
	}
	catch (Exception $ex)
	{
