...
// Single Request.
$results = monitoredResourceDescriptorsGetExample($service, $name, $optParams);
...
*/
function monitoredResourceDescriptorsGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->monitoredResourceDescriptors->GetMonitoredResourceDescriptors($name, $optParams);
	}
	catch (Exception $e)
	{
