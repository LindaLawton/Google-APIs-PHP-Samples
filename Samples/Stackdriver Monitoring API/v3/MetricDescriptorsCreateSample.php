...
print_r(metricDescriptorsCreateExample($service, $name));
...
*/
function metricDescriptorsCreateExample($service, $name)
{
	try
	{
		...
		return $service->metricDescriptors->CreateMetricDescriptors($name);
	}
	catch (Exception $ex)
	{
