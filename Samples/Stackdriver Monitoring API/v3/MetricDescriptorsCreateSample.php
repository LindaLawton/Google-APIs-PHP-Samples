...
// Single Request.
$results = metricDescriptorsCreateExample($service, $name, $optParams);
...
*/
function metricDescriptorsCreateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->metricDescriptors->CreateMetricDescriptors($name, $optParams);
	}
	catch (Exception $e)
	{
