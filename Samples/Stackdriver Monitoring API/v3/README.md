...
# UnOfficial Stackdriver Monitoring API v3 Samples for PHP
...
[Official Documentation](https://cloud.google.com/monitoring/api/)

## Sample Description

These samples show how to access the [Stackdriver Monitoring API v3](https://cloud.google.com/monitoring/api/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
