...
print_r(monitoredResourceDescriptorsListExample($service, $name));
...
* @return ListMonitoredResourceDescriptorsResponse</returns>
*/
function monitoredResourceDescriptorsListExample($service, $name)
{
	try
	{
		...
		return $service->monitoredResourceDescriptors->ListMonitoredResourceDescriptors($name);
	}
	catch (Exception $ex)
	{
