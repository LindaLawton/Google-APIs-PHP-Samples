 ...
 * Initializes an Monitoring.v3 service object.
 * @param string API key
 * @return An authorized Monitoring.v3 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Monitoring Sample");
		...
		// Create authenticated Monitoring service
		return new Google_Service_Monitoring($client);
	} catch (Exception $e) {
