...
$results = timeSeriesCreateExample($service, $name, $optParams);
...
* @return Empty
*/
function timeSeriesCreateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->timeSeries->CreateTimeSeries($name, $optParams);
	}
	catch (Exception $e)
	{
