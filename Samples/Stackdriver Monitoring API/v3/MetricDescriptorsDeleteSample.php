...
print_r(metricDescriptorsDeleteExample($service, $name));
...
*/
function metricDescriptorsDeleteExample($service, $name)
{
	try
	{
		...
		return $service->metricDescriptors->DeleteMetricDescriptors($name);
	}
	catch (Exception $ex)
	{
