...
$results = collectdTimeSeriesCreateExample($service, $name, $optParams);
...
*/
function collectdTimeSeriesCreateExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->collectdTimeSeries->CreateCollectdTimeSeries($name, $optParams);
	}
	catch (Exception $e)
	{
