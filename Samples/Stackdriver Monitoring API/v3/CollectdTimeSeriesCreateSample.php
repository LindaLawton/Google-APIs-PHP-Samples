...
print_r(collectdTimeSeriesCreateExample($service, $name));
...
* @return CreateCollectdTimeSeriesResponse</returns>
*/
function collectdTimeSeriesCreateExample($service, $name)
{
	try
	{
		...
		return $service->collectdTimeSeries->CreateCollectdTimeSeries($name);
	}
	catch (Exception $ex)
	{
