...
print_r(metricDescriptorsListExample($service, $name));
...
*/
function metricDescriptorsListExample($service, $name)
{
	try
	{
		...
		return $service->metricDescriptors->ListMetricDescriptors($name);
	}
	catch (Exception $ex)
	{
