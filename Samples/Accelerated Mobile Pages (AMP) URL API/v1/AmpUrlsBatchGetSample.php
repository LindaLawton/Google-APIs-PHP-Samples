...
* $service = new Google_Service_Acceleratedmobilepageurl($client); 
****************************************************/
...
$results = ampUrlsBatchGetExample($service, $optParams);


/**
* Returns AMP URL(s) and equivalent[AMP Cache URL(s)](/amp/cache/overview#amp-cache-url-format).
* @service Authenticated Acceleratedmobilepageurl service.
* @optParams Optional paramaters are not required by a request.
* @return BatchGetAmpUrlsResponse
*/
function ampUrlsBatchGetExample($service, $optParams)
{
	try
	{
		...
		return $service->ampUrls->BatchGetAmpUrls($optParams);
	}
	catch (Exception $e)
	{
