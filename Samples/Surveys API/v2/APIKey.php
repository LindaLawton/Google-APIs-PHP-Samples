 ...
 * Initializes an Surveys.v2 service object.
 * @param string API key
 * @return An authorized Surveys.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Surveys Sample");
		...
		// Create authenticated Surveys service
		return new Google_Service_Surveys($client);
	} catch (Exception $e) {
