...
// Single Request.
$results = surveysGetExample($service, $surveyUrlId, $optParams);
...
* @return Survey
*/
function surveysGetExample($service, $surveyUrlId, $optParams)
{
	try
	{
		...
		return $service->surveys->GetSurveys($surveyUrlId, $optParams);
	}
	catch (Exception $e)
	{
