...
print_r(resultsGetExample($service, $surveyUrlId));

/**
* Retrieves any survey results that have been produced so far. Results are formatted as an Excel file. You must add "?alt=media" to the URL as an argument to get results.
* @service Authenticated Surveys service.
* @surveyUrlId External URL ID for the survey.
* @return SurveyResults</returns>
*/
function resultsGetExample($service, $surveyUrlId)
{
	try
	{
		...
		return $service->results->GetResults($surveyUrlId);
	}
	catch (Exception $ex)
	{
