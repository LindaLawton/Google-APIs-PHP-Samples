...
// Single Request.
$results = resultsGetExample($service, $surveyUrlId, $optParams);
...
*/
function resultsGetExample($service, $surveyUrlId, $optParams)
{
	try
	{
		...
		return $service->results->GetResults($surveyUrlId, $optParams);
	}
	catch (Exception $e)
	{
