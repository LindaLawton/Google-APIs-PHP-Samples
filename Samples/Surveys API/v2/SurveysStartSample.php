...
print_r(surveysStartExample($service, $resourceId));

/**
* Begins running a survey.
* @service Authenticated Surveys service.
* @resourceId 
* @return SurveysStartResponse</returns>
*/
function surveysStartExample($service, $resourceId)
{
	try
	{
		...
		return $service->surveys->StartSurveys($resourceId);
	}
	catch (Exception $ex)
	{
