...
print_r(surveysStopExample($service, $resourceId));

/**
* Stops a running survey.
* @service Authenticated Surveys service.
* @resourceId 
* @return SurveysStopResponse</returns>
*/
function surveysStopExample($service, $resourceId)
{
	try
	{
		...
		return $service->surveys->StopSurveys($resourceId);
	}
	catch (Exception $ex)
	{
