...
$results = surveysStopExample($service, $resourceId, $optParams);
...
* @resourceId 
* @return SurveysStopResponse
*/
function surveysStopExample($service, $resourceId, $optParams)
{
	try
	{
		...
		return $service->surveys->StopSurveys($resourceId, $optParams);
	}
	catch (Exception $e)
	{
