...
print_r(mobileapppanelsGetExample($service, $panelId));
...
*/
function mobileapppanelsGetExample($service, $panelId)
{
	try
	{
		...
		return $service->mobileapppanels->GetMobileapppanels($panelId);
	}
	catch (Exception $ex)
	{
