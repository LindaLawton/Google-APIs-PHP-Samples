...
print_r(mobileapppanelsListExample($service));

/**
* Lists the MobileAppPanels available to the authenticated user.
* @service Authenticated Surveys service.
* @return MobileAppPanelsListResponse</returns>
*/
function mobileapppanelsListExample($service)
{
	try
	{
		...
		return $service->mobileapppanels->ListMobileapppanels();
	}
	catch (Exception $ex)
	{
