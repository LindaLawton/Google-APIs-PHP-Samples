...
// Single Request.
$results = mobileapppanelsListExample($service, $optParams);
...
* @return MobileAppPanelsListResponse
*/
function mobileapppanelsListExample($service, $optParams)
{
	try
	{
		...
		return $service->mobileapppanels->ListMobileapppanels($optParams);
	}
	catch (Exception $e)
	{
