...
print_r(surveysDeleteExample($service, $surveyUrlId));

/**
* Removes a survey from view in all user GET requests.
* @service Authenticated Surveys service.
* @surveyUrlId External URL ID for the survey.
* @return SurveysDeleteResponse</returns>
*/
function surveysDeleteExample($service, $surveyUrlId)
{
	try
	{
		...
		return $service->surveys->DeleteSurveys($surveyUrlId);
	}
	catch (Exception $ex)
	{
