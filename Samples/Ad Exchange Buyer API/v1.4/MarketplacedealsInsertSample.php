...
// Single Request.
$results = marketplacedealsInsertExample($service, $proposalId, $optParams);
...
*/
function marketplacedealsInsertExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->marketplacedeals->InsertMarketplacedeals($proposalId, $optParams);
	}
	catch (Exception $e)
	{
