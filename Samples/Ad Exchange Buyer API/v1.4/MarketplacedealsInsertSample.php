...
print_r(marketplacedealsInsertExample($service, $proposalId));

/**
* Add new deals for the specified proposal
* @service Authenticated Adexchangebuyer service.
* @proposalId proposalId for which deals need to be added.
* @return AddOrderDealsResponse</returns>
*/
function marketplacedealsInsertExample($service, $proposalId)
{
	try
	{
		...
		return $service->marketplacedeals->InsertMarketplacedeals($proposalId);
	}
	catch (Exception $ex)
	{
