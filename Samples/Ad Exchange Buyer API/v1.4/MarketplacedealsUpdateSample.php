...
print_r(marketplacedealsUpdateExample($service, $proposalId));

/**
* Replaces all the deals in the proposal with the passed in deals
* @service Authenticated Adexchangebuyer service.
* @proposalId The proposalId to edit deals on.
* @return EditAllOrderDealsResponse</returns>
*/
function marketplacedealsUpdateExample($service, $proposalId)
{
	try
	{
		...
		return $service->marketplacedeals->UpdateMarketplacedeals($proposalId);
	}
	catch (Exception $ex)
	{
