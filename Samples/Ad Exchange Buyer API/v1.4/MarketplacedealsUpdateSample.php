...
$results = marketplacedealsUpdateExample($service, $proposalId, $optParams);
...
*/
function marketplacedealsUpdateExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->marketplacedeals->UpdateMarketplacedeals($proposalId, $optParams);
	}
	catch (Exception $e)
	{
