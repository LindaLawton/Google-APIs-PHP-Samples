...
print_r(listDeals($service, $accountId, $buyerCreativeId));
...
*/
function listDeals($service, $accountId, $buyerCreativeId)
{
	try
	{
		...
		return $service->listDeals($accountId, $buyerCreativeId);
	}
	catch (Exception $ex)
	{
