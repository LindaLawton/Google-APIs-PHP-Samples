...
print_r(creativesListDealsExample($service, $accountId, $buyerCreativeId));
...
* @return CreativeDealIds</returns>
*/
function creativesListDealsExample($service, $accountId, $buyerCreativeId)
{
	try
	{
		...
		return $service->creatives->ListDealsCreatives($accountId, $buyerCreativeId);
	}
	catch (Exception $ex)
	{
