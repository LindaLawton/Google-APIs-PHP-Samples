...
$results = creativesListDealsExample($service, $accountId, $buyerCreativeId, $optParams);
...
*/
function creativesListDealsExample($service, $accountId, $buyerCreativeId, $optParams)
{
	try
	{
		...
		return $service->creatives->ListDealsCreatives($accountId, $buyerCreativeId, $optParams);
	}
	catch (Exception $e)
	{
