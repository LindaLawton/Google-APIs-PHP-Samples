...
print_r(update($service, $proposalId, $revisionNumber, $updateAction));
...
*/
function update($service, $proposalId, $revisionNumber, $updateAction)
{
	try
	{
		...
		return $service->update($proposalId, $revisionNumber, $updateAction);
	}
	catch (Exception $ex)
	{
