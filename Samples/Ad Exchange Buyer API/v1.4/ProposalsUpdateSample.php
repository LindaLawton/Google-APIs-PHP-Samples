...
// Single Request.
$results = proposalsUpdateExample($service, $proposalId, $revisionNumber, $updateAction, $optParams);
...
* @return Proposal
*/
function proposalsUpdateExample($service, $proposalId, $revisionNumber, $updateAction, $optParams)
{
	try
	{
		...
		if (revisionNumber == null)
			throw new Exception("revisionNumber is required.");
		if (updateAction == null)
			throw new Exception("updateAction is required.");
		// Make the request and return the results.
		return $service->proposals->UpdateProposals($proposalId, $revisionNumber, $updateAction, $optParams);
	}
	catch (Exception $e)
	{
