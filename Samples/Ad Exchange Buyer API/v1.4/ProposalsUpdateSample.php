...
print_r(proposalsUpdateExample($service, $proposalId, $revisionNumber, $updateAction));
...
* @return Proposal</returns>
*/
function proposalsUpdateExample($service, $proposalId, $revisionNumber, $updateAction)
{
	try
	{
		...
		return $service->proposals->UpdateProposals($proposalId, $revisionNumber, $updateAction);
	}
	catch (Exception $ex)
	{
