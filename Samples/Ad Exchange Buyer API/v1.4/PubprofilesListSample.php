...
print_r(pubprofilesListExample($service, $accountId));

/**
* Gets the requested publisher profile(s) by publisher accountId.
* @service Authenticated Adexchangebuyer service.
* @accountId The accountId of the publisher to get profiles for.
* @return GetPublisherProfilesByAccountIdResponse</returns>
*/
function pubprofilesListExample($service, $accountId)
{
	try
	{
		...
		return $service->pubprofiles->ListPubprofiles($accountId);
	}
	catch (Exception $ex)
	{
