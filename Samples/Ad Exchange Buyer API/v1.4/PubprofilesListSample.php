...
$results = pubprofilesListExample($service, $accountId, $optParams);
...
*/
function pubprofilesListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->pubprofiles->ListPubprofiles($accountId, $optParams);
	}
	catch (Exception $e)
	{
