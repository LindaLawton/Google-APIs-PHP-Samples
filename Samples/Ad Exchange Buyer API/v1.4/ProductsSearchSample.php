...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pqlQuery' => '[YourValue]',  // The pql query used to query for products.
  'fields' => '*'
);
// Single Request.
$results = productsSearchExample($service, $optParams);
...
*/
function productsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->products->SearchProducts($optParams);
	}
	catch (Exception $e)
	{
