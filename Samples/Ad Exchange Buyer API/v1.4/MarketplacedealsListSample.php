...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pqlQuery' => '[YourValue]',  // Query string to retrieve specific deals.
  'fields' => '*'
);
// Single Request.
$results = marketplacedealsListExample($service, $proposalId, $optParams);
...
*/
function marketplacedealsListExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->marketplacedeals->ListMarketplacedeals($proposalId, $optParams);
	}
	catch (Exception $e)
	{
