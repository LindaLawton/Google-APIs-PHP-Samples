...
print_r(marketplacedealsListExample($service, $proposalId));
...
* @return GetOrderDealsResponse</returns>
*/
function marketplacedealsListExample($service, $proposalId)
{
	try
	{
		...
		return $service->marketplacedeals->ListMarketplacedeals($proposalId);
	}
	catch (Exception $ex)
	{
