...
$results = proposalsGetExample($service, $proposalId, $optParams);
...
* @return Proposal
*/
function proposalsGetExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->proposals->GetProposals($proposalId, $optParams);
	}
	catch (Exception $e)
	{
