...
print_r(marketplacedealsDeleteExample($service, $proposalId));

/**
* Delete the specified deals from the proposal
* @service Authenticated Adexchangebuyer service.
* @proposalId The proposalId to delete deals from.
* @return DeleteOrderDealsResponse</returns>
*/
function marketplacedealsDeleteExample($service, $proposalId)
{
	try
	{
		...
		return $service->marketplacedeals->DeleteMarketplacedeals($proposalId);
	}
	catch (Exception $ex)
	{
