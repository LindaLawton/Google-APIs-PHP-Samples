...
// Single Request.
$results = marketplacedealsDeleteExample($service, $proposalId, $optParams);
...
*/
function marketplacedealsDeleteExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->marketplacedeals->DeleteMarketplacedeals($proposalId, $optParams);
	}
	catch (Exception $e)
	{
