...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'confirmUnsafeAccountChange' => '[YourValue]',  //Confirmation for erasing bidder and cookie matching urls.
  'fields' => '*'
);
// Single Request.
$results = accountsPatchExample($service, $id, $optParams);
...
* @return Account
*/
function accountsPatchExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->accounts->PatchAccounts($id, $optParams);
	}
	catch (Exception $e)
	{
