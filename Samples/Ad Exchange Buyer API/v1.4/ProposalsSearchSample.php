...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pqlQuery' => '[YourValue]',  // Query string to retrieve specific proposals.
  'fields' => '*'
);
// Single Request.
$results = proposalsSearchExample($service, $optParams);
...
*/
function proposalsSearchExample($service, $optParams)
{
	try
	{
		...
		return $service->proposals->SearchProposals($optParams);
	}
	catch (Exception $e)
	{
