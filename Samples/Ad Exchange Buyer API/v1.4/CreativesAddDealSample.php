...
print_r(addDeal($service, $accountId, $buyerCreativeId, $dealId));
...
*/
function addDeal($service, $accountId, $buyerCreativeId, $dealId)
{
	try
	{
		...
		return $service->addDeal($accountId, $buyerCreativeId, $dealId);
	}
	catch (Exception $ex)
	{
