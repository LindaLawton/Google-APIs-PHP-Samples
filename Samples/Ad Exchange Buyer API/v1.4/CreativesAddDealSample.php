...
print_r(creativesAddDealExample($service, $accountId, $buyerCreativeId, $dealId));
...
*/
function creativesAddDealExample($service, $accountId, $buyerCreativeId, $dealId)
{
	try
	{
		...
		return $service->creatives->AddDealCreatives($accountId, $buyerCreativeId, $dealId);
	}
	catch (Exception $ex)
	{
