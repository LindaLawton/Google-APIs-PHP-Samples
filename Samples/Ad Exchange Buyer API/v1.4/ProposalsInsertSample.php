...
print_r(proposalsInsertExample($service));

/**
* Create the given list of proposals
* @service Authenticated Adexchangebuyer service.
* @return CreateOrdersResponse</returns>
*/
function proposalsInsertExample($service)
{
	try
	{
		...
		return $service->proposals->InsertProposals();
	}
	catch (Exception $ex)
	{
