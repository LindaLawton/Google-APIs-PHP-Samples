...
// Single Request.
$results = marketplacenotesInsertExample($service, $proposalId, $optParams);
...
*/
function marketplacenotesInsertExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->marketplacenotes->InsertMarketplacenotes($proposalId, $optParams);
	}
	catch (Exception $e)
	{
