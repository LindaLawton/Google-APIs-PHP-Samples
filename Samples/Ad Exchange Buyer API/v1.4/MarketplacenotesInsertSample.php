...
print_r(marketplacenotesInsertExample($service, $proposalId));

/**
* Add notes to the proposal
* @service Authenticated Adexchangebuyer service.
* @proposalId The proposalId to add notes for.
* @return AddOrderNotesResponse</returns>
*/
function marketplacenotesInsertExample($service, $proposalId)
{
	try
	{
		...
		return $service->marketplacenotes->InsertMarketplacenotes($proposalId);
	}
	catch (Exception $ex)
	{
