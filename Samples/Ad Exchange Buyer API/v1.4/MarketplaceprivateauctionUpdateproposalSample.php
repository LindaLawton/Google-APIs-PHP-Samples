...
print_r(marketplaceprivateauctionUpdateproposalExample($service, $privateAuctionId));
...
*/
function marketplaceprivateauctionUpdateproposalExample($service, $privateAuctionId)
{
	try
	{
		...
		return $service->marketplaceprivateauction->UpdateproposalMarketplaceprivateauction($privateAuctionId);
	}
	catch (Exception $ex)
	{
