...
$results = marketplaceprivateauctionUpdateproposalExample($service, $privateAuctionId, $optParams);
...
*/
function marketplaceprivateauctionUpdateproposalExample($service, $privateAuctionId, $optParams)
{
	try
	{
		...
		if (privateAuctionId == null)
			throw new Exception("privateAuctionId is required.");
		// Make the request and return the results.
		return $service->marketplaceprivateauction->UpdateproposalMarketplaceprivateauction($privateAuctionId, $optParams);
	}
	catch (Exception $e)
	{
