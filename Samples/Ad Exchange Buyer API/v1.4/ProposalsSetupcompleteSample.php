...
print_r(proposalsSetupcompleteExample($service, $proposalId));
...
*/
function proposalsSetupcompleteExample($service, $proposalId)
{
	try
	{
		...
		return $service->proposals->SetupcompleteProposals($proposalId);
	}
	catch (Exception $ex)
	{
