...
print_r(creativesRemoveDealExample($service, $accountId, $buyerCreativeId, $dealId));
...
*/
function creativesRemoveDealExample($service, $accountId, $buyerCreativeId, $dealId)
{
	try
	{
		...
		return $service->creatives->RemoveDealCreatives($accountId, $buyerCreativeId, $dealId);
	}
	catch (Exception $ex)
	{
