...
print_r(removeDeal($service, $accountId, $buyerCreativeId, $dealId));
...
*/
function removeDeal($service, $accountId, $buyerCreativeId, $dealId)
{
	try
	{
		...
		return $service->removeDeal($accountId, $buyerCreativeId, $dealId);
	}
	catch (Exception $ex)
	{
