...
// Single Request.
$results = productsGetExample($service, $productId, $optParams);
...
* @return Product
*/
function productsGetExample($service, $productId, $optParams)
{
	try
	{
		...
		return $service->products->GetProducts($productId, $optParams);
	}
	catch (Exception $e)
	{
