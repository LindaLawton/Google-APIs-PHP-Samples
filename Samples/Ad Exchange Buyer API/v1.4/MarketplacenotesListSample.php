...
print_r(marketplacenotesListExample($service, $proposalId));
...
* @return GetOrderNotesResponse</returns>
*/
function marketplacenotesListExample($service, $proposalId)
{
	try
	{
		...
		return $service->marketplacenotes->ListMarketplacenotes($proposalId);
	}
	catch (Exception $ex)
	{
