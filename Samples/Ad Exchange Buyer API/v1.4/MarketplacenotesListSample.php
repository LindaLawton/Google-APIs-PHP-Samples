...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'pqlQuery' => '[YourValue]',  // Query string to retrieve specific notes. To search the text contents of notes, please use syntax like "WHERE note.note = "foo" or "WHERE note.note LIKE "%bar%"
  'fields' => '*'
);
// Single Request.
$results = marketplacenotesListExample($service, $proposalId, $optParams);
...
*/
function marketplacenotesListExample($service, $proposalId, $optParams)
{
	try
	{
		...
		return $service->marketplacenotes->ListMarketplacenotes($proposalId, $optParams);
	}
	catch (Exception $e)
	{
