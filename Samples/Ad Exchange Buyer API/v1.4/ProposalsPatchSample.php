...
print_r(patch($service, $proposalId, $revisionNumber, $updateAction));
...
*/
function patch($service, $proposalId, $revisionNumber, $updateAction)
{
	try
	{
		...
		return $service->patch($proposalId, $revisionNumber, $updateAction);
	}
	catch (Exception $ex)
	{
