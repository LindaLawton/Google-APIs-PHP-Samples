...
// Single Request.
$results = proposalsPatchExample($service, $proposalId, $revisionNumber, $updateAction, $optParams);
...
* @return Proposal
*/
function proposalsPatchExample($service, $proposalId, $revisionNumber, $updateAction, $optParams)
{
	try
	{
		...
		return $service->proposals->PatchProposals($proposalId, $revisionNumber, $updateAction, $optParams);
	}
	catch (Exception $e)
	{
