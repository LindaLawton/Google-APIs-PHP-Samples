...
print_r(proposalsPatchExample($service, $proposalId, $revisionNumber, $updateAction));
...
*/
function proposalsPatchExample($service, $proposalId, $revisionNumber, $updateAction)
{
	try
	{
		...
		return $service->proposals->PatchProposals($proposalId, $revisionNumber, $updateAction);
	}
	catch (Exception $ex)
	{
