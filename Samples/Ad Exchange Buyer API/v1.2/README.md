...
# UnOfficial Ad Exchange Buyer API v1.2 Samples for PHP
...
These samples show how to access the [Ad Exchange Buyer API v1.2](https://developers.google.com/ad-exchange/buyer-rest) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
