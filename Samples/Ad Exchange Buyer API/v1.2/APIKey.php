 ...
 * Initializes an Adexchangebuyer.v1.2 service object.
 * @param string API key
 * @return An authorized Adexchangebuyer.v1.2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Adexchangebuyer Sample");
		...
		// Create authenticated Adexchangebuyer service
		return new Google_Service_Adexchangebuyer($client);
	} catch (Exception $e) {
