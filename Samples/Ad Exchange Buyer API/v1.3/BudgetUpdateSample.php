...
print_r(budgetUpdateExample($service, $accountId, $billingId));
...
*/
function budgetUpdateExample($service, $accountId, $billingId)
{
	try
	{
		...
		return $service->budget->UpdateBudget($accountId, $billingId);
	}
	catch (Exception $ex)
	{
