...
// Single Request.
$results = budgetUpdateExample($service, $accountId, $billingId, $optParams);
...
* @return Budget
*/
function budgetUpdateExample($service, $accountId, $billingId, $optParams)
{
	try
	{
		...
		if (billingId == null)
			throw new Exception("billingId is required.");
		// Make the request and return the results.
		return $service->budget->UpdateBudget($accountId, $billingId, $optParams);
	}
	catch (Exception $e)
	{
