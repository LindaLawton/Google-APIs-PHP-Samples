...
print_r(performanceReportListExample($service, $accountId, $endDateTime, $startDateTime));
...
* @return PerformanceReportList</returns>
*/
function performanceReportListExample($service, $accountId, $endDateTime, $startDateTime)
{
	try
	{
		...
		return $service->performanceReport->ListPerformanceReport($accountId, $endDateTime, $startDateTime);
	}
	catch (Exception $ex)
	{
