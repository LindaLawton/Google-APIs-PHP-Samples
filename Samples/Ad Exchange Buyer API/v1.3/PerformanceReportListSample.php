...
print_r(list($service, $accountId, $endDateTime, $startDateTime));
...
*/
function list($service, $accountId, $endDateTime, $startDateTime)
{
	try
	{
		...
		return $service->list($accountId, $endDateTime, $startDateTime);
	}
	catch (Exception $ex)
	{
