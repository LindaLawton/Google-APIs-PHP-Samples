...
// Single Request.
$results = pretargetingConfigInsertExample($service, $accountId, $optParams);
...
*/
function pretargetingConfigInsertExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->pretargetingConfig->InsertPretargetingConfig($accountId, $optParams);
	}
	catch (Exception $e)
	{
