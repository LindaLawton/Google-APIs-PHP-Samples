...
print_r(pretargetingConfigInsertExample($service, $accountId));
...
*/
function pretargetingConfigInsertExample($service, $accountId)
{
	try
	{
		...
		return $service->pretargetingConfig->InsertPretargetingConfig($accountId);
	}
	catch (Exception $ex)
	{
