...
// Single Request.
$results = pretargetingConfigGetExample($service, $accountId, $configId, $optParams);
...
*/
function pretargetingConfigGetExample($service, $accountId, $configId, $optParams)
{
	try
	{
		...
		return $service->pretargetingConfig->GetPretargetingConfig($accountId, $configId, $optParams);
	}
	catch (Exception $e)
	{
