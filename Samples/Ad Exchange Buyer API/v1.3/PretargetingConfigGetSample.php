...
print_r(pretargetingConfigGetExample($service, $accountId, $configId));
...
*/
function pretargetingConfigGetExample($service, $accountId, $configId)
{
	try
	{
		...
		return $service->pretargetingConfig->GetPretargetingConfig($accountId, $configId);
	}
	catch (Exception $ex)
	{
