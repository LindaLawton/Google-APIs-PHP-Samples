...
// Single Request.
$results = billingInfoGetExample($service, $accountId, $optParams);
...
* @return BillingInfo
*/
function billingInfoGetExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->billingInfo->GetBillingInfo($accountId, $optParams);
	}
	catch (Exception $e)
	{
