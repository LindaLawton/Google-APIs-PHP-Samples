...
print_r(billingInfoGetExample($service, $accountId));

/**
* Returns the billing information for one account specified by account ID.
* @service Authenticated Adexchangebuyer service.
* @accountId The account id.
* @return BillingInfo</returns>
*/
function billingInfoGetExample($service, $accountId)
{
	try
	{
		...
		return $service->billingInfo->GetBillingInfo($accountId);
	}
	catch (Exception $ex)
	{
