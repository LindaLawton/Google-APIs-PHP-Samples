...
print_r(pretargetingConfigUpdateExample($service, $accountId, $configId));
...
* @return PretargetingConfig</returns>
*/
function pretargetingConfigUpdateExample($service, $accountId, $configId)
{
	try
	{
		...
		return $service->pretargetingConfig->UpdatePretargetingConfig($accountId, $configId);
	}
	catch (Exception $ex)
	{
