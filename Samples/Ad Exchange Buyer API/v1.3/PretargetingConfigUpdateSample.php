...
// Single Request.
$results = pretargetingConfigUpdateExample($service, $accountId, $configId, $optParams);
...
*/
function pretargetingConfigUpdateExample($service, $accountId, $configId, $optParams)
{
	try
	{
		...
		return $service->pretargetingConfig->UpdatePretargetingConfig($accountId, $configId, $optParams);
	}
	catch (Exception $e)
	{
