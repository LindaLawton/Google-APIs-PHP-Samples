...
print_r(budgetGetExample($service, $accountId, $billingId));
...
*/
function budgetGetExample($service, $accountId, $billingId)
{
	try
	{
		...
		return $service->budget->GetBudget($accountId, $billingId);
	}
	catch (Exception $ex)
	{
