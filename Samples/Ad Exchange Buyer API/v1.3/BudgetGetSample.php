...
// Single Request.
$results = budgetGetExample($service, $accountId, $billingId, $optParams);
...
* @return Budget
*/
function budgetGetExample($service, $accountId, $billingId, $optParams)
{
	try
	{
		...
		return $service->budget->GetBudget($accountId, $billingId, $optParams);
	}
	catch (Exception $e)
	{
