...
print_r(directDealsGetExample($service, $id));

/**
* Gets one direct deal by ID.
* @service Authenticated Adexchangebuyer service.
* @id The direct deal id
* @return DirectDeal</returns>
*/
function directDealsGetExample($service, $id)
{
	try
	{
		...
		return $service->directDeals->GetDirectDeals($id);
	}
	catch (Exception $ex)
	{
