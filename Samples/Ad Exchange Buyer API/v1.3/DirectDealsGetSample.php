...
$results = directDealsGetExample($service, $id, $optParams);
...
* @return DirectDeal
*/
function directDealsGetExample($service, $id, $optParams)
{
	try
	{
		...
		return $service->directDeals->GetDirectDeals($id, $optParams);
	}
	catch (Exception $e)
	{
