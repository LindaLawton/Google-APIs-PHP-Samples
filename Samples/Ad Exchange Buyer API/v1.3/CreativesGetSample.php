...
$results = creativesGetExample($service, $accountId, $buyerCreativeId, $optParams);
...
* @return Creative
*/
function creativesGetExample($service, $accountId, $buyerCreativeId, $optParams)
{
	try
	{
		...
		if (buyerCreativeId == null)
			throw new Exception("buyerCreativeId is required.");
		// Make the request and return the results.
		return $service->creatives->GetCreatives($accountId, $buyerCreativeId, $optParams);
	}
	catch (Exception $e)
	{
