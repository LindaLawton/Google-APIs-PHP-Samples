...
print_r(creativesGetExample($service, $accountId, $buyerCreativeId));
...
* @return Creative</returns>
*/
function creativesGetExample($service, $accountId, $buyerCreativeId)
{
	try
	{
		...
		return $service->creatives->GetCreatives($accountId, $buyerCreativeId);
	}
	catch (Exception $ex)
	{
