...
# UnOfficial Ad Exchange Buyer API v1.3 Samples for PHP

## API Description

Accesses your bidding-account information, submits creatives for validation, finds available direct deals, and retrieves performance reports.

[Official Documentation](https://developers.google.com/ad-exchange/buyer-rest)

## Sample Description

These samples show how to access the [Ad Exchange Buyer API v1.3](https://developers.google.com/ad-exchange/buyer-rest) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
