...
// Single Request.
$results = pretargetingConfigPatchExample($service, $accountId, $configId, $optParams);
...
*/
function pretargetingConfigPatchExample($service, $accountId, $configId, $optParams)
{
	try
	{
		...
		return $service->pretargetingConfig->PatchPretargetingConfig($accountId, $configId, $optParams);
	}
	catch (Exception $e)
	{
