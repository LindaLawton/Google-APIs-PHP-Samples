...
print_r(pretargetingConfigPatchExample($service, $accountId, $configId));
...
*/
function pretargetingConfigPatchExample($service, $accountId, $configId)
{
	try
	{
		...
		return $service->pretargetingConfig->PatchPretargetingConfig($accountId, $configId);
	}
	catch (Exception $ex)
	{
