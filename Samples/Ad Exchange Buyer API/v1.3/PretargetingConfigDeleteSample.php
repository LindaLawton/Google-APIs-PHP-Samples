...
print_r(pretargetingConfigDeleteExample($service, $accountId, $configId));
...
*/
function pretargetingConfigDeleteExample($service, $accountId, $configId)
{
	try
	{
		...
		return $service->pretargetingConfig->DeletePretargetingConfig($accountId, $configId);
	}
	catch (Exception $ex)
	{
