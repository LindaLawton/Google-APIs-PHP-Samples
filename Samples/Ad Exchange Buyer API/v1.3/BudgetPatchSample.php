...
// Single Request.
$results = budgetPatchExample($service, $accountId, $billingId, $optParams);
...
* @return Budget
*/
function budgetPatchExample($service, $accountId, $billingId, $optParams)
{
	try
	{
		...
		return $service->budget->PatchBudget($accountId, $billingId, $optParams);
	}
	catch (Exception $e)
	{
