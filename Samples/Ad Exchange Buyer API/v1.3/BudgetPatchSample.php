...
print_r(budgetPatchExample($service, $accountId, $billingId));
...
*/
function budgetPatchExample($service, $accountId, $billingId)
{
	try
	{
		...
		return $service->budget->PatchBudget($accountId, $billingId);
	}
	catch (Exception $ex)
	{
