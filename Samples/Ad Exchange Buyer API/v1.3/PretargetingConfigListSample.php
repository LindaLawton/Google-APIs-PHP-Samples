...
print_r(pretargetingConfigListExample($service, $accountId));

/**
* Retrieves a list of the authenticated user's pretargeting configurations.
* @service Authenticated Adexchangebuyer service.
* @accountId The account id to get the pretargeting configs for.
* @return PretargetingConfigList</returns>
*/
function pretargetingConfigListExample($service, $accountId)
{
	try
	{
		...
		return $service->pretargetingConfig->ListPretargetingConfig($accountId);
	}
	catch (Exception $ex)
	{
