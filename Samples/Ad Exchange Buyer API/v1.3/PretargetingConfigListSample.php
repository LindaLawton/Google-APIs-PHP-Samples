...
// Single Request.
$results = pretargetingConfigListExample($service, $accountId, $optParams);
...
*/
function pretargetingConfigListExample($service, $accountId, $optParams)
{
	try
	{
		...
		return $service->pretargetingConfig->ListPretargetingConfig($accountId, $optParams);
	}
	catch (Exception $e)
	{
