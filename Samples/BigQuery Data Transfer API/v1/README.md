...
# UnOfficial BigQuery Data Transfer API v1 Samples for PHP

## API Description

Transfers data from partner SaaS applications to Google BigQuery on a scheduled, managed basis.

[Official Documentation](https://cloud.google.com/bigquery/)

## Sample Description

These samples show how to access the [BigQuery Data Transfer API v1](https://cloud.google.com/bigquery/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
