...
print_r(dataSourcesCheckValidCredsExample($service, $name));
...
* @return CheckValidCredsResponse</returns>
*/
function dataSourcesCheckValidCredsExample($service, $name)
{
	try
	{
		...
		return $service->dataSources->CheckValidCredsDataSources($name);
	}
	catch (Exception $ex)
	{
