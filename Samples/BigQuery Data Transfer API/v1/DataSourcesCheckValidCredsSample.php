...
// Single Request.
$results = dataSourcesCheckValidCredsExample($service, $name, $optParams);
...
*/
function dataSourcesCheckValidCredsExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->dataSources->CheckValidCredsDataSources($name, $optParams);
	}
	catch (Exception $e)
	{
