...
print_r(dataSourcesGetExample($service, $name));
...
* @return DataSource</returns>
*/
function dataSourcesGetExample($service, $name)
{
	try
	{
		...
		return $service->dataSources->GetDataSources($name);
	}
	catch (Exception $ex)
	{
