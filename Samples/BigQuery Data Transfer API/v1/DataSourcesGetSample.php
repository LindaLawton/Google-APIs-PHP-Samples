...
$results = dataSourcesGetExample($service, $name, $optParams);
...
* @return DataSource
*/
function dataSourcesGetExample($service, $name, $optParams)
{
	try
	{
		...
		return $service->dataSources->GetDataSources($name, $optParams);
	}
	catch (Exception $e)
	{
