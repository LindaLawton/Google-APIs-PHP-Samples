...
print_r(dataSourcesListExample($service, $parent));
...
* @return ListDataSourcesResponse</returns>
*/
function dataSourcesListExample($service, $parent)
{
	try
	{
		...
		return $service->dataSources->ListDataSources($parent);
	}
	catch (Exception $ex)
	{
