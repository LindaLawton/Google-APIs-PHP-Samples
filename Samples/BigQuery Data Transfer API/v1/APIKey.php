 ...
 * Initializes an Bigquerydatatransfer.v1 service object.
 * @param string API key
 * @return An authorized Bigquerydatatransfer.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Bigquerydatatransfer Sample");
		...
		// Create authenticated Bigquerydatatransfer service
		return new Google_Service_Bigquerydatatransfer($client);
	} catch (Exception $e) {
