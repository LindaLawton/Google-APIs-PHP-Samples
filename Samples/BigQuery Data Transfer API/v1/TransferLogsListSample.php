...
print_r(transferLogsListExample($service, $parent));
...
* @return ListTransferLogsResponse</returns>
*/
function transferLogsListExample($service, $parent)
{
	try
	{
		...
		return $service->transferLogs->ListTransferLogs($parent);
	}
	catch (Exception $ex)
	{
