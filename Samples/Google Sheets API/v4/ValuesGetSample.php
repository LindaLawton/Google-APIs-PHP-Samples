...
print_r(valuesGetExample($service, $spreadsheetId, $range));
...
* @return ValueRange</returns>
*/
function valuesGetExample($service, $spreadsheetId, $range)
{
	try
	{
		...
		return $service->values->GetValues($spreadsheetId, $range);
	}
	catch (Exception $ex)
	{
