...
// Single Request.
$results = valuesGetExample($service, $spreadsheetId, $range, $optParams);
...
* @return ValueRange
*/
function valuesGetExample($service, $spreadsheetId, $range, $optParams)
{
	try
	{
		...
		return $service->values->GetValues($spreadsheetId, $range, $optParams);
	}
	catch (Exception $e)
	{
