...
print_r(sheetsCopyToExample($service, $spreadsheetId, $sheetId));
...
* @return SheetProperties</returns>
*/
function sheetsCopyToExample($service, $spreadsheetId, $sheetId)
{
	try
	{
		...
		return $service->sheets->CopyToSheets($spreadsheetId, $sheetId);
	}
	catch (Exception $ex)
	{
