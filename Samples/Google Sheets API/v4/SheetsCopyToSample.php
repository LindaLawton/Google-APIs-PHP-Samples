...
// Single Request.
$results = sheetsCopyToExample($service, $spreadsheetId, $sheetId, $optParams);
...
*/
function sheetsCopyToExample($service, $spreadsheetId, $sheetId, $optParams)
{
	try
	{
		...
		if (sheetId == null)
			throw new Exception("sheetId is required.");
		// Make the request and return the results.
		return $service->sheets->CopyToSheets($spreadsheetId, $sheetId, $optParams);
	}
	catch (Exception $e)
	{
