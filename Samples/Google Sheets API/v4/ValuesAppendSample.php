...
print_r(valuesAppendExample($service, $spreadsheetId, $range));
...
* @return AppendValuesResponse</returns>
*/
function valuesAppendExample($service, $spreadsheetId, $range)
{
	try
	{
		...
		return $service->values->AppendValues($spreadsheetId, $range);
	}
	catch (Exception $ex)
	{
