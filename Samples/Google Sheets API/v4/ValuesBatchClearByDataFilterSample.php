...
print_r(batchClearByDataFilter($service, $spreadsheetId));
...
*/
function batchClearByDataFilter($service, $spreadsheetId)
{
	try
	{
		...
		return $service->batchClearByDataFilter($spreadsheetId);
	}
	catch (Exception $ex)
	{
