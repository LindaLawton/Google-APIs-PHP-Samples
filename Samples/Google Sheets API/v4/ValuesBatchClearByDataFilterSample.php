...
print_r(valuesBatchClearByDataFilterExample($service, $spreadsheetId));
...
* @return BatchClearValuesByDataFilterResponse</returns>
*/
function valuesBatchClearByDataFilterExample($service, $spreadsheetId)
{
	try
	{
		...
		return $service->values->BatchClearByDataFilterValues($spreadsheetId);
	}
	catch (Exception $ex)
	{
