...
// Single Request.
$results = valuesBatchClearByDataFilterExample($service, $spreadsheetId, $optParams);
...
*/
function valuesBatchClearByDataFilterExample($service, $spreadsheetId, $optParams)
{
	try
	{
		...
		return $service->values->BatchClearByDataFilterValues($spreadsheetId, $optParams);
	}
	catch (Exception $e)
	{
