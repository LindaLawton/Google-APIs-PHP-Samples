...
// Single Request.
$results = valuesBatchClearExample($service, $spreadsheetId, $optParams);
...
*/
function valuesBatchClearExample($service, $spreadsheetId, $optParams)
{
	try
	{
		...
		return $service->values->BatchClearValues($spreadsheetId, $optParams);
	}
	catch (Exception $e)
	{
