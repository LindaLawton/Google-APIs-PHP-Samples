...
print_r(valuesBatchClearExample($service, $spreadsheetId));
...
* @return BatchClearValuesResponse</returns>
*/
function valuesBatchClearExample($service, $spreadsheetId)
{
	try
	{
		...
		return $service->values->BatchClearValues($spreadsheetId);
	}
	catch (Exception $ex)
	{
