...
print_r(developerMetadataSearchExample($service, $spreadsheetId));
...
* @return SearchDeveloperMetadataResponse</returns>
*/
function developerMetadataSearchExample($service, $spreadsheetId)
{
	try
	{
		...
		return $service->developerMetadata->SearchDeveloperMetadata($spreadsheetId);
	}
	catch (Exception $ex)
	{
