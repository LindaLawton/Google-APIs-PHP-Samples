...
$results = developerMetadataSearchExample($service, $spreadsheetId, $optParams);
...
*/
function developerMetadataSearchExample($service, $spreadsheetId, $optParams)
{
	try
	{
		...
		return $service->developerMetadata->SearchDeveloperMetadata($spreadsheetId, $optParams);
	}
	catch (Exception $e)
	{
