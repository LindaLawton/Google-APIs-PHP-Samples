...
// Single Request.
$results = valuesBatchUpdateByDataFilterExample($service, $spreadsheetId, $optParams);
...
*/
function valuesBatchUpdateByDataFilterExample($service, $spreadsheetId, $optParams)
{
	try
	{
		...
		return $service->values->BatchUpdateByDataFilterValues($spreadsheetId, $optParams);
	}
	catch (Exception $e)
	{
