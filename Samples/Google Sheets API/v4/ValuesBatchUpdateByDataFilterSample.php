...
print_r(valuesBatchUpdateByDataFilterExample($service, $spreadsheetId));
...
* @return BatchUpdateValuesByDataFilterResponse</returns>
*/
function valuesBatchUpdateByDataFilterExample($service, $spreadsheetId)
{
	try
	{
		...
		return $service->values->BatchUpdateByDataFilterValues($spreadsheetId);
	}
	catch (Exception $ex)
	{
