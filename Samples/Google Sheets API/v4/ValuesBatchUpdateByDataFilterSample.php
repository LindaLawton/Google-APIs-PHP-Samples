...
print_r(batchUpdateByDataFilter($service, $spreadsheetId));
...
*/
function batchUpdateByDataFilter($service, $spreadsheetId)
{
	try
	{
		...
		return $service->batchUpdateByDataFilter($spreadsheetId);
	}
	catch (Exception $ex)
	{
