...
print_r(valuesBatchGetExample($service, $spreadsheetId));

/**
* Returns one or more ranges of values from a spreadsheet.The caller must specify the spreadsheet ID and one or more ranges.
* @service Authenticated Sheets service.
* @spreadsheetId The ID of the spreadsheet to retrieve data from.
* @return BatchGetValuesResponse</returns>
*/
function valuesBatchGetExample($service, $spreadsheetId)
{
	try
	{
		...
		return $service->values->BatchGetValues($spreadsheetId);
	}
	catch (Exception $ex)
	{
