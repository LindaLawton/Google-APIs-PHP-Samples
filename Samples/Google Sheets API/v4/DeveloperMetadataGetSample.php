...
print_r(developerMetadataGetExample($service, $spreadsheetId, $metadataId));
...
* @return DeveloperMetadata</returns>
*/
function developerMetadataGetExample($service, $spreadsheetId, $metadataId)
{
	try
	{
		...
		return $service->developerMetadata->GetDeveloperMetadata($spreadsheetId, $metadataId);
	}
	catch (Exception $ex)
	{
