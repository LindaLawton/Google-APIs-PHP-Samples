...
// Single Request.
$results = valuesClearExample($service, $spreadsheetId, $range, $optParams);
...
*/
function valuesClearExample($service, $spreadsheetId, $range, $optParams)
{
	try
	{
		...
		return $service->values->ClearValues($spreadsheetId, $range, $optParams);
	}
	catch (Exception $e)
	{
