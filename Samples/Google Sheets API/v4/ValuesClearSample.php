...
print_r(valuesClearExample($service, $spreadsheetId, $range));
...
* @return ClearValuesResponse</returns>
*/
function valuesClearExample($service, $spreadsheetId, $range)
{
	try
	{
		...
		return $service->values->ClearValues($spreadsheetId, $range);
	}
	catch (Exception $ex)
	{
