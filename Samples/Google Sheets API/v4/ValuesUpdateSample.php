...
print_r(valuesUpdateExample($service, $spreadsheetId, $range));
...
* @return UpdateValuesResponse</returns>
*/
function valuesUpdateExample($service, $spreadsheetId, $range)
{
	try
	{
		...
		return $service->values->UpdateValues($spreadsheetId, $range);
	}
	catch (Exception $ex)
	{
