...
*/
function valuesUpdateExample($service, $spreadsheetId, $range, $optParams)
{
	try
	{
		...
		return $service->values->UpdateValues($spreadsheetId, $range, $optParams);
	}
	catch (Exception $e)
	{
