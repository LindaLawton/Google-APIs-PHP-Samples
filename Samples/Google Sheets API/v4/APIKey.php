 ...
 * Initializes an Sheets.v4 service object.
 * @param string API key
 * @return An authorized Sheets.v4 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Sheets Sample");
		...
		// Create authenticated Sheets service
