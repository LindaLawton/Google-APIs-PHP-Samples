...
print_r(valuesBatchUpdateExample($service, $spreadsheetId));
...
* @return BatchUpdateValuesResponse</returns>
*/
function valuesBatchUpdateExample($service, $spreadsheetId)
{
	try
	{
		...
		return $service->values->BatchUpdateValues($spreadsheetId);
	}
	catch (Exception $ex)
	{
