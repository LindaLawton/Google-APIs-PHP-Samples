...
$results = valuesBatchUpdateExample($service, $spreadsheetId, $optParams);
...
*/
function valuesBatchUpdateExample($service, $spreadsheetId, $optParams)
{
	try
	{
		...
		return $service->values->BatchUpdateValues($spreadsheetId, $optParams);
	}
	catch (Exception $e)
	{
