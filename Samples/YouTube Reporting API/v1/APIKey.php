...
// About 
// 
// Unofficial sample for the Youtubereporting v1 API for PHP. 
 ...
 * Initializes an Youtubereporting.v1 service object.
 * @param string API key
 * @return An authorized Youtubereporting.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Youtubereporting Sample");
		...
		// Create authenticated Youtubereporting service
		return new Google_Service_Youtubereporting($client);
	} catch (Exception $e) {
