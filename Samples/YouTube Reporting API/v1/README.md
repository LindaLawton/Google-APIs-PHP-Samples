...
# UnOfficial YouTube Reporting API v1 Samples for PHP

## API Description

Schedules reporting jobs containing your YouTube Analytics data and downloads the resulting bulk data reports in the form of CSV files.

[Official Documentation](https://developers.google.com/youtube/reporting/v1/reports/)

## Sample Description

These samples show how to access the [YouTube Reporting API v1](https://developers.google.com/youtube/reporting/v1/reports/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
