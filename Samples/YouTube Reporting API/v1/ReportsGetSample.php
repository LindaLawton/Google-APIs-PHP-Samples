...
$results = reportsGetExample($service, $jobId, $reportId, $optParams);
...
* @return Report
*/
function reportsGetExample($service, $jobId, $reportId, $optParams)
{
	try
	{
		...
		return $service->reports->GetReports($jobId, $reportId, $optParams);
	}
	catch (Exception $e)
	{
