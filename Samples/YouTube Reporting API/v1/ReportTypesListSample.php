...
print_r(reportTypesListExample($service));

/**
* Lists report types.
* @service Authenticated Youtubereporting service.
* @return ListReportTypesResponse</returns>
*/
function reportTypesListExample($service)
{
	try
	{
		...
		return $service->reportTypes->ListReportTypes();
	}
	catch (Exception $ex)
	{
