...
# Unoffical Google Spectrum Database API Samples for PHP
...
These samples show how to access the [Google Spectrum Database API](http://developers.google.com/spectrum) with the Offical [Google PHP client library](https://github.com/google/google-api-php-client)
