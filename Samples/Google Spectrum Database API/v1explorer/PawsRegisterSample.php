...
// Single Request.
$results = pawsRegisterExample($service, $optParams);
...
* @return PawsRegisterResponse
*/
function pawsRegisterExample($service, $optParams)
{
	try
	{
		...
		return $service->paws->RegisterPaws($optParams);
	}
	catch (Exception $e)
	{
