...
# UnOfficial Google Spectrum Database API v1explorer Samples for PHP

## API Description

API for spectrum-management functions.

[Official Documentation](http://developers.google.com/spectrum)

## Sample Description

These samples show how to access the [Google Spectrum Database API v1explorer](http://developers.google.com/spectrum) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
