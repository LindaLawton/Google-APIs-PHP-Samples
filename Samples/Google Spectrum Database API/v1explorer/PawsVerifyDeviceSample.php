...
$results = pawsVerifyDeviceExample($service, $optParams);
...
* @return PawsVerifyDeviceResponse
*/
function pawsVerifyDeviceExample($service, $optParams)
{
	try
	{
		...
		return $service->paws->VerifyDevicePaws($optParams);
	}
	catch (Exception $e)
	{
