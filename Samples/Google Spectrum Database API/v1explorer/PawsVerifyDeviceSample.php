...
print_r(pawsVerifyDeviceExample($service));
...
* @return PawsVerifyDeviceResponse</returns>
*/
function pawsVerifyDeviceExample($service)
{
	try
	{
		...
		return $service->paws->VerifyDevicePaws();
	}
	catch (Exception $ex)
	{
