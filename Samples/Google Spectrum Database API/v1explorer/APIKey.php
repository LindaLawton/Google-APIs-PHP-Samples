 ...
 * Initializes an Spectrum.v1explorer service object.
 * @param string API key
 * @return An authorized Spectrum.v1explorer service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Spectrum Sample");
		...
		// Create authenticated Spectrum service
		return new Google_Service_Spectrum($client);
	} catch (Exception $e) {
