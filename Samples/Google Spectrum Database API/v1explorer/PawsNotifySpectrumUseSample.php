...
print_r(pawsNotifySpectrumUseExample($service));
...
* @return PawsNotifySpectrumUseResponse</returns>
*/
function pawsNotifySpectrumUseExample($service)
{
	try
	{
		...
		return $service->paws->NotifySpectrumUsePaws();
	}
	catch (Exception $ex)
	{
