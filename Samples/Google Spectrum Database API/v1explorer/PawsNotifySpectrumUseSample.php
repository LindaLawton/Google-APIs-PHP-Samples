...
// About 
// 
// Unofficial sample for the spectrum v1explorer API for PHP. 
...
* $service = new Google_Service_Spectrum($client); 
****************************************************/
...
// Single Request.
$results = pawsNotifySpectrumUseExample($service, $optParams);
...
* @service Authenticated Spectrum service.
* @optParams Optional paramaters are not required by a request.
* @return PawsNotifySpectrumUseResponse
*/
function pawsNotifySpectrumUseExample($service, $optParams)
{
	try
	{
		...
		return $service->paws->NotifySpectrumUsePaws($optParams);
	}
	catch (Exception $e)
	{
