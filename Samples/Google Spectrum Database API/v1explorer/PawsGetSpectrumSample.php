...
print_r(pawsGetSpectrumExample($service));
...
* @return PawsGetSpectrumResponse</returns>
*/
function pawsGetSpectrumExample($service)
{
	try
	{
		...
		return $service->paws->GetSpectrumPaws();
	}
	catch (Exception $ex)
	{
