...
$results = pawsGetSpectrumExample($service, $optParams);
...
* @return PawsGetSpectrumResponse
*/
function pawsGetSpectrumExample($service, $optParams)
{
	try
	{
		...
		return $service->paws->GetSpectrumPaws($optParams);
	}
	catch (Exception $e)
	{
