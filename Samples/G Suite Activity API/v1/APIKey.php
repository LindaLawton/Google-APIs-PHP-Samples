 ...
 * Initializes an Appsactivity.v1 service object.
 * @param string API key
 * @return An authorized Appsactivity.v1 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Appsactivity Sample");
		...
		// Create authenticated Appsactivity service
		return new Google_Service_Appsactivity($client);
	} catch (Exception $e) {
