...
# UnOfficial G Suite Activity API v1 Samples for PHP

## API Description

Provides a historical view of activity.

[Official Documentation](https://developers.google.com/google-apps/activity/)

## Sample Description

These samples show how to access the [G Suite Activity API v1](https://developers.google.com/google-apps/activity/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
