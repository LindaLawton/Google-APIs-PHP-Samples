...
// Option paramaters can be set as needed.
 $optParams = array(
  ...
  //'updateMask' => '[YourValue]',  //Standard field mask for the set of fields to be updated.Required with at least 1 value in FieldMask's paths.
...
// Single Request.
$results = v2UpdateCompaniesExample($service, $optParams);
...
* @return Company
*/
function v2UpdateCompaniesExample($service, $optParams)
{
	try
	{
		...
		return $service->v2->UpdateCompaniesV2($optParams);
	}
	catch (Exception $e)
	{
