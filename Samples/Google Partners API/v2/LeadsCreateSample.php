...
print_r(leadsCreateExample($service, $companyId));

/**
* Creates an advertiser lead for the given company ID.
* @service Authenticated Partners service.
* @companyId The ID of the company to contact.
* @return CreateLeadResponse</returns>
*/
function leadsCreateExample($service, $companyId)
{
	try
	{
		...
		return $service->leads->CreateLeads($companyId);
	}
	catch (Exception $ex)
	{
