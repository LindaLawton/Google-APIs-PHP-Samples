...
// Single Request.
$results = leadsCreateExample($service, $companyId, $optParams);
...
*/
function leadsCreateExample($service, $companyId, $optParams)
{
	try
	{
		...
		return $service->leads->CreateLeads($companyId, $optParams);
	}
	catch (Exception $e)
	{
