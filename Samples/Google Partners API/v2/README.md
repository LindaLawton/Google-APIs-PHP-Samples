...
# UnOfficial Google Partners API v2 Samples for PHP

## API Description

Searches certified companies and creates contact leads with them, and also audits the usage of clients.

[Official Documentation](https://developers.google.com/partners/)

## Sample Description

These samples show how to access the [Google Partners API v2](https://developers.google.com/partners/) with the Official [Google PHP client library](https://github.com/google/google-api-php-client)
