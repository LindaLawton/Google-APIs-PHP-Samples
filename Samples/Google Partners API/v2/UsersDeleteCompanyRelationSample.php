...
print_r(usersDeleteCompanyRelationExample($service, $userId));
...
*/
function usersDeleteCompanyRelationExample($service, $userId)
{
	try
	{
		...
		return $service->users->DeleteCompanyRelationUsers($userId);
	}
	catch (Exception $ex)
	{
