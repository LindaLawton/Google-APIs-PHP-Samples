...
$results = usersDeleteCompanyRelationExample($service, $userId, $optParams);
...
* @return Empty
*/
function usersDeleteCompanyRelationExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->users->DeleteCompanyRelationUsers($userId, $optParams);
	}
	catch (Exception $e)
	{
