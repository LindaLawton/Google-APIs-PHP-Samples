...
// Single Request.
$results = usersUpdateProfileExample($service, $optParams);
...
* @return UserProfile
*/
function usersUpdateProfileExample($service, $optParams)
{
	try
	{
		...
		return $service->users->UpdateProfileUsers($optParams);
	}
	catch (Exception $e)
	{
