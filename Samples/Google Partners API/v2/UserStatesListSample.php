...
// Single Request.
$results = userStatesListExample($service, $optParams);
...
* @return ListUserStatesResponse
*/
function userStatesListExample($service, $optParams)
{
	try
	{
		...
		return $service->userStates->ListUserStates($optParams);
	}
	catch (Exception $e)
	{
