...
print_r(userStatesListExample($service));

/**
* Lists states for current user.
* @service Authenticated Partners service.
* @return ListUserStatesResponse</returns>
*/
function userStatesListExample($service)
{
	try
	{
		...
		return $service->userStates->ListUserStates();
	}
	catch (Exception $ex)
	{
