...
// Single Request.
$results = examsGetTokenExample($service, $examType, $optParams);
...
* @return ExamToken
*/
function examsGetTokenExample($service, $examType, $optParams)
{
	try
	{
		...
		if (examType == null)
			throw new Exception("examType is required.");
		// Make the request and return the results.
		return $service->exams->GetTokenExams($examType, $optParams);
	}
	catch (Exception $e)
	{
