...
print_r(examsGetTokenExample($service, $examType));
...
* @return ExamToken</returns>
*/
function examsGetTokenExample($service, $examType)
{
	try
	{
		...
		return $service->exams->GetTokenExams($examType);
	}
	catch (Exception $ex)
	{
