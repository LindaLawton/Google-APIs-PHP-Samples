...
$results = clientMessagesLogExample($service, $optParams);
...
*/
function clientMessagesLogExample($service, $optParams)
{
	try
	{
		...
		return $service->clientMessages->LogClientMessages($optParams);
	}
	catch (Exception $e)
	{
