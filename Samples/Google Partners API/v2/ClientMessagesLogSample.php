...
print_r(clientMessagesLogExample($service));
...
* @return LogMessageResponse</returns>
*/
function clientMessagesLogExample($service)
{
	try
	{
		...
		return $service->clientMessages->LogClientMessages();
	}
	catch (Exception $ex)
	{
