...
print_r(v2GetPartnersstatusExample($service));
...
* @return GetPartnersStatusResponse</returns>
*/
function v2GetPartnersstatusExample($service)
{
	try
	{
		...
		return $service->v2->GetPartnersstatusV2();
	}
	catch (Exception $ex)
	{
