...
$results = v2GetPartnersstatusExample($service, $optParams);
...
* @return GetPartnersStatusResponse
*/
function v2GetPartnersstatusExample($service, $optParams)
{
	try
	{
		...
		return $service->v2->GetPartnersstatusV2($optParams);
	}
	catch (Exception $e)
	{
