 ...
 * Initializes an Partners.v2 service object.
 * @param string API key
 * @return An authorized Partners.v2 service object.
 */
function getPublicService($apiKey) {
	try {
		
		$client = new Google_Client();
		$client->setApplicationName("Google Partners Sample");
		...
		// Create authenticated Partners service
		return new Google_Service_Partners($client);
	} catch (Exception $e) {
