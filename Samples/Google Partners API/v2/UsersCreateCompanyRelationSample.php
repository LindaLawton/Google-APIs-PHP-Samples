...
// Single Request.
$results = usersCreateCompanyRelationExample($service, $userId, $optParams);
...
*/
function usersCreateCompanyRelationExample($service, $userId, $optParams)
{
	try
	{
		...
		return $service->users->CreateCompanyRelationUsers($userId, $optParams);
	}
	catch (Exception $e)
	{
