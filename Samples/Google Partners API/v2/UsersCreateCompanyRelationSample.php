...
print_r(usersCreateCompanyRelationExample($service, $userId));
...
* @return CompanyRelation</returns>
*/
function usersCreateCompanyRelationExample($service, $userId)
{
	try
	{
		...
		return $service->users->CreateCompanyRelationUsers($userId);
	}
	catch (Exception $ex)
	{
